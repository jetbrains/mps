...
public class TestContextActionsToolMenu extends TransformationMenuBase {
  public TestContextActionsToolMenu() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "TestContextActionsToolMenu", new SNodePointer("r:5198f57a-b6fe-4b27-af15-f0dc1a790395(jetbrains.mps.lang.editor.test.generation.editor)", "2895511001984650029")), List.<String>of(MenuLocations.CONTEXT_ACTIONS_TOOL));
  }
