...
public class IndividualImports_Map1 {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        SPropertyOperations.assign(node, PROPS.result$xPGH, "DELETE-1");
      }
  ...
  /*package*/ static AbstractCellAction createAction_INSERT(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        SPropertyOperations.assign(node, PROPS.result$xPGH, "INSERT-1");
      }
  ...
  private static final class PROPS {
    /*package*/ static final SProperty result$xPGH = MetaAdapterFactory.getProperty(0x81f0abb8d71e4d13L, 0xa0c1d2291fbb28b7L, 0x1454bfe1d0c7b8f5L, 0x1454bfe1d0c7b8f6L, "result");
  }
}
