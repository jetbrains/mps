...
public class NotEditableVarableReference_SubstituteMenu extends SubstituteMenuBase {
  public NotEditableVarableReference_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for NotEditableVarableReference. Generated from the smart reference attribute.", new SNodePointer("r:1a7fc406-f263-498c-a126-51036fe6a9da(jetbrains.mps.lang.editor.editorTest.structure)", "8846826897881127685")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_2zcnuz_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_2zcnuz_a() {
      super(CONCEPTS.NotEditableVarableReference$ZP, LINKS.variableDeclaration$QH$d, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }
  ...
  public class SMP_Subconcepts_2zcnuz_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_2zcnuz_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "NotEditableVarableReference", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.NotEditableVarableReference$ZP);
    }
