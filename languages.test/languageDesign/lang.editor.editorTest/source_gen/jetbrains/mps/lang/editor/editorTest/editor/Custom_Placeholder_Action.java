...
public class Custom_Placeholder_Action {
  ...
  /*package*/ static AbstractCellAction createAction_INSERT_PLACEHOLDER(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.customPlaceholder$V1ss)).isNotEmpty()) {
          ...
          SLinkOperations.addNewChild(node, LINKS.customPlaceholder$V1ss, null);
        }
      }
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink customPlaceholder$V1ss = MetaAdapterFactory.getContainmentLink(0x81f0abb8d71e4d13L, 0xa0c1d2291fbb28b7L, 0x5f4994bb9f207828L, 0x611ca85be0637679L, "customPlaceholder");
  }
}
