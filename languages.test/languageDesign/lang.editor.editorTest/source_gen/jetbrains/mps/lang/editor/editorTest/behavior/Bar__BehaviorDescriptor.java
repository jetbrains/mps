...
public final class Bar__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> bar_id2lc36UC2R3m = new SMethodBuilder<>(Void.TYPE).name("bar").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2687536747038601430L).languageId(0xa0c1d2291fbb28b7L, 0x81f0abb8d71e4d13L).build2();
