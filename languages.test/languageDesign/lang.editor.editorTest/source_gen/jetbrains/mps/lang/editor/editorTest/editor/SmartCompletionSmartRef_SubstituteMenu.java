...
public class SmartCompletionSmartRef_SubstituteMenu extends SubstituteMenuBase {
  public SmartCompletionSmartRef_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for SmartCompletionSmartRef. Generated from implicit smart reference attribute.", new SNodePointer("r:1a7fc406-f263-498c-a126-51036fe6a9da(jetbrains.mps.lang.editor.editorTest.structure)", "6999890265142422770")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_hcxcl0_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_hcxcl0_a() {
      super(CONCEPTS.SmartCompletionSmartRef$o8, LINKS.reference$fUbJ, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_hcxcl0_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_hcxcl0_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "SmartCompletionSmartRef", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.SmartCompletionSmartRef$o8);
    }
