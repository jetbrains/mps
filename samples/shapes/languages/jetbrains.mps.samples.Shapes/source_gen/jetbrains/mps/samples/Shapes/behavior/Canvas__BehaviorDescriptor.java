...
public final class Canvas__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> interpret_idW6XMzE_6ci = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("interpret").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1082824515535528722L).languageId(0x83327c6de8729b3fL, 0x16bafbb4c6cd4cc5L).build2();
