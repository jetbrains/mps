...
import jetbrains.mps.samples.highlevel.sampleLanguage.constraints.GeneratedRulesConstraintsAspect;
...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    myId = SLanguageId.deserialize("99aa3e0f-a162-4dc1-bcff-2def4d654205");
  }
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass == StructureAspectDescriptor.class) {
      return aspectClass.cast(new jetbrains.mps.samples.highlevel.sampleLanguage.structure.StructureAspectDescriptor());
    }
