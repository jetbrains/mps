...
public class ParenthesisSubstitute extends SubstituteMenuBase {
  public ParenthesisSubstitute() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "ParenthesisSubstitute", new SNodePointer("r:293510ad-7298-4276-86d7-1873781733f1(jetbrains.mps.samples.lambdaCalculus.editor)", "1741258697587106990")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Action_smqx88_a extends SingleItemSubstituteMenuPart {
    ...
    private class Item extends DefaultSubstituteMenuItem {
      ...
      /*package*/ void resetTraceInfo() {
        ...
        updateTraceInfo(description, new SNodePointer("r:293510ad-7298-4276-86d7-1873781733f1(jetbrains.mps.samples.lambdaCalculus.editor)", "1741258697587106992"));
      }
