...
public class Let_Substitute extends SubstituteMenuBase {
  public Let_Substitute() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "Let_Substitute", new SNodePointer("r:293510ad-7298-4276-86d7-1873781733f1(jetbrains.mps.samples.lambdaCalculus.editor)", "1741258697587106945")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Action_6lhmf3_a extends SingleItemSubstituteMenuPart {
    ...
    private class Item extends DefaultSubstituteMenuItem {
      ...
      /*package*/ void resetTraceInfo() {
        ...
        updateTraceInfo(description, new SNodePointer("r:293510ad-7298-4276-86d7-1873781733f1(jetbrains.mps.samples.lambdaCalculus.editor)", "1741258697587106947"));
      }
