...
public class SideTransformMultiple extends TransformationMenuBase {
  public SideTransformMultiple() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "SideTransformMultiple", new SNodePointer("r:293510ad-7298-4276-86d7-1873781733f1(jetbrains.mps.samples.lambdaCalculus.editor)", "1741258697587106815")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
