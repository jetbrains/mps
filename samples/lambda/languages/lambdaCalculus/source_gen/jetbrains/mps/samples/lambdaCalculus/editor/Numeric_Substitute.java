...
public class Numeric_Substitute extends SubstituteMenuBase {
  public Numeric_Substitute() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "Numeric_Substitute", new SNodePointer("r:293510ad-7298-4276-86d7-1873781733f1(jetbrains.mps.samples.lambdaCalculus.editor)", "1741258697587107035")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Action_6g51gm_a extends SingleItemSubstituteMenuPart {
    ...
    private class Item extends DefaultSubstituteMenuItem {
      ...
      /*package*/ void resetTraceInfo() {
        ...
        updateTraceInfo(description, new SNodePointer("r:293510ad-7298-4276-86d7-1873781733f1(jetbrains.mps.samples.lambdaCalculus.editor)", "1741258697587107037"));
      }
