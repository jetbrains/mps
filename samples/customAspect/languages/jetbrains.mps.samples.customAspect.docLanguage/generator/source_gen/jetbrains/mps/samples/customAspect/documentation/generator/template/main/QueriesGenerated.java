...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static Object propertyMacro_GetValue_1_0(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(ListSequence.fromList(SModelOperations.roots(_context.getInputModel(), CONCEPTS.ConceptDocumentation$mT)).findFirst((it) -> SLinkOperations.getTarget(it, LINKS.cncpt$CYFe) == _context.getNode()), PROPS.text$sz8T);
  }
  ...
  public static Iterable<SNode> sourceNodesQuery_1_0(final SourceSubstituteMacroNodesContext _context) {
    return ListSequence.fromList(SModelOperations.roots(_context.getOriginalInputModel(), CONCEPTS.ConceptDocumentation$mT)).select((it) -> SLinkOperations.getTarget(it, LINKS.cncpt$CYFe)).distinct();
  }
  private final Map<String, CreateRootCondition> crcMethods = new HashMap<String, CreateRootCondition>();
  {
    int i = 0;
    crcMethods.put("2897519568668578988", new CRC(i++));
  }
  @Override
  @NotNull
  ...
  {
    int i = 0;
    snsqMethods.put("2897519568668600552", new SNsQ(i++));
  }
  @NotNull
  @Override
  ...
  {
    int i = 0;
    pvqMethods.put("2897519568668614237", new PVQ(i++, MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf93d565d10L, 0xf93d565d11L, "value"), "doc"));
  }
  @NotNull
  @Override
  ...
  {
    rtqMethods.put("2897519568668612286", new RTQ(0, "ConceptDocumentation"));
  }
  @NotNull
  @Override
  ...
  private static final class PROPS {
    /*package*/ static final SProperty text$sz8T = MetaAdapterFactory.getProperty(0x22916f45e98f4433L, 0x9c1b1b382cf5bd8dL, 0x28360eb22c3ac732L, 0x28360eb22c3acdf0L, "text");
  }
}
