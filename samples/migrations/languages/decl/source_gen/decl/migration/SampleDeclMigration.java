...
public class SampleDeclMigration extends MigrationScriptBase {
  ...
  private static SNode createDeclMigrationData_i4ro0d_a0f0a0a5a3a5(Object p0, Object p1) {
    ...
    rootBuilder1.setProperty(PROPS.oldId$lFYx, PROPS.oldId$lFYx.getType().toString(p0));
    rootBuilder1.setProperty(PROPS.newId$lGdy, PROPS.newId$lGdy.getType().toString(p1));
