...
public class SampleDeclMigration extends MigrationScriptBase {
  ...
  private static SNode createDeclMigrationData_i4ro0d_a0f0a0a5a3a5(Object p0, Object p1) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.DeclMigrationData$fR);
    rootBuilder1.setProperty(PROPS.oldId$bq$n, PROPS.oldId$bq$n.getType().toString(p0));
    rootBuilder1.setProperty(PROPS.newId$bqNo, PROPS.newId$bqNo.getType().toString(p1));
