...
public class EventReference_SubstituteMenu extends SubstituteMenuBase {
  public EventReference_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for EventReference. Generated from implicit smart reference attribute.", new SNodePointer("r:b986234b-0ae5-423e-aca0-76655e94d151(jetbrains.mps.samples.multipleProjections.stateMachine.structure)", "763922957008729158")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_w7xorn_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_w7xorn_a() {
      super(CONCEPTS.EventReference$dP, LINKS.event$qnvG, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }
  ...
  public class SMP_Subconcepts_w7xorn_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.EventReference$dP);
    }
