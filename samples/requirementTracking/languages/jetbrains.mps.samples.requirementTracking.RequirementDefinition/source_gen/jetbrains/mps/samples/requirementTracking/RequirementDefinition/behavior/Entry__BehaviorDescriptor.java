...
public final class Entry__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String getPresentation_idhEwIMiw(@NotNull SNode __thisNode__) {
    return ((isNotEmptyString(SPropertyOperations.getString(__thisNode__, PROPS.id$hYkt)) ? "" + SPropertyOperations.getString(__thisNode__, PROPS.id$hYkt) + ": " : "")) + SPropertyOperations.getString(__thisNode__, PROPS.name$MnvL);
  }
