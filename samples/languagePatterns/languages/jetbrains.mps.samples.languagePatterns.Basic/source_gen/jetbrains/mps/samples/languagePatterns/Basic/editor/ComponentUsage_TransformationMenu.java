...
public class ComponentUsage_TransformationMenu extends TransformationMenuBase {
  public ComponentUsage_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "ComponentUsage", new SNodePointer("r:22f33598-07c7-4dfb-8f90-72f788e27c1b(jetbrains.mps.samples.languagePatterns.Basic.editor)", "307972218720608164")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  public class TMP_Reference_z2yv9d_a0 extends ReferenceMenuTransformationMenuPart {
    ...
    protected SReferenceLink getReferenceLink(TransformationMenuContext context) {
      return LINKS.usedComponent$uCxb;
    }
  }
