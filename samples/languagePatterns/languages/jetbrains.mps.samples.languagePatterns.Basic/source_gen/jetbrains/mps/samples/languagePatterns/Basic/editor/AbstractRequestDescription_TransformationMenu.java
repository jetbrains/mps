...
public class AbstractRequestDescription_TransformationMenu extends TransformationMenuBase {
  public AbstractRequestDescription_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "AbstractRequestDescription", new SNodePointer("r:22f33598-07c7-4dfb-8f90-72f788e27c1b(jetbrains.mps.samples.languagePatterns.Basic.editor)", "4638275137436062994")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
