...
public class AbstractRequestDescription_SubstituteMenu extends SubstituteMenuBase {
  public AbstractRequestDescription_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "AbstractRequestDescription", new SNodePointer("r:22f33598-07c7-4dfb-8f90-72f788e27c1b(jetbrains.mps.samples.languagePatterns.Basic.editor)", "4638275137435787855")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Subconcepts_dcepxw_a extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_dcepxw_a() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "AbstractRequestDescription", new SNodePointer("r:22f33598-07c7-4dfb-8f90-72f788e27c1b(jetbrains.mps.samples.languagePatterns.Basic.editor)", "4638275137435787856")));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.AbstractRequestDescription$fB);
    }
  ...
  private class SMP_Action_dcepxw_b extends SingleItemSubstituteMenuPart {
    ...
    private class Item extends DefaultSubstituteMenuItem {
      ...
      /*package*/ void resetTraceInfo() {
        ...
        updateTraceInfo(description, new SNodePointer("r:22f33598-07c7-4dfb-8f90-72f788e27c1b(jetbrains.mps.samples.languagePatterns.Basic.editor)", "4638275137435830417"));
      }
