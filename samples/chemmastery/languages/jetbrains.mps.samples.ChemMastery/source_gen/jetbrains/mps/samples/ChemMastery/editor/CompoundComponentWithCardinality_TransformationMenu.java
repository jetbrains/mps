...
public class CompoundComponentWithCardinality_TransformationMenu extends TransformationMenuBase {
  public CompoundComponentWithCardinality_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "CompoundComponentWithCardinality", new SNodePointer("r:563c5369-4649-4929-a845-37c7045ffecd(jetbrains.mps.samples.ChemMastery.editor)", "3123291046851062707")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  public class TMP_Include_qoepdk_a0 extends IncludeTransformationMenuTransformationMenuPart {
    ...
    protected TransformationMenuLookup getMenuLookup(TransformationMenuContext _context) {
      ...
      return new DefaultTransformationMenuLookup(LanguageRegistry.getInstance(editorContext.getRepository()), CONCEPTS.CompoundComponent$9d);
    }
  ...
  private class TMP_Action_qoepdk_b0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:563c5369-4649-4929-a845-37c7045ffecd(jetbrains.mps.samples.ChemMastery.editor)", "7995886393883075699"));
        return this;
      }
      @Nullable
      @Override
