...
public class ElementRef_SubstituteMenu extends SubstituteMenuBase {
  public ElementRef_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "ElementRef", new SNodePointer("r:563c5369-4649-4929-a845-37c7045ffecd(jetbrains.mps.samples.ChemMastery.editor)", "6567999678833598947")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_srjwog_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_srjwog_a() {
      super(CONCEPTS.ElementRef$EZ, LINKS.element$uhEr, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:563c5369-4649-4929-a845-37c7045ffecd(jetbrains.mps.samples.ChemMastery.editor)", "6567999678833598975")));
    }
