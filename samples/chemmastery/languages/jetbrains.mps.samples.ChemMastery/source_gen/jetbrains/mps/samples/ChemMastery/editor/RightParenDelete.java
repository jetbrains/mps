  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, final SNode node) {
        SNode last = ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.elements$p7zr)).last();
        if ((last == null)) {
        ...
        if (last != null) {
          SelectionUtil.selectLabelCellAnSetCaret(editorContext, last, SelectionManager.LAST_CELL, -1);
        }
      }
