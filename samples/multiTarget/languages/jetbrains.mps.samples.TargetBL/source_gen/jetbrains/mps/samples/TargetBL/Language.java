...
import jetbrains.mps.samples.TargetBL.constraints.GeneratedRulesConstraintsAspect;
...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    myId = SLanguageId.deserialize("2be98ea6-ab10-4fb3-8aad-ddec015f4320");
  }
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass == StructureAspectDescriptor.class) {
      return aspectClass.cast(new jetbrains.mps.samples.TargetBL.structure.StructureAspectDescriptor());
    }
