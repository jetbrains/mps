...
import jetbrains.mps.samples.TargetXML.constraints.GeneratedRulesConstraintsAspect;
...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    myId = SLanguageId.deserialize("80471978-5b5c-4b34-a272-816c5dc96e2a");
  }
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass == StructureAspectDescriptor.class) {
      return aspectClass.cast(new jetbrains.mps.samples.TargetXML.structure.StructureAspectDescriptor());
    }
