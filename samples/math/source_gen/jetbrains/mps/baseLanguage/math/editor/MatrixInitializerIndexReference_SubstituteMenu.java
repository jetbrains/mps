...
public class MatrixInitializerIndexReference_SubstituteMenu extends SubstituteMenuBase {
  public MatrixInitializerIndexReference_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for MatrixInitializerIndexReference. Generated from implicit smart reference attribute.", new SNodePointer("r:cb1a36c8-1ffb-415a-aba8-afb9dc042d1b(jetbrains.mps.baseLanguage.math.structure)", "6219660258344759890")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_2x2usv_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_2x2usv_a() {
      super(CONCEPTS.MatrixInitializerIndexReference$AV, LINKS.index$gez$, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_2x2usv_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_2x2usv_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "MatrixInitializerIndexReference", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.MatrixInitializerIndexReference$AV);
    }
