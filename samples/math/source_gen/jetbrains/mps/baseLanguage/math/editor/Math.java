...
public class Math extends TransformationMenuBase {
  public Math() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default transformation menu for " + "Expression", new SNodePointer("r:93eafd6e-0a56-402c-930d-564027be226b(jetbrains.mps.baseLanguage.math.editor)", "3425189563111377433")), List.<String>of(MenuLocations.CONTEXT_ACTIONS_TOOL));
  }
