...
public class Sample {
  ...
  public static void main(String[] args) {
    ...
    Matrix<Double> r = new Matrix<Double>(false, Matrix.soDouble, new Matrix<Double>(new Double[][]{{Math.cos(a)}, {Math.pow(3, 2)}, {((_FunctionTypes._return_P0_E0<Double>) () -> {
      Double r_c0a0h0b;
      r_c0a0h0b = null;
      ...
      return r_c0a0h0b;
    }).invoke()}, {(double) 4}}, Matrix.soDouble), new Matrix<Double>(new Double[][]{{Math.sin(1)}, {(double) 1}, {Math.pow(2, 7 - (a / 2) + b)}, {(double) 0}}, Matrix.soDouble), new Matrix<Double>(true, Matrix.soDouble, 1, 3 + (1.0 / 2), Math.exp(1), ((_FunctionTypes._return_P0_E0<Integer>) () -> {
      Integer r_d2a0h0b;
      r_d2a0h0b = (Integer) 1;
