...
public final class TestConcept_ConstraintRules extends BaseRulesConstraintsDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x7cf7c95bc81e4da9L, 0xa05645e480a7abd3L, 0x530a123e5fc34d34L, "messagesCustomization.structure.TestConcept");

  public static final Rule<CanBeRootContext> check_id7932913038699129641 = new Rule_unnamed_6y4avc_c0();
  ...
  public static final class Rule_unnamed_6y4avc_c0 extends BaseRule<CanBeRootContext> {
    private static final SNodeReference SOURCE_NODE_REF = PersistenceFacade.getInstance().createNodeReference("r:5dbac061-aef9-4696-88ee-0f21fe5598f3(messagesCustomization.constraints)/7932913038699129641");
    public static final RuleId ID_unnamed_6y4avc_c0 = new RuleId(7932913038699129641L, SOURCE_NODE_REF);

    public Rule_unnamed_6y4avc_c0() {
      super(CONCEPT, PredefinedRuleKinds.CAN_BE_ROOT, ID_unnamed_6y4avc_c0, SOURCE_NODE_REF);
    }
  ...
  public static final class Rule_unnamed_6y4avc_a1 extends BaseRule<ContainmentContext> {
    private static final SNodeReference SOURCE_NODE_REF = PersistenceFacade.getInstance().createNodeReference("r:5dbac061-aef9-4696-88ee-0f21fe5598f3(messagesCustomization.constraints)/2716118816015675669");
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept TestConcept$83 = MetaAdapterFactory.getConcept(0x7cf7c95bc81e4da9L, 0xa05645e480a7abd3L, 0x530a123e5fc34d34L, "messagesCustomization.structure.TestConcept");
  }
