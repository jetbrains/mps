...
public class ParallelForSample {
  ...
  public static void main(String[] args) {
        ...
        final Runnable runnable = new Runnable() {
          public void run() {
            try {
              ...
              // External(compiled)methodcallscanbeannotatedasthread-safetoindicatethattheyaresafetocall
    ...
    // Referencestonon-finalvariablesandparametersfromwithinparallelloopsarereportedaserrors
    // Trymakingthefollowingvariablenon-final(Alt+Enter)
    final String doNotMessupWith = "The Shared State";

    // Accessingnon-thread-safeclasses,suchaslists,isreportedaswarnings
    final List<String> names = ListSequence.fromListAndArray(new ArrayList<String>(), "Joe", "Dave", "Alice");

    // Accessingthread-safeclassesisconsideredok
    ...
    // Iteratingoveracollectionofstrings
    // Nothreadpoolisset(Alt|Command+2)sousingthreadsdirectly
    {
