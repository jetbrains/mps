...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static Object propertyMacro_GetValue_1_2(final PropertyMacroContext _context) {
    return _context.createUniqueName("decisionTable", SNodeOperations.getNodeAncestor(_context.getNode(), CONCEPTS.ClassConcept$bK, false, false));
  }
  ...
  public static SNode sourceNodeQuery_1_2(final SourceSubstituteMacroNodeContext _context) {
    SNode t = SNodeOperations.getNodeAncestor(_context.getNode(), CONCEPTS.DecisionTable$ri, false, false);
    SNode rowHeader = _context.getNode();
    SNode colHeader = (SNode) _context.getNode().getUserObject("colHeader");
    return ListSequence.fromList(SLinkOperations.getChildren(t, LINKS.resultValues$2Mdt)).getElement(SNodeOperations.getIndexInParent(rowHeader) * ListSequence.fromList(SLinkOperations.getChildren(t, LINKS.colHeaders$2LJr)).count() + SNodeOperations.getIndexInParent(colHeader));
  }
  public static SNode sourceNodeQuery_1_3(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.defaultValue$2Lwq);
  }
  public static SNode sourceNodeQuery_1_4(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.expectedType$2Lhp);
  }
  public static Iterable<SNode> sourceNodesQuery_0_0(final SourceSubstituteMacroNodesContext _context) {
    return SetSequence.fromSet(DecisionTable__BehaviorDescriptor.referencedLVDs_id3mtcPBWFCmw.invoke(_context.getNode())).toList();
  }
  public static Iterable<SNode> sourceNodesQuery_0_1(final SourceSubstituteMacroNodesContext _context) {
    return SetSequence.fromSet(DecisionTable__BehaviorDescriptor.referencedParams_id3mtcPBWFDo3.invoke(_context.getNode())).toList();
  }
  ...
  public static Iterable<SNode> sourceNodesQuery_1_2(final SourceSubstituteMacroNodesContext _context) {
    List<SNode> rowHeaders = SLinkOperations.getChildren(SNodeOperations.getNodeAncestor(_context.getNode(), CONCEPTS.DecisionTable$ri, false, false), LINKS.rowHeaders$2LYs);
    ListSequence.fromList(rowHeaders).visitAll((it) -> it.putUserObject("colHeader", _context.getNode()));
    return rowHeaders;
  }
  public static Iterable<SNode> sourceNodesQuery_1_3(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(_context.getNode(), LINKS.colHeaders$2LJr);
  }
