...
/*package*/ class Constants_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class constantsListHandler_v2fri_c0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.constants$KxKC;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.Constant$Ym;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(constantsListHandler_v2fri_c0.this.getNode(), LINKS.constants$KxKC));
      try {
