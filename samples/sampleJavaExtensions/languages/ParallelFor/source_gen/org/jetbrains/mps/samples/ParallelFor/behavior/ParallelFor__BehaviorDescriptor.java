...
public final class ParallelFor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> findPoolDeclaration_id6FH9fp$mItT = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("findPoolDeclaration").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("6FH9fp$mItT").build();
