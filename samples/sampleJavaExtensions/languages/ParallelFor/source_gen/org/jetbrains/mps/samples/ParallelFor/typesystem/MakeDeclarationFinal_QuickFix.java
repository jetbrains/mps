...
public class MakeDeclarationFinal_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    SPropertyOperations.assign(SLinkOperations.getTarget(SNodeOperations.cast(node, CONCEPTS.VariableReference$TC), LINKS.variableDeclaration$N1XG), PROPS.isFinal$gvTP, true);
  }
