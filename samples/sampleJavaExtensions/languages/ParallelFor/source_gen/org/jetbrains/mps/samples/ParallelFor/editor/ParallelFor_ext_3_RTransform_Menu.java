...
public class ParallelFor_ext_3_RTransform_Menu extends TransformationMenuBase {
  public ParallelFor_ext_3_RTransform_Menu() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "ParallelFor_ext_3_RTransform_Menu", new SNodePointer("r:356cdff9-223c-480e-a34e-0b9eab641194(org.jetbrains.mps.samples.ParallelFor.editor)", "1741258697587112640")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  public class TMP_Include_w7u9im_a0 extends IncludeTransformationMenuTransformationMenuPart {
    ...
    protected TransformationMenuLookup getMenuLookup(TransformationMenuContext _context) {
      ...
      return new NamedTransformationMenuLookup(LanguageRegistry.getInstance(editorContext.getRepository()), CONCEPTS.ParallelFor$2i, "org.jetbrains.mps.samples.ParallelFor.editor.NoWaitTransforms_ParallelFor_ext_3");
    }
  ...
  public class TMP_Include_w7u9im_b0 extends IncludeTransformationMenuTransformationMenuPart {
    ...
    protected TransformationMenuLookup getMenuLookup(TransformationMenuContext _context) {
      ...
      return new NamedTransformationMenuLookup(LanguageRegistry.getInstance(editorContext.getRepository()), CONCEPTS.ParallelFor$2i, "org.jetbrains.mps.samples.ParallelFor.editor.ThreadPoolTransforms_ext_3");
    }
