...
/*package*/ class MoneyLiteral_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.amount$FBiW;
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.unit$Yo4p;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.unit$Yo4p);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.unit$Yo4p);
    }
    if (true) {
