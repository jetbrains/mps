...
public final class ConstraintsExpressionHolder__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getInterfaceConcept(0x47257bf378d3470bL, 0x89d98c3261a61d15L, 0x653030359356e968L, "jetbrains.mps.constraints.rules.structure.ConstraintsExpressionHolder");
  ...
  public static final SMethod<SNode> getApplicableConcept_id1yskeTf3HiD = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getApplicableConcept").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("1yskeTf3HiD").build();

  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getRuleKind_id6kKc3mjmXYb, getBlock_id6kKc3mjn3VM, getApplicableConcept_id1yskeTf3HiD);
  ...
  /*package*/ static SNode getApplicableConcept_id1yskeTf3HiD(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(SNodeOperations.cast(SNodeOperations.getParent(SNodeOperations.cast(SNodeOperations.getParent(__thisNode__), MetaAdapterFactory.getConcept(0x47257bf378d3470bL, 0x89d98c3261a61d15L, 0x6530303593554246L, "jetbrains.mps.constraints.rules.structure.ConstraintsRuleBlock"))), MetaAdapterFactory.getConcept(0x47257bf378d3470bL, 0x89d98c3261a61d15L, 0x6530303593554221L, "jetbrains.mps.constraints.rules.structure.ConstraintsRoot")), MetaAdapterFactory.getReferenceLink(0x47257bf378d3470bL, 0x89d98c3261a61d15L, 0x6530303593554221L, 0x6530303593940081L, "concept"));
  }
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      ...
      case 2:
        return (T) ((SNode) getApplicableConcept_id1yskeTf3HiD(node));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
