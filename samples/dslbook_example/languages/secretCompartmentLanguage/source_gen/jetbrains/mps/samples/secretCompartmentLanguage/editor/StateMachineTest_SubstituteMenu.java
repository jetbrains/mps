...
public class StateMachineTest_SubstituteMenu extends SubstituteMenuBase {
  public StateMachineTest_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for StateMachineTest. Generated from implicit smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c8959042e(jetbrains.mps.samples.secretCompartmentLanguage.structure)", "1197246912613")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_4nt6vc_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_4nt6vc_a() {
      super(CONCEPTS.StateMachineTest$oe, LINKS.stateMachine$rUP6, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_4nt6vc_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_4nt6vc_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "StateMachineTest", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.StateMachineTest$oe);
    }
