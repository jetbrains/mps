...
public class MoneyMethods_Contribution extends TransformationMenuBase {
  public MoneyMethods_Contribution() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default transformation menu for " + "Expression", new SNodePointer("r:00000000-0000-4000-0000-011c895903f5(jetbrains.mps.baseLanguage.money.editor)", "1741258697587199953")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  private class TMP_Action_tctb8u_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895903f5(jetbrains.mps.baseLanguage.money.editor)", "1741258697587199959"));
        return this;
      }
      @Nullable
      @Override
  ...
  private class TMP_Action_tctb8u_b0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895903f5(jetbrains.mps.baseLanguage.money.editor)", "1741258697587200020"));
        return this;
      }
      @Nullable
      @Override
  ...
  private class TMP_Action_tctb8u_c0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895903f5(jetbrains.mps.baseLanguage.money.editor)", "1741258697587200081"));
        return this;
      }
      @Nullable
      @Override
