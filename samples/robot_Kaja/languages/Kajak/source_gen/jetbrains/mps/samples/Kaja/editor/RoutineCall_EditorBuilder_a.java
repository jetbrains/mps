...
import jetbrains.mps.samples.Kaja.editor.KajakStyles_StyleSheet.CommentStyleClass;
...
/*package*/ class RoutineCall_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_wwx4md_a1a() {
    return SNodeOperations.getNodeAncestor(SLinkOperations.getTarget(myNode, LINKS.definition$J8D4), CONCEPTS.Library$oJ, false, false) != null;
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.definition$J8D4;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.definition$J8D4);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.definition$J8D4);
    }
