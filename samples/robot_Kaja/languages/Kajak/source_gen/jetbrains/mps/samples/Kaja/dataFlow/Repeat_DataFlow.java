...
public class Repeat_DataFlow extends DataFlowBuilder {
  public void build(final DataFlowBuilderContext _context) {
    if (SPropertyOperations.getInteger(_context.getNode(), PROPS.count$Ir4s) <= 0) {
    ...
    _context.getBuilder().build((SNode) SLinkOperations.getTarget(_context.getNode(), LINKS.body$Irjt));
