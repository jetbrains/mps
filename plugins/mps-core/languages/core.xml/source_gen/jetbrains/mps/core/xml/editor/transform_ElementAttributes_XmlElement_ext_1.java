...
public class transform_ElementAttributes_XmlElement_ext_1 extends TransformationMenuBase {
  public transform_ElementAttributes_XmlElement_ext_1() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "transform_ElementAttributes_XmlElement_ext_1", new SNodePointer("r:2f32078d-2a84-4fef-b050-97e346d25159(jetbrains.mps.core.xml.editor)", "1741258697587213639")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  public class TMP_Group_gxyyd8_b0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_gxyyd8_b0() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:2f32078d-2a84-4fef-b050-97e346d25159(jetbrains.mps.core.xml.editor)", "1741258697587213668")));
    }
    @Override
    ...
    private class TMP_Action_gxyyd8_a1a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:2f32078d-2a84-4fef-b050-97e346d25159(jetbrains.mps.core.xml.editor)", "1741258697587213684"));
          return this;
        }
        @Nullable
        @Override
