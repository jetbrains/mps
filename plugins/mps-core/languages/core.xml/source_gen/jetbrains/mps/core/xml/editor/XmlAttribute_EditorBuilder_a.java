...
/*package*/ class XmlAttribute_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.attrName$omjx;
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new valueListHandler_1uorir_a3a0(myNode, getEditorContext());
  ...
  private static class valueListHandler_1uorir_a3a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(valueListHandler_1uorir_a3a0.this.getNode(), LINKS.value$1h4D));
      try {
  ...
  private EditorCell createConstant_3() {
    ...
    style.set(StyleAttributes.PUNCTUATION_LEFT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setTransformationMenuLookup(new DefaultTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.XmlAttribute$ll));
    editorCell.setDefaultText("");
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new valueListHandler_1uorir_d0a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class valueListHandler_1uorir_d0a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(valueListHandler_1uorir_d0a.this.getNode(), LINKS.value$1h4D));
      try {
        EditorCell emptyCell = null;
  ...
  private boolean nodeCondition_1uorir_a3a0() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.value$1h4D)).isEmpty();
  }
