...
public class XmlText_TransformationMenu extends TransformationMenuBase {
  public XmlText_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "XmlText", new SNodePointer("r:2f32078d-2a84-4fef-b050-97e346d25159(jetbrains.mps.core.xml.editor)", "3868755094421773791")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
