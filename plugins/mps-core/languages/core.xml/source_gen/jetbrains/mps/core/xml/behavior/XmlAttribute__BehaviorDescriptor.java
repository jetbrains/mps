...
public final class XmlAttribute__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isMultiline_id2EZ251fZScc = new SMethodBuilder<>(Boolean.TYPE).name("isMultiline").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3080189811177259788L).languageId(0x9139d910cb22f298L, 0x479c7a8c02f943b5L).build2();
  ...
  /*package*/ static boolean isMultiline_id2EZ251fZScc(@NotNull SNode __thisNode__) {
    ...
    for (SNode part : SLinkOperations.getChildren(__thisNode__, LINKS.value$1h4D)) {
