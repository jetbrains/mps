...
public final class XmlElement__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isMultiline_id7HilnpQ3Ckr = new SMethodBuilder<>(Boolean.TYPE).name("isMultiline").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8886258982030574875L).languageId(0x9139d910cb22f298L, 0x479c7a8c02f943b5L).build2();
