...
public class XMLSAXAttributeReference_SmartReference extends SubstituteMenuBase {
  public XMLSAXAttributeReference_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "XMLSAXAttributeReference_SmartReference", new SNodePointer("r:1c9826ed-1ac5-4a4a-a16c-c4f33a9e7348(jetbrains.mps.core.xml.sax.editor)", "4747359941571312070")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_k75wpb_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_k75wpb_a() {
      super(CONCEPTS.XMLSAXAttributeReference$40, LINKS.attribute$zzQt, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:1c9826ed-1ac5-4a4a-a16c-c4f33a9e7348(jetbrains.mps.core.xml.sax.editor)", "4747359941571312068")));
    }
