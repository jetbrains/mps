...
public class XMLSAXNodeRuleParam_SubstituteMenu extends SubstituteMenuBase {
  public XMLSAXNodeRuleParam_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "XMLSAXNodeRuleParam", new SNodePointer("r:1c9826ed-1ac5-4a4a-a16c-c4f33a9e7348(jetbrains.mps.core.xml.sax.editor)", "1741258697587120273")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Wrap_b5jt4u_a extends WrapperSubstituteMenuPart {
    private SMP_Wrap_b5jt4u_a() {
      super(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "Type", new SNodePointer("r:1c9826ed-1ac5-4a4a-a16c-c4f33a9e7348(jetbrains.mps.core.xml.sax.editor)", "1741258697587120275")));
    }
