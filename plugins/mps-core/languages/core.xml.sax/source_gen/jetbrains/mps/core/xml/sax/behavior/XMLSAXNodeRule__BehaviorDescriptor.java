...
public final class XMLSAXNodeRule__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getType_id1XGsQcRHufH = new SMethodBuilder<>(SNode.class).name("getType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2264311582634140653L).languageId(0xa4cbfc7d324ecc63L, 0xdcb5a83a19a844ffL).build2();
