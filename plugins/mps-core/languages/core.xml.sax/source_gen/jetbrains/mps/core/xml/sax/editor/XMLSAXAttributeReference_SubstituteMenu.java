...
public class XMLSAXAttributeReference_SubstituteMenu extends SubstituteMenuBase {
  public XMLSAXAttributeReference_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "XMLSAXAttributeReference", new SNodePointer("r:1c9826ed-1ac5-4a4a-a16c-c4f33a9e7348(jetbrains.mps.core.xml.sax.editor)", "4747359941571312072")));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new SMP_Include_8gefmj_a());
    result.add(new SMP_Subconcepts_8gefmj_b());
    return result;
  }
  ...
  public class SMP_Subconcepts_8gefmj_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_8gefmj_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "XMLSAXAttributeReference", new SNodePointer("r:1c9826ed-1ac5-4a4a-a16c-c4f33a9e7348(jetbrains.mps.core.xml.sax.editor)", "4747359941571312075")));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.XMLSAXAttributeReference$40);
    }
