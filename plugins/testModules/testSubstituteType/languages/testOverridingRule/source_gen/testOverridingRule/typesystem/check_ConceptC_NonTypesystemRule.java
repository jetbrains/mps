...
public class check_ConceptC_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  private static SNode _quotation_createNode_id212q_a0a0b0b0a0c() {
    ...
    quotedNode_1 = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0x38be1c36cdf64e3cL, 0xb9db14f88a11fa03L, "testOverridingRule"), 0x7aa4e26e6874caa6L, "ConceptC")).getResult();
