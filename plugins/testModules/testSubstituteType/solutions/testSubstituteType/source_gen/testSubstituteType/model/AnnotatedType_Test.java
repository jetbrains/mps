...
public class AnnotatedType_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_NodeErrorCheck8675420879155382069() throws Exception {
      ...
      new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("3077325331580971297"), MessageStatus.ERROR, null, myProject.getRepository()).run();
    }
    public void test_NodeErrorCheck8675420879155452234() throws Exception {
      ...
      new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("8675420879155440104"), MessageStatus.ERROR, null, myProject.getRepository()).run();
    }
    public void test_NodeErrorCheck8675420879155453375() throws Exception {
      ...
      new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("8675420879155450086"), MessageStatus.ERROR, null, myProject.getRepository()).run();
    }
    public void test_NodeErrorCheck8675420879155482970() throws Exception {
      ...
      new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("8675420879155458663"), MessageStatus.ERROR, null, myProject.getRepository()).run();
    }
    public void test_NodeErrorCheck8675420879155484751() throws Exception {
      ...
      new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("8675420879155461594"), MessageStatus.ERROR, null, myProject.getRepository()).run();
    }
    public void test_NodeErrorCheck8675420879155485361() throws Exception {
      ...
      new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("8675420879155464922"), MessageStatus.ERROR, null, myProject.getRepository()).run();
    }
    public void test_NodeErrorCheck1470921783545427862() throws Exception {
      ...
      new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("1470921783545424960"), MessageStatus.ERROR, null, myProject.getRepository()).run();
    }
    public void test_ErrorMessagesCheck8675420879155382183() throws Exception {
      ...
      new CheckErrorMessagesAction(nodeToCheck, true, false).includeSelf(false).exclude(ListSequence.fromListAndArray(new ArrayList<CheckExpectedMessageAction>(), new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("3077325331580971297"), MessageStatus.ERROR, null, myProject.getRepository()), new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("8675420879155440104"), MessageStatus.ERROR, null, myProject.getRepository()), new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("8675420879155450086"), MessageStatus.ERROR, null, myProject.getRepository()), new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("8675420879155458663"), MessageStatus.ERROR, null, myProject.getRepository()), new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("8675420879155461594"), MessageStatus.ERROR, null, myProject.getRepository()), new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("8675420879155464922"), MessageStatus.ERROR, null, myProject.getRepository()), new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(getRealNodeById("1470921783545424960"), MessageStatus.ERROR, null, myProject.getRepository()))).run();
    }
