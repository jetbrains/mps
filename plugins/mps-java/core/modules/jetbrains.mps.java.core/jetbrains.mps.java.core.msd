...
<solution name="jetbrains.mps.java.core" uuid="65557aaa-5381-435d-b705-3f8d546e0f40" moduleVersion="0">
  <compileInIDEA />
  <models>
  ...
  <facets>
    <facet type="java" compile="ext" classes="provided" ext="yes">
      ...
      <library location="${mps_home}/plugins/mps-java/lib/java-core.jar" />
    </facet>
  </facets>
  <dependencies>
