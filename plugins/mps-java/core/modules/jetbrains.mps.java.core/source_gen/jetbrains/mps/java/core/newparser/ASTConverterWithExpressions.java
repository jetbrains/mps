...
public class ASTConverterWithExpressions extends ASTConverter {
  ...
  private SReference adjustClassReference(SNode clsType, SNode source, SReferenceLink role) {
    org.jetbrains.mps.openapi.model.SReference sref = clsType.getReference(LINKS.classifier$cxMr);
  ...
  /*package*/ SNode convertExpression(QualifiedThisReference x) throws JavaParseException {
    ...
    SReference sref = adjustClassReference(SNodeOperations.cast(type, CONCEPTS.ClassifierType$bL), thisRef, LINKS.classConcept$zzjZ);
  ...
  /*package*/ SNode convertExpression(SingleNameReference x) {
    ...
    SReference sref = new DynamicReference(LINKS.variableDeclaration$N1XG, varRef, null, new String(x.token));
  ...
  /*package*/ SNode convertExpression(MessageSend x) throws JavaParseException {
    ...
    if (x.receiver instanceof ThisReference && ((ThisReference) x.receiver).isImplicitThis()) {
      ...
      org.jetbrains.mps.openapi.model.SReference ref = new DynamicReference(LINKS.baseMethodDeclaration$pyYw, lmc, null, methodName);
      lmc.setReference(LINKS.baseMethodDeclaration$pyYw, ref);
      ...
      if (receiver instanceof NameReference) {
        ...
        SPropertyOperations.assign(unkDotCall, PROPS.tokens$J1uk, sb.toString());
        ...
        org.jetbrains.mps.openapi.model.SReference ref = new DynamicReference(LINKS.baseMethodDeclaration$pyYw, smc, null, methodName);
        ...
        SLinkOperations.setTarget(dotExpr, LINKS.operation$gs9E, instCall);

        org.jetbrains.mps.openapi.model.SReference sref = new DynamicReference(LINKS.baseMethodDeclaration$pyYw, instCall, null, methodName);
  ...
  /*package*/ SNode convertExpression(AllocationExpression x) throws JavaParseException {
    if (x instanceof QualifiedAllocationExpression) {
      ...
      addTypeArgs(typeArguments(x.type), SLinkOperations.getChildren(unkNew, LINKS.typeArgument$jaIN));
  ...
  /*package*/ SNode convertExpression(ClassLiteralAccess x) throws JavaParseException {
    ...
    if (SNodeOperations.isInstanceOf(argType, CONCEPTS.ClassifierType$bL)) {
      ...
      SReference sref = adjustClassReference(SNodeOperations.cast(argType, CONCEPTS.ClassifierType$bL), result, LINKS.classifier$7Ex9);
  ...
  /*package*/ SNode convertExpression(FieldReference x) throws JavaParseException {
    ...
    SReference sref = new DynamicReference(LINKS.fieldDeclaration$H7Ag, fieldRef, null, new String(x.token));
