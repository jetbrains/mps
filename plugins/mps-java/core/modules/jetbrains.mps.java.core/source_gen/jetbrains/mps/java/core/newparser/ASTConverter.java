...
public class ASTConverter {
  ...
  public SNode convertRoot(ASTNode node) throws JavaParseException {
    ...
    if (node instanceof TypeDeclaration) {
      ...
      SNode rv = convertTypeDecl(decl);
      if (SNodeOperations.isInstanceOf(rv, CONCEPTS.ClassConcept$bK)) {
        // topmost classes are treated as 'static' regardless of keyword presence
        SPropertyOperations.assign(rv, PROPS.nonStatic$aWW8, false);
      }
      return rv;
    } else {
      throw new JavaParseException("Parsed AST root node is not a TypeDeclaration");
    }
  }
  ...
  public SNode convertTypeDecl(TypeDeclaration x) throws JavaParseException {
    ...
    if (isAnonymous) {
      lazyNode = new LazySNode(CONCEPTS.AnonymousClass$Bt);
    } else {
      switch (TypeDeclaration.kind(x.modifiers)) {
        case TypeDeclaration.CLASS_DECL:
          lazyNode = new LazySNode(CONCEPTS.ClassConcept$bK);
          break;
        case TypeDeclaration.INTERFACE_DECL:
          lazyNode = new LazySNode(CONCEPTS.Interface$db);
          break;
        case TypeDeclaration.ENUM_DECL:
          lazyNode = new LazySNode(CONCEPTS.EnumClass$Vk);
          break;
        case TypeDeclaration.ANNOTATION_TYPE_DECL:
          lazyNode = new LazySNode(CONCEPTS.Annotation$he);
          break;
        default:
    ...
    SNode cls = (SNode) (SNode) lazyNode;
    ...
    if (!(isAnonymous)) {
      ...
      if (myOnlyStubs) {
        String nodeId = getState().getIdPrefix() + SPropertyOperations.getString(cls, PROPS.name$MnvL);
        ((jetbrains.mps.smodel.SNode) cls).setId(new SNodeId.Foreign(nodeId));
        prefixedConverter = this.withIdPrefix(SPropertyOperations.getString(cls, PROPS.name$MnvL) + ".");
      }
    }
      ...
      for (TypeDeclaration innerTyp : x.memberTypes) {
        try {
          ...
          if (SNodeOperations.isInstanceOf(cls, CONCEPTS.Interface$db)) {
            ...
            SLinkOperations.setTarget(nested, LINKS.visibility$Yyua, createPublicVisibility_rbndtb_a0a1a1a0a2a61a31());
      ...
      if (SNodeOperations.isInstanceOf(claz, CONCEPTS.ClassConcept$bK)) {
        ...
        if (x.superInterfaces != null) {
          for (TypeReference i : x.superInterfaces) {
            ListSequence.fromList(SLinkOperations.getChildren(claz, LINKS.implementedInterface$rujG)).addElement(SNodeOperations.cast(childConverter.convertTypeReference(i), CONCEPTS.ClassifierType$bL));
          }
        }
        SPropertyOperations.assign(claz, PROPS.abstractClass$Ta1X, flagSet(x.modifiers, ClassFileConstants.AccAbstract));
        SPropertyOperations.assign(claz, PROPS.isFinal$f7C_, flagSet(x.modifiers, ClassFileConstants.AccFinal));
      }
    }

    {
      ...
      if (SNodeOperations.isInstanceOf(iface, CONCEPTS.Interface$db)) {
        if (x.superInterfaces != null) {
          for (TypeReference i : x.superInterfaces) {
            ListSequence.fromList(SLinkOperations.getChildren(iface, LINKS.extendedInterface$PDVO)).addElement(SNodeOperations.cast(childConverter.convertTypeReference(i), CONCEPTS.ClassifierType$bL));
          }
        }
      }
    }
  ...
  private SNode convertField(SNode cls, FieldDeclaration f, boolean attach) throws JavaParseException {
    ...
    if (f instanceof Initializer) {
      ...
      if (attach) {
        ListSequence.fromList(SLinkOperations.getChildren(cls, LINKS.member$L_2d)).addElement(SNodeOperations.cast(initBlock, CONCEPTS.ClassifierMember$At));
      }
      return initBlock;
    }
    ...
    if (flagSet(f.modifiers, ClassFileConstants.AccStatic) || SNodeOperations.isInstanceOf(cls, CONCEPTS.Interface$db)) {
      ...
      assert SNodeOperations.isInstanceOf(cls, CONCEPTS.ClassConcept$bK);
      ...
      SPropertyOperations.assign(fieldDecl, PROPS.isVolatile$HGG9, flagSet(f.modifiers, ClassFileConstants.AccVolatile));
      SPropertyOperations.assign(fieldDecl, PROPS.isTransient$K3Ge, flagSet(f.modifiers, ClassFileConstants.AccTransient));
    ...
    if ((fDecl != null)) {
      ...
      SPropertyOperations.assign(fDecl, PROPS.name$MnvL, new String(f.name));
      SLinkOperations.setTarget(fDecl, LINKS.type$a1UY, convertTypeReference(f.type));
      if (!(myOnlyStubs) && f.initialization != null) {
        SLinkOperations.setTarget(fDecl, LINKS.initializer$2twD, convertExpression(f.initialization));
      }

      SLinkOperations.setTarget(SNodeOperations.cast(fDecl, CONCEPTS.IVisible$zu), LINKS.visibility$Yyua, convertVisibility(f.modifiers));
      SPropertyOperations.assign(fDecl, PROPS.isFinal$gvTP, flagSet(f.modifiers, ClassFileConstants.AccFinal));

      if (!(SNodeOperations.isInstanceOf(cls, CONCEPTS.AnonymousClass$Bt)) && myOnlyStubs) {
        SNodeId nodeId = new SNodeId.Foreign(getState().getIdPrefix() + SPropertyOperations.getString(fDecl, PROPS.name$MnvL));
        ((jetbrains.mps.smodel.SNode) fDecl).setId(nodeId);
      }

      if (attach) {
        ListSequence.fromList(SLinkOperations.getChildren(cls, LINKS.member$L_2d)).addElement(SNodeOperations.cast(fDecl, CONCEPTS.ClassifierMember$At));
      }
    }
    ...
    return SNodeOperations.cast(fDecl, CONCEPTS.ClassifierMember$At);
  }
  ...
  private SNode convertMethod(SNode cls, AbstractMethodDeclaration method, boolean attach) throws JavaParseException {
    ...
    // FIXME
    String clsStringId = (SNodeOperations.isInstanceOf(cls, CONCEPTS.AnonymousClass$Bt) || sNodeId instanceof SNodeId.Regular ? null : cls.getNodeId().toString());
    ...
    if (method instanceof MethodDeclaration) {
      ...
      } else if (SNodeOperations.isInstanceOf(cls, CONCEPTS.Annotation$he)) {
      ...
      if (SNodeOperations.isInstanceOf(result, CONCEPTS.InstanceMethodDeclaration$39) && SNodeOperations.isInstanceOf(cls, CONCEPTS.Interface$db)) {
        if (method.isDefaultMethod()) {
          SLinkOperations.addNewChild(SNodeOperations.cast(result, CONCEPTS.InstanceMethodDeclaration$39), LINKS.modifiers$F5MM, CONCEPTS.DefaultModifier$rO);
        }
        SLinkOperations.setTarget(SNodeOperations.cast(result, CONCEPTS.InstanceMethodDeclaration$39), LINKS.visibility$Yyua, _quotation_createNode_rbndtb_a0b0c0g0x());
      }

      if (method instanceof AnnotationMethodDeclaration) {
        SLinkOperations.setTarget(SNodeOperations.cast(result, CONCEPTS.AnnotationMethodDeclaration$4O), LINKS.defaultValue$85b5, convertExpression(((AnnotationMethodDeclaration) method).defaultValue));
      }
      convertMethodGuts((MethodDeclaration) method, clsStringId, result);

      if (attach) {
        ListSequence.fromList(SLinkOperations.getChildren(cls, LINKS.member$L_2d)).addElement(SNodeOperations.cast(result, CONCEPTS.ClassifierMember$At));
      }
      ...
      SLinkOperations.setTarget(result, LINKS.returnType$5xoi, _quotation_createNode_rbndtb_a0c0a6a32());

      convertMethodGuts(method, clsStringId, result);

      if (attach) {
        ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(cls, CONCEPTS.ClassConcept$bK), LINKS.member$L_2d)).addElement(SNodeOperations.cast(result, CONCEPTS.ConstructorDeclaration$yG));
      }
    }
  ...
  public SNode convertTypeVar(TypeParameter par) throws JavaParseException {
    ...
    SPropertyOperations.assign(tvar, PROPS.name$MnvL, new String(par.name));
    if (par.type != null) {
      SLinkOperations.setTarget(tvar, LINKS.bound$aZCB, convertTypeReference(par.type));
    }
    if (par.bounds != null) {
      for (TypeReference b : par.bounds) {
        ...
        if (SNodeOperations.isInstanceOf(typ, CONCEPTS.ClassifierType$bL)) {
          ...
          LOG.error("one of bounds of type var `" + SPropertyOperations.getString(tvar, PROPS.name$MnvL) + "' resolved not to a class name");
        }
      }
    }
    return tvar;
  ...
  public void convertAnnotations(Annotation[] annos, SNode result) throws JavaParseException {
    if (annos != null) {
      for (Annotation anno : annos) {
        SLinkOperations.getChildren(result, LINKS.annotation$K49I).add(convertAnnotation(anno));
      }
    }
  }
  ...
  public SNode convertAnnotation(Annotation anno) throws JavaParseException {
    ...
    for (MemberValuePair pair : anno.memberValuePairs()) {
      ...
      val.setReference(LINKS.key$bSmV, ResolveInfo.of(new String(pair.name)));
      SLinkOperations.setTarget(val, LINKS.value$Y7om, convertExpression(pair.value));
      ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.value$uK2B)).addElement(val);
    }
    return node;
  }
  ...
  private SNode convertMethodGuts(@NotNull AbstractMethodDeclaration x, @Nullable String idPrefix, @NotNull SNode result) throws JavaParseException {
    ...
    if (!(x instanceof ConstructorDeclaration)) {
      SPropertyOperations.assign(result, PROPS.name$MnvL, new String(x.selector));
      check_rbndtb_a1a5a53(idBuilder, result);
    }
    check_rbndtb_a6a53(idBuilder);

    {
      ...
      if (SNodeOperations.isInstanceOf(imd, CONCEPTS.InstanceMethodDeclaration$39)) {
        if (flagSet(x.modifiers, ClassFileConstants.AccAbstract)) {
          SPropertyOperations.assign(imd, PROPS.isAbstract$VtH_, true);
        }
      }
    }
    ...
    if (x.arguments != null) {
      for (Argument arg : x.arguments) {
        SNode par = convertParameter(arg, childConverter);
        ListSequence.fromList(SLinkOperations.getChildren(result, LINKS.parameter$5xBj)).addElement(par);

        check_rbndtb_a3a0a21a53(idBuilder, arg, this);
        check_rbndtb_a4a0a21a53(idBuilder);
      }
      // delete the last comma
      if (x.arguments.length > 0) {
        check_rbndtb_a0a2a21a53(idBuilder, idBuilder);
      }
    }
    check_rbndtb_a31a53(idBuilder);

    if (x.thrownExceptions != null) {
      for (TypeReference exc : x.thrownExceptions) {
        ListSequence.fromList(SLinkOperations.getChildren(result, LINKS.throwsItem$CdW$)).addElement(childConverter.convertTypeReference(exc));
      }
    }

    if (myOnlyStubs) {
      // make a different stub statement list 'source code' ?
      SLinkOperations.setTarget(result, LINKS.body$5xQk, _quotation_createNode_rbndtb_a0b0r0jb());
...

    {
      ...
      if (SNodeOperations.isInstanceOf(mem, CONCEPTS.ClassifierMember$At)) {
        if ((SLinkOperations.getTarget(mem, LINKS.visibility$Yyua) == null)) {
          SLinkOperations.setTarget(mem, LINKS.visibility$Yyua, convertVisibility(x.modifiers));
        }
      }
    }
  ...
  public SNode convertVisibility(int astModifiers) {
    return (flagSet(astModifiers, ClassFileConstants.AccPublic) ? _quotation_createNode_rbndtb_a0a0ub() : (flagSet(astModifiers, ClassFileConstants.AccProtected) ? _quotation_createNode_rbndtb_a0a0a64() : (flagSet(astModifiers, ClassFileConstants.AccPrivate) ? _quotation_createNode_rbndtb_a0a0a0ub() : null)));
  }
  ...
  protected SNode convertParameter(Argument arg, ASTConverter childConverter) throws JavaParseException {
    ...
    SPropertyOperations.assign(par, PROPS.name$MnvL, new String(arg.name));
    SLinkOperations.setTarget(par, LINKS.type$a1UY, childConverter.convertTypeReference(arg.type));
    SPropertyOperations.assign(par, PROPS.isFinal$gvTP, flagSet(arg.modifiers, ClassFileConstants.AccFinal));
  ...
  public SNode convertTypeRef(TypeReference typRef) {
    ...
    } else if (typRef instanceof UnionTypeReference) {
      return convertTypeRef((UnionTypeReference) typRef);
    } else {
      if (typRef != null) {
  ...
  public SNode convertTypeRef(UnionTypeReference typRef) {
    SNode result = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x70a99a0b674a3895L, "jetbrains.mps.baseLanguage.structure.AlternativeType"));
    for (int i = 0, c = typRef.typeReferences.length; i < c; ++i) {
      SNode catchVar = convertTypeRef(typRef.typeReferences[i]);
      ListSequence.fromList(SLinkOperations.getChildren(result, LINKS.alternative$IEPM)).addElement(catchVar);
    }
    return result;
  }
  ...
  public SNode tryConvertPrimitiveType(String typ) {
    if ("void".equals(typ)) {
      return _quotation_createNode_rbndtb_a0a0a06();
    } else if ("int".equals(typ)) {
      return _quotation_createNode_rbndtb_a0a0a0ic();
    } else if ("long".equals(typ)) {
      return _quotation_createNode_rbndtb_a0a1a0ic();
    } else if ("short".equals(typ)) {
      return _quotation_createNode_rbndtb_a0a2a0ic();
    } else if ("byte".equals(typ)) {
      return _quotation_createNode_rbndtb_a0a3a0ic();
    } else if ("float".equals(typ)) {
      return _quotation_createNode_rbndtb_a0a4a0ic();
    } else if ("double".equals(typ)) {
      return _quotation_createNode_rbndtb_a0a5a0ic();
    } else if ("boolean".equals(typ)) {
      return _quotation_createNode_rbndtb_a0a6a0ic();
    } else if ("char".equals(typ)) {
      return _quotation_createNode_rbndtb_a0a7a0ic();
    }
    return null;
  }
  ...
  public SNode convertTypeRef(Wildcard typRef) {
    ...
    switch (typRef.kind) {
      case Wildcard.UNBOUND:
        return _quotation_createNode_rbndtb_a0a0c0kc();

      case Wildcard.EXTENDS:
        SNode upperBound = convertTypeReference(typRef.bound);
        return _quotation_createNode_rbndtb_a1a1c0kc(upperBound);

      case Wildcard.SUPER:
        SNode lowerBound = convertTypeReference(typRef.bound);
        return _quotation_createNode_rbndtb_a1a2c0kc(lowerBound);
  ...
  protected SNode buildArrayType(SNode base, int dimensions, boolean vararg) {
    ...
    for (int i = 0; i < until; i++) {
      arrType = _quotation_createNode_rbndtb_a0a0e0oc(arrType);
    }
    ...
    if (vararg) {
      ...
      SLinkOperations.setTarget(varargType, LINKS.componentType$ypmi, arrType);
      arrType = varargType;
    }
  ...
  public SNode buildClassifierType(String typ, TypeReference typRef) {
    ...
    cls.setReference(LINKS.classifier$cxMr, ResolveInfo.of(typ));
    ...
    if (typeArgs != null) {
      for (TypeReference typArg : typeArgs) {
        ...
        if (argType != null) {
          ListSequence.fromList(SLinkOperations.getChildren(cls, LINKS.parameter$oqG$)).addElement(argType);
        }
      }
    }
  ...
  public SNode buildAnnotationInstance(String name) {
    ...
    anno.setReference(LINKS.annotation$12Ek, ResolveInfo.of(name));
    return anno;
  }
  ...
  private String getTypeName(SNode type) {
    if (SNodeOperations.isInstanceOf(type, CONCEPTS.PrimitiveType$sR)) {
      return SConceptOperations.conceptAlias(SNodeOperations.getConcept(SNodeOperations.cast(type, CONCEPTS.PrimitiveType$sR)));
    } else if (SNodeOperations.isInstanceOf(type, CONCEPTS.ClassifierType$bL)) {
      return SPropertyOperations.getString(SLinkOperations.getTarget(SNodeOperations.cast(type, CONCEPTS.ClassifierType$bL), LINKS.classifier$cxMr), PROPS.name$MnvL);
    } else if (SNodeOperations.isInstanceOf(type, CONCEPTS.TypeVariableReference$WL)) {
      return "Tv:" + SPropertyOperations.getString(SLinkOperations.getTarget(SNodeOperations.cast(type, CONCEPTS.TypeVariableReference$WL), LINKS.typeVariableDeclaration$Lz1I), PROPS.name$MnvL);
    } else {
      return "unk";
    }
  }
  ...
  public SNode convertExpression(Expression x) throws JavaParseException {
    ...
    return _quotation_createNode_rbndtb_a1a48();
  }
  ...
  /*package*/ SNode convertConstant(BooleanConstant x, String source) {
    ...
    SPropertyOperations.assign(result, PROPS.value$5y_M, x.booleanValue());
    return result;
  }
  ...
  /*package*/ SNode convertConstant(ByteConstant x, String source) {
    ...
    SPropertyOperations.assign(result, PROPS.value$jgCM, x.byteValue());
    return result;
  }
  ...
  /*package*/ SNode convertConstant(CharConstant x, String source) {
    ...
    SPropertyOperations.assign(result, PROPS.charConstant$DOTs, sb.toString());
    return result;
  }
  ...
  /*package*/ SNode convertConstant(DoubleConstant x, String source) {
    ...
    SPropertyOperations.assign(result, PROPS.value$ENN8, x.doubleValue() + "");
    return result;
  }
  ...
  /*package*/ SNode convertConstant(FloatConstant x, String source) {
    ...
    SPropertyOperations.assign(result, PROPS.value$kirj, x.floatValue() + "f");
    return result;
  }
  ...
  /*package*/ SNode convertConstant(IntConstant x, String source) {
    ...
    if (hex) {
      ...
      SPropertyOperations.assign(hexLit, PROPS.value$JSvS, source.substring(2));
      return hexLit;
    } else {
      ...
      SPropertyOperations.assign(cnst, PROPS.value$jgCM, x.intValue());
      return cnst;
    }
  }
  ...
  /*package*/ SNode convertConstant(LongConstant x, String source) {
    ...
    SPropertyOperations.assign(result, PROPS.value$b84M, x.longValue() + "L");
    return result;
  }

  /*package*/ SNode convertConstant(ShortConstant x, String source) {
    SNode result = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc59b314L, "jetbrains.mps.baseLanguage.structure.IntegerConstant"));
    SPropertyOperations.assign(result, PROPS.value$jgCM, x.shortValue());
    return result;
  }
  ...
  /*package*/ SNode convertConstant(StringConstant x, String source) {
    ...
    SPropertyOperations.assign(result, PROPS.value$w7MM, sb.toString());
    return result;
  }
  ...
  private static SNode createPublicVisibility_rbndtb_a0a1a1a0a2a61a31() {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.PublicVisibility$R0);
    return n0.getResult();
  }
  private static SNode _quotation_createNode_rbndtb_a0b0c0g0x() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0x10af9581ff1L, "PublicVisibility"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_rbndtb_a0c0a6a32() {
    SNode quotedNode_1 = null;
  ...
  private static StringBuilder check_rbndtb_a1a5a53(StringBuilder checkedDotOperand, SNode result) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.append("." + new String(SPropertyOperations.getString(result, PROPS.name$MnvL)));
    }
    return null;
  }
  private static StringBuilder check_rbndtb_a6a53(StringBuilder checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.append("(");
    }
    return null;
  }
  private static StringBuilder check_rbndtb_a3a0a21a53(StringBuilder checkedDotOperand, Argument arg, ASTConverter checkedDotThisExpression) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.append(checkedDotThisExpression.typeReferenceId(arg.type));
    }
    return null;
  }
  private static StringBuilder check_rbndtb_a4a0a21a53(StringBuilder checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.append(",");
    }
    return null;
  }
  private static StringBuilder check_rbndtb_a0a2a21a53(StringBuilder checkedDotOperand, StringBuilder idBuilder) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.deleteCharAt(check_rbndtb_a0a0a0c0m0jb(idBuilder) - 1);
    }
    return null;
  }
  private static int check_rbndtb_a0a0a0c0m0jb(StringBuilder checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.length();
    }
    return 0;
  }
  private static StringBuilder check_rbndtb_a31a53(StringBuilder checkedDotOperand) {
    if (null != checkedDotOperand) {
      return checkedDotOperand.append(")");
    }
    return null;
  }
  private static SNode _quotation_createNode_rbndtb_a0b0r0jb() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0x4975dc2bdcfa0c49L, "StubStatementList"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_rbndtb_a0a0ub() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0x10af9581ff1L, "PublicVisibility"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_rbndtb_a0a0a64() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0x10af958b686L, "ProtectedVisibility"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_rbndtb_a0a0a0ub() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0x10af9586f0cL, "PrivateVisibility"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_rbndtb_a0a0a06() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf8cc6bf96dL, "VoidType"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_rbndtb_a0a0a0ic() {
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_rbndtb_a0a1a0ic() {
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_rbndtb_a0a2a0ic() {
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_rbndtb_a0a3a0ic() {
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_rbndtb_a0a4a0ic() {
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_rbndtb_a0a5a0ic() {
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_rbndtb_a0a6a0ic() {
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_rbndtb_a0a7a0ic() {
    SNode quotedNode_1 = null;
  ...
  private static SNode _quotation_createNode_rbndtb_a0a0c0kc() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0x110dae5f4a3L, "WildCardType"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
  }
  private static SNode _quotation_createNode_rbndtb_a1a1c0kc(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_rbndtb_a1a2c0kc(Object parameter_1) {
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
  ...
  private static SNode _quotation_createNode_rbndtb_a0a0e0oc(Object parameter_1) {
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
  ...
  private static SNode _quotation_createNode_rbndtb_a1a48() {
    SNode quotedNode_1 = null;
    ...
    quotedNode_1 = nb.getResult();
    nb.setProperty(MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf93d565d10L, 0xf93d565d11L, "value"), "NO EXPR IN STUBS");
    return quotedNode_1;
  }
