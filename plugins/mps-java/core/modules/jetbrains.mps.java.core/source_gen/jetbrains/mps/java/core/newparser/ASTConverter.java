...
public class ASTConverter {
    ...
    if (method instanceof MethodDeclaration) {
      ...
      if (SNodeOperations.isInstanceOf(result, CONCEPTS.InstanceMethodDeclaration$39) && SNodeOperations.isInstanceOf(cls, CONCEPTS.Interface$db)) {
        if (method.isDefaultMethod()) {
          SLinkOperations.addNewChild(SNodeOperations.cast(result, CONCEPTS.InstanceMethodDeclaration$39), LINKS.modifiers$F5MM, CONCEPTS.DefaultModifier$PN);
        }
  ...
  private static SNode createPublicVisibility_rbndtb_a0a1a1a0a2a61a01() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.PublicVisibility$R0);
