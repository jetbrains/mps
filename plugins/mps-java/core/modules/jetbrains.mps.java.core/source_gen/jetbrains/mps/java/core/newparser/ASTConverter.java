...
public class ASTConverter {
  ...
  public SNode convertTypeDecl(TypeDeclaration x) throws JavaParseException {
    ...
    if (x.javadoc != null) {
      AttributeOperations.createAndSetAttrbiute(cls, new IAttributeDescriptor.NodeAttribute(CONCEPTS.ClassifierDocComment$mh), CONCEPTS.ClassifierDocComment$mh);
  ...
  private SNode convertMethod(SNode cls, AbstractMethodDeclaration method, boolean attach) throws JavaParseException {
    ...
    if (method instanceof MethodDeclaration) {
      ...
      if (SNodeOperations.isInstanceOf(result, CONCEPTS.InstanceMethodDeclaration$39) && SNodeOperations.isInstanceOf(cls, CONCEPTS.Interface$db)) {
        ...
        SLinkOperations.setTarget(SNodeOperations.cast(result, CONCEPTS.InstanceMethodDeclaration$39), LINKS.visibility$Yyua, _quotation_createNode_rbndtb_a0b0c0g0u());
      }
      ...
      SLinkOperations.setTarget(result, LINKS.returnType$5xoi, _quotation_createNode_rbndtb_a0c0a6a02());
    ...
    if (method.javadoc != null) {
      AttributeOperations.createAndSetAttrbiute(result, new IAttributeDescriptor.NodeAttribute(CONCEPTS.MethodDocComment$HI), CONCEPTS.MethodDocComment$HI);
  ...
  public SNode convertAnnotation(Annotation anno) throws JavaParseException {
    ...
    for (MemberValuePair pair : anno.memberValuePairs()) {
      ...
      SReference ref = new DynamicReference(LINKS.key$bSmV, val, null, new String(pair.name));
  ...
  public SNode buildClassifierType(String typ, TypeReference typRef) {
    ...
    SReference ref = new DynamicReference(LINKS.classifier$cxMr, cls, null, typ);
    cls.setReference(LINKS.classifier$cxMr, ref);
  ...
  public SNode buildAnnotationInstance(String name) {
    ...
    SReference ref = new DynamicReference(LINKS.annotation$12Ek, anno, null, name);
    anno.setReference(LINKS.annotation$12Ek, ref);
    return anno;
  }
  ...
  public String getTypeName(SNode type) {
    if (SNodeOperations.isInstanceOf(type, CONCEPTS.PrimitiveType$sR)) {
      ...
      if (SNodeOperations.cast(type, CONCEPTS.ClassifierType$bL).getReference(LINKS.classifier$cxMr) instanceof DynamicReference) {
        DynamicReference dynRef = (DynamicReference) SNodeOperations.cast(type, CONCEPTS.ClassifierType$bL).getReference(LINKS.classifier$cxMr);
  ...
  protected static class State {
    ...
    protected SNode resolveTypeVar(String name) {
      ...
      if (myTypeVars == null || !(MapSequence.fromMap(myTypeVars).containsKey(name))) {
        ...
        if (typeVar != null) {
          ref = new StaticReference(LINKS.typeVariableDeclaration$Lz1I, typeVarRef, typeVar);
        } else {
          ref = new DynamicReference(LINKS.typeVariableDeclaration$Lz1I, typeVarRef, null, name);
        }
