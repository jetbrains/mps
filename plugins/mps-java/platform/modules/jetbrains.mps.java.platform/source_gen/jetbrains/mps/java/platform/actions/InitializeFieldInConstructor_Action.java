...
public class InitializeFieldInConstructor_Action extends BaseAction {
  ...
  public InitializeFieldInConstructor_Action() {
    super("Initialize in Constructor", "Initialize a field in a constructor", ICON);
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    ...
    return new InitializeFieldInConstructorRefactoring().isApplicable(field);
  }
  @Override
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ...
    if (Sequence.fromIterable(constructors).isEmpty()) {
      ...
      for (SNodeReference element : selectedElements) {
