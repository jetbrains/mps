...
@GeneratedClass(node = "r:147fb550-8026-46fe-830c-81449036a4c3(jetbrains.mps.java.workbench.actions)/6812098398776640299", model = "r:147fb550-8026-46fe-830c-81449036a4c3(jetbrains.mps.java.workbench.actions)")
public class ChangeMethodSignature_Action extends BaseAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    return RefactoringAccess.getInstance().isApplicable("jetbrains.mps.baseLanguage.refactorings.ChangeMethodSignature", ((SNode) MapSequence.fromMap(_params).get("method")));
  }
  @Override
