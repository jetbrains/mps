...
public class NewModelFromSource_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ...
    ApplicationManager.getApplication().runWriteAction(() -> ((MPSProject) MapSequence.fromMap(_params).get("project")).getRepository().getModelAccess().runWriteAction(() -> parser.saveAll()));
