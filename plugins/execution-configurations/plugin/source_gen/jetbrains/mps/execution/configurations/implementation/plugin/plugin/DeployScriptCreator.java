...
public class DeployScriptCreator {
  public static SNode createDeployScript(final Project project, List<SNodeReference> plugins, File baseDir) {
    ...
    SPropertyOperations.set(deployProject, MetaAdapterFactory.getProperty(0x798100da4f0a421aL, 0xb99171f8c50ce5d2L, 0x4df58c6f18f84a13L, 0x48387ebae1a07a23L, "internalBaseDirectory"), makeRelative(ideaProject.getBasePath(), baseDir.getAbsolutePath()));
