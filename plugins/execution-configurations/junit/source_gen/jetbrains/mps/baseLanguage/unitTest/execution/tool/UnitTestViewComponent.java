...
public class UnitTestViewComponent extends JPanel implements Disposable {
  ...
  public void addNotify() {
    super.addNotify();
    // progresslinegoesuntilthetextoutputbarwithactions
  ...
  /*package*/ class MyTreePanel extends JPanel implements DataProvider {
    ...
    public Object getData(@NonNls String dataId) {
      ...
      if (MPSDataKeys.NODE.is(dataId)) {
        ...
        // XXXit'sunclearwhetherweshallassumemodelreadlockhere,orobtainitourselves
        // Ididn'tgetthelockhereasit'sstupidtoaskforSNodenotinsidealockalready.
