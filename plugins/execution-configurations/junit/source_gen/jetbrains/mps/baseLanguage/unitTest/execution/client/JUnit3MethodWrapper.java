...
public class JUnit3MethodWrapper extends AbstractTestWrapper<SNode> {
  ...
  public JUnit3MethodWrapper(@NotNull ITestNodeWrapper testCase, SNode method) {
    super(method, false, AbstractTestWrapper.isAnnotatedToLaunch(method) || AbstractTestWrapper.needsMPS(SNodeOperations.getNodeAncestor(method, CONCEPTS.ClassConcept$bK, false, false)), true);
    myTestCase = testCase;
