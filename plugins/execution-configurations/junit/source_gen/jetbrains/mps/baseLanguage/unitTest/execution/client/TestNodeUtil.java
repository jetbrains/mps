...
/*package*/ class TestNodeUtil {
  ...
  /*package*/ static boolean isTestMethod(@NotNull SNode method) {
  ...
  /*package*/ static boolean isJUnit4TestMethod(SNode method) {
  ...
  /*package*/ static boolean isJUnit4TestCase(SNode clazz) {
  ...
  /*package*/ static boolean isJUnit5TestMethod(SNode method) {
  ...
  /*package*/ static boolean isJUnit5TestCase(SNode clazz) {
    if (SPropertyOperations.getBoolean(SNodeOperations.cast(clazz, CONCEPTS.ClassConcept$bK), PROPS.abstractClass$Ta1X)) {
      return false;
    }
    for (SNode method : Sequence.fromIterable(Classifier__BehaviorDescriptor.methods_id4_LVZ3pBKCn.invoke(clazz))) {
