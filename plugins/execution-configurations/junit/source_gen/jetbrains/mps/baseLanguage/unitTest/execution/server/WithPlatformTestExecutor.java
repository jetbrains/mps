...
public class WithPlatformTestExecutor extends DefaultTestExecutor {
  ...
  protected void executeWithJUnit5(List<DiscoverySelector> selectors) {
    ((JUnit5ScriptTestContributor) this.myTestContributor).initExtensions();
    super.executeWithJUnit5(selectors);
  }
  ...
  public static void main(String[] args) throws Exception {
    ...
    TestsContributor contributor = (compatibilityMode ? new ScriptTestContributor(env, execScript) : new JUnit5ScriptTestContributor(env, execScript));
