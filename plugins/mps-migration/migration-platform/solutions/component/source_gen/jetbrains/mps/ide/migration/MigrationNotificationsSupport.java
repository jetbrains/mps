...
/*package*/ abstract class MigrationNotificationsSupport {
  ...
  private static final NotificationGroup NOTIFICATION_GROUP = new NotificationGroup("Migration", NotificationDisplayType.STICKY_BALLOON, true);
  ...
  public boolean showRequired() {
    ...
    myLastNotification = new Notification(NOTIFICATION_GROUP.getDisplayId(), "Migration required", "<p>This project requires migration.</p><p><a href=\"" + REF_RUN_MIGRATION + "\">Migrate</a></p>", NotificationType.INFORMATION, new NotificationListener() {
      @Override
