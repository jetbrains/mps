...
public class PostCheckError extends MigrationError {
  ...
  private Iterable<AppliedScript> myMigrationsToCheck;
  private MigrationChecker myChecker;

  public PostCheckError(Project p, Iterable<AppliedScript> migrationsToCheck, boolean haveBadCode, MigrationChecker checker) {
