...
public class Refactorings_TabDescriptor extends RelationDescriptor {
  ...
  protected SNode doCreateAspect(final CreateAspectContext _context) {
    return ConceptAspectsHelper.attachNewConceptAspect(LanguageAspect.REFACTORINGS, _context.getBaseNode(), SNodeFactoryOperations.createNewNode(((SAbstractConcept) _context.getAspectConcept()), null));
  }
