...
public class Intentions_TabDescriptor extends RelationDescriptor {
  ...
  protected SNode doCreateAspect(final CreateAspectContext _context) {
    return ConceptAspectsHelper.attachNewConceptAspect(LanguageAspect.INTENTIONS, _context.getBaseNode(), SNodeFactoryOperations.createNewNode(((SAbstractConcept) _context.getAspectConcept()), null));
  }
