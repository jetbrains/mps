...
public class Find_Usages_TabDescriptor extends RelationDescriptor {
  ...
  protected SNode doCreateAspect(final CreateAspectContext _context) {
    return ConceptAspectsHelper.attachNewConceptAspect(LanguageAspect.FIND_USAGES, _context.getBaseNode(), SNodeFactoryOperations.createNewNode(((SAbstractConcept) _context.getAspectConcept()), null));
  }
