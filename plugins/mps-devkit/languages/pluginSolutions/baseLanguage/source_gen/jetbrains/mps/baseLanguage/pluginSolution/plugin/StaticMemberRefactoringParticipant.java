...
public abstract class StaticMemberRefactoringParticipant extends UpdateReferencesParticipantBase<UpdateReferencesParticipantBase.NamedNodeReference> {
  ...
  private static SNode createClassifierMemberData_io42ml_a0a5(SNode node0, SNode node1) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ClassifierMemberData$O5);
    rootBuilder1.forChild(LINKS.nodeData$_zS_).initNode(node0, CONCEPTS.ReflectionNodeReference$cY, true);
    rootBuilder1.forChild(LINKS.classifierData$_$mB).initNode(node1, CONCEPTS.ReflectionNodeReference$cY, true);
