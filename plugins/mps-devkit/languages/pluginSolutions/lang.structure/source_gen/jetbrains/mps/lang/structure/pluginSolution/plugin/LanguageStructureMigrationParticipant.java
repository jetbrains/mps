...
public class LanguageStructureMigrationParticipant<I, F> extends RefactoringParticipantBase<SNodeReference, SNodeReference, SNode, SNode> implements MoveNodeRefactoringParticipant<SNodeReference, SNodeReference> {
  ...
  public static class MigrationBuilder {
    ...
    private static SNode createPureMigrationScript_kz6lmo_a0d0d01(Object p0, Object p1) {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.PureMigrationScript$hG);
      rootBuilder1.setProperty(PROPS.fromVersion$hHKK, PROPS.fromVersion$hHKK.getType().toString(p0));
    ...
    private static SNode createMoveNodeMigrationPart_kz6lmo_a0a0e01(SNode node0, SNode node1, SNode node2) {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.MoveNodeMigrationPart$zn);
      rootBuilder1.forChild(LINKS.fromNode$UG1d).initNode(node0, CONCEPTS.AbstractNodeReference$bQ, true);
      rootBuilder1.forChild(LINKS.toNode$UGvf).initNode(node1, CONCEPTS.AbstractNodeReference$bQ, true);
      {
        SNodeBuilder n2 = rootBuilder1.forChild(LINKS.specialization$dM5g).initNode(node2, CONCEPTS.MoveNodeSpecialization$AM, false);
      }
      return rootBuilder1.getResult();
    }
  }
