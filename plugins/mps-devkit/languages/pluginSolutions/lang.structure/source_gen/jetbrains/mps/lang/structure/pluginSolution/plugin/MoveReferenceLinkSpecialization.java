...
public class MoveReferenceLinkSpecialization extends MoveConceptMemberSpecialization<SReferenceLink> {
  ...
  public void confirm(List<RefactoringParticipant.Option> selectedOptions, SNodeReference initialState, SNodeReference finalState, SRepository repository, LanguageStructureMigrationParticipant.MigrationBuilder migrationBuilder, boolean updateModuleDependencies) {
    ...
    AttributeOperations.setAttribute(from, new IAttributeDescriptor.NodeAttribute(CONCEPTS.DeprecatedNodeAnnotation$zV), createDeprecatedNodeAnnotation_w90w7j_a0e0d("The link was moved to concept \"" + INamedConcept__BehaviorDescriptor.getFqName_idhEwIO9y.invoke(targetConcept) + "\""));
  ...
  private static SNode createMoveReferenceLink_w90w7j_c0a21a3(SNode p0, SNode p1) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.MoveReferenceLink$ix);
    n0.forChild(LINKS.sourceId$YVlh).initNode(p0, CONCEPTS.ReferenceLinkId$JG, true);
    n0.forChild(LINKS.targetId$YV$i).initNode(p1, CONCEPTS.ReferenceLinkId$JG, true);
    return n0.getResult();
  }
