...
public class MovePropertySpecialization extends MoveConceptMemberSpecialization<SProperty> {
  ...
  private static SNode createMoveProperty_fubpxk_c0a11a3(SNode p0, SNode p1) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.MoveProperty$jv);
    n0.forChild(LINKS.sourceId$YPuQ).initNode(p0, CONCEPTS.PropertyId$JK, true);
    n0.forChild(LINKS.targetId$YPHR).initNode(p1, CONCEPTS.PropertyId$JK, true);
    return n0.getResult();
  }
