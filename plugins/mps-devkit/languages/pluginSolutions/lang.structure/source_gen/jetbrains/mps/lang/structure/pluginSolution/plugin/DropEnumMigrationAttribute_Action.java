...
public class DropEnumMigrationAttribute_Action extends BaseAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    ...
    return (new IAttributeDescriptor.NodeAttribute(CONCEPTS.EnumMigrationInfo$S$).get(SNodeOperations.getNodeAncestor(node, CONCEPTS.EnumerationDeclaration$hv, true, false)) != null);
  }
  @Override
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ...
    SNode migrationInfoAttribute = new IAttributeDescriptor.NodeAttribute(CONCEPTS.EnumMigrationInfo$S$).get(enumm);
  ...
  public boolean nodeCondition(SNode parameter) {
    ...
    return (new IAttributeDescriptor.NodeAttribute(CONCEPTS.EnumMigrationInfo$S$).get(enumDecl) != null);
  }
