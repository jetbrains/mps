...
public class NewTemplateInRootMappingRoot_Action extends BaseAction {
  private static final Icon ICON = null;

  public NewTemplateInRootMappingRoot_Action() {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    return SLinkOperations.getTarget(event.getData(MPSCommonDataKeys.NODE), LINKS.template$n_Qy) == null;
  }
  @Override
  ...
  protected boolean collectActionData(AnActionEvent event, final Map<String, Object> _params) {
    ...
    }
    {
      ...
      if (node != null && !(SNodeOperations.isInstanceOf(node, CONCEPTS.Root_MappingRule$NH))) {
        node = null;
      }
      if (node == null) {
        return false;
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ...
    if (name.value == null || name.value.length() == 0) {
      name.value = "map_" + SPropertyOperations.getString(SLinkOperations.getTarget(rule, LINKS.applicableConcept$Hpnk), PROPS.name$MnvL);
    }
