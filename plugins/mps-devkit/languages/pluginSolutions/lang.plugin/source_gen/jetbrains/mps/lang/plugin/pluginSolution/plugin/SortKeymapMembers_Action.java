...
public class SortKeymapMembers_Action extends BaseAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    return RefactoringAccess.getInstance(((MPSProject) MapSequence.fromMap(_params).get("project"))).isApplicable("jetbrains.mps.lang.plugin.refactorings.SortKeymapMembers", ((SNode) MapSequence.fromMap(_params).get("target")));
  }
  @Override
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    ...
    repository.getModelAccess().runReadInEDT(new Runnable() {
      ...
      public void run() {
        ...
        RefactoringAccess.getInstance(((MPSProject) MapSequence.fromMap(_params).get("project"))).getRefactoringFacade().execute(RefactoringContext.createRefactoringContextByName("jetbrains.mps.lang.plugin.refactorings.SortKeymapMembers", Arrays.asList(), Arrays.asList(), ((SNode) MapSequence.fromMap(_params).get("target")), ((MPSProject) MapSequence.fromMap(_params).get("project"))));
      }
    });
