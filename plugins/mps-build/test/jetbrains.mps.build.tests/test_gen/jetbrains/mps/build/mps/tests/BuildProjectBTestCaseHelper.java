...
public final class BuildProjectBTestCaseHelper {
  ...
  public SNode createLang(String name) {
    ...
    SPropertyOperations.assign(lang, PROPS.name$MnvL, name);
    ListSequence.fromList(SLinkOperations.getChildren(myProject, LINKS.parts$mGDj)).addElement(lang);
    return lang;
  }
  ...
  public SNode createSolution(String name) {
    ...
    SPropertyOperations.assign(sln, PROPS.name$MnvL, name);
    ListSequence.fromList(SLinkOperations.getChildren(myProject, LINKS.parts$mGDj)).addElement(sln);
    return sln;
  }
  ...
  public SNode createDevkit(String name) {
    ...
    SPropertyOperations.assign(devkit, PROPS.name$MnvL, name);
    ListSequence.fromList(SLinkOperations.getChildren(myProject, LINKS.parts$mGDj)).addElement(devkit);
    return devkit;
  }
