...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.asm.tools.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.automaton.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.blockmap.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.bouncy.castle.pgp.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.bouncy.castle.provider.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.classgraph.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.cli.parser.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.commons.cli.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.commons.codec.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.commons.compress.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.commons.imaging.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.commons.io.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.commons.lang3.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.commons.logging.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.hdr.histogram.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.http.client.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.icu4j.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.imgscalr.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.ini4j.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jackson.dataformat.yaml.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.java.websocket.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.javax.annotation.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jaxen.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jbr.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jcef.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jcip.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jediterm.core.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jediterm.ui.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jettison.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jsonpath.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jsoup.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jsvg.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jvm.native.trusted.roots.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.jzlib.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.kotlin.reflect.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.kotlinx.collections.immutable.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.kotlinx.coroutines.slf4j.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.kotlinx.datetime.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.kotlinx.html.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.kotlinx.serialization.protobuf.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.kryo5.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.markdown.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.oro.matcher.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.proxy.vole.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.pty4j.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.rd.text.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.rhino.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.snakeyaml.engine.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.snakeyaml.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.sshj.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.stream.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.velocity.jar"
...
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.xstream.jar"
CLASSPATH="$CLASSPATH:$IDE_HOME/lib/module-intellij.libraries.xtext.xbase.jar"
