...
public final class MPSTipsAndTricks_Text__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    ...
    SPropertyOperations.assign(elem, PROPS.tagName$ZoHR, "p");
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.element$Z3cS)).addElement(elem);
    SPropertyOperations.assign(__thisNode__, PROPS.language$YhsR, "");
  }
