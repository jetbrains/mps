...
public final class MPSTipsAndTricks_Image__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isValid_idIb_Fk7zRKP = new SMethodBuilder<>(Boolean.TYPE).name("isValid").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(831924260440079413L).languageId(0x804f8987b652fceaL, 0xfeee615f9f2b486fL).build2();
