...
public class BuildMps_GeneratorRef_SubstituteMenu extends SubstituteMenuBase {
  public BuildMps_GeneratorRef_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for BuildMps_GeneratorRef. Generated from implicit smart reference attribute.", new SNodePointer("r:0353b795-df17-4050-9687-ee47eeb7094f(jetbrains.mps.build.mps.structure)", "7862711839422606209")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_1y4yql_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_1y4yql_a() {
      super(CONCEPTS.BuildMps_GeneratorRef$aa, LINKS.generator$98gH, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_1y4yql_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_1y4yql_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "BuildMps_GeneratorRef", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.BuildMps_GeneratorRef$aa);
    }
