...
public final class BuildMPSPlugin__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static final SMethod<Void> fetchGenerationDeps_id3WZD5LHqDLU = new SMethodBuilder<>(Void.TYPE).name("fetchGenerationDeps").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(4557542064801881210L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(VisibleArtifacts.class, "artifacts"), SMethodBuilder.createJavaParameter(RequiredDependenciesBuilder.class, "builder"));
  /*package*/ static final SMethod<Void> addPluginsRequiredForGenerationToDepBuilder_id5VKiljnaBi = new SMethodBuilder<>(Void.TYPE).name("addPluginsRequiredForGenerationToDepBuilder").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(106891382229871058L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(RequiredDependenciesBuilder.class, "builder"), SMethodBuilder.createJavaParameter((Class<Iterable<SNode>>) ((Class) Object.class), "allRequiredModules"), SMethodBuilder.createJavaParameter(VisibleArtifacts.class, "artifacts"));
  /*package*/ static final SMethod<Boolean> areLocatedInTheSameRoot_id5eGY5T7x8$N = new SMethodBuilder<>(Boolean.TYPE).name("areLocatedInTheSameRoot").modifiers(1, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(6029467084952734003L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(SNode.class, "first"), SMethodBuilder.createJavaParameter(SNode.class, "second"));
