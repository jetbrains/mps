...
public class BuildMps_IdeaPluginModule_SmartReference extends SubstituteMenuBase {
  public BuildMps_IdeaPluginModule_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "BuildMps_IdeaPluginModule_SmartReference", new SNodePointer("r:589e3942-2f2d-42a2-9312-986a1d3e2f7f(jetbrains.mps.build.mps.editor)", "4747359941571311762")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_wbo7rb_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_wbo7rb_a() {
      super(CONCEPTS.BuildMps_IdeaPluginModule$rY, LINKS.target$ccfo, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:589e3942-2f2d-42a2-9312-986a1d3e2f7f(jetbrains.mps.build.mps.editor)", "4747359941571311760")));
    }
