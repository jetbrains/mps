...
public class addModuleResources_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    SNode buildModule = SNodeOperations.as(node, CONCEPTS.BuildMps_Module$JW);
    SNode bif = SLinkOperations.setNewChild(SLinkOperations.addNewChild(buildModule, LINKS.sources$mT1j, CONCEPTS.BuildMps_ModuleResources$M6), LINKS.files$uRjo, null);
    SLinkOperations.setTarget(bif, LINKS.dir$e6r$, BuildSourcePath__BehaviorDescriptor.getParent_id7wpYgMyTXsR.invoke(SLinkOperations.getTarget(buildModule, LINKS.path$iYKB)));
    SPropertyOperations.set(SLinkOperations.addNewChild(bif, LINKS.selectors$hp_C, CONCEPTS.BuildFileIncludesSelector$kb), PROPS.pattern$u5_$, "icons/**, resources/**");
  }
