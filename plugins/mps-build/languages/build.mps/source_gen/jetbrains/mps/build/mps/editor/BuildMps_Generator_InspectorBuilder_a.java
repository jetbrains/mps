...
/*package*/ class BuildMps_Generator_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_leuqor_0");
  ...
  private EditorCell createCollection_1() {
    ...
    editorCell.setCellId("Collection_leuqor_1");
  ...
  private EditorCell createCollection_2() {
    ...
    editorCell.setCellId("Collection_leuqor_2");
    Style style = new StyleImpl();
    style.set(StyleAttributes.SELECTABLE, false);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_leuqor_0");
    Style style = new StyleImpl();
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.uuid$pC01;
  ...
  private EditorCell createCollection_3() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Indent());
    editorCell.setCellId("Collection_leuqor_3");
    Style style = new StyleImpl();
  ...
  private boolean nodeCondition_leuqor_a1b0a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.withKotlin$2YBL);
  }
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_leuqor_1");
    Style style = new StyleImpl();
    new keywordStyleClass(this).apply(style, editorCell);
    editorCell.getStyle().putAll(style);
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.BuildMps_Module$JW, "jetbrains.mps.build.mps.editor.add_moduleLocationAndFlags_BuildMps_Module_ext_4"));
    editorCell.setDefaultText("");
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setCellId("withKotlin");
    Style style = new StyleImpl();
    new jetbrains.mps.build.editor.buildStyles_StyleSheet.keywordStyleClass(this).apply(style, editorCell);
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    editorCell.getStyle().putAll(style);
    delete_withKotlin.setCellActions(editorCell, myNode, getEditorContext());
    editorCell.setDefaultText("");
    return editorCell;
  }
  ...
  private EditorCell createCollection_4() {
    EditorCell_Collection editorCell = new EditorCell_Collection(getEditorContext(), myNode, new CellLayout_Horizontal());
    editorCell.setCellId("Collection_leuqor_4");
    Style style = new StyleImpl();
    style.set(StyleAttributes.INDENT_LAYOUT_INDENT, true);
    style.set(StyleAttributes.INDENT_LAYOUT_ON_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createConstant_4() {
    ...
    editorCell.setCellId("Constant_leuqor_2");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.javaCode$OceX;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no javaCode>");
      editorCell.setCellId("property_javaCode");
      editorCell.setSubstituteInfo(new SPropertySubstituteInfo(editorCell, property));
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(new IAttributeDescriptor.AllAttributes().list(myNode), CONCEPTS.PropertyAttribute$Gb);
      Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where((it) -> Objects.equals(PropertyAttribute__BehaviorDescriptor.getProperty_id1avfQ4BBzOo.invoke(it), property));
  ...
  private EditorCell createConstant_5() {
    ...
    editorCell.setCellId("Constant_leuqor_3");
    Style style = new StyleImpl();
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new sourcesListHandler_leuqor_e1a0(myNode, getEditorContext());
  ...
  private static class sourcesListHandler_leuqor_e1a0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public sourcesListHandler_leuqor_e1a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.sources$mT1j;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.BuildMps_ModuleSource$J2;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(sourcesListHandler_leuqor_e1a0.this.getNode(), LINKS.sources$mT1j));
      try {
    ...
    private EditorCell createConstant_6() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_leuqor_4");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_7() {
    ...
    editorCell.setCellId("Constant_leuqor_5");
    Style style = new StyleImpl();
    new keywordStyleClass(this).apply(style, editorCell);
    style.set(StyleAttributes.INDENT_LAYOUT_NEW_LINE, true);
    editorCell.getStyle().putAll(style);
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new dependenciesListHandler_leuqor_g1a0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class dependenciesListHandler_leuqor_g1a0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public dependenciesListHandler_leuqor_g1a0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public SContainmentLink getSLink() {
      return LINKS.dependencies$j8Lj;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.BuildMps_ModuleDependency$Zx;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(dependenciesListHandler_leuqor_g1a0.this.getNode(), LINKS.dependencies$j8Lj));
      try {
        EditorCell emptyCell = null;
    ...
    private EditorCell createConstant_8() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_leuqor_6");
      Style style = new StyleImpl();
      style.set(StyleAttributes.EDITABLE, true);
      editorCell.getStyle().putAll(style);
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept BuildMps_ModuleDependency$Zx = MetaAdapterFactory.getConcept(0xcf935df46994e9cL, 0xa132fa109541cba3L, 0x48e82d5083341cb7L, "jetbrains.mps.build.mps.structure.BuildMps_ModuleDependency");
  }
