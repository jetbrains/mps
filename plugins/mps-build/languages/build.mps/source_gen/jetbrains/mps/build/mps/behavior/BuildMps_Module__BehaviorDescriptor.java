...
public final class BuildMps_Module__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isCompilable_id6tOCIA6_7jg = new SMethodBuilder<>(Boolean.TYPE).name("isCompilable").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7454762407073969360L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2();
  public static final SMethod<Iterable<SNode>> getDependenciesUnwrapped_id3QtfwKhgryb = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("getDependenciesUnwrapped").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4439773029207226507L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2();
  ...
  /*package*/ static final SMethod<Boolean> addJarPath_id3WZD5LHqnU8 = new SMethodBuilder<>(Boolean.TYPE).name("addJarPath").modifiers(1, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(4557542064801808008L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(SNode.class, "path"), SMethodBuilder.createJavaParameter(VisibleArtifacts.class, "artifacts"), SMethodBuilder.createJavaParameter(RequiredDependenciesBuilder.class, "builder"));
  /*package*/ static final SMethod<Iterable<SNode>> getJarDeps_id3WZD5LHqufx = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("getJarDeps").modifiers(1, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(4557542064801833953L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(SNode.class, "module"));
  /*package*/ static final SMethod<Boolean> areLocatedInTheSameRoot_id3ZROizBPX9c = new SMethodBuilder<>(Boolean.TYPE).name("areLocatedInTheSameRoot").modifiers(1, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(4609382717255569996L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(SNode.class, "first"), SMethodBuilder.createJavaParameter(SNode.class, "second"));
  /*package*/ static final SMethod<Boolean> fetchJavaDeps_id3WZD5LHqUHY = new SMethodBuilder<>(Boolean.TYPE).name("fetchJavaDeps").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(4557542064801950590L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(MPSModulesClosure.class, "closure"), SMethodBuilder.createJavaParameter(VisibleArtifacts.class, "artifacts"), SMethodBuilder.createJavaParameter(RequiredDependenciesBuilder.class, "builder"));
  /*package*/ static final SMethod<Boolean> fetchMPSDeps_id3WZD5LHqVGt = new SMethodBuilder<>(Boolean.TYPE).name("fetchMPSDeps").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(4557542064801954589L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(MPSModulesClosure.class, "closure"), SMethodBuilder.createJavaParameter(VisibleArtifacts.class, "artifacts"), SMethodBuilder.createJavaParameter(RequiredDependenciesBuilder.class, "builder"));
  /*package*/ static final SMethod<Boolean> fetchMPSDep_id3WZD5LHqWXL = new SMethodBuilder<>(Boolean.TYPE).name("fetchMPSDep").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(4557542064801959793L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(SNode.class, "dependency"), SMethodBuilder.createJavaParameter(VisibleArtifacts.class, "artifacts"), SMethodBuilder.createJavaParameter(RequiredDependenciesBuilder.class, "builder"));
  public static final SMethod<SNode> getOptions_idgpKvTnoZBS = new SMethodBuilder<>(SNode.class).name("getOptions").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(295480548701501944L).languageId(0xb99171f8c50ce5d2L, 0x798100da4f0a421aL).build2();
  ...
  /*package*/ static void fetchDependencies_id57YmpYyL8F1(@NotNull SNode __thisNode__, VisibleArtifacts artifacts, RequiredDependenciesBuilder builder) {
    ...
    BuildMps_Module__BehaviorDescriptor.fetchMPSDeps_id3WZD5LHqVGt.invokeSpecial(__thisNode__, closure, artifacts, builder);
    BuildMps_Module__BehaviorDescriptor.fetchJavaDeps_id3WZD5LHqUHY.invokeSpecial(__thisNode__, closure, artifacts, builder);
  }
  /*package*/ static boolean addJarPath_id3WZD5LHqnU8(@NotNull SAbstractConcept __thisConcept__, SNode path, VisibleArtifacts artifacts, RequiredDependenciesBuilder builder) {
    ...
    SNode artifact = SNodeOperations.as(resource._0(), CONCEPTS.BuildLayout_Node$Rb);
    if (artifact != null) {
  ...
  /*package*/ static Iterable<SNode> getJarDeps_id3WZD5LHqufx(@NotNull SAbstractConcept __thisConcept__, SNode module) {
    return SNodeOperations.ofConcept(ListSequence.fromList(SLinkOperations.getChildren(module, LINKS.dependencies$j8Lj)).select((it) -> (SNodeOperations.isInstanceOf(it, CONCEPTS.BuildMps_ExtractedModuleDependency$e8) ? SLinkOperations.getTarget(SNodeOperations.cast(it, CONCEPTS.BuildMps_ExtractedModuleDependency$e8), LINKS.dependency$u_ko) : it)), CONCEPTS.BuildMps_ModuleDependencyJar$Rm);
  }
  ...
  /*package*/ static boolean fetchMPSDeps_id3WZD5LHqVGt(@NotNull SNode __thisNode__, MPSModulesClosure closure, VisibleArtifacts artifacts, RequiredDependenciesBuilder builder) {
    ...
    for (SNode dependency : Sequence.fromIterable(closure.getModules())) {
      needsFetch |= ((boolean) BuildMps_Module__BehaviorDescriptor.fetchMPSDep_id3WZD5LHqWXL.invokeSpecial(__thisNode__, dependency, artifacts, builder));
    }
    return needsFetch;
  }
  /*package*/ static boolean fetchMPSDep_id3WZD5LHqWXL(@NotNull SNode __thisNode__, SNode dependency, VisibleArtifacts artifacts, RequiredDependenciesBuilder builder) {
    ...
    for (SNode dep : Sequence.fromIterable(BuildMps_Module__BehaviorDescriptor.getJarDeps_id3WZD5LHqufx.invokeSpecial(__thisNode__.getConcept(), dependency))) {
      if ((SLinkOperations.getTarget(dep, LINKS.customLocation$e43G) != null)) {
        ...
        if (dependencyComesFromAnotherRoot) {
          ...
          needsFetch |= ((boolean) BuildMps_Module__BehaviorDescriptor.addJarPath_id3WZD5LHqnU8.invokeSpecial(__thisNode__.getConcept(), SLinkOperations.getTarget(dep, LINKS.path$yTVo), artifacts, builder));
        }
      }
    }
    return needsFetch;
  ...
  /*package*/ static SNode getOptions_idgpKvTnoZBS(@NotNull SNode __thisNode__) {
    SNode options = BuildSource_CompilablePart__BehaviorDescriptor.getOptions_idgpKvTnoZBS.invoke0(__thisNode__, CONCEPTS.BuildSource_CompilablePart$37);
    if (options != null) {
      return options;
    }
    ...
    while (SNodeOperations.isInstanceOf(SNodeOperations.getParent(node), CONCEPTS.BuildMps_Group$Jc)) {
      options = Sequence.fromIterable(SNodeOperations.ofConcept(SNodeOperations.getAllSiblings(SNodeOperations.getParent(node), false), CONCEPTS.BuildSource_JavaOptions$D)).findFirst((it) -> isEmptyString(SPropertyOperations.getString(it, PROPS.optionsName$Rr_z)));
      if (options != null) {
        return options;
      }
