...
public final class BuildMpsLayout_Plugin__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getOutputPath_WithMacro_idfzIHCHip1Q = new SMethodBuilder<>(String.class).name("getOutputPath_WithMacro").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(280273048052535414L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(Context.class, "context"));
  ...
  public static final SMethod<Boolean> isFolder_id1bWeed$oPYW = new SMethodBuilder<>(Boolean.TYPE).name("isFolder").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1368030936106753980L).languageId(0xb99171f8c50ce5d2L, 0x798100da4f0a421aL).build2();
  public static final SMethod<Boolean> isAutoLayoutForPluginDescriptorNeeded_id1RsDREuQnlU = new SMethodBuilder<>(Boolean.TYPE).name("isAutoLayoutForPluginDescriptorNeeded").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2151778867069154682L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(MacroHelper.class, "macrosHelper"));
  public static final SMethod<Boolean> isPluginDescriptorPossiblyMissingInLayout_id1RsDREvCrek = new SMethodBuilder<>(Boolean.TYPE).name("isPluginDescriptorPossiblyMissingInLayout").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2151778867082277780L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2();
  public static final SMethod<SNode> conflictingJar_id1RsDREvPMQ$ = new SMethodBuilder<>(SNode.class).name("conflictingJar").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2151778867085782436L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(MacroHelper.class, "macros"));
  /*package*/ static final SMethod<Boolean> confictingJarNameExists_id1RsDREvQK61 = new SMethodBuilder<>(Boolean.TYPE).name("confictingJarNameExists").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(2151778867086033281L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(MacroHelper.class, "macros"));
  /*package*/ static final SMethod<SNode> findGroup_id7cOEBlPT2gC = new SMethodBuilder<>(SNode.class).name("findGroup").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(8301447434616448040L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter(SNode.class, "module"));
  /*package*/ static final SMethod<Boolean> isPackagedAutomatically_id36cV00CxaOW = new SMethodBuilder<>(Boolean.TYPE).name("isPackagedAutomatically").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(3570488090021899580L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2();
  /*package*/ static final SMethod<Void> unpackPluginModules_id6ZIjmBZXud7 = new SMethodBuilder<>(Void.TYPE).name("unpackPluginModules").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(8065469100328346439L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2(SMethodBuilder.createJavaParameter((Class<Iterable<SNode>>) ((Class) Object.class), "modules"), SMethodBuilder.createJavaParameter(UnpackHelper.class, "helper"), SMethodBuilder.createJavaParameter(String.class, "baseLocation"), SMethodBuilder.createJavaParameter(String.class, "groupSuffix"));
