...
/*package*/ class BuildMps_ModuleDependencyOnJavaModule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_1yxynp_a1a() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.javaLibLocation$VgPH)).isNotEmpty();
  }
  private boolean nodeCondition_1yxynp_a2a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.reexport$feO0);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.module$feOv;
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.module$feOv);
    }
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.BuildMps_ModuleDependencyOnJavaModule$mo, "jetbrains.mps.build.mps.editor.add_reexport_BuildMps_ModuleDependencyOnJavaModule"));
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new javaLibLocationSingleRoleHandler_1yxynp_b1a(myNode, LINKS.javaLibLocation$VgPH, getEditorContext());
  ...
  private static class javaLibLocationSingleRoleHandler_1yxynp_b1a extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.javaLibLocation$VgPH, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.javaLibLocation$VgPH, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.javaLibLocation$VgPH);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.javaLibLocation$VgPH));
      try {
