...
/*package*/ class BuildMps_ModuleDependencyTargetLanguage_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public BuildMps_ModuleDependencyTargetLanguage_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_vgz9nr_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_vgz9nr_a0");
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.language$wAwY;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.language$wAwY);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.language$wAwY);
    }
