...
public class SetModuleJarClasspathEntry_QuickFix extends QuickFix_Runtime {
  ...
  public void execute(SNode node) {
    SNode moduleXml = SNodeOperations.as(node, CONCEPTS.BuildMpsLayout_ModuleXml$_e);
    SPropertyOperations.assign(SLinkOperations.addNewChild(moduleXml, LINKS.classpathEntries$PWzd, null), PROPS.path$oN2q, ".");
  }
