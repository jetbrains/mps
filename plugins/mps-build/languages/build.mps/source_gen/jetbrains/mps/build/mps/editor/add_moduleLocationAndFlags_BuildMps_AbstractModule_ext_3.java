...
public class add_moduleLocationAndFlags_BuildMps_AbstractModule_ext_3 extends TransformationMenuBase {
  public add_moduleLocationAndFlags_BuildMps_AbstractModule_ext_3() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "add_moduleLocationAndFlags_BuildMps_AbstractModule_ext_3", new SNodePointer("r:589e3942-2f2d-42a2-9312-986a1d3e2f7f(jetbrains.mps.build.mps.editor)", "1741258697587175805")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new TMP_Group_rsg86w_a0());
    }
    return result;
  }
  ...
  public class TMP_Group_rsg86w_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new TMP_Action_rsg86w_a0a());
    }
    private class TMP_Action_rsg86w_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:589e3942-2f2d-42a2-9312-986a1d3e2f7f(jetbrains.mps.build.mps.editor)", "1741258697587175821"));
          return this;
        }
        @Nullable
        @Override
        ...
        public void execute(@NotNull String pattern) {
          SNodeFactoryOperations.setNewChild(_context.getNode(), LINKS.path$iYKB, null);
