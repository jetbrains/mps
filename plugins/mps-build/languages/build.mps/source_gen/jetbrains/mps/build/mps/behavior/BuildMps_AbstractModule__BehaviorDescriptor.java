...
public final class BuildMps_AbstractModule__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isCompact_id7gAtt1ju6Jy = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isCompact").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("7gAtt1ju6Jy").build();
  public static final SMethod<String> getModuleReference_id41K1b4v5ZCB = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getModuleReference").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("41K1b4v5ZCB").build();
