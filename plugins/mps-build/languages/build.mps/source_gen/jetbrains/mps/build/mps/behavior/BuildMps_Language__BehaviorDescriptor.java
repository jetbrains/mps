...
public final class BuildMps_Language__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getGenerator_id1kfMLj5Jhus = new SMethodBuilder<>(SNode.class).name("getGenerator").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1517654889524434844L).languageId(0xa132fa109541cba3L, 0xcf935df46994e9cL).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getGenerator_id1kfMLj5Jhus);
