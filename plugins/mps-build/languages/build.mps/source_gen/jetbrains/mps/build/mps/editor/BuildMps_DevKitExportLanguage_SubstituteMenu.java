...
public class BuildMps_DevKitExportLanguage_SubstituteMenu extends SubstituteMenuBase {
  public BuildMps_DevKitExportLanguage_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for BuildMps_DevKitExportLanguage. Generated from the smart reference attribute.", new SNodePointer("r:0353b795-df17-4050-9687-ee47eeb7094f(jetbrains.mps.build.mps.structure)", "4747359941569484034")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_37zm5j_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_37zm5j_a() {
      super(CONCEPTS.BuildMps_DevKitExportLanguage$EV, LINKS.language$qqxl, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }
  ...
  public class SMP_Subconcepts_37zm5j_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_37zm5j_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "BuildMps_DevKitExportLanguage", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.BuildMps_DevKitExportLanguage$EV);
    }
