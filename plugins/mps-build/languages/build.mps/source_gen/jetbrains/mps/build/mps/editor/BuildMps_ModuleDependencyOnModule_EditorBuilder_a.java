...
/*package*/ class BuildMps_ModuleDependencyOnModule_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_2jl94m_a1a() {
    return SPropertyOperations.getBoolean(myNode, PROPS.reexport$kN5t);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.module$kGi0;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.module$kGi0);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.module$kGi0);
    }
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.BuildMps_ModuleDependencyOnModule$1C, "jetbrains.mps.build.mps.editor.add_reexport"));
