...
public class BuildMps_IdeaPluginGroup_SmartReference extends SubstituteMenuBase {
  public BuildMps_IdeaPluginGroup_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "BuildMps_IdeaPluginGroup_SmartReference", new SNodePointer("r:589e3942-2f2d-42a2-9312-986a1d3e2f7f(jetbrains.mps.build.mps.editor)", "4747359941571311813")));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_v60gxw_a(), CONCEPTS.BuildMps_IdeaPluginGroup$_R));
    return result;
  }
  ...
  public class SMP_ReferenceScope_v60gxw_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_v60gxw_a() {
      super(CONCEPTS.BuildMps_IdeaPluginGroup$_R, LINKS.group$qLbS, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:589e3942-2f2d-42a2-9312-986a1d3e2f7f(jetbrains.mps.build.mps.editor)", "4747359941571311811")));
    }
    ...
    private class Item extends ReferenceScopeSubstituteMenuItem {
      ...
      public String getMatchingText(String pattern) {
        if (SNodeOperations.getContainingRoot(referencedNode) != SNodeOperations.getContainingRoot(_context.getParentNode())) {
          SNode proj = SNodeOperations.as(SNodeOperations.getContainingRoot(referencedNode), CONCEPTS.BuildProject$ae);
          if (proj != null) {
            return SPropertyOperations.getString(proj, PROPS.name$MnvL) + "/" + SPropertyOperations.getString(referencedNode, PROPS.name$MnvL);
          }
        }
