...
public final class ModuleChecker {
  ...
  private void generatorSourceLanguage(CheckType type) {
    ...
    if (type.doCheck && (SLinkOperations.getTarget(generator, LINKS.sourceLanguage$6S_y) == null)) {
  ...
  private static SNode createBuildMps_ModuleDependencyOnModule_yr5c5g_a0a0a0a31a63(SNode node0) {
    ...
    rootBuilder1.setReferenceTarget(LINKS.module$PvPC, node0);
    rootBuilder1.setProperty(PROPS.reexport$PAD5, PROPS.reexport$PAD5.getType().toString(false));
