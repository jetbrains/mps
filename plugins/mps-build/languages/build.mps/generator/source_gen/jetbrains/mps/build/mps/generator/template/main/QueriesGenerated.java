...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static Object propertyMacro_GetValue_8_44(final PropertyMacroContext _context) {
    return (SPropertyOperations.getBoolean(((SNode) _context.getVariable("branding")), PROPS.eap$o5ED) ? "eap-url" : "release-url");
  }
  ...
  public static Object propertyMacro_GetValue_8_48(final PropertyMacroContext _context) {
    return (String) BuildString__BehaviorDescriptor.getText_id3NagsOfTioI.invoke(SLinkOperations.getTarget(((SNode) _context.getVariable("branding")), LINKS.thirdparty$rm$o), Context.defaultContext(_context).getMacros(((SNode) _context.getVariable("branding"))));
  }
  ...
  public static boolean ifMacro_Condition_8_30(final IfMacroContext _context) {
    return (SLinkOperations.getTarget(((SNode) _context.getVariable("branding")), LINKS.thirdparty$rm$o) != null);
  }
  ...
  private static SNode createGeneratorInternal_String_x583g4_a0a0a0a0km(Object p0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.GeneratorInternal_String$CC);
    rootBuilder1.setProperty(PROPS.path$oN2q, PROPS.path$oN2q.getType().toString(p0));
  ...
  private static SNode createGeneratorInternal_ProjectDependency_x583g4_a0a0a0a1a263(SNode node0, Object p0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.GeneratorInternal_ProjectDependency$bb);
    rootBuilder1.setProperty(PROPS.path$URGX, PROPS.path$URGX.getType().toString(p0));
    rootBuilder1.setReferenceTarget(LINKS.project$ciHu, node0);
    return rootBuilder1.getResult();
  }
