...
public final class BuildLayout_Node__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> appendName_internal_id1bWeed$oEMe = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("appendName_internal").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1368030936106708110L).languageId(0xb99171f8c50ce5d2L, 0x798100da4f0a421aL).build2(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""), SMethodBuilder.createJavaParameter(StringBuilder.class, ""));
