...
public final class BuildSourceMacroRelativePath__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String getRelativePath_id4Kip2_918YF(@NotNull SNode __thisNode__) {
    ...
    return ((tail == null || tail.length() == 0) ? "${" + SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.macro$kdvp), PROPS.name$MnvL) + "}" : "${" + SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.macro$kdvp), PROPS.name$MnvL) + "}/" + tail);
  }
