...
public final class BuildSource_SingleFile__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getApproximateName_id4RsV8qJDnFm = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getApproximateName").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4RsV8qJDnFm").build();
