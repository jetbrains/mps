...
public final class BuildLayout_File__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> canHaveFilemode_id7UAfeVQUccL = new SMethodBuilder<>(Boolean.TYPE).name("canHaveFilemode").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9126048691955221297L).languageId(0xb99171f8c50ce5d2L, 0x798100da4f0a421aL).build2();
  ...
  /*package*/ static boolean exports_id5FtnUVJQES1(@NotNull SNode __thisNode__, Object artifactId) {
    ...
    // Here used to be dead code with LocalSourcePathArtifact alternative. LSPA now always represents folders, no way to match BL_File
    return false;
  }
