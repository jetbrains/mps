...
public class BuildSource_JavaFiles_SubstituteMenu extends SubstituteMenuBase {
  public BuildSource_JavaFiles_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "BuildSource_JavaFiles", new SNodePointer("r:00f69407-23a8-49a2-a236-9e89a32679aa(jetbrains.mps.build.editor)", "1741258697587201536")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Wrap_xmzx4c_a extends WrapperSubstituteMenuPart {
    private SMP_Wrap_xmzx4c_a() {
      super(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "BuildInputSingleFolder", new SNodePointer("r:00f69407-23a8-49a2-a236-9e89a32679aa(jetbrains.mps.build.editor)", "1741258697587201538")));
    }
