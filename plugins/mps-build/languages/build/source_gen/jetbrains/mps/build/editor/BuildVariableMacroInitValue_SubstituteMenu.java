...
public class BuildVariableMacroInitValue_SubstituteMenu extends SubstituteMenuBase {
  public BuildVariableMacroInitValue_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "BuildVariableMacroInitValue", new SNodePointer("r:00f69407-23a8-49a2-a236-9e89a32679aa(jetbrains.mps.build.editor)", "1741258697587202670")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Wrap_8kfjf0_a extends WrapperSubstituteMenuPart {
    private SMP_Wrap_8kfjf0_a() {
      super(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "BuildString", new SNodePointer("r:00f69407-23a8-49a2-a236-9e89a32679aa(jetbrains.mps.build.editor)", "1741258697587202672")));
    }
  ...
  public class SMP_Subconcepts_8kfjf0_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_8kfjf0_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "BuildVariableMacroInitValue", new SNodePointer("r:00f69407-23a8-49a2-a236-9e89a32679aa(jetbrains.mps.build.editor)", "1741258697587202746")));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.BuildVariableMacroInitValue$$g);
    }
