...
public class BuildCompositePath_TransformationMenu extends TransformationMenuBase {
  ...
  private static SNode createBuildCompositePath_a4cilw_a0a0a0b1(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.BuildCompositePath$Eh);
    rootBuilder1.forChild(LINKS.tail$$gpz).initNode(node0, CONCEPTS.BuildCompositePath$Eh, true);
