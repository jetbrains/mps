...
/*package*/ class BuildCompositePath_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_n78otj_a1a() {
    return (SLinkOperations.getTarget(myNode, LINKS.tail$$gpz) != null);
  }
  private boolean nodeCondition_n78otj_a2a() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.tail$$gpz)).isNotEmpty();
  }
  private EditorCell createProperty_0() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.head$$gC$;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, true), myNode);
      editorCell.setDefaultText("");
      editorCell.setCellId("property_head");
      Style style = new StyleImpl();
      style.set(StyleAttributes.TEXT_COLOR, getStyleRegistry().getSimpleColor(_StyleParameter_QueryFunction_n78otj_a0a0()));
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new tailSingleRoleHandler_n78otj_c0(myNode, LINKS.tail$$gpz, getEditorContext());
  ...
  private static class tailSingleRoleHandler_n78otj_c0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.tail$$gpz, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.tail$$gpz, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.tail$$gpz);
      }
      Style style = new StyleImpl();
      style.set(StyleAttributes.INDENT_LAYOUT_NO_WRAP, true);
      editorCell.getStyle().putAll(style);
    ...
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.tail$$gpz));
      try {
