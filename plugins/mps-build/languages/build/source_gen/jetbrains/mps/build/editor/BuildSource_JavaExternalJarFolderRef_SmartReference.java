...
public class BuildSource_JavaExternalJarFolderRef_SmartReference extends SubstituteMenuBase {
  public BuildSource_JavaExternalJarFolderRef_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "BuildSource_JavaExternalJarFolderRef_SmartReference", new SNodePointer("r:00f69407-23a8-49a2-a236-9e89a32679aa(jetbrains.mps.build.editor)", "4747359941571312009")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_tq42m2_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_tq42m2_a() {
      super(CONCEPTS.BuildSource_JavaExternalJarFolderRef$kv, LINKS.folder$95wz, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:00f69407-23a8-49a2-a236-9e89a32679aa(jetbrains.mps.build.editor)", "4747359941571312007")));
    }
