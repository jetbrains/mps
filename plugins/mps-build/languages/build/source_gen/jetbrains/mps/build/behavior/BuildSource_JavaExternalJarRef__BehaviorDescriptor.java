...
public final class BuildSource_JavaExternalJarRef__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Tuples._2<SNode, Boolean>> getDependencyTarget_id4RsV8qJGJqY = new SMethodBuilder<>((Class<Tuples._2<SNode, Boolean>>) ((Class) Object.class)).name("getDependencyTarget").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5610619299014309566L).languageId(0xb99171f8c50ce5d2L, 0x798100da4f0a421aL).build2(SMethodBuilder.createJavaParameter(VisibleArtifacts.class, "artifacts"));
