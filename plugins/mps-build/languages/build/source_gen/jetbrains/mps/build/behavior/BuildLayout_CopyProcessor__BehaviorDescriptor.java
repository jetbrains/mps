...
public final class BuildLayout_CopyProcessor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getTaskName_id19QsrPtc4wK = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getTaskName").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).id("19QsrPtc4wK").build();
  public static final SMethod<Map<String, String>> getTaskArguments_id6R_3WZ31H2E = new SMethodBuilder<Map<String, String>>(new SJavaCompoundTypeImpl(Map.class)).name("getTaskArguments").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).id("6R_3WZ31H2E").build();
  public static final SMethod<String> getTempFolder_id19QsrPvjYS$ = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getTempFolder").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("19QsrPvjYS$").build(SMethodBuilder.createJavaParameter(TemplateQueryContext.class, ""));
  /*package*/ static final SMethod<String> representativeName_id19QsrPvAva7 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("representativeName").modifiers(1, AccessPrivileges.PRIVATE).concept(CONCEPT).id("19QsrPvAva7").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  /*package*/ static final SMethod<String> filesetName_id19QsrPvClqt = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("filesetName").modifiers(1, AccessPrivileges.PRIVATE).concept(CONCEPT).id("19QsrPvClqt").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
