...
public class BuildSourcePath_TransformationMenu extends TransformationMenuBase {
  public BuildSourcePath_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "BuildSourcePath", new SNodePointer("r:00f69407-23a8-49a2-a236-9e89a32679aa(jetbrains.mps.build.editor)", "1741258697587200859")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new DefaultConceptMenusTransformationMenuPart(SModelUtil.getDirectSuperConcepts(CONCEPTS.BuildSourcePath$H)) {
        @NotNull
        @Override
      ...
      result.add(new TMP_Include_8dks2k_b0());
      result.add(new TMP_Include_8dks2k_c0());
    }
    return result;
  }
  ...
  public class TMP_Include_8dks2k_b0 extends IncludeTransformationMenuTransformationMenuPart {
    ...
    protected TransformationMenuLookup getMenuLookup(TransformationMenuContext _context) {
      ...
      return new NamedTransformationMenuLookup(LanguageRegistry.getInstance(editorContext.getRepository()), CONCEPTS.BuildSourcePath$H, "jetbrains.mps.build.editor.add_reexport_BuildSourcePath");
    }
  ...
  public class TMP_Include_8dks2k_c0 extends IncludeTransformationMenuTransformationMenuPart {
    ...
    protected TransformationMenuLookup getMenuLookup(TransformationMenuContext _context) {
      ...
      return new NamedTransformationMenuLookup(LanguageRegistry.getInstance(editorContext.getRepository()), CONCEPTS.BuildSourcePath$H, "jetbrains.mps.build.editor.transform_CompositePath_BuildSourcePath");
    }
