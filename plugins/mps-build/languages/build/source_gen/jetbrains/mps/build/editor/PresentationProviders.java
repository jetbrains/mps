...
public class PresentationProviders {
  public static final IReferentPresentationProvider PRESENTATION_4dmy40_a0a1a = ((IReferentPresentationProvider) (sourceNode, targetNode) -> {
  ...
  public static final IReferentPresentationProvider PRESENTATION_roxgcf_a0a1a = ((IReferentPresentationProvider) (sourceNode, targetNode) -> {
    SNode contextProject = SNodeOperations.getNodeAncestor(sourceNode, CONCEPTS.BuildProject$ae, true, false);
    String target = null;
  ...
  public static final IReferentPresentationProvider PRESENTATION_uanmw8_a0a0a = ((IReferentPresentationProvider) (sourceNode, targetNode) -> {
    SNode contextProject = SNodeOperations.getNodeAncestor(sourceNode, CONCEPTS.BuildProject$ae, true, false);
    String target = null;
    if ((contextProject != null)) {
  ...
  public static final IReferentPresentationProvider PRESENTATION_cqnk8f_a0a0a = ((IReferentPresentationProvider) (sourceNode, targetNode) -> {
    SNode contextProject = SNodeOperations.getNodeAncestor(sourceNode, CONCEPTS.BuildProject$ae, true, false);
    String target = null;
    if ((contextProject != null)) {
