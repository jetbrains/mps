...
public class transform_CompositePath_BuildSourcePath extends TransformationMenuBase {
  public transform_CompositePath_BuildSourcePath() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "transform_CompositePath_BuildSourcePath", new SNodePointer("r:00f69407-23a8-49a2-a236-9e89a32679aa(jetbrains.mps.build.editor)", "1741258697587201127")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
    ...
    private class TMP_Action_qnu3dg_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem, ConstraintsVerifiableActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00f69407-23a8-49a2-a236-9e89a32679aa(jetbrains.mps.build.editor)", "1741258697587201167"));
          return this;
        }
        @Nullable
        @Override
