...
public class BuildSource_JavaExternalJarRef_SmartReference extends SubstituteMenuBase {
  public BuildSource_JavaExternalJarRef_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "BuildSource_JavaExternalJarRef_SmartReference", new SNodePointer("r:00f69407-23a8-49a2-a236-9e89a32679aa(jetbrains.mps.build.editor)", "4747359941571311902")));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_fdjpgz_a(), CONCEPTS.BuildSource_JavaExternalJarRef$GK));
    return result;
  }
  ...
  public class SMP_ReferenceScope_fdjpgz_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_fdjpgz_a() {
      super(CONCEPTS.BuildSource_JavaExternalJarRef$GK, LINKS.jar$JLD3, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:00f69407-23a8-49a2-a236-9e89a32679aa(jetbrains.mps.build.editor)", "4747359941571311900")));
    }
    ...
    private class Item extends ReferenceScopeSubstituteMenuItem {
      ...
      public String getMatchingText(String pattern) {
        ...
        if (target == null) {
          target = (SNodeOperations.isInstanceOf(referencedNode, CONCEPTS.BuildInputSingleFile$4U) ? BuildSourcePath__BehaviorDescriptor.getRelativePath_id4Kip2_918YF.invoke(SLinkOperations.getTarget(SNodeOperations.cast(referencedNode, CONCEPTS.BuildInputSingleFile$4U), LINKS.path$dYr6)) : BaseConcept__BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(referencedNode));
        }
        return target;
      }
      @Override
