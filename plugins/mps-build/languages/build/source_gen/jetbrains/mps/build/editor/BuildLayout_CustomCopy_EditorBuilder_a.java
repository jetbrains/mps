...
/*package*/ class BuildLayout_CustomCopy_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new filesetSingleRoleHandler_6lrdv3_b0(myNode, LINKS.fileset$tUzn, getEditorContext());
  ...
  private static class filesetSingleRoleHandler_6lrdv3_b0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.fileset$tUzn, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.fileset$tUzn, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.fileset$tUzn);
      }
      Style style = new StyleImpl();
    ...
    protected EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.fileset$tUzn));
      try {
  ...
  private static class handlersListHandler_6lrdv3_c0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.handlers$AdkY;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.BuildLayout_CopyHandler$W9;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(handlersListHandler_6lrdv3_c0.this.getNode(), LINKS.handlers$AdkY));
      try {
