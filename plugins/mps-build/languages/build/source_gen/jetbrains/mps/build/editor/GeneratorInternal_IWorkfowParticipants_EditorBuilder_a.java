...
/*package*/ class GeneratorInternal_IWorkfowParticipants_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.for$UmSz;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.for$UmSz);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.for$UmSz);
    }
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new participantListHandler_4clv4k_c0(myNode, getEditorContext());
  ...
  private static class participantListHandler_4clv4k_c0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.participant$Un7$;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.GeneratorInternal_IWorkflowParticipantReference$YB;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(participantListHandler_4clv4k_c0.this.getNode(), LINKS.participant$Un7$));
      try {
