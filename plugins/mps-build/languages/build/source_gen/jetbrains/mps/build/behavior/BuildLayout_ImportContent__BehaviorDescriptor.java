...
public final class BuildLayout_ImportContent__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(fetchDependencies_id57YmpYyL8F1, isImplicit_id19QsrPuCW11);
  ...
  /*package*/ static void fetchDependencies_id57YmpYyL8F1(@NotNull SNode __thisNode__, VisibleArtifacts artifacts, RequiredDependenciesBuilder builder) {
    if (SNodeOperations.getContainingRoot(__thisNode__) == SNodeOperations.getContainingRoot(SLinkOperations.getTarget(__thisNode__, LINKS.target$HFO4))) {
      return;
    }

    SNode artifact = SNodeOperations.as(artifacts.findArtifact(SLinkOperations.getTarget(__thisNode__, LINKS.target$HFO4)), CONCEPTS.BuildLayout_Node$Rb);
    if (SNodeOperations.isInstanceOf(artifact, CONCEPTS.BuildLayout_Container$vv)) {
