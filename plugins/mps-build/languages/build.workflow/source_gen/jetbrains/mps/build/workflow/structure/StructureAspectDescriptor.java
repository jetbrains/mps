...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptBwfTaskMacroCondition = createDescriptorForBwfTaskMacroCondition();
  ...
  /*package*/ final ConceptDescriptor myConceptXmlForeignRefValue = createDescriptorForXmlForeignRefValue();
  ...
  public ConceptDescriptor getDescriptor(SConceptId id) {
    switch (myIndexSwitch.index(id)) {
      ...
      case LanguageConceptSwitch.BwfTaskMacroCondition:
        return myConceptBwfTaskMacroCondition;
      ...
      case LanguageConceptSwitch.XmlForeignRefValue:
        return myConceptXmlForeignRefValue;
      default:
        return null;
    }
  }
  ...
  private static ConceptDescriptor createDescriptorForBwfAntStatement() {
    ...
    b.class_(false, false, false);
    // extends: jetbrains.mps.build.workflow.structure.BwfStatement
    b.super_(0x698a8d22a10447a0L, 0xba8d10e3ec237f13L, 0x2670d5989d5b4a1bL);
  ...
  private static ConceptDescriptor createDescriptorForBwfJavaClassPath() {
    ...
    b.class_(false, false, false);
    // extends: jetbrains.mps.build.workflow.structure.BwfJavaDependency
    b.super_(0x698a8d22a10447a0L, 0xba8d10e3ec237f13L, 0x5c3f3e2c1cede06eL);
  ...
  private static ConceptDescriptor createDescriptorForBwfJavaModule() {
    ...
    b.property("withKotlin", 0x6ab0965855d6fac1L).type(PrimitiveTypeId.BOOLEAN).origin("7687809870062877377").done();
  ...
  private static ConceptDescriptor createDescriptorForBwfTaskMacroCondition() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("jetbrains.mps.build.workflow", "BwfTaskMacroCondition", 0x698a8d22a10447a0L, 0xba8d10e3ec237f13L, 0x71e3a5e19d710d42L);
    b.class_(false, false, false);
    b.origin("r:ed179f4d-7cf2-479d-8348-50c1fc63b96a(jetbrains.mps.build.workflow.structure)/8206585334426832194");
    b.version(3);
    b.property("inverted", 0x71e3a5e19d71203bL).type(PrimitiveTypeId.BOOLEAN).origin("8206585334426837051").done();
    b.associate("macro", 0x71e3a5e19d712923L).target(0x698a8d22a10447a0L, 0xba8d10e3ec237f13L, 0x5fb388b43aa25d48L).optional(false).origin("8206585334426839331").done();
    b.alias("condition");
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForXmlForeignRefValue() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("jetbrains.mps.build.workflow", "XmlForeignRefValue", 0x698a8d22a10447a0L, 0xba8d10e3ec237f13L, 0x98b3588cc616ccaL);
    b.class_(false, false, false);
    ...
    b.origin("r:ed179f4d-7cf2-479d-8348-50c1fc63b96a(jetbrains.mps.build.workflow.structure)/687702229764893898");
    b.version(3);
    b.associate("target", 0x98b3588cc616ccbL).target(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x10802efe25aL).optional(false).origin("687702229764893899").done();
    b.alias("*[");
    return b.create();
  }
}
