...
public class java_module_content_XmlBaseElement_Contribution extends SubstituteMenuBase {
  public java_module_content_XmlBaseElement_Contribution() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "XmlBaseElement", new SNodePointer("r:1267752b-a233-4432-a848-3e68e0ea0db1(jetbrains.mps.build.workflow.editor)", "1741258697587102676")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_fc12n3_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_fc12n3_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:1267752b-a233-4432-a848-3e68e0ea0db1(jetbrains.mps.build.workflow.editor)", "1741258697587102679")));
    }
    @Override
