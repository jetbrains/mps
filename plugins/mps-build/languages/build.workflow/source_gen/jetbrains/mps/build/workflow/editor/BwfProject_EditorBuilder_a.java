...
/*package*/ class BwfProject_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new importsListHandler_4tk4ky_f0(myNode, getEditorContext());
  ...
  private static class importsListHandler_4tk4ky_f0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.imports$B1XX;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.BwfTaskLibraryDependency$g5;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(importsListHandler_4tk4ky_f0.this.getNode(), LINKS.imports$B1XX));
      try {
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.baseDirectory$BDIf;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
  ...
  private EditorCell createProperty_2() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.temporaryFolder$kyMK;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new partsListHandler_4tk4ky_o0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class partsListHandler_4tk4ky_o0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.parts$$VTL;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.BwfProjectPart$u1;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(partsListHandler_4tk4ky_o0.this.getNode(), LINKS.parts$$VTL));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept BwfProjectPart$u1 = MetaAdapterFactory.getConcept(0x698a8d22a10447a0L, 0xba8d10e3ec237f13L, 0x2670d5989d5a6287L, "jetbrains.mps.build.workflow.structure.BwfProjectPart");
  }
