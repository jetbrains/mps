...
/*package*/ class BwfTaskPart_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_rjgbfl_a2a() {
    return Sequence.fromIterable(AttributeOperations.getChildNodesAndAttributes(myNode, LINKS.additionalDependencies$kDSv)).isNotEmpty();
  }
  private boolean nodeCondition_rjgbfl_a4a() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.subTasks$aim9)).isEmpty() || (SNodeOperations.getNextSibling(myNode) == null);
  }
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.task$ai78;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.task$ai78);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.task$ai78);
    }
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.BwfTaskPart$sR, "jetbrains.mps.build.workflow.editor.add_dependencies_BwfTaskPart"));
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new additionalDependenciesListHandler_rjgbfl_b2a(myNode, getEditorContext());
  ...
  private static class additionalDependenciesListHandler_rjgbfl_b2a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.additionalDependencies$kDSv;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(additionalDependenciesListHandler_rjgbfl_b2a.this.getNode(), LINKS.additionalDependencies$kDSv));
      try {
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new subTasksListHandler_rjgbfl_d0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class subTasksListHandler_rjgbfl_d0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(subTasksListHandler_rjgbfl_d0.this.getNode(), LINKS.subTasks$aim9));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
