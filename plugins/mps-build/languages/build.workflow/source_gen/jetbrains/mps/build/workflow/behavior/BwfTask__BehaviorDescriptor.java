...
public final class BwfTask__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getScope_id52_Geb4QDV$, getPriority_id1Mjrj7j4T5I);


  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    if (SConceptOperations.isExactly(SNodeOperations.asSConcept(kind), CONCEPTS.BwfSubTask$X)) {
      Scope result = SimpleRoleScope.forNamedElements(__thisNode__, LINKS.subTasks$u4ob);
      for (SNode n : SNodeOperations.getAllSiblings(__thisNode__, false)) {
        if (SNodeOperations.isInstanceOf(n, CONCEPTS.BwfTaskPart$sR) && SLinkOperations.getTarget(SNodeOperations.cast(n, CONCEPTS.BwfTaskPart$sR), LINKS.task$ai78) == __thisNode__) {
          result = CompositeScope.createComposite(result, SimpleRoleScope.forNamedElements(n, LINKS.subTasks$aim9));
        }
      }
      return result;
    }
