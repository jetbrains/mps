...
public class BwfJavaDependency_SubstituteMenu extends SubstituteMenuBase {
  public BwfJavaDependency_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "BwfJavaDependency", new SNodePointer("r:1267752b-a233-4432-a848-3e68e0ea0db1(jetbrains.mps.build.workflow.editor)", "1741258697587102918")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Wrap_qn58zx_a extends WrapperSubstituteMenuPart {
    private SMP_Wrap_qn58zx_a() {
      super(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "XmlBaseElement", new SNodePointer("r:1267752b-a233-4432-a848-3e68e0ea0db1(jetbrains.mps.build.workflow.editor)", "1741258697587102921")));
    }
  ...
  public class SMP_Subconcepts_qn58zx_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_qn58zx_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "BwfJavaDependency", new SNodePointer("r:1267752b-a233-4432-a848-3e68e0ea0db1(jetbrains.mps.build.workflow.editor)", "1741258697587102981")));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.BwfJavaDependency$66).stream().filter((SAbstractConcept concept) -> filterConcept(_context, concept)).collect(Collectors.toList());
    }
