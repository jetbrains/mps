...
public final class BwfPathDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getPathId_id5KZfyKsWnkn = new SMethodBuilder<>(String.class).name("getPathId").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6647099934207210775L).languageId(0xba8d10e3ec237f13L, 0x698a8d22a10447a0L).build2();
