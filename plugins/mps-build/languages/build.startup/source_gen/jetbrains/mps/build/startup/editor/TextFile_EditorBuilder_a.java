...
/*package*/ class TextFile_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private static class linesListHandler_fmnf9t_c0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.lines$DTIB;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.TextLine$zd;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(linesListHandler_fmnf9t_c0.this.getNode(), LINKS.lines$DTIB));
      try {
