...
public class includeIntoLayout_QuickFix extends QuickFix_Runtime {
  ...
  public String getDescription(SNode node) {
    return "Add " + SPropertyOperations.getString(((SNode) includeIntoLayout_QuickFix.this.getField("module")[0]), PROPS.name$MnvL) + " to the layout";
  }
  public void execute(SNode node) {
    ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(((SNode) includeIntoLayout_QuickFix.this.getField("project")[0]), LINKS.layout$r7bw), LINKS.children$aMRO)).addElement(createBuildMpsLayout_ModuleJars_f5l1y2_a0a0a2(((SNode) includeIntoLayout_QuickFix.this.getField("module")[0])));
  }
