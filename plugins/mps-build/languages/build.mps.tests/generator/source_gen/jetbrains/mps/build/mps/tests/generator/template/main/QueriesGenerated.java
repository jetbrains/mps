...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static Object propertyMacro_GetValue_0_2(final PropertyMacroContext _context) {
    ...
    if ((mpsTestJarFolder != null)) {
      String location = helper.getLocation(mpsTestJarFolder);
      // strip the trailing /lib and hope the result is the location of mps_home folder
      // see BuildModuleTestPlugin.fetchDependencies() method for information on 
      // where "mps-test-folder" comes from
  ...
  public static Object propertyMacro_GetValue_0_10(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(_context.getNode(), PROPS.name$MnvL).substring(((String) _context.getVariable("var:MPS_MACRO_PREFIX")).length());
  }
  ...
  public static boolean ifMacro_Condition_0_0(final IfMacroContext _context) {
    return (SLinkOperations.getTarget(_context.getNode(), LINKS.options$gctq) != null) && (SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.options$gctq), LINKS.openTestReport$U4gB) != null);
  }
  ...
  private final Map<String, SourceNodesQuery> snsqMethods = new HashMap<String, SourceNodesQuery>();
  {
    ...
    snsqMethods.put("819766574531067642", new SNsQ(i++));
    snsqMethods.put("819766574531067684", new SNsQ(i++));
    snsqMethods.put("819766574532351184", new SNsQ(i++));
  ...
  private final Map<String, PropertyValueQuery> pvqMethods = new HashMap<String, PropertyValueQuery>();
  {
    ...
    pvqMethods.put("5794342746865578582", new PVQ(i++, MetaAdapterFactory.getProperty(0x479c7a8c02f943b5L, 0x9139d910cb22f298L, 0x5c842a42c54cfd1fL, 0x5c842a42c54cfd20L, "text"), "false"));
    ...
    pvqMethods.put("5528547093830289142", new PVQ(i++, MetaAdapterFactory.getProperty(0x479c7a8c02f943b5L, 0x9139d910cb22f298L, 0x5c842a42c54cfd1fL, 0x5c842a42c54cfd20L, "text"), "plugin.id"));
    ...
    pvqMethods.put("881291017016005252", new PVQ(i++, MetaAdapterFactory.getProperty(0x479c7a8c02f943b5L, 0x9139d910cb22f298L, 0x5c842a42c54cfd1fL, 0x5c842a42c54cfd20L, "text"), "${basedir}"));
    pvqMethods.put("8658160622856544027", new PVQ(i++, MetaAdapterFactory.getProperty(0x479c7a8c02f943b5L, 0x9139d910cb22f298L, 0x5c842a42c54cfd1fL, 0x5c842a42c54cfd20L, "text"), "${build.tmp}"));
  ...
  {
    int i = 0;
    imcMethods.put("5794342746865591717", new IfMC(i++));
  ...
  private final Map<String, ReferenceTargetQuery> rtqMethods = new HashMap<String, ReferenceTargetQuery>();
  {
    ...
    rtqMethods.put("819766574531067802", new RTQ(1, "_project"));
    rtqMethods.put("7135065582586127325", new RTQ(2, "_project"));
  }
  @NotNull
  @Override
