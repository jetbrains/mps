...
public class QueriesGenerated extends QueryProviderBase {
  ...
  private static SNode createGeneratorInternal_PluginExpanded_x583g4_a0a0a0e0m(Object p0, Object p1) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.GeneratorInternal_PluginExpanded$$Z);
    rootBuilder1.setProperty(PROPS.path$4PFd, PROPS.path$4PFd.getType().toString(p0));
    rootBuilder1.setProperty(PROPS.id$4PUe, PROPS.id$4PUe.getType().toString(p1));
