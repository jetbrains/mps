...
public class ModelCheckerIssueFinder implements SearchTask {
  ...
  public SearchResults<IssueKindReportItem> execute(final ProgressMonitor monitor) {
    return new ModelAccessHelper(myRepository).runReadAction(() -> {
      ...
      // FIXME extract the option to use parallel model checking to options
      TaskScheduler scheduler = ((myMpsProject != null) && Registry.is("mps.modelchecker.parallel") ? new IdeaPlatformTaskScheduler(myMpsProject) : new DefaultTaskScheduler());
