  ...
  public SearchResults<IssueKindReportItem> execute(final ProgressMonitor monitor) {
    return new ModelAccessHelper(myRepository).runReadAction(new Computable<SearchResults<IssueKindReportItem>>() {
      public SearchResults<IssueKindReportItem> compute() {
        ...
        // FIXMEit'soddtocreatecheckerhereprovidedoutercodecaresaboutModelCheckerSettingsandIssueKindReportItemanyway.
        // WecouldhavepassedIAbstractChecker(createdthewayfromthelinebelow)tothecons,however,can'tdoitrightaway
        // asIdon'tliketoexposeModelCheckerBuilder.ItemsToCheck,andneedtorefactorthis.
