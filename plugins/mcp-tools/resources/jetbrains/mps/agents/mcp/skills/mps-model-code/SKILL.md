...
5. **Validate** with `mps_mcp_check_root_node_problems(nodeRef, onlyNodesWithProblems=true)`. Re-read generated `source_gen/...java` only to confirm runtime shape — never to apply fixes. See `references/workflows.md`.
