...
| Method return type is `List<SNode>` but model expects `sequence<node<X>>` | Java parser flaw | Replace `returnType` child — see `mps-model-code/references/variable-declarations.md` |
