 ...
 *
 * - happy-path parsing for [com.intellij.mcp.tools.parseStructureConceptSpecs],
 *   [com.intellij.mcp.tools.parseStructureInterfaceConceptSpecs],
 *   [com.intellij.mcp.tools.parseEnumValueSpecs] and
 *   [com.intellij.mcp.tools.parseJavaParseInsertRequest];
 * - the previously untested [com.intellij.mcp.tools.parseStructureInterfaceConceptSpecs]
...
class McpToolInputSchemasTest {
    ...
    fun structureConceptRejectsBlankImplementsEntry() {
        assertSchemaFailure("Missing 'conceptsJson[0].implements[1]'") {
            parseStructureConceptSpecs(
    ...
    fun structureInterfaceConceptRejectsBlankExtendedInterfacesEntry() {
        assertSchemaFailure("Missing 'interfaceConceptsJson[0].extendedInterfaces[1]'") {
            parseStructureInterfaceConceptSpecs(
