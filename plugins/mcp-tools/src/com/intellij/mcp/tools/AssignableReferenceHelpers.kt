...
internal class AssignableReferenceHelpers(
    ...
    internal fun computeAccessibility(candidateNode: SNode, context: AssignableReferenceService.ReferenceResolutionContext): Boolean {
        ...
        return when {
            ...
            visibilityNode.concept.isSubConceptOf(protectedVisibilityConcept) -> {
                ...
                moduleRefStr(candidateNode) == context.containingModuleRef
            }
            else -> true
        }
    }
    ...
    internal fun enrichContextFromScope(
        ...
        if (context.inferredKind == CandidateKind.CONSTRUCTOR && context.expectedDeclaringType == null && allAvailable.isNotEmpty()) {
            ...
            if (declaringClassifier != null && declaringClassifier.concept.isSubConceptOf(classifierConcept)) {
    ...
    internal fun baseCandidate(node: SNode): AssignableReferenceCandidate = AssignableReferenceCandidate(
    ...
    internal fun createCandidate(node: SNode, context: AssignableReferenceService.ReferenceResolutionContext): AssignableReferenceCandidate {
        ...
        if (node.concept.isSubConceptOf(baseMethodDeclarationConcept)) {
