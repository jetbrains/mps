...
public final class IGeneratedToClass__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getSuffix_idO$iR4JBsSb = new SMethodBuilder<>(String.class).name("getSuffix").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(946964771156905483L).languageId(0x8292b8985697c74bL, 0x73c1a49099fa4d0dL).build2();
  public static final SMethod<String> getGeneratedClassName_idO$iR4JBsSg = new SMethodBuilder<>(String.class).name("getGeneratedClassName").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(946964771156905488L).languageId(0x8292b8985697c74bL, 0x73c1a49099fa4d0dL).build2();
  public static final SMethod<String> getFullName_idO$iR4JBsSv = new SMethodBuilder<>(String.class).name("getFullName").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(946964771156905503L).languageId(0x8292b8985697c74bL, 0x73c1a49099fa4d0dL).build2();
  public static final SMethod<String> getValidClassName_id2eOtvO7hJjT = new SMethodBuilder<>(String.class).name("getValidClassName").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(2572811016744662265L).languageId(0x8292b8985697c74bL, 0x73c1a49099fa4d0dL).build2(SMethodBuilder.createJavaParameter(String.class, "name"));
  public static final SMethod<String> getGeneratedClassName_idO$iR4JBsSG = new SMethodBuilder<>(String.class).name("getGeneratedClassName").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(946964771156905516L).languageId(0x8292b8985697c74bL, 0x73c1a49099fa4d0dL).build2(SMethodBuilder.createJavaParameter(String.class, "name"));
  ...
  public static final SMethod<String> getNamespace_id1XgDflG1h$6 = new SMethodBuilder<>(String.class).name("getNamespace").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2256484787298834694L).languageId(0x8292b8985697c74bL, 0x73c1a49099fa4d0dL).build2();
  public static final SMethod<String> replaceProhibitedSymbol_idO$iR4JBsQI = new SMethodBuilder<>(String.class).name("replaceProhibitedSymbol").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(946964771156905390L).languageId(0x8292b8985697c74bL, 0x73c1a49099fa4d0dL).build2(SMethodBuilder.createJavaParameter(String.class, "name"), SMethodBuilder.createJavaParameter(String.class, "symbol"));
  public static final SMethod<String> makeUpperCase_idO$iR4JBsRn = new SMethodBuilder<>(String.class).name("makeUpperCase").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(946964771156905431L).languageId(0x8292b8985697c74bL, 0x73c1a49099fa4d0dL).build2(SMethodBuilder.createJavaParameter(String.class, "string"), SMethodBuilder.createJavaParameter(Integer.TYPE, "index"));
  public static final SMethod<String> getValidClassName_id3gpm$NHlLi1 = new SMethodBuilder<>(String.class).name("getValidClassName").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3754131050835940481L).languageId(0x8292b8985697c74bL, 0x73c1a49099fa4d0dL).build2(SMethodBuilder.createJavaParameter(String.class, "name"));
