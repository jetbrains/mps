...
public final class IGeneratedToClass__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getSuffix_idO$iR4JBsSb = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getSuffix").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).id("O$iR4JBsSb").build();
  public static final SMethod<String> getGeneratedClassName_idO$iR4JBsSg = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getGeneratedClassName").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("O$iR4JBsSg").build();
  public static final SMethod<String> getFullName_idO$iR4JBsSv = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getFullName").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("O$iR4JBsSv").build();
  public static final SMethod<String> getValidClassName_id2eOtvO7hJjT = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getValidClassName").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).id("2eOtvO7hJjT").build(SMethodBuilder.createJavaParameter(String.class, ""));
  public static final SMethod<String> getGeneratedClassName_idO$iR4JBsSG = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getGeneratedClassName").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).id("O$iR4JBsSG").build(SMethodBuilder.createJavaParameter(String.class, ""));
  ...
  public static final SMethod<String> getNamespace_id1XgDflG1h$6 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getNamespace").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1XgDflG1h$6").build();
  public static final SMethod<String> replaceProhibitedSymbol_idO$iR4JBsQI = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("replaceProhibitedSymbol").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).id("O$iR4JBsQI").build(SMethodBuilder.createJavaParameter(String.class, ""), SMethodBuilder.createJavaParameter(String.class, ""));
  public static final SMethod<String> makeUpperCase_idO$iR4JBsRn = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("makeUpperCase").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).id("O$iR4JBsRn").build(SMethodBuilder.createJavaParameter(String.class, ""), SMethodBuilder.createJavaParameter(Integer.TYPE, ""));
  public static final SMethod<String> getValidClassName_id3gpm$NHlLi1 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getValidClassName").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3gpm$NHlLi1").build(SMethodBuilder.createJavaParameter(String.class, ""));
