...
/*package*/ class TemplatePersistentConfigurationType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_1clvom_a0a() {
    return (SLinkOperations.getTarget(myNode, LINKS.persistentConfiguration$QL_P) == null) || (new IAttributeDescriptor.NodeAttribute(CONCEPTS.DeprecatedAnnotation$xW).get(SLinkOperations.getTarget(myNode, LINKS.persistentConfiguration$QL_P)) == null);
  }
  private boolean nodeCondition_1clvom_a1a() {
    return (SLinkOperations.getTarget(myNode, LINKS.persistentConfiguration$QL_P) != null) && (new IAttributeDescriptor.NodeAttribute(CONCEPTS.DeprecatedAnnotation$xW).get(SLinkOperations.getTarget(myNode, LINKS.persistentConfiguration$QL_P)) != null);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.persistentConfiguration$QL_P;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.template$Yjjl);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.persistentConfiguration$QL_P);
    }
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfo(editorCell, referenceLink, CONCEPTS.PersistentConfigurationTemplate$li));
  ...
  private EditorCell createRefCell_1() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder1(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.template$Yjjl);
        CellUtil.setupIDeprecatableStyles(targetNode, cell);
        setSemanticNodeToCells(cell, getNode());
        installDeleteActions_nullable_reference(cell);
        return cell;
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink template$Yjjl = MetaAdapterFactory.getReferenceLink(0x756e911c3f1f4a48L, 0xbdf5a2ceb91b723cL, 0xd244b712f9100fdL, 0xd244b712f9100feL, "template");
  }
