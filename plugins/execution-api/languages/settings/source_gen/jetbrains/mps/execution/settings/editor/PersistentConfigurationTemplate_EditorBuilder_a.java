...
/*package*/ class PersistentConfigurationTemplate_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new templateParameterListHandler_85j21_d0a(myNode, getEditorContext());
  ...
  private static class templateParameterListHandler_85j21_d0a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.templateParameter$YBXF;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.TemplateParameter$yQ;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(templateParameterListHandler_85j21_d0a.this.getNode(), LINKS.templateParameter$YBXF));
      try {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept TemplateParameter$yQ = MetaAdapterFactory.getConcept(0x756e911c3f1f4a48L, 0xbdf5a2ceb91b723cL, 0xd244b712f91011aL, "jetbrains.mps.execution.settings.structure.TemplateParameter");
  }
