...
/*package*/ class EditorExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.persistentPropertyDeclaration$YE4l;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.persistentPropertyDeclaration$YE4l);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.persistentPropertyDeclaration$YE4l);
    }
