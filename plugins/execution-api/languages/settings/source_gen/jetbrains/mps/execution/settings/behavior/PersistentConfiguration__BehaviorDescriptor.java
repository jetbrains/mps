...
public final class PersistentConfiguration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getGeneratedEditorName_idO$iR4J$g2J = new SMethodBuilder<>(String.class).name("getGeneratedEditorName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(946964771156066479L).languageId(0xbdf5a2ceb91b723cL, 0x756e911c3f1f4a48L).build2();
  public static final SMethod<String> getFullEditorName_idO$iR4J$g2V = new SMethodBuilder<>(String.class).name("getFullEditorName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(946964771156066491L).languageId(0xbdf5a2ceb91b723cL, 0x756e911c3f1f4a48L).build2();
  ...
  public static final SMethod<List<SNode>> getTemplateProperties_idO$iR4J$g3e = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getTemplateProperties").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(946964771156066510L).languageId(0xbdf5a2ceb91b723cL, 0x756e911c3f1f4a48L).build2();
  public static final SMethod<List<SNode>> getNonTemplateProperties_idO$iR4J$g3y = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getNonTemplateProperties").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(946964771156066530L).languageId(0xbdf5a2ceb91b723cL, 0x756e911c3f1f4a48L).build2();
  /*package*/ static final SMethod<String> getEditorSuffix_idO$iR4J$g3R = new SMethodBuilder<>(String.class).name("getEditorSuffix").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(946964771156066551L).languageId(0xbdf5a2ceb91b723cL, 0x756e911c3f1f4a48L).build2();
  ...
  public static final SMethod<SNode> getContextPersistentConfiguration_idO$iR4J$g1l = new SMethodBuilder<>(SNode.class).name("getContextPersistentConfiguration").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(946964771156066389L).languageId(0xbdf5a2ceb91b723cL, 0x756e911c3f1f4a48L).build2(SMethodBuilder.createJavaParameter(SNode.class, "node"));
  public static final SMethod<List<SNode>> getContextPersistentProperties_idO$iR4J$g22 = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getContextPersistentProperties").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(946964771156066434L).languageId(0xbdf5a2ceb91b723cL, 0x756e911c3f1f4a48L).build2(SMethodBuilder.createJavaParameter(SNode.class, "node"));
  public static final SMethod<String> getCheckMethodName_idO$iR4J$g2y = new SMethodBuilder<>(String.class).name("getCheckMethodName").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(946964771156066466L).languageId(0xbdf5a2ceb91b723cL, 0x756e911c3f1f4a48L).build2();
