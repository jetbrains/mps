...
public class typeof_PersistentPropertyDeclaration_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  private static SNode createJoinType_sacma3_a1a0c0i0b() {
    ...
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.argument$Iuyp).init(CONCEPTS.ClassifierType$bL);
      n2.setReference(LINKS.classifier$cxMr, new SNodePointer(facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~Cloneable")));
      SNodeBuilder n3 = n2.forSibling().init(CONCEPTS.ClassifierType$bL);
      n3.setReference(LINKS.classifier$cxMr, new SNodePointer(facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~Enum")));
      SNodeBuilder n4 = n3.forSibling().init(CONCEPTS.ClassifierType$bL);
      n4.setReference(LINKS.classifier$cxMr, new SNodePointer(facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~String")));
      SNodeBuilder n5 = n4.forSibling().init(CONCEPTS.BooleanType$_u);
      SNodeBuilder n6 = n5.forSibling().init(CONCEPTS.IntegerType$7a);
      SNodeBuilder n7 = n6.forSibling().init(CONCEPTS.FloatType$up);
      SNodeBuilder n8 = n7.forSibling().init(CONCEPTS.DoubleType$x0);
      SNodeBuilder n9 = n8.forSibling().init(CONCEPTS.CharType$JQ);
      SNodeBuilder n10 = n9.forSibling().init(CONCEPTS.ByteType$Ms);
      SNodeBuilder n11 = n10.forSibling().init(CONCEPTS.LongType$5X);
      SNodeBuilder n12 = n11.forSibling().init(CONCEPTS.ShortType$ro);
      SNodeBuilder n13 = n12.forSibling().init(CONCEPTS.TemplatePersistentConfigurationType$Qi);
    }
