...
public class typeof_PersistentPropertyDeclaration_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  private static SNode createJoinType_sacma3_a1a0c0i0b() {
    ...
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.argument$lCgz).init(CONCEPTS.ClassifierType$IZ);
      n2.setReference(LINKS.classifier$xslD, new SNodePointer(facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~Cloneable")));
      SNodeBuilder n3 = n2.forSibling().init(CONCEPTS.ClassifierType$IZ);
      n3.setReference(LINKS.classifier$xslD, new SNodePointer(facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~Enum")));
      SNodeBuilder n4 = n3.forSibling().init(CONCEPTS.ClassifierType$IZ);
      n4.setReference(LINKS.classifier$xslD, new SNodePointer(facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~String")));
