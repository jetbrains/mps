...
public final class AbstractRunConfigurationExecutor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getCanExecuteMethodName_id6LlKjXrMerG = new SMethodBuilder<>(String.class).name("getCanExecuteMethodName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7806358006983616236L).languageId(0x84036750153aa615L, 0x22e72e4c0f6946ceL).build2();
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    ...
    SPropertyOperations.assign(__thisNode__, PROPS.configurationName$Ks$, "myRunConfiguration");
  }
  ...
  /*package*/ static String getSuffix_idO$iR4JBsSb(@NotNull SNode __thisNode__) {
    return IGeneratedToClass__BehaviorDescriptor.getSuffix_idO$iR4JBsSb.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.configuration$CM7P)) + "_RunProfileState";
  }
  /*package*/ static String getGeneratedClassName_idO$iR4JBsSg(@NotNull SNode __thisNode__) {
    return ((String) IGeneratedToClass__BehaviorDescriptor.getGeneratedClassName_idO$iR4JBsSG.invoke(__thisNode__, SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.configuration$CM7P), PROPS.name$MnvL)));
  }
