...
public class RunConfigurationTypeContribution extends SubstituteMenuBase {
  public RunConfigurationTypeContribution() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Type", new SNodePointer("r:7d438dd6-fddd-4f98-b0ae-eed9d2bebdce(jetbrains.mps.execution.configurations.editor)", "4414733712827001199")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_82l17u_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_82l17u_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:7d438dd6-fddd-4f98-b0ae-eed9d2bebdce(jetbrains.mps.execution.configurations.editor)", "1741258697586930412")));
    }
    @Override
    protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts() {
      return Arrays.<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>asList(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Param_82l17u_a0(), CONCEPTS.RunConfigurationType$7_));
    }
    private class SMP_Param_82l17u_a0 extends ParameterizedMenuPart<SNode, SubstituteMenuItem, SubstituteMenuContext> {
      /*package*/ SMP_Param_82l17u_a0() {
        super(new EditorMenuDescriptorBase("parameterized substitute menu part", new SNodePointer("r:7d438dd6-fddd-4f98-b0ae-eed9d2bebdce(jetbrains.mps.execution.configurations.editor)", "1741258697586930447")));
      }
      @NotNull
      @Override
      ...
      private class SMP_Action_82l17u_a0a extends SingleItemSubstituteMenuPart {
        ...
        private class Item extends DefaultSubstituteMenuItem {
          ...
          public Item(SubstituteMenuContext context) {
            super(CONCEPTS.RunConfigurationType$7_, context);
            _context = context;
          }
          ...
          /*package*/ void resetTraceInfo() {
            ...
            updateTraceInfo(description, new SNodePointer("r:7d438dd6-fddd-4f98-b0ae-eed9d2bebdce(jetbrains.mps.execution.configurations.editor)", "1741258697586930497"));
          }

          @Nullable
          @Override
          public SNode createNode(@NotNull String pattern) {
            SNode node = SNodeFactoryOperations.createNewNode(CONCEPTS.RunConfigurationType$7_, null);
          ...
          protected CompletionItemInformation createInformation(String pattern) {
            return new CompletionItemInformation(myParameterObject, CONCEPTS.RunConfigurationType$7_, getMatchingText(pattern), getDescriptionText(pattern));
          }
          @Nullable
          @Override
          ...
          public String getDescriptionText(@NotNull String pattern) {
            return "runConfiguration<" + SPropertyOperations.getString(myParameterObject, PROPS.name$MnvL) + ">";
          }
        }
      }
