...
public class typeof_KeyValueCommandPart_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode keyValueCommandPart, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(keyValueCommandPart, LINKS.key$w4Z3);
    ...
    {
      SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(keyValueCommandPart, LINKS.value$wa9p);
  ...
  private static SNode createJoinType_jl7ika_a1a0c0b0b() {
    ...
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.argument$lCgz).init(CONCEPTS.StringType$2b);
      SNodeBuilder n3 = n2.forSibling().init(CONCEPTS.ClassifierType$IZ);
      n3.setReference(LINKS.classifier$xslD, new SNodePointer(facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.io(JDK/)"), facade.createNodeId("~File")));
  ...
  private static SNode createProcessBuilderCommandPartType_jl7ika_a1a0c0c0b() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ProcessBuilderCommandPartType$gI);
    return rootBuilder1.getResult();
  }
