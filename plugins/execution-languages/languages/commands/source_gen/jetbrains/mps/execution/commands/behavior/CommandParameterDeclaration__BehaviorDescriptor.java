...
public final class CommandParameterDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getSetterName_id6mJVBGGsi5s = new SMethodBuilder<>(String.class).name("getSetterName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7327337331549086044L).languageId(0x8ac91574f25c986fL, 0xf3347d8a0e794f35L).build2();
  public static final SMethod<String> getSetterLongName_id3gpm$NHlR8F = new SMethodBuilder<>(String.class).name("getSetterLongName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3754131050835964459L).languageId(0x8ac91574f25c986fL, 0xf3347d8a0e794f35L).build2();
  /*package*/ static final SMethod<String> getUpperCaseName_id6mJVBGGsi5H = new SMethodBuilder<>(String.class).name("getUpperCaseName").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(7327337331549086061L).languageId(0x8ac91574f25c986fL, 0xf3347d8a0e794f35L).build2();
  public static final SMethod<String> getFieldName_id6mJVBGGspQq = new SMethodBuilder<>(String.class).name("getFieldName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7327337331549117850L).languageId(0x8ac91574f25c986fL, 0xf3347d8a0e794f35L).build2();
  public static final SMethod<String> getFieldName_id6mJVBGGsi69 = new SMethodBuilder<>(String.class).name("getFieldName").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7327337331549086089L).languageId(0x8ac91574f25c986fL, 0xf3347d8a0e794f35L).build2(SMethodBuilder.createJavaParameter(String.class, "name"));
  public static final SMethod<String> getTypeSuffix_id3gpm$NHlXW7 = new SMethodBuilder<>(String.class).name("getTypeSuffix").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3754131050835992327L).languageId(0x8ac91574f25c986fL, 0xf3347d8a0e794f35L).build2(SMethodBuilder.createJavaParameter(SNode.class, "type"));
  public static final SMethod<String> getUpperCaseName_id6mJVBGGsi5Q = new SMethodBuilder<>(String.class).name("getUpperCaseName").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7327337331549086070L).languageId(0x8ac91574f25c986fL, 0xf3347d8a0e794f35L).build2(SMethodBuilder.createJavaParameter(String.class, "name"));
