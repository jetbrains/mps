...
public class SubstituteListCommandPart extends SubstituteMenuBase {
  public SubstituteListCommandPart() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "SubstituteListCommandPart", new SNodePointer("r:e255c21e-d39c-4295-8088-dd96816b455c(jetbrains.mps.execution.commands.editor)", "1741258697587103929")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Action_5b7y1v_a extends SingleItemSubstituteMenuPart {
    ...
    private class Item extends DefaultSubstituteMenuItem {
      ...
      /*package*/ void resetTraceInfo() {
        ...
        updateTraceInfo(description, new SNodePointer("r:e255c21e-d39c-4295-8088-dd96816b455c(jetbrains.mps.execution.commands.editor)", "1741258697587103931"));
      }
  ...
  private class SMP_Action_5b7y1v_b extends SingleItemSubstituteMenuPart {
    ...
    private class Item extends DefaultSubstituteMenuItem {
      ...
      /*package*/ void resetTraceInfo() {
        String description = "Substitute item: " + getMatchingText("");
        updateTraceInfo(description, new SNodePointer("r:e255c21e-d39c-4295-8088-dd96816b455c(jetbrains.mps.execution.commands.editor)", "1741258697587103979"));
      }
