...
<solution name="jetbrains.mps.ide.vcs" uuid="b0d98700-54f0-4c39-a8e0-bb27733b8b38" moduleVersion="0" pluginKind="PLUGIN_OTHER" compileInMPS="false">
  <compileInIDEA/>
  <models>
  ...
  <stubModelEntries>
    <stubModelEntry path="${mps_home}/plugins/vcs/lib/vcs-ide.jar" />
  </stubModelEntries>
  <sourcePath />
  <dependencies>
