...
public class ConstraintsAspectDescriptor extends BaseConstraintsAspectDescriptor {
  ...
  public ConstraintsDescriptor getConstraints(@NotNull SAbstractConcept concept, @NotNull ConstraintsDescriptorInitContext context) {
    ...
    switch (conceptIndex.index(cncpt)) {
      case 0:
        return new PrivateFieldReferenceOperation_Constraints(context);
      case 1:
        return new PrivateInstanceMethodCallOperation_Constraints(context);
      case 2:
        return new PrivateStaticFieldReference_Constraints(context);
      case 3:
        return new PrivateStaticMethodCall_Constraints(context);
      default:
    }
