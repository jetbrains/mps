...
public class ConstraintsAspectDescriptor extends BaseConstraintsAspectDescriptor {
  ...
  public ConstraintsDescriptor getConstraints(@NotNull SAbstractConcept concept, @NotNull ConstraintsDescriptorInitContext context) {
    ...
    switch (conceptIndex.index(cncpt)) {
      case 0:
        return new CanWrapHighLevelValue_ConceptFunction_Constraints(context);
      case 1:
        return new GetHighLevelValuePresentation_ConceptFunction_Constraints(context);
      case 2:
        return new GetHighLevelWatchablesBlock_ConceptFunction_Constraints(context);
      case 3:
        return new HighLevelWatchableCreator_Constraints(context);
      default:
    }
