...
/*package*/ class CustomWatchable_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell_Image fromImageCellProvider0() {
    String imagePath = (((_FunctionTypes._return_P0_E0<String>) () -> SPropertyOperations.getString(myNode, PROPS.iconPath$qD21))).invoke();
    return EditorCell_Image.createImageCell(getEditorContext(), myNode, imagePath);
  }
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.iconPath$qD21;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
