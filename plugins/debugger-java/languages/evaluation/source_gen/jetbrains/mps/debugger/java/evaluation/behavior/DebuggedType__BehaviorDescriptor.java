...
public final class DebuggedType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getHighClassifierType_id3WhGjgvCHCA = new SMethodBuilder<>(SNode.class).name("getHighClassifierType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4544608336420723238L).languageId(0x816251a896d78375L, 0x7da4580f9d754603L).build2();
  public static final SMethod<SNode> getLowClassifierType_id3WhGjgvCHDA = new SMethodBuilder<>(SNode.class).name("getLowClassifierType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4544608336420723302L).languageId(0x816251a896d78375L, 0x7da4580f9d754603L).build2();
