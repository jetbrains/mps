...
public class ToolController implements ItemExecutor {
  ...
  public ToolController(MPSProject project, ToolComponent toolComponent, SelectionMenuProvider menuProvider) {
    myProject = project;
    ...
    ApplicationManager.getApplication().executeOnPooledThread(() -> {
      ...
      try {
        ...
        myProject.getRepository().getModelAccess().runReadAction(() -> {
          ...
          items.value = ListSequence.fromList(items.value).where((it) -> it.isVisible()).sort((it) -> it.getLabel(), true).toList();
        });
