...
__switch__:
              switch (this.__CP__) {
                case -1:
                  ...
                  return false;
                case 2:
                  this._2__yield_6gh6m3_a0a0a0a_it = Sequence.fromIterable(ListSequence.fromList(ListSequence.fromListAndArray(new ArrayList<SNode>(), _quotation_createNode_6gh6m3_a0a0a0a0a0a0(), _quotation_createNode_6gh6m3_b0a0a0a0a0a0())).select((it) -> SNodeOperations.as(it, CONCEPTS.Statement$P6))).iterator();
                case 3:
...
__switch__:
              switch (this.__CP__) {
                case -1:
                  ...
                  return false;
                case 2:
                  this._2__yield_6gh6m3_a0a0a0e_it = Sequence.fromIterable(ListSequence.fromList(ListSequence.fromList(new ArrayList<SNode>())).translate((it) -> AttributeOperations.getChildNodesAndAttributes(it, LINKS.statement$53DE))).iterator();
                case 3:
