...
public class EnumerationDatatypes_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCache(EnumerationDatatypes_Test.class, "${mps_home}", "r:3526f944-06ad-48b3-a2a1-fffa752849ed(jetbrains.mps.smodel.test.smodelOperations@tests)", false));
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_init(SNode container) {
      ...
      Assert.assertFalse(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWODefault$6hVk), 0x61fc446ba477f2ddL));
      Assert.assertFalse(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWODefault$6hVk), 0x61fc446ba477f2deL));

      Assert.assertFalse(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWithDefault$6hti), 0x125bc18df9d40efaL));
      Assert.assertTrue(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWithDefault$6hti), 0x125bc18df9d40efbL));
    }
    public void test_setfirst(SNode container) {
      Assert.assertSame(SPropertyOperations.getEnum(container, PROPS.enumWODefault$6hVk), SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0xb02ae39f4c164545L, 0x8dfa88df16804e7eL, 0x55fd055f8f014df2L, "jetbrains.mps.lang.smodelTests.structure.TestEnum_WODefault"), 0x61fc446ba477f2ddL, "name_1"));
      Assert.assertSame(SPropertyOperations.getEnum(container, PROPS.enumWithDefault$6hti), SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0xb02ae39f4c164545L, 0x8dfa88df16804e7eL, 0x55fd055f8f014dbfL, "jetbrains.mps.lang.smodelTests.structure.TestEnum_WithDefault"), 0x125bc18df9d40efaL, "name_1"));

      Assert.assertTrue(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWODefault$6hVk), 0x61fc446ba477f2ddL));
      Assert.assertFalse(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWODefault$6hVk), 0x61fc446ba477f2deL));

      Assert.assertTrue(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWithDefault$6hti), 0x125bc18df9d40efaL));
      Assert.assertFalse(SEnumOperations.isMember(SPropertyOperations.getEnum(container, PROPS.enumWithDefault$6hti), 0x125bc18df9d40efbL));
    }
  }
