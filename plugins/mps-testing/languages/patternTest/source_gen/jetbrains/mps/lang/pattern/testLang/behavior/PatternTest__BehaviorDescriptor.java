...
public final class PatternTest__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getPatternTestName_idlS$o0er$H8 = new SMethodBuilder<>(String.class).name("getPatternTestName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(394224946578869064L).languageId(0xbc0a7c4da12f46e8L, 0x5206c8887c5d4275L).build2();
