...
/*package*/ class NodeTypeSystemErrorCheckOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new equationRefSingleRoleHandler_v8czwo_b0(myNode, LINKS.equationRef$I3dj, getEditorContext());
  ...
  private static class equationRefSingleRoleHandler_v8czwo_b0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.equationRef$I3dj, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.equationRef$I3dj, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new AggregationCellContext(myNode, child, LINKS.equationRef$I3dj, CONCEPTS.TypesystemEquationReference$Zj), new SubstituteInfoPartExt[]{new NodeTypeSystemErrorCheckOperation_generic_cellMenu_v8czwo_a0b0(), new SChildSubstituteInfoPartEx(editorCell)}));
      }
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.equationRef$I3dj);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.equationRef$I3dj));
      try {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new expectedMessageSingleRoleHandler_v8czwo_c0(myNode, LINKS.expectedMessage$6o6s, getEditorContext());
    return provider.createCell();
  }
