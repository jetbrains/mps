...
public class SLinkListAccess_ListModifyingOperaions_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_attributeAddLast() throws Exception {
      ...
      SNode attributeToAdd = SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x3a98b0957fe8e5d2L, "jetbrains.mps.lang.core.structure.SuppressErrorsAnnotation"));
      Assert.assertEquals(1, ListSequence.fromList(AttributeOperations.getAttributeList(SNodeOperations.cast(getNodeById("5158784817733657701"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xb02ae39f4c164545L, 0x8dfa88df16804e7eL, "jetbrains.mps.lang.smodelTests"), 0x2e6fb09209ce6473L, "ChildSubConceptSuppressError"))), new IAttributeDescriptor.NodeAttribute(CONCEPTS.SuppressErrorsAnnotation$D1))).count());
      ListSequence.fromList(AttributeOperations.getAttributeList(SNodeOperations.cast(getNodeById("5158784817733657701"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xb02ae39f4c164545L, 0x8dfa88df16804e7eL, "jetbrains.mps.lang.smodelTests"), 0x2e6fb09209ce6473L, "ChildSubConceptSuppressError"))), new IAttributeDescriptor.NodeAttribute(CONCEPTS.SuppressErrorsAnnotation$D1))).addElement(attributeToAdd);
      Assert.assertEquals(ListSequence.fromList(AttributeOperations.getAttributeList(SNodeOperations.cast(getNodeById("5158784817733657701"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xb02ae39f4c164545L, 0x8dfa88df16804e7eL, "jetbrains.mps.lang.smodelTests"), 0x2e6fb09209ce6473L, "ChildSubConceptSuppressError"))), new IAttributeDescriptor.NodeAttribute(CONCEPTS.SuppressErrorsAnnotation$D1))).last(), attributeToAdd);
    }
