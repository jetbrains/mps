...
/*package*/ class NodeWarningCheckOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    if (SNodeAccessUtil.hasProperty(myNode, PROPS.name$MnvL)) {
      editorCell.addEditorCell(createNonEmptyProperty_0());
    }
    return editorCell;
  }
  private boolean nodeCondition_sh9o09_a2a() {
    return (SLinkOperations.getTarget(myNode, LINKS.expectedMessage$6o6s) != null);
  }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new warningRefSingleRoleHandler_sh9o09_b0(myNode, LINKS.warningRef$9AXl, getEditorContext());
  ...
  private static class warningRefSingleRoleHandler_sh9o09_b0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.warningRef$9AXl, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.warningRef$9AXl, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      if (editorCell.getSubstituteInfo() == null || editorCell.getSubstituteInfo() instanceof DefaultSubstituteInfo) {
        editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new AggregationCellContext(myNode, child, LINKS.warningRef$9AXl, CONCEPTS.WarningStatementReference$SB), new SubstituteInfoPartExt[]{new NodeWarningCheckOperation_generic_cellMenu_sh9o09_a0b0(), new SChildSubstituteInfoPartEx(editorCell)}));
      }
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.warningRef$9AXl);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.warningRef$9AXl));
      try {
    ...
    public static class NodeWarningCheckOperation_generic_cellMenu_sh9o09_a0b0 extends AbstractCellMenuPart_Generic_Group {
      ...
      protected List<?> createParameterObjects(SNode node, EditorContext editorContext) {
        SAbstractConcept concept = CONCEPTS.WarningStatement$iV;
        ...
        return ListSequence.fromList(SetSequence.fromSet(warningInstances).toList()).select((it) -> SNodeOperations.cast(it, CONCEPTS.WarningStatement$iV)).toList();
      ...
      private void handleAction_impl(SNode parameterObject, SNode node, SModel model, EditorContext editorContext) {
        SLinkOperations.setTarget(node, LINKS.warningRef$9AXl, SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x8585453e6bfb4d80L, 0x98deb16074f1d86cL, 0x3ee2cbee8b386d76L, "jetbrains.mps.lang.test.structure.WarningStatementReference")));
        SLinkOperations.setTarget(SLinkOperations.getTarget(node, LINKS.warningRef$9AXl), LINKS.declaration$oKj7, parameterObject);
      }
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new expectedMessageSingleRoleHandler_sh9o09_c0(myNode, LINKS.expectedMessage$6o6s, getEditorContext());
    return provider.createCell();
  }
  private static class expectedMessageSingleRoleHandler_sh9o09_c0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      EditorCell editorCell = getUpdateSession().updateChildNodeCell(child);
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.expectedMessage$6o6s, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.expectedMessage$6o6s, child));
      installCellInfo(child, editorCell, false);
      return editorCell;
    }
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.expectedMessage$6o6s);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.expectedMessage$6o6s));
      try {
        EditorCell editorCell = super.createEmptyCell();
