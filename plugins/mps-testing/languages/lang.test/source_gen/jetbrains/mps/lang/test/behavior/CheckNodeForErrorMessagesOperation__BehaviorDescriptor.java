...
public final class CheckNodeForErrorMessagesOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static boolean expectsErrorsInside_id77$odk0vlBj(@NotNull SNode __thisNode__, NodeReportItem reportItem, SRepository ruleRepository, @Nullable ComponentHost host) {
    CheckErrorMessagesRunnable checkErrorsAction = new CheckErrorMessagesRunnable(INodesTestMethod__BehaviorDescriptor.getAnnotatedNode_id38gbJV0XvZR.invoke(__thisNode__), SPropertyOperations.getBoolean(__thisNode__, PROPS.allowWarnings$lvb6), SPropertyOperations.getBoolean(__thisNode__, PROPS.allowErrors$luW5), host).includeSelf(SPropertyOperations.getBoolean(__thisNode__, PROPS.includeSelf$xNXw));
