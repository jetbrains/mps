...
public final class TestProjectAware__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> requiresTestInfo_id1Zcerrmz81D = new SMethodBuilder<>(Boolean.TYPE).name("requiresTestInfo").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2291269767871103081L).languageId(0x98deb16074f1d86cL, 0x8585453e6bfb4d80L).build2();
