...
public final class NodeTypeSystemWarningCheckOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static final SMethod<String> getExpectedMessageText_id3q9wAW4tyBj = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getExpectedMessageText").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(3929815563185301971L).languageId(0x98deb16074f1d86cL, 0x8585453e6bfb4d80L).build2();
