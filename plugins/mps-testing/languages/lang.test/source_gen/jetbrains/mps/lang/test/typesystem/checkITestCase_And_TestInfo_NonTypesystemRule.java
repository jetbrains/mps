...
import jetbrains.mps.lang.test.behavior.TestProjectAware__BehaviorDescriptor;
...
public class checkITestCase_And_TestInfo_NonTypesystemRule extends AbstractNonTypesystemRule_Runtime implements NonTypesystemRule_Runtime {
  ...
  public void applyRule(final SNode iTestCase, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if ((boolean) ITestable__BehaviorDescriptor.isMpsStartRequired_id2RMg39tmiFh.invoke(iTestCase) && SNodeOperations.isInstanceOf(iTestCase, CONCEPTS.TestProjectAware$TE) && (boolean) TestProjectAware__BehaviorDescriptor.requiresTestInfo_id1Zcerrmz81D.invoke(SNodeOperations.cast(iTestCase, CONCEPTS.TestProjectAware$TE)) && ListSequence.fromList(SModelOperations.roots(SNodeOperations.getModel(iTestCase), CONCEPTS.TestInfo$9q)).isEmpty()) {
      {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SInterfaceConcept TestProjectAware$TE = MetaAdapterFactory.getInterfaceConcept(0x8585453e6bfb4d80L, 0x98deb16074f1d86cL, 0x1fcc39b6d68cb962L, "jetbrains.mps.lang.test.structure.TestProjectAware");
