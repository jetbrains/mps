...
public final class AbstractNodeErrorCheckOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static final SMethod<String> getExpectedMessageText_id6kTaUF4b1ss = new SMethodBuilder<>(String.class).name("getExpectedMessageText").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(7293909083938887452L).languageId(0x98deb16074f1d86cL, 0x8585453e6bfb4d80L).build2();
