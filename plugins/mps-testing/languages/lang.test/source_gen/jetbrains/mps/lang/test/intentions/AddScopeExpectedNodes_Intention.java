  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      for (SNode avaliable : scope.getAvailableElements(null)) {
        ...
        SLinkOperations.setTarget(expectedNode, LINKS.ref$RHE6, avaliable);
        ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.nodes$Many)).addElement(expectedNode);
      }
    }
    ...
    private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
      return SLinkOperations.getTarget(node, LINKS.checkingReference$LcK9) != null;
    }
