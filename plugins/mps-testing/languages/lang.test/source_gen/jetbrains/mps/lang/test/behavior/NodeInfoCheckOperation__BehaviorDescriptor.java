...
public final class NodeInfoCheckOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getReferencedRuleNode_id2wBFdLy8qmt = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getReferencedRuleNode").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2wBFdLy8qmt").build();
  ...
  /*package*/ static final SMethod<String> getExpectedMsgText_id3q9wAW4tvJ6 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getExpectedMsgText").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).id("3q9wAW4tvJ6").build();
