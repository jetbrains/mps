...
public final class NodeInfoCheckOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> canAttachReference_id2wBFdLy7HtS = new SMethodBuilder<>(Boolean.TYPE).name("canAttachReference").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2893471348147804024L).languageId(0x98deb16074f1d86cL, 0x8585453e6bfb4d80L).build2(SMethodBuilder.createJavaParameter(SNode.class, "reference"));
  public static final SMethod<Void> attachReference_id2wBFdLy8qmn = new SMethodBuilder<>(Void.TYPE).name("attachReference").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2893471348147987863L).languageId(0x98deb16074f1d86cL, 0x8585453e6bfb4d80L).build2(SMethodBuilder.createJavaParameter(SNode.class, "reference"));
  public static final SMethod<SNode> getReference_id7eBNsYUkslm = new SMethodBuilder<>(SNode.class).name("getReference").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8333855927540237654L).languageId(0x98deb16074f1d86cL, 0x8585453e6bfb4d80L).build2();
  public static final SMethod<SNode> getReferencedRuleNode_id2wBFdLy8qmt = new SMethodBuilder<>(SNode.class).name("getReferencedRuleNode").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2893471348147987869L).languageId(0x98deb16074f1d86cL, 0x8585453e6bfb4d80L).build2();
  ...
  /*package*/ static final SMethod<String> getExpectedMsgText_id3q9wAW4tvJ6 = new SMethodBuilder<>(String.class).name("getExpectedMsgText").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(3929815563185290182L).languageId(0x98deb16074f1d86cL, 0x8585453e6bfb4d80L).build2();
  ...
  /*package*/ static void attachReference_id2wBFdLy8qmn(@NotNull SNode __thisNode__, SNode reference) {
    ...
    SLinkOperations.setTarget(__thisNode__, LINKS.statementRef$zSVB, SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0x8585453e6bfb4d80L, 0x98deb16074f1d86cL, 0x1de1fbd5fbfe9cf9L, "jetbrains.mps.lang.test.structure.InfoStatementReference")));
    SLinkOperations.setTarget(SLinkOperations.getTarget(__thisNode__, LINKS.statementRef$zSVB), LINKS.declaration$oKj7, SNodeOperations.cast(reference, CONCEPTS.InfoStatement$Y5));
  }
  /*package*/ static SNode getReference_id7eBNsYUkslm(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.statementRef$zSVB);
  }
  /*package*/ static SNode getReferencedRuleNode_id2wBFdLy8qmt(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(SLinkOperations.getTarget(__thisNode__, LINKS.statementRef$zSVB), LINKS.declaration$oKj7);
  }
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink statementRef$zSVB = MetaAdapterFactory.getContainmentLink(0x8585453e6bfb4d80L, 0x98deb16074f1d86cL, 0x1de1fbd5fbfe6272L, 0x1de1fbd5fbfe97adL, "statementRef");
