...
public final class AnonymousCellAnnotation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> setupSelection_id5rZKa_fUiYP = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("setupSelection").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("5rZKa_fUiYP").build(SMethodBuilder.createJavaParameter(NodeEditorComponent.class, ""), SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""), SMethodBuilder.createJavaParameter((Class<Map<SNode, SNode>>) ((Class) Object.class), ""));
  public static final SMethod<EditorComponent> setupSelection_id5g7DxxpaP55 = new SMethodBuilder<EditorComponent>(new SJavaCompoundTypeImpl(EditorComponent.class)).name("setupSelection").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("5g7DxxpaP55").build(SMethodBuilder.createJavaParameter(NodeEditorComponent.class, ""), SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""), SMethodBuilder.createJavaParameter((Class<Map<SNode, SNode>>) ((Class) Object.class), ""));
  public static final SMethod<Integer> getCaretPosition_id5rZKa_fUlry = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("getCaretPosition").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("5rZKa_fUlry").build(SMethodBuilder.createJavaParameter(EditorCell_Label.class, ""));
  /*package*/ static final SMethod<Void> setupCaretAndSelection_id7TYU6fNl1yz = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("setupCaretAndSelection").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).id("7TYU6fNl1yz").build(SMethodBuilder.createJavaParameter(EditorCell.class, ""));
