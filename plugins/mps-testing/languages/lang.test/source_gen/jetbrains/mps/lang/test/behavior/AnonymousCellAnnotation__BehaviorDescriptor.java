...
public final class AnonymousCellAnnotation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Integer> getCaretPosition_id5rZKa_fUlry = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("getCaretPosition").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6268941039745717986L).languageId(0x98deb16074f1d86cL, 0x8585453e6bfb4d80L).build2(SMethodBuilder.createJavaParameter(EditorCell_Label.class, ""));
  /*package*/ static final SMethod<Void> setupCaretAndSelection_id7TYU6fNl1yz = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("setupCaretAndSelection").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(9114978211826243747L).languageId(0x98deb16074f1d86cL, 0x8585453e6bfb4d80L).build2(SMethodBuilder.createJavaParameter(EditorCell.class, ""));
