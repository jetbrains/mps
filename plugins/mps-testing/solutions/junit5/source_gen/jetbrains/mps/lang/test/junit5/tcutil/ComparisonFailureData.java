...
public class ComparisonFailureData {
  ...
  public static void registerSMAttributes(ComparisonFailureData notification, String trace, String failureMessage, Map attrs, Throwable throwable, String comparisonFailurePrefix, final String expectedPrefix) {
  ...
  private static ComparisonFailureData createCommonAssertion(Throwable assertion) {
    try {
      ...
      if (assertionClass.getName().equals(OPENTEST4J_ASSERTION)) {
        ...
        if (((Boolean) assertionClass.getDeclaredMethod("isExpectedDefined", parameterTypes).invoke(assertion, args)).booleanValue() && ((Boolean) assertionClass.getDeclaredMethod("isActualDefined", parameterTypes).invoke(assertion, args)).booleanValue()) {
