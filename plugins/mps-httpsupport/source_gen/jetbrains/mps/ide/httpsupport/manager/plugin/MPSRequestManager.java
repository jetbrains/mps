...
public class MPSRequestManager extends HttpRequestHandler {
  ...
  public boolean isAccessible(@NotNull HttpRequest request) {
    // Dosamethingsthatsuper.isAccessible(request)doesexceptthatthisdefinition
    // alsoacceptslocalrequeststhattriggeredbytrustedhosts(notonlybyuserdirectly)
    // TODOAtcurrentstageusercannotdefinetheirowntrustedhosts(seeMPS-27006)
