...
public final class RequestURLBuilderExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Iterable<SNode>> getInitializedParameters_id40BYgt09_iZ = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("getInitializedParameters").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4622937352055444671L).languageId(0x98a115e9f32231f1L, 0x817e4e70961e4a95L).build2();
