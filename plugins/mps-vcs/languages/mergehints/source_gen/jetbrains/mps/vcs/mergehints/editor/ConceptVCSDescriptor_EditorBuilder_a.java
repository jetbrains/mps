...
/*package*/ class ConceptVCSDescriptor_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.cncpt$ubC$;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.cncpt$ubC$);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.cncpt$ubC$);
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new strategySingleRoleHandler_94pzwf_d0a0(myNode, LINKS.strategy$rJZs, getEditorContext());
  ...
  private static class strategySingleRoleHandler_94pzwf_d0a0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.strategy$rJZs, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.strategy$rJZs, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.strategy$rJZs);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.strategy$rJZs));
      try {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new featuresListHandler_94pzwf_b1a(myNode, getEditorContext());
  ...
  private static class featuresListHandler_94pzwf_b1a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.features$1ZkL;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.FeatureVCSDescriptor$Jv;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(featuresListHandler_94pzwf_b1a.this.getNode(), LINKS.features$1ZkL));
      try {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept FeatureVCSDescriptor$Jv = MetaAdapterFactory.getConcept(0x37e03aa1728949bcL, 0x826930de5eceec76L, 0x4f2cc0d970a4f875L, "jetbrains.mps.vcs.mergehints.structure.FeatureVCSDescriptor");
  }
