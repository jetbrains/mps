...
/*package*/ final class DiffUtil {
  ...
  /*package*/ static Iterable<ModelChange> collectPropertyChanges(@NotNull final ChangeSet changeSet, @NotNull final SNode oldNode, @NotNull final SNode newNode) {
    Iterable<SProperty> oldProperties = oldNode.getProperties();
    Iterable<SProperty> newProperties = newNode.getProperties();
  ...
  /*package*/ static Iterable<ModelChange> collectPropertyChanges(@NotNull final ChangeSet changeSet, @NotNull final SNode oldNode, @NotNull final SNode newNode, @NotNull final SProperty property) {
    if (propertiesAreEqual(oldNode, newNode, property)) {
...
__switch__:
  ...
  /*package*/ static Iterable<ModelChange> collectReferenceChanges(@NotNull final ChangeSet changeSet, @NotNull final SNode oldNode, @NotNull final SNode newNode) {
  ...
  /*package*/ static Iterable<ModelChange> collectReferenceChanges(@NotNull final ChangeSet changeSet, @NotNull final SNode oldNode, @NotNull final SNode newNode, @NotNull final SReferenceLink role) {
...
__switch__:
  ...
  /*package*/ static Iterable<ModelChange> collectConceptChanges(final ChangeSet changeSet, @NotNull final SNode oldNode, @NotNull SNode newNode) {
...
__switch__:
  ...
  /*package*/ static Iterable<ModelChange> collectNodeChanges(@NotNull ChangeSet changeSet, @NotNull SNode oldNode, @NotNull SNode newNode) {
