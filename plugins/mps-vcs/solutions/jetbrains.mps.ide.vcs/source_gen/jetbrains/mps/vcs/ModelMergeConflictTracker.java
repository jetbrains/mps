...
public final class ModelMergeConflictTracker implements ProjectLifecycleListener {
  ...
  public void projectReady(@NotNull MPSProject project, @NotNull ProjectLifecycleListener.Context context) {
    LoadSaveProblemsListener listener = new LoadSaveProblemsListener(project);
    new RepoListenerRegistrar(project.getRepository(), listener).attach();
    context.keep(LoadSaveProblemsListener.class, listener);
  }
  @Override
  public void projectDiscarded(@NotNull MPSProject project, @NotNull ProjectLifecycleListener.Context context) {
    LoadSaveProblemsListener listener = context.discard(LoadSaveProblemsListener.class);
    if (listener != null) {
      new RepoListenerRegistrar(project.getRepository(), listener).detach();
    }
  }
