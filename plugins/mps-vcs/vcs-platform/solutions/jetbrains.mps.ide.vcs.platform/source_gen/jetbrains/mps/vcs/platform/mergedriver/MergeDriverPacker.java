...
public abstract class MergeDriverPacker {
  ...
  private static final Iterable<String> ideaLibJars = Arrays.asList("asm-all-8.0.1.jar", "xstream-1.4.11.1.jar", "guava-29.0-jre.jar", "jdom.jar", "log4j.jar", "trove4j.jar", "annotations.jar");
