...
/*package*/ class GitMergeDriverInstaller extends AbstractInstaller {
  ...
  private List<VcsRoot> getGitRoots() {
    return Sequence.fromIterable(Sequence.fromArray((ServiceManager.getService(myProject, ProjectLevelVcsManager.class)).getAllVcsRoots())).where(new IWhereFilter<VcsRoot>() {
