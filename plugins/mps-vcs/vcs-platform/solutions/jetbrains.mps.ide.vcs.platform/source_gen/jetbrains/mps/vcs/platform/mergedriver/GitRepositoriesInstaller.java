...
@GeneratedClass(node = "r:36539f52-7ec3-4937-98bf-1fbc1fbe99fc(jetbrains.mps.vcs.platform.mergedriver)/572687202609933800", model = "r:36539f52-7ec3-4937-98bf-1fbc1fbe99fc(jetbrains.mps.vcs.platform.mergedriver)")
/*package*/ class GitRepositoriesInstaller extends AbstractInstaller {
  ...
  private Iterable<VcsRoot> getGitRoots() {
    VcsRoot[] allRoots = (ServiceManager.getService(myProject, ProjectLevelVcsManager.class)).getAllVcsRoots();
