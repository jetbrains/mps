...
public class CommandHolder_Empty_Snippets extends TransformationMenuBase {
  ...
  private static SNode createBLExpression_vryvy0_a0a0a0a() {
    ...
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.BLExpression$WS);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.expression$A9uN).init(CONCEPTS.DotExpression$yW);
      {
        SNodeBuilder n3 = n2.forChild(LINKS.operand$w6IR).init(CONCEPTS.DotExpression$yW);
        {
          SNodeBuilder n4 = n3.forChild(LINKS.operand$w6IR).init(CONCEPTS.InstancesExpression$nT);
          {
            SNodeBuilder n5 = n4.forChild(LINKS.conceptArg$eEYy).init(CONCEPTS.RefConcept_Reference$Ij);
            n5.setReference(LINKS.conceptDeclaration$3mP7, new SNodePointer(facade.createModelReference("r:00000000-0000-4000-0000-011c89590288(jetbrains.mps.lang.core.structure)"), facade.createNodeId("1133920641626")));
          }
          {
            SNodeBuilder n6 = n4.forChild(LINKS.parameter$jM02).init(CONCEPTS.QueryParameterList$3N);
            {
              SNodeBuilder n7 = n6.forChild(LINKS.parameter$clir).init(CONCEPTS.QueryParameterScope$YW);
              n7.forChild(LINKS.value$y3rn).init(CONCEPTS.ProjectEditableScope$p4);
            }
          }
        }
        {
          SNodeBuilder n8 = n3.forChild(LINKS.operation$gs9E).init(CONCEPTS.WhereOperation$WR);
          {
            SNodeBuilder n9 = n8.forChild(LINKS.closure$Rjuo).init(CONCEPTS.ClosureLiteral$rp);
            n9.setProperty(PROPS.forceMultiLine$AhIn, PROPS.forceMultiLine$AhIn.getType().toString(true));
            {
              SNodeBuilder n10 = n9.forChild(LINKS.body$Ujx2).init(CONCEPTS.StatementList$m_);
              {
                SNodeBuilder n11 = n10.forChild(LINKS.statement$53DE).init(CONCEPTS.SingleLineComment$Kw);
                {
                  SNodeBuilder n12 = n11.forChild(LINKS.text$XpYF).init(CONCEPTS.Line$yC);
                  {
                    SNodeBuilder n13 = n12.forChild(LINKS.elements$_j45).init(CONCEPTS.Word$Dn);
                    n13.setProperty(PROPS.value$zQr_, "TODO");
                    SNodeBuilder n14 = n13.forSibling().init(CONCEPTS.Word$Dn);
                    n14.setProperty(PROPS.value$zQr_, "specify");
                    SNodeBuilder n15 = n14.forSibling().init(CONCEPTS.Word$Dn);
                    n15.setProperty(PROPS.value$zQr_, "condition");
                  }
                }
                SNodeBuilder n16 = n11.forSibling().init(CONCEPTS.ExpressionStatement$O8);
                {
                  SNodeBuilder n17 = n16.forChild(LINKS.expression$5L7M).init(CONCEPTS.BooleanConstant$n4);
                  n17.setProperty(PROPS.value$5y_M, PROPS.value$5y_M.getType().toString(true));
                }
              }
            }
            {
              SNodeBuilder n18 = n9.forChild(LINKS.parameter$b4Y3).init(CONCEPTS.SmartClosureParameterDeclaration$bO);
              n18.setProperty(PROPS.name$MnvL, "node");
              n18.forChild(LINKS.type$a1UY).init(CONCEPTS.UndefinedType$uv);
            }
          }
        }
      }
      {
        SNodeBuilder n19 = n2.forChild(LINKS.operation$gs9E).init(CONCEPTS.RefactorOperation$hX);
        {
          SNodeBuilder n20 = n19.forChild(LINKS.closure$Rjuo).init(CONCEPTS.ClosureLiteral$rp);
          n20.setProperty(PROPS.forceMultiLine$AhIn, PROPS.forceMultiLine$AhIn.getType().toString(true));
          {
            SNodeBuilder n21 = n20.forChild(LINKS.body$Ujx2).init(CONCEPTS.StatementList$m_);
            {
              SNodeBuilder n22 = n21.forChild(LINKS.statement$53DE).init(CONCEPTS.SingleLineComment$Kw);
              {
                SNodeBuilder n23 = n22.forChild(LINKS.text$XpYF).init(CONCEPTS.Line$yC);
                {
                  SNodeBuilder n24 = n23.forChild(LINKS.elements$_j45).init(CONCEPTS.Word$Dn);
                  n24.setProperty(PROPS.value$zQr_, "TODO");
                  SNodeBuilder n25 = n24.forSibling().init(CONCEPTS.Word$Dn);
                  n25.setProperty(PROPS.value$zQr_, "specify");
                  SNodeBuilder n26 = n25.forSibling().init(CONCEPTS.Word$Dn);
                  n26.setProperty(PROPS.value$zQr_, "action");
                }
              }
            }
          }
          {
            SNodeBuilder n27 = n20.forChild(LINKS.parameter$b4Y3).init(CONCEPTS.SmartClosureParameterDeclaration$bO);
            n27.setProperty(PROPS.name$MnvL, "node");
            n27.forChild(LINKS.type$a1UY).init(CONCEPTS.UndefinedType$uv);
          }
        }
      }
    }
  ...
  private static SNode createBLExpression_vryvy0_a0a0a1a() {
    ...
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.BLExpression$WS);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.expression$A9uN).init(CONCEPTS.ShowExpression$ue);
      {
        SNodeBuilder n3 = n2.forChild(LINKS.object$A1S4).init(CONCEPTS.DotExpression$yW);
        {
          SNodeBuilder n4 = n3.forChild(LINKS.operand$w6IR).init(CONCEPTS.InstancesExpression$nT);
          {
            SNodeBuilder n5 = n4.forChild(LINKS.conceptArg$eEYy).init(CONCEPTS.RefConcept_Reference$Ij);
        ...
        }
        {
          SNodeBuilder n8 = n3.forChild(LINKS.operation$gs9E).init(CONCEPTS.WhereOperation$WR);
          {
            ...
            {
              SNodeBuilder n16 = n9.forChild(LINKS.parameter$b4Y3).init(CONCEPTS.SmartClosureParameterDeclaration$bO);
              n16.setProperty(PROPS.name$MnvL, "node");
              n16.forChild(LINKS.type$a1UY).init(CONCEPTS.UndefinedType$uv);
            }
          }
        }
      }
