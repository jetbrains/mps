...
public class CommandHolder_Empty_Snippets extends TransformationMenuBase {
  public CommandHolder_Empty_Snippets() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "named transformation menu " + "CommandHolder_EmptyCell_TransformationMenu", new SNodePointer("r:5d9868cc-091b-49b3-85eb-87af773e0884(jetbrains.mps.console.ideCommands.editor)", "9041541628639360365")), List.<String>of(MenuLocations.CONTEXT_ASSISTANT));
  }
  ...
  private class TMP_Action_vryvy0_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:5d9868cc-091b-49b3-85eb-87af773e0884(jetbrains.mps.console.ideCommands.editor)", "9041541628638947534"));
        return this;
      }
      @Nullable
      @Override
  ...
  private class TMP_Action_vryvy0_b0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:5d9868cc-091b-49b3-85eb-87af773e0884(jetbrains.mps.console.ideCommands.editor)", "7452996865427022503"));
        return this;
      }
      @Nullable
      @Override
