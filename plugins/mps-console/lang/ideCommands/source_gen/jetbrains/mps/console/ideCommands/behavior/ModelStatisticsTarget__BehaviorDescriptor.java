...
public final class ModelStatisticsTarget__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static SModel resolveModel_id4xqDcS7DWbP(@NotNull SNode __thisNode__, SRepository repo) {
    SModel m = null;
    SModelReference ref = ModelIdentity__BehaviorDescriptor.toModelReference_id1Bs_61$mvvu.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.target$GlCF));
    if (ref != null) {
      m = ref.resolve(repo);
    }
    return m;
