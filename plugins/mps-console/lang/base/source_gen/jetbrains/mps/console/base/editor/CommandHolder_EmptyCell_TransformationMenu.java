...
public class CommandHolder_EmptyCell_TransformationMenu extends TransformationMenuBase {
  public CommandHolder_EmptyCell_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "CommandHolder_EmptyCell_TransformationMenu", new SNodePointer("r:f09c85c2-fb88-4283-852e-78d5fc87420e(jetbrains.mps.console.base.editor)", "9041541628638947515")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
