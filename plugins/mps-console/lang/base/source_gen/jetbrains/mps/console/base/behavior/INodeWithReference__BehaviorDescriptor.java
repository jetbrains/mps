...
public final class INodeWithReference__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String getTextWhenBroken_idigjXyuNrou(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(__thisNode__, PROPS.referencePresentation$r1y1) + " (deleted node)";
  }
  /*package*/ static boolean isBroken_id7m$hACyVN2F(@NotNull SNode __thisNode__) {
    if (SLinkOperations.getTarget(__thisNode__, LINKS.target$CsE) == null || (check_rmj4zv_a0a0a0e(SNodeOperations.getModel(__thisNode__)) == null)) {
      return true;
    }
    return !(SNodeUtil.isAccessible(SLinkOperations.getTarget(__thisNode__, LINKS.target$CsE), SNodeOperations.getModel(__thisNode__).getRepository()));
  }
  ...
  private static final class PROPS {
    /*package*/ static final SProperty referencePresentation$r1y1 = MetaAdapterFactory.getProperty(0xde1ad86d6e504a02L, 0xb306d4d17f64c375L, 0x36ac6f29ae8c1fb5L, 0x4904fd89e75e1c4L, "referencePresentation");
  }
}
