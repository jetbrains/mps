...
public class HelpConceptReference_SmartReference extends SubstituteMenuBase {
  public HelpConceptReference_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "HelpConceptReference_SmartReference", new SNodePointer("r:f09c85c2-fb88-4283-852e-78d5fc87420e(jetbrains.mps.console.base.editor)", "4747359941571311668")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_gtqjni_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_gtqjni_a() {
      super(CONCEPTS.HelpConceptReference$Y8, LINKS.command$b3Jl, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:f09c85c2-fb88-4283-852e-78d5fc87420e(jetbrains.mps.console.base.editor)", "4747359941571311666")));
    }
