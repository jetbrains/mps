...
public final class NodeReferenceString__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getText_id5E451QuvdoB, getTextWhenBroken_idigjXyuNrou);


  /*package*/ static String getText_id5E451QuvdoB(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(__thisNode__, PROPS.referencePresentation$r1y1);
  }
