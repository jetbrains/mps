...
public class print extends TransformationMenuBase {
  public print() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default transformation menu for " + "Expression", new SNodePointer("r:f09c85c2-fb88-4283-852e-78d5fc87420e(jetbrains.mps.console.base.editor)", "5286186381821047465")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM));
  }
