...
public class CommandHolderRef_SubstituteMenu extends SubstituteMenuBase {
  public CommandHolderRef_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for CommandHolderRef. Generated from implicit smart reference attribute.", new SNodePointer("r:359b1d2b-77c4-46df-9bf2-b25cbea32254(jetbrains.mps.console.base.structure)", "5758176878586720817")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_ckvqv2_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_ckvqv2_a() {
      super(CONCEPTS.CommandHolderRef$9c, LINKS.target$kCjp, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_ckvqv2_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_ckvqv2_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "CommandHolderRef", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.CommandHolderRef$9c);
    }
