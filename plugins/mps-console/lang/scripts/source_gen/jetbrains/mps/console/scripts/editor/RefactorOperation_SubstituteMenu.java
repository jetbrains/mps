...
public class RefactorOperation_SubstituteMenu extends SubstituteMenuBase {
  public RefactorOperation_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "RefactorOperation", new SNodePointer("r:9fe44883-19b9-49f5-b65d-10b7b410436b(jetbrains.mps.console.scripts.editor)", "1741258697586930332")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_wjsnk9_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_wjsnk9_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:9fe44883-19b9-49f5-b65d-10b7b410436b(jetbrains.mps.console.scripts.editor)", "2660922206084153591")));
    }
    @Override
