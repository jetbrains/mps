...
public class ConsoleStreamImpl implements ConsoleStream {
  ...
  public void addText(String text) {
    ...
    while (scanner.hasNextLine()) {
      ...
      if ((line != null && line.length() > 0)) {
        addResponse(createTextResponseItem_kp3e3v_a0a0b0b0e(line));
      }
      if (scanner.hasNextLine() || text.charAt(text.length() - 1) == '\n') {
        addResponse(createNewLineResponseItem_kp3e3v_a0a0c0b0e());
      }
    }
  }
  private void addResponse(final SNode response) {
    ...
    ApplicationManager.getApplication().invokeLater(new Runnable() {
      public void run() {
        ...
        myTab.getProject().getModelAccess().executeCommand(new EditorCommand(myTab.getEditorComponent()) {
          public void doExecute() {
            myTab.addNodeImports(response);
            ListSequence.fromList(SLinkOperations.getChildren(myTab.getLastReponse(), MetaAdapterFactory.getContainmentLink(0xde1ad86d6e504a02L, 0xb306d4d17f64c375L, 0x4e3b035171a5ba02L, 0x4e3b035171b356edL, "item"))).addElement(response);
          }
        });
      }
    });
  ...
  public void addNode(final SNode node) {
    addResponse(createNodeResponseItem_kp3e3v_a0a0g(node));
  }
  ...
  private static SNode createNewLineResponseItem_kp3e3v_a0a0c0b0e() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
  ...
  private static SNode createNodeResponseItem_kp3e3v_a0a0g(SNode node0) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
