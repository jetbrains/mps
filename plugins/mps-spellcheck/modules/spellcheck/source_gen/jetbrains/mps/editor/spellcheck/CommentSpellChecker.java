...
public class CommentSpellChecker extends BaseEditorChecker {
  ...
  public CommentSpellChecker(MPSProject project) {
  ...
  public static void addToDictionary(@NotNull MPSProject project, @NotNull String word) {
    Project ideaProject = project.getProject();
    SpellCheckerManager scm = SpellCheckerManager.getInstance(ideaProject);
    if (scm == null) {
      return;
    }
    scm.acceptWordAsCorrect(word, ideaProject);
  }
