...
public final class ShortNodeType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getConceptType_id4VnyIrvoQ8N = new SMethodBuilder<>(SNode.class).name("getConceptType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5681162179146113587L).languageId(0xaf06fc1cd08b495aL, 0xeb56ebf4df56438eL).build2();
