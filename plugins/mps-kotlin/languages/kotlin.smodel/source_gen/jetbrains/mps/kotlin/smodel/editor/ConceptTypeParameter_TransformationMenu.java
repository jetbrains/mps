...
public class ConceptTypeParameter_TransformationMenu extends TransformationMenuBase {
  ...
  private class TMP_Param_wnfc0w_a0 extends ParameterizedMenuPart<SEnumerationLiteral, TransformationMenuItem, TransformationMenuContext> {
    ...
    private class TMP_Action_wnfc0w_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        ...
        try {
          context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:ea3af2e4-d2a0-4af5-9025-3843d79c1cde(jetbrains.mps.kotlin.smodel.editor)", "4217388692997061347")));
  ...
  private class TMP_Action_wnfc0w_b0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected TransformationMenuItem createItem(TransformationMenuContext context) {
      ...
      context.getEditorMenuTrace().pushTraceInfo();
      try {
        context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:ea3af2e4-d2a0-4af5-9025-3843d79c1cde(jetbrains.mps.kotlin.smodel.editor)", "4217388692997073557")));
        item.setTraceInfo(context.getEditorMenuTrace().getTraceInfo());
      } finally {
        context.getEditorMenuTrace().popTraceInfo();
      }
