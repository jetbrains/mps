...
public final class NodeReferenceType__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xeb56ebf4df56438eL, 0xaf06fc1cd08b495aL, 0x3248aa7224556638L, "jetbrains.mps.kotlin.smodel.structure.NodeReferenceType");
  ...
  /*package*/ static String getTypeErasedName_idAa0Z14exTA(@NotNull SNode __thisNode__) {
    return "SNodeReference";
  }
  /*package*/ static SNodeReference getJavaClassPointer_idAa0Z14eCoU(@NotNull SNode __thisNode__) {
    return new SNodePointer("8865b7a8-5271-43d3-884c-6fd1d9cfdd34/java:org.jetbrains.mps.openapi.model(MPS.OpenAPI/)", "~SNodeReference");
  }

  /*package*/ NodeReferenceType__BehaviorDescriptor() {
  }
