...
public final class NullableType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static final SMethod<String> toStringInternal_id41oFOFuJUdT = new SMethodBuilder<>(String.class).name("toStringInternal").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(4636648552477467513L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2(SMethodBuilder.createJavaParameter(String.class, "subtypeString"), SMethodBuilder.createJavaParameter(Boolean.TYPE, "isErased"));
  ...
  public static final SMethod<Boolean> showParenthesis_id3PNJzGvtdRU = new SMethodBuilder<>(Boolean.TYPE).name("showParenthesis").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4428092019775430138L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2();
  ...
  /*package*/ static SignatureScope getStaticScope_id1ODRHGtufGw(@NotNull SNode __thisNode__, SignatureFilter filter, FullScopeContext context) {
    return (SignatureScope) IType__BehaviorDescriptor.getStaticScope_id1ODRHGtufGw.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.type$Tm0J), filter, context);
  }
