...
/*package*/ class LocalPropertyDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new assignmentSingleRoleHandler_i7sp49_g0(myNode, LINKS.assignment$nl1j, getEditorContext());
    return provider.createCell();
  }
  private static class assignmentSingleRoleHandler_i7sp49_g0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public assignmentSingleRoleHandler_i7sp49_g0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
