  ...
  private class TMP_Action_4totud_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "1848838727258168431"));
        return this;
      }
      @Nullable
      @Override
      ...
      public void execute(@NotNull String pattern) {
        SNode newConstraint = SNodeFactoryOperations.addNewChild(_context.getNode(), LINKS.constraints$BRhr, null);
        _context.getEditorContext().selectWRTFocusPolicy(newConstraint);
      }
