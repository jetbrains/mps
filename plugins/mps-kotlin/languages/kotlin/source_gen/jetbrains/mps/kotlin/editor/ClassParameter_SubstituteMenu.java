...
public class ClassParameter_SubstituteMenu extends SubstituteMenuBase {
  ...
  private class SMP_Wrap_xrak1v_a extends WrapperSubstituteMenuPart {
    ...
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
      ...
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "IType", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "2998782254608359831")));
      try {
