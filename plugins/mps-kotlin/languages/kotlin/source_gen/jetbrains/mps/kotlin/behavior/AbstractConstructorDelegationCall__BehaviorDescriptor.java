...
public final class AbstractConstructorDelegationCall__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Iterable<SNode>> getAvailableConstructors_id4DC0lWpsin = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("getAvailableConstructors").modifiers(13, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(83774013505389719L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2(SMethodBuilder.createJavaParameter(SNode.class, "contextNode"));
