...
/*package*/ class VariableDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean _StyleParameter_QueryFunction_lfy4ev_a0b0() {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new typeSingleRoleHandler_lfy4ev_b2a(myNode, LINKS.type$RmkT, getEditorContext());
    return provider.createCell();
  }
  private static class typeSingleRoleHandler_lfy4ev_b2a extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public typeSingleRoleHandler_lfy4ev_b2a(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
