...
public final class SuperInterfaceSpecifier__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x6b3888c1980244d8L, 0x8baff8e6c33ed689L, 0x2043bc8310b9b194L, "jetbrains.mps.kotlin.structure.SuperInterfaceSpecifier");
  ...
  /*package*/ static SNode getInheritedType_id5q426iHvzD9(@NotNull SNode __thisNode__) {
    return createClassType_mu2tzc_a0a0(SLinkOperations.getTarget(__thisNode__, LINKS.target$mYQV), ITypeArguments__BehaviorDescriptor.getTypeProjections_idFn6l2JqIEF.invoke(__thisNode__));
  }

  /*package*/ SuperInterfaceSpecifier__BehaviorDescriptor() {
  }
  ...
  private static SNode createClassType_mu2tzc_a0a0(SNode p0, Iterable<? extends SNode> p1) {
