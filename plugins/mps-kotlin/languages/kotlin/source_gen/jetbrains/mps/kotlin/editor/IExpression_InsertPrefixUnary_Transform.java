...
public class IExpression_InsertPrefixUnary_Transform extends TransformationMenuBase {
  public IExpression_InsertPrefixUnary_Transform() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "IExpression_InsertPrefixUnary_Transform", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "7027413324313228080")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM));
  }
