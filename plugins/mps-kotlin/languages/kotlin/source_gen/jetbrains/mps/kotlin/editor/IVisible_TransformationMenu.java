...
public class IVisible_TransformationMenu extends TransformationMenuBase {
  public IVisible_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "IVisible", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "7138249191285441734")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
