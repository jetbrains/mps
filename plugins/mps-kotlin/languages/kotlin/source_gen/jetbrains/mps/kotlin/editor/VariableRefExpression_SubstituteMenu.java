...
public class VariableRefExpression_SubstituteMenu extends SubstituteMenuBase {
  public VariableRefExpression_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "VariableRefExpression", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "5533310174484856346")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_jlehec_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_jlehec_a() {
      super(CONCEPTS.VariableRefExpression$J$, LINKS.target$xQFr, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "5533310174484856349")));
    }
