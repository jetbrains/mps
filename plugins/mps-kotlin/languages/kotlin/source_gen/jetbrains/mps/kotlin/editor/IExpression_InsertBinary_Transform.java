...
public class IExpression_InsertBinary_Transform extends TransformationMenuBase {
  public IExpression_InsertBinary_Transform() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "IExpression_InsertBinary_Transform", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "5533310174483281796")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  public class TMP_WrapSM_ehoule_a0 extends WrapSubstituteMenuTransformationMenuPart {
    ...
    public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
      ...
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("wrap substitute menu " + "named substitute menu " + "BinaryExpression_AllSubconcepts", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "5533310174483317608")));
      try {
  ...
  public class TMP_WrapSM_ehoule_a1 extends WrapSubstituteMenuTransformationMenuPart {
    ...
    public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("wrap substitute menu " + "named substitute menu " + "BinaryExpression_AllSubconcepts", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "5533310174483294982")));
      try {
        return super.createItems(context);
      } finally {
        context.getEditorMenuTrace().popTraceInfo();
