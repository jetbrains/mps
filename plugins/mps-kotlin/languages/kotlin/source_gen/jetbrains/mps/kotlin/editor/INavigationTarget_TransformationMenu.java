...
public class INavigationTarget_TransformationMenu extends TransformationMenuBase {
  public INavigationTarget_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "INavigationTarget", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "4100182522256650226")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
