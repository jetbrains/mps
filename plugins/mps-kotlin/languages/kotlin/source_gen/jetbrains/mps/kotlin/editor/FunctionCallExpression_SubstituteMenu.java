...
public class FunctionCallExpression_SubstituteMenu extends SubstituteMenuBase {
  public FunctionCallExpression_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "FunctionCallExpression", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "8625556777609170364")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_lm8z5h_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_lm8z5h_a() {
      super(CONCEPTS.FunctionCallExpression$EQ, LINKS.function$Weyv, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "2027552004985731378")));
    }
