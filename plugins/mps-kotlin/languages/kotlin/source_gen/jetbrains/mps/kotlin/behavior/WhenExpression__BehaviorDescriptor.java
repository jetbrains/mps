...
public final class WhenExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), CONCEPTS.IVariableIdentifier$v2) && (SLinkOperations.getTarget(__thisNode__, LINKS.variableDeclaration$jXBd) != null)) {
      return new HidingByNameScope(CONCEPTS.IVariableIdentifier$v2, kind, new NamedElementsScope(SLinkOperations.getTarget(__thisNode__, LINKS.variableDeclaration$jXBd)), ScopeUtils.lazyParentScope(__thisNode__, kind));
    }
