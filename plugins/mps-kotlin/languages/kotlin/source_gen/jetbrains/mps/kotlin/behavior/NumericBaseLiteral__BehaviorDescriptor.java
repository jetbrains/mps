...
public final class NumericBaseLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Integer> getValue_id6cg9X74s8pg = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("getValue").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).id("6cg9X74s8pg").build();
  public static final SMethod<Void> setValue_id6cg9X74saKl = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("setValue").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).id("6cg9X74saKl").build(SMethodBuilder.createJavaParameter(Integer.TYPE, ""));
