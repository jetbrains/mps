...
public final class ClassDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Iterable<SNode>> getPrimaryNonPropertyVariables_id1$jFvlDFKeB = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("getPrimaryNonPropertyVariables").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1806979145057371047L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2();
  ...
  public static final SMethod<Boolean> usesDefaultConstructor_id5H$PF0dBJLd = new SMethodBuilder<>(Boolean.TYPE).name("usesDefaultConstructor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6585624606753619021L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2();
