...
public class ClassDeclaration_RemoveModifier {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (DeletionApproverUtil.approve(editorContext, SLinkOperations.getTarget(node, LINKS.modifier$C$4W))) {
          return;
        }
        SNodeOperations.deleteNode(SLinkOperations.getTarget(node, LINKS.modifier$C$4W));
