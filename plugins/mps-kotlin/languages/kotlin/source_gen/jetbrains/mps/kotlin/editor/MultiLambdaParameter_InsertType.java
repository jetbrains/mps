...
public class MultiLambdaParameter_InsertType extends TransformationMenuBase {
  public MultiLambdaParameter_InsertType() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "MultiLambdaParameter_InsertType", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "8373598162229626172")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  private class TMP_Action_18u69g_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "8373598162229628535"));
        return this;
      }
      @Nullable
      @Override
