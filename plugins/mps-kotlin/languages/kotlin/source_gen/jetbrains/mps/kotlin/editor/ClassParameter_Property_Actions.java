...
public class ClassParameter_Property_Actions {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (DeletionApproverUtil.approve(editorContext, node, "propertyCell")) {
          return;
        }
        SPropertyOperations.set(node, PROPS.isProperty$MCKN, false);
        SelectionUtil.selectLabelCellAnSetCaret(editorContext, node, SelectionManager.FIRST_EDITABLE_CELL, 0);
      }
