...
public class ConstructorCall_SubstituteMenu extends SubstituteMenuBase {
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_wcp1fk_a extends ReferenceScopeSubstituteMenuPart {

    public SMP_ReferenceScope_wcp1fk_a() {
      // that cast is needed for prevent the users from https://youtrack.jetbrains.com/issue/MPS-29051
      super((SAbstractConcept) CONCEPTS.ConstructorCall$SH, LINKS.target$VUYb);
    }
    @NotNull
    @Override
