...
public final class IClassLike__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> populateNonMemberSignatures_id1pD7IS2T3rZ = new SMethodBuilder<>(Void.TYPE).name("populateNonMemberSignatures").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1614855948988593919L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2(SMethodBuilder.createJavaParameter(SignatureCollector.class, "visitor"));
  ...
  public static final SMethod<SNode> getCompanion_id1dpU28wP77w = new SMethodBuilder<>(SNode.class).name("getCompanion").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1394400792925204960L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2();
  ...
  public static final SMethod<Iterable<SNode>> getConstructors_id2NtWm0y9fFa = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("getConstructors").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3233005502713887434L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2();
  public static final SMethod<Boolean> isAbstractClass_id$q1KckYQOy = new SMethodBuilder<>(Boolean.TYPE).name("isAbstractClass").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(655844405554146594L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2();
