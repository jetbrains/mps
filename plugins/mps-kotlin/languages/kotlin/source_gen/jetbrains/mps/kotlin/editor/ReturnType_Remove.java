...
public class ReturnType_Remove {
  ...
  /*package*/ static AbstractCellAction createAction_BACKSPACE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        // Remove return type
        SNodeOperations.deleteNode(SLinkOperations.getTarget(node, LINKS.returnType$fGYV));

        // TODO merge into child and select proper cell
      }
