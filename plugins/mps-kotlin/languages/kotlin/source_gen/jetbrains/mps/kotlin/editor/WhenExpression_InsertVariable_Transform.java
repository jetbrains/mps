...
public class WhenExpression_InsertVariable_Transform extends TransformationMenuBase {
  public WhenExpression_InsertVariable_Transform() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "WhenExpression_InsertVariable_Transform", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "8939835910405032971")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
