...
public final class LanguageConceptSwitch {
  ...
  public static final int IConditionalFlow = 85;
  ...
  public static final int IDataFlowSource = 89;
  public static final int IDataflowPassToChild = 90;
  public static final int IDataflowPassToChildren = 91;
  public static final int IDeclaration = 92;
  public static final int IDeclarationHolder = 93;
  public static final int IDeclarationScopePart = 94;
  public static final int IDeconstructingDeclarations = 95;
  public static final int IElseExpression = 96;
  public static final int IExpression = 97;
  public static final int IExpressionLike = 98;
  public static final int IFunctionCall = 99;
  public static final int IFunctionDeclaration = 100;
  public static final int IFunctionIdentifier = 101;
  public static final int IFunctionMemberTarget = 102;
  public static final int IFunctionModifier = 103;
  public static final int IFunctionParameters = 104;
  public static final int IIdentifier = 105;
  public static final int IInferencePart = 106;
  public static final int IInheritExplicitly = 107;
  public static final int IInheritable = 108;
  public static final int IInheritanceModifier = 109;
  public static final int IKotlinFile = 110;
  ...
  public static final int ISignatureScopeProvider = 132;
  public static final int IStatement = 133;
  public static final int IStatementHolder = 134;
  public static final int IStatementScopePart = 135;
  public static final int IStaticType = 136;
  public static final int IStringLiteral = 137;
  public static final int IStringLiteralPart = 138;
  public static final int ISuperTypeSpecifier = 139;
  public static final int IThisReceiverProvider = 140;
  public static final int IType = 141;
  public static final int ITypeArguments = 142;
  public static final int ITypeConstrained = 143;
  public static final int ITypeParameter = 144;
  public static final int ITypeParameterReference = 145;
  public static final int ITypeParameters = 146;
  public static final int ITypeProjection = 147;
  public static final int IVariableConstraintHolder = 148;
  public static final int IVariableIdentifier = 149;
  public static final int IVisible = 150;
  public static final int IWhenCondition = 151;
  public static final int IWithClassBody = 152;
  public static final int IWithReceiver = 153;
  public static final int IdentityOperator = 154;
  public static final int IfExpression = 155;
  public static final int ImportHeader = 156;
  public static final int IncOperation = 157;
  public static final int IncompleteDeclaration = 158;
  public static final int IndexOperation = 159;
  public static final int InfixCallOperator = 160;
  public static final int InfixFunctionModifier = 161;
  public static final int InlineFunctionModifier = 162;
  public static final int InnerClassModifier = 163;
  public static final int IntegerLiteral = 164;
  public static final int InterfaceDeclaration = 165;
  public static final int InternalVisibility = 166;
  public static final int IntersectionType = 167;
  public static final int IsOperator = 168;
  public static final int KotlinFile = 169;
  public static final int KtScript = 170;
  public static final int Label = 171;
  public static final int LambdaLiteral = 172;
  public static final int LessEqOperation = 173;
  public static final int LessOperation = 174;
  public static final int LocalPropertyDeclaration = 175;
  public static final int LongLiteral = 176;
  public static final int MemberNavigationOperation = 177;
  public static final int MinusOperation = 178;
  public static final int MultiLambdaParameter = 179;
  public static final int MultiLineStringLiteral = 180;
  public static final int NavigationOperation = 181;
  public static final int NoinlineParameterModifier = 182;
  public static final int NotContainedOperation = 183;
  public static final int NotEqualsOperation = 184;
  public static final int NotOperation = 185;
  public static final int NullLiteral = 186;
  public static final int NullSafeOperation = 187;
  public static final int NullableType = 188;
  public static final int NumericBaseLiteral = 189;
  public static final int ObjectDeclaration = 190;
  public static final int ObjectLiteral = 191;
  public static final int OpenInheritanceModifier = 192;
  public static final int OperatorFunctionModifier = 193;
  public static final int OrExpression = 194;
  public static final int OverloadedAssignment = 195;
  public static final int OverloadedBinaryExpression = 196;
  public static final int OverloadedPostfixUnaryExpression = 197;
  public static final int OverloadedPrefixUnaryExpression = 198;
  public static final int PackageHeader = 199;
  public static final int ParamUseSiteTarget = 200;
  public static final int Parameter = 201;
  public static final int ParameterWithOptionalType = 202;
  public static final int ParenthesizedExpression = 203;
  public static final int PlusOperation = 204;
  public static final int PostfixDecOperation = 205;
  public static final int PostfixIncOperation = 206;
  public static final int PostfixUnaryExpression = 207;
  public static final int PrefixUnaryExpression = 208;
  public static final int PrimaryConstructor = 209;
  public static final int PrivateVisibility = 210;
  public static final int PropertyDeclaration = 211;
  public static final int PropertyDefaultAssignement = 212;
  public static final int PropertyDelegateAssignement = 213;
  public static final int PropertyGetter = 214;
  public static final int PropertyMemberTarget = 215;
  public static final int PropertySetter = 216;
  public static final int PropertyUseSiteTarget = 217;
  public static final int ProtectedVisibility = 218;
  public static final int PublicVisibility = 219;
  public static final int RangeToOperation = 220;
  public static final int RealLiteral = 221;
  public static final int ReceiverType = 222;
  public static final int ReceiverUseSiteTarget = 223;
  public static final int RemOperation = 224;
  public static final int ReturnExpression = 225;
  public static final int SealedInheritanceModifier = 226;
  public static final int SecondaryConstructor = 227;
  public static final int SetUseSiteTarget = 228;
  public static final int SetparamUseSiteTarget = 229;
  public static final int StarProjection = 230;
  public static final int StringExpressionEvaluation = 231;
  public static final int StringLiteral = 232;
  public static final int StringLiteralLine = 233;
  public static final int StringLiteralRaw = 234;
  public static final int SuperClassSpecifier = 235;
  public static final int SuperConstructorDelegationCall = 236;
  public static final int SuperExpression = 237;
  public static final int SuspendFunctionModifier = 238;
  public static final int TailRecFunctionModifier = 239;
  public static final int ThisConstructorDelegationCall = 240;
  public static final int ThisExpression = 241;
  public static final int ThrowExpression = 242;
  public static final int TimesOperation = 243;
  public static final int TryExpression = 244;
  public static final int TypeAdditionalData = 245;
  public static final int TypeAlias = 246;
  public static final int TypeAliasType = 247;
  public static final int TypeConstraint = 248;
  public static final int TypeParameter = 249;
  public static final int TypeParameterReference = 250;
  public static final int TypePostFixUnaryExpression = 251;
  public static final int TypeProjection = 252;
  public static final int TypeReference = 253;
  public static final int TypeTest = 254;
  public static final int UnaryExpression = 255;
  public static final int UnaryMinusOperation = 256;
  public static final int UnaryPlusOperation = 257;
  public static final int UnresolvedParsedReference = 258;
  public static final int UnsignedLiteral = 259;
  public static final int ValueArgument = 260;
