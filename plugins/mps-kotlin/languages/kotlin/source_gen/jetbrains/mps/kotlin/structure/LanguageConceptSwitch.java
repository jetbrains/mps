...
public final class LanguageConceptSwitch implements ConceptIndex {
  ...
  public static final int CommonTargetPlatform = 29;
  public static final int CompanionObject = 30;
  public static final int CompareToOperation = 31;
  public static final int CompiledStubStatement = 32;
  public static final int ComponentDeclaration = 33;
  public static final int ComponentFunctionCall = 34;
  public static final int ConstructorSuperSpecifier = 35;
  public static final int ContainedOperation = 36;
  public static final int ContinueExpression = 37;
  public static final int CopyFunctionCall = 38;
  public static final int CrossinslineParameterModifier = 39;
  public static final int DataClassModifier = 40;
  public static final int DecOperation = 41;
  public static final int DelegateUseSiteTarget = 42;
  public static final int DivOperation = 43;
  public static final int DoWhileStatement = 44;
  public static final int DynamicType = 45;
  public static final int ElvisOperator = 46;
  public static final int EmptyClassMemberDeclaration = 47;
  public static final int EmptyDeclaration = 48;
  public static final int EmptyStatement = 49;
  public static final int EnumClassDeclaration = 50;
  public static final int EnumClassModifier = 51;
  public static final int EnumEntry = 52;
  public static final int EqualsOperation = 53;
  public static final int ExpectPlatformModifier = 54;
  public static final int ExternalFunctionModifier = 55;
  public static final int FieldUseSiteTarget = 56;
  public static final int FileAnnotationList = 57;
  public static final int FinalInheritanceModifier = 58;
  public static final int FinallyBlock = 59;
  public static final int FlexibleBlock = 60;
  public static final int FlippedOverloadedBinaryExpression = 61;
  public static final int ForStatement = 62;
  ...
  public static final int ICondition = 86;
  ...
  public static final int IDataflowPassToChild = 90;
  public static final int IDeclaration = 91;
  public static final int IDeclarationHolder = 92;
  public static final int IDeclarationScopePart = 93;
  public static final int IDeconstructingDeclarations = 94;
  public static final int IElseExpression = 95;
  public static final int IExpression = 96;
  public static final int IExpressionLike = 97;
  public static final int IFunctionCall = 98;
  public static final int IFunctionDeclaration = 99;
  public static final int IFunctionIdentifier = 100;
  public static final int IFunctionMemberTarget = 101;
  public static final int IFunctionModifier = 102;
  public static final int IFunctionParameters = 103;
  public static final int IIdentifier = 104;
  public static final int IInferencePart = 105;
  public static final int IInheritExplicitly = 106;
  public static final int IInheritable = 107;
  public static final int IInheritanceModifier = 108;
  public static final int IKotlinFile = 109;
  public static final int IKotlinRoot = 110;
  public static final int IKotlinRunnable = 111;
  public static final int ILabelTarget = 112;
  public static final int ILabelled = 113;
  public static final int ILambdaAsArgument = 114;
  public static final int ILambdaParameter = 115;
  public static final int ILeftExpression = 116;
  public static final int IMemberTarget = 117;
  public static final int INavigationTarget = 118;
  public static final int INullableType = 119;
  public static final int IObject = 120;
  public static final int IOverloadableOperator = 121;
  public static final int IParameterModifier = 122;
  public static final int IPlatformModifier = 123;
  public static final int IProjectedTypeArguments = 124;
  public static final int IPropertyAssignment = 125;
  public static final int IRegularFunctionCall = 126;
  public static final int IResolvable = 127;
  public static final int IResolvableReference = 128;
  public static final int IReturnType = 129;
  public static final int ISelfHandledAssignment = 130;
  public static final int ISignatureScopeProvider = 131;
  ...
  public static final int IThisReceiverProvider = 139;
  public static final int IType = 140;
  public static final int ITypeArguments = 141;
  public static final int ITypeConstrainedParameters = 142;
  public static final int ITypeParameter = 143;
  public static final int ITypeParameterReference = 144;
  public static final int ITypeParameters = 145;
  public static final int ITypeProjection = 146;
  public static final int ITypecheckingRoot = 147;
  public static final int IUnaryExpression = 148;
  public static final int IVariableConstraintHolder = 149;
  public static final int IVariableIdentifier = 150;
  public static final int IVisible = 151;
  public static final int IWhenCondition = 152;
  public static final int IWithClassBody = 153;
  public static final int IWithReceiver = 154;
  public static final int IdentityOperator = 155;
  public static final int IfExpression = 156;
  public static final int ImportHeader = 157;
  public static final int IncOperation = 158;
  public static final int IncompleteDeclaration = 159;
  public static final int IndexOperation = 160;
  public static final int InfixCallOperator = 161;
  public static final int InfixFunctionModifier = 162;
  public static final int InlineFunctionModifier = 163;
  public static final int InnerClassModifier = 164;
  public static final int IntegerLiteral = 165;
  public static final int InterfaceDeclaration = 166;
  public static final int InternalVisibility = 167;
  public static final int IntersectionType = 168;
  public static final int IsOperator = 169;
  public static final int JvmTargetPlatform = 170;
  public static final int KotlinFile = 171;
  public static final int KtScript = 172;
  public static final int Label = 173;
  public static final int LambdaLiteral = 174;
  public static final int LessEqOperation = 175;
  public static final int LessOperation = 176;
  public static final int LocalPropertyDeclaration = 177;
  public static final int LongLiteral = 178;
  public static final int MemberNavigationExpression = 179;
  public static final int MinusOperation = 180;
  public static final int MultiLambdaParameter = 181;
  public static final int MultiLineStringLiteral = 182;
  public static final int NavigationOperation = 183;
  public static final int NoinlineParameterModifier = 184;
  public static final int NotContainedOperation = 185;
  public static final int NotEqualsOperation = 186;
  public static final int NotOperation = 187;
  public static final int NullLiteral = 188;
  public static final int NullSafeOperation = 189;
  public static final int NullableType = 190;
  public static final int NumericBaseLiteral = 191;
  public static final int ObjectDeclaration = 192;
  public static final int ObjectLiteral = 193;
  public static final int OpenInheritanceModifier = 194;
  public static final int OperatorFunctionModifier = 195;
  public static final int OrExpression = 196;
  public static final int OverloadedAssignment = 197;
  public static final int OverloadedBinaryExpression = 198;
  public static final int OverloadedPostfixUnaryExpression = 199;
  public static final int OverloadedPrefixUnaryExpression = 200;
  public static final int PackageHeader = 201;
  public static final int ParamUseSiteTarget = 202;
  public static final int Parameter = 203;
  public static final int ParameterWithOptionalType = 204;
  public static final int ParenthesizedExpression = 205;
  public static final int PlusOperation = 206;
  public static final int PostfixDecOperation = 207;
  public static final int PostfixIncOperation = 208;
  public static final int PostfixUnaryExpression = 209;
  public static final int PrefixUnaryExpression = 210;
  public static final int PrimaryConstructor = 211;
  public static final int PrivateVisibility = 212;
  public static final int PropertyAccessor = 213;
  public static final int PropertyDeclaration = 214;
  public static final int PropertyDefaultAssignement = 215;
  public static final int PropertyDelegateAssignement = 216;
  public static final int PropertyGetter = 217;
  public static final int PropertyMemberTarget = 218;
  public static final int PropertySetter = 219;
  public static final int PropertyUseSiteTarget = 220;
  public static final int ProtectedVisibility = 221;
  public static final int PublicVisibility = 222;
  public static final int RangeToOperation = 223;
  public static final int RealLiteral = 224;
  public static final int ReceiverType = 225;
  public static final int ReceiverUseSiteTarget = 226;
  public static final int RemOperation = 227;
  public static final int ReturnExpression = 228;
  public static final int SealedInheritanceModifier = 229;
  public static final int SecondaryConstructor = 230;
  public static final int SetUseSiteTarget = 231;
  public static final int SetparamUseSiteTarget = 232;
  public static final int SourceSetDeclaration = 233;
  public static final int SourceSetTargetPlatform = 234;
  public static final int StarProjection = 235;
  public static final int StringExpressionEvaluation = 236;
  public static final int StringLiteral = 237;
  public static final int StringLiteralLine = 238;
  public static final int StringLiteralRaw = 239;
  public static final int SuperClassSpecifier = 240;
  public static final int SuperConstructorDelegationCall = 241;
  public static final int SuperExpression = 242;
  public static final int SuspendFunctionModifier = 243;
  public static final int TailRecFunctionModifier = 244;
  public static final int TargetPlatform = 245;
  public static final int TargetPlatforms = 246;
  public static final int ThisConstructorDelegationCall = 247;
  public static final int ThisExpression = 248;
  public static final int ThrowExpression = 249;
  public static final int TimesOperation = 250;
  public static final int TryExpression = 251;
  public static final int TypeAdditionalData = 252;
  public static final int TypeAlias = 253;
  public static final int TypeAliasType = 254;
  public static final int TypeConstraint = 255;
  public static final int TypeParameter = 256;
  public static final int TypeParameterReference = 257;
  public static final int TypePostFixUnaryExpression = 258;
  public static final int TypeProjection = 259;
  public static final int TypeReference = 260;
  public static final int TypeTest = 261;
  public static final int UnaryExpression = 262;
  public static final int UnaryMinusOperation = 263;
  public static final int UnaryPlusOperation = 264;
  public static final int UnresolvedParsedReference = 265;
  public static final int UnsignedLiteral = 266;
  public static final int ValueArgument = 267;
  public static final int ValueClassModifier = 268;
  public static final int VariableDeclaration = 269;
  public static final int VariableRefExpression = 270;
  public static final int VisibilityModifier = 271;
  public static final int WhenEntry = 272;
  public static final int WhenExpression = 273;
  public static final int WhileStatement = 274;
