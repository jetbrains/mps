...
public class StringExpressionEvaluation_TransformationMenu extends TransformationMenuBase {
  public StringExpressionEvaluation_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "StringExpressionEvaluation", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "5849129648644319057")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
