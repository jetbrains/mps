...
public class ConstructorSuperSpecifier_SubstituteMenu extends SubstituteMenuBase {
  public ConstructorSuperSpecifier_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "ConstructorSuperSpecifier", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "1806979145073004835")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_sdbckd_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_sdbckd_a() {
      super(CONCEPTS.ConstructorSuperSpecifier$SH, LINKS.target$VUYb, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "1806979145073006097")));
    }
