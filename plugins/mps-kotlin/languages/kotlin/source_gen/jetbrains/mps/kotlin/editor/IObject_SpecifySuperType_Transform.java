...
public class IObject_SpecifySuperType_Transform extends TransformationMenuBase {
  public IObject_SpecifySuperType_Transform() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "IObject_SpecifySuperType_Transform", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "1991556721067233112")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  private class TMP_Action_1vrky4_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "1991556721067234862"));
        return this;
      }
      @Nullable
      @Override
