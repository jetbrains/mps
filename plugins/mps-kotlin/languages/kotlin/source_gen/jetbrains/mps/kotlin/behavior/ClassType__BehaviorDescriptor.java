...
public final class ClassType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> populateTypeSignatures_id5q426iHK5S9 = new SMethodBuilder<>(Void.TYPE).name("populateSignature").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6234117012692426249L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2(SMethodBuilder.createJavaParameter(SignatureCollector.class, "visitor"));
  ...
  public static final SMethod<SNode> getClassifier_id7an2tsIdpk7 = new SMethodBuilder<>(SNode.class).name("getClassifier").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8257079261604975879L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2();
  ...
  /*package*/ static SignatureScope getStaticScope_id1ODRHGtufGw(@NotNull SNode __thisNode__, SignatureFilter filter, FullScopeContext context) {
    return (SignatureScope) IClassLike__BehaviorDescriptor.getStaticScope_id3HHsmlLCHdO.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.class$ExdX), filter, context.getNode());
  }
