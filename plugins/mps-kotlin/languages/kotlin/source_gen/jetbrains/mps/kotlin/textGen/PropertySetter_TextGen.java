...
public class PropertySetter_TextGen extends TextGenDescriptorBase {
  ...
  public void generateText(final TextGenContext ctx) {
    ...
    tgs.append("set");
    if ((SLinkOperations.getTarget(ctx.getPrimaryInput(), LINKS.parameter$J_aM) != null) || ListSequence.fromList(SLinkOperations.getChildren(ctx.getPrimaryInput(), LINKS.statements$R3pt)).isNotEmpty()) {
      tgs.append("(");
