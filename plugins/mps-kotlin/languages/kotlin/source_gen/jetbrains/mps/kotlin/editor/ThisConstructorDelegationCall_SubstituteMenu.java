...
public class ThisConstructorDelegationCall_SubstituteMenu extends SubstituteMenuBase {
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for " + "ThisConstructorDelegationCall", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "1806979145065159425")));
    try {
  ...
  public class SMP_ReferenceScope_ur4kcb_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_ur4kcb_a() {
      super(CONCEPTS.ThisConstructorDelegationCall$nG, LINKS.constructor$vAAY);
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:5e60d3fe-71b1-4c17-b38e-424792223875(jetbrains.mps.kotlin.editor)", "1806979145065160505")));
      try {
