...
public final class FunctionDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<SNode>> getParameters_id6f3juM$_Kx4 = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getParameters").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7188675108982425668L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2();
  public static final SMethod<SNode> getReturnType_id6QVUYzas5Of = new SMethodBuilder<>(SNode.class).name("getReturnType").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7907172955840339215L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2();
  ...
  public static final SMethod<SNode> getReceiverType_id2gj5XQXMFhP = new SMethodBuilder<>(SNode.class).name("getReceiverType").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2599447651062297717L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2();
  ...
  public static final SMethod<String> getClassName_id7klTmOSHg_9 = new SMethodBuilder<>(String.class).name("getClassFqName").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8436901734214076745L).languageId(0x8baff8e6c33ed689L, 0x6b3888c1980244d8L).build2(SMethodBuilder.createJavaParameter(KtEnvironmentConfig.class, "envConfig"));
