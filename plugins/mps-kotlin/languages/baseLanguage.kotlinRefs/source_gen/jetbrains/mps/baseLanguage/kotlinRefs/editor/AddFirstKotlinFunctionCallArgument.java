...
public class AddFirstKotlinFunctionCallArgument {
  ...
  /*package*/ static AbstractCellAction createAction_INSERT(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        SNode newArgument = SNodeFactoryOperations.addNewChild(node, LINKS.actualArgument$Q6nt, null);
        // TODO implement for kotlin?
        SelectionUtil.selectCell(editorContext, newArgument, SelectionManager.LAST_EDITABLE_CELL);
      }
