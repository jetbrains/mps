...
public class PresentationProviders {
  public static final IReferentPresentationProvider PRESENTATION_agwymw_a0a0a = new IReferentPresentationProvider() {
    @NotNull
    @Override
  ...
  public static final IReferentPresentationProvider PRESENTATION_qmmmcv_a0a0a = new IReferentPresentationProvider() {
    ...
    @Override
    public String getPresentation(@NotNull SNode sourceNode, @NotNull SNode targetNode) {
      return SPropertyOperations.getString(targetNode, PROPS.name$MnvL) + "Kt";
    }
  };
