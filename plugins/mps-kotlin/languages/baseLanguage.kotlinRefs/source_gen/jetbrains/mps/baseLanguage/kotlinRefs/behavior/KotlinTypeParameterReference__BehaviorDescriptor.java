...
public final class KotlinTypeParameterReference__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getConvertedBoundType_id4L0QGs2qXZf = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getConvertedBoundType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5494632093665976271L).languageId(0x938bae8e3fac20aaL, 0x2405a196e75d462cL).build2();
