...
public final class KotlinTypeParameterReference__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getConvertedBoundType_id4L0QGs2qXZf = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getConvertedBoundType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4L0QGs2qXZf").build();
