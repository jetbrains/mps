...
public class IKotlinFunctionCall_DeleteTypeArguments {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        // Copied from IMethodCall
        if (DeletionApproverUtil.approve(editorContext, node, "typeArguments")) {
          return;
        }
        ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.typeArgument$Q6Au)).clear();
