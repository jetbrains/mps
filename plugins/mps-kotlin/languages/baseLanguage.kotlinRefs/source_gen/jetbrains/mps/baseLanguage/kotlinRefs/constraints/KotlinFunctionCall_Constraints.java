      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public Scope createScope(final ReferenceConstraintsContext _context) {
            return KotlinInBaseLanguageScopeHelper.getScopeForMemeber(_context.getReferenceNode(), _context.getContextNode(), CONCEPTS.IFunctionDeclaration$ZB, FunctionSignature.class, null);
          }
        };
      }
    };
