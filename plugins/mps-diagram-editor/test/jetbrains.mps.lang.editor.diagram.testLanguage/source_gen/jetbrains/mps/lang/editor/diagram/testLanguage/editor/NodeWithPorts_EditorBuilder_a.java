  ...
  private class BlockCellImpl_t9c2f5_a extends BlockCell {
    ...
    private BlockCellImpl_t9c2f5_a(EditorContext editorContext, final SNode node) {
      ...
      myPropertyCell_t9c2f5_a4a = new PropertyMapperCell<Integer>(editorContext, node) {
        protected Integer getModelPropertyValueImpl() {
          return SPropertyOperations.getInteger(node, PROPS.lineWidth$5Nb0);
        }
        protected void setModelPropertyValueImpl(Integer value) {
          SPropertyOperations.assign(node, PROPS.lineWidth$5Nb0, value);
        }
      };
    ...
    public void synchronize() {
      ...
      syncPortNodes(SLinkOperations.getChildren(getSNode(), LINKS.inputs$oxFv), myInputPorts.listIterator(), new HashSet<SNode>(myInputPorts));
      syncPortNodes(SLinkOperations.getChildren(getSNode(), LINKS.outputs$oKtu), myOutputPorts.listIterator(), new HashSet<SNode>(myOutputPorts));
    }
