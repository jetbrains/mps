...
/*package*/ class OutputPort_diagram_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public OutputPort_diagram_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createDiagramPort_0() {
    final EditorCell editorCell = new PortCellImpl_bbhyff_a(getEditorContext(), myNode);
