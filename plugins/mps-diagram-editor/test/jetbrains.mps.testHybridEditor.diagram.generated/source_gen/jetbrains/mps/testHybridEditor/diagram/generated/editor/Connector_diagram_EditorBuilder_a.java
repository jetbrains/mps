...
/*package*/ class Connector_diagram_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  public class ConnectorCellImpl_a4xffp_a extends ConnectorCell {
    ...
    public void synchronize() {
      myInputPort.set(MultiTuple.<SNode>from(SLinkOperations.getTarget(getSNode(), LINKS.inputPort$udU1)));
      myOutputPort.set(MultiTuple.<SNode>from(SLinkOperations.getTarget(getSNode(), LINKS.outputPort$ucXX)));
    }
