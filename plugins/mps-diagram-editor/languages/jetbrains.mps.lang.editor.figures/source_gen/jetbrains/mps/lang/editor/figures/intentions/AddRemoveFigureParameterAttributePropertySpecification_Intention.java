...
public final class AddRemoveFigureParameterAttributePropertySpecification_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return (new IAttributeDescriptor.NodeAttribute(CONCEPTS.FigureParameterAttributeViewProperty$gb).get(node) == null ? "Add figure parameter attribute" : "Remove figure parameter attribute");

    }
    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      if (new IAttributeDescriptor.NodeAttribute(CONCEPTS.FigureParameterAttributeViewProperty$gb).get(node) != null) {
        new IAttributeDescriptor.NodeAttribute(CONCEPTS.FigureParameterAttributeViewProperty$gb).set(node, null);
      } else {
        new IAttributeDescriptor.NodeAttribute(CONCEPTS.FigureParameterAttributeViewProperty$gb).set(node, SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xd7722d504b934c3aL, 0xae061903d05f95a7L, 0x6595651980a1f8ecL, "jetbrains.mps.lang.editor.figures.structure.FigureParameterAttributeViewProperty")));
      }
    }
    @Override
