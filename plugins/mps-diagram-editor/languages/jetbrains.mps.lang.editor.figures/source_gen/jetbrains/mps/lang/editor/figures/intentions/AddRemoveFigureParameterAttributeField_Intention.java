...
public final class AddRemoveFigureParameterAttributeField_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      return (new IAttributeDescriptor.NodeAttribute(CONCEPTS.FigureParameterAttributeField$rl).get(node) == null ? "Add figure parameter attribute" : "Remove figure parameter attribute");
    }
    @Override
    public void execute(final SNode node, final EditorContext editorContext) {
      if (new IAttributeDescriptor.NodeAttribute(CONCEPTS.FigureParameterAttributeField$rl).get(node) != null) {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept FigureParameterAttributeField$rl = MetaAdapterFactory.getConcept(0xd7722d504b934c3aL, 0xae061903d05f95a7L, 0x1ceea85e3fd59976L, "jetbrains.mps.lang.editor.figures.structure.FigureParameterAttributeField");
  }
}
