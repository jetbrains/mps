...
public final class ExternalViewFigure__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    if (SConceptOperations.isExactly(SNodeOperations.asSConcept(kind), CONCEPTS.FieldDeclaration$ie) && SLinkOperations.getTarget(__thisNode__, LINKS.classifier$HHUi) != null) {
      return Scopes.forVariables(CONCEPTS.FieldDeclaration$ie, Sequence.fromIterable(IClassifierType__BehaviorDescriptor.getMembers_id6r77ob2V1Fr.invoke(IClassifier__BehaviorDescriptor.getThisType_id6r77ob2UWbY.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.classifier$HHUi)))).where((it) -> SNodeOperations.isInstanceOf(it, CONCEPTS.FieldDeclaration$ie)).select((it) -> SNodeOperations.cast(it, CONCEPTS.FieldDeclaration$ie)), new EmptyScope());
    }
