...
public final class FigureParameterAttributeField__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getParameterMember_id4H19mAwT7Py = new SMethodBuilder<>(SNode.class).name("getParameterMember").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5422656561931910498L).languageId(0xae061903d05f95a7L, 0xd7722d504b934c3aL).build2();
  public static final SMethod<SNode> getFieldDeclaration_id6RaK14zk5fe = new SMethodBuilder<>(SNode.class).name("getFieldDeclaration").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7911346875269141454L).languageId(0xae061903d05f95a7L, 0xd7722d504b934c3aL).build2();
