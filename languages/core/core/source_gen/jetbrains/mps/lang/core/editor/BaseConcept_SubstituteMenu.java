...
public class BaseConcept_SubstituteMenu extends SubstituteMenuBase {
  public BaseConcept_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "BaseConcept", new SNodePointer("r:00000000-0000-4000-0000-011c89590284(jetbrains.mps.lang.core.editor)", "960304987045279857")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_s3h0kg_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    public SMP_Group_s3h0kg_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:00000000-0000-4000-0000-011c89590284(jetbrains.mps.lang.core.editor)", "6524522039911462403")));
    }
    @Override
    protected void initialize(SubstituteMenuContext _context) {
      ...
      isChildNullOrExactlyBaseConcept = new Computable<Boolean>() {
        public Boolean compute() {
          return (_context.getCurrentTargetNode() == null) || SConceptOperations.isExactly(SNodeOperations.asSConcept(SNodeOperations.getConcept(_context.getCurrentTargetNode())), CONCEPTS.BaseConcept$gP);
        }
      }.compute();
    }
    @Override
    ...
    public class SMP_Group_s3h0kg_a0 extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
      public SMP_Group_s3h0kg_a0() {
        super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:00000000-0000-4000-0000-011c89590284(jetbrains.mps.lang.core.editor)", "2654820218214078752")));
      }
      @Override
      ...
      @Override
      protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts() {
        return Arrays.<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>asList(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Param_s3h0kg_a0a(), CONCEPTS.BaseConcept$gP));
      }
      private class SMP_Param_s3h0kg_a0a extends ParameterizedMenuPart<SAbstractConcept, SubstituteMenuItem, SubstituteMenuContext> {
        /*package*/ SMP_Param_s3h0kg_a0a() {
          super(new EditorMenuDescriptorBase("parameterized substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c89590284(jetbrains.mps.lang.core.editor)", "7656359757586264703")));
        }
        @NotNull
        @Override
        ...
        protected Iterable<? extends SAbstractConcept> getParameters(SubstituteMenuContext _context) {
          return ((Iterable<SAbstractConcept>) SConceptOperations.getAllSubConcepts(CONCEPTS.BaseConcept$gP, SNodeOperations.getModel(_context.getParentNode())));
        }
    ...
    public class SMP_Group_s3h0kg_b0 extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
      public SMP_Group_s3h0kg_b0() {
        super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:00000000-0000-4000-0000-011c89590284(jetbrains.mps.lang.core.editor)", "960304987045279860")));
      }
      @Override
      protected boolean isApplicable(SubstituteMenuContext _context) {
        return !(isChildNullOrExactlyBaseConcept);
      ...
      public class SMP_Include_s3h0kg_a1a extends IncludeSubstituteMenuSubstituteMenuPart {
        ...
        public SMP_Include_s3h0kg_a1a() {
          super(new EditorMenuDescriptorBase("include " + "", new SNodePointer("r:00000000-0000-4000-0000-011c89590284(jetbrains.mps.lang.core.editor)", "7074419662141309136")));
        }
