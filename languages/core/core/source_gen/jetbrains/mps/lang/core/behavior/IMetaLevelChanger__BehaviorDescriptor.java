...
public final class IMetaLevelChanger__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Integer> getMetaLevelChange_idbc0iGlxcsE = new SMethodBuilder<>(Integer.TYPE).name("getMetaLevelChange").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(201537367881074474L).languageId(0x9b92103b95ca8c0cL, 0xceab519525ea4f22L).build2();
