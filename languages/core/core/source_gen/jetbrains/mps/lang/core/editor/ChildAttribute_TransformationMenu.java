...
public class ChildAttribute_TransformationMenu extends TransformationMenuBase {
  public ChildAttribute_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "ChildAttribute", new SNodePointer("r:00000000-0000-4000-0000-011c89590284(jetbrains.mps.lang.core.editor)", "2508844969616682842")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
