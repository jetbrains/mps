...
public class BasePlaceholder_TransformationMenu extends TransformationMenuBase {
  public BasePlaceholder_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "BasePlaceholder_TransformationMenu", new SNodePointer("r:00000000-0000-4000-0000-011c89590284(jetbrains.mps.lang.core.editor)", "4058177569375149993")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
