...
public class HtmlClosingTag_Convert_Actions {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        SNode openingTag = SNodeOperations.replaceWithNewChild(node, CONCEPTS.HtmlOpeningTag$K);
        SPropertyOperations.assign(openingTag, PROPS.tagName$H2fv, SPropertyOperations.getString(node, PROPS.tagName$9lI7));
        SelectionUtil.selectCell(editorContext, openingTag, SelectionManager.FIRST_EDITABLE_CELL);
      }
