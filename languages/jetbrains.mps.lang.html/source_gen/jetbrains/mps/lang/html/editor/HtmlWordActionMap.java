  ...
  /*package*/ static AbstractCellAction createAction_BACKSPACE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        ...
        if ((SNodeOperations.getPrevSibling(node) == null) && !(SConceptOperations.isExactly(SNodeOperations.asSConcept(SNodeOperations.getConcept(SNodeOperations.getParent(node))), CONCEPTS.HtmlLine$u)) && ((SNodeOperations.getPrevSibling(SNodeOperations.getParent(node)) == null))) {
          SNode l = SNodeFactoryOperations.replaceWithNewChild(SNodeOperations.getParent(node), CONCEPTS.HtmlLine$u);
