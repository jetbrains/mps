...
@Generated
public class Template_reduce_ExtensionFieldReference extends TemplateDeclarationBase {

  public Template_reduce_ExtensionFieldReference() {
    super(new MO());
  }

  public SNodeReference getTemplateNode() {
    return new SNodePointer("r:9b417160-a560-428b-b721-a26a33b5bd8c(jetbrains.mps.lang.extension.generator.template.main@generator)", "7036359038356141288");
  }
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    environment.resolve(new RefResolver(tnode1, myAssociationLinks[0], context, new SNodePointer("r:9b417160-a560-428b-b721-a26a33b5bd8c(jetbrains.mps.lang.extension.generator.template.main@generator)", "7036359038356141309"), "field") {
      @Override
