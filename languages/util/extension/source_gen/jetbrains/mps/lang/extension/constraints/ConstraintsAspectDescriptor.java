...
public class ConstraintsAspectDescriptor extends BaseConstraintsAspectDescriptor {
  ...
  public ConstraintsDescriptor getConstraints(@NotNull SAbstractConcept concept, @NotNull ConstraintsDescriptorInitContext context) {
    ...
    switch (conceptIndex.index(cncpt)) {
      case 0:
        return new BasicExtensionDeclaration_Constraints(context);
      case 1:
        return new ExtensionRegistrar_Constraints(context);
      case 2:
        return new GetExtensionObjectsOperation_Constraints(context);
      case 3:
        return new IRootWithUniqueName_Constraints(context);
      default:
    }
    return null;
  }
