...
public final class Regexp__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getTopLevelRegexp_idhNm6Oh5 = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getTopLevelRegexp").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("hNm6Oh5").build();
  public static final SMethod<String> toString_idhEwIUjb = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("toString").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("hEwIUjb").build();
  ...
  public static final SMethod<String> par_idhMuIPHY = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("par").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).id("hMuIPHY").build(SMethodBuilder.createJavaParameter(String.class, ""));
  public static final SMethod<Boolean> checkStringForUnicode_idhMRXRyL = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("checkStringForUnicode").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).id("hMRXRyL").build(SMethodBuilder.createJavaParameter(String.class, ""));
  public static final SMethod<String> quote_idhMRXVXe = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("quote").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).id("hMRXVXe").build(SMethodBuilder.createJavaParameter(Character.TYPE, ""));
  public static final SMethod<String> escape_id1b8uQvZ_lG7 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("escape").modifiers(0, AccessPrivileges.PROTECTED).concept(CONCEPT).id("1b8uQvZ_lG7").build(SMethodBuilder.createJavaParameter(String.class, ""));
