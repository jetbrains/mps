...
public class SymbolClassPart_TransformationMenu extends TransformationMenuBase {
  public SymbolClassPart_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "SymbolClassPart", new SNodePointer("r:00000000-0000-4000-0000-011c89590516(jetbrains.mps.baseLanguage.regexp.editor)", "1741258697587056210")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
