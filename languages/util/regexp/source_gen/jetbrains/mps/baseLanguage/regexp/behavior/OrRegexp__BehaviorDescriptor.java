...
public final class OrRegexp__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> needParentheses_id1b8uQvZynii = new SMethodBuilder<>(Boolean.TYPE).name("needParentheses").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1353467374623880338L).languageId(0xb09669cd7c8408c0L, 0xdaafa647f1f74b0bL).build2();
  public static final SMethod<Boolean> inParentheses_id1b8uQvZyDXU = new SMethodBuilder<>(Boolean.TYPE).name("inParentheses").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1353467374623956858L).languageId(0xb09669cd7c8408c0L, 0xdaafa647f1f74b0bL).build2();
  ...
  /*package*/ static boolean inParentheses_id1b8uQvZyDXU(@NotNull SNode __thisNode__) {
    return SNodeOperations.isInstanceOf(SNodeOperations.getParent(__thisNode__), CONCEPTS.SeqRegexp$F6);
  }
