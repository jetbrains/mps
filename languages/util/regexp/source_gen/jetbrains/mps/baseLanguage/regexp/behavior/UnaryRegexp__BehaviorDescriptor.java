...
public final class UnaryRegexp__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> inParentheses_id1b8uQvZyDW8 = new SMethodBuilder<>(Boolean.TYPE).name("inParentheses").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1353467374623956744L).languageId(0xb09669cd7c8408c0L, 0xdaafa647f1f74b0bL).build2();
