...
public final class LiteralReplacement__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isValid_id3iI_KKpaMFg = new SMethodBuilder<>(Boolean.TYPE).name("isValid").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3796137614137567952L).languageId(0xb09669cd7c8408c0L, 0xdaafa647f1f74b0bL).build2();
  public static final SMethod<String> toRegexp_id3iI_KKpaM6i = new SMethodBuilder<>(String.class).name("toRegexp").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3796137614137565586L).languageId(0xb09669cd7c8408c0L, 0xdaafa647f1f74b0bL).build2(SMethodBuilder.createJavaParameter(String.class, "s"));
