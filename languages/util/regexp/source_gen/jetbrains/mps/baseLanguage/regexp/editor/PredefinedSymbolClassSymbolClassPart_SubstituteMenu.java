...
public class PredefinedSymbolClassSymbolClassPart_SubstituteMenu extends SubstituteMenuBase {
  public PredefinedSymbolClassSymbolClassPart_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for PredefinedSymbolClassSymbolClassPart. Generated from implicit smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c89590518(jetbrains.mps.baseLanguage.regexp.structure)", "1174558792178")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_kon73z_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_kon73z_a() {
      super(CONCEPTS.PredefinedSymbolClassSymbolClassPart$Go, LINKS.declaration$GbT1, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_kon73z_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_kon73z_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "PredefinedSymbolClassSymbolClassPart", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.PredefinedSymbolClassSymbolClassPart$Go);
    }
