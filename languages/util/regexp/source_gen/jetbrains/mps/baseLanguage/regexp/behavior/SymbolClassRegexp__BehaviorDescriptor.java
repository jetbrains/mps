...
public final class SymbolClassRegexp__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static final SMethod<String> partsToString_idhMS0769 = new SMethodBuilder<>(String.class).name("partsToString").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(1222857748873L).languageId(0xb09669cd7c8408c0L, 0xdaafa647f1f74b0bL).build2(SMethodBuilder.createJavaParameter((Class<List<SNode>>) ((Class) Object.class), "parts"));
