...
public class Regexp_TransformationMenu extends TransformationMenuBase {
  ...
  public class TMP_Group_luzgqn_a1 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_luzgqn_a1.TMP_Action_luzgqn_a0b(), CONCEPTS.NTimesRegexp$Ld), new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_luzgqn_a1.TMP_Action_luzgqn_b0b(), CONCEPTS.AtLeastNTimesRegexp$MR), new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_luzgqn_a1.TMP_Action_luzgqn_c0b(), CONCEPTS.FromNToMTimesRegexp$bi), new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_luzgqn_a1.TMP_Param_luzgqn_d0b(), CONCEPTS.UnaryRegexp$Nw));
    }
