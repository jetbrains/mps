...
public class stringOperations_Contribution extends TransformationMenuBase {
  ...
  public class TMP_Group_uamzhl_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_uamzhl_a0.TMP_Action_uamzhl_a0a(), CONCEPTS.FindMatchExpression$Gp), new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_uamzhl_a0.TMP_Action_uamzhl_b0a(), CONCEPTS.MatchRegexpExpression$e0), new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_uamzhl_a0.TMP_Action_uamzhl_c0a(), CONCEPTS.ReplaceWithRegexpExpression$Ts), new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_uamzhl_a0.TMP_Action_uamzhl_d0a(), CONCEPTS.SplitExpression$n7));
    }
