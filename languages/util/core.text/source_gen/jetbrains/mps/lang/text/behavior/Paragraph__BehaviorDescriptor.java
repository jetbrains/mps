...
public final class Paragraph__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> initialize_id1v077Wg2A59 = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("initialize").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1711399190456328521L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2();
  public static final SMethod<Void> clearTextualElements_id1uSfHaoOxlA = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("clearTextualElements").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1709185132815062374L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2();
  /*package*/ static final SMethod<Void> clearFromEmptyLetters_id10ljsgpnzm5 = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("clearFromEmptyLetters").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(1158917983752304005L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2();
  ...
  public static final SMethod<Void> removeTextualElementAt_id250QDwq2Yav = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("removeTextualElementAt").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2396155348567974559L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2(SMethodBuilder.createJavaParameter(Integer.TYPE, ""));
  public static final SMethod<Void> addTextualElement_id1uSfHaoOOLl = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("addTextualElement").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1709185132815141973L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  public static final SMethod<Void> addAllTextualElements_id1uSfHaoPgT1 = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("addAllTextualElements").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1709185132815257153L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2(SMethodBuilder.createJavaParameter((Class<Iterable<SNode>>) ((Class) Object.class), ""));
