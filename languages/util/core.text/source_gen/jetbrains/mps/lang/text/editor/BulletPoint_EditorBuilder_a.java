...
/*package*/ class BulletPoint_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new lettersListHandler_uagdkf_d0(myNode, getEditorContext());
  ...
  private static class lettersListHandler_uagdkf_d0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public lettersListHandler_uagdkf_d0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(lettersListHandler_uagdkf_d0.this.getNode(), LINKS.letters$rNyA));
      try {
