...
public class PasteHandler {
  private static final Logger LOG = LogManager.getLogger(PasteHandler.class);
    ...
    if (dataFromClipboard instanceof SNodeTransferable) {
      ...
      for (SNode n : data) {
        ...
        if (SNodeOperations.isInstanceOf(n, CONCEPTS.Paragraph$XF) || SNodeOperations.isInstanceOf(n, CONCEPTS.IHoldParagraphs$eh)) {
          ...
          LoggingRuntime.logMsgView(Level.WARN, "AAAAAAAA " + SPropertyOperations.getInteger(SNodeOperations.as(l, CONCEPTS.IndentedPoint$BF), PROPS.indentation$8ZOp) + ":" + Line__BehaviorDescriptor.representAsText_id2iG$EWuTXv2.invoke(l), PasteHandler.class, null, null);
          LoggingRuntime.logMsgView(Level.ERROR, "BBBBBBB " + SPropertyOperations.getInteger(SNodeOperations.as(pastedParagraph, CONCEPTS.IndentedPoint$BF), PROPS.indentation$8ZOp), PasteHandler.class, null, null);
