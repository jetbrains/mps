...
public class HtmlTag_RightBrace_KeyMap extends KeyMapImpl {
  public HtmlTag_RightBrace_KeyMap() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new HtmlTag_RightBrace_KeyMap_Action0();
    this.putAction("any", " ", action);
  }
  public static class HtmlTag_RightBrace_KeyMap_Action0 extends KeyMapActionImpl {
    public HtmlTag_RightBrace_KeyMap_Action0() {
