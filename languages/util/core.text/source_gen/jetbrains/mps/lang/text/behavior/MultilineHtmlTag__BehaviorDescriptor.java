...
public final class MultilineHtmlTag__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.body$r6l0)).addElement(l);
  }

  /*package*/ static String getTextualRepresentation_idfB3l81it7u(@NotNull SNode __thisNode__) {
    if (ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.body$r6l0)).isEmpty()) {
      return "<" + SPropertyOperations.getString(__thisNode__, PROPS.name$feV5) + "/>";
    }
