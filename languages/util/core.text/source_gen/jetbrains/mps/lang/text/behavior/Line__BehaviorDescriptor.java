...
public final class Line__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> initializeFromParagraphs_id2iG$EWuZbnH = new SMethodBuilder<>(Void.TYPE).name("initializeFromParagraphs").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2642648362196448749L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2(SMethodBuilder.createJavaParameter(SNode.class, "l"));
  public static final SMethod<Void> merge_id1YnOZxALrLu = new SMethodBuilder<>(Void.TYPE).name("merge").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2276521200488660062L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2(SMethodBuilder.createJavaParameter(SNode.class, "other"));
  public static final SMethod<Void> merge_id1YnOZxAMHtO = new SMethodBuilder<>(Void.TYPE).name("merge").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2276521200488994676L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2(SMethodBuilder.createJavaParameter(SNode.class, "other"), SMethodBuilder.createJavaParameter(SNode.class, "position"));
  public static final SMethod<SNode> split_id1YnOZxANc9P = new SMethodBuilder<>(SNode.class).name("split").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2276521200489120373L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2(SMethodBuilder.createJavaParameter(SNode.class, "afterPosition"));
  ...
  public static final SMethod<Void> addTextElement_idWJz9iAYdP6 = new SMethodBuilder<>(Void.TYPE).name("addTextElement").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1094247804558695750L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2(SMethodBuilder.createJavaParameter(SNode.class, "element"));
  public static final SMethod<Void> addAllTextElements_idWJz9iAYdPl = new SMethodBuilder<>(Void.TYPE).name("addAllTextElements").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1094247804558695765L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2(SMethodBuilder.createJavaParameter((Class<Iterable<SNode>>) ((Class) Object.class), "elements"));
  public static final SMethod<Boolean> isEmptyLine_id1YnOZxAO76B = new SMethodBuilder<>(Boolean.TYPE).name("isEmptyLine").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2276521200489361831L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2();
  public static final SMethod<Iterable<SNode>> getTextElements_idWJz9iATjyN = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("getTextElements").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1094247804557408435L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2();
  public static final SMethod<Void> removeTextElementAt_idWJz9iAXbMU = new SMethodBuilder<>(Void.TYPE).name("removeTextElementAt").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1094247804558425274L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2(SMethodBuilder.createJavaParameter(Integer.TYPE, "index"));
  ...
  public static final SMethod<String> representAsText_id2iG$EWuTXv2 = new SMethodBuilder<>(String.class).name("representAsText").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2642648362195081154L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2();
  ...
  public static final SMethod<Void> parseAndAppendText_id68pBJP34v1v = new SMethodBuilder<>(Void.TYPE).name("parseAndAppendText").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7068855900723867743L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2(SMethodBuilder.createJavaParameter(String.class, "text"));
