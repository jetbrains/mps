...
/*package*/ class UrlTextualElement_InspectorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public UrlTextualElement_InspectorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_w88m4q_0");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_w88m4q_0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.address$M$I6;
