...
public class HtmlTag_LeftBrace_KeyMap extends KeyMapImpl {
  public HtmlTag_LeftBrace_KeyMap() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new HtmlTag_LeftBrace_KeyMap_Action0();
    this.putAction("any", " ", action);
  }
  public static class HtmlTag_LeftBrace_KeyMap_Action0 extends KeyMapActionImpl {
    public HtmlTag_LeftBrace_KeyMap_Action0() {
