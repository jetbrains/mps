...
public final class ConvertToParagraphs_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
    return ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$$cru)).isNotEmpty() && ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.paragraphs$MNJ2)).isEmpty();
  }
  @Override
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.lines$$cru)).visitAll(new IVisitor<SNode>() {
        public void visit(SNode it) {
          ...
          ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.paragraphs$MNJ2)).addElement(p);
          SNodeOperations.deleteNode(it);
          Paragraph__BehaviorDescriptor.initializeFromLine_id6n6K0Pj71DU.invoke(p, it);
        }
      });
      SLinkOperations.addNewChild(node, LINKS.lines$$cru, CONCEPTS.Line$w3);
    }
    @Override
  ...
  private static final class LINKS {
    /*package*/ static final SContainmentLink paragraphs$MNJ2 = MetaAdapterFactory.getContainmentLink(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x2331694e5619f411L, 0x7ee31bf598f6d778L, "paragraphs");
