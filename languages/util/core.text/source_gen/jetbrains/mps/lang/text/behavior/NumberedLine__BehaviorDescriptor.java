...
public final class NumberedLine__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> canBeTurnedToNumberedLine_id60UJ0Iso0yR = new SMethodBuilder<>(Boolean.TYPE).name("canBeTurnedToNumberedLine").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6934061334344501431L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2(SMethodBuilder.createJavaParameter(SNode.class, "l"));
  /*package*/ static final SMethod<Boolean> startsWithNumberSpace_id60UJ0IsnXdF = new SMethodBuilder<>(Boolean.TYPE).name("startsWithNumberSpace").modifiers(1, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(6934061334344487787L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2(SMethodBuilder.createJavaParameter(SNode.class, "l"));
