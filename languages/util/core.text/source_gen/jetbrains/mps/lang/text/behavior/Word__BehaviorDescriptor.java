...
public final class Word__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> normalize_id3yV2h2COV$s = new SMethodBuilder<>(SNode.class).name("normalize").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4087871053925431580L).languageId(0x89b0b5959c3fa8c8L, 0xc7fb639fbe784307L).build2();
