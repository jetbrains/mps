...
public final class MakeBulletLine_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;

  public MakeBulletLine_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:d0aef15b-6499-4272-812e-6bb6f7408ee0(jetbrains.mps.lang.text.intentions)", "2642648362195546611"));
  }

  @Override
  public String getPresentation() {
    return "MakeBulletLine";
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SNode replaceWithNewInitialized = SNodeFactoryOperations.replaceWithNewChild(SNodeOperations.getParent(node), CONCEPTS.BulletLine$ef);
    ...
    private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
      return SNodeOperations.getContainingLink(SNodeOperations.getParent(node)).isMultiple() && SNodeOperations.isInstanceOf(SNodeOperations.getParent(node), CONCEPTS.Line$yC) && !(SNodeOperations.isInstanceOf(SNodeOperations.getParent(node), CONCEPTS.BulletLine$ef));
    }


    @Override
    public IntentionDescriptor getDescriptor() {
      return MakeBulletLine_Intention.this;
    }
