...
/*package*/ class TextDeleteStrategyFactory {
  ...
  /*package*/ static TextStrategy createDeleteStrategy(SNode currentNode, EditorContext editorContext, boolean isForward) {
    ...
    if ((neighbour != null)) {
      ...
      SNode neighbourLine = SNodeOperations.cast(((isForward ? SNodeOperations.getNextSibling(currentLine) : SNodeOperations.getPrevSibling(currentLine))), CONCEPTS.Line$yC);
