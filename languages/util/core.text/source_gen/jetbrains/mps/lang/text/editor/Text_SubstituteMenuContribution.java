...
public class Text_SubstituteMenuContribution extends SubstituteMenuBase {
  public Text_SubstituteMenuContribution() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "IPlaceholderContent", new SNodePointer("r:ad87c166-8161-4e40-b79b-3d7ba4070d9e(jetbrains.mps.lang.text.editor)", "4058177569375321748")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Action_dmpu6l_a extends SingleItemSubstituteMenuPart {
    ...
    private class Item extends DefaultSubstituteMenuItem {
      ...
      /*package*/ void resetTraceInfo() {
        ...
        updateTraceInfo(description, new SNodePointer("r:ad87c166-8161-4e40-b79b-3d7ba4070d9e(jetbrains.mps.lang.text.editor)", "4058177569375321755"));
      }
