...
public class EmptyParagraphLetter_TransformationMenu extends TransformationMenuBase {
  public EmptyParagraphLetter_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "EmptyParagraphLetter", new SNodePointer("r:ad87c166-8161-4e40-b79b-3d7ba4070d9e(jetbrains.mps.lang.text.editor)", "4949381856255299040")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM));
  }
  ...
  private class TMP_Action_mm7vrk_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:ad87c166-8161-4e40-b79b-3d7ba4070d9e(jetbrains.mps.lang.text.editor)", "3254004994132216456"));
        return this;
      }
      @Nullable
      @Override
