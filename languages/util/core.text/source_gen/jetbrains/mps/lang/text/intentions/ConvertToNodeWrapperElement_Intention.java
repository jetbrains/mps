...
public final class ConvertToNodeWrapperElement_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  private Collection<IntentionExecutable> myCachedExecutable;

  public ConvertToNodeWrapperElement_Intention() {
    super(Kind.NORMAL, false, new SNodePointer("r:d0aef15b-6499-4272-812e-6bb6f7408ee0(jetbrains.mps.lang.text.intentions)", "6245409794075373876"));
  }

  @Override
  public String getPresentation() {
    return "ConvertToNodeWrapperElement";
  }
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      SNodeFactoryOperations.replaceWithNewChild(node, CONCEPTS.NodeWrapperElement$c8);
    }
    ...
    public IntentionDescriptor getDescriptor() {
      return ConvertToNodeWrapperElement_Intention.this;
    }
