...
/*package*/ class Word_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private Color _StyleParameter_QueryFunction_8g1p9d_a3b0() {
    if (isNotEmptyString(SPropertyOperations.getString(getNode(), PROPS.url$SIrt))) {
      return MPSColors.BLUE;
    }
    return MPSColors.BLACK;
  }
  private int _StyleParameter_QueryFunction_8g1p9d_a4b0() {
    if (SPropertyOperations.getBoolean(getNode(), PROPS.bold$SBR1) && SPropertyOperations.getBoolean(getNode(), PROPS.italic$SC$4)) {
      return MPSFonts.BOLD_ITALIC;
    } else if (SPropertyOperations.getBoolean(getNode(), PROPS.bold$SBR1)) {
      return MPSFonts.BOLD;
    } else if (SPropertyOperations.getBoolean(getNode(), PROPS.italic$SC$4)) {
