...
/*package*/ class SimpleExtensionMethodsContainer_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new staticFieldsListHandler_kgfzrc_a4a(myNode, getEditorContext());
  ...
  private static class staticFieldsListHandler_kgfzrc_a4a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.staticFields$J2SP;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.ExtensionStaticFieldDeclaration$Ec;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(staticFieldsListHandler_kgfzrc_a4a.this.getNode(), LINKS.staticFields$J2SP));
      try {
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new methodsListHandler_kgfzrc_c4a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
  ...
  private static class methodsListHandler_kgfzrc_c4a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.methods$7wWM;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.ExtensionMethodDeclaration$mW;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(methodsListHandler_kgfzrc_c4a.this.getNode(), LINKS.methods$7wWM));
      try {
        EditorCell emptyCell = null;
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept ExtensionStaticFieldDeclaration$Ec = MetaAdapterFactory.getConcept(0x5dc5fc0d37ef4782L, 0x81928b5ce1f69f80L, 0x1b622d944bc0aff7L, "jetbrains.mps.baseLanguage.extensionMethods.structure.ExtensionStaticFieldDeclaration");
