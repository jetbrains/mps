...
/*package*/ class LocalExtendedMethodCall_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.instanceMethodDeclaration$s6Wh);
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink instanceMethodDeclaration$s6Wh = MetaAdapterFactory.getReferenceLink(0x5dc5fc0d37ef4782L, 0x81928b5ce1f69f80L, 0x6aa7ca55518b9170L, 0x6aa7ca55518b9171L, "instanceMethodDeclaration");
  }
