...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForBaseExtensionMethodContainer() {
    ...
    // extends: jetbrains.mps.baseLanguage.structure.GenericDeclaration
    b.super_(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x102463b447aL);
  ...
  private static ConceptDescriptor createDescriptorForExtensionMethodCall() {
    ...
    b.version(3);
    b.associate("extension", 0x1583d1b63359483cL).target(0x5dc5fc0d37ef4782L, 0x81928b5ce1f69f80L, 0x1583d1b63365e7f9L).optional(false).origin("1550313277221324860").specialize(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x11857355952L, 0xf8c78301adL).done();
  ...
  private static ConceptDescriptor createDescriptorForExtensionStaticFieldReference() {
    ...
    b.version(3);
    b.associate("staticFieldDeclaration", 0x17c5dbeccc5dec7dL).target(0x5dc5fc0d37ef4782L, 0x81928b5ce1f69f80L, 0x1b622d944bc0aff7L).optional(false).origin("1713017043371814013").specialize(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c77f1e98L, 0xf8cc6bf960L).done();
    b.kind(ConceptKind.NORMAL, StaticScope.NONE);
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForLocalExtendedMethodCall() {
    ...
    b.version(3);
    b.associate("instanceMethodDeclaration", 0x6aa7ca55518b9171L).target(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b21dL).optional(false).origin("7685333756920172913").specialize(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x11857355952L, 0xf8c78301adL).done();
    b.kind(ConceptKind.NORMAL, StaticScope.NONE);
    return b.create();
  }
  private static ConceptDescriptor createDescriptorForSimpleExtensionMethodsContainer() {
    ...
    // extends: jetbrains.mps.baseLanguage.extensionMethods.structure.BaseExtensionMethodContainer
    b.super_(0x5dc5fc0d37ef4782L, 0x81928b5ce1f69f80L, 0x6f5433076549f519L);
