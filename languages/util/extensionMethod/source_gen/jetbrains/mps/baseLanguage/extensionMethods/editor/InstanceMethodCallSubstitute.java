...
public class InstanceMethodCallSubstitute extends SubstituteMenuBase {
  public InstanceMethodCallSubstitute() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "InstanceMethodCallSubstitute", new SNodePointer("r:ba4ce2b4-b708-4183-95e3-2753aef5bf29(jetbrains.mps.baseLanguage.extensionMethods.editor)", "1741258697587119514")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_ru4l93_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts() {
      return Arrays.<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>asList(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Param_ru4l93_a0(), CONCEPTS.DotExpression$yW));
    }
    private class SMP_Param_ru4l93_a0 extends ParameterizedMenuPart<SNode, SubstituteMenuItem, SubstituteMenuContext> {
      ...
      protected List<SubstituteMenuItem> createItems(SNode parameter, SubstituteMenuContext context) {
        return new SMP_Action_ru4l93_a0a(parameter).createItems(context);
      }
      @NotNull
      @Override
      public List<SubstituteMenuItem> createItems(@NotNull SubstituteMenuContext context) {
      ...
      private class SMP_Action_ru4l93_a0a extends SingleItemSubstituteMenuPart {
        ...
        private class Item extends DefaultSubstituteMenuItem {
          ...
          /*package*/ void resetTraceInfo() {
            ...
            updateTraceInfo(description, new SNodePointer("r:ba4ce2b4-b708-4183-95e3-2753aef5bf29(jetbrains.mps.baseLanguage.extensionMethods.editor)", "1741258697587119614"));
          }
