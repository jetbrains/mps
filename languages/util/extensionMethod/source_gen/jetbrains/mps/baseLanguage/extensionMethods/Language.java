...
import jetbrains.mps.baseLanguage.extensionMethods.constraints.GeneratedRulesConstraintsAspect;
...
public class Language extends LanguageRuntime {
  ...
  public Language() {
    myId = SLanguageId.deserialize("5dc5fc0d-37ef-4782-8192-8b5ce1f69f80");
  }
  ...
  protected <T extends ILanguageAspect> T createAspect(Class<T> aspectClass) {
    ...
    if (aspectClass == BehaviorAspectDescriptor.class) {
      return aspectClass.cast(new jetbrains.mps.baseLanguage.extensionMethods.behavior.BehaviorAspectDescriptor());
    }
    if (aspectClass == ConstraintsAspectDescriptor.class) {
      return aspectClass.cast(new jetbrains.mps.baseLanguage.extensionMethods.constraints.ConstraintsAspectDescriptor());
    }
    ...
    if (aspectClass == StructureAspectDescriptor.class) {
      return aspectClass.cast(new jetbrains.mps.baseLanguage.extensionMethods.structure.StructureAspectDescriptor());
    }
