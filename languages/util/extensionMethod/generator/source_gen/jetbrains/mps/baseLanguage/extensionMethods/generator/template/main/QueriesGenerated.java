...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static boolean rule_Condition_0_0(final BaseMappingRuleContext _context) {
    return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(_context.getNode(), LINKS.operation$gs9E), CONCEPTS.ExtensionMethodCall$xm);
  }
  public static Object propertyMacro_GetValue_2_0(final PropertyMacroContext _context) {
    SNode extension = SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(_context.getNode(), LINKS.operation$gs9E), CONCEPTS.ExtensionMethodCall$xm), LINKS.baseMethodDeclaration$pyYw);
    String namespace = SModelOperations.getModelName(SNodeOperations.getModel(extension));
    String className = SPropertyOperations.getString(SNodeOperations.cast(SNodeOperations.getParent(extension), CONCEPTS.INamedConcept$Kd), PROPS.name$MnvL);
    return namespace + '.' + className;
  }
  public static Object propertyMacro_GetValue_2_1(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(_context.getNode(), LINKS.operation$gs9E), CONCEPTS.ExtensionMethodCall$xm), LINKS.baseMethodDeclaration$pyYw), PROPS.name$MnvL);
  }
  ...
  public static Object referenceMacro_GetReferent_1_0(final ReferenceMacroContext _context) {
    return _context.getOutputNodeByInputNodeAndMappingLabel(SNodeOperations.getNodeAncestor(_context.getNode(), CONCEPTS.ExtensionMethodDeclaration$mW, false, false), "thisParam");
  }
  ...
  public static SNode sourceNodeQuery_2_1(final SourceSubstituteMacroNodeContext _context) {
    return (SNode) ExtensionMethodDeclaration__BehaviorDescriptor.getThisType_id6XkcKt_eUWM.invoke(SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(_context.getNode(), LINKS.operation$gs9E), CONCEPTS.ExtensionMethodCall$xm), LINKS.baseMethodDeclaration$pyYw));
  }
  ...
  public static Iterable<SNode> sourceNodesQuery_2_0(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(SNodeOperations.cast(SLinkOperations.getTarget(_context.getNode(), LINKS.operation$gs9E), CONCEPTS.ExtensionMethodCall$xm), LINKS.typeArgument$jaIN);
  }
  public static Iterable<SNode> sourceNodesQuery_2_1(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(SNodeOperations.cast(SLinkOperations.getTarget(_context.getNode(), LINKS.operation$gs9E), CONCEPTS.ExtensionMethodCall$xm), LINKS.actualArgument$pzdx);
  }
  public static Iterable<SNode> sourceNodesQuery_3_0(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(_context.getNode(), LINKS.staticFields$J2SP);
  }
  ...
  public static Iterable<SNode> sourceNodesQuery_3_2(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(_context.getNode(), LINKS.methods$7wWM);
  }
  public static Iterable<SNode> sourceNodesQuery_3_3(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(SNodeOperations.getNodeAncestor(_context.getNode(), CONCEPTS.TypeExtension$Er, false, false), LINKS.typeVariableDeclaration$Lipp);
  }
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SContainmentLink staticFields$J2SP = MetaAdapterFactory.getContainmentLink(0x5dc5fc0d37ef4782L, 0x81928b5ce1f69f80L, 0x6f5433076549f519L, 0x1b622d944bbb1c5fL, "staticFields");
