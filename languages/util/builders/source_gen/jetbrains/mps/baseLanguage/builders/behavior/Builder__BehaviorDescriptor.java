...
public final class Builder__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getContextBuilder_id67LR$5LPgSh = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getContextBuilder").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("67LR$5LPgSh").build();
  ...
  public static final SMethod<SNode> getCreatorExpression_id67LR$5LQRIR = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getCreatorExpression").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).id("67LR$5LQRIR").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  ...
  public static final SMethod<SNode> getContextBuilder_id67LR$5LPv$c = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getContextBuilder").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).id("67LR$5LPv$c").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
