...
public class Builder_SubstituteMenu extends SubstituteMenuBase {
  public Builder_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "Builder", new SNodePointer("r:4b2fc856-1e6f-49a5-825e-2904bdab655c(jetbrains.mps.baseLanguage.builders.editor)", "1741258697587117601")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_85pfem_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_85pfem_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:4b2fc856-1e6f-49a5-825e-2904bdab655c(jetbrains.mps.baseLanguage.builders.editor)", "1741258697587117603")));
    }
    @Override
    ...
    private class SMP_Wrap_85pfem_a0 extends WrapperSubstituteMenuPart {
      private SMP_Wrap_85pfem_a0() {
        super(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "Type", new SNodePointer("r:4b2fc856-1e6f-49a5-825e-2904bdab655c(jetbrains.mps.baseLanguage.builders.editor)", "1741258697587117638")));
      }
  ...
  public class SMP_Subconcepts_85pfem_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_85pfem_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "Builder", new SNodePointer("r:4b2fc856-1e6f-49a5-825e-2904bdab655c(jetbrains.mps.baseLanguage.builders.editor)", "1741258697587117794")));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.Builder$Cf);
    }
