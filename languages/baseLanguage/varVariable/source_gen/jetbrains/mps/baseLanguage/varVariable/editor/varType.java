...
public class varType extends TransformationMenuBase {
  public varType() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default transformation menu for " + "Type", new SNodePointer("r:c7cd0bd2-9f1a-40db-94ef-4882de6f36b2(jetbrains.mps.baseLanguage.varVariable.editor)", "4792977609793407658")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  public class TMP_WrapSM_1yb43k_a0 extends WrapSubstituteMenuTransformationMenuPart {
    ...
    private class SMIasTMI extends SubstituteMenuItemAsActionItem implements SubstituteCompletionActionItem {
      ...
      public void execute(@NotNull String pattern) {
        ...
        if (SNodeOperations.hasRole(_context.getNode(), LINKS.type$a1UY) && SConceptOperations.isExactly(SNodeOperations.asSConcept(SNodeOperations.getConcept(SNodeOperations.getParent(_context.getNode()))), CONCEPTS.LocalVariableDeclaration$41)) {
          SLinkOperations.setTarget(SNodeFactoryOperations.replaceWithNewChild(SNodeOperations.getParent(_context.getNode()), CONCEPTS.VarVariableDeclaration$pa), LINKS.type$a1UY, createdNode);
        } else {
