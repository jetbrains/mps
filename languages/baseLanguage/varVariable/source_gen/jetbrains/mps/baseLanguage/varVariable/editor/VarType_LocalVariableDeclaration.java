...
public class VarType_LocalVariableDeclaration extends SubstituteMenuBase {
  public VarType_LocalVariableDeclaration() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "VarType_LocalVariableDeclaration", new SNodePointer("r:c7cd0bd2-9f1a-40db-94ef-4882de6f36b2(jetbrains.mps.baseLanguage.varVariable.editor)", "4792977609794484734")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Action_sr4kig_a extends SingleItemSubstituteMenuPart {
    ...
    private class Item extends DefaultSubstituteMenuItem {
      ...
      /*package*/ void resetTraceInfo() {
        ...
        updateTraceInfo(description, new SNodePointer("r:c7cd0bd2-9f1a-40db-94ef-4882de6f36b2(jetbrains.mps.baseLanguage.varVariable.editor)", "4852852411435221769"));
      }
