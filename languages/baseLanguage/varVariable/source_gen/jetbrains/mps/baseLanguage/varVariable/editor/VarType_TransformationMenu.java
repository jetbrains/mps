...
public class VarType_TransformationMenu extends TransformationMenuBase {
  public VarType_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "VarType", new SNodePointer("r:c7cd0bd2-9f1a-40db-94ef-4882de6f36b2(jetbrains.mps.baseLanguage.varVariable.editor)", "4852852411435283396")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.SUBSTITUTE).contains(_context.getMenuLocation())) {
      result.add(new TMP_WrapSM_fgzokj_a0());
    }
    return result;
  }

  public class TMP_WrapSM_fgzokj_a0 extends WrapSubstituteMenuTransformationMenuPart {
    @NotNull
    @Override
    public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("wrap substitute menu " + "default substitute menu for " + "Type", new SNodePointer("r:c7cd0bd2-9f1a-40db-94ef-4882de6f36b2(jetbrains.mps.baseLanguage.varVariable.editor)", "4852852411435283404")));
      try {
    ...
    private class SMIasTMI extends SubstituteMenuItemAsActionItem implements SubstituteCompletionActionItem {
      ...
      public void execute(@NotNull String pattern) {
        ...
        if (SNodeOperations.hasRole(_context.getNode(), LINKS.type$a1UY) && SConceptOperations.isExactly(SNodeOperations.asSConcept(SNodeOperations.getConcept(SNodeOperations.getParent(_context.getNode()))), CONCEPTS.VarVariableDeclaration$pa)) {
          SLinkOperations.setTarget(SNodeFactoryOperations.replaceWithNewChild(SNodeOperations.getParent(_context.getNode()), CONCEPTS.LocalVariableDeclaration$41), LINKS.type$a1UY, createdNode);
        } else {
