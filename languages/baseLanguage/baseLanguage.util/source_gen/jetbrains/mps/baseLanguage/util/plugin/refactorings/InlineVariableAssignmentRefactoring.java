...
public class InlineVariableAssignmentRefactoring extends InlineVariableRefactoring {
  ...
  public static SNode findStatementList(SNode node) {
    ...
    if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(body), CONCEPTS.IStatementListContainer$xz) && !((boolean) IStatementListContainer__BehaviorDescriptor.isExecuteSynchronous_idhTIpcC8.invoke(SNodeOperations.cast(SNodeOperations.getParent(body), CONCEPTS.IStatementListContainer$xz)))) {
      return body;
    }
