...
public final class ThisClassifierExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getClassifier_idhEwJeDN = new SMethodBuilder<>(SNode.class).name("getClassifier").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877512819L).languageId(0x95008d06ed259e3eL, 0x443f4c36fcf54eb6L).build2();
  public static final SMethod<List<SNode>> getPossibleClassifiers_idhJm8WEN = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getPossibleClassifiers").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1219068414643L).languageId(0x95008d06ed259e3eL, 0x443f4c36fcf54eb6L).build2();
