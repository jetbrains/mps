...
public final class IClassifierPart__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getMainClassifier_idhEwIfO4 = new SMethodBuilder<>(SNode.class).name("getMainClassifier").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877255428L).languageId(0x95008d06ed259e3eL, 0x443f4c36fcf54eb6L).build2();
  public static final SMethod<List<SNode>> getMembers_idhEwIfO7 = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getMembers").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877255431L).languageId(0x95008d06ed259e3eL, 0x443f4c36fcf54eb6L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getMainClassifier_idhEwIfO4, getMembers_idhEwIfO7);
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 1:
        return (T) ((List<SNode>) getMembers_idhEwIfO7(node));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
