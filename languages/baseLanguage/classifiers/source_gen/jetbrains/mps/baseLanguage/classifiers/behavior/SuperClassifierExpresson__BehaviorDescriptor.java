...
public final class SuperClassifierExpresson__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getClassifier_idhHOIkvz = new SMethodBuilder<>(SNode.class).name("getClassifier").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1217434044387L).languageId(0x95008d06ed259e3eL, 0x443f4c36fcf54eb6L).build2();
