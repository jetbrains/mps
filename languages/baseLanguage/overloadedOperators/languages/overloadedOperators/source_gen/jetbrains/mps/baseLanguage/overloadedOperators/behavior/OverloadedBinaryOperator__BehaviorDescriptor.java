...
public final class OverloadedBinaryOperator__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getFunctionName_id5MF4VwG2rD2 = new SMethodBuilder<>(String.class).name("getFunctionName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6677452554240637506L).languageId(0xb749aab2fb23aefcL, 0xfc8d557e5de64dd8L).build2();
