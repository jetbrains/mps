...
public class CustomOperatorUsageTransform_Contribution extends TransformationMenuBase {
  public CustomOperatorUsageTransform_Contribution() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default transformation menu for " + "Expression", new SNodePointer("r:13d16a02-6fc1-4986-8d3c-61aadbaeccd7(jetbrains.mps.baseLanguage.overloadedOperators.editor)", "1741258697587178575")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  private class TMP_Param_z54bif_a0 extends ParameterizedMenuPart<SNode, TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<TransformationMenuItem> createItems(SNode parameter, TransformationMenuContext context) {
      return new TMP_Action_z54bif_a0a(parameter).createItems(context);
    }
    ...
    private class TMP_Action_z54bif_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem, ConstraintsVerifiableActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:13d16a02-6fc1-4986-8d3c-61aadbaeccd7(jetbrains.mps.baseLanguage.overloadedOperators.editor)", "1741258697587178591"));
          return this;
        }
        @Nullable
        @Override
