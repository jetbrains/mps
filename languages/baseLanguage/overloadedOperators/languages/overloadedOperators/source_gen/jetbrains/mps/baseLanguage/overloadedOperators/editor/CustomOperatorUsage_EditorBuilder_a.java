...
/*package*/ class CustomOperatorUsage_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftExpressionSingleRoleHandler_fe04xc_a0(myNode, LINKS.leftExpression$sEj, getEditorContext());
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.operator$R44$;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.operator$R44$);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.operator$R44$);
    }
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightExpressionSingleRoleHandler_fe04xc_c0(myNode, LINKS.rightExpression$nvX, getEditorContext());
    return provider.createCell();
  }
