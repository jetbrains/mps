...
public class InferredClosureParameterDeclaration_TransformationMenu extends TransformationMenuBase {
  public InferredClosureParameterDeclaration_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "InferredClosureParameterDeclaration", new SNodePointer("r:00000000-0000-4000-0000-011c89590336(jetbrains.mps.baseLanguage.closures.editor)", "2524418899405758589")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM));
  }
