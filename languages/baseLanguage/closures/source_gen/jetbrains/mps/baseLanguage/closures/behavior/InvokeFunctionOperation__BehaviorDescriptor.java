...
public final class InvokeFunctionOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<SNode>> getParameters_idnfIF2FKNkP = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getParameters").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(418758558327452981L).languageId(0x907112563d152375L, 0xfd3920347849419dL).build2();
