    ...
    this.addRefactoring(new AbstractMigrationRefactoring() {
      ...
      public void doUpdateInstanceNode(SNode node) {
        ...
        for (SNode ifc : SNodeOperations.ofConcept(SLinkOperations.getChildren(fncls, LINKS.member$L_2d), CONCEPTS.Interface$db)) {
          ListSequence.fromList(SLinkOperations.getChildren(ssw, LINKS.case$8PWE)).addElement(_quotation_createNode_tdy3l4_a0a0a11a0a(SPropertyOperations.getString(ifc, PROPS.name$MnvL), NodePointer__BehaviorDescriptor.create_id4nxIQVL$eu9.invoke(SNodeOperations.asSConcept(CONCEPTS.NodePointer$6k), SNodeOperations.getModel(node), ifc.getReference())));
        }
      }
      @Override
