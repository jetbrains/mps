...
public class transform_FunctionType_to_ClassifierLiteralType extends TransformationMenuBase {
  ...
  public class TMP_Group_f0n48v_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_f0n48v_a0.TMP_Action_f0n48v_a0a(), CONCEPTS.ClosureLiteralType$AF));
    }
    private class TMP_Action_f0n48v_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        TMP_Group_f0n48v_a0.TMP_Action_f0n48v_a0a.Item item = new TMP_Group_f0n48v_a0.TMP_Action_f0n48v_a0a.Item(context);
        String description;
        try {
  ...
  private static SNode _quotation_createNode_f0n48v_a0a0b0a0a0(Object parameter_1, Object parameter_2, Object parameter_3) {
    ...
    quotedNode_4 = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xfd3920347849419dL, 0x907112563d152375L, "jetbrains.mps.baseLanguage.closures"), 0xe8770ba07b68051L, "ClosureLiteralType")).getResult();
    {
