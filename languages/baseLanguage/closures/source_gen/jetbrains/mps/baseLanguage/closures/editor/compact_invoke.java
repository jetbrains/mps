...
public class compact_invoke extends TransformationMenuBase {
  ...
  public class TMP_Group_hyoqyy_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_hyoqyy_a0.TMP_Action_hyoqyy_a0a(), CONCEPTS.CompactInvokeFunctionExpression$_X));
    }
