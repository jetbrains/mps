...
public class remove_ReturnStatement extends SubstituteMenuBase {
  public remove_ReturnStatement() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "remove_ReturnStatement", new SNodePointer("r:00000000-0000-4000-0000-011c89590336(jetbrains.mps.baseLanguage.closures.editor)", "1741258697587051208")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_jk3faa_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_jk3faa_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:00000000-0000-4000-0000-011c89590336(jetbrains.mps.baseLanguage.closures.editor)", "1741258697587051210")));
    }
    @Override
