...
public class PrepStatementUtil {
  ...
  private void prepTopStatementList(TemplateQueryContext genContext, SNode slist) {
    ...
    this._prepStatementList(genContext, slist);
  }
  private int _prepStatementList(TemplateQueryContext genContext, SNode slist) {
  ...
  private int prepWhileStatement(TemplateQueryContext genContext, SNode wstmt, int label) {
    ...
    this._prepStatementList(genContext, SLinkOperations.getTarget(wstmt, LINKS.body$c1sm));
    return nextLabel;
  }
  private int prepDoWhileStatement(TemplateQueryContext genContext, SNode dwstmt, int label) {
    ...
    this._prepStatementList(genContext, SLinkOperations.getTarget(dwstmt, LINKS.body$c1sm));
    return nextLabel;
  }
  private int prepForStatement(TemplateQueryContext genContext, SNode fstmt, int label) {
    ...
    this._prepStatementList(genContext, SLinkOperations.getTarget(fstmt, LINKS.body$c1sm));
    return nextLabel;
  }
  ...
  private int prepIfStatement(TemplateQueryContext genContext, SNode ifstmt, int label) {
    ...
    Values.CLOSURE_DATA.set(genContext, sn, data);
    this._prepStatementList(genContext, SLinkOperations.getTarget(ifstmt, LINKS.ifTrue$5Rg8));
    if (ListSequence.fromList(SLinkOperations.getChildren(ifstmt, LINKS.elsifClauses$EVJW)).isNotEmpty()) {
      for (SNode eicls : SLinkOperations.getChildren(ifstmt, LINKS.elsifClauses$EVJW)) {
        ...
        this._prepStatementList(genContext, SLinkOperations.getTarget(eicls, LINKS.statementList$neQf));
    ...
    if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(ifstmt, LINKS.ifFalseStatement$psZK), CONCEPTS.BlockStatement$u4)) {
      ...
      Values.CLOSURE_DATA.set(genContext, sn1, data1);
      this._prepStatementList(genContext, SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(ifstmt, LINKS.ifFalseStatement$psZK), CONCEPTS.BlockStatement$u4), LINKS.statements$q65M));
    } else
    if ((SLinkOperations.getTarget(ifstmt, LINKS.ifFalseStatement$psZK) != null)) {
  ...
  private int prepSwitchStatement(TemplateQueryContext genContext, SNode sstmt, int label) {
    ...
    for (SNode scase : SLinkOperations.getChildren(sstmt, LINKS.case$8PWE)) {
      ...
      if ((SLinkOperations.getTarget(scase, LINKS.body$5LhG) != null)) {
        ...
        Values.CLOSURE_DATA.set(genContext, sn, data);
        this._prepStatementList(genContext, SLinkOperations.getTarget(scase, LINKS.body$5LhG));
      }
    }
    if ((SLinkOperations.getTarget(sstmt, LINKS.defaultBlock$QOu8) != null)) {
      ...
      Values.CLOSURE_DATA.set(genContext, sn, data);
      this._prepStatementList(genContext, SLinkOperations.getTarget(sstmt, LINKS.defaultBlock$QOu8));
    }
    return nextLabel;
  }
  ...
  private int prepBlockStatement(TemplateQueryContext genContext, SNode bs, int label) {
    ...
    Object data1 = new Integer[]{beginLabel, nextLabel};
    Values.CLOSURE_DATA.set(genContext, sn, data1);
    int tmp = this._prepStatementList(genContext, SLinkOperations.getTarget(bs, LINKS.statements$q65M));
  ...
  public static void prepStatementList(TemplateQueryContext genContext, SNode slist) {
    PrepStatementUtil psu = new PrepStatementUtil();
