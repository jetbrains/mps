...
public final class ClosureLiteral__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getFunctionInterfaceName_idhEwI$6K = new SMethodBuilder<>(String.class).name("getFunctionInterfaceName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877338544L).languageId(0x907112563d152375L, 0xfd3920347849419dL).build2();
  public static final SMethod<SNode> getType_idhTgUC0Q = new SMethodBuilder<>(SNode.class).name("getType").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1229718192182L).languageId(0x907112563d152375L, 0xfd3920347849419dL).build2(SMethodBuilder.createJavaParameter((Class<List<SNode>>) ((Class) Object.class), "paramTypes"), SMethodBuilder.createJavaParameter(SNode.class, "resultType"), SMethodBuilder.createJavaParameter(SNode.class, "returnType"), SMethodBuilder.createJavaParameter(SNode.class, "termType"), SMethodBuilder.createJavaParameter((Class<List<SNode>>) ((Class) Object.class), "throwsTypes"));
  ...
  public static final SMethod<Boolean> isClosure_id2P5W1FWMZPJ = new SMethodBuilder<>(Boolean.TYPE).name("isClosure").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3262277503800835439L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
