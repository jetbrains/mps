...
with_meet:
  ...
  private static boolean isFunctionTypeClassifier(SNode classifier) {
    return SNodeOperations.isInstanceOf(classifier, CONCEPTS.Interface$db) && Objects.equals(SNodeOperations.getModel(classifier).getReference().getModelName(), SNodeOperations.getModel(SLinkOperations.getTarget(_quotation_createNode_zgotlq_a0a0a0a0a0f(), LINKS.classifier$cxMr)).getReference().getModelName());
  }
