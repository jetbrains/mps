    ...
    while (!(ListSequence.fromList(allStmts).isEmpty())) {
      ...
      if (SNodeOperations.isInstanceOf(stmt, CONCEPTS.YieldStatement$ER)) {
        ...
        if (SNodeOperations.isInstanceOf(stmt, CONCEPTS.ThrowStatement$yK)) {
          ...
          for (SNode caught : ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(stmt, CONCEPTS.TryStatement$Vw), LINKS.catchClause$EvoR)).where(new IWhereFilter<SNode>() {
            public boolean accept(SNode it) {
              return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SLinkOperations.getTarget(it, LINKS.throwable$T0lV), LINKS.type$uWuc), CONCEPTS.ClassifierType$IZ);
            }
          }).select(new ISelector<SNode, SNode>() {
            public SNode select(SNode it) {
              return SNodeOperations.as(SLinkOperations.getTarget(SLinkOperations.getTarget(it, LINKS.throwable$T0lV), LINKS.type$uWuc), CONCEPTS.ClassifierType$IZ);
            }
          })) {
          ...
          for (SNode caught : ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(stmt, CONCEPTS.TryCatchStatement$x5), LINKS.catchClause$yGV3)).where(new IWhereFilter<SNode>() {
            public boolean accept(SNode it) {
              return SNodeOperations.isInstanceOf(SLinkOperations.getTarget(SLinkOperations.getTarget(it, LINKS.throwable$T0lV), LINKS.type$uWuc), CONCEPTS.ClassifierType$IZ);
            }
          }).select(new ISelector<SNode, SNode>() {
