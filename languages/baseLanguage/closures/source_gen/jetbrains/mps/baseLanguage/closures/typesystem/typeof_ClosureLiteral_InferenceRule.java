  ...
  public void applyRule(final SNode closure, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    while (!(ListSequence.fromList(allStmts).isEmpty())) {
      ...
      if (SNodeOperations.isInstanceOf(stmt, CONCEPTS.YieldStatement$yx)) {
        ...
        } else if (SNodeOperations.isInstanceOf(stmt, CONCEPTS.TryStatement$oi)) {
          for (SNode caught : ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(stmt, CONCEPTS.TryStatement$oi), LINKS.catchClause$l$PD)).where(new IWhereFilter<SNode>() {
