...
public class InstanceMethodCallSubstitute extends SubstituteMenuBase {
  ...
  public class SMP_Group_ru4l93_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_ru4l93_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:ba4ce2b4-b708-4183-95e3-2753aef5bf29(jetbrains.mps.baseLanguage.extensionMethods.editor)", "1741258697587119516")));
    }
    @Override
