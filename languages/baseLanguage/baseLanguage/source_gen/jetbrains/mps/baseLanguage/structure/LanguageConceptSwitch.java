...
public final class LanguageConceptSwitch {
  ...
  public static final int IInferredExpression = 131;
  public static final int IInferredType = 132;
  public static final int IInternalType = 133;
  public static final int ILocalDeclaration = 134;
  public static final int ILocalReference = 135;
  public static final int ILocalVariableElement = 136;
  public static final int ILocalVariableElementList = 137;
  public static final int IMemberContainer = 138;
  public static final int IMethodCall = 139;
  public static final int IMethodLike = 140;
  public static final int IOperation = 141;
  public static final int IParameter = 142;
  public static final int ISkipsReturn = 143;
  public static final int IStatementListContainer = 144;
  public static final int IStaticContainerForMethods = 145;
  public static final int IThisExpression = 146;
  public static final int IThrowCheckedExceptions = 147;
  public static final int ITryCatchStatement = 148;
  public static final int ITypeApplicable = 149;
  public static final int IValidIdentifier = 150;
  public static final int IVariableAssignment = 151;
  public static final int IVariableDeclaration = 152;
  public static final int IVariableReference = 153;
  public static final int IVisible = 154;
  public static final int IWillBeClassifier = 155;
  public static final int IYetUnresolved = 156;
  public static final int IfStatement = 157;
  public static final int ImplicitAnnotationInstanceValue = 158;
  public static final int ImplicitAnnotationMethodKind = 159;
  public static final int IncompleteLeftParen = 160;
  public static final int IncompleteMemberDeclaration = 161;
  public static final int IncompleteRightParen = 162;
  public static final int InstanceInitializer = 163;
  public static final int InstanceMethodCallOperation = 164;
  public static final int InstanceMethodDeclaration = 165;
  public static final int InstanceOfExpression = 166;
  public static final int IntegerConstant = 167;
  public static final int IntegerLiteral = 168;
  public static final int IntegerType = 169;
  public static final int Interface = 170;
  public static final int IsEmptyOperation = 171;
  public static final int IsNotEmptyOperation = 172;
  public static final int JavaImport = 173;
  public static final int JavaImports = 174;
  public static final int JavaModifier = 175;
  public static final int LeftShiftAssignmentExpression = 176;
  public static final int LessThanExpression = 177;
  public static final int LessThanOrEqualsExpression = 178;
  public static final int LocalInstanceFieldReference = 179;
  public static final int LocalInstanceMethodCall = 180;
  public static final int LocalMethodCall = 181;
  public static final int LocalPropertyReference = 182;
  public static final int LocalStaticFieldReference = 183;
  public static final int LocalStaticMethodCall = 184;
  public static final int LocalToMethodKind = 185;
  public static final int LocalVariableDeclaration = 186;
  public static final int LocalVariableDeclarationStatement = 187;
  public static final int LongLiteral = 188;
  public static final int LongType = 189;
  public static final int LoopLabel = 190;
  public static final int LoopLabelReference = 191;
  public static final int LowerBoundType = 192;
  public static final int MethodDeclaration = 193;
  public static final int MinusAssignmentExpression = 194;
  public static final int MinusExpression = 195;
  public static final int Modifier = 196;
  public static final int MulAssignmentExpression = 197;
  public static final int MulExpression = 198;
  public static final int MultiLineComment = 199;
  public static final int MultipleCatchClause = 200;
  public static final int NPEEqualsExpression = 201;
  public static final int NPENotEqualsExpression = 202;
  public static final int NestedNewExpression = 203;
  public static final int NotEqualsExpression = 204;
  public static final int NotExpression = 205;
  public static final int NullLiteral = 206;
  public static final int NullType = 207;
  public static final int Number = 208;
  public static final int OctalIntegerLiteral = 209;
  public static final int OperationAssignmentExpression = 210;
  public static final int OrAssignmentExpression = 211;
  public static final int OrExpression = 212;
  public static final int ParameterDeclaration = 213;
  public static final int ParenthesizedExpression = 214;
  public static final int PassByRefExpression = 215;
  public static final int PlaceholderMember = 216;
  public static final int PlusAssignmentExpression = 217;
  public static final int PlusExpression = 218;
  public static final int PostfixDecrementExpression = 219;
  public static final int PostfixIncrementExpression = 220;
  public static final int PrefixDecrementExpression = 221;
  public static final int PrefixIncrementExpression = 222;
  public static final int PrimitiveClassExpression = 223;
  public static final int PrimitiveType = 224;
  public static final int PrivateVisibility = 225;
  public static final int Property = 226;
  public static final int PropertyImplementation = 227;
  public static final int PropertyReference = 228;
  public static final int PropertyValueReference = 229;
  public static final int ProtectedVisibility = 230;
  public static final int PublicVisibility = 231;
  public static final int QualifiedReference = 232;
  public static final int QualifiedSuperMethodCall = 233;
  public static final int RemAssignmentExpression = 234;
  public static final int RemExpression = 235;
  public static final int RemarkStatement = 236;
  public static final int ResourceVariable = 237;
  public static final int ReturnStatement = 238;
  public static final int RightShiftAssignmentExpression = 239;
  public static final int SetAccessor = 240;
  public static final int ShiftLeftExpression = 241;
  public static final int ShiftRightExpression = 242;
  public static final int ShiftRightUnsignedExpression = 243;
  public static final int ShortType = 244;
  public static final int SingleLineComment = 245;
  public static final int Statement = 246;
  public static final int StatementCommentPart = 247;
  public static final int StatementList = 248;
  public static final int StaticFieldDeclaration = 249;
  public static final int StaticFieldReference = 250;
  public static final int StaticFieldReferenceOperation = 251;
  public static final int StaticInitializer = 252;
  public static final int StaticKind = 253;
  public static final int StaticMethodCall = 254;
  public static final int StaticMethodCallOperation = 255;
  public static final int StaticMethodDeclaration = 256;
  public static final int StringBooleanOperation = 257;
  public static final int StringLiteral = 258;
  public static final int StringToken = 259;
  public static final int StringType = 260;
  public static final int StubInitializer = 261;
  public static final int StubStatementList = 262;
  public static final int SubstringExpression = 263;
  public static final int SuperConstructorInvocation = 264;
  public static final int SuperConstructorKind = 265;
  public static final int SuperInerfaceKind = 266;
  public static final int SuperInterfaceMethodCall = 267;
  public static final int SuperMethodCall = 268;
  public static final int SuperMethodKind = 269;
  public static final int SwitchCase = 270;
  public static final int SwitchCaseExtension = 271;
  public static final int SwitchStatement = 272;
  public static final int SynchronizedStatement = 273;
  public static final int TernaryOperatorExpression = 274;
  public static final int TextCommentPart = 275;
  public static final int ThisConstructorInvocation = 276;
  public static final int ThisConstructorKind = 277;
  public static final int ThisExpression = 278;
  public static final int ThrowStatement = 279;
  public static final int Tokens = 280;
  public static final int TrimOperation = 281;
  public static final int TryCatchStatement = 282;
  public static final int TryFinallyStatement = 283;
  public static final int TryUniversalStatement = 284;
  public static final int Type = 285;
  public static final int TypeAnnotable = 286;
  public static final int TypeDerivable = 287;
  public static final int TypeVariableDeclaration = 288;
  public static final int TypeVariableReference = 289;
  public static final int UnaryMinus = 290;
  public static final int UndefinedType = 291;
  public static final int UnknownConsCall = 292;
  public static final int UnknownDotCall = 293;
  public static final int UnknownInstanceMethodCall = 294;
  public static final int UnknownLocalCall = 295;
  public static final int UnknownNameRef = 296;
  public static final int UnknownNew = 297;
  public static final int UnresolvedNameReference = 298;
  public static final int UnsignedRightShiftAssignmentExpression = 299;
  public static final int UpperBoundType = 300;
  public static final int UsingStatement = 301;
  public static final int ValueParameter = 302;
  public static final int ValueRef = 303;
  public static final int VariableArityType = 304;
  public static final int VariableDeclaration = 305;
  public static final int VariableReference = 306;
  public static final int Visibility = 307;
  public static final int VoidType = 308;
  public static final int WhileStatement = 309;
  public static final int WildCardType = 310;
  public static final int XorAssignmentExpression = 311;
