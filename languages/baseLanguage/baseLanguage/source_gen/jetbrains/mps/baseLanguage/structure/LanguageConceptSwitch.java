...
public final class LanguageConceptSwitch {
  ...
  public static final int IsEmptyOperation = 175;
  public static final int IsNotEmptyOperation = 176;
  public static final int JavaImport = 177;
  public static final int JavaImports = 178;
  public static final int JavaModifier = 179;
  public static final int LeftShiftAssignmentExpression = 180;
  public static final int LessThanExpression = 181;
  public static final int LessThanOrEqualsExpression = 182;
  public static final int LocalInstanceFieldReference = 183;
  public static final int LocalInstanceMethodCall = 184;
  public static final int LocalMethodCall = 185;
  public static final int LocalPropertyReference = 186;
  public static final int LocalStaticFieldReference = 187;
  public static final int LocalStaticMethodCall = 188;
  public static final int LocalToMethodKind = 189;
  public static final int LocalVariableDeclaration = 190;
  public static final int LocalVariableDeclarationStatement = 191;
  public static final int LongLiteral = 192;
  public static final int LongType = 193;
  public static final int LoopLabel = 194;
  public static final int LoopLabelReference = 195;
  public static final int LowerBoundType = 196;
  public static final int MethodDeclaration = 197;
  public static final int MinusAssignmentExpression = 198;
  public static final int MinusExpression = 199;
  public static final int Modifier = 200;
  public static final int MulAssignmentExpression = 201;
  public static final int MulExpression = 202;
  public static final int MultiLineComment = 203;
  public static final int MultipleCatchClause = 204;
  public static final int NPEEqualsExpression = 205;
  public static final int NPENotEqualsExpression = 206;
  public static final int NestedNewExpression = 207;
  public static final int NotEqualsExpression = 208;
  public static final int NotExpression = 209;
  public static final int NullLiteral = 210;
  public static final int NullType = 211;
  public static final int Number = 212;
  public static final int OctalIntegerLiteral = 213;
  public static final int OperationAssignmentExpression = 214;
  public static final int OrAssignmentExpression = 215;
  public static final int OrExpression = 216;
  public static final int ParameterDeclaration = 217;
  public static final int ParenthesizedExpression = 218;
  public static final int PassByRefExpression = 219;
  public static final int PlaceholderMember = 220;
  public static final int PlusAssignmentExpression = 221;
  public static final int PlusExpression = 222;
  public static final int PostfixDecrementExpression = 223;
  public static final int PostfixIncrementExpression = 224;
  public static final int PrefixDecrementExpression = 225;
  public static final int PrefixIncrementExpression = 226;
  public static final int PrimitiveClassExpression = 227;
  public static final int PrimitiveType = 228;
  public static final int PrivateVisibility = 229;
  public static final int Property = 230;
  public static final int PropertyImplementation = 231;
  public static final int PropertyReference = 232;
  public static final int PropertyValueReference = 233;
  public static final int ProtectedVisibility = 234;
  public static final int PublicVisibility = 235;
  public static final int QualifiedReference = 236;
  public static final int QualifiedSuperMethodCall = 237;
  public static final int RemAssignmentExpression = 238;
  public static final int RemExpression = 239;
  public static final int RemarkStatement = 240;
  public static final int ResourceVariable = 241;
  public static final int ReturnStatement = 242;
  public static final int RightShiftAssignmentExpression = 243;
  public static final int SetAccessor = 244;
  public static final int ShiftLeftExpression = 245;
  public static final int ShiftRightExpression = 246;
  public static final int ShiftRightUnsignedExpression = 247;
  public static final int ShortType = 248;
  public static final int SingleLineComment = 249;
  public static final int Statement = 250;
  public static final int StatementCommentPart = 251;
  public static final int StatementList = 252;
  public static final int StaticFieldDeclaration = 253;
  public static final int StaticFieldReference = 254;
  public static final int StaticFieldReferenceOperation = 255;
  public static final int StaticInitializer = 256;
  public static final int StaticKind = 257;
  public static final int StaticMethodCall = 258;
  public static final int StaticMethodCallOperation = 259;
  public static final int StaticMethodDeclaration = 260;
  public static final int StringBooleanOperation = 261;
  public static final int StringLiteral = 262;
  public static final int StringToken = 263;
  public static final int StringType = 264;
  public static final int StubInitializer = 265;
  public static final int StubStatementList = 266;
  public static final int SubstringExpression = 267;
  public static final int SuperConstructorInvocation = 268;
  public static final int SuperConstructorKind = 269;
  public static final int SuperInerfaceKind = 270;
  public static final int SuperInterfaceMethodCall = 271;
  public static final int SuperMethodCall = 272;
  public static final int SuperMethodKind = 273;
  public static final int SwitchCase = 274;
  public static final int SwitchCaseExtension = 275;
  public static final int SwitchStatement = 276;
  public static final int SynchronizedStatement = 277;
  public static final int TernaryOperatorExpression = 278;
  public static final int TextCommentPart = 279;
  public static final int ThisConstructorInvocation = 280;
  public static final int ThisConstructorKind = 281;
  public static final int ThisExpression = 282;
  public static final int ThrowStatement = 283;
  public static final int Tokens = 284;
  public static final int TrimOperation = 285;
  public static final int TryCatchStatement = 286;
  public static final int TryFinallyStatement = 287;
  public static final int TryUniversalStatement = 288;
  public static final int Type = 289;
  public static final int TypeAnnotable = 290;
  public static final int TypeDerivable = 291;
  public static final int TypeVariableDeclaration = 292;
  public static final int TypeVariableReference = 293;
  public static final int UnaryMinus = 294;
  public static final int UndefinedType = 295;
  public static final int UnknownConsCall = 296;
  public static final int UnknownDotCall = 297;
  public static final int UnknownInstanceMethodCall = 298;
  public static final int UnknownLocalCall = 299;
  public static final int UnknownNameRef = 300;
  public static final int UnknownNew = 301;
  public static final int UnresolvedNameReference = 302;
  public static final int UnsignedRightShiftAssignmentExpression = 303;
  public static final int UpperBoundType = 304;
  public static final int UsingStatement = 305;
  public static final int ValueParameter = 306;
  public static final int ValueRef = 307;
  public static final int VariableArityType = 308;
  public static final int VariableDeclaration = 309;
  public static final int VariableReference = 310;
  public static final int Visibility = 311;
  public static final int VoidType = 312;
  public static final int WhileStatement = 313;
  public static final int WildCardType = 314;
  public static final int XorAssignmentExpression = 315;
