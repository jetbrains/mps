...
public final class LanguageConceptSwitch {
  ...
  public static final int IGenericType = 125;
  public static final int IHasModifiers = 126;
  public static final int IIncompleteParen = 127;
  public static final int IInternalType = 128;
  public static final int ILocalDeclaration = 129;
  public static final int ILocalReference = 130;
  public static final int ILocalVariableElement = 131;
  public static final int ILocalVariableElementList = 132;
  public static final int IMemberContainer = 133;
  public static final int IMethodCall = 134;
  public static final int IMethodLike = 135;
  public static final int IOperation = 136;
  public static final int IParameter = 137;
  public static final int ISkipsReturn = 138;
  public static final int IStatementListContainer = 139;
  public static final int IStaticContainerForMethods = 140;
  public static final int IThisExpression = 141;
  public static final int IThrowCheckedExceptions = 142;
  public static final int ITryCatchStatement = 143;
  public static final int ITypeApplicable = 144;
  public static final int IValidIdentifier = 145;
  public static final int IVariableAssignment = 146;
  public static final int IVariableDeclaration = 147;
  public static final int IVariableReference = 148;
  public static final int IVisible = 149;
  public static final int IWillBeClassifier = 150;
  public static final int IYetUnresolved = 151;
  public static final int IfStatement = 152;
  public static final int ImplicitAnnotationInstanceValue = 153;
  public static final int ImplicitAnnotationMethodKind = 154;
  public static final int IncompleteLeftParen = 155;
  public static final int IncompleteMemberDeclaration = 156;
  public static final int IncompleteRightParen = 157;
  public static final int InstanceInitializer = 158;
  public static final int InstanceMethodCallOperation = 159;
  public static final int InstanceMethodDeclaration = 160;
  public static final int InstanceOfExpression = 161;
  public static final int IntegerConstant = 162;
  public static final int IntegerLiteral = 163;
  public static final int IntegerType = 164;
  public static final int Interface = 165;
  public static final int IsEmptyOperation = 166;
  public static final int IsNotEmptyOperation = 167;
  public static final int JavaImport = 168;
  public static final int JavaImports = 169;
  public static final int JavaModifier = 170;
  public static final int LeftShiftAssignmentExpression = 171;
  public static final int LessThanExpression = 172;
  public static final int LessThanOrEqualsExpression = 173;
  public static final int LocalInstanceFieldReference = 174;
  public static final int LocalInstanceMethodCall = 175;
  public static final int LocalMethodCall = 176;
  public static final int LocalPropertyReference = 177;
  public static final int LocalStaticFieldReference = 178;
  public static final int LocalStaticMethodCall = 179;
  public static final int LocalToMethodKind = 180;
  public static final int LocalVariableDeclaration = 181;
  public static final int LocalVariableDeclarationStatement = 182;
  public static final int LongLiteral = 183;
  public static final int LongType = 184;
  public static final int LoopLabel = 185;
  public static final int LoopLabelReference = 186;
  public static final int LowerBoundType = 187;
  public static final int MethodDeclaration = 188;
  public static final int MinusAssignmentExpression = 189;
  public static final int MinusExpression = 190;
  public static final int Modifier = 191;
  public static final int MulAssignmentExpression = 192;
  public static final int MulExpression = 193;
  public static final int MultiLineComment = 194;
  public static final int MultipleCatchClause = 195;
  public static final int NPEEqualsExpression = 196;
  public static final int NPENotEqualsExpression = 197;
  public static final int NestedNewExpression = 198;
  public static final int NotEqualsExpression = 199;
  public static final int NotExpression = 200;
  public static final int NullLiteral = 201;
  public static final int NullType = 202;
  public static final int Number = 203;
  public static final int OctalIntegerLiteral = 204;
  public static final int OperationAssignmentExpression = 205;
  public static final int OrAssignmentExpression = 206;
  public static final int OrExpression = 207;
  public static final int ParameterDeclaration = 208;
  public static final int ParenthesizedExpression = 209;
  public static final int PassByRefExpression = 210;
  public static final int PlaceholderMember = 211;
  public static final int PlusAssignmentExpression = 212;
  public static final int PlusExpression = 213;
  public static final int PostfixDecrementExpression = 214;
  public static final int PostfixIncrementExpression = 215;
  public static final int PrefixDecrementExpression = 216;
  public static final int PrefixIncrementExpression = 217;
  public static final int PrimitiveClassExpression = 218;
  public static final int PrimitiveType = 219;
  public static final int PrivateVisibility = 220;
  public static final int Property = 221;
  public static final int PropertyImplementation = 222;
  public static final int PropertyReference = 223;
  public static final int PropertyValueReference = 224;
  public static final int ProtectedVisibility = 225;
  public static final int PublicVisibility = 226;
  public static final int QualifiedReference = 227;
  public static final int QualifiedSuperMethodCall = 228;
  public static final int RemAssignmentExpression = 229;
  public static final int RemExpression = 230;
  public static final int RemarkStatement = 231;
  public static final int ResourceVariable = 232;
  public static final int ReturnStatement = 233;
  public static final int RightShiftAssignmentExpression = 234;
  public static final int SetAccessor = 235;
  public static final int ShiftLeftExpression = 236;
  public static final int ShiftRightExpression = 237;
  public static final int ShiftRightUnsignedExpression = 238;
  public static final int ShortType = 239;
  public static final int SingleLineComment = 240;
  public static final int Statement = 241;
  public static final int StatementCommentPart = 242;
  public static final int StatementList = 243;
  public static final int StaticFieldDeclaration = 244;
  public static final int StaticFieldReference = 245;
  public static final int StaticFieldReferenceOperation = 246;
  public static final int StaticInitializer = 247;
  public static final int StaticKind = 248;
  public static final int StaticMethodCall = 249;
  public static final int StaticMethodCallOperation = 250;
  public static final int StaticMethodDeclaration = 251;
  public static final int StringBooleanOperation = 252;
  public static final int StringLiteral = 253;
  public static final int StringToken = 254;
  public static final int StringType = 255;
  public static final int StubInitializer = 256;
  public static final int StubStatementList = 257;
  public static final int SubstringExpression = 258;
  public static final int SuperConstructorInvocation = 259;
  public static final int SuperConstructorKind = 260;
  public static final int SuperInerfaceKind = 261;
  public static final int SuperInterfaceMethodCall = 262;
  public static final int SuperMethodCall = 263;
  public static final int SuperMethodKind = 264;
  public static final int SwitchCase = 265;
  public static final int SwitchCaseExtension = 266;
  public static final int SwitchStatement = 267;
  public static final int SynchronizedStatement = 268;
  public static final int TernaryOperatorExpression = 269;
  public static final int TextCommentPart = 270;
  public static final int ThisConstructorInvocation = 271;
  public static final int ThisConstructorKind = 272;
  public static final int ThisExpression = 273;
  public static final int ThrowStatement = 274;
  public static final int Tokens = 275;
  public static final int TrimOperation = 276;
  public static final int TryCatchStatement = 277;
  public static final int TryFinallyStatement = 278;
  public static final int TryUniversalStatement = 279;
  public static final int Type = 280;
  public static final int TypeAnnotable = 281;
  public static final int TypeDerivable = 282;
  public static final int TypeVariableDeclaration = 283;
  public static final int TypeVariableReference = 284;
  public static final int UnaryMinus = 285;
  public static final int UndefinedType = 286;
  public static final int UnknownConsCall = 287;
  public static final int UnknownDotCall = 288;
  public static final int UnknownLocalCall = 289;
  public static final int UnknownNameRef = 290;
  public static final int UnknownNew = 291;
  public static final int UnresolvedNameReference = 292;
  public static final int UnsignedRightShiftAssignmentExpression = 293;
  public static final int UpperBoundType = 294;
  public static final int UsingStatement = 295;
  public static final int ValueParameter = 296;
  public static final int ValueRef = 297;
  public static final int VariableArityType = 298;
  public static final int VariableDeclaration = 299;
  public static final int VariableReference = 300;
  public static final int Visibility = 301;
  public static final int VoidType = 302;
  public static final int WhileStatement = 303;
  public static final int WildCardType = 304;
  public static final int XorAssignmentExpression = 305;
