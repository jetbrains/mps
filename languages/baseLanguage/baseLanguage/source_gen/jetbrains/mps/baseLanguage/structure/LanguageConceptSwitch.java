...
public final class LanguageConceptSwitch {
  ...
  public static final int FormatOperation = 104;
  public static final int GenericDeclaration = 105;
  public static final int GenericLValueExpression = 106;
  public static final int GenericNewExpression = 107;
  public static final int GetAccessor = 108;
  public static final int GreaterThanExpression = 109;
  public static final int GreaterThanOrEqualsExpression = 110;
  public static final int HasAnnotation = 111;
  public static final int HexIntegerLiteral = 112;
  public static final int IAnonymousClass = 113;
  public static final int IBLDeprecatable = 114;
  public static final int IBinaryLike = 115;
  public static final int IClassifier = 116;
  public static final int IClassifierMember = 117;
  public static final int IClassifierType = 118;
  public static final int IComment = 119;
  public static final int IConditional = 120;
  public static final int IContainsStatementList = 121;
  public static final int IControlFlowInterrupter = 122;
  public static final int ICustomConstructorReference = 123;
  public static final int IExtractMethodAvailable = 124;
  public static final int IFinalWrapper = 125;
  public static final int IFixableMethodReference = 126;
  public static final int IGenericClassCreator = 127;
  public static final int IGenericType = 128;
  public static final int IHasModifiers = 129;
  public static final int IIncompleteParen = 130;
  public static final int IInferenceContextProvider = 131;
  public static final int IInferredExpression = 132;
  public static final int IInferredType = 133;
  public static final int IInheritableFeature = 134;
  public static final int IInternalType = 135;
  public static final int ILocalDeclaration = 136;
  public static final int ILocalReference = 137;
  public static final int ILocalVariableElement = 138;
  public static final int ILocalVariableElementList = 139;
  public static final int IMemberContainer = 140;
  public static final int IMethodCall = 141;
  public static final int IMethodLike = 142;
  public static final int IOperation = 143;
  public static final int IParameter = 144;
  public static final int ISkipsReturn = 145;
  public static final int IStatementListContainer = 146;
  public static final int IStaticContainerForMethods = 147;
  public static final int IThisExpression = 148;
  public static final int IThrowCheckedExceptions = 149;
  public static final int ITryCatchStatement = 150;
  public static final int ITypeApplicable = 151;
  public static final int IValidIdentifier = 152;
  public static final int IVariableAssignment = 153;
  public static final int IVariableDeclaration = 154;
  public static final int IVariableReference = 155;
  public static final int IVisible = 156;
  public static final int IWillBeClassifier = 157;
  public static final int IYetUnresolved = 158;
  public static final int IfStatement = 159;
  public static final int ImplicitAnnotationInstanceValue = 160;
  public static final int ImplicitAnnotationMethodKind = 161;
  public static final int IncompleteLeftParen = 162;
  public static final int IncompleteMemberDeclaration = 163;
  public static final int IncompleteRightParen = 164;
  public static final int InferredClassifierType = 165;
  public static final int InstanceInitializer = 166;
  public static final int InstanceMethodCallOperation = 167;
  public static final int InstanceMethodDeclaration = 168;
  public static final int InstanceOfExpression = 169;
  public static final int IntegerConstant = 170;
  public static final int IntegerLiteral = 171;
  public static final int IntegerType = 172;
  public static final int Interface = 173;
  public static final int IsEmptyOperation = 174;
  public static final int IsNotEmptyOperation = 175;
  public static final int JavaImport = 176;
  public static final int JavaImports = 177;
  public static final int JavaModifier = 178;
  public static final int LeftShiftAssignmentExpression = 179;
  public static final int LessThanExpression = 180;
  public static final int LessThanOrEqualsExpression = 181;
  public static final int LocalInstanceFieldReference = 182;
  public static final int LocalInstanceMethodCall = 183;
  public static final int LocalMethodCall = 184;
  public static final int LocalPropertyReference = 185;
  public static final int LocalStaticFieldReference = 186;
  public static final int LocalStaticMethodCall = 187;
  public static final int LocalToMethodKind = 188;
  public static final int LocalVariableDeclaration = 189;
  public static final int LocalVariableDeclarationStatement = 190;
  public static final int LongLiteral = 191;
  public static final int LongType = 192;
  public static final int LoopLabel = 193;
  public static final int LoopLabelReference = 194;
  public static final int LowerBoundType = 195;
  public static final int MethodDeclaration = 196;
  public static final int MinusAssignmentExpression = 197;
  public static final int MinusExpression = 198;
  public static final int Modifier = 199;
  public static final int MulAssignmentExpression = 200;
  public static final int MulExpression = 201;
  public static final int MultiLineComment = 202;
  public static final int MultipleCatchClause = 203;
  public static final int NPEEqualsExpression = 204;
  public static final int NPENotEqualsExpression = 205;
  public static final int NestedNewExpression = 206;
  public static final int NotEqualsExpression = 207;
  public static final int NotExpression = 208;
  public static final int NullLiteral = 209;
  public static final int NullType = 210;
  public static final int Number = 211;
  public static final int OctalIntegerLiteral = 212;
  public static final int OperationAssignmentExpression = 213;
  public static final int OrAssignmentExpression = 214;
  public static final int OrExpression = 215;
  public static final int ParameterDeclaration = 216;
  public static final int ParenthesizedExpression = 217;
  public static final int PassByRefExpression = 218;
  public static final int PlaceholderMember = 219;
  public static final int PlusAssignmentExpression = 220;
  public static final int PlusExpression = 221;
  public static final int PostfixDecrementExpression = 222;
  public static final int PostfixIncrementExpression = 223;
  public static final int PrefixDecrementExpression = 224;
  public static final int PrefixIncrementExpression = 225;
  public static final int PrimitiveClassExpression = 226;
  public static final int PrimitiveType = 227;
  public static final int PrivateVisibility = 228;
  public static final int Property = 229;
  public static final int PropertyImplementation = 230;
  public static final int PropertyReference = 231;
  public static final int PropertyValueReference = 232;
  public static final int ProtectedVisibility = 233;
  public static final int PublicVisibility = 234;
  public static final int QualifiedReference = 235;
  public static final int QualifiedSuperMethodCall = 236;
  public static final int RemAssignmentExpression = 237;
  public static final int RemExpression = 238;
  public static final int RemarkStatement = 239;
  public static final int ResourceVariable = 240;
  public static final int ReturnStatement = 241;
  public static final int RightShiftAssignmentExpression = 242;
  public static final int SetAccessor = 243;
  public static final int ShiftLeftExpression = 244;
  public static final int ShiftRightExpression = 245;
  public static final int ShiftRightUnsignedExpression = 246;
  public static final int ShortType = 247;
  public static final int SingleLineComment = 248;
  public static final int Statement = 249;
  public static final int StatementCommentPart = 250;
  public static final int StatementList = 251;
  public static final int StaticFieldDeclaration = 252;
  public static final int StaticFieldReference = 253;
  public static final int StaticFieldReferenceOperation = 254;
  public static final int StaticInitializer = 255;
  public static final int StaticKind = 256;
  public static final int StaticMethodCall = 257;
  public static final int StaticMethodCallOperation = 258;
  public static final int StaticMethodDeclaration = 259;
  public static final int StringBooleanOperation = 260;
  public static final int StringLiteral = 261;
  public static final int StringToken = 262;
  public static final int StringType = 263;
  public static final int StubInitializer = 264;
  public static final int StubStatementList = 265;
  public static final int SubstringExpression = 266;
  public static final int SuperConstructorInvocation = 267;
  public static final int SuperConstructorKind = 268;
  public static final int SuperInerfaceKind = 269;
  public static final int SuperInterfaceMethodCall = 270;
  public static final int SuperMethodCall = 271;
  public static final int SuperMethodKind = 272;
  public static final int SwitchCase = 273;
  public static final int SwitchCaseExtension = 274;
  public static final int SwitchStatement = 275;
  public static final int SynchronizedStatement = 276;
  public static final int TernaryOperatorExpression = 277;
  public static final int TextCommentPart = 278;
  public static final int ThisConstructorInvocation = 279;
  public static final int ThisConstructorKind = 280;
  public static final int ThisExpression = 281;
  public static final int ThrowStatement = 282;
  public static final int Tokens = 283;
  public static final int TrimOperation = 284;
  public static final int TryCatchStatement = 285;
  public static final int TryFinallyStatement = 286;
  public static final int TryUniversalStatement = 287;
  public static final int Type = 288;
  public static final int TypeAnnotable = 289;
  public static final int TypeDerivable = 290;
  public static final int TypeVariableDeclaration = 291;
  public static final int TypeVariableReference = 292;
  public static final int UnaryMinus = 293;
  public static final int UndefinedType = 294;
  public static final int UnknownConsCall = 295;
  public static final int UnknownDotCall = 296;
  public static final int UnknownInstanceMethodCall = 297;
  public static final int UnknownLocalCall = 298;
  public static final int UnknownNameRef = 299;
  public static final int UnknownNew = 300;
  public static final int UnresolvedNameReference = 301;
  public static final int UnsignedRightShiftAssignmentExpression = 302;
  public static final int UpperBoundType = 303;
  public static final int UsingStatement = 304;
  public static final int ValueParameter = 305;
  public static final int ValueRef = 306;
  public static final int VariableArityType = 307;
  public static final int VariableDeclaration = 308;
  public static final int VariableReference = 309;
  public static final int Visibility = 310;
  public static final int VoidType = 311;
  public static final int WhileStatement = 312;
  public static final int WildCardType = 313;
  public static final int XorAssignmentExpression = 314;
