...
public final class LanguageConceptSwitch {
  ...
  public static final int EqualsExpression = 93;
  public static final int EscapeOperation = 94;
  public static final int Expression = 95;
  public static final int ExpressionStatement = 96;
  public static final int FieldDeclaration = 97;
  public static final int FieldReferenceOperation = 98;
  public static final int FinallyClause = 99;
  public static final int FloatType = 100;
  public static final int FloatingPointConstant = 101;
  public static final int FloatingPointFloatConstant = 102;
  public static final int ForStatement = 103;
  public static final int ForeachStatement = 104;
  public static final int FormatOperation = 105;
  public static final int GenericDeclaration = 106;
  public static final int GenericLValueExpression = 107;
  public static final int GenericNewExpression = 108;
  public static final int GetAccessor = 109;
  public static final int GreaterThanExpression = 110;
  public static final int GreaterThanOrEqualsExpression = 111;
  public static final int HasAnnotation = 112;
  public static final int HexIntegerLiteral = 113;
  public static final int IAnonymousClass = 114;
  public static final int IBLDeprecatable = 115;
  public static final int IBinaryLike = 116;
  public static final int IClassifier = 117;
  public static final int IClassifierMember = 118;
  public static final int IClassifierType = 119;
  public static final int IComment = 120;
  public static final int IConditional = 121;
  public static final int IContainsStatementList = 122;
  public static final int IControlFlowInterrupter = 123;
  public static final int ICustomConstructorReference = 124;
  public static final int IExtractMethodAvailable = 125;
  public static final int IFinalWrapper = 126;
  public static final int IFixableMethodReference = 127;
  public static final int IGenericClassCreator = 128;
  public static final int IGenericType = 129;
  public static final int IHasModifiers = 130;
  public static final int IIncompleteParen = 131;
  public static final int IInferenceContextProvider = 132;
  public static final int IInferredExpression = 133;
  public static final int IInferredType = 134;
  public static final int IInheritableFeature = 135;
  public static final int IInternalType = 136;
  public static final int ILocalDeclaration = 137;
  public static final int ILocalReference = 138;
  public static final int ILocalVariableElement = 139;
  public static final int ILocalVariableElementList = 140;
  public static final int IMemberContainer = 141;
  public static final int IMethodCall = 142;
  public static final int IMethodLike = 143;
  public static final int IOperation = 144;
  public static final int IParameter = 145;
  public static final int ISkipsReturn = 146;
  public static final int IStatementListContainer = 147;
  public static final int IStaticContainerForMethods = 148;
  public static final int IThisExpression = 149;
  public static final int IThrowCheckedExceptions = 150;
  public static final int ITryCatchStatement = 151;
  public static final int ITypeApplicable = 152;
  public static final int IValidIdentifier = 153;
  public static final int IVariableAssignment = 154;
  public static final int IVariableDeclaration = 155;
  public static final int IVariableReference = 156;
  public static final int IVisible = 157;
  public static final int IWillBeClassifier = 158;
  public static final int IYetUnresolved = 159;
  public static final int IfStatement = 160;
  public static final int ImplicitAnnotationInstanceValue = 161;
  public static final int ImplicitAnnotationMethodKind = 162;
  public static final int IncompleteLeftParen = 163;
  public static final int IncompleteMemberDeclaration = 164;
  public static final int IncompleteRightParen = 165;
  public static final int InferredClassifierType = 166;
  public static final int InstanceInitializer = 167;
  public static final int InstanceMethodCallOperation = 168;
  public static final int InstanceMethodDeclaration = 169;
  public static final int InstanceOfExpression = 170;
  public static final int IntegerConstant = 171;
  public static final int IntegerLiteral = 172;
  public static final int IntegerType = 173;
  public static final int Interface = 174;
  public static final int IntersectionType = 175;
  public static final int IsEmptyOperation = 176;
  public static final int IsNotEmptyOperation = 177;
  public static final int JavaImport = 178;
  public static final int JavaImports = 179;
  public static final int JavaModifier = 180;
  public static final int LeftShiftAssignmentExpression = 181;
  public static final int LessThanExpression = 182;
  public static final int LessThanOrEqualsExpression = 183;
  public static final int LocalInstanceFieldReference = 184;
  public static final int LocalInstanceMethodCall = 185;
  public static final int LocalMethodCall = 186;
  public static final int LocalPropertyReference = 187;
  public static final int LocalStaticFieldReference = 188;
  public static final int LocalStaticMethodCall = 189;
  public static final int LocalToMethodKind = 190;
  public static final int LocalVariableDeclaration = 191;
  public static final int LocalVariableDeclarationStatement = 192;
  public static final int LongLiteral = 193;
  public static final int LongType = 194;
  public static final int LoopLabel = 195;
  public static final int LoopLabelReference = 196;
  public static final int LowerBoundType = 197;
  public static final int MethodDeclaration = 198;
  public static final int MinusAssignmentExpression = 199;
  public static final int MinusExpression = 200;
  public static final int Modifier = 201;
  public static final int MulAssignmentExpression = 202;
  public static final int MulExpression = 203;
  public static final int MultiLineComment = 204;
  public static final int MultipleCatchClause = 205;
  public static final int NPEEqualsExpression = 206;
  public static final int NPENotEqualsExpression = 207;
  public static final int NestedNewExpression = 208;
  public static final int NotEqualsExpression = 209;
  public static final int NotExpression = 210;
  public static final int NullLiteral = 211;
  public static final int NullType = 212;
  public static final int Number = 213;
  public static final int OctalIntegerLiteral = 214;
  public static final int OperationAssignmentExpression = 215;
  public static final int OrAssignmentExpression = 216;
  public static final int OrExpression = 217;
  public static final int ParameterDeclaration = 218;
  public static final int ParenthesizedExpression = 219;
  public static final int PassByRefExpression = 220;
  public static final int PlaceholderMember = 221;
  public static final int PlusAssignmentExpression = 222;
  public static final int PlusExpression = 223;
  public static final int PostfixDecrementExpression = 224;
  public static final int PostfixIncrementExpression = 225;
  public static final int PrefixDecrementExpression = 226;
  public static final int PrefixIncrementExpression = 227;
  public static final int PrimitiveClassExpression = 228;
  public static final int PrimitiveType = 229;
  public static final int PrivateVisibility = 230;
  public static final int Property = 231;
  public static final int PropertyImplementation = 232;
  public static final int PropertyReference = 233;
  public static final int PropertyValueReference = 234;
  public static final int ProtectedVisibility = 235;
  public static final int PublicVisibility = 236;
  public static final int QualifiedReference = 237;
  public static final int QualifiedSuperMethodCall = 238;
  public static final int RemAssignmentExpression = 239;
  public static final int RemExpression = 240;
  public static final int RemarkStatement = 241;
  public static final int ResourceVariable = 242;
  public static final int ReturnStatement = 243;
  public static final int RightShiftAssignmentExpression = 244;
  public static final int SetAccessor = 245;
  public static final int ShiftLeftExpression = 246;
  public static final int ShiftRightExpression = 247;
  public static final int ShiftRightUnsignedExpression = 248;
  public static final int ShortType = 249;
  public static final int SingleLineComment = 250;
  public static final int Statement = 251;
  public static final int StatementCommentPart = 252;
  public static final int StatementList = 253;
  public static final int StaticFieldDeclaration = 254;
  public static final int StaticFieldReference = 255;
  public static final int StaticFieldReferenceOperation = 256;
  public static final int StaticInitializer = 257;
  public static final int StaticKind = 258;
  public static final int StaticMethodCall = 259;
  public static final int StaticMethodCallOperation = 260;
  public static final int StaticMethodDeclaration = 261;
  public static final int StringBooleanOperation = 262;
  public static final int StringLiteral = 263;
  public static final int StringToken = 264;
  public static final int StringType = 265;
  public static final int StubInitializer = 266;
  public static final int StubStatementList = 267;
  public static final int SubstringExpression = 268;
  public static final int SuperConstructorInvocation = 269;
  public static final int SuperConstructorKind = 270;
  public static final int SuperInerfaceKind = 271;
  public static final int SuperInterfaceMethodCall = 272;
  public static final int SuperMethodCall = 273;
  public static final int SuperMethodKind = 274;
  public static final int SwitchCase = 275;
  public static final int SwitchCaseExtension = 276;
  public static final int SwitchStatement = 277;
  public static final int SynchronizedStatement = 278;
  public static final int TernaryOperatorExpression = 279;
  public static final int TextCommentPart = 280;
  public static final int ThisConstructorInvocation = 281;
  public static final int ThisConstructorKind = 282;
  public static final int ThisExpression = 283;
  public static final int ThrowStatement = 284;
  public static final int Tokens = 285;
  public static final int TrimOperation = 286;
  public static final int TryCatchStatement = 287;
  public static final int TryFinallyStatement = 288;
  public static final int TryUniversalStatement = 289;
  public static final int Type = 290;
  public static final int TypeAnnotable = 291;
  public static final int TypeDerivable = 292;
  public static final int TypeVariableDeclaration = 293;
  public static final int TypeVariableReference = 294;
  public static final int UnaryMinus = 295;
  public static final int UndefinedType = 296;
  public static final int UnionType = 297;
  public static final int UnknownConsCall = 298;
  public static final int UnknownDotCall = 299;
  public static final int UnknownInstanceMethodCall = 300;
  public static final int UnknownLocalCall = 301;
  public static final int UnknownNameRef = 302;
  public static final int UnknownNew = 303;
  public static final int UnresolvedNameReference = 304;
  public static final int UnsignedRightShiftAssignmentExpression = 305;
  public static final int UpperBoundType = 306;
  public static final int UsingStatement = 307;
  public static final int ValueParameter = 308;
  public static final int ValueRef = 309;
  public static final int VariableArityType = 310;
  public static final int VariableDeclaration = 311;
  public static final int VariableReference = 312;
  public static final int Visibility = 313;
  public static final int VoidType = 314;
  public static final int WhileStatement = 315;
  public static final int WildCardType = 316;
  public static final int XorAssignmentExpression = 317;
