...
public final class LanguageConceptSwitch {
  ...
  public static final int DummyCommant = 86;
  public static final int ElsifClause = 87;
  public static final int EnumClass = 88;
  public static final int EnumConstantCopyPasteOrigin = 89;
  public static final int EnumConstantDeclaration = 90;
  public static final int EnumConstantReference = 91;
  public static final int EnumValueOfExpression = 92;
  public static final int EnumValuesExpression = 93;
  public static final int EqualsExpression = 94;
  public static final int EscapeOperation = 95;
  public static final int Expression = 96;
  public static final int ExpressionStatement = 97;
  public static final int FieldDeclaration = 98;
  public static final int FieldReferenceOperation = 99;
  public static final int FinallyClause = 100;
  public static final int FloatType = 101;
  public static final int FloatingPointConstant = 102;
  public static final int FloatingPointFloatConstant = 103;
  public static final int ForStatement = 104;
  public static final int ForeachStatement = 105;
  public static final int FormatOperation = 106;
  public static final int GenericDeclaration = 107;
  public static final int GenericLValueExpression = 108;
  public static final int GenericNewExpression = 109;
  public static final int GetAccessor = 110;
  public static final int GreaterThanExpression = 111;
  public static final int GreaterThanOrEqualsExpression = 112;
  public static final int HasAnnotation = 113;
  public static final int HexIntegerLiteral = 114;
  public static final int IAnonymousClass = 115;
  public static final int IBLDeprecatable = 116;
  public static final int IBinaryLike = 117;
  public static final int IClassifier = 118;
  public static final int IClassifierMember = 119;
  public static final int IClassifierType = 120;
  public static final int IComment = 121;
  public static final int IConditional = 122;
  public static final int IContainsStatementList = 123;
  public static final int IControlFlowInterrupter = 124;
  public static final int ICustomConstructorReference = 125;
  public static final int IExtractMethodAvailable = 126;
  public static final int IFinalWrapper = 127;
  public static final int IFixableMethodReference = 128;
  public static final int IGenericClassCreator = 129;
  public static final int IGenericType = 130;
  public static final int IHasModifiers = 131;
  public static final int IIncompleteParen = 132;
  public static final int IInferenceContextProvider = 133;
  public static final int IInferredExpression = 134;
  public static final int IInferredType = 135;
  public static final int IInheritableFeature = 136;
  public static final int IInternalType = 137;
  public static final int ILocalDeclaration = 138;
  public static final int ILocalReference = 139;
  public static final int ILocalVariableElement = 140;
  public static final int ILocalVariableElementList = 141;
  public static final int IMemberContainer = 142;
  public static final int IMethodCall = 143;
  public static final int IMethodLike = 144;
  public static final int IOperation = 145;
  public static final int IParameter = 146;
  public static final int ISkipsReturn = 147;
  public static final int IStatementListContainer = 148;
  public static final int IStaticContainerForMethods = 149;
  public static final int IThisExpression = 150;
  public static final int IThrowCheckedExceptions = 151;
  public static final int ITryCatchStatement = 152;
  public static final int ITypeApplicable = 153;
  public static final int IValidIdentifier = 154;
  public static final int IVariableAssignment = 155;
  public static final int IVariableDeclaration = 156;
  public static final int IVariableReference = 157;
  public static final int IVisible = 158;
  public static final int IWillBeClassifier = 159;
  public static final int IYetUnresolved = 160;
  public static final int IfStatement = 161;
  public static final int ImplicitAnnotationInstanceValue = 162;
  public static final int ImplicitAnnotationMethodKind = 163;
  public static final int IncompleteLeftParen = 164;
  public static final int IncompleteMemberDeclaration = 165;
  public static final int IncompleteRightParen = 166;
  public static final int InferredClassifierType = 167;
  public static final int InferredType = 168;
  public static final int InstanceInitializer = 169;
  public static final int InstanceMethodCallOperation = 170;
  public static final int InstanceMethodDeclaration = 171;
  public static final int InstanceOfExpression = 172;
  public static final int IntegerConstant = 173;
  public static final int IntegerLiteral = 174;
  public static final int IntegerType = 175;
  public static final int Interface = 176;
  public static final int IntersectionType = 177;
  public static final int IsEmptyOperation = 178;
  public static final int IsNotEmptyOperation = 179;
  public static final int JavaImport = 180;
  public static final int JavaImports = 181;
  public static final int JavaModifier = 182;
  public static final int LeftShiftAssignmentExpression = 183;
  public static final int LessThanExpression = 184;
  public static final int LessThanOrEqualsExpression = 185;
  public static final int LocalInstanceFieldReference = 186;
  public static final int LocalInstanceMethodCall = 187;
  public static final int LocalMethodCall = 188;
  public static final int LocalPropertyReference = 189;
  public static final int LocalStaticFieldReference = 190;
  public static final int LocalStaticMethodCall = 191;
  public static final int LocalToMethodKind = 192;
  public static final int LocalVariableDeclaration = 193;
  public static final int LocalVariableDeclarationStatement = 194;
  public static final int LongLiteral = 195;
  public static final int LongType = 196;
  public static final int LoopLabel = 197;
  public static final int LoopLabelReference = 198;
  public static final int LowerBoundType = 199;
  public static final int MethodDeclaration = 200;
  public static final int MinusAssignmentExpression = 201;
  public static final int MinusExpression = 202;
  public static final int Modifier = 203;
  public static final int MulAssignmentExpression = 204;
  public static final int MulExpression = 205;
  public static final int MultiLineComment = 206;
  public static final int MultipleCatchClause = 207;
  public static final int NPEEqualsExpression = 208;
  public static final int NPENotEqualsExpression = 209;
  public static final int NestedNewExpression = 210;
  public static final int NotEqualsExpression = 211;
  public static final int NotExpression = 212;
  public static final int NullLiteral = 213;
  public static final int NullType = 214;
  public static final int Number = 215;
  public static final int OctalIntegerLiteral = 216;
  public static final int OperationAssignmentExpression = 217;
  public static final int OrAssignmentExpression = 218;
  public static final int OrExpression = 219;
  public static final int ParameterDeclaration = 220;
  public static final int ParenthesizedExpression = 221;
  public static final int PassByRefExpression = 222;
  public static final int PlaceholderMember = 223;
  public static final int PlusAssignmentExpression = 224;
  public static final int PlusExpression = 225;
  public static final int PostfixDecrementExpression = 226;
  public static final int PostfixIncrementExpression = 227;
  public static final int PrefixDecrementExpression = 228;
  public static final int PrefixIncrementExpression = 229;
  public static final int PrimitiveClassExpression = 230;
  public static final int PrimitiveType = 231;
  public static final int PrivateVisibility = 232;
  public static final int Property = 233;
  public static final int PropertyImplementation = 234;
  public static final int PropertyReference = 235;
  public static final int PropertyValueReference = 236;
  public static final int ProtectedVisibility = 237;
  public static final int PublicVisibility = 238;
  public static final int QualifiedReference = 239;
  public static final int QualifiedSuperMethodCall = 240;
  public static final int RemAssignmentExpression = 241;
  public static final int RemExpression = 242;
  public static final int RemarkStatement = 243;
  public static final int ResourceVariable = 244;
  public static final int ReturnStatement = 245;
  public static final int RightShiftAssignmentExpression = 246;
  public static final int SetAccessor = 247;
  public static final int ShiftLeftExpression = 248;
  public static final int ShiftRightExpression = 249;
  public static final int ShiftRightUnsignedExpression = 250;
  public static final int ShortType = 251;
  public static final int SingleLineComment = 252;
  public static final int Statement = 253;
  public static final int StatementCommentPart = 254;
  public static final int StatementList = 255;
  public static final int StaticFieldDeclaration = 256;
  public static final int StaticFieldReference = 257;
  public static final int StaticFieldReferenceOperation = 258;
  public static final int StaticInitializer = 259;
  public static final int StaticKind = 260;
  public static final int StaticMethodCall = 261;
  public static final int StaticMethodCallOperation = 262;
  public static final int StaticMethodDeclaration = 263;
  public static final int StringBooleanOperation = 264;
  public static final int StringLiteral = 265;
  public static final int StringToken = 266;
  public static final int StringType = 267;
  public static final int StubInitializer = 268;
  public static final int StubStatementList = 269;
  public static final int SubstringExpression = 270;
  public static final int SuperConstructorInvocation = 271;
  public static final int SuperConstructorKind = 272;
  public static final int SuperInerfaceKind = 273;
  public static final int SuperInterfaceMethodCall = 274;
  public static final int SuperMethodCall = 275;
  public static final int SuperMethodKind = 276;
  public static final int SwitchCase = 277;
  public static final int SwitchCaseExtension = 278;
  public static final int SwitchStatement = 279;
  public static final int SynchronizedStatement = 280;
  public static final int TernaryOperatorExpression = 281;
  public static final int TextCommentPart = 282;
  public static final int ThisConstructorInvocation = 283;
  public static final int ThisConstructorKind = 284;
  public static final int ThisExpression = 285;
  public static final int ThrowStatement = 286;
  public static final int Tokens = 287;
  public static final int TrimOperation = 288;
  public static final int TryCatchStatement = 289;
  public static final int TryFinallyStatement = 290;
  public static final int TryUniversalStatement = 291;
  public static final int Type = 292;
  public static final int TypeAnnotable = 293;
  public static final int TypeDerivable = 294;
  public static final int TypeVariableDeclaration = 295;
  public static final int TypeVariableReference = 296;
  public static final int UnaryMinus = 297;
  public static final int UndefinedType = 298;
  public static final int UnionType = 299;
  public static final int UnknownConsCall = 300;
  public static final int UnknownDotCall = 301;
  public static final int UnknownInstanceMethodCall = 302;
  public static final int UnknownLocalCall = 303;
  public static final int UnknownNameRef = 304;
  public static final int UnknownNew = 305;
  public static final int UnresolvedNameReference = 306;
  public static final int UnsignedRightShiftAssignmentExpression = 307;
  public static final int UpperBoundType = 308;
  public static final int UsingStatement = 309;
  public static final int ValueParameter = 310;
  public static final int ValueRef = 311;
  public static final int VariableArityType = 312;
  public static final int VariableDeclaration = 313;
  public static final int VariableReference = 314;
  public static final int Visibility = 315;
  public static final int VoidType = 316;
  public static final int WhileStatement = 317;
  public static final int WildCardType = 318;
  public static final int XorAssignmentExpression = 319;
