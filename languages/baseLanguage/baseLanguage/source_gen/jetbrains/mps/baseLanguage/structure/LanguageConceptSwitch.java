...
public final class LanguageConceptSwitch {
  ...
  public static final int IExtractMethodAvailable = 123;
  public static final int IFinalWrapper = 124;
  public static final int IFixableMethodReference = 125;
  public static final int IGenericType = 126;
  public static final int IHasModifiers = 127;
  public static final int IIncompleteParen = 128;
  public static final int IInferenceContextProvider = 129;
  public static final int IInferredExpression = 130;
  public static final int IInferredType = 131;
  public static final int IInternalType = 132;
  public static final int ILocalDeclaration = 133;
  public static final int ILocalReference = 134;
  public static final int ILocalVariableElement = 135;
  public static final int ILocalVariableElementList = 136;
  public static final int IMemberContainer = 137;
  public static final int IMethodCall = 138;
  public static final int IMethodLike = 139;
  public static final int IOperation = 140;
  public static final int IParameter = 141;
  public static final int ISkipsReturn = 142;
  public static final int IStatementListContainer = 143;
  public static final int IStaticContainerForMethods = 144;
  public static final int IThisExpression = 145;
  public static final int IThrowCheckedExceptions = 146;
  public static final int ITryCatchStatement = 147;
  public static final int ITypeApplicable = 148;
  public static final int IValidIdentifier = 149;
  public static final int IVariableAssignment = 150;
  public static final int IVariableDeclaration = 151;
  public static final int IVariableReference = 152;
  public static final int IVisible = 153;
  public static final int IWillBeClassifier = 154;
  public static final int IYetUnresolved = 155;
  public static final int IfStatement = 156;
  public static final int ImplicitAnnotationInstanceValue = 157;
  public static final int ImplicitAnnotationMethodKind = 158;
  public static final int IncompleteLeftParen = 159;
  public static final int IncompleteMemberDeclaration = 160;
  public static final int IncompleteRightParen = 161;
  public static final int InstanceInitializer = 162;
  public static final int InstanceMethodCallOperation = 163;
  public static final int InstanceMethodDeclaration = 164;
  public static final int InstanceOfExpression = 165;
  public static final int IntegerConstant = 166;
  public static final int IntegerLiteral = 167;
  public static final int IntegerType = 168;
  public static final int Interface = 169;
  public static final int IsEmptyOperation = 170;
  public static final int IsNotEmptyOperation = 171;
  public static final int JavaImport = 172;
  public static final int JavaImports = 173;
  public static final int JavaModifier = 174;
  public static final int LeftShiftAssignmentExpression = 175;
  public static final int LessThanExpression = 176;
  public static final int LessThanOrEqualsExpression = 177;
  public static final int LocalInstanceFieldReference = 178;
  public static final int LocalInstanceMethodCall = 179;
  public static final int LocalMethodCall = 180;
  public static final int LocalPropertyReference = 181;
  public static final int LocalStaticFieldReference = 182;
  public static final int LocalStaticMethodCall = 183;
  public static final int LocalToMethodKind = 184;
  public static final int LocalVariableDeclaration = 185;
  public static final int LocalVariableDeclarationStatement = 186;
  public static final int LongLiteral = 187;
  public static final int LongType = 188;
  public static final int LoopLabel = 189;
  public static final int LoopLabelReference = 190;
  public static final int LowerBoundType = 191;
  public static final int MethodDeclaration = 192;
  public static final int MinusAssignmentExpression = 193;
  public static final int MinusExpression = 194;
  public static final int Modifier = 195;
  public static final int MulAssignmentExpression = 196;
  public static final int MulExpression = 197;
  public static final int MultiLineComment = 198;
  public static final int MultipleCatchClause = 199;
  public static final int NPEEqualsExpression = 200;
  public static final int NPENotEqualsExpression = 201;
  public static final int NestedNewExpression = 202;
  public static final int NotEqualsExpression = 203;
  public static final int NotExpression = 204;
  public static final int NullLiteral = 205;
  public static final int NullType = 206;
  public static final int Number = 207;
  public static final int OctalIntegerLiteral = 208;
  public static final int OperationAssignmentExpression = 209;
  public static final int OrAssignmentExpression = 210;
  public static final int OrExpression = 211;
  public static final int ParameterDeclaration = 212;
  public static final int ParenthesizedExpression = 213;
  public static final int PassByRefExpression = 214;
  public static final int PlaceholderMember = 215;
  public static final int PlusAssignmentExpression = 216;
  public static final int PlusExpression = 217;
  public static final int PostfixDecrementExpression = 218;
  public static final int PostfixIncrementExpression = 219;
  public static final int PrefixDecrementExpression = 220;
  public static final int PrefixIncrementExpression = 221;
  public static final int PrimitiveClassExpression = 222;
  public static final int PrimitiveType = 223;
  public static final int PrivateVisibility = 224;
  public static final int Property = 225;
  public static final int PropertyImplementation = 226;
  public static final int PropertyReference = 227;
  public static final int PropertyValueReference = 228;
  public static final int ProtectedVisibility = 229;
  public static final int PublicVisibility = 230;
  public static final int QualifiedReference = 231;
  public static final int QualifiedSuperMethodCall = 232;
  public static final int RemAssignmentExpression = 233;
  public static final int RemExpression = 234;
  public static final int RemarkStatement = 235;
  public static final int ResourceVariable = 236;
  public static final int ReturnStatement = 237;
  public static final int RightShiftAssignmentExpression = 238;
  public static final int SetAccessor = 239;
  public static final int ShiftLeftExpression = 240;
  public static final int ShiftRightExpression = 241;
  public static final int ShiftRightUnsignedExpression = 242;
  public static final int ShortType = 243;
  public static final int SingleLineComment = 244;
  public static final int Statement = 245;
  public static final int StatementCommentPart = 246;
  public static final int StatementList = 247;
  public static final int StaticFieldDeclaration = 248;
  public static final int StaticFieldReference = 249;
  public static final int StaticFieldReferenceOperation = 250;
  public static final int StaticInitializer = 251;
  public static final int StaticKind = 252;
  public static final int StaticMethodCall = 253;
  public static final int StaticMethodCallOperation = 254;
  public static final int StaticMethodDeclaration = 255;
  public static final int StringBooleanOperation = 256;
  public static final int StringLiteral = 257;
  public static final int StringToken = 258;
  public static final int StringType = 259;
  public static final int StubInitializer = 260;
  public static final int StubStatementList = 261;
  public static final int SubstringExpression = 262;
  public static final int SuperConstructorInvocation = 263;
  public static final int SuperConstructorKind = 264;
  public static final int SuperInerfaceKind = 265;
  public static final int SuperInterfaceMethodCall = 266;
  public static final int SuperMethodCall = 267;
  public static final int SuperMethodKind = 268;
  public static final int SwitchCase = 269;
  public static final int SwitchCaseExtension = 270;
  public static final int SwitchStatement = 271;
  public static final int SynchronizedStatement = 272;
  public static final int TernaryOperatorExpression = 273;
  public static final int TextCommentPart = 274;
  public static final int ThisConstructorInvocation = 275;
  public static final int ThisConstructorKind = 276;
  public static final int ThisExpression = 277;
  public static final int ThrowStatement = 278;
  public static final int Tokens = 279;
  public static final int TrimOperation = 280;
  public static final int TryCatchStatement = 281;
  public static final int TryFinallyStatement = 282;
  public static final int TryUniversalStatement = 283;
  public static final int Type = 284;
  public static final int TypeAnnotable = 285;
  public static final int TypeDerivable = 286;
  public static final int TypeVariableDeclaration = 287;
  public static final int TypeVariableReference = 288;
  public static final int UnaryMinus = 289;
  public static final int UndefinedType = 290;
  public static final int UnknownConsCall = 291;
  public static final int UnknownDotCall = 292;
  public static final int UnknownInstanceMethodCall = 293;
  public static final int UnknownLocalCall = 294;
  public static final int UnknownNameRef = 295;
  public static final int UnknownNew = 296;
  public static final int UnresolvedNameReference = 297;
  public static final int UnsignedRightShiftAssignmentExpression = 298;
  public static final int UpperBoundType = 299;
  public static final int UsingStatement = 300;
  public static final int ValueParameter = 301;
  public static final int ValueRef = 302;
  public static final int VariableArityType = 303;
  public static final int VariableDeclaration = 304;
  public static final int VariableReference = 305;
  public static final int Visibility = 306;
  public static final int VoidType = 307;
  public static final int WhileStatement = 308;
  public static final int WildCardType = 309;
  public static final int XorAssignmentExpression = 310;
