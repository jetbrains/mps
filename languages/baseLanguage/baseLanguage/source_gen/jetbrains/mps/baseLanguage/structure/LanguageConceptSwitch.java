...
public final class LanguageConceptSwitch {
  ...
  public static final int BinaryIntegerLiteral = 36;
  public static final int BinaryOperation = 37;
  public static final int BitwiseAndExpression = 38;
  public static final int BitwiseNotExpression = 39;
  public static final int BitwiseOrExpression = 40;
  public static final int BitwiseXorExpression = 41;
  public static final int BlockStatement = 42;
  public static final int BooleanConstant = 43;
  public static final int BooleanType = 44;
  public static final int BreakStatement = 45;
  public static final int ByteType = 46;
  public static final int CastExpression = 47;
  public static final int CatchClause = 48;
  public static final int CharConstant = 49;
  public static final int CharType = 50;
  public static final int ClassConcept = 51;
  public static final int ClassCreator = 52;
  public static final int Classifier = 53;
  public static final int ClassifierClassExpression = 54;
  public static final int ClassifierMember = 55;
  public static final int ClassifierMethodMember = 56;
  public static final int ClassifierType = 57;
  public static final int Closure = 58;
  public static final int ClosureParameter = 59;
  public static final int ClosureParameterReference = 60;
  public static final int Closureoid = 61;
  public static final int CommentPart = 62;
  public static final int CommentedStatement = 63;
  public static final int ConceptFunction = 64;
  public static final int ConceptFunctionParameter = 65;
  public static final int ConstructorDeclaration = 66;
  public static final int ConstructorInvocationStatement = 67;
  public static final int ContextClassifierKind = 68;
  public static final int ContinueStatement = 69;
  public static final int CustomPropertyImplementation = 70;
  public static final int CustomSetterPropertyImplementation = 71;
  public static final int DefaultClassCreator = 72;
  public static final int DefaultGetAccessor = 73;
  public static final int DefaultPropertyImplementation = 74;
  public static final int DefaultSetAccessor = 75;
  public static final int DimensionExpression = 76;
  public static final int DivAssignmentExpression = 77;
  public static final int DivExpression = 78;
  public static final int DoWhileStatement = 79;
  public static final int DotExpression = 80;
  public static final int DoubleType = 81;
  public static final int ElsifClause = 82;
  public static final int EnumClass = 83;
  public static final int EnumConstantDeclaration = 84;
  public static final int EnumConstantReference = 85;
  public static final int EnumValueOfExpression = 86;
  public static final int EnumValuesExpression = 87;
  public static final int EqualsExpression = 88;
  public static final int EscapeOperation = 89;
  public static final int Expression = 90;
  public static final int ExpressionStatement = 91;
  public static final int FieldDeclaration = 92;
  public static final int FieldReferenceOperation = 93;
  public static final int FloatType = 94;
  public static final int FloatingPointConstant = 95;
  public static final int FloatingPointFloatConstant = 96;
  public static final int ForStatement = 97;
  public static final int ForeachStatement = 98;
  public static final int GenericDeclaration = 99;
  public static final int GenericLValueExpression = 100;
  public static final int GenericNewExpression = 101;
  public static final int GetAccessor = 102;
  public static final int GreaterThanExpression = 103;
  public static final int GreaterThanOrEqualsExpression = 104;
  public static final int HasAnnotation = 105;
  public static final int HexIntegerLiteral = 106;
  public static final int IAnonymousClass = 107;
  public static final int IBLDeprecatable = 108;
  public static final int IBinaryLike = 109;
  public static final int IClassifier = 110;
  public static final int IClassifierMember = 111;
  public static final int IClassifierType = 112;
  public static final int IConditional = 113;
  public static final int IContainsStatementList = 114;
  public static final int IControlFlowInterrupter = 115;
  public static final int IExtractMethodAvailable = 116;
  public static final int IFinalWrapper = 117;
  public static final int IGenericType = 118;
  public static final int IHasModifiers = 119;
  public static final int IIncompleteParen = 120;
  public static final int IInternalType = 121;
  public static final int ILocalDeclaration = 122;
  public static final int ILocalReference = 123;
  public static final int ILocalVariableElement = 124;
  public static final int ILocalVariableElementList = 125;
  public static final int IMemberContainer = 126;
  public static final int IMethodCall = 127;
  public static final int IMethodLike = 128;
  public static final int IOperation = 129;
  public static final int IParameter = 130;
  public static final int ISkipsReturn = 131;
  public static final int IStatementListContainer = 132;
  public static final int IStaticContainerForMethods = 133;
  public static final int IThisExpression = 134;
  public static final int ITryCatchStatement = 135;
  public static final int ITypeApplicable = 136;
  public static final int IValidIdentifier = 137;
  public static final int IVariableAssignment = 138;
  public static final int IVariableDeclaration = 139;
  public static final int IVariableReference = 140;
  public static final int IVisible = 141;
  public static final int IWillBeClassifier = 142;
  public static final int IYetUnresolved = 143;
  public static final int IfStatement = 144;
  public static final int ImplicitAnnotationInstanceValue = 145;
  public static final int ImplicitAnnotationMethodKind = 146;
  public static final int IncompleteLeftParen = 147;
  public static final int IncompleteMemberDeclaration = 148;
  public static final int IncompleteRightParen = 149;
  public static final int InstanceInitializer = 150;
  public static final int InstanceMethodCallOperation = 151;
  public static final int InstanceMethodDeclaration = 152;
  public static final int InstanceOfExpression = 153;
  public static final int IntegerConstant = 154;
  public static final int IntegerLiteral = 155;
  public static final int IntegerType = 156;
  public static final int Interface = 157;
  public static final int IsEmptyOperation = 158;
  public static final int IsNotEmptyOperation = 159;
  public static final int JavaImport = 160;
  public static final int JavaImports = 161;
  public static final int JavaModifier = 162;
  public static final int LeftShiftAssignmentExpression = 163;
  public static final int LessThanExpression = 164;
  public static final int LessThanOrEqualsExpression = 165;
  public static final int LocalInstanceFieldReference = 166;
  public static final int LocalInstanceMethodCall = 167;
  public static final int LocalMethodCall = 168;
  public static final int LocalPropertyReference = 169;
  public static final int LocalStaticFieldReference = 170;
  public static final int LocalStaticMethodCall = 171;
  public static final int LocalToMethodKind = 172;
  public static final int LocalVariableDeclaration = 173;
  public static final int LocalVariableDeclarationStatement = 174;
  public static final int LongLiteral = 175;
  public static final int LongType = 176;
  public static final int LoopLabel = 177;
  public static final int LoopLabelReference = 178;
  public static final int LowerBoundType = 179;
  public static final int MethodDeclaration = 180;
  public static final int MinusAssignmentExpression = 181;
  public static final int MinusExpression = 182;
  public static final int Modifier = 183;
  public static final int MulAssignmentExpression = 184;
  public static final int MulExpression = 185;
  public static final int MultiLineComment = 186;
  ...
  public static final int QualifiedReference = 218;
  public static final int QualifiedSuperMethodCall = 219;
  public static final int RemAssignmentExpression = 220;
  public static final int RemExpression = 221;
  public static final int RemarkStatement = 222;
  public static final int ReturnStatement = 223;
  public static final int RightShiftAssignmentExpression = 224;
  public static final int SetAccessor = 225;
  public static final int ShiftLeftExpression = 226;
  public static final int ShiftRightExpression = 227;
  public static final int ShiftRightUnsignedExpression = 228;
  public static final int ShortType = 229;
  public static final int SingleLineComment = 230;
  public static final int Statement = 231;
  public static final int StatementCommentPart = 232;
  public static final int StatementList = 233;
  public static final int StaticFieldDeclaration = 234;
  public static final int StaticFieldReference = 235;
  public static final int StaticInitializer = 236;
  public static final int StaticKind = 237;
  public static final int StaticMethodCall = 238;
  public static final int StaticMethodDeclaration = 239;
  public static final int StringBooleanOperation = 240;
  public static final int StringLiteral = 241;
  public static final int StringToken = 242;
  public static final int StringType = 243;
  public static final int StubInitializer = 244;
  public static final int StubStatementList = 245;
  public static final int SubstringExpression = 246;
  public static final int SuperConstructorInvocation = 247;
  public static final int SuperConstructorKind = 248;
  public static final int SuperInerfaceKind = 249;
  public static final int SuperMethodCall = 250;
  public static final int SuperMethodKind = 251;
  public static final int SwitchCase = 252;
  public static final int SwitchStatement = 253;
  public static final int SynchronizedStatement = 254;
  public static final int TernaryOperatorExpression = 255;
  public static final int TextCommentPart = 256;
  public static final int ThisConstructorInvocation = 257;
  public static final int ThisConstructorKind = 258;
  public static final int ThisExpression = 259;
  public static final int ThrowStatement = 260;
  public static final int Tokens = 261;
  public static final int TrimOperation = 262;
  public static final int TryCatchStatement = 263;
  public static final int TryStatement = 264;
  public static final int Type = 265;
  public static final int TypeAnnotable = 266;
  public static final int TypeDerivable = 267;
  public static final int TypeVariableDeclaration = 268;
  public static final int TypeVariableReference = 269;
  public static final int UnaryMinus = 270;
  public static final int UndefinedType = 271;
  public static final int UnknownConsCall = 272;
  public static final int UnknownDotCall = 273;
  public static final int UnknownLocalCall = 274;
  public static final int UnknownNameRef = 275;
  public static final int UnknownNew = 276;
  public static final int UnresolvedNameReference = 277;
  public static final int UnsignedRightShiftAssignmentExpression = 278;
  public static final int UpperBoundType = 279;
  public static final int UsingStatement = 280;
  public static final int ValueParameter = 281;
  public static final int ValueRef = 282;
  public static final int VarType = 283;
