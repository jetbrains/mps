...
public final class LanguageConceptSwitch implements ConceptIndex {
  ...
  public static final int IGenericClassCreator = 131;
  public static final int IGenericType = 132;
  public static final int IHasModifiers = 133;
  public static final int IIncompleteParen = 134;
  public static final int IInferenceContextProvider = 135;
  public static final int IInferredExpression = 136;
  public static final int IInferredType = 137;
  public static final int IInheritableFeature = 138;
  public static final int IInternalType = 139;
  public static final int ILocalDeclaration = 140;
  public static final int ILocalReference = 141;
  public static final int ILocalVariableElement = 142;
  public static final int ILocalVariableElementList = 143;
  public static final int IMemberContainer = 144;
  public static final int IMethodCall = 145;
  public static final int IMethodLike = 146;
  public static final int IOperation = 147;
  public static final int IParameter = 148;
  public static final int IRawTypeHolder = 149;
  public static final int ISkipsReturn = 150;
  public static final int IStatementListContainer = 151;
  public static final int IStaticContainerForMethods = 152;
  public static final int IThisExpression = 153;
  public static final int IThrowCheckedExceptions = 154;
  public static final int ITryCatchStatement = 155;
  public static final int ITypeApplicable = 156;
  public static final int IValidIdentifier = 157;
  public static final int IVariableAssignment = 158;
  public static final int IVariableDeclaration = 159;
  public static final int IVariableReference = 160;
  public static final int IVisible = 161;
  public static final int IWillBeClassifier = 162;
  public static final int IYetUnresolved = 163;
  public static final int IfStatement = 164;
  public static final int ImplicitAnnotationInstanceValue = 165;
  public static final int ImplicitAnnotationMethodKind = 166;
  public static final int IncompleteLeftParen = 167;
  public static final int IncompleteMemberDeclaration = 168;
  public static final int IncompleteRightParen = 169;
  public static final int InferredClassifierType = 170;
  public static final int InferredType = 171;
  public static final int InstanceInitializer = 172;
  public static final int InstanceMethodCallOperation = 173;
  public static final int InstanceMethodDeclaration = 174;
  public static final int InstanceOfExpression = 175;
  public static final int IntegerConstant = 176;
  public static final int IntegerLiteral = 177;
  public static final int IntegerType = 178;
  public static final int Interface = 179;
  public static final int IntersectionType = 180;
  public static final int IsEmptyOperation = 181;
  public static final int IsNotEmptyOperation = 182;
  public static final int JavaImport = 183;
  public static final int JavaImports = 184;
  public static final int JavaModifier = 185;
  public static final int LeftShiftAssignmentExpression = 186;
  public static final int LessThanExpression = 187;
  public static final int LessThanOrEqualsExpression = 188;
  public static final int LocalInstanceFieldReference = 189;
  public static final int LocalInstanceMethodCall = 190;
  public static final int LocalMethodCall = 191;
  public static final int LocalPropertyReference = 192;
  public static final int LocalStaticFieldReference = 193;
  public static final int LocalStaticMethodCall = 194;
  public static final int LocalToMethodKind = 195;
  public static final int LocalVariableDeclaration = 196;
  public static final int LocalVariableDeclarationStatement = 197;
  public static final int LongLiteral = 198;
  public static final int LongType = 199;
  public static final int LoopLabel = 200;
  public static final int LoopLabelReference = 201;
  public static final int LowerBoundType = 202;
  public static final int MethodDeclaration = 203;
  public static final int MinusAssignmentExpression = 204;
  public static final int MinusExpression = 205;
  public static final int Modifier = 206;
  public static final int MulAssignmentExpression = 207;
  public static final int MulExpression = 208;
  public static final int MultiLineComment = 209;
  public static final int MultipleCatchClause = 210;
  public static final int NPEEqualsExpression = 211;
  public static final int NPENotEqualsExpression = 212;
  public static final int NestedNewExpression = 213;
  public static final int NotEqualsExpression = 214;
  public static final int NotExpression = 215;
  public static final int NullLiteral = 216;
  public static final int NullType = 217;
  public static final int Number = 218;
  public static final int OctalIntegerLiteral = 219;
  public static final int OperationAssignmentExpression = 220;
  public static final int OrAssignmentExpression = 221;
  public static final int OrExpression = 222;
  public static final int ParameterDeclaration = 223;
  public static final int ParenthesizedExpression = 224;
  public static final int PassByRefExpression = 225;
  public static final int PlaceholderMember = 226;
  public static final int PlusAssignmentExpression = 227;
  public static final int PlusExpression = 228;
  public static final int PostfixDecrementExpression = 229;
  public static final int PostfixIncrementExpression = 230;
  public static final int PrefixDecrementExpression = 231;
  public static final int PrefixIncrementExpression = 232;
  public static final int PrimitiveClassExpression = 233;
  public static final int PrimitiveType = 234;
  public static final int PrivateVisibility = 235;
  public static final int Property = 236;
  public static final int PropertyImplementation = 237;
  public static final int PropertyReference = 238;
  public static final int PropertyValueReference = 239;
  public static final int ProtectedVisibility = 240;
  public static final int PublicVisibility = 241;
  public static final int QualifiedReference = 242;
  public static final int QualifiedSuperMethodCall = 243;
  public static final int RemAssignmentExpression = 244;
  public static final int RemExpression = 245;
  public static final int RemarkStatement = 246;
  public static final int ResourceVariable = 247;
  public static final int ReturnStatement = 248;
  public static final int RightShiftAssignmentExpression = 249;
  public static final int SetAccessor = 250;
  public static final int ShiftLeftExpression = 251;
  public static final int ShiftRightExpression = 252;
  public static final int ShiftRightUnsignedExpression = 253;
  public static final int ShortType = 254;
  public static final int SingleLineComment = 255;
  public static final int Statement = 256;
  public static final int StatementCommentPart = 257;
  public static final int StatementList = 258;
  public static final int StaticFieldDeclaration = 259;
  public static final int StaticFieldReference = 260;
  public static final int StaticFieldReferenceOperation = 261;
  public static final int StaticInitializer = 262;
  public static final int StaticKind = 263;
  public static final int StaticMethodCall = 264;
  public static final int StaticMethodCallOperation = 265;
  public static final int StaticMethodDeclaration = 266;
  public static final int StringBooleanOperation = 267;
  public static final int StringLiteral = 268;
  public static final int StringToken = 269;
  public static final int StringType = 270;
  public static final int StubInitializer = 271;
  public static final int StubStatementList = 272;
  public static final int SubstringExpression = 273;
  public static final int SuperConstructorInvocation = 274;
  public static final int SuperConstructorKind = 275;
  public static final int SuperInerfaceKind = 276;
  public static final int SuperInterfaceMethodCall = 277;
  public static final int SuperMethodCall = 278;
  public static final int SuperMethodKind = 279;
  public static final int SwitchCase = 280;
  public static final int SwitchCaseExtension = 281;
  public static final int SwitchStatement = 282;
  public static final int SynchronizedStatement = 283;
  public static final int TernaryOperatorExpression = 284;
  public static final int TextCommentPart = 285;
  public static final int ThisConstructorInvocation = 286;
  public static final int ThisConstructorKind = 287;
  public static final int ThisExpression = 288;
  public static final int ThrowStatement = 289;
  public static final int Tokens = 290;
  public static final int TrimOperation = 291;
  public static final int TryCatchStatement = 292;
  public static final int TryFinallyStatement = 293;
  public static final int TryUniversalStatement = 294;
  public static final int Type = 295;
  public static final int TypeAnnotable = 296;
  public static final int TypeDerivable = 297;
  public static final int TypeVariableDeclaration = 298;
  public static final int TypeVariableReference = 299;
  public static final int UnaryMinus = 300;
  public static final int UndefinedType = 301;
  public static final int UnionType = 302;
  public static final int UnknownConsCall = 303;
  public static final int UnknownDotCall = 304;
  public static final int UnknownInstanceMethodCall = 305;
  public static final int UnknownLocalCall = 306;
  public static final int UnknownNameRef = 307;
  public static final int UnknownNew = 308;
  public static final int UnresolvedNameReference = 309;
  public static final int UnsignedRightShiftAssignmentExpression = 310;
  public static final int UpperBoundType = 311;
  public static final int UsingStatement = 312;
  public static final int ValueParameter = 313;
  public static final int ValueRef = 314;
  public static final int VariableArityType = 315;
  public static final int VariableDeclaration = 316;
  public static final int VariableReference = 317;
  public static final int Visibility = 318;
  public static final int VoidType = 319;
  public static final int WhileStatement = 320;
  public static final int WildCardType = 321;
  public static final int XorAssignmentExpression = 322;
