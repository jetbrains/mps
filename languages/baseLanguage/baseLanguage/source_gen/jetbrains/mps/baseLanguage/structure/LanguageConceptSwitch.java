...
public final class LanguageConceptSwitch {
  ...
  public static final int IComment = 118;
  public static final int IConditional = 119;
  public static final int IContainsStatementList = 120;
  public static final int IControlFlowInterrupter = 121;
  public static final int IExtractMethodAvailable = 122;
  public static final int IFinalWrapper = 123;
  public static final int IGenericType = 124;
  public static final int IHasModifiers = 125;
  public static final int IIncompleteParen = 126;
  public static final int IInternalType = 127;
  public static final int ILocalDeclaration = 128;
  public static final int ILocalReference = 129;
  public static final int ILocalVariableElement = 130;
  public static final int ILocalVariableElementList = 131;
  public static final int IMemberContainer = 132;
  public static final int IMethodCall = 133;
  public static final int IMethodLike = 134;
  public static final int IOperation = 135;
  public static final int IParameter = 136;
  public static final int ISkipsReturn = 137;
  public static final int IStatementListContainer = 138;
  public static final int IStaticContainerForMethods = 139;
  public static final int IThisExpression = 140;
  public static final int IThrowCheckedExceptions = 141;
  public static final int ITryCatchStatement = 142;
  public static final int ITypeApplicable = 143;
  public static final int IValidIdentifier = 144;
  public static final int IVariableAssignment = 145;
  public static final int IVariableDeclaration = 146;
  public static final int IVariableReference = 147;
  public static final int IVisible = 148;
  public static final int IWillBeClassifier = 149;
  public static final int IYetUnresolved = 150;
  public static final int IfStatement = 151;
  public static final int ImplicitAnnotationInstanceValue = 152;
  public static final int ImplicitAnnotationMethodKind = 153;
  public static final int IncompleteLeftParen = 154;
  public static final int IncompleteMemberDeclaration = 155;
  public static final int IncompleteRightParen = 156;
  public static final int InstanceInitializer = 157;
  public static final int InstanceMethodCallOperation = 158;
  public static final int InstanceMethodDeclaration = 159;
  public static final int InstanceOfExpression = 160;
  public static final int IntegerConstant = 161;
  public static final int IntegerLiteral = 162;
  public static final int IntegerType = 163;
  public static final int Interface = 164;
  public static final int IsEmptyOperation = 165;
  public static final int IsNotEmptyOperation = 166;
  public static final int JavaImport = 167;
  public static final int JavaImports = 168;
  public static final int JavaModifier = 169;
  public static final int LeftShiftAssignmentExpression = 170;
  public static final int LessThanExpression = 171;
  public static final int LessThanOrEqualsExpression = 172;
  public static final int LocalInstanceFieldReference = 173;
  public static final int LocalInstanceMethodCall = 174;
  public static final int LocalMethodCall = 175;
  public static final int LocalPropertyReference = 176;
  public static final int LocalStaticFieldReference = 177;
  public static final int LocalStaticMethodCall = 178;
  public static final int LocalToMethodKind = 179;
  public static final int LocalVariableDeclaration = 180;
  public static final int LocalVariableDeclarationStatement = 181;
  public static final int LongLiteral = 182;
  public static final int LongType = 183;
  public static final int LoopLabel = 184;
  public static final int LoopLabelReference = 185;
  public static final int LowerBoundType = 186;
  public static final int MethodDeclaration = 187;
  public static final int MinusAssignmentExpression = 188;
  public static final int MinusExpression = 189;
  public static final int Modifier = 190;
  public static final int MulAssignmentExpression = 191;
  public static final int MulExpression = 192;
  public static final int MultiLineComment = 193;
  public static final int MultipleCatchClause = 194;
  public static final int NPEEqualsExpression = 195;
  public static final int NPENotEqualsExpression = 196;
  public static final int NestedNewExpression = 197;
  public static final int NotEqualsExpression = 198;
  public static final int NotExpression = 199;
  public static final int NullLiteral = 200;
  public static final int NullType = 201;
  public static final int Number = 202;
  public static final int OctalIntegerLiteral = 203;
  public static final int OperationAssignmentExpression = 204;
  public static final int OrAssignmentExpression = 205;
  public static final int OrExpression = 206;
  public static final int ParameterDeclaration = 207;
  public static final int ParenthesizedExpression = 208;
  public static final int PassByRefExpression = 209;
  public static final int PlaceholderMember = 210;
  public static final int PlusAssignmentExpression = 211;
  public static final int PlusExpression = 212;
  public static final int PostfixDecrementExpression = 213;
  public static final int PostfixIncrementExpression = 214;
  public static final int PrefixDecrementExpression = 215;
  public static final int PrefixIncrementExpression = 216;
  public static final int PrimitiveClassExpression = 217;
  public static final int PrimitiveType = 218;
  public static final int PrivateVisibility = 219;
  public static final int Property = 220;
  public static final int PropertyImplementation = 221;
  public static final int PropertyReference = 222;
  public static final int PropertyValueReference = 223;
  public static final int ProtectedVisibility = 224;
  public static final int PublicVisibility = 225;
  public static final int QualifiedReference = 226;
  public static final int QualifiedSuperMethodCall = 227;
  public static final int RemAssignmentExpression = 228;
  public static final int RemExpression = 229;
  public static final int RemarkStatement = 230;
  public static final int ResourceVariable = 231;
  public static final int ReturnStatement = 232;
  public static final int RightShiftAssignmentExpression = 233;
  public static final int SetAccessor = 234;
  public static final int ShiftLeftExpression = 235;
  public static final int ShiftRightExpression = 236;
  public static final int ShiftRightUnsignedExpression = 237;
  public static final int ShortType = 238;
  public static final int SingleLineComment = 239;
  public static final int Statement = 240;
  public static final int StatementCommentPart = 241;
  public static final int StatementList = 242;
  public static final int StaticFieldDeclaration = 243;
  public static final int StaticFieldReference = 244;
  public static final int StaticInitializer = 245;
  public static final int StaticKind = 246;
  public static final int StaticMethodCall = 247;
  public static final int StaticMethodDeclaration = 248;
  public static final int StringBooleanOperation = 249;
  public static final int StringLiteral = 250;
  public static final int StringToken = 251;
  public static final int StringType = 252;
  public static final int StubInitializer = 253;
  public static final int StubStatementList = 254;
  public static final int SubstringExpression = 255;
  public static final int SuperConstructorInvocation = 256;
  public static final int SuperConstructorKind = 257;
  public static final int SuperInerfaceKind = 258;
  public static final int SuperInterfaceMethodCall = 259;
  public static final int SuperMethodCall = 260;
  public static final int SuperMethodKind = 261;
  public static final int SwitchCase = 262;
  public static final int SwitchCaseExtension = 263;
  public static final int SwitchStatement = 264;
  public static final int SynchronizedStatement = 265;
  public static final int TernaryOperatorExpression = 266;
  public static final int TextCommentPart = 267;
  public static final int ThisConstructorInvocation = 268;
  public static final int ThisConstructorKind = 269;
  public static final int ThisExpression = 270;
  public static final int ThrowStatement = 271;
  public static final int Tokens = 272;
  public static final int TrimOperation = 273;
  public static final int TryCatchStatement = 274;
  public static final int TryFinallyStatement = 275;
  public static final int TryUniversalStatement = 276;
  public static final int Type = 277;
  public static final int TypeAnnotable = 278;
  public static final int TypeDerivable = 279;
  public static final int TypeVariableDeclaration = 280;
  public static final int TypeVariableReference = 281;
  public static final int UnaryMinus = 282;
  public static final int UndefinedType = 283;
  public static final int UnknownConsCall = 284;
  public static final int UnknownDotCall = 285;
  public static final int UnknownLocalCall = 286;
  public static final int UnknownNameRef = 287;
  public static final int UnknownNew = 288;
  public static final int UnresolvedNameReference = 289;
  public static final int UnsignedRightShiftAssignmentExpression = 290;
  public static final int UpperBoundType = 291;
  public static final int UsingStatement = 292;
  public static final int ValueParameter = 293;
  public static final int ValueRef = 294;
  public static final int VariableArityType = 295;
  public static final int VariableDeclaration = 296;
  public static final int VariableReference = 297;
  public static final int Visibility = 298;
  public static final int VoidType = 299;
  public static final int WhileStatement = 300;
  public static final int WildCardType = 301;
  public static final int XorAssignmentExpression = 302;
