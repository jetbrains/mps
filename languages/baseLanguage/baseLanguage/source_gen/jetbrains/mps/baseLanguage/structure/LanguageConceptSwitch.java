...
public final class LanguageConceptSwitch {
  ...
  public static final int IGenericType = 127;
  public static final int IHasModifiers = 128;
  public static final int IIncompleteParen = 129;
  public static final int IInferenceContextProvider = 130;
  public static final int IInferrableTypeParameter = 131;
  public static final int IInferredExpression = 132;
  public static final int IInferredType = 133;
  public static final int IInternalType = 134;
  public static final int ILocalDeclaration = 135;
  public static final int ILocalReference = 136;
  public static final int ILocalVariableElement = 137;
  public static final int ILocalVariableElementList = 138;
  public static final int IMemberContainer = 139;
  public static final int IMethodCall = 140;
  public static final int IMethodLike = 141;
  public static final int IOperation = 142;
  public static final int IParameter = 143;
  public static final int ISkipsReturn = 144;
  public static final int IStatementListContainer = 145;
  public static final int IStaticContainerForMethods = 146;
  public static final int IThisExpression = 147;
  public static final int IThrowCheckedExceptions = 148;
  public static final int ITryCatchStatement = 149;
  public static final int ITypeApplicable = 150;
  public static final int IValidIdentifier = 151;
  public static final int IVariableAssignment = 152;
  public static final int IVariableDeclaration = 153;
  public static final int IVariableReference = 154;
  public static final int IVisible = 155;
  public static final int IWillBeClassifier = 156;
  public static final int IYetUnresolved = 157;
  public static final int IfStatement = 158;
  public static final int ImplicitAnnotationInstanceValue = 159;
  public static final int ImplicitAnnotationMethodKind = 160;
  public static final int IncompleteLeftParen = 161;
  public static final int IncompleteMemberDeclaration = 162;
  public static final int IncompleteRightParen = 163;
  public static final int InferredClassifierType = 164;
  public static final int InstanceInitializer = 165;
  public static final int InstanceMethodCallOperation = 166;
  public static final int InstanceMethodDeclaration = 167;
  public static final int InstanceOfExpression = 168;
  public static final int IntegerConstant = 169;
  public static final int IntegerLiteral = 170;
  public static final int IntegerType = 171;
  public static final int Interface = 172;
  public static final int IsEmptyOperation = 173;
  public static final int IsNotEmptyOperation = 174;
  public static final int JavaImport = 175;
  public static final int JavaImports = 176;
  public static final int JavaModifier = 177;
  public static final int LeftShiftAssignmentExpression = 178;
  public static final int LessThanExpression = 179;
  public static final int LessThanOrEqualsExpression = 180;
  public static final int LocalInstanceFieldReference = 181;
  public static final int LocalInstanceMethodCall = 182;
  public static final int LocalMethodCall = 183;
  public static final int LocalPropertyReference = 184;
  public static final int LocalStaticFieldReference = 185;
  public static final int LocalStaticMethodCall = 186;
  public static final int LocalToMethodKind = 187;
  public static final int LocalVariableDeclaration = 188;
  public static final int LocalVariableDeclarationStatement = 189;
  public static final int LongLiteral = 190;
  public static final int LongType = 191;
  public static final int LoopLabel = 192;
  public static final int LoopLabelReference = 193;
  public static final int LowerBoundType = 194;
  public static final int MethodDeclaration = 195;
  public static final int MinusAssignmentExpression = 196;
  public static final int MinusExpression = 197;
  public static final int Modifier = 198;
  public static final int MulAssignmentExpression = 199;
  public static final int MulExpression = 200;
  public static final int MultiLineComment = 201;
  public static final int MultipleCatchClause = 202;
  public static final int NPEEqualsExpression = 203;
  public static final int NPENotEqualsExpression = 204;
  public static final int NestedNewExpression = 205;
  public static final int NotEqualsExpression = 206;
  public static final int NotExpression = 207;
  public static final int NullLiteral = 208;
  public static final int NullType = 209;
  public static final int Number = 210;
  public static final int OctalIntegerLiteral = 211;
  public static final int OperationAssignmentExpression = 212;
  public static final int OrAssignmentExpression = 213;
  public static final int OrExpression = 214;
  public static final int ParameterDeclaration = 215;
  public static final int ParenthesizedExpression = 216;
  public static final int PassByRefExpression = 217;
  public static final int PlaceholderMember = 218;
  public static final int PlusAssignmentExpression = 219;
  public static final int PlusExpression = 220;
  public static final int PostfixDecrementExpression = 221;
  public static final int PostfixIncrementExpression = 222;
  public static final int PrefixDecrementExpression = 223;
  public static final int PrefixIncrementExpression = 224;
  public static final int PrimitiveClassExpression = 225;
  public static final int PrimitiveType = 226;
  public static final int PrivateVisibility = 227;
  public static final int Property = 228;
  public static final int PropertyImplementation = 229;
  public static final int PropertyReference = 230;
  public static final int PropertyValueReference = 231;
  public static final int ProtectedVisibility = 232;
  public static final int PublicVisibility = 233;
  public static final int QualifiedReference = 234;
  public static final int QualifiedSuperMethodCall = 235;
  public static final int RemAssignmentExpression = 236;
  public static final int RemExpression = 237;
  public static final int RemarkStatement = 238;
  public static final int ResourceVariable = 239;
  public static final int ReturnStatement = 240;
  public static final int RightShiftAssignmentExpression = 241;
  public static final int SetAccessor = 242;
  public static final int ShiftLeftExpression = 243;
  public static final int ShiftRightExpression = 244;
  public static final int ShiftRightUnsignedExpression = 245;
  public static final int ShortType = 246;
  public static final int SingleLineComment = 247;
  public static final int Statement = 248;
  public static final int StatementCommentPart = 249;
  public static final int StatementList = 250;
  public static final int StaticFieldDeclaration = 251;
  public static final int StaticFieldReference = 252;
  public static final int StaticFieldReferenceOperation = 253;
  public static final int StaticInitializer = 254;
  public static final int StaticKind = 255;
  public static final int StaticMethodCall = 256;
  public static final int StaticMethodCallOperation = 257;
  public static final int StaticMethodDeclaration = 258;
  public static final int StringBooleanOperation = 259;
  public static final int StringLiteral = 260;
  public static final int StringToken = 261;
  public static final int StringType = 262;
  public static final int StubInitializer = 263;
  public static final int StubStatementList = 264;
  public static final int SubstringExpression = 265;
  public static final int SuperConstructorInvocation = 266;
  public static final int SuperConstructorKind = 267;
  public static final int SuperInerfaceKind = 268;
  public static final int SuperInterfaceMethodCall = 269;
  public static final int SuperMethodCall = 270;
  public static final int SuperMethodKind = 271;
  public static final int SwitchCase = 272;
  public static final int SwitchCaseExtension = 273;
  public static final int SwitchStatement = 274;
  public static final int SynchronizedStatement = 275;
  public static final int TernaryOperatorExpression = 276;
  public static final int TextCommentPart = 277;
  public static final int ThisConstructorInvocation = 278;
  public static final int ThisConstructorKind = 279;
  public static final int ThisExpression = 280;
  public static final int ThrowStatement = 281;
  public static final int Tokens = 282;
  public static final int TrimOperation = 283;
  public static final int TryCatchStatement = 284;
  public static final int TryFinallyStatement = 285;
  public static final int TryUniversalStatement = 286;
  public static final int Type = 287;
  public static final int TypeAnnotable = 288;
  public static final int TypeDerivable = 289;
  public static final int TypeVariableDeclaration = 290;
  public static final int TypeVariableReference = 291;
  public static final int UnaryMinus = 292;
  public static final int UndefinedType = 293;
  public static final int UnknownConsCall = 294;
  public static final int UnknownDotCall = 295;
  public static final int UnknownInstanceMethodCall = 296;
  public static final int UnknownLocalCall = 297;
  public static final int UnknownNameRef = 298;
  public static final int UnknownNew = 299;
  public static final int UnresolvedNameReference = 300;
  public static final int UnsignedRightShiftAssignmentExpression = 301;
  public static final int UpperBoundType = 302;
  public static final int UsingStatement = 303;
  public static final int ValueParameter = 304;
  public static final int ValueRef = 305;
  public static final int VariableArityType = 306;
  public static final int VariableDeclaration = 307;
  public static final int VariableReference = 308;
  public static final int Visibility = 309;
  public static final int VoidType = 310;
  public static final int WhileStatement = 311;
  public static final int WildCardType = 312;
  public static final int XorAssignmentExpression = 313;
  ...
  public LanguageConceptSwitch() {
    ...
    builder.put(0x15003fd0d31aebe1L, IInferrableTypeParameter);
