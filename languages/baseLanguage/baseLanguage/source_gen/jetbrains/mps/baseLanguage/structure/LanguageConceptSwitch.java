...
public final class LanguageConceptSwitch {
  ...
  public static final int FloatType = 98;
  public static final int FloatingPointConstant = 99;
  public static final int FloatingPointFloatConstant = 100;
  public static final int ForStatement = 101;
  public static final int ForeachStatement = 102;
  public static final int GenericDeclaration = 103;
  public static final int GenericLValueExpression = 104;
  public static final int GenericNewExpression = 105;
  public static final int GetAccessor = 106;
  public static final int GreaterThanExpression = 107;
  public static final int GreaterThanOrEqualsExpression = 108;
  public static final int HasAnnotation = 109;
  public static final int HexIntegerLiteral = 110;
  public static final int IAnonymousClass = 111;
  public static final int IBLDeprecatable = 112;
  public static final int IBinaryLike = 113;
  public static final int IClassifier = 114;
  public static final int IClassifierMember = 115;
  public static final int IClassifierType = 116;
  public static final int IConditional = 117;
  public static final int IContainsStatementList = 118;
  public static final int IControlFlowInterrupter = 119;
  public static final int IExtractMethodAvailable = 120;
  public static final int IFinalWrapper = 121;
  public static final int IGenericType = 122;
  public static final int IHasModifiers = 123;
  public static final int IIncompleteParen = 124;
  public static final int IInternalType = 125;
  public static final int ILocalDeclaration = 126;
  public static final int ILocalReference = 127;
  public static final int ILocalVariableElement = 128;
  public static final int ILocalVariableElementList = 129;
  public static final int IMemberContainer = 130;
  public static final int IMethodCall = 131;
  public static final int IMethodLike = 132;
  public static final int IOperation = 133;
  public static final int IParameter = 134;
  public static final int ISkipsReturn = 135;
  public static final int IStatementListContainer = 136;
  public static final int IStaticContainerForMethods = 137;
  public static final int IThisExpression = 138;
  public static final int ITryCatchStatement = 139;
  public static final int ITypeApplicable = 140;
  public static final int IValidIdentifier = 141;
  public static final int IVariableAssignment = 142;
  public static final int IVariableDeclaration = 143;
  public static final int IVariableReference = 144;
  public static final int IVisible = 145;
  public static final int IWillBeClassifier = 146;
  public static final int IYetUnresolved = 147;
  public static final int IfStatement = 148;
  public static final int ImplicitAnnotationInstanceValue = 149;
  public static final int ImplicitAnnotationMethodKind = 150;
  public static final int IncompleteLeftParen = 151;
  public static final int IncompleteMemberDeclaration = 152;
  public static final int IncompleteRightParen = 153;
  public static final int InstanceInitializer = 154;
  public static final int InstanceMethodCallOperation = 155;
  public static final int InstanceMethodDeclaration = 156;
  public static final int InstanceOfExpression = 157;
  public static final int IntegerConstant = 158;
  public static final int IntegerLiteral = 159;
  public static final int IntegerType = 160;
  public static final int Interface = 161;
  public static final int IsEmptyOperation = 162;
  public static final int IsNotEmptyOperation = 163;
  public static final int JavaImport = 164;
  public static final int JavaImports = 165;
  public static final int JavaModifier = 166;
  public static final int LeftShiftAssignmentExpression = 167;
  public static final int LessThanExpression = 168;
  public static final int LessThanOrEqualsExpression = 169;
  public static final int LocalInstanceFieldReference = 170;
  public static final int LocalInstanceMethodCall = 171;
  public static final int LocalMethodCall = 172;
  public static final int LocalPropertyReference = 173;
  public static final int LocalStaticFieldReference = 174;
  public static final int LocalStaticMethodCall = 175;
  public static final int LocalToMethodKind = 176;
  public static final int LocalVariableDeclaration = 177;
  public static final int LocalVariableDeclarationStatement = 178;
  public static final int LongLiteral = 179;
  public static final int LongType = 180;
  public static final int LoopLabel = 181;
  public static final int LoopLabelReference = 182;
  public static final int LowerBoundType = 183;
  public static final int MethodDeclaration = 184;
  public static final int MinusAssignmentExpression = 185;
  public static final int MinusExpression = 186;
  public static final int Modifier = 187;
  public static final int MulAssignmentExpression = 188;
  public static final int MulExpression = 189;
  public static final int MultiLineComment = 190;
  public static final int MultipleCatchClause = 191;
  public static final int NPEEqualsExpression = 192;
  public static final int NPENotEqualsExpression = 193;
  public static final int NestedNewExpression = 194;
  public static final int NotEqualsExpression = 195;
  public static final int NotExpression = 196;
  public static final int NullLiteral = 197;
  public static final int NullType = 198;
  public static final int Number = 199;
  public static final int OctalIntegerLiteral = 200;
  public static final int OperationAssignmentExpression = 201;
  public static final int OrAssignmentExpression = 202;
  public static final int OrExpression = 203;
  public static final int ParameterDeclaration = 204;
  public static final int ParenthesizedExpression = 205;
  public static final int PassByRefExpression = 206;
  public static final int PlaceholderMember = 207;
  public static final int PlusAssignmentExpression = 208;
  public static final int PlusExpression = 209;
  public static final int PostfixDecrementExpression = 210;
  public static final int PostfixIncrementExpression = 211;
  public static final int PrefixDecrementExpression = 212;
  public static final int PrefixIncrementExpression = 213;
  public static final int PrimitiveClassExpression = 214;
  public static final int PrimitiveType = 215;
  public static final int PrivateVisibility = 216;
  public static final int Property = 217;
  public static final int PropertyImplementation = 218;
  public static final int PropertyReference = 219;
  public static final int PropertyValueReference = 220;
  public static final int ProtectedVisibility = 221;
  public static final int PublicVisibility = 222;
  public static final int QualifiedReference = 223;
  public static final int QualifiedSuperMethodCall = 224;
  public static final int RemAssignmentExpression = 225;
  public static final int RemExpression = 226;
  public static final int RemarkStatement = 227;
  public static final int ResourceVariable = 228;
  public static final int ReturnStatement = 229;
  public static final int RightShiftAssignmentExpression = 230;
  public static final int SetAccessor = 231;
  public static final int ShiftLeftExpression = 232;
  public static final int ShiftRightExpression = 233;
  public static final int ShiftRightUnsignedExpression = 234;
  public static final int ShortType = 235;
  public static final int SingleLineComment = 236;
  public static final int Statement = 237;
  public static final int StatementCommentPart = 238;
  public static final int StatementList = 239;
  public static final int StaticFieldDeclaration = 240;
  public static final int StaticFieldReference = 241;
  public static final int StaticInitializer = 242;
  public static final int StaticKind = 243;
  public static final int StaticMethodCall = 244;
  public static final int StaticMethodDeclaration = 245;
  public static final int StringBooleanOperation = 246;
  public static final int StringLiteral = 247;
  public static final int StringToken = 248;
  public static final int StringType = 249;
  public static final int StubInitializer = 250;
  public static final int StubStatementList = 251;
  public static final int SubstringExpression = 252;
  public static final int SuperConstructorInvocation = 253;
  public static final int SuperConstructorKind = 254;
  public static final int SuperInerfaceKind = 255;
  public static final int SuperInterfaceMethodCall = 256;
  public static final int SuperMethodCall = 257;
  public static final int SuperMethodKind = 258;
  public static final int SwitchCase = 259;
  public static final int SwitchStatement = 260;
  public static final int SynchronizedStatement = 261;
  public static final int TernaryOperatorExpression = 262;
  public static final int TextCommentPart = 263;
  public static final int ThisConstructorInvocation = 264;
  public static final int ThisConstructorKind = 265;
  public static final int ThisExpression = 266;
  public static final int ThrowStatement = 267;
  public static final int Tokens = 268;
  public static final int TrimOperation = 269;
  public static final int TryCatchStatement = 270;
  public static final int TryFinallyStatement = 271;
  public static final int TryWithResourcesStatement = 272;
  public static final int Type = 273;
  public static final int TypeAnnotable = 274;
  public static final int TypeDerivable = 275;
  public static final int TypeVariableDeclaration = 276;
  public static final int TypeVariableReference = 277;
  public static final int UnaryMinus = 278;
  public static final int UndefinedType = 279;
  public static final int UnknownConsCall = 280;
  public static final int UnknownDotCall = 281;
  public static final int UnknownLocalCall = 282;
  public static final int UnknownNameRef = 283;
  public static final int UnknownNew = 284;
  public static final int UnresolvedNameReference = 285;
  public static final int UnsignedRightShiftAssignmentExpression = 286;
  public static final int UpperBoundType = 287;
  public static final int UsingStatement = 288;
  public static final int ValueParameter = 289;
  public static final int ValueRef = 290;
  public static final int VariableArityType = 291;
  public static final int VariableDeclaration = 292;
  public static final int VariableReference = 293;
  public static final int Visibility = 294;
  public static final int VoidType = 295;
  public static final int WhileStatement = 296;
  public static final int WildCardType = 297;
  public static final int XorAssignmentExpression = 298;
