...
public final class LanguageConceptSwitch {
  ...
  public static final int DefaultPropertyImplementation = 77;
  public static final int DefaultSetAccessor = 78;
  public static final int DimensionExpression = 79;
  public static final int DivAssignmentExpression = 80;
  public static final int DivExpression = 81;
  public static final int DoWhileStatement = 82;
  public static final int DotExpression = 83;
  public static final int DoubleType = 84;
  public static final int ElsifClause = 85;
  public static final int EnumClass = 86;
  public static final int EnumConstantDeclaration = 87;
  public static final int EnumConstantReference = 88;
  public static final int EnumValueOfExpression = 89;
  public static final int EnumValuesExpression = 90;
  public static final int EqualsExpression = 91;
  public static final int EscapeOperation = 92;
  public static final int Expression = 93;
  public static final int ExpressionStatement = 94;
  public static final int FieldDeclaration = 95;
  public static final int FieldReferenceOperation = 96;
  public static final int FloatType = 97;
  public static final int FloatingPointConstant = 98;
  public static final int FloatingPointFloatConstant = 99;
  public static final int ForStatement = 100;
  public static final int ForeachStatement = 101;
  public static final int GenericDeclaration = 102;
  public static final int GenericLValueExpression = 103;
  public static final int GenericNewExpression = 104;
  public static final int GetAccessor = 105;
  public static final int GreaterThanExpression = 106;
  public static final int GreaterThanOrEqualsExpression = 107;
  public static final int HasAnnotation = 108;
  public static final int HexIntegerLiteral = 109;
  public static final int IAnonymousClass = 110;
  public static final int IBLDeprecatable = 111;
  public static final int IBinaryLike = 112;
  public static final int IClassifier = 113;
  public static final int IClassifierMember = 114;
  public static final int IClassifierType = 115;
  public static final int IConditional = 116;
  public static final int IContainsStatementList = 117;
  public static final int IControlFlowInterrupter = 118;
  public static final int IExtractMethodAvailable = 119;
  public static final int IFinalWrapper = 120;
  public static final int IGenericType = 121;
  public static final int IHasModifiers = 122;
  public static final int IIncompleteParen = 123;
  public static final int IInternalType = 124;
  public static final int ILocalDeclaration = 125;
  public static final int ILocalReference = 126;
  public static final int ILocalVariableElement = 127;
  public static final int ILocalVariableElementList = 128;
  public static final int IMemberContainer = 129;
  public static final int IMethodCall = 130;
  public static final int IMethodLike = 131;
  public static final int IOperation = 132;
  public static final int IParameter = 133;
  public static final int ISkipsReturn = 134;
  public static final int IStatementListContainer = 135;
  public static final int IStaticContainerForMethods = 136;
  public static final int IThisExpression = 137;
  public static final int ITryCatchStatement = 138;
  public static final int ITypeApplicable = 139;
  public static final int IValidIdentifier = 140;
  public static final int IVariableAssignment = 141;
  public static final int IVariableDeclaration = 142;
  public static final int IVariableReference = 143;
  public static final int IVisible = 144;
  public static final int IWillBeClassifier = 145;
  public static final int IYetUnresolved = 146;
  public static final int IfStatement = 147;
  public static final int ImplicitAnnotationInstanceValue = 148;
  public static final int ImplicitAnnotationMethodKind = 149;
  public static final int IncompleteLeftParen = 150;
  public static final int IncompleteMemberDeclaration = 151;
  public static final int IncompleteRightParen = 152;
  public static final int InstanceInitializer = 153;
  public static final int InstanceMethodCallOperation = 154;
  public static final int InstanceMethodDeclaration = 155;
  public static final int InstanceOfExpression = 156;
  public static final int IntegerConstant = 157;
  public static final int IntegerLiteral = 158;
  public static final int IntegerType = 159;
  public static final int Interface = 160;
  public static final int IsEmptyOperation = 161;
  public static final int IsNotEmptyOperation = 162;
  public static final int JavaImport = 163;
  public static final int JavaImports = 164;
  public static final int JavaModifier = 165;
  public static final int LeftShiftAssignmentExpression = 166;
  public static final int LessThanExpression = 167;
  public static final int LessThanOrEqualsExpression = 168;
  public static final int LocalInstanceFieldReference = 169;
  public static final int LocalInstanceMethodCall = 170;
  public static final int LocalMethodCall = 171;
  public static final int LocalPropertyReference = 172;
  public static final int LocalStaticFieldReference = 173;
  public static final int LocalStaticMethodCall = 174;
  public static final int LocalToMethodKind = 175;
  public static final int LocalVariableDeclaration = 176;
  public static final int LocalVariableDeclarationStatement = 177;
  public static final int LongLiteral = 178;
  public static final int LongType = 179;
  public static final int LoopLabel = 180;
  public static final int LoopLabelReference = 181;
  public static final int LowerBoundType = 182;
  public static final int MethodDeclaration = 183;
  public static final int MinusAssignmentExpression = 184;
  public static final int MinusExpression = 185;
  public static final int Modifier = 186;
  public static final int MulAssignmentExpression = 187;
  public static final int MulExpression = 188;
  public static final int MultiLineComment = 189;
  public static final int MultipleCatchClause = 190;
  public static final int NPEEqualsExpression = 191;
  public static final int NPENotEqualsExpression = 192;
  public static final int NestedNewExpression = 193;
  public static final int NotEqualsExpression = 194;
  public static final int NotExpression = 195;
  public static final int NullLiteral = 196;
  public static final int NullType = 197;
  public static final int Number = 198;
  public static final int OctalIntegerLiteral = 199;
  public static final int OperationAssignmentExpression = 200;
  public static final int OrAssignmentExpression = 201;
  public static final int OrExpression = 202;
  public static final int ParameterDeclaration = 203;
  public static final int ParenthesizedExpression = 204;
  public static final int PassByRefExpression = 205;
  public static final int PlaceholderMember = 206;
  public static final int PlusAssignmentExpression = 207;
  public static final int PlusExpression = 208;
  public static final int PostfixDecrementExpression = 209;
  public static final int PostfixIncrementExpression = 210;
  public static final int PrefixDecrementExpression = 211;
  public static final int PrefixIncrementExpression = 212;
  public static final int PrimitiveClassExpression = 213;
  public static final int PrimitiveType = 214;
  public static final int PrivateVisibility = 215;
  public static final int Property = 216;
  public static final int PropertyImplementation = 217;
  public static final int PropertyReference = 218;
  public static final int PropertyValueReference = 219;
  public static final int ProtectedVisibility = 220;
  public static final int PublicVisibility = 221;
  public static final int QualifiedReference = 222;
  public static final int QualifiedSuperMethodCall = 223;
  public static final int RemAssignmentExpression = 224;
  public static final int RemExpression = 225;
  public static final int RemarkStatement = 226;
  public static final int ResourceVariable = 227;
  public static final int ReturnStatement = 228;
  public static final int RightShiftAssignmentExpression = 229;
  public static final int SetAccessor = 230;
  public static final int ShiftLeftExpression = 231;
  public static final int ShiftRightExpression = 232;
  public static final int ShiftRightUnsignedExpression = 233;
  public static final int ShortType = 234;
  public static final int SingleLineComment = 235;
  public static final int Statement = 236;
  public static final int StatementCommentPart = 237;
  public static final int StatementList = 238;
  public static final int StaticFieldDeclaration = 239;
  public static final int StaticFieldReference = 240;
  public static final int StaticInitializer = 241;
  public static final int StaticKind = 242;
  public static final int StaticMethodCall = 243;
  public static final int StaticMethodDeclaration = 244;
  public static final int StringBooleanOperation = 245;
  public static final int StringLiteral = 246;
  public static final int StringToken = 247;
  public static final int StringType = 248;
  public static final int StubInitializer = 249;
  public static final int StubStatementList = 250;
  public static final int SubstringExpression = 251;
  public static final int SuperConstructorInvocation = 252;
  public static final int SuperConstructorKind = 253;
  public static final int SuperInerfaceKind = 254;
  public static final int SuperMethodCall = 255;
  public static final int SuperMethodKind = 256;
  public static final int SwitchCase = 257;
  public static final int SwitchStatement = 258;
  public static final int SynchronizedStatement = 259;
  public static final int TernaryOperatorExpression = 260;
  public static final int TextCommentPart = 261;
  public static final int ThisConstructorInvocation = 262;
  public static final int ThisConstructorKind = 263;
  public static final int ThisExpression = 264;
  public static final int ThrowStatement = 265;
  public static final int Tokens = 266;
  public static final int TrimOperation = 267;
  public static final int TryCatchStatement = 268;
  public static final int TryFinallyStatement = 269;
  public static final int TryWithResourcesStatement = 270;
  public static final int Type = 271;
  public static final int TypeAnnotable = 272;
  public static final int TypeDerivable = 273;
  public static final int TypeVariableDeclaration = 274;
  public static final int TypeVariableReference = 275;
  public static final int UnaryMinus = 276;
  public static final int UndefinedType = 277;
  public static final int UnknownConsCall = 278;
  public static final int UnknownDotCall = 279;
  public static final int UnknownLocalCall = 280;
  public static final int UnknownNameRef = 281;
  public static final int UnknownNew = 282;
  public static final int UnresolvedNameReference = 283;
  public static final int UnsignedRightShiftAssignmentExpression = 284;
  public static final int UpperBoundType = 285;
  public static final int UsingStatement = 286;
  public static final int ValueParameter = 287;
  public static final int ValueRef = 288;
  public static final int VariableArityType = 289;
  public static final int VariableDeclaration = 290;
  public static final int VariableReference = 291;
  public static final int Visibility = 292;
  public static final int VoidType = 293;
  public static final int WhileStatement = 294;
  public static final int WildCardType = 295;
  public static final int XorAssignmentExpression = 296;
