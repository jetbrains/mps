...
public class CreateClassFromUsageHelper {
  ...
  private static SNode createClassCreator_lt4o84_a0a3a0a0s0l(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ClassCreator$ZG);
    rootBuilder1.setReferenceTarget(LINKS.baseMethodDeclaration$pyYw, node0);
  ...
  private static SNode createClassConcept_lt4o84_a0a31(Object p0) {
    ...
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.member$L_2d).init(CONCEPTS.ConstructorDeclaration$yG);
      n2.forChild(LINKS.body$5xQk).init(CONCEPTS.StatementList$m_);
      n2.forChild(LINKS.returnType$5xoi).init(CONCEPTS.VoidType$BF);
    }
    return rootBuilder1.getResult();
  }
