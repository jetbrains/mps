...
public final class SurroundWithTryCatchFinally_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      final SNode tryStatement = SNodeFactoryOperations.createNewNode(CONCEPTS.TryUniversalStatement$80, null);
      ...
      Set<SNode> uncaughtThrowables = StatementList__BehaviorDescriptor.uncaughtThrowables_id2SVUfbZ9Qq1.invoke(SLinkOperations.getTarget(tryStatement, LINKS.body$4P0u), ((boolean) false));
      if (SetSequence.fromSet(uncaughtThrowables).isNotEmpty()) {
        ListSequence.fromList(SLinkOperations.getChildren(tryStatement, LINKS.catchClause$4PbB)).clear();
      ...
      if (ListSequence.fromList(SLinkOperations.getChildren(tryStatement, LINKS.catchClause$4PbB)).isEmpty()) {
        SNodeFactoryOperations.addNewChild(tryStatement, LINKS.catchClause$4PbB, CONCEPTS.MultipleCatchClause$U5);
      }
      SelectionUtil.selectLabelCellAnSetCaret(editorContext, SLinkOperations.getTarget(SLinkOperations.getTarget(ListSequence.fromList(SLinkOperations.getChildren(tryStatement, LINKS.catchClause$4PbB)).first(), LINKS.throwable$pijh), LINKS.type$pLrO), SelectionManager.FIRST_ERROR_CELL + "|" + SelectionManager.FOCUS_POLICY_CELL + "|" + SelectionManager.FIRST_EDITABLE_CELL + "|" + SelectionManager.FIRST_CELL, -1);
    }
    @Override
