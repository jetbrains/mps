    ...
    switch (conceptIndex.index(cncpt)) {
      ...
      case 40:
        if (true) {
          // concept 
          intentions = new IntentionFactory[1];
          intentions[0] = new MigrateTryCatchToUniversalTry_Intention();
        }
        break;
      case 41:
        if (true) {
          // concept 
          intentions = new IntentionFactory[1];
          intentions[0] = new MigrateTryFinallyToUniversalTry_Intention();
        }
        break;
      case 42:
        if (true) {
