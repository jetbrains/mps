...
public class CreateMethodFromUsageHelper {
  ...
  private static SNode createExpressionStatement_tok9no_a0a1a0a0b0b32a21(SNode node0) {
    ...
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.expression$qFF0).init(CONCEPTS.LocalMethodCall$77);
      n2.setReferenceTarget(LINKS.baseMethodDeclaration$ItxI, node0);
    }
    return rootBuilder1.getResult();
  }
  ...
  private static SNode createInstanceMethodDeclaration_tok9no_a0a0r(SNode node0, SNode node1, Object p0) {
    ...
    rootBuilder1.forChild(LINKS.body$qspy).init(CONCEPTS.StatementList$TN);
    rootBuilder1.forChild(LINKS.returnType$qrVw).initNode(node0, CONCEPTS.Type$IG, true);
    rootBuilder1.forChild(LINKS.visibility$jt1o).initNode(node1, CONCEPTS.Visibility$Lz, true);
    return rootBuilder1.getResult();
  }
