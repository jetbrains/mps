...
public class CreateMethodFromUsageHelper {
  ...
  private static SNode createInstanceMethodCallOperation_tok9no_a0a1a0a0b0x0m(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.InstanceMethodCallOperation$uu);
  ...
  private static SNode createLocalMethodCall_tok9no_a0a1a0a0b0a32a21(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.LocalMethodCall$zT);
    rootBuilder1.setReferenceTarget(LINKS.baseMethodDeclaration$pyYw, node0);
    return rootBuilder1.getResult();
  }
  private static SNode createVoidType_tok9no_d0a0a0a0b0b32a21() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.VoidType$BF);
    return rootBuilder1.getResult();
  }
  private static SNode createExpressionStatement_tok9no_a0a1a0a0b0b32a21(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ExpressionStatement$O8);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.expression$5L7M).init(CONCEPTS.LocalMethodCall$zT);
      n2.setReferenceTarget(LINKS.baseMethodDeclaration$pyYw, node0);
    }
    return rootBuilder1.getResult();
  }
  ...
  private static SNode createInstanceMethodDeclaration_tok9no_a0a0r(SNode node0, SNode node1, Object p0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.InstanceMethodDeclaration$39);
    rootBuilder1.setProperty(PROPS.name$MnvL, PROPS.name$MnvL.getType().toString(p0));
    rootBuilder1.forChild(LINKS.body$5xQk).init(CONCEPTS.StatementList$m_);
    rootBuilder1.forChild(LINKS.returnType$5xoi).initNode(node0, CONCEPTS.Type$bu, true);
    rootBuilder1.forChild(LINKS.visibility$Yyua).initNode(node1, CONCEPTS.Visibility$el, true);
    return rootBuilder1.getResult();
  }
  ...
  private static SNode createPrivateVisibility_tok9no_a0a3a0a0a71() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.PrivateVisibility$l0);
    return rootBuilder1.getResult();
  }
