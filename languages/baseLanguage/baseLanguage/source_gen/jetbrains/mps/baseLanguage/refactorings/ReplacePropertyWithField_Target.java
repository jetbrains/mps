...
public class ReplacePropertyWithField_Target implements IRefactoringTarget {
  public ReplacePropertyWithField_Target() {
  }
  ...
  public boolean isApplicableToEntityType(final Object entity) {
    return SNodeOperations.isInstanceOf(((SNode) entity), CONCEPTS.Property$iK);
  }
  public boolean isApplicable(final Object entity) {
    if (!(this.isApplicableToEntityType(entity))) {
      return false;
    }
    return SNodeOperations.isInstanceOf(SNodeOperations.getParent(((SNode) entity)), CONCEPTS.ClassConcept$bK);
  }
