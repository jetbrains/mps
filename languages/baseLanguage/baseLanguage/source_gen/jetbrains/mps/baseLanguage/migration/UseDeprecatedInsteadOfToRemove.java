...
public class UseDeprecatedInsteadOfToRemove extends MigrationScriptBase {
  private final String description = "Replace the ToRemove annotation with the standard Java's Deprecated annotation";
  ...
  public void doExecute(final SModule m) {
    {
      SearchScope scope_lz72y7_a0e = CommandUtil.createScope(m);
      final SearchScope scope_lz72y7_a0e_0 = new EditableFilteringScope(scope_lz72y7_a0e);
      final QueryExecutionContext context = new QueryExecutionContext() {
        public SearchScope getDefaultSearchScope() {
          return scope_lz72y7_a0e_0;
        }
      };
        ...
        public void visit(SModel currentModel) {
          ...
          CollectionSequence.fromCollection(CommandUtil.instances(CommandUtil.selectScope(new ModelsScope(Sequence.<SModel>singleton(currentModel)), context), CONCEPTS.AnnotationInstance$yl, false)).where(new IWhereFilter<SNode>() {
            ...
            public void visit(SNode toRemove) {
              SNode valueExpr = SLinkOperations.getTarget(ListSequence.fromList(SLinkOperations.getChildren(toRemove, LINKS.value$uK2B)).findFirst(new IWhereFilter<SNode>() {
                public boolean accept(SNode it) {
              ...
              SLinkOperations.setTarget(instanceValueToRemove, LINKS.value$Y7om, createBooleanConstant_lz72y7_a0s0a0a1a0a0b0a0g());
  ...
  public Iterable<Problem> check(SModule m) {
    ...
    {
      SearchScope scope_lz72y7_b0f = CommandUtil.createScope(m);
      final SearchScope scope_lz72y7_b0f_0 = new EditableFilteringScope(scope_lz72y7_b0f);
      final QueryExecutionContext context = new QueryExecutionContext() {
        public SearchScope getDefaultSearchScope() {
          return scope_lz72y7_b0f_0;
        }
      };
      Sequence.fromIterable(CommandUtil.models(CommandUtil.selectScope(null, context))).visitAll(new IVisitor<SModel>() {
        public void visit(SModel currentModel) {
  ...
  private static SNode createBooleanConstant_lz72y7_a0s0a0a1a0a0b0a0g() {
