...
public class VaraibleTypeUtil {
  ...
  public static TypeDescriptor fromType(SNode valueType) {
    SNode classifierType = TypeChecker.getInstance().getRuntimeSupport().coerce_(valueType, HUtil.createMatchingPatternByConcept(MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, "jetbrains.mps.baseLanguage.structure.ClassifierType")), false);
    if ((classifierType != null)) {
      return new ClassifierTypeDescriptor(SLinkOperations.getTarget(classifierType, MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier")));
    }
    if (TypeChecker.getInstance().getSubtypingManager().isSubtype(valueType, _quotation_createNode_c9xwxw_b0a2a1(), false)) {
      return PrimitiveTypeDescriptor.BOOL;
    }
    if (TypeChecker.getInstance().getSubtypingManager().isSubtype(valueType, _quotation_createNode_c9xwxw_b0a3a1(), false)) {
      return PrimitiveTypeDescriptor.INT;
    }
    if (TypeChecker.getInstance().getSubtypingManager().isSubtype(valueType, _quotation_createNode_c9xwxw_b0a4a1(), false)) {
      return PrimitiveTypeDescriptor.LONG;
    }
    if (TypeChecker.getInstance().getSubtypingManager().isSubtype(valueType, _quotation_createNode_c9xwxw_b0a5a1(), false)) {
      return PrimitiveTypeDescriptor.CHAR;
    }
    if (TypeChecker.getInstance().getSubtypingManager().isSubtype(valueType, _quotation_createNode_c9xwxw_b0a6a1(), false)) {
      return PrimitiveTypeDescriptor.FLOAT;
    }
    if (TypeChecker.getInstance().getSubtypingManager().isSubtype(valueType, _quotation_createNode_c9xwxw_b0a7a1(), false)) {
      return PrimitiveTypeDescriptor.DOUBLE;
    }
    if (TypeChecker.getInstance().getSubtypingManager().isSubtype(valueType, _quotation_createNode_c9xwxw_b0a8a1(), false)) {
      return PrimitiveTypeDescriptor.BYTE;
    }
    if (TypeChecker.getInstance().getSubtypingManager().isSubtype(valueType, _quotation_createNode_c9xwxw_b0a9a1(), false)) {
  ...
  public static SNode toLocalVariableClassType(SNode valueType) {
    ...
    SLinkOperations.setPointer(res, MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"), td.handle(LOCAL_VARIABLE_CLASS));
    ListSequence.fromList(SLinkOperations.getChildren(res, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x102419671abL, "parameter"))).addElement(td.handle(VARIABLE_TYPE_PARAMETER));
    return res;
  }
