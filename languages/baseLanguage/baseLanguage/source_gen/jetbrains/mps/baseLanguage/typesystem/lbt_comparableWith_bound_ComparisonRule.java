...
public class lbt_comparableWith_bound_ComparisonRule extends ComparisonRule_Runtime {
  public lbt_comparableWith_bound_ComparisonRule() {
  }
  public boolean areComparable(SNode node1, SNode node2, IsApplicable2Status status) {
    return TypeChecker.getInstance().getSubtypingManager().isComparable(SLinkOperations.getTarget(node1, LINKS.bound$$a6H), node2, false);
  }
