...
public class MethodParameterMatcher {
  private final Iterable<SNode> myMethodParamTypes;
  private final List<? extends SNode> myCallParamTypes;

  public MethodParameterMatcher(Iterable<SNode> methodTypes, List<? extends SNode> callTypes) {
  ...
  public static MethodParameterMatcher fromParameterAndExpressions(List<SNode> methodParameters, List<SNode> callParams) {
    List<SNode> methodTypes = ListSequence.fromList(methodParameters).select((it) -> SLinkOperations.getTarget(it, LINKS.type$a1UY)).toList();
  ...
  public Tuples._2<Integer[], Integer[]> findAppropriateMatching() {
    ...
    Integer[][] compatiblesValues = Sequence.fromIterable(myMethodParamTypes).select((param) -> {
    ...
    Integer[] methodParamMappedTo = Sequence.fromIterable(myMethodParamTypes).select((it) -> as_7zrs51_a0a0a0a0a5a7(-1, Integer.class)).toGenericArray(Integer.class);
    Integer[] callParamMappedFrom = ListSequence.fromList(myCallParamTypes).select((it) -> as_7zrs51_a0a0a0a0a6a7(-1, Integer.class)).toGenericArray(Integer.class);
  ...
  public List<? extends SNode> getCallParamTypes() {
  ...
  private static <T> T as_7zrs51_a0a0a0a0a5a7(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
  private static <T> T as_7zrs51_a0a0a0a0a6a7(Object o, Class<T> type) {
    return (type.isInstance(o) ? (T) o : null);
  }
