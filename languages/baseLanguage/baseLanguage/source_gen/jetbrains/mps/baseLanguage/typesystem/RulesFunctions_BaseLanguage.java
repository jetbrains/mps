        ...
        SNode matchedNode_5ahx9e_b0g0t = anc;
        {
          ...
          if (matches_5ahx9e_a1a6a91) {
            if (ListSequence.fromList(ancSLs).contains(SLinkOperations.getTarget(matchedNode_5ahx9e_b0g0t, LINKS.body$1aAh))) {
              for (final SNode cc : SLinkOperations.getChildren(matchedNode_5ahx9e_b0g0t, LINKS.catchClause$EvoR)) {
                ListSequence.fromList(throwTypes).removeWhere(new IWhereFilter<SNode>() {
                  public boolean accept(SNode tt) {
                    return TypecheckingFacade.getFromContext().isSubtype(tt, SLinkOperations.getTarget(SLinkOperations.getTarget(cc, LINKS.throwable$T0lV), LINKS.type$uWuc));
                  }
                });
              }
            }
            ...
            if (matches_5ahx9e_b1a6a91) {
              if (ListSequence.fromList(ancSLs).contains(SLinkOperations.getTarget(matchedNode_5ahx9e_b0g0t, LINKS.body$I$eg))) {
                for (final SNode cc : SLinkOperations.getChildren(matchedNode_5ahx9e_b0g0t, LINKS.catchClause$yGV3)) {
                  ListSequence.fromList(throwTypes).removeWhere(new IWhereFilter<SNode>() {
                    public boolean accept(SNode tt) {
                      return TypecheckingFacade.getFromContext().isSubtype(tt, SLinkOperations.getTarget(SLinkOperations.getTarget(cc, LINKS.throwable$T0lV), LINKS.type$uWuc));
                    }
