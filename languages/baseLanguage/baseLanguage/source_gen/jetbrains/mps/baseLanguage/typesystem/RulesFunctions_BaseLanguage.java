...
__switch__:
  ...
  /*package*/ static void check(final TypeCheckingContext typeCheckingContext, Set<SNode> throwables, SNode mainNode, String message) {
    ...
    for (SNode anc : SNodeOperations.getNodeAncestorsWhereConceptInList(mainNode, new SAbstractConcept[]{CONCEPTS.TryStatement$oi, CONCEPTS.TryCatchStatement$XR, CONCEPTS.IStatementListContainer$xz}, false)) {
      if (ListSequence.fromList(throwTypes).isEmpty()) {
        return;
      }
      {
        SNode matchedNode_5ahx9e_b0g0t = anc;
        {
          boolean matches_5ahx9e_a1a6a91 = false;
          {
            ...
            if (matchingNode_5ahx9e_a1a6a91 != null) {
              matches_5ahx9e_a1a6a91 = matchingNode_5ahx9e_a1a6a91.getConcept().isSubConceptOf(CONCEPTS.TryStatement$oi);
            }
          }
          if (matches_5ahx9e_a1a6a91) {
            if (ListSequence.fromList(ancSLs).contains(SLinkOperations.getTarget(matchedNode_5ahx9e_b0g0t, LINKS.body$Gg33))) {
              for (final SNode cc : SLinkOperations.getChildren(matchedNode_5ahx9e_b0g0t, LINKS.catchClause$l$PD)) {
                ListSequence.fromList(throwTypes).removeWhere(new IWhereFilter<SNode>() {
                  public boolean accept(SNode tt) {
                    return TypecheckingFacade.getFromContext().isSubtype(tt, SLinkOperations.getTarget(SLinkOperations.getTarget(cc, LINKS.throwable$$5MH), LINKS.type$a1UY));
                  }
                });
              }
            }
            ...
            boolean matches_5ahx9e_b1a6a91 = false;
            {
              ...
              if (matchingNode_5ahx9e_b1a6a91 != null) {
                matches_5ahx9e_b1a6a91 = matchingNode_5ahx9e_b1a6a91.getConcept().isSubConceptOf(CONCEPTS.TryCatchStatement$XR);
              }
            }
            if (matches_5ahx9e_b1a6a91) {
              if (ListSequence.fromList(ancSLs).contains(SLinkOperations.getTarget(matchedNode_5ahx9e_b0g0t, LINKS.body$pDF2))) {
                for (final SNode cc : SLinkOperations.getChildren(matchedNode_5ahx9e_b0g0t, LINKS.catchClause$dMnP)) {
                  ListSequence.fromList(throwTypes).removeWhere(new IWhereFilter<SNode>() {
                    public boolean accept(SNode tt) {
                      return TypecheckingFacade.getFromContext().isSubtype(tt, SLinkOperations.getTarget(SLinkOperations.getTarget(cc, LINKS.throwable$$5MH), LINKS.type$a1UY));
                    }
