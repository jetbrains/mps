...
public final class FieldReferenceOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> convertToLocal_id4APqwMfCtHb = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("convertToLocal").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5311267937735269195L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
