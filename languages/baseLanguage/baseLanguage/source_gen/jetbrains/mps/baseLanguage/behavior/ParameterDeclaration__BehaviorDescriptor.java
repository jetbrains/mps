...
public final class ParameterDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> hasAnnotation_id4LgT5De_n2I = new SMethodBuilder<>(Boolean.TYPE).name("hasAnnotation").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5499146221535981742L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "annotation"));
  public static final SMethod<Boolean> hasAnnotation_id3WDGf12Eb7o = new SMethodBuilder<>(Boolean.TYPE).name("hasAnnotation").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4551363444391588312L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNodeReference.class, "annotation"));
