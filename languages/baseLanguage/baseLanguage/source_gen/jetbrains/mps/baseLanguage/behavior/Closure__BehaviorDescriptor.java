...
public final class Closure__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<SNode>> getVariablesReferencedInClosure_idhNVujlz = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getVariablesReferencedInClosure").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("hNVujlz").build();
