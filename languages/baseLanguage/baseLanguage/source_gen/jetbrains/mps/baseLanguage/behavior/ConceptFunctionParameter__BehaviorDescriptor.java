...
public final class ConceptFunctionParameter__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> findConceptFunction_idhEwJh7Q = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("findConceptFunction").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("hEwJh7Q").build();
  public static final SMethod<String> getParameterName_idhP8qAbK = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getParameterName").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("hP8qAbK").build();
  public static final SMethod<SNode> getDeclaration_idhP8xjWn = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getDeclaration").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("hP8xjWn").build();
