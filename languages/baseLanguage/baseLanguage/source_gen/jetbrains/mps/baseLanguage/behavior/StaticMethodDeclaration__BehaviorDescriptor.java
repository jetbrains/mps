...
public final class StaticMethodDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isMainMethod_idhEwJkuu = new SMethodBuilder<>(Boolean.TYPE).name("isMainMethod").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877536670L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
