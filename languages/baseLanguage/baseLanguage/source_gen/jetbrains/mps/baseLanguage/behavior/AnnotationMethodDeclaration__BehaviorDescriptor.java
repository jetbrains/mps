...
public final class AnnotationMethodDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isGoodReturnType_id5JI19Xbr7EK = new SMethodBuilder<>(Boolean.TYPE).name("isGoodReturnType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6624237184120289968L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "type"));

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(canBeAnnotated_idhWp4PwP, isGoodReturnType_id5JI19Xbr7EK);
