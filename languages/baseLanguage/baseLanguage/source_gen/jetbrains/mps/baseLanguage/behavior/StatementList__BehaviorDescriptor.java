...
public final class StatementList__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Set<SNode>> getExternalVariablesDeclarations_idhF5UhAC = new SMethodBuilder<>((Class<Set<SNode>>) ((Class) Object.class)).name("getExternalVariablesDeclarations").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1214501165480L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Boolean> isCompact_idi0zxBt8 = new SMethodBuilder<>(Boolean.TYPE).name("isCompact").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1237546596168L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Boolean> isOneLiner_idi0z3USV = new SMethodBuilder<>(Boolean.TYPE).name("isOneLiner").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1237538811451L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<List<SNode>> getLocalVariableElements_idi1I$XiP = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getLocalVariableElements").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1238805763253L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Set<SNode>> uncaughtThrowables_id2SVUfbZ9Qq1 = new SMethodBuilder<>((Class<Set<SNode>>) ((Class) Object.class)).name("uncaughtThrowables").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3331512479731115649L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(Boolean.TYPE, "ignoreMayBeThrowables"));
  public static final SMethod<Void> collectUncaughtThrowables_id4Gt7ANIVHca = new SMethodBuilder<>(Void.TYPE).name("collectUncaughtThrowables").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5412515780383134474L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter((Class<Set<SNode>>) ((Class) Object.class), "throwables"), SMethodBuilder.createJavaParameter(Boolean.TYPE, "ignoreMayBeThrowables"));
  public static final SMethod<SNode> getFirstStatement_id4GU1DgEHJ2u = new SMethodBuilder<>(SNode.class).name("getFirstStatement").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5420652334935371934L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<SNode> getLastStatement_id28aPEVv8l7T = new SMethodBuilder<>(SNode.class).name("getLastStatement").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2453008993612812793L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<List<SNode>> getLocalVariableDeclarations_id3tkxRydYUUs = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getLocalVariableDeclarations").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3986960521977638556L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "child"));
  public static final SMethod<List<SNode>> getLocalVariableDeclarations_id7WLeqcv1izg = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getLocalVariableDeclarations").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9165170089438554320L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(Integer.TYPE, "index"));
  ...
  /*package*/ static Set<SNode> getExternalVariablesDeclarations_idhF5UhAC(@NotNull SNode __thisNode__) {
    ...
    SetSequence.fromSet(reference).addSequence(ListSequence.fromList(SNodeOperations.getNodeDescendants(__thisNode__, CONCEPTS.IVariableReference$C, false, new SAbstractConcept[]{})));
  ...
  /*package*/ static boolean isCompact_idi0zxBt8(@NotNull SNode __thisNode__) {
    if (!(SNodeOperations.isInstanceOf(SNodeOperations.getParent(__thisNode__), CONCEPTS.IContainsStatementList$v9))) {
      return false;
    }
    SNode parent = SNodeOperations.cast(SNodeOperations.getParent(__thisNode__), CONCEPTS.IContainsStatementList$v9);
  ...
  /*package*/ static boolean isOneLiner_idi0z3USV(@NotNull SNode __thisNode__) {
    if (ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.statement$53DE)).count() > 1) {
      return false;
    }
    if (ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.statement$53DE)).count() == 1) {
      SNode statement = ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.statement$53DE)).first();
      if (SNodeOperations.isInstanceOf(statement, CONCEPTS.IContainsStatementList$v9)) {
        return false;
      }
      if (ListSequence.fromList(SNodeOperations.getNodeDescendants(statement, CONCEPTS.AnonymousClass$Bt, false, new SAbstractConcept[]{})).isNotEmpty()) {
        return false;
      }
    }
    return true;
  ...
  /*package*/ static List<SNode> getLocalVariableElements_idi1I$XiP(@NotNull SNode __thisNode__) {
    return SLinkOperations.getChildren(__thisNode__, LINKS.statement$53DE);
  }
  ...
  /*package*/ static void collectUncaughtThrowables_id4Gt7ANIVHca(@NotNull SNode __thisNode__, Set<SNode> throwables, boolean ignoreMayBeThrowables) {
    for (SNode statement : ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.statement$53DE))) {
  ...
  /*package*/ static SNode getFirstStatement_id4GU1DgEHJ2u(@NotNull SNode __thisNode__) {
    for (SNode statement : SLinkOperations.getChildren(__thisNode__, LINKS.statement$53DE)) {
      if (SNodeOperations.isInstanceOf(statement, CONCEPTS.SingleLineComment$Kw) || SConceptOperations.isExactly(SNodeOperations.asSConcept(SNodeOperations.getConcept(statement)), CONCEPTS.Statement$P6)) {
        continue;
      }
      return statement;
    }
  ...
  /*package*/ static SNode getLastStatement_id28aPEVv8l7T(@NotNull SNode __thisNode__) {
    List<SNode> statements = SLinkOperations.getChildren(__thisNode__, LINKS.statement$53DE);
  ...
  /*package*/ static List<SNode> getScopeVariables_id4pl5GY7LKmA(@NotNull SNode __thisNode__) {
    ...
    for (SNode statement : SLinkOperations.getChildren(__thisNode__, LINKS.statement$53DE)) {
      if (SNodeOperations.isInstanceOf(statement, CONCEPTS.LocalVariableDeclarationStatement$4w)) {
        ListSequence.fromList(result).addElement(SLinkOperations.getTarget(SNodeOperations.cast(statement, CONCEPTS.LocalVariableDeclarationStatement$4w), LINKS.localVariableDeclaration$RpjM));
      }
    }
    return result;
  }
  ...
  /*package*/ static List<SNode> getLocalVariableDeclarations_id7WLeqcv1izg(@NotNull SNode __thisNode__, int index) {
    assert index == 0 || index < ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.statement$53DE)).count();
    List<SNode> result = new ArrayList<SNode>();
