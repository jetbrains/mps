...
public final class ConstructorDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> canBeAnnotated_idhWp4PwP = new SMethodBuilder<>(Boolean.TYPE).name("canBeAnnotated").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1233076312117L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<Boolean> isReturnsVoid_idhX_$1pM = new SMethodBuilder<>(Boolean.TYPE).name("isVoidReturn").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1234359555698L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<List<SNode>> getChildrenToDisplayIntention_id3vsDNFqJVhw = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getChildrenToDisplayIntention").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4025276038182319200L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<String> getPresentationInContext_idQAyHtBupSt = new SMethodBuilder<>(String.class).name("getPresentationInContext").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(983626226385657373L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "context"));
  /*package*/ static final SMethod<String> getPresentationInContext_id2Yg2DIzbsBp = new SMethodBuilder<>(String.class).name("getPresentationInContext").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(3427250980002843097L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "context"), SMethodBuilder.createJavaParameter(String.class, "customName"));
  public static final SMethod<String> jniSignature_id7F81Cd2CcPY = new SMethodBuilder<>(String.class).name("jniSignature").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8847328628797656446L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Boolean> containsImplicitSuperConstructorCall_id6d19RW5IPof = new SMethodBuilder<>(Boolean.TYPE).name("containsImplicitSuperConstructorCall").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7152041109751551503L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<SNode> getThisConstructorInvocation_id5e6QuLS30e$ = new SMethodBuilder<>(SNode.class).name("getThisConstructorInvocation").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6018737561676809124L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<SNode> getSuperDefaultConstructor_id6d19RW5J1tP = new SMethodBuilder<>(SNode.class).name("getSuperDefaultConstructor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7152041109751601013L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Boolean> hasImplicitSuperDefaultConstructor_id5lFB3KB0eQS = new SMethodBuilder<>(Boolean.TYPE).name("hasImplicitSuperDefaultConstructor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6155185097898257848L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Void> populateMember_id6r77ob2UW9O = new SMethodBuilder<>(Void.TYPE).name("populateMember").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7405920559687254644L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(MembersPopulatingContext.class, "context"), SMethodBuilder.createJavaParameter(SNode.class, "classifierType"));
  ...
  /*package*/ static List<SNode> getChildrenToDisplayIntention_id3vsDNFqJVhw(@NotNull SNode __thisNode__) {
    List<SNode> result = HasAnnotation__BehaviorDescriptor.getChildrenToDisplayIntention_id3vsDNFqJVhw.invokeSuper(__thisNode__, CONCEPTS.ConstructorDeclaration$yG);
  ...
  /*package*/ static String getPresentationInContext_id2Yg2DIzbsBp(@NotNull SNode __thisNode__, SNode context, String customName) {
    ...
    result.append("(");
    boolean first = true;
    for (SNode parm : SLinkOperations.getChildren(__thisNode__, LINKS.parameter$5xBj)) {
      if (!(first)) {
        result.append(",");
      }
      first = false;
      if (SLinkOperations.getTarget(parm, LINKS.type$a1UY) != null) {
        result.append(BaseConcept__BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(SLinkOperations.getTarget(parm, LINKS.type$a1UY)));
      } else {
        result.append("???");
      }
    }
  ...
  /*package*/ static String jniSignature_id7F81Cd2CcPY(@NotNull SNode __thisNode__) {
    ...
    sb.append("(");
    for (SNode p : SLinkOperations.getChildren(__thisNode__, LINKS.parameter$5xBj)) {
      sb.append(Type__BehaviorDescriptor.jniSignature_id7F81Cd2C7e3.invoke(SLinkOperations.getTarget(p, LINKS.type$a1UY)));
    }
    sb.append(")");
    sb.append("V");
    return sb.toString();
  ...
  /*package*/ static boolean containsImplicitSuperConstructorCall_id6d19RW5IPof(@NotNull SNode __thisNode__) {
    if ((SLinkOperations.getTarget(__thisNode__, LINKS.body$5xQk) == null) || SNodeOperations.isInstanceOf(SLinkOperations.getTarget(__thisNode__, LINKS.body$5xQk), CONCEPTS.StubStatementList$v6)) {
      return false;
    }
    SNode firstStatement = StatementList__BehaviorDescriptor.getFirstStatement_id4GU1DgEHJ2u.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.body$5xQk));
    return !(SNodeOperations.isInstanceOf(firstStatement, CONCEPTS.ConstructorInvocationStatement$yY));
  }
  /*package*/ static SNode getThisConstructorInvocation_id5e6QuLS30e$(@NotNull SNode __thisNode__) {
    SNode firstStatement = StatementList__BehaviorDescriptor.getFirstStatement_id4GU1DgEHJ2u.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.body$5xQk));
    if (SNodeOperations.isInstanceOf(firstStatement, CONCEPTS.ConstructorInvocationStatement$yY)) {
      return SLinkOperations.getTarget(SNodeOperations.cast(firstStatement, CONCEPTS.ConstructorInvocationStatement$yY), LINKS.baseMethodDeclaration$pyYw);
    }
    return null;
  }
  /*package*/ static SNode getSuperDefaultConstructor_id6d19RW5J1tP(@NotNull SNode __thisNode__) {
    ...
    SNode superclass = SNodeOperations.cast(classifier, CONCEPTS.ClassConcept$bK);
    if (!(SNodeOperations.is(superclass, new SNodePointer("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)", "~Enum")))) {
      Iterable<SNode> constructors = Sequence.fromIterable(ClassConcept__BehaviorDescriptor.constructors_id4_LVZ3pCvsd.invoke(superclass)).where((it) -> !(SNodeOperations.isInstanceOf(SLinkOperations.getTarget(it, LINKS.visibility$Yyua), CONCEPTS.PrivateVisibility$l0)));
      if (Sequence.fromIterable(constructors).isEmpty()) {
        return null;
      }
      for (SNode constructor : constructors) {
        if (ListSequence.fromList(SLinkOperations.getChildren(constructor, LINKS.parameter$5xBj)).isEmpty()) {
          return constructor;
        }
      }
      return null;
  ...
  /*package*/ static boolean hasImplicitSuperDefaultConstructor_id5lFB3KB0eQS(@NotNull SNode __thisNode__) {
    ...
    return Sequence.fromIterable(ClassConcept__BehaviorDescriptor.constructors_id4_LVZ3pCvsd.invoke(SNodeOperations.cast(classifier, CONCEPTS.ClassConcept$bK))).isEmpty();
  }
