...
public final class DotExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getClassifier_idhEwIPI9 = new SMethodBuilder<>(SNode.class).name("getClassifier").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877410697L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<SNode> getOperandType_id7GulAc9z0dN = new SMethodBuilder<>(SNode.class).name("getOperandType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8871623299328377715L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<List<SNode>> getAllDots_id2c6AtCN58E1 = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getAllDots").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2523873803626646145L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
