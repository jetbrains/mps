...
public final class IClassifierType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> populateMembers_id6r77ob2USS_ = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("populateMembers").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7405920559687241253L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(MembersPopulatingContext.class, ""), SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  public static final SMethod<Void> enumerateTypesHierarchy_id65_8Gi1edLu = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("enumerateTypesHierarchy").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7018053821703707742L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(ClassifierHierarchyVisitor.class, ""));
  public static final SMethod<Void> enumerateMembers_id65_8Gi2shR6 = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("enumerateMembers").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7018053821724171718L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(ClassifierHierarchyVisitor.class, ""));
  public static final SMethod<Void> enumerateObjectMembers_id9QjKR8mfZm = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("enumerateObjectMembers").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(177416155942158294L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(ClassifierHierarchyVisitor.class, ""));
