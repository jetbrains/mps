...
public final class AnonymousClass__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getJavaName_id2_jKYQ0K_an = new SMethodBuilder<>(String.class).name("getJavaName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2977939203456914071L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  /*package*/ static final SMethod<Integer> getIndexInContainingClass_id3BacVlMg8ub = new SMethodBuilder<>(Integer.TYPE).name("getIndexInContainingClass").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(4164197659856373643L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<SNode> findAncestor_id3HluQRcXTJl = new SMethodBuilder<>(SNode.class).name("findAncestor").modifiers(8, AccessPrivileges.PROTECTED).concept(CONCEPT).baseMethodId(4275459132778585045L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNodeReference.class, "target"), SMethodBuilder.createJavaParameter((Class<Set<SNode>>) ((Class) Object.class), "visited"));
  ...
  /*package*/ static final SMethod<String> getAnonymousClassPresentation_id6xEo7wt3U0_ = new SMethodBuilder<>(String.class).name("getAnonymousClassPresentation").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(7523932196475740197L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "containingClassifier"));
  ...
  public static final SMethod<Iterable<SNode>> getConcreteTypeParameter_id4H6sh0LUNF7 = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("getConcreteTypeParameter").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5424147115585256135L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
