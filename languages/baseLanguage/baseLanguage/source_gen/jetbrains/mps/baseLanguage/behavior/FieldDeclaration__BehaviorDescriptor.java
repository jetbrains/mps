...
public final class FieldDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getGetterName_idhEwIcY6 = new SMethodBuilder<>(String.class).name("getGetterName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877243782L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<Boolean> hasGetter_idhEwIcYw = new SMethodBuilder<>(Boolean.TYPE).name("hasGetter").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877243808L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "classConcept"));
  /*package*/ static final SMethod<Boolean> isGetter_idhEwIcYT = new SMethodBuilder<>(Boolean.TYPE).name("isGetter").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(1213877243833L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "method"));
  public static final SMethod<String> getSetterName_idhEwIcZl = new SMethodBuilder<>(String.class).name("getSetterName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877243861L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Boolean> hasSetter_idhEwIcZv = new SMethodBuilder<>(Boolean.TYPE).name("hasSetter").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877243871L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "classConcept"));
  /*package*/ static final SMethod<Boolean> isSetter_idhEwIcZS = new SMethodBuilder<>(Boolean.TYPE).name("isSetter").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(1213877243896L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "method"));
  ...
  public static final SMethod<Void> markLoadedNodeAsDeprecated_id5H8W9_ECA0g = new SMethodBuilder<>(Void.TYPE).name("markLoadedNodeAsDeprecated").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6577771797484298256L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "node"));
  ...
  /*package*/ static List<SNode> getChildrenToDisplayIntention_id3vsDNFqJVhw(@NotNull SNode __thisNode__) {
    List<SNode> result = HasAnnotation__BehaviorDescriptor.getChildrenToDisplayIntention_id3vsDNFqJVhw.invokeSuper(__thisNode__, CONCEPTS.FieldDeclaration$ie);
  ...
  /*package*/ static String getSetterName_idhEwIcZl(@NotNull SNode __thisNode__) {
    return "set" + NameUtil.capitalize(SPropertyOperations.getString(__thisNode__, PROPS.name$MnvL));
  }
