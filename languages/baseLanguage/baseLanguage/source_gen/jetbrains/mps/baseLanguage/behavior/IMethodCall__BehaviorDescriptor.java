...
public final class IMethodCall__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Object[]> getActualArguments_idhJyuD6_ = new SMethodBuilder<>(Object[].class).name("getActualArguments").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1219275428261L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SModule.class, "module"));
  public static final SMethod<SNode> declaredArgumentType_id2TF6A0TNzEJ = new SMethodBuilder<>(SNode.class).name("declaredArgumentType").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3344796148841724591L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "expression"));
  ...
  /*package*/ static final SMethod<SNode> getConcreteType_id6WzWPTX2xhN = new SMethodBuilder<>(SNode.class).name("getConcreteType").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(8008512149545161843L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "typeVariableReference"), SMethodBuilder.createJavaParameter(SNode.class, "coercedClt"), SMethodBuilder.createJavaParameter(SNode.class, "methodClassifier"));
