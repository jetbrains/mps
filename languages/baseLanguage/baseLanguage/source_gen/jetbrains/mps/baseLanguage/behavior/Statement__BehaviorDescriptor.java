...
public final class Statement__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> nodeDescription_id4oS1ku9jIXr = new SMethodBuilder<>(String.class).name("nodeDescription").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5059799986155220827L).languageId(0x9b92103b95ca8c0cL, 0xceab519525ea4f22L).build2();
  public static final SMethod<Set<SNode>> uncaughtThrowables_id4Gt7ANIVAVT = new SMethodBuilder<>((Class<Set<SNode>>) ((Class) Object.class)).name("uncaughtThrowables").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5412515780383108857L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(Boolean.TYPE, "ignoreMayBeThrowables"));
  ...
  public static final SMethod<Void> collectUncaughtMethodThrowables_id4Gt7ANIVBW7 = new SMethodBuilder<>(Void.TYPE).name("collectUncaughtMethodThrowables").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5412515780383112967L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter((Class<Set<SNode>>) ((Class) Object.class), "throwables"), SMethodBuilder.createJavaParameter(SNode.class, "arg"));

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(isGuardClauseStatement_idi0z$q7V, nodeDescription_id4oS1ku9jIXr, uncaughtThrowables_id4Gt7ANIVAVT, collectUncaughtMethodThrowables_id4Gt7ANIVH8f, collectUncaughtMethodThrowables_id4Gt7ANIVBW7);
