...
public final class Classifier__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> traverseClassifierHierarchy_id3rj45ZUtGbP = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("traverseClassifierHierarchy").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("3rj45ZUtGbP").registry(REGISTRY).build(SMethodBuilder.createJavaParameter(ClassifierTraversalCallback.class, ""));
  /*package*/ static final SMethod<Void> dfs_id3rj45ZVCYEm = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("dfs").modifiers(SModifiersImpl.create(0, AccessPrivileges.PRIVATE)).concept(CONCEPT).id("3rj45ZVCYEm").registry(REGISTRY).build(SMethodBuilder.createJavaParameter(ClassifierTraversalCallback.class, ""), SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""), SMethodBuilder.createJavaParameter((Class<Set<SNode>>) ((Class) Object.class), ""), SMethodBuilder.createJavaParameter(TraversalControllerImpl.class, ""));
  ...
  /*package*/ static void dfs_id3rj45ZVCYEm(@NotNull SNode __thisNode__, @NotNull ClassifierTraversalCallback callback, SNode current, Set<SNode> seen, TraversalControllerImpl controller) {
    ...
    if (!(controller.isDoNotGoInto())) {
      for (SNode classifierType : ListSequence.fromList(Classifier__BehaviorDescriptor.getExtendedClassifierTypes_id1UeCwxlWKny.invoke(current))) {
        SNode superClassifier = SLinkOperations.getTarget(classifierType, MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"));
  ...
  /*package*/ static void populateMember_id6r77ob2UW9O(@NotNull SNode __thisNode__, MembersPopulatingContext context, SNode classifier) {
    ...
    context.exposeMember(__thisNode__, new ClassifierSignature(SPropertyOperations.getString(__thisNode__, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"))));
    context.hideMembersForAncestors(new ClassifierSignature(SPropertyOperations.getString(__thisNode__, MetaAdapterFactory.getProperty(0xceab519525ea4f22L, 0x9b92103b95ca8c0cL, 0x110396eaaa4L, 0x110396ec041L, "name"))));
  }
