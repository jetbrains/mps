...
public final class Classifier__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static String getNestedNameInContext_id7q4lzBFjvF8(@NotNull SNode __thisNode__, SNode context) {
    List<SNode> containers = ListSequence.fromList(SNodeOperations.getNodeAncestors(__thisNode__, CONCEPTS.Classifier$Ix, true)).reversedList();
    List<SNode> contextContainers = SNodeOperations.getNodeAncestors(context, CONCEPTS.Classifier$Ix, true);

    List<SNode> ancestors = SNodeOperations.getNodeAncestors(context, null, true);
    if (ListSequence.fromList(ancestors).contains(SNodeOperations.getParent(__thisNode__)) || ListSequence.fromList(ancestors).contains(__thisNode__) || (SNodeOperations.getNodeAncestor(context, CONCEPTS.NestedNewExpression$zV, true, false) != null)) {
