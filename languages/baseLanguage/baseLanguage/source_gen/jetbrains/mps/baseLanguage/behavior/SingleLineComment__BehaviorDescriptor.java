...
public final class SingleLineComment__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> parseAndAddWordsIntoLines_id45vN3dBFprj = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("parseAndAddWordsIntoLines").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4710708256407656147L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(String.class, ""));
  public static final SMethod<Void> parseAndAddWords_id13gAna0o0W6 = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("parseAndAddWords").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1211637016821763846L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(String.class, ""));
