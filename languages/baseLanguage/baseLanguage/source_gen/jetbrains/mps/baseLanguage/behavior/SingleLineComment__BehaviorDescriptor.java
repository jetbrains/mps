...
public final class SingleLineComment__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    SNode line = SNodeFactoryOperations.addNewChild(__thisNode__, LINKS.text$XpYF, null);
    ListSequence.fromList(SLinkOperations.getChildren(line, LINKS.elements$_j45)).removeElementAt(0);
    SNodeFactoryOperations.addNewChild(line, LINKS.elements$_j45, CONCEPTS.Word$Dn);
  }
  ...
  /*package*/ static boolean isTODOComment_idRbAU21$c$g(@NotNull SNode __thisNode__) {
    SNode firstLine = ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, LINKS.text$XpYF)).first();
    if ((firstLine != null) && ListSequence.fromList(SLinkOperations.getChildren(firstLine, LINKS.elements$_j45)).isNotEmpty()) {
      SNode firstElement = ListSequence.fromList(SLinkOperations.getChildren(firstLine, LINKS.elements$_j45)).first();
