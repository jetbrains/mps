...
public final class IVisible__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<IconResource> getVisibilityIcon_id4mxbjAOAG0d = new SMethodBuilder<>(IconResource.class).name("getVisibilityIcon").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5017341185733869581L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getVisibilityIcon_id4mxbjAOAG0d);
