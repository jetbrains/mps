...
public final class ClassConcept__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getMainMethod_idhEwIClG = new SMethodBuilder<>(SNode.class).name("getMainMethod").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877355884L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<List<SNode>> getAllSuperClassifiers_id4fAeKISQjDi = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getAllSuperClassifiers").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4892662966716545618L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<Iterable<SNode>> instanceInitializers_id6Fz0RL3y9UD = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("instanceInitializers").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7702003619977535145L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Iterable<SNode>> staticInitializers_id2I6sE$IuBP7 = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("staticInitializers").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3136320261464948039L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Iterable<SNode>> fields_id4_LVZ3pC27C = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("fields").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5292274854859383272L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Iterable<SNode>> staticMethods_id4_LVZ3pCeXr = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("staticMethods").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5292274854859435867L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Iterable<SNode>> constructors_id4_LVZ3pCvsd = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("constructors").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5292274854859503373L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Iterable<SNode>> properties_id4_LVZ3pCxYY = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("properties").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5292274854859513790L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<SNode> getContextClass_id6WzWPTX2$6q = new SMethodBuilder<>(SNode.class).name("getContextClass").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8008512149545173402L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "expr"));
  ...
  public static final SMethod<Void> addConstructor_id32Td0Ia9Mgr = new SMethodBuilder<>(Void.TYPE).name("addConstructor").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3510894608679117851L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "constructor"));
  public static final SMethod<Void> markLoadedNodeAsDeprecated_id5H8W9_EDlcn = new SMethodBuilder<>(Void.TYPE).name("markLoadedNodeAsDeprecated").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6577771797484491543L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "node"));
  public static final SMethod<Boolean> canBeExtendedOrInstantiatedAt_id2YFkRQdLLqk = new SMethodBuilder<>(Boolean.TYPE).name("canBeExtendedOrInstantiatedAt").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3434930939514787476L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "context"));
