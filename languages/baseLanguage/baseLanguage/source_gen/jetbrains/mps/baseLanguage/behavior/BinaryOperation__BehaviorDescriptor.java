...
public final class BinaryOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Object> calculateCompileTimeConstantValue_id1o8Ht9sN5Hn = new SMethodBuilder<Object>(new SJavaCompoundTypeImpl(Object.class)).name("calculateCompileTimeConstantValue").modifiers(SModifiersImpl.create(8, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("1o8Ht9sN5Hn").build(SMethodBuilder.createJavaParameter(Object.class, ""), SMethodBuilder.createJavaParameter(Object.class, ""));
  ...
  /*package*/ static void setSyntacticallyLeftSideExpression_id1wHCnsn58ZK(@NotNull SNode __thisNode__, SNode expr) {
    SLinkOperations.setTarget(__thisNode__, BinaryOperation__BehaviorDescriptor.LINKS.leftExpression$rxLZ, expr);
  }
  /*package*/ static void setSyntacticallyRightSideExpression_id1wHCnsn58ZY(@NotNull SNode __thisNode__, SNode expr) {
    SLinkOperations.setTarget(__thisNode__, BinaryOperation__BehaviorDescriptor.LINKS.rightExpression$rxBl, expr);
  }
  /*package*/ static SNode getSyntacticallyLeftSideExpression_id1wHCnsn590c(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, BinaryOperation__BehaviorDescriptor.LINKS.leftExpression$rxLZ);
  }
  /*package*/ static SNode getSyntacticallyRightSideExpression_id1wHCnsn590i(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, BinaryOperation__BehaviorDescriptor.LINKS.rightExpression$rxBl);
  }
  /*package*/ static boolean isCompileTimeConstant_idi1LOPRp(@NotNull SNode __thisNode__) {
    return (boolean) Expression__BehaviorDescriptor.isCompileTimeConstant_idi1LOPRp.invoke(SLinkOperations.getTarget(__thisNode__, BinaryOperation__BehaviorDescriptor.LINKS.leftExpression$rxLZ)) && (boolean) Expression__BehaviorDescriptor.isCompileTimeConstant_idi1LOPRp.invoke(SLinkOperations.getTarget(__thisNode__, BinaryOperation__BehaviorDescriptor.LINKS.rightExpression$rxBl));
  }
  /*package*/ static Object getCompileTimeConstantValue_idi1LP2xI(@NotNull SNode __thisNode__, SModule module) {
    Object l = Expression__BehaviorDescriptor.getCompileTimeConstantValue_idi1LP2xI.invoke(SLinkOperations.getTarget(__thisNode__, BinaryOperation__BehaviorDescriptor.LINKS.leftExpression$rxLZ), module);
    Object r = Expression__BehaviorDescriptor.getCompileTimeConstantValue_idi1LP2xI.invoke(SLinkOperations.getTarget(__thisNode__, BinaryOperation__BehaviorDescriptor.LINKS.rightExpression$rxBl), module);
    if (l != null && r != null) {
