  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), CONCEPTS.LoopLabel$jQ)) {
      if (ScopeUtils.comeFrom(LINKS.body$c1sm, __thisNode__, child)) {
        return Scopes.forLoopLabels(ListSequence.fromListAndArray(new ArrayList<SNode>(), SLinkOperations.getTarget(__thisNode__, LINKS.loopLabel$sgvV)), ScopeUtils.lazyParentScope(__thisNode__, kind));
      }
    }
