...
public final class OrExpression__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfb8255689fL, "jetbrains.mps.baseLanguage.structure.OrExpression");
  ...
  /*package*/ static NextProgramPoint getNextProgramPoint_id3F8BxGibk8h(@NotNull SNode __thisNode__, @NotNull SNode child, boolean value) {
    if (child == SLinkOperations.getTarget(__thisNode__, OrExpression__BehaviorDescriptor.LINKS.leftExpression$rxLZ)) {
      if (!(value) && SLinkOperations.getTarget(__thisNode__, OrExpression__BehaviorDescriptor.LINKS.rightExpression$rxBl) != null) {
        return NextProgramPoint.continueAt(SLinkOperations.getTarget(__thisNode__, OrExpression__BehaviorDescriptor.LINKS.rightExpression$rxBl), false);
      } else {
        if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(__thisNode__), OrExpression__BehaviorDescriptor.CONCEPTS.IConditional$bU)) {
          NextProgramPoint point = IConditional__BehaviorDescriptor.getNextProgramPoint_id3F8BxGibk8h.invoke(SNodeOperations.cast(SNodeOperations.getParent(__thisNode__), OrExpression__BehaviorDescriptor.CONCEPTS.IConditional$bU), __thisNode__, ((boolean) value));
          if (point != null) {
            return point.withJump();
          }
        }
      }
    } else if (child == SLinkOperations.getTarget(__thisNode__, OrExpression__BehaviorDescriptor.LINKS.rightExpression$rxBl)) {
      if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(__thisNode__), OrExpression__BehaviorDescriptor.CONCEPTS.IConditional$bU)) {
        return IConditional__BehaviorDescriptor.getNextProgramPoint_id3F8BxGibk8h.invoke(SNodeOperations.cast(SNodeOperations.getParent(__thisNode__), OrExpression__BehaviorDescriptor.CONCEPTS.IConditional$bU), __thisNode__, ((boolean) value));
      }
    }
    return null;
  }
