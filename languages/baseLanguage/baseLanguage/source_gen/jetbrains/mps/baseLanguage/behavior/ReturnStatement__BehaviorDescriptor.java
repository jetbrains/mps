...
public final class ReturnStatement__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<SNode> getFinallyBlocks_idhEwJbU4(@NotNull SNode __thisNode__) {
    ...
    while (true) {
      if (SNodeOperations.isInstanceOf(current, CONCEPTS.TryStatement$oi)) {
        SNode tryStatement = SNodeOperations.cast(current, CONCEPTS.TryStatement$oi);
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept TryStatement$oi = MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x10cacebf556L, "jetbrains.mps.baseLanguage.structure.TryStatement");
