...
public final class EnumConstantDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isVisible_id70J2WaK_oVl = new SMethodBuilder<>(Boolean.TYPE).name("isVisible").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8083692786967482069L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "contextClassifier"), SMethodBuilder.createJavaParameter(SNode.class, "contextNode"));
  ...
  /*package*/ static final SMethod<String> getEnumConstantDeclarationPresentation_id7AEI0n132aJ = new SMethodBuilder<>(String.class).name("getEnumConstantDeclarationPresentation").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(8767021959483237039L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<SNode> findSuitableConstructor_idFdL0MDGgE3 = new SMethodBuilder<>(SNode.class).name("findSuitableConstructor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(778493869270567555L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
