...
public final class StaticFieldDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isInitializable_idhEwJfMK = new SMethodBuilder<>(Boolean.TYPE).name("isInitializable").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877517488L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<SNode> createReference_idhEwJfME = new SMethodBuilder<>(SNode.class).name("createReference").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877517482L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<Boolean> isStaticClassifierMember_id7MS72Gc8avw = new SMethodBuilder<>(Boolean.TYPE).name("isStaticClassifierMember").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8986964027630462944L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<Boolean> canBeInterfaceMember_id2zJQqQIUx2B = new SMethodBuilder<>(Boolean.TYPE).name("canBeInterfaceMember").modifiers(9, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2949815620938109095L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<String> getSuffix_id2Bet8mWh3pg = new SMethodBuilder<>(String.class).name("getSuffix").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3012473318495499856L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(Project.class, "project"));
  public static final SMethod<String> getPrefix_id2Bet8mWh2lw = new SMethodBuilder<>(String.class).name("getPrefix").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3012473318495495520L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(Project.class, "project"));
  ...
  public static final SMethod<SNode> getQualifiedReference_id3Zg$dTLuqo9 = new SMethodBuilder<>(SNode.class).name("getQualifiedReference").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4598334504606213641L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<Void> markLoadedNodeAsDeprecated_id5H8W9_ECCQE = new SMethodBuilder<>(Void.TYPE).name("markLoadedNodeAsDeprecated").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6577771797484309930L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "node"));
  ...
  public static final SMethod<Boolean> isConstantValue_id3dsApLDTYgy = new SMethodBuilder<>(Boolean.TYPE).name("isConstantValue").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3701001890862457890L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  /*package*/ static void markDeprecated_id6Va_BJexupi(@NotNull SNode __thisNode__) {
    ...
    if ((new IAttributeDescriptor.NodeAttribute(CONCEPTS.FieldDocComment$wl).get(__thisNode__) == null)) {
    ...
    if (!((boolean) IBLDeprecatable__BehaviorDescriptor.hasDeprecatedBlockDocTag_id3yvWaPI09DC.invoke(__thisNode__))) {
      SNodeFactoryOperations.addNewChild(new IAttributeDescriptor.NodeAttribute(CONCEPTS.FieldDocComment$wl).get(__thisNode__), LINKS.tags$stUD, CONCEPTS.DeprecatedBlockDocTag$8n);
    }
  ...
  /*package*/ static void unmarkDeprecated_id6Va_BJex$aE(@NotNull SNode __thisNode__) {
    ...
    IBLDeprecatable__BehaviorDescriptor.removeDeprecationFromDoc_id63oBH1IM79r.invoke(__thisNode__, new IAttributeDescriptor.NodeAttribute(CONCEPTS.FieldDocComment$wl).get(__thisNode__));
