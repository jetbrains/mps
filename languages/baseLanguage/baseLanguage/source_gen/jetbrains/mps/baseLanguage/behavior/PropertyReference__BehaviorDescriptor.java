...
public final class PropertyReference__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isBeingAssigned_id5WTl5xTCF5s = new SMethodBuilder<>(Boolean.TYPE).name("isBeingAssigned").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6861608246250221916L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
