...
public final class IWillBeClassifier__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> classifierName_id3ZSHU3pg$b_ = new SMethodBuilder<>(String.class).name("classifierName").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4609636120081351397L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<SNode> baseClassifier_id3_1Lj9FFNJ0 = new SMethodBuilder<>(SNode.class).name("baseClassifier").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4125795553993767872L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<SNode> resolve_id3ZSHU3ph184 = new SMethodBuilder<>(SNode.class).name("resolve").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4609636120081469956L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SModel.class, "targetModel"));
