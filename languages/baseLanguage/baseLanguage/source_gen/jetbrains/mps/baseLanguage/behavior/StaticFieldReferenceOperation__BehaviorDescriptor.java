...
public final class StaticFieldReferenceOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getClassifier_id1U0U1G1L440 = new SMethodBuilder<>(SNode.class).name("getClassifier").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2198011820848201984L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
