...
public final class InstanceMethodDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isDataFlowChecked_idhRptrfk = new SMethodBuilder<>(Boolean.TYPE).name("isDataFlowChecked").modifiers(8, AccessPrivileges.PACKAGE).concept(CONCEPT).baseMethodId(1227714048980L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<Boolean> isAbstract_idhWjv7RO = new SMethodBuilder<>(Boolean.TYPE).name("isAbstract").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1232982539764L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Boolean> isAnAbstractMethod_id28P2dHxCoRl = new SMethodBuilder<>(Boolean.TYPE).name("isAnAbstractMethod").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2464886109384052181L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Boolean> hasBody_id10BRnhak8m8 = new SMethodBuilder<>(Boolean.TYPE).name("hasBody").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1164142520231298440L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<Boolean> hasVisibility_id1X7GQqyPHmE = new SMethodBuilder<>(Boolean.TYPE).name("hasVisibility").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2253967391922247082L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<SNode> getImplementedInterfaceMethod_id7cTWCexFh1W = new SMethodBuilder<>(SNode.class).name("getImplementedInterfaceMethod").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8302934035201331324L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  public static final SMethod<SNode> getNearestOverriddenMethod_id4DuBHEkPTzU = new SMethodBuilder<>(SNode.class).name("getNearestOverriddenMethod").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5358895268254685434L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  /*package*/ static SNode getImplementedInterfaceMethod_id7cTWCexFh1W(@NotNull SNode __thisNode__) {
    ...
    for (SNode method : Sequence.fromIterable(implementedInterfaces).translate((it) -> (Iterable<SNode>) Classifier__BehaviorDescriptor.methods_id4_LVZ3pBKCn.invoke(it))) {
  ...
  /*package*/ static SNode getNearestOverriddenMethod_id4DuBHEkPTzU(@NotNull SNode __thisNode__) {
    ...
    Iterable<SNode> instanceMethods = SetSequence.fromSet(extendedClassifiers).translate((it) -> (Iterable<SNode>) Classifier__BehaviorDescriptor.methods_id4_LVZ3pBKCn.invoke(it));
