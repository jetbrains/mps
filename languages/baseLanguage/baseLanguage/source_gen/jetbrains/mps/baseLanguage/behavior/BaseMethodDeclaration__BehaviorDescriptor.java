...
public final class BaseMethodDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<IconResource> getIconMarks_id6TtJ6IUkhQJ(@NotNull SNode __thisNode__) {
    List<IconResource> markIcons = new ArrayList<IconResource>(BaseConcept__BehaviorDescriptor.getIconMarks_id6TtJ6IUkhQJ.invokeSuper(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.BaseMethodDeclaration$RR));
    if (SPropertyOperations.getBoolean(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.PROPS.isFinal$I$Qu)) {
  ...
  /*package*/ static SNode getExpectedRetType_idi2fhBNC(@NotNull SNode __thisNode__) {
    SNode expectedRetType = SLinkOperations.getTarget(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.returnType$WIkw);
    if (SConceptOperations.isExactly(SNodeOperations.asSConcept(SNodeOperations.getConcept(expectedRetType)), BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.Type$IG) || SNodeOperations.isInstanceOf(expectedRetType, BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.VoidType$aT) || ((boolean) BaseMethodDeclaration__BehaviorDescriptor.isReturnsVoid_idhX_$1pM.invoke(__thisNode__))) {
  ...
  /*package*/ static boolean isImplementation_id19gBtYEvixA(@NotNull SNode __thisNode__, SNode child) {
    return SNodeOperations.isInstanceOf(child, BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.StatementList$TN);
  }
  /*package*/ static SNode getBody_idi2fhZ_m(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.body$WIlu);
  }
  /*package*/ static List<SNode> getChildrenToDisplayIntention_id3vsDNFqJVhw(@NotNull SNode __thisNode__) {
    List<SNode> result = new ArrayList<SNode>();
    ListSequence.fromList(result).addElement(SLinkOperations.getTarget(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.returnType$WIkw));
    return result;
  }
  ...
  /*package*/ static String getParametersPresentation_idhEwIAYw(@NotNull SNode __thisNode__) {
    ...
    result.append("(");
    boolean first = true;
    for (SNode parm : SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ)) {
      if (!(first)) {
        result.append(",");
      }
      first = false;
      if (SLinkOperations.getTarget(parm, BaseMethodDeclaration__BehaviorDescriptor.LINKS.type$pLrO) != null) {
        result.append(BaseConcept__BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(SLinkOperations.getTarget(parm, BaseMethodDeclaration__BehaviorDescriptor.LINKS.type$pLrO)));
      } else {
        result.append("???");
      }
    }
  ...
  /*package*/ static String getPresentation_idhEwIMiw(@NotNull SNode __thisNode__) {
    StringBuilder result = new StringBuilder();
    String name = SPropertyOperations.getString(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.PROPS.name$tAp1);
    if (name != null) {
      result.append(name);
    } else {
    ...
    result.append(":");
    if (SLinkOperations.getTarget(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.returnType$WIkw) != null) {
      result.append(BaseConcept__BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(SLinkOperations.getTarget(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.returnType$WIkw)));
    } else {
      result.append("???");
    }
    return result.toString();
  ...
  /*package*/ static boolean hasSameParameters_idJuSt8W4$Q2(@NotNull SNode __thisNode__, SNode checked) {
    if (ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ)).count() != ListSequence.fromList(SLinkOperations.getChildren(checked, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ)).count()) {
      return false;
    }
    for (int i = 0; i < ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ)).count(); i++) {
      String searchedParamType = check_tq0gdw_a0a0b0n(check_tq0gdw_a0a0a1a31(ListSequence.fromList(SLinkOperations.getChildren(checked, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ)).getElement(i)));
      String foundParamType = check_tq0gdw_a0b0b0n(check_tq0gdw_a0a1a1a31(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ)).getElement(i)));
  ...
  /*package*/ static boolean hasSameSignature_idhEwIB0z(@NotNull SNode __thisNode__, SNode checked) {
    if (!(Objects.equals(SPropertyOperations.getString(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.PROPS.name$tAp1), SPropertyOperations.getString(checked, BaseMethodDeclaration__BehaviorDescriptor.PROPS.name$tAp1)))) {
      return false;
    }
    if (ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ)).count() != ListSequence.fromList(SLinkOperations.getChildren(checked, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ)).count()) {
      return false;
    }
    if (SNodeOperations.isInstanceOf(checked, BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.InstanceMethodDeclaration$An)) {
      SNode patternMethod = BaseMethodDeclaration__BehaviorDescriptor.getMethodToImplement_id3RE744JWbF.invoke(__thisNode__, SNodeOperations.getNodeAncestor(checked, BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.Classifier$hJ, false, false));
  ...
  /*package*/ static String getErasureSignature_id2t8d$bukubq(@NotNull SNode __thisNode__) {
    ...
    List<SNode> parameters = SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ);
    for (int i = 0; i < ListSequence.fromList(parameters).count(); i++) {
      SNode param = ListSequence.fromList(parameters).getElement(i);
      sb.append(Type__BehaviorDescriptor.getErasureSignature_idhEwIzNx.invoke(SLinkOperations.getTarget(param, BaseMethodDeclaration__BehaviorDescriptor.LINKS.type$pLrO)));
  ...
  /*package*/ static SNode getTypeAnnotation_idhXbqSv6(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.returnType$WIkw);
  }
  /*package*/ static String jniSignature_id7F81Cd2CcPY(@NotNull SNode __thisNode__) {
    StringBuilder sb = new StringBuilder();
    sb.append("(");
    for (SNode p : SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ)) {
      sb.append(Type__BehaviorDescriptor.jniSignature_id7F81Cd2C7e3.invoke(SLinkOperations.getTarget(p, BaseMethodDeclaration__BehaviorDescriptor.LINKS.type$pLrO)));
    }
    sb.append(")");
    sb.append(Type__BehaviorDescriptor.jniSignature_id7F81Cd2C7e3.invoke(SLinkOperations.getTarget(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.returnType$WIkw)));
    return sb.toString();
  }
  /*package*/ static List<SNode> getThrowableTypes_id5op8ooRkkc7(@NotNull SNode __thisNode__) {
    return SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.throwsItem$gr7e);
  }
  /*package*/ static boolean hasAnnotation_id4LgT5De$Kd_(@NotNull SNode __thisNode__, SNode annotation) {
    for (SNode annotationInstance : SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.annotation$oVP4)) {
      if (SLinkOperations.getTarget(annotationInstance, BaseMethodDeclaration__BehaviorDescriptor.LINKS.annotation$zNxu) == annotation) {
        return true;
      }
    }
    return false;
  ...
  /*package*/ static boolean hasAnnotation_id3WDGf12DPy8(@NotNull SNode __thisNode__, SNodeReference annotation) {
    for (SNode annotationInstance : SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.annotation$oVP4)) {
      if (Objects.equals(SLinkOperations.getPointer(annotationInstance, BaseMethodDeclaration__BehaviorDescriptor.LINKS.annotation$zNxu), annotation)) {
        return true;
      }
    }
    return false;
  ...
  /*package*/ static String getTraceableProperty_id4pl5GY7LKmH(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.PROPS.name$tAp1) + "#" + BaseMethodDeclaration__BehaviorDescriptor.jniSignature_id7F81Cd2CcPY.invoke(__thisNode__);
  }
  /*package*/ static List<SNode> getScopeVariables_id4pl5GY7LKmA(@NotNull SNode __thisNode__) {
    return SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ);
  }
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    if (SConceptOperations.isSubConceptOf(SNodeOperations.asSConcept(kind), BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.LocalToMethodKind$WY)) {
      return new EmptyScope();
    }
    if (SConceptOperations.isExactly(SNodeOperations.asSConcept(kind), BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.VariableDeclaration$xe)) {
      if (ScopeUtils.comeFrom(BaseMethodDeclaration__BehaviorDescriptor.LINKS.body$WIlu, __thisNode__, child)) {
        return Scopes.forVariables(kind, SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ), ScopeUtils.lazyParentScope(__thisNode__, kind));
      } else {
        return ScopeUtils.lazyParentScope(__thisNode__, kind);
      }
    }

    return ((Scope) ScopeProvider__BehaviorDescriptor.getScope_id52_Geb4QDV$.invoke0(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.GenericDeclaration$IQ, kind, child));
  }
  /*package*/ static List<SNode> getTypeApplicationParameters_id7bu6bIyR2DR(@NotNull SNode __thisNode__, int actualArgs) {
    List<SNode> result = new ArrayList<SNode>();
    ListSequence.fromList(result).addSequence(ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ)).select(new ISelector<SNode, SNode>() {
      public SNode select(SNode it) {
        return SLinkOperations.getTarget(it, BaseMethodDeclaration__BehaviorDescriptor.LINKS.type$pLrO);
      }
    }));

    if (SNodeOperations.isInstanceOf(ListSequence.fromList(result).last(), BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.VariableArityType$jT)) {
      ...
      if (actualArgs > formalParams) {
        while (actualArgs > ListSequence.fromList(result).count()) {
          ListSequence.fromList(result).addElement(SNodeOperations.copyNode(SLinkOperations.getTarget(SNodeOperations.cast(last, BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.VariableArityType$jT), BaseMethodDeclaration__BehaviorDescriptor.LINKS.componentType$knmw)));
        }
      } else if (actualArgs == formalParams) {
        // array may be passed as value for vararg 
        ListSequence.fromList(result).addElement(_quotation_createNode_tq0gdw_a0a1a0d0d0bb(SNodeOperations.copyNode(SLinkOperations.getTarget(SNodeOperations.cast(last, BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.VariableArityType$jT), BaseMethodDeclaration__BehaviorDescriptor.LINKS.componentType$knmw)), SNodeOperations.copyNode(SLinkOperations.getTarget(SNodeOperations.cast(last, BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.VariableArityType$jT), BaseMethodDeclaration__BehaviorDescriptor.LINKS.componentType$knmw))));
      }
    }
  ...
  /*package*/ static List<SNode> getInferrableTypeVars_id5W9RYt5baxk(@NotNull final SNode __thisNode__) {
    List<SNode> returnTypeVars = ListSequence.fromList(SNodeOperations.getNodeDescendants(SLinkOperations.getTarget(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.returnType$WIkw), BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.TypeVariableReference$vZ, false, new SAbstractConcept[]{})).select(new ISelector<SNode, SNode>() {
      public SNode select(SNode it) {
        return SLinkOperations.getTarget(it, BaseMethodDeclaration__BehaviorDescriptor.LINKS.typeVariableDeclaration$U0X4);
      }
    ...
    List<SNode> boundTypeVars = ListSequence.fromList(SLinkOperations.getChildren(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.LINKS.parameter$WIkZ)).translate(new ITranslator2<SNode, SNode>() {
      public Iterable<SNode> translate(SNode p) {
        return SNodeOperations.getNodeDescendants(p, BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.TypeVariableReference$vZ, false, new SAbstractConcept[]{});
      }
  ...
  /*package*/ static void markDeprecated_id6Va_BJexupi(@NotNull SNode __thisNode__) {
    IBLDeprecatable__BehaviorDescriptor.markDeprecated_id6Va_BJexupi.invoke0(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.IBLDeprecatable$Hv);
    if ((AttributeOperations.getAttribute(__thisNode__, new IAttributeDescriptor.NodeAttribute(BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.MethodDocComment$Vx)) == null)) {
      SNodeFactoryOperations.setNewAttribute(__thisNode__, new IAttributeDescriptor.NodeAttribute(BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.MethodDocComment$Vx), BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.MethodDocComment$Vx);
    }
    if (!(((boolean) IBLDeprecatable__BehaviorDescriptor.hasDeprecatedBlockDocTag_id3yvWaPI09DC.invoke(__thisNode__)))) {
      SNodeFactoryOperations.addNewChild(AttributeOperations.getAttribute(__thisNode__, new IAttributeDescriptor.NodeAttribute(BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.MethodDocComment$Vx)), BaseMethodDeclaration__BehaviorDescriptor.LINKS.tags$LJD$, BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.DeprecatedBlockDocTag$ma);
    }
  ...
  /*package*/ static void unmarkDeprecated_id6Va_BJex$aE(@NotNull SNode __thisNode__) {
    IBLDeprecatable__BehaviorDescriptor.unmarkDeprecated_id6Va_BJex$aE.invoke0(__thisNode__, BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.IBLDeprecatable$Hv);
    IBLDeprecatable__BehaviorDescriptor.removeDeprecationFromDoc_id63oBH1IM79r.invoke(__thisNode__, AttributeOperations.getAttribute(__thisNode__, new IAttributeDescriptor.NodeAttribute(BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.MethodDocComment$Vx)));
  ...
  /*package*/ static void markLoadedNodeAsDeprecated_id5H8W9_EDFVg(@NotNull SAbstractConcept __thisConcept__, SNode node) {
    AttributeOperations.setAttribute(node, new IAttributeDescriptor.NodeAttribute(BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.MethodDocComment$Vx), DeprecationUtil.createDocComment(BaseMethodDeclaration__BehaviorDescriptor.CONCEPTS.MethodDocComment$Vx));
  }
  ...
  private static SNode check_tq0gdw_a0a0a1a31(SNode checkedDotOperand) {
    if (null != checkedDotOperand) {
      return SLinkOperations.getTarget(checkedDotOperand, BaseMethodDeclaration__BehaviorDescriptor.LINKS.type$pLrO);
    }
    return null;
  }
