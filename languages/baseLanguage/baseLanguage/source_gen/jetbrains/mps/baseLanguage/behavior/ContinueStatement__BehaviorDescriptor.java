...
public final class ContinueStatement__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getLoop_idhEwIA0E = new SMethodBuilder<>(SNode.class).name("getLoop").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877346346L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
