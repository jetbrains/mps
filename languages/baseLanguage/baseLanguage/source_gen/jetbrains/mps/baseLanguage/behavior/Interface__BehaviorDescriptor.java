...
public final class Interface__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> canBeStatic_id2L7NFMC7$9I = new SMethodBuilder<>(Boolean.TYPE).name("canBeStatic").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3190746170685014638L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<Void> markLoadedNodeAsDeprecated_id5H8W9_EDv7w = new SMethodBuilder<>(Void.TYPE).name("markLoadedNodeAsDeprecated").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6577771797484532192L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "node"));

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(findAncestor_id3HluQRcXTJl, isDescendant_checkLoops_id6dL7A1DpKoA, checkLoops_id3sXyOQUqKq5, getUnitName_id4pl5GY7LKmR, getScope_id52_Geb4QDV$, getExtendedClassifierTypes_id1UeCwxlWKny, populateMembers_id6r77ob2USUV, enumerateMembers_id65_8Gi2s6iV, enumerateSupertypes_id65_8Gi1dKDs, enumerateObjectMembers_id9QjKR8ksDs, canBeStatic_id2L7NFMC7$9I, markDeprecated_id6Va_BJexupi, unmarkDeprecated_id6Va_BJex$aE, markLoadedNodeAsDeprecated_id5H8W9_EDv7w);
