...
public final class EnumClass__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> findConstantByName_idhEwIiGU = new SMethodBuilder<>(SNode.class).name("findConstantByName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877267258L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(String.class, "name"));
  ...
  /*package*/ static final SMethod<SNode> getExtendedEnumJavaType_id6O4rE5gbZ0q = new SMethodBuilder<>(SNode.class).name("getExtendedEnumJavaType").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(7855525289155096602L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
