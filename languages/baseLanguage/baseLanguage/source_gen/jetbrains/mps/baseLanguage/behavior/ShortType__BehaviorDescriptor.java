...
public final class ShortType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static SNode getBoxedType_idhEwIzNC(@NotNull SNode __thisNode__) {
    return createClassifierType_gsl4dp_a0a0();
  }
  /*package*/ static List<SNode> getSupertypes_id4w2h6RLlygH(@NotNull SNode __thisNode__) {
    return ListSequence.fromListAndArray(new ArrayList<SNode>(), _quotation_createNode_gsl4dp_a0a0a1());
  }
  /*package*/ static SNode getClassExpression_idhEwIzOd(@NotNull SNode __thisNode__) {
    return createStaticFieldReference_gsl4dp_a0a2();
  }
  ...
  private static SNode createClassifierType_gsl4dp_a0a0() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.ClassifierType$bL);
    n0.setReference(LINKS.classifier$cxMr, new SNodePointer(facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~Short")));
    return n0.getResult();
  }
  private static SNode _quotation_createNode_gsl4dp_a0a0a1() {
  ...
  private static SNode createStaticFieldReference_gsl4dp_a0a2() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.StaticFieldReference$cU);
    n0.setReference(LINKS.classifier$BPY8, new SNodePointer(facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~Short")));
    n0.setReference(LINKS.variableDeclaration$N1XG, new SNodePointer(facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.lang(JDK/)"), facade.createNodeId("~Short.TYPE")));
    return n0.getResult();
  }
