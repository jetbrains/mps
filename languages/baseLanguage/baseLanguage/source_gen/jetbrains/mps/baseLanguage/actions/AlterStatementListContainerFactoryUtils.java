...
public class AlterStatementListContainerFactoryUtils {
  ...
  private static SNode createIntegerConstant_kz5t2g_a0a1a01a2a1a4() {
    ...
    rootBuilder1.setProperty(PROPS.value$jgCM, PROPS.value$jgCM.getType().toString(0));
    return rootBuilder1.getResult();
  }
  private static SNode createIntegerType_kz5t2g_a0a2a01a2a1a4() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.IntegerType$7a);
    return rootBuilder1.getResult();
  }
  private static SNode createLessThanExpression_kz5t2g_a0a4a01a2a1a4() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.LessThanExpression$Li);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.leftExpression$sEj).init(CONCEPTS.VariableReference$TC);
    }
    {
      SNodeBuilder n3 = rootBuilder1.forChild(LINKS.rightExpression$nvX).init(CONCEPTS.DotExpression$yW);
      {
        SNodeBuilder n4 = n3.forChild(LINKS.operand$w6IR).init(CONCEPTS.VariableReference$TC);
      }
      n3.forChild(LINKS.operation$gs9E).init(CONCEPTS.ArrayLengthOperation$fn);
    }
    return rootBuilder1.getResult();
  }
  private static SNode createPostfixIncrementExpression_kz5t2g_a0a5a01a2a1a4() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.PostfixIncrementExpression$wn);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.expression$uRUg).init(CONCEPTS.VariableReference$TC);
    }
    return rootBuilder1.getResult();
  }
  private static SNode createArrayAccessExpression_kz5t2g_a0l0k0c0b0e() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ArrayAccessExpression$Eu);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.array$tTQe).init(CONCEPTS.VariableReference$TC);
    }
    {
      SNodeBuilder n3 = rootBuilder1.forChild(LINKS.index$LbBP).init(CONCEPTS.VariableReference$TC);
    }
    return rootBuilder1.getResult();
  }
  private static SNode createDotExpression_kz5t2g_a0a1a0k0c0b0e() {
    ...
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.operand$w6IR).init(CONCEPTS.VariableReference$TC);
    }
    rootBuilder1.forChild(LINKS.operation$gs9E).init(CONCEPTS.GetIteratorOperation$L1);
    return rootBuilder1.getResult();
  }
  private static SNode createDotExpression_kz5t2g_a0a11a0k0c0b0e() {
    ...
    {
      SNodeBuilder n3 = rootBuilder1.forChild(LINKS.operation$gs9E).init(CONCEPTS.InstanceMethodCallOperation$uu);
      n3.setReference(LINKS.baseMethodDeclaration$pyYw, new SNodePointer(facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.util(JDK/)"), facade.createNodeId("~Iterator.hasNext()")));
    }
    return rootBuilder1.getResult();
  }
  private static SNode createDotExpression_kz5t2g_a0a71a0k0c0b0e() {
    ...
    {
      SNodeBuilder n3 = rootBuilder1.forChild(LINKS.operation$gs9E).init(CONCEPTS.InstanceMethodCallOperation$uu);
      n3.setReference(LINKS.baseMethodDeclaration$pyYw, new SNodePointer(facade.createModelReference("6354ebe7-c22a-4a0f-ac54-50b52ab9b065/java:java.util(JDK/)"), facade.createNodeId("~Iterator.next()")));
    }
    return rootBuilder1.getResult();
  }
