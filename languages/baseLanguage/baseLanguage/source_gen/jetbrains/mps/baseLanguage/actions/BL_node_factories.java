...
public class BL_node_factories {
    ...
    public void setup(SNode newNode, SNode sampleNode, SNode enclosingNode, SModel model) {
      if (SNodeOperations.isInstanceOf(sampleNode, CONCEPTS.Expression$mB)) {
        ...
        if (PrecedenceUtil.needsParensAroundNotExpression(newNode)) {
          ...
          SLinkOperations.setTarget(parens, LINKS.expression$TlhM, sampleNode);
        }
      }
    }
  }
  ...
  public static class NodeFactory_5649551303341182515 implements NodeFactory {
    public void setup(SNode newNode, SNode sampleNode, SNode enclosingNode, SModel model) {
      SLinkOperations.setTarget(newNode, LINKS.variable$JNH6, _quotation_createNode_ns07og_a0a0a0z());
    }
  ...
  public static class NodeFactory_2256531611052034561 implements NodeFactory {
    public void setup(SNode newNode, SNode sampleNode, SNode enclosingNode, SModel model) {
      ...
      if ((SLinkOperations.getTarget(newNode, LINKS.type$a1UY) == null)) {
        SLinkOperations.setTarget(newNode, LINKS.type$a1UY, _quotation_createNode_ns07og_a0a0a1a0ab());
      }
    }
    ...
    public void setup(SNode newNode, SNode sampleNode, SNode enclosingNode, SModel model) {
      {
        ...
        if (SNodeOperations.isInstanceOf(next, CONCEPTS.AdditionalForLoopVariable$dI)) {
          SPropertyOperations.assign(newNode, PROPS.name$MnvL, SPropertyOperations.getString(next, PROPS.name$MnvL));
          SLinkOperations.setTarget(newNode, LINKS.type$a1UY, SNodeOperations.copyNode(SLinkOperations.getTarget(next, LINKS.type$a1UY)));
          SLinkOperations.setTarget(newNode, LINKS.initializer$2twD, SNodeOperations.copyNode(SLinkOperations.getTarget(next, LINKS.initializer$2twD)));
        }
      }
    }
  }
