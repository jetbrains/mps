...
/*package*/ class SwitchStatement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_nmr9ig_a8a() {
    return (SLinkOperations.getTarget(myNode, LINKS.defaultBlock$QOu8) == null) && ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.case$8PWE)).isNotEmpty();
  }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new switchLabelSingleRoleHandler_nmr9ig_a1a(myNode, LINKS.switchLabel$nNiT, getEditorContext());
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new expressionSingleRoleHandler_nmr9ig_e0(myNode, LINKS.expression$CjpY, getEditorContext());
    return provider.createCell();
  }
  ...
  private static class caseListHandler_nmr9ig_h0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(caseListHandler_nmr9ig_h0.this.getNode(), LINKS.case$8PWE));
      try {
  ...
  private EditorCell createRefNode_2() {
    SingleRoleCellProvider provider = new defaultBlockSingleRoleHandler_nmr9ig_c9a(myNode, LINKS.defaultBlock$QOu8, getEditorContext());
    return provider.createCell();
  }
