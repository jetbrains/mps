...
public class ExpressionStatement_TransformationMenu extends TransformationMenuBase {
  public ExpressionStatement_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "ExpressionStatement", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "6087507514943557671")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  private class TMP_Action_buu7zc_b0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SubstituteCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "6087507514941105233"));
        return this;
      }
      @Nullable
      @Override
