...
public class BinaryOperation_Alias_TransformationMenu extends TransformationMenuBase {
  public BinaryOperation_Alias_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "BinaryOperation_Alias_TransformationMenu", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "8577426829558646394")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
