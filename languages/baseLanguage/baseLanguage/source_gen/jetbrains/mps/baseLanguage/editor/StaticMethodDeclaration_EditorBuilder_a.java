...
/*package*/ class StaticMethodDeclaration_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new returnTypeSingleRoleHandler_j4vm40_j0(myNode, LINKS.returnType$WIkw, getEditorContext());
  ...
  private static class parameterListHandler_j4vm40_m0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(parameterListHandler_j4vm40_m0.this.getNode(), LINKS.parameter$WIkZ));
      try {
