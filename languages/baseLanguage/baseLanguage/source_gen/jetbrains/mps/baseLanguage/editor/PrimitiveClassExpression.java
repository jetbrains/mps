...
public class PrimitiveClassExpression extends SubstituteMenuBase {
  public PrimitiveClassExpression() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "PrimitiveClassExpression", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586958063")));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Wrap_vqoe2c_a(), CONCEPTS.Expression$mB));
    return result;
  }

  private class SMP_Wrap_vqoe2c_a extends WrapperSubstituteMenuPart {
    private SMP_Wrap_vqoe2c_a() {
      super(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "PrimitiveType", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1786743323644956535")));
    }
    ...
    protected SubstituteMenuItem wrapItem(final SubstituteMenuItem item, final SubstituteMenuContext _context) {
      ...
      return new SubstituteMenuItemWrapper(item, _context) {
        ...
        public SNode createNode(@NotNull String pattern) {
          ...
          SNode result = SNodeFactoryOperations.createNewNode(CONCEPTS.PrimitiveClassExpression$gf, null);
          SLinkOperations.setTarget(result, LINKS.primitiveType$wvbi, nodeToWrap);
          return result;
        }
