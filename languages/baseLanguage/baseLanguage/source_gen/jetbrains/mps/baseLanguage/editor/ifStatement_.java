...
public class ifStatement_ extends SubstituteMenuBase {
  public ifStatement_() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "ifStatement_", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586959120")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Action_vrmndy_a extends SingleItemSubstituteMenuPart {
    ...
    private class Item extends DefaultSubstituteMenuItem {
      ...
      /*package*/ void resetTraceInfo() {
        ...
        updateTraceInfo(description, new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586959122"));
      }
