...
public class ReplaceQualifiedReference extends TransformationMenuBase {
  public ReplaceQualifiedReference() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "ReplaceQualifiedReference", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "9079830899494398504")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  private class TMP_Action_5j0rtt_b0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SubstituteCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "9079830899494483737"));
        return this;
      }
      @Nullable
      @Override
