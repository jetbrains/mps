...
/*package*/ class LocalMethodCall_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_2jlgx_a0a() {
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.method$WDuk);
    ...
    editorCell.setSubstituteInfo(new SReferenceSubstituteInfoSmartReferenceDecorator(new SReferenceSubstituteInfo(editorCell, referenceLink, CONCEPTS.MethodDeclaration$_P)));
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink method$WDuk = MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x6c6b6a1e379f9404L, 0x6c6b6a1e379f9407L, "method");
  }
