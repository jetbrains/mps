...
public class ctor_IncompleteFromModifier extends SubstituteMenuBase {
  ...
  public class SMP_Group_ylzf1h_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    protected boolean isApplicable(SubstituteMenuContext _context) {
      return JavaLanguageLevel.JAVA_8.covers(new BaseLanguageEnvironmentHelper().getLanguageLevel(_context.getParentNode())) && SNodeOperations.isInstanceOf(_context.getParentNode(), CONCEPTS.Interface$Kp);
    }
    @NotNull
    @Override
    ...
    protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts() {
      return Arrays.<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>asList(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Action_ylzf1h_a0(), CONCEPTS.IncompleteMemberDeclaration$QW));
    }
