...
public class expressionstmt_to_variable_declaration extends TransformationMenuBase {
  public expressionstmt_to_variable_declaration() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "expressionstmt_to_variable_declaration", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "6824408471354613068")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  public class TMP_Group_mt5nim_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_mt5nim_a0() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "6824408471354613071")));
    }
    @Override
