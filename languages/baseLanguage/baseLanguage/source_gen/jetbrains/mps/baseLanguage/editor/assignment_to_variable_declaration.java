...
public class assignment_to_variable_declaration extends TransformationMenuBase {
  public assignment_to_variable_declaration() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "assignment_to_variable_declaration", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "2924820976074275291")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  public class TMP_Group_ebtzic_b0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_ebtzic_b0() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "3701001890858074352")));
    }
    @Override
    protected boolean isApplicable(TransformationMenuContext _context) {
      return SNodeOperations.isInstanceOf(SNodeOperations.getParent(_context.getNode()), CONCEPTS.BaseAssignmentExpression$PA) && SNodeOperations.isInstanceOf(SNodeOperations.getParent(SNodeOperations.getParent(_context.getNode())), CONCEPTS.Statement$P6);
    }
    @Override
    ...
    public class TMP_WrapSM_ebtzic_a1a extends WrapSubstituteMenuTransformationMenuPart {
      ...
      private class SMIasTMI extends SubstituteMenuItemAsActionItem implements SubstituteCompletionActionItem {
        ...
        public void execute(@NotNull String pattern) {
          ...
          SNode rValue = SLinkOperations.getTarget(SNodeOperations.cast(SNodeOperations.getParent(_context.getNode()), CONCEPTS.BaseAssignmentExpression$PA), LINKS.rValue$spNK);
          SNode varstmt = SNodeOperations.replaceWithNewChild(SNodeOperations.getParent(SNodeOperations.getParent(_context.getNode())), CONCEPTS.LocalVariableDeclarationStatement$4w);
          ...
          SLinkOperations.setTarget(varstmt, LINKS.localVariableDeclaration$RpjM, var);
          SLinkOperations.setTarget(var, LINKS.type$a1UY, createdNode);
          SLinkOperations.setTarget(var, LINKS.initializer$2twD, rValue);
