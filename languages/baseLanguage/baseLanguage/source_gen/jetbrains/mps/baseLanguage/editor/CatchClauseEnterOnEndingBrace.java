...
public class CatchClauseEnterOnEndingBrace {
  ...
  /*package*/ static AbstractCellAction createAction_INSERT(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        SNode n = SNodeOperations.insertNextSiblingChild(SNodeOperations.getParent(node), SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8cc56b215L, "jetbrains.mps.baseLanguage.structure.Statement")));
      ...
      public boolean canExecute_internal(EditorContext editorContext, SNode node) {
        return (SNodeOperations.getNextSibling(node) == null) && (SLinkOperations.getTarget(SNodeOperations.as(SNodeOperations.getParent(node), CONCEPTS.TryUniversalStatement$80), LINKS.finallyClause$4P0X) == null);
      }
