...
public class DeprecatedFieldReferences implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    DeprecatedFieldReferencesSpecific customizer = new DeprecatedFieldReferencesSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class DeprecatedFieldReferencesSpecific implements EditorMenuItemCustomizer {
