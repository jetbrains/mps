...
public class ClassifierClassExpression_SmartReference extends SubstituteMenuBase {
  public ClassifierClassExpression_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "ClassifierClassExpression_SmartReference", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "4747359941571310605")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_hqdq8p_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_hqdq8p_a() {
      super(CONCEPTS.ClassifierClassExpression$lN, LINKS.classifier$7Ex9, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "4747359941571310603")));
    }
