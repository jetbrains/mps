...
public class AddParametersToDefaultClassCreatorToCreateClassCreator extends TransformationMenuBase {
  public AddParametersToDefaultClassCreatorToCreateClassCreator() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "AddParametersToDefaultClassCreatorToCreateClassCreator", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "4221915412199422921")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
    ...
    protected void initialize(TransformationMenuContext _context) {
      ...
      constructorsWithParams = new Computable<Iterable<SNode>>() {
        public Iterable<SNode> compute() {
          return Sequence.fromIterable(ClassConcept__BehaviorDescriptor.constructors_id4_LVZ3pCvsd.invoke(SNodeOperations.as(SLinkOperations.getTarget(_context.getNode(), LINKS.classifier$9NRM), CONCEPTS.ClassConcept$bK))).where((it) -> ListSequence.fromList(SLinkOperations.getChildren(it, LINKS.parameter$5xBj)).isNotEmpty());
        }
      }.compute();
    }
    @Override
