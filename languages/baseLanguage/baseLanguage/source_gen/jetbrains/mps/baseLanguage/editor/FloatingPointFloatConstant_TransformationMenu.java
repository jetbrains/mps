...
public class FloatingPointFloatConstant_TransformationMenu extends TransformationMenuBase {
  public FloatingPointFloatConstant_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "FloatingPointFloatConstant", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "6525807733572851617")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM));
  }
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.LEFT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new TMP_Include_ad5a08_a0());
      result.add(new TMP_Group_ad5a08_b0());
    }
    return result;
  }

  public class TMP_Include_ad5a08_a0 extends IncludeTransformationMenuTransformationMenuPart {
    @NotNull
    @Override
    public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
      context.getEditorMenuTrace().pushTraceInfo();
      context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("include " + "named transformation menu " + "binaryOperations_Expression", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "6525807733572851619")));
      try {
  ...
  public class TMP_Group_ad5a08_b0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_ad5a08_b0() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "6525807733572851621")));
    }
    @Override
    protected boolean isApplicable(TransformationMenuContext _context) {
      return SPropertyOperations.getString(_context.getNode(), PROPS.value$kirj).startsWith("-");
    }
    @Override
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new TMP_WrapSM_ad5a08_a1a());
    }
    public class TMP_WrapSM_ad5a08_a1a extends WrapSubstituteMenuTransformationMenuPart {
      @NotNull
      @Override
      public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
        context.getEditorMenuTrace().pushTraceInfo();
        context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("wrap substitute menu " + "named substitute menu " + "NonBinaryExpressions", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "6525807733572851622")));
        try {
          return super.createItems(context);
        } finally {
          context.getEditorMenuTrace().popTraceInfo();
      ...
      protected SubstituteMenuLookup getSubstituteMenuLookup(TransformationMenuContext _context) {
        ...
        return new NamedSubstituteMenuLookup(LanguageRegistry.getInstance(editorContext.getRepository()), conceptToFindMenuFor, "jetbrains.mps.baseLanguage.editor.NonBinaryExpressions");
      }
      ...
      private class SMIasTMI extends SubstituteMenuItemAsActionItem implements SideTransformCompletionActionItem {
        ...
        public void execute(@NotNull String pattern) {
          ...
          SNode m = SNodeFactoryOperations.createNewNode(CONCEPTS.MinusExpression$6V, null);
          SLinkOperations.setTarget(m, LINKS.leftExpression$sEj, createdNode);
          SPropertyOperations.assign(_context.getNode(), PROPS.value$kirj, SPropertyOperations.getString(_context.getNode(), PROPS.value$kirj).substring(1));
          SelectionUtil.selectLabelCellAnSetCaret(_context.getEditorContext(), PrecedenceUtil.processLeftTransform(_context.getNode(), m), SelectionManager.FIRST_ERROR_CELL + "|" + SelectionManager.FOCUS_POLICY_CELL + "|" + SelectionManager.FIRST_EDITABLE_CELL + "|" + SelectionManager.FIRST_CELL, -1);
        }
