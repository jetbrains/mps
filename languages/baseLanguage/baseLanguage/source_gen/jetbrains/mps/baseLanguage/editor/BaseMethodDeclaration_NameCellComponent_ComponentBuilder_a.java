...
/*package*/ class BaseMethodDeclaration_NameCellComponent_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean _StyleParameter_QueryFunction_8989zw_a0a0() {
    return !(SNodeOperations.isInstanceOf(SNodeOperations.getParent(getNode()), CONCEPTS.ClassConcept$bK)) && (boolean) IDeprecatable__BehaviorDescriptor.isDeprecated_idhOwoPtR.invoke(getNode());
  }
  public static class BaseMethodDeclaration_name_postfixCellMenu_8989zw_a0a0 extends AbstractCellMenuPart_PropertyPostfixHints {
    ...
    protected List<String> getPostfixes(SNode node, EditorContext editorContext) {
      List<String> result;
      SNode nodeType = SLinkOperations.getTarget(node, LINKS.returnType$5xoi);
      if (nodeType != null) {
