...
public class Expression_to_type_Cast extends TransformationMenuBase {
  ...
  public class TMP_Group_94hljn_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_94hljn_a0.TMP_Action_94hljn_a0a(), CONCEPTS.CastExpression$$8), new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_94hljn_a0.TMP_Action_94hljn_b0a(), CONCEPTS.CastExpression$$8));
    }
    private class TMP_Action_94hljn_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem, ConstraintsVerifiableActionItem {
        ...
        public void execute(@NotNull String pattern) {
          ...
          if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(result), CONCEPTS.Expression$mB) && !(SNodeOperations.isInstanceOf(SNodeOperations.getParent(result), CONCEPTS.ParenthesizedExpression$Ws))) {
