...
public class DefaultClassCreator_SmartReference extends SubstituteMenuBase {
  public DefaultClassCreator_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "DefaultClassCreator_SmartReference", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "4747359941571310485")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_8tkoyu_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_8tkoyu_a() {
      super(CONCEPTS.DefaultClassCreator$TC, LINKS.classifier$9NRM, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "4747359941571310483")));
    }
