...
public class addSwitchCaseExtension extends TransformationMenuBase {
  public addSwitchCaseExtension() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "addSwitchCaseExtension", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "8572110276177712290")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  private class TMP_Action_5n2rj1_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "8572110276177712674"));
        return this;
      }
      @Nullable
      @Override
