...
public class DeprecatedClassiferReferences implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    DeprecatedClassiferReferencesSpecific customizer = new DeprecatedClassiferReferencesSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class DeprecatedClassiferReferencesSpecific implements EditorMenuItemCustomizer {
