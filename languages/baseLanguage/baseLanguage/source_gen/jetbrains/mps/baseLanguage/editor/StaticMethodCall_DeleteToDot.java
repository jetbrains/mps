...
public class StaticMethodCall_DeleteToDot {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (!(DeletionApproverUtil.approve(editorContext, node, "method"))) {
          SNodeOperations.replaceWithAnother(node, createStaticFieldReference_cnykaw_a0a0a0a0a(QualifiedReference__BehaviorDescriptor.getClassifier_id7S22xyoLQG7.invoke(node)));
        }
      }
  ...
  private static SNode createStaticFieldReference_cnykaw_a0a0a0a0a(SNode p0) {
    SNodeBuilder n0 = new SNodeBuilder().init(CONCEPTS.StaticFieldReference$cU);
    n0.setReferenceTarget(LINKS.classifier$BPY8, p0);
    n0.setReferenceTarget(LINKS.variableDeclaration$N1XG, null);
    return n0.getResult();
  }
