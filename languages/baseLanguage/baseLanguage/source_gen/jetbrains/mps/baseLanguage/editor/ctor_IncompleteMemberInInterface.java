...
public class ctor_IncompleteMemberInInterface extends SubstituteMenuBase {
  ...
  public class SMP_Group_4je5xk_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts() {
      return Arrays.<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>asList(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Group_4je5xk_a.SMP_Action_4je5xk_a0(), CONCEPTS.IncompleteMemberDeclaration$jI), new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Group_4je5xk_a.SMP_Action_4je5xk_b0(), CONCEPTS.IncompleteMemberDeclaration$jI), new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Group_4je5xk_a.SMP_Action_4je5xk_c0(), CONCEPTS.IncompleteMemberDeclaration$jI), new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Group_4je5xk_a.SMP_Wrap_4je5xk_d0(), CONCEPTS.IncompleteMemberDeclaration$jI), new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Group_4je5xk_a.SMP_Wrap_4je5xk_e0(), CONCEPTS.IncompleteMemberDeclaration$jI), new SMP_Group_4je5xk_a.SMP_Include_4je5xk_f0());
    }
