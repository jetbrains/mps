...
public class ClassConceptModifiersExtendsAndImplements extends TransformationMenuBase {
  public ClassConceptModifiersExtendsAndImplements() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "ClassConceptModifiersExtendsAndImplements", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586942964")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM));
  }
  ...
  public class TMP_Group_qsmppp_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_qsmppp_a0() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586942970")));
    }
    @Override
    ...
    private class TMP_Action_qsmppp_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586942980"));
          return this;
        }
        @Nullable
        @Override
  ...
  public class TMP_Group_qsmppp_b0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_qsmppp_b0() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586943006")));
    }
    @Override
    protected boolean isApplicable(TransformationMenuContext _context) {
    ...
    private class TMP_Action_qsmppp_a1a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586943023"));
          return this;
        }
        @Nullable
        @Override
