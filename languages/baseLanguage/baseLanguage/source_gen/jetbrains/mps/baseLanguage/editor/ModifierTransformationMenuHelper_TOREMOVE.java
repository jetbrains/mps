...
public class ModifierTransformationMenuHelper_TOREMOVE extends TransformationMenuBase {
  public ModifierTransformationMenuHelper_TOREMOVE() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "ModifierTransformationMenuHelper_TOREMOVE", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "4125212090855018499")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  public class TMP_Group_r0u7vs_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_r0u7vs_a0() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "4125212090855038323")));
    }
    @Override
