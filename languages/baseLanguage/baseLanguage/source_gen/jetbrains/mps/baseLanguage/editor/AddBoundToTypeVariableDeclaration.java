...
public class AddBoundToTypeVariableDeclaration extends TransformationMenuBase {
  public AddBoundToTypeVariableDeclaration() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "AddBoundToTypeVariableDeclaration", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "4967345845881433048")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  private class TMP_Action_djneue_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "4967345845881433068"));
        return this;
      }
      @Nullable
      @Override
