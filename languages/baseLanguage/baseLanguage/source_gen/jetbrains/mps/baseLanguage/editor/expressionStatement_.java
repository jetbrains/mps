...
public class expressionStatement_ extends SubstituteMenuBase {
  public expressionStatement_() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "expressionStatement_", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586962340")));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Wrap_36p2h0_a(), CONCEPTS.ExpressionStatement$O8));
    return result;
  }

  private class SMP_Wrap_36p2h0_a extends WrapperSubstituteMenuPart {
    private SMP_Wrap_36p2h0_a() {
      super(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "Expression", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586962342")));
    }
    ...
    protected SubstituteMenuItem wrapItem(final SubstituteMenuItem item, final SubstituteMenuContext _context) {
      ...
      return new SubstituteMenuItemWrapper(item, _context) {
        ...
        public SNode createNode(@NotNull String pattern) {
          ...
          SNode result = SNodeFactoryOperations.createNewNode(SNodeOperations.getModel(nodeToWrap), CONCEPTS.ExpressionStatement$O8, null);
          SLinkOperations.setTarget(result, LINKS.expression$5L7M, nodeToWrap);
          return result;
        }
        @Override
