...
public class localVariables extends SubstituteMenuBase {
  public localVariables() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "localVariables", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586960997")));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Wrap_lecwti_a(), CONCEPTS.LocalVariableDeclarationStatement$4w));
    return result;
  }

  private class SMP_Wrap_lecwti_a extends WrapperSubstituteMenuPart {
    private SMP_Wrap_lecwti_a() {
      super(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "LocalVariableDeclaration", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586960999")));
    }
    ...
    protected SubstituteMenuItem wrapItem(final SubstituteMenuItem item, final SubstituteMenuContext _context) {
      ...
      return new SubstituteMenuItemWrapper(item, _context) {
        ...
        public SNode createNode(@NotNull String pattern) {
          ...
          SLinkOperations.setTarget(result, LINKS.localVariableDeclaration$RpjM, nodeToWrap);
          return result;
        }
