...
/*package*/ class StaticMethodCallOperation_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public StaticMethodCallOperation_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private boolean nodeCondition_73omvd_a0a() {
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.staticMethodDeclaration$nfIG);
    ...
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.StaticMethodCallOperation$Uo, "jetbrains.mps.baseLanguage.editor.StaticMethodCallOperation_ApplySideTransforms"));
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink staticMethodDeclaration$nfIG = MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x4ffda504fa5847fcL, 0x4ffda504fa5849afL, "staticMethodDeclaration");
  }
