...
public class ClassConceptModifiersExtendsAndImplements_ext_3 extends TransformationMenuBase {
  public ClassConceptModifiersExtendsAndImplements_ext_3() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "ClassConceptModifiersExtendsAndImplements_ext_3", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586942711")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  public class TMP_Group_52qbso_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_52qbso_a0() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586942717")));
    }
    @Override
    ...
    private class TMP_Action_52qbso_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586942727"));
          return this;
        }
        @Nullable
        @Override
