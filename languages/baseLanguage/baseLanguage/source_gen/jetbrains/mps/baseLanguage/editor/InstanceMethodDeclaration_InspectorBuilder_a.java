...
/*package*/ class InstanceMethodDeclaration_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new annotationListHandler_359zr8_b0(myNode, getEditorContext());
  ...
  private static class annotationListHandler_359zr8_b0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(annotationListHandler_359zr8_b0.this.getNode(), LINKS.annotation$K49I));
      try {
