...
public class tryCatch_CatchClause_DEPRECATED extends TransformationMenuBase {
  public tryCatch_CatchClause_DEPRECATED() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "tryCatch_CatchClause_DEPRECATED", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586945999")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  private class TMP_Action_y08bb7_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586946004"));
        return this;
      }
      @Nullable
      @Override
