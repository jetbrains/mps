...
public class expressionToNotExpression extends TransformationMenuBase {
  ...
  public class TMP_Group_ihw7u4_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_ihw7u4_a0.TMP_Action_ihw7u4_a0a(), CONCEPTS.NotExpression$Pc));
    }
