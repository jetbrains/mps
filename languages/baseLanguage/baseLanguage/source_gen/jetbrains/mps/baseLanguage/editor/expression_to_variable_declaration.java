...
public class expression_to_variable_declaration extends TransformationMenuBase {
  public expression_to_variable_declaration() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "expression_to_variable_declaration", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586945419")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM));
  }
  ...
  public class TMP_Group_7b89ka_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_7b89ka_a0() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586945424")));
    }
    @Override
