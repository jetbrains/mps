...
public class localVariablesWithType extends SubstituteMenuBase {
  ...
  private class SMP_Wrap_rr84hy_a extends WrapperSubstituteMenuPart {
    private SMP_Wrap_rr84hy_a() {
      super(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "Type", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586957762")));
    }
