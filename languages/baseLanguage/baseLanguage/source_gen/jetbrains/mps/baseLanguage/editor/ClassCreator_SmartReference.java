...
public class ClassCreator_SmartReference extends SubstituteMenuBase {
  public ClassCreator_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "ClassCreator_SmartReference", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "4747359941571310563")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_bew3wm_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_bew3wm_a() {
      super(CONCEPTS.ClassCreator$ZG, LINKS.baseMethodDeclaration$pyYw, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "4747359941571310560")));
    }
