...
public class ClassCreator_SmartReference extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_bew3wm_a(), CONCEPTS.ClassCreator$yU));
    return result;
  }
  ...
  public class SMP_ReferenceScope_bew3wm_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_bew3wm_a() {
      ...
      super((SAbstractConcept) CONCEPTS.ClassCreator$yU, LINKS.baseMethodDeclaration$ItxI);
    }
    @NotNull
    @Override
    ...
    protected ReferenceScopeSubstituteMenuItem createItem(SubstituteMenuContext context, SNode referencedNode) {
      return new SMP_ReferenceScope_bew3wm_a.Item(context, referencedNode, getSConcept(), getReferenceLink());
    }
