...
public class VariableReference_SubstituteMenu extends SubstituteMenuBase {
  public VariableReference_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for VariableReference. Generated from implicit smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c895902ca(jetbrains.mps.baseLanguage.structure)", "1068498886296")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_hx33jo_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_hx33jo_a() {
      super(CONCEPTS.VariableReference$TC, LINKS.variableDeclaration$N1XG, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }
  ...
  public class SMP_Subconcepts_hx33jo_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.VariableReference$TC);
    }
