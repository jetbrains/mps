...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase implements EditorHintsProvider {
  ...
  public Collection<EditorMenuItemCustomizer> getEditorMenuItemCustomizers() {
    return Arrays.asList(new EditorMenuItemCustomizer[]{new ReturnStatementStyling(), new VariableReferencePriority(), new BooleanLocalVariable(), new ConceptFunctionParameter_Customization(), new DeprecatedMethodReferences(), new DeprecatedFieldReferences(), new DeprecatedVariableReferences(), new DeprecatedClassiferReferences(), new DeprecatedAbstractClassiferReferences(), new DeprecatedQualifiedReferences()});
  }
