...
public class loopLabelsAndIfStatement extends TransformationMenuBase {
  public loopLabelsAndIfStatement() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "loopLabelsAndIfStatement", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586947573")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.SUBSTITUTE));
  }
