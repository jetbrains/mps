...
public class EnumValueOfExpression_DeleteToDot {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (!(DeletionApproverUtil.approve(editorContext, node, "valueOf"))) {
          SNodeOperations.replaceWithAnother(node, createStaticFieldReference_dac4rl_a0a0a0a0a(QualifiedReference__BehaviorDescriptor.getClassifier_id7S22xyoLQG7.invoke(node)));
        }
      }
  ...
  private static SNode createStaticFieldReference_dac4rl_a0a0a0a0a(SNode p0) {
