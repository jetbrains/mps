...
public class LoopLabelReference_SubstituteMenu extends SubstituteMenuBase {
  public LoopLabelReference_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for LoopLabelReference. Generated from implicit smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c895902ca(jetbrains.mps.baseLanguage.structure)", "363746191845183785")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_6lvr1q_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_6lvr1q_a() {
      super(CONCEPTS.LoopLabelReference$uM, LINKS.loopLabel$tAsM, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_6lvr1q_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_6lvr1q_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "LoopLabelReference", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.LoopLabelReference$uM);
    }
