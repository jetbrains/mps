...
public class assignments extends TransformationMenuBase {
  public assignments() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "assignments", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586946256")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
