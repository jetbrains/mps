...
public class DeprecatedMethodReferences implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    DeprecatedMethodReferencesSpecific customizer = new DeprecatedMethodReferencesSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class DeprecatedMethodReferencesSpecific implements EditorMenuItemCustomizer {
