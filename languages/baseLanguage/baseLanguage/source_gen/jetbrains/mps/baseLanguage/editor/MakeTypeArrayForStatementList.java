...
public class MakeTypeArrayForStatementList extends KeyMapImpl {
  public MakeTypeArrayForStatementList() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new MakeTypeArrayForStatementList_Action0();
    this.putAction("any", "[", action);
    action = new MakeTypeArrayForStatementList_Action1();
    this.putAction("any", "<", action);
  }
  public static class MakeTypeArrayForStatementList_Action0 extends KeyMapActionImpl {
    public MakeTypeArrayForStatementList_Action0() {
    ...
    public boolean canExecute(final EditorContext editorContext) {
      ...
      if (!(SNodeOperations.isInstanceOf(contextNode, CONCEPTS.StatementList$m_))) {
        return false;
      }
  ...
  public static class MakeTypeArrayForStatementList_Action1 extends KeyMapActionImpl {
    public MakeTypeArrayForStatementList_Action1() {
      super.setCaretPolicy(KeyMapAction.CARET_AT_LAST_POSITION);
      this.setShownInPopupMenu(false);
    }
    public String getDescriptionText() {
