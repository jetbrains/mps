...
public class UnresolvedNameReference_SubstituteMenu extends SubstituteMenuBase {
  public UnresolvedNameReference_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "UnresolvedNameReference", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586960014")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_46ekb8_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_46ekb8_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586960016")));
    }
    @Override
    ...
    private class SMP_Wrap_46ekb8_a0 extends WrapperSubstituteMenuPart {
      private SMP_Wrap_46ekb8_a0() {
        super(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "ClassifierType", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586960181")));
      }
