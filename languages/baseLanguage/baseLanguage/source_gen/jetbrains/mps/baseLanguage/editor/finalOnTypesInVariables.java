...
public class finalOnTypesInVariables extends TransformationMenuBase {
  ...
  public class TMP_Group_q2o0d3_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_q2o0d3_a0.TMP_Action_q2o0d3_a0a(), CONCEPTS.VariableDeclaration$Y0));
    }
