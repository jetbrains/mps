...
public class ClassCreator_TransformationMenu extends TransformationMenuBase {
  public ClassCreator_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "ClassCreator", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586945037")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  private class TMP_Action_gpcrwp_a1 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem, ConstraintsVerifiableActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586945047"));
        return this;
      }
      @Nullable
      @Override
      ...
      public void execute(@NotNull String pattern) {
        ...
        ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), LINKS.actualArgument$pzdx)).visitAll((it) -> ListSequence.fromList(SLinkOperations.getChildren(cls, LINKS.actualArgument$pzdx)).addElement(it));
        ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), LINKS.typeParameter$uYiw)).visitAll((it) -> ListSequence.fromList(SLinkOperations.getChildren(cls, LINKS.typeParameter$F9H8)).addElement(it));
