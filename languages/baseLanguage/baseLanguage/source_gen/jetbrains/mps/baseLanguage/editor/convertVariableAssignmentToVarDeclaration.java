...
public class convertVariableAssignmentToVarDeclaration extends TransformationMenuBase {
  public convertVariableAssignmentToVarDeclaration() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "convertVariableAssignmentToVarDeclaration", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586946902")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM));
  }
      ...
      private class TMP_Action_lavomd_a0a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
        ...
        private class Item extends ActionItemBase implements SideTransformCompletionActionItem, ConstraintsVerifiableActionItem {
          ...
          /*package*/ Item resetTraceInfo() {
            updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586946976"));
            return this;
          }
          @Nullable
          @Override
