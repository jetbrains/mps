...
/*package*/ class ParameterDeclaration_InspectorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new annotationListHandler_vsmugd_d0(myNode, getEditorContext());
  ...
  private static class annotationListHandler_vsmugd_d0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(annotationListHandler_vsmugd_d0.this.getNode(), LINKS.annotation$K49I));
      try {
