...
public class DeprecatedQualifiedReferences implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    DeprecatedQualifiedReferencesSpecific customizer = new DeprecatedQualifiedReferencesSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class DeprecatedQualifiedReferencesSpecific implements EditorMenuItemCustomizer {
    ...
    private void customize_(SNode contextNode, EditorMenuItemStyle style, CompletionItemInformation itemInformation) {
      DeprecatedVisualizationnHelper.setDeprecationStyle(itemInformation.getParameterObject(), style);
    }
