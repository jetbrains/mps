...
public class DeprecatedAbstractClassiferReferences implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    DeprecatedAbstractClassiferReferencesSpecific customizer = new DeprecatedAbstractClassiferReferencesSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class DeprecatedAbstractClassiferReferencesSpecific implements EditorMenuItemCustomizer {
