...
public class Expression_wrapWithPassByRef extends TransformationMenuBase {
  public Expression_wrapWithPassByRef() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "Expression_wrapWithPassByRef", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "885351258698154693")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM));
  }
