...
public class expressionstmt_to_returnstms_on_expression extends TransformationMenuBase {
  public expressionstmt_to_returnstms_on_expression() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "expressionstmt_to_returnstms_on_expression", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "6824408471337749984")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  public class TMP_Group_vdgfyi_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_vdgfyi_a0() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "6824408471337749987")));
    }
    @Override
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new TMP_Action_vdgfyi_a0a());
    }
    private class TMP_Action_vdgfyi_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        ...
        try {
          context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase(description, new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "6824408471337749988")));
