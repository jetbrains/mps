...
public class AddSquareBracketsToarrayCreatorWithInitializer extends TransformationMenuBase {
  public AddSquareBracketsToarrayCreatorWithInitializer() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "AddSquareBracketsToarrayCreatorWithInitializer", new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586947522")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  private class TMP_Action_kf6njm_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895902c3(jetbrains.mps.baseLanguage.editor)", "1741258697586947528"));
        return this;
      }
      @Nullable
      @Override
