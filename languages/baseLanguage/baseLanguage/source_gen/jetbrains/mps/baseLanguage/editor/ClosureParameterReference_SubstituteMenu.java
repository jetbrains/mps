...
public class ClosureParameterReference_SubstituteMenu extends SubstituteMenuBase {
  public ClosureParameterReference_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for ClosureParameterReference. Generated from implicit smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c895902ca(jetbrains.mps.baseLanguage.structure)", "1153179560115")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_s9pff1_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_s9pff1_a() {
      super(CONCEPTS.ClosureParameterReference$ES, LINKS.closureParameter$OjY$, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_s9pff1_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_s9pff1_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "ClosureParameterReference", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.ClosureParameterReference$ES);
    }
