...
/*package*/ class InstanceMethodCallOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_jyer24_a0a() {
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.instanceMethodDeclaration$xULU);
    ...
    editorCell.setTransformationMenuLookup(new NamedTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.InstanceMethodCallOperation$uu, "jetbrains.mps.baseLanguage.editor.InstanceMethodCallOperation_ApplySideTransforms"));
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink instanceMethodDeclaration$xULU = MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x118154a6332L, 0x118155506ceL, "instanceMethodDeclaration");
  }
