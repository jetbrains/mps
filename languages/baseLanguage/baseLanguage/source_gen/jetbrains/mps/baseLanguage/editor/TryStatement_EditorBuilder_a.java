...
/*package*/ class TryStatement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new bodySingleRoleHandler_cmnz0s_c0(myNode, LINKS.body$Gg33, getEditorContext());
  ...
  private EditorCell createConstant_2() {
    ...
    editorCell.setTransformationMenuLookup(new DefaultTransformationMenuLookup(LanguageRegistry.getInstance(getEditorContext().getRepository()), CONCEPTS.TryStatement$oi));
    editorCell.setDefaultText("");
  ...
  private static class catchClauseListHandler_cmnz0s_e0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(catchClauseListHandler_cmnz0s_e0.this.getNode(), LINKS.catchClause$l$PD));
      try {
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new finallyBodySingleRoleHandler_cmnz0s_c5a(myNode, LINKS.finallyBody$O1w$, getEditorContext());
    return provider.createCell();
  }
