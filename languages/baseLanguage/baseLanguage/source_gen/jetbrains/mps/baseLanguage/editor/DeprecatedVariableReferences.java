...
public class DeprecatedVariableReferences implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    DeprecatedVariableReferencesSpecific customizer = new DeprecatedVariableReferencesSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class DeprecatedVariableReferencesSpecific implements EditorMenuItemCustomizer {
