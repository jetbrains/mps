...
public class InlineMethodRefactoring {
  ...
  public void addLastReturnStatement(SNode body) {
    ...
    if (SNodeOperations.isInstanceOf(last, CONCEPTS.ExpressionStatement$nm)) {
      SNodeOperations.replaceWithAnother(last, _quotation_createNode_49noxv_a0a0a1a9(SLinkOperations.getTarget(SNodeOperations.cast(last, CONCEPTS.ExpressionStatement$nm), LINKS.expression$qFF0)));
    }
  }
          ...
          if (SNodeOperations.isInstanceOf(callStatement, CONCEPTS.LocalVariableDeclarationStatement$BI)) {
            ListSequence.fromList(SNodeOperations.getNodeDescendants(SNodeOperations.getNodeAncestor(callStatement, CONCEPTS.StatementList$TN, false, false), CONCEPTS.VariableReference$sQ, false, new SAbstractConcept[]{})).where(new IWhereFilter<SNode>() {
              public boolean accept(SNode it) {
                return Objects.equals(SLinkOperations.getTarget(it, LINKS.variableDeclaration$7WwU), SLinkOperations.getTarget(SNodeOperations.cast(callStatement, CONCEPTS.LocalVariableDeclarationStatement$BI), LINKS.localVariableDeclaration$cjR0));
              }
            }).visitAll(new IVisitor<SNode>() {
              public void visit(SNode it) {
                SLinkOperations.setTarget(it, LINKS.variableDeclaration$7WwU, SLinkOperations.getTarget(SNodeOperations.cast(nextStatement, CONCEPTS.LocalVariableDeclarationStatement$BI), LINKS.localVariableDeclaration$cjR0));
              }
            });
          }
        }
