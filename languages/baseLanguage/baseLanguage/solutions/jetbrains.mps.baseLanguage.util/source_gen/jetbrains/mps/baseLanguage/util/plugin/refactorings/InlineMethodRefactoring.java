...
public class InlineMethodRefactoring {
  ...
  public void addLastReturnStatement(SNode body) {
    ...
    if (SNodeOperations.isInstanceOf(last, CONCEPTS.ExpressionStatement$O8)) {
      SNodeOperations.replaceWithAnother(last, _quotation_createNode_49noxv_a0a0a1a9(SLinkOperations.getTarget(SNodeOperations.cast(last, CONCEPTS.ExpressionStatement$O8), LINKS.expression$5L7M)));
    }
  }
    ...
    for (SNode returnStatement : ListSequence.fromList(SNodeOperations.getNodeDescendants(body, CONCEPTS.ReturnStatement$lt, false, new SAbstractConcept[]{}))) {
      ...
      if (returnVar == null) {
        if (returnExpression != null) {
          ...
          if (SNodeOperations.isInstanceOf(callStatement, CONCEPTS.LocalVariableDeclarationStatement$4w)) {
            ListSequence.fromList(SNodeOperations.getNodeDescendants(SNodeOperations.getNodeAncestor(callStatement, CONCEPTS.StatementList$m_, false, false), CONCEPTS.VariableReference$TC, false, new SAbstractConcept[]{})).where(new IWhereFilter<SNode>() {
              public boolean accept(SNode it) {
                return Objects.equals(SLinkOperations.getTarget(it, LINKS.variableDeclaration$N1XG), SLinkOperations.getTarget(SNodeOperations.cast(callStatement, CONCEPTS.LocalVariableDeclarationStatement$4w), LINKS.localVariableDeclaration$RpjM));
              }
            }).visitAll(new IVisitor<SNode>() {
              public void visit(SNode it) {
                SLinkOperations.setTarget(it, LINKS.variableDeclaration$N1XG, SLinkOperations.getTarget(SNodeOperations.cast(nextStatement, CONCEPTS.LocalVariableDeclarationStatement$4w), LINKS.localVariableDeclaration$RpjM));
              }
            });
          }
        }
