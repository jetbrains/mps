...
public class InlineVariableAssignmentRefactoring extends InlineVariableRefactoring {
  ...
  public List<SNode> getNodesToRefactor() {
    ...
    for (ReadInstruction read : SetSequence.fromSet(this.myReadInstructions)) {
      ...
      if (!((SNodeOperations.hasRole(node, LINKS.expression$NMtu) && !(SNodeOperations.isInstanceOf(SNodeOperations.getParent(node), CONCEPTS.UnaryMinus$Uo)))) && !(SNodeOperations.isInstanceOf(node, CONCEPTS.OperationAssignmentExpression$Ue))) {
