...
public class InlineVariableAssignmentRefactoring extends InlineVariableRefactoring {
  ...
  public List<SNode> getNodesToRefactor() {
    ...
    for (ReadInstruction read : SetSequence.fromSet(this.myReadInstructions)) {
      ...
      if (!((SNodeOperations.hasRole(node, LINKS.expression$uRUg) && !(SNodeOperations.isInstanceOf(SNodeOperations.getParent(node), CONCEPTS.UnaryMinus$na)))) && !(SNodeOperations.isInstanceOf(node, CONCEPTS.OperationAssignmentExpression$n0))) {
