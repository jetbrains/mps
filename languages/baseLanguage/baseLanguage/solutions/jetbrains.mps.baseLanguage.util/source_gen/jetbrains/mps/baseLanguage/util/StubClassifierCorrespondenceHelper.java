...
public class StubClassifierCorrespondenceHelper {
  ...
  public SNode findNodeClassifier(final SNode stubClassifier) {
    ...
    SNode generatedAnnotation = ListSequence.fromList(SLinkOperations.getChildren(stubClassifier, LINKS.annotation$4YGW)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return Objects.equals(check_79n3t7_a0a0a0a0a1a3(SLinkOperations.getTarget(it, LINKS.annotation$lXdy)), new SNodePointer("6ed54515-acc8-4d1e-a16c-9fd6cfe951ea/java:jetbrains.mps.annotations(MPS.Core/)", "~GeneratedClass").getNodeId());
      }
    }).first();
    ...
    String nodeParameter = SPropertyOperations.getString(SNodeOperations.as(SLinkOperations.getTarget(ListSequence.fromList(SLinkOperations.getChildren(generatedAnnotation, LINKS.value$NE_P)).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return Objects.equals(check_79n3t7_a0a0a0a0a0a0d0d(SLinkOperations.getTarget(it, LINKS.key$wMU9)), new SNodePointer("6ed54515-acc8-4d1e-a16c-9fd6cfe951ea/java:jetbrains.mps.annotations(MPS.Core/)", "~GeneratedClass.node()").getNodeId());
      }
