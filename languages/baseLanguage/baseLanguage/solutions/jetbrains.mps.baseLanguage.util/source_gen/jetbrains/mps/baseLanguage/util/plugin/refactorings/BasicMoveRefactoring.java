...
@GeneratedClass(node = "r:5f19c5cc-325c-485a-b033-20949d89a6f0(jetbrains.mps.baseLanguage.util.plugin.refactorings)/5142438244426402999", model = "r:5f19c5cc-325c-485a-b033-20949d89a6f0(jetbrains.mps.baseLanguage.util.plugin.refactorings)")
public class BasicMoveRefactoring {
  ...
  public void doRefactoring() {
    ...
    for (SearchResult<SNode> result : ListSequence.fromList(this.myUsages.getSearchResults())) {
      // accomodatefornon-MPSusages(e.g.inplugin)
      // TODO(notsureifit'sagoodsolution)
