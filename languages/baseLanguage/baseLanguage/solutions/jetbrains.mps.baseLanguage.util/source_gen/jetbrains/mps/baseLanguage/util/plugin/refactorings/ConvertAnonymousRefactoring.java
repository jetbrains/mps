...
public class ConvertAnonymousRefactoring {
  ...
  private static SNode createSuperConstructorInvocation_qy1soj_a0b0a0q(SNode node0, Iterable<? extends SNode> seq0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.SuperConstructorInvocation$wU);
    rootBuilder1.setReferenceTarget(LINKS.baseMethodDeclaration$pyYw, node0);
    rootBuilder1.forChild(LINKS.actualArgument$pzdx).initNodeList(seq0, CONCEPTS.Expression$mB);
