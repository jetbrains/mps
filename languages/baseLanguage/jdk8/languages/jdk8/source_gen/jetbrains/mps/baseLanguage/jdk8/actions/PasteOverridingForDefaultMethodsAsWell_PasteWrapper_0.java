...
public final class PasteOverridingForDefaultMethodsAsWell_PasteWrapper_0 implements PasteWrapper {
  ...
  public SNode wrap(SNode sourceNode) {
    ...
    if (SNodeOperations.isInstanceOf(method, CONCEPTS.InstanceMethodDeclaration$39)) {
      ...
      } else if (!(SPropertyOperations.getBoolean(sourceNode, PROPS.isAbstract$qvtK))) {
        SNodeFactoryOperations.addNewChild(method, LINKS.modifiers$F5MM, CONCEPTS.DefaultModifier$PN);
      }
    }
