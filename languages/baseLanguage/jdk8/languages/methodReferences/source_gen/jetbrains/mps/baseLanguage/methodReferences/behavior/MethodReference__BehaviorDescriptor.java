...
public final class MethodReference__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isConstructor_id5DBbMQ1v9ur = new SMethodBuilder<>(Boolean.TYPE).name("isConstructor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6514227258507171739L).languageId(0xb3706f4a983f05b2L, 0xacfc188dd5d64598L).build2();
  public static final SMethod<Boolean> isOperandTypeFirstParameter_id4aYRP41Um04 = new SMethodBuilder<>(Boolean.TYPE).name("isOperandTypeFirstParameter").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4809526991095685124L).languageId(0xb3706f4a983f05b2L, 0xacfc188dd5d64598L).build2();
  public static final SMethod<List<SNode>> getReferencedMethodActualArguments_id4GHzns1UXdE = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getReferencedMethodActualArguments").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5417141469069431658L).languageId(0xb3706f4a983f05b2L, 0xacfc188dd5d64598L).build2();
  public static final SMethod<SNode> getReferencedMethodReturnType_id4GHzns1W2n$ = new SMethodBuilder<>(SNode.class).name("getReferencedMethodReturnType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5417141469069714916L).languageId(0xb3706f4a983f05b2L, 0xacfc188dd5d64598L).build2();
  public static final SMethod<SNode> getInferredTargetType_id6WTbe$J9sKc = new SMethodBuilder<>(SNode.class).name("getInferredTargetType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8014486391912516620L).languageId(0xb3706f4a983f05b2L, 0xacfc188dd5d64598L).build2();
  public static final SMethod<List<SNode>> getActualArguments_id5DBbMQ33xDf = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getTargetMethodActualArguments").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6514227258533485135L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2();
  ...
  public static final SMethod<String> getNameForConstructor_id2Yg2DIzb3El = new SMethodBuilder<>(String.class).name("getNameForConstructor").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3427250980002740885L).languageId(0xa443f952ceaf5816L, 0xf3061a5392264cc5L).build2(SMethodBuilder.createJavaParameter(SNode.class, "constructor"));
