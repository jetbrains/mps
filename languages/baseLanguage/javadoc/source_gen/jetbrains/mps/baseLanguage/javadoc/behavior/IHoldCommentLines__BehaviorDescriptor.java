...
public final class IHoldCommentLines__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> representLinesAsText_id2pw9ZXKQIYx = new SMethodBuilder<>(String.class).name("representLinesAsText").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2765254149269024673L).languageId(0xbb1b463a8781b786L, 0xf280165065d5424eL).build2();
