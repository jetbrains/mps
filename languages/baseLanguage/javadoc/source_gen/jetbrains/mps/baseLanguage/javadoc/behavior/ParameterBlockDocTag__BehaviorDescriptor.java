...
public final class ParameterBlockDocTag__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf280165065d5424eL, 0xbb1b463a8781b786L, 0x757ba20a4c905f8aL, "jetbrains.mps.baseLanguage.javadoc.structure.ParameterBlockDocTag");
  ...
  /*package*/ static void appendText_id2pw9ZXKThR2(@NotNull SNode __thisNode__, String text) {
    SPropertyOperations.assign(__thisNode__, PROPS.text$99vK, SPropertyOperations.getString(__thisNode__, PROPS.text$99vK) + "\n" + text);
  }

  /*package*/ ParameterBlockDocTag__BehaviorDescriptor() {
  }
