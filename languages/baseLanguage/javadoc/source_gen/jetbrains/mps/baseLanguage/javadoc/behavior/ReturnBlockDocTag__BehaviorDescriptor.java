...
public final class ReturnBlockDocTag__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf280165065d5424eL, 0xbb1b463a8781b786L, 0x514c0f687050918eL, "jetbrains.mps.baseLanguage.javadoc.structure.ReturnBlockDocTag");
  ...
  /*package*/ static void appendText_id2pw9ZXKThR2(@NotNull SNode __thisNode__, String text) {
    SPropertyOperations.assign(__thisNode__, PROPS.text$eo0d, SPropertyOperations.getString(__thisNode__, PROPS.text$eo0d) + "\n" + text);
  }

  /*package*/ ReturnBlockDocTag__BehaviorDescriptor() {
  }
