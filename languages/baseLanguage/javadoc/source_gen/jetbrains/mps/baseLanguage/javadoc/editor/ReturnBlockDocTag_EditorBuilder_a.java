...
/*package*/ class ReturnBlockDocTag_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    if (nodeCondition_eiwgw6_a2a()) {
      editorCell.addEditorCell(createConstant_1());
    }
    if (nodeCondition_eiwgw6_a3a()) {
      editorCell.addEditorCell(createProperty_0());
    }
    return editorCell;
  }
  private boolean nodeCondition_eiwgw6_a2a() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.commentBody$sIzh)).isEmpty() && isNotEmptyString(SPropertyOperations.getString(myNode, PROPS.text$eo0d));
  }
  private boolean nodeCondition_eiwgw6_a3a() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.commentBody$sIzh)).isEmpty() && isNotEmptyString(SPropertyOperations.getString(myNode, PROPS.text$eo0d));
  }
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new commentBodyListHandler_eiwgw6_b0(myNode, getEditorContext());
  ...
  private static class commentBodyListHandler_eiwgw6_b0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public commentBodyListHandler_eiwgw6_b0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(commentBodyListHandler_eiwgw6_b0.this.getNode(), LINKS.commentBody$sIzh));
      try {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_eiwgw6_c0");
    editorCell.setDefaultText("");
    return editorCell;
  }
  private EditorCell createProperty_0() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.text$eo0d;
