...
public final class BaseBlockDocTag__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> appendTextLine_id2pw9ZXKThR2 = new SMethodBuilder<>(Void.TYPE).name("appendTextLine").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2765254149269691842L).languageId(0xbb1b463a8781b786L, 0xf280165065d5424eL).build2(SMethodBuilder.createJavaParameter(String.class, "text"));
