...
public class CodeSnippetTextElement_Constraints extends BaseConstraintsDescriptor {
  /*package*/ CodeSnippetTextElement_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.CodeSnippetTextElement$I3, initContext);
  ...
  private static final SNodePointer canBeChildBreakingPoint = new SNodePointer("r:28bcf003-0004-46b6-9fe7-2093e7fb1368(jetbrains.mps.baseLanguage.javadoc.constraints)", "7134894838729631444");
