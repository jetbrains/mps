...
public class DocTypeParameterReference_SubstituteMenu extends SubstituteMenuBase {
  public DocTypeParameterReference_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "DocTypeParameterReference", new SNodePointer("r:87ed07dc-bdb2-44c5-8db4-8d5a74e959ff(jetbrains.mps.baseLanguage.javadoc.editor)", "9049866855250945543")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_jz6j6a_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_jz6j6a_a() {
      super(CONCEPTS.DocTypeParameterReference$Qk, LINKS.param$eUNL, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:87ed07dc-bdb2-44c5-8db4-8d5a74e959ff(jetbrains.mps.baseLanguage.javadoc.editor)", "9049866855250945685")));
    }
