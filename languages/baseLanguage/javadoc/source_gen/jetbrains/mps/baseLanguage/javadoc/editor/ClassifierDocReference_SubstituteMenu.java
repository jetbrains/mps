...
public class ClassifierDocReference_SubstituteMenu extends SubstituteMenuBase {
  public ClassifierDocReference_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "ClassifierDocReference", new SNodePointer("r:87ed07dc-bdb2-44c5-8db4-8d5a74e959ff(jetbrains.mps.baseLanguage.javadoc.editor)", "8454525179034394472")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_qz15z6_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_qz15z6_a() {
      super(CONCEPTS.ClassifierDocReference$$o, LINKS.classifier$AhRH, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:87ed07dc-bdb2-44c5-8db4-8d5a74e959ff(jetbrains.mps.baseLanguage.javadoc.editor)", "8454525179034394500")));
    }
