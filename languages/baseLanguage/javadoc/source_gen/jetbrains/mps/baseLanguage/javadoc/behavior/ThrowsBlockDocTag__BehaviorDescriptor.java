...
public final class ThrowsBlockDocTag__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf280165065d5424eL, 0xbb1b463a8781b786L, 0x514c0f68704ec270L, "jetbrains.mps.baseLanguage.javadoc.structure.ThrowsBlockDocTag");
  ...
  /*package*/ static void appendText_id2pw9ZXKThR2(@NotNull SNode __thisNode__, String text) {
    SPropertyOperations.assign(__thisNode__, PROPS.text$w_DI, SPropertyOperations.getString(__thisNode__, PROPS.text$w_DI) + "\n" + text);
  }

  /*package*/ ThrowsBlockDocTag__BehaviorDescriptor() {
  }
