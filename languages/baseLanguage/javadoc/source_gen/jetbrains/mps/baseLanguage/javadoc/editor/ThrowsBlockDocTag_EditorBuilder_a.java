...
/*package*/ class ThrowsBlockDocTag_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_0() {
    ...
    if (nodeCondition_fp467p_a3a()) {
      editorCell.addEditorCell(createConstant_1());
    }
    if (nodeCondition_fp467p_a4a()) {
      editorCell.addEditorCell(createProperty_0());
    }
    return editorCell;
  }
  private boolean nodeCondition_fp467p_a3a() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.commentBody$sIzh)).isEmpty() && isNotEmptyString(SPropertyOperations.getString(myNode, PROPS.text$w_DI));
  }
  private boolean nodeCondition_fp467p_a4a() {
    return ListSequence.fromList(SLinkOperations.getChildren(myNode, LINKS.commentBody$sIzh)).isEmpty() && isNotEmptyString(SPropertyOperations.getString(myNode, PROPS.text$w_DI));
  }
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new commentBodyListHandler_fp467p_c0(myNode, getEditorContext());
  ...
  private static class commentBodyListHandler_fp467p_c0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public commentBodyListHandler_fp467p_c0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(commentBodyListHandler_fp467p_c0.this.getNode(), LINKS.commentBody$sIzh));
      try {
  ...
  private EditorCell createConstant_1() {
    ...
    editorCell.setCellId("Constant_fp467p_d0");
    editorCell.setDefaultText("");
    return editorCell;
  }
