...
public final class BaseDocComment__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> hasTags_id4iGwz$GSfd_ = new SMethodBuilder<>(Boolean.TYPE).name("hasTags").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4948473272651019109L).languageId(0xbb1b463a8781b786L, 0xf280165065d5424eL).build2();
