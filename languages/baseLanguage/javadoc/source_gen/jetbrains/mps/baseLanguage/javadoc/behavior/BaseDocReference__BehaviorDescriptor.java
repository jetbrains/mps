...
public final class BaseDocReference__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getFQNameInContext_idM5aELaKhPF = new SMethodBuilder<>(String.class).name("getFQNameInContext").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(902174219834563947L).languageId(0xbb1b463a8781b786L, 0xf280165065d5424eL).build2(SMethodBuilder.createJavaParameter(SNode.class, "classifier"));
  public static final SMethod<String> getFQNameInContextIgnoreSameClassifier_idM5aELaQ3fi = new SMethodBuilder<>(String.class).name("getFQNameInContextIgnoreSameClassifier").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(902174219836077010L).languageId(0xbb1b463a8781b786L, 0xf280165065d5424eL).build2(SMethodBuilder.createJavaParameter(SNode.class, "classifier"));
