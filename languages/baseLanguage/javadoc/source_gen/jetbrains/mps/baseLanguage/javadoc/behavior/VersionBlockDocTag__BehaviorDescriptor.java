...
public final class VersionBlockDocTag__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0xf280165065d5424eL, 0xbb1b463a8781b786L, 0x757ba20a4c87dda0L, "jetbrains.mps.baseLanguage.javadoc.structure.VersionBlockDocTag");
  ...
  /*package*/ static void appendText_id2pw9ZXKThR2(@NotNull SNode __thisNode__, String text) {
    SPropertyOperations.assign(__thisNode__, PROPS.text$$fSd, SPropertyOperations.getString(__thisNode__, PROPS.text$$fSd) + "\n" + text);
  }

  /*package*/ VersionBlockDocTag__BehaviorDescriptor() {
  }
