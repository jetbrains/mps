...
public class addCtorIncompleteFromModifier extends SubstituteMenuBase {
  public addCtorIncompleteFromModifier() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "named substitute menu " + "ctor_IncompleteFromModifier", new SNodePointer("r:fc8d3ef4-4153-4861-a13a-e9c4b97a4b06(jetbrains.mps.baseLanguage.doubleDispatch.editor)", "8727913099382245291")));
  }
  @NotNull
  @Override
    ...
    private class SMP_Action_oxmga2_a0 extends SingleItemSubstituteMenuPart {
      ...
      private class Item extends DefaultSubstituteMenuItem {
        ...
        /*package*/ void resetTraceInfo() {
          ...
          updateTraceInfo(description, new SNodePointer("r:fc8d3ef4-4153-4861-a13a-e9c4b97a4b06(jetbrains.mps.baseLanguage.doubleDispatch.editor)", "8727913099384214386"));
        }
        ...
        public SNode createNode(@NotNull String pattern) {
          ...
          ListSequence.fromList(SLinkOperations.getChildren(decl, LINKS.modifiers$F5MM)).addElement(SNodeFactoryOperations.createNewNode(CONCEPTS.DispatchModifier$PK, null));
          return decl;
        }
        ...
        public String getMatchingText(@NotNull String pattern) {
          return SConceptOperations.conceptAlias(CONCEPTS.DispatchModifier$PK);
        }
      }
    }
  }
