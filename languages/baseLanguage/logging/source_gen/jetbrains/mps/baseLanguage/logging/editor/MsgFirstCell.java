...
public class MsgFirstCell extends TransformationMenuBase {
  public MsgFirstCell() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "MsgFirstCell", new SNodePointer("r:00000000-0000-4000-0000-011c8959057d(jetbrains.mps.baseLanguage.logging.editor)", "6057591418743177400")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
