...
public class ReplaceLogWithMessage extends SubstituteMenuBase {
  public ReplaceLogWithMessage() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "ReplaceLogWithMessage", new SNodePointer("r:00000000-0000-4000-0000-011c8959057d(jetbrains.mps.baseLanguage.logging.editor)", "6057591418743074346")));
  }
  @NotNull
  @Override
