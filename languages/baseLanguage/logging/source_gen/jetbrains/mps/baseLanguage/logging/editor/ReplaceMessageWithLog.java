...
public class ReplaceMessageWithLog extends SubstituteMenuBase {
  public ReplaceMessageWithLog() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "ReplaceMessageWithLog", new SNodePointer("r:00000000-0000-4000-0000-011c8959057d(jetbrains.mps.baseLanguage.logging.editor)", "6057591418743177426")));
  }
  @NotNull
  @Override
