...
<solution name="jetbrains.mps.baseLanguage.references.runtime" uuid="52b81ac7-93fd-4e9e-b972-4995882da6d4" moduleVersion="0">
  <compileInIDEA />
  <models>
  ...
  <facets>
    <facet type="java" compile="ext" classes="provided" ext="no">
      ...
      <library location="${mps_home}/lib/mps-references.jar" />
    </facet>
  </facets>
  <dependencies>
