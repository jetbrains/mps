...
public class checkedDotExpression_Contribution extends TransformationMenuBase {
  ...
  public class TMP_Group_y6cflm_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_y6cflm_a0.TMP_Action_y6cflm_a0a(), CONCEPTS.CheckedDotExpression$Du));
    }
