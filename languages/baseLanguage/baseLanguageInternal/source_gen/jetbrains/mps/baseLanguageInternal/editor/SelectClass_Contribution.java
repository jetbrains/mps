...
public class SelectClass_Contribution extends SubstituteMenuBase {
  public SelectClass_Contribution() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Expression", new SNodePointer("r:00000000-0000-4000-0000-011c895903aa(jetbrains.mps.baseLanguageInternal.editor)", "1741258697587170897")));
  }
  @NotNull
  @Override
