...
public class ExtractStaticInnerClassCreator_SmartReference extends SubstituteMenuBase {
  public ExtractStaticInnerClassCreator_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "ExtractStaticInnerClassCreator_SmartReference", new SNodePointer("r:00000000-0000-4000-0000-011c895903aa(jetbrains.mps.baseLanguageInternal.editor)", "4747359941571311163")));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_369k9v_a(), CONCEPTS.ExtractStaticInnerClassCreator$tF));
    return result;
  }
  ...
  public class SMP_ReferenceScope_369k9v_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_369k9v_a() {
      super(CONCEPTS.ExtractStaticInnerClassCreator$tF, LINKS.baseMethodDeclaration$pyYw, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c895903aa(jetbrains.mps.baseLanguageInternal.editor)", "4747359941571311160")));
    }
