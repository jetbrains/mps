...
public class ExtractToConstantRefExpression_SmartReference extends SubstituteMenuBase {
  public ExtractToConstantRefExpression_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "ExtractToConstantRefExpression_SmartReference", new SNodePointer("r:00000000-0000-4000-0000-011c895903aa(jetbrains.mps.baseLanguageInternal.editor)", "4747359941571311085")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_ultiz_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_ultiz_a() {
      super(CONCEPTS.ExtractToConstantRefExpression$H7, LINKS.original$Wri, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c895903aa(jetbrains.mps.baseLanguageInternal.editor)", "4747359941571311083")));
    }
