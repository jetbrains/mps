...
/*package*/ class InternalClassifierType_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    ...
    new SquareBracketStyleClass(this).apply(style, editorCell);
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.fqClassName$SoJd;
  ...
  private static class parameterListHandler_7zoim2_g0a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(parameterListHandler_7zoim2_g0a.this.getNode(), LINKS.parameter$oqG$));
      try {
  ...
  private static final class PROPS {
    /*package*/ static final SProperty fqClassName$SoJd = MetaAdapterFactory.getProperty(0xdf345b11b8c74213L, 0xac6648d2a9b75d88L, 0x1118e558c6dL, 0x1118e56212bL, "fqClassName");
