...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForNamedTupleDeclaration() {
    ...
    // extends: jetbrains.mps.baseLanguage.structure.Classifier
    b.super_(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101d9d3ca30L);
  ...
  private static ConceptDescriptor createDescriptorForNamedTupleType() {
    ...
    b.version(3);
    b.associate("tupleDeclaration", 0x12099dc8a6aL).target(0xa247e09e243545baL, 0xb8d207e93feba96aL, 0x1208fa48aa5L).optional(false).origin("1239531948650").specialize(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL).done();
    b.aggregate("parameterType", 0x1209ada0e2bL).target(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506dL).optional(true).ordered(true).multiple(true).origin("1239548562987").specialize(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x102419671abL).done();
    b.kind(ConceptKind.INTERFACE, StaticScope.NONE);
    return b.create();
  }
}
