  ...
  public void build(final DataFlowBuilderContext _context) {
    if (_context.getNode() == SLinkOperations.getTarget(SNodeOperations.as(SNodeOperations.getParent(_context.getNode()), CONCEPTS.BaseAssignmentExpression$PA), LINKS.lValue$splI)) {
      for (SNode mbr : SLinkOperations.getChildren(_context.getNode(), LINKS.component$uznI)) {
        if (SNodeOperations.isInstanceOf(mbr, CONCEPTS.VariableReference$TC)) {
        ...
        if (SNodeOperations.isInstanceOf(mbr, CONCEPTS.LocalVariableDeclarationInTuple$Gg)) {
        ...
        if (SNodeOperations.isInstanceOf(mbr, CONCEPTS.DotExpression$yW)) {
          _context.getBuilder().emitWrite(SLinkOperations.getTarget(SNodeOperations.as(mbr, CONCEPTS.DotExpression$yW), LINKS.operation$gs9E), SLinkOperations.getTarget(SNodeOperations.as(SNodeOperations.getParent(_context.getNode()), CONCEPTS.BaseAssignmentExpression$PA), LINKS.rValue$spNK), "r:584f574a-ff70-48d8-8e32-f847d7f18b78(jetbrains.mps.baseLanguage.tuples.dataFlow)/8093601809672940793");
        }
      }
    } else {
      for (SNode mbr : SLinkOperations.getChildren(_context.getNode(), LINKS.component$uznI)) {
