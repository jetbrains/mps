...
public class tuple_member_access_Contribution extends TransformationMenuBase {
  ...
  public class TMP_Group_dlrmni_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_dlrmni_a0.TMP_Action_dlrmni_a0a(), CONCEPTS.IndexedTupleMemberAccessExpression$i7));
    }
