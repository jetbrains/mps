...
public class TypesystemDescriptor extends BaseHelginsDescriptor {
  public TypesystemDescriptor() {
    ...
    {
      InferenceRule_Runtime inferenceRule = new typeof_LocalVariableDeclarationInTuple_InferenceRule();
      this.myInferenceRules.add(inferenceRule);
    }
    {
    ...
    {
      NonTypesystemRule_Runtime nonTypesystemRule = new GenericTupleArrayWithInit_NonTypesystemRule();
      this.myNonTypesystemRules.add(nonTypesystemRule);
    }
    {
      NonTypesystemRule_Runtime nonTypesystemRule = new GenericTupleTupleArray_NonTypesystemRule();
      this.myNonTypesystemRules.add(nonTypesystemRule);
    }
    {
    ...
    {
      SubtypingRule_Runtime subtypingRule = new Dictionary_supertypeOf_namedTupleType_SubtypingRule();
    ...
    {
      SubtypingRule_Runtime subtypingRule = new namedTupleDeclaration_ClassifierType_subtypeOf_namedTupleType_SubtypingRule();
      this.mySubtypingRules.add(subtypingRule);
    }
    {
    ...
    {
      ComparisonRule_Runtime comparisonRule = new comparable_IndexedTupleType_Object_ComparisonRule();
      this.myComparisonRules.add(comparisonRule);
    }
    {
      ComparisonRule_Runtime comparisonRule = new comparable_NamedTupleType_Object_ComparisonRule();
      this.myComparisonRules.add(comparisonRule);
    }
    {
