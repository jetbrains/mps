...
public final class NamedTupleDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<SNode>> allExtends_id2ItBWjOSZqc = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("allExtends").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3142843783245461132L).languageId(0xb8d207e93feba96aL, 0xa247e09e243545baL).build2();
  ...
  public static final SMethod<Void> markLoadedNodeAsDeprecated_id5H8W9_ECA0g = new SMethodBuilder<>(Void.TYPE).name("markLoadedNodeAsDeprecated").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6577771797484298256L).languageId(0xb8d207e93feba96aL, 0xa247e09e243545baL).build2(SMethodBuilder.createJavaParameter(SNode.class, "node"));
  ...
  /*package*/ static void enumerateMembers_id65_8Gi2s6iV(@NotNull SNode __thisNode__, ClassifierHierarchyVisitor visitor) {
    for (SNode method : SLinkOperations.getChildren(__thisNode__, LINKS.member$L_2d)) {
