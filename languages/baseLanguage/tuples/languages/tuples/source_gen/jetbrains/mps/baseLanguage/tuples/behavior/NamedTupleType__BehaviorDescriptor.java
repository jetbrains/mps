...
public final class NamedTupleType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getLeftBracket_id1653mnvAgn0 = new SMethodBuilder<>(String.class).name("getLeftBracket").modifiers(9, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1262430001741497792L).languageId(0xb8d207e93feba96aL, 0xa247e09e243545baL).build2();
  public static final SMethod<String> getRightBracket_id1653mnvAgq6 = new SMethodBuilder<>(String.class).name("getRightBracket").modifiers(9, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1262430001741497990L).languageId(0xb8d207e93feba96aL, 0xa247e09e243545baL).build2();
  ...
  /*package*/ static String getPresentation_idhEwIMiw(@NotNull SNode __thisNode__) {
    ...
    String sep = "";
    for (SNode ntcd : ListSequence.fromList(NamedTupleDeclaration__BehaviorDescriptor.allExtends_id2ItBWjOSZqc.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.classifier$cxMr))).reversedList().translate((ntd) -> SLinkOperations.getChildren(ntd, LINKS.component$wCHx))) {
      sb.append(sep).append(BaseConcept__BehaviorDescriptor.getPresentation_idhEwIMiw.invoke(SLinkOperations.getTarget(ntcd, LINKS.type$q$C9))).append(" ").append(SPropertyOperations.getString(ntcd, PROPS.name$MnvL));
      sep = ", ";
    }
    sb.append(NamedTupleType__BehaviorDescriptor.getRightBracket_id1653mnvAgq6.invoke(SNodeOperations.asSConcept(SNodeOperations.getConcept(__thisNode__)))).append(" ").append(SPropertyOperations.getString(SLinkOperations.getTarget(__thisNode__, LINKS.classifier$cxMr), PROPS.name$MnvL));
    sep = "<";
    String suffix = "";
    for (SNode t : SLinkOperations.getChildren(__thisNode__, LINKS.parameter$oqG$)) {
