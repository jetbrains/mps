...
/*package*/ class CustomConstructorContainer_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new constructorsListHandler_9w29gq_a2a(myNode, getEditorContext());
  ...
  private static class constructorsListHandler_9w29gq_a2a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.constructors$eNfl;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.CustomConstructor$j9;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(constructorsListHandler_9w29gq_a2a.this.getNode(), LINKS.constructors$eNfl));
      try {
