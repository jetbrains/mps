...
public final class ParameterDescriptor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static SNode create_id2h59CdJp99Y(@NotNull SNode __thisNode__, SNode point) {
    return createMethodParameterInstance_e87i4c_a0a0(__thisNode__, (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(__thisNode__, LINKS.type$fC91), CONCEPTS.DependentTypeDescriptor$1L) ? DependentTypeDescriptor__BehaviorDescriptor.create_id2h59CdJp8nr.invoke(SNodeOperations.cast(SLinkOperations.getTarget(__thisNode__, LINKS.type$fC91), CONCEPTS.DependentTypeDescriptor$1L), point) : SNodeOperations.copyNode(SLinkOperations.getTarget(__thisNode__, LINKS.type$fC91))), SPropertyOperations.getString(__thisNode__, PROPS.name$lA7v));
  }
  ...
  /*package*/ static String getGeneratedMethodName_id7GXvAHO1heb(@NotNull SNode __thisNode__) {
    return SPropertyOperations.getString(SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.MethodDescriptor$hh, false, false), PROPS.name$lA7v) + "_" + SPropertyOperations.getString(SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.ParameterDescriptor$fO, false, false), PROPS.name$lA7v) + "_opt";
  }
  ...
  private static SNode createMethodParameterInstance_e87i4c_a0a0(SNode node0, SNode node1, Object p0) {
    ...
    rootBuilder1.setReferenceTarget(LINKS.decl$hLc5, node0);
    rootBuilder1.forChild(LINKS.type$uWuc).initNode(node1, CONCEPTS.Type$IG, true);
