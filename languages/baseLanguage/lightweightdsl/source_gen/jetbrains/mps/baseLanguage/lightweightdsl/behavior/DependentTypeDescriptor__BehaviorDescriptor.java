...
public final class DependentTypeDescriptor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static SNode createDependentTypeInstance_anu5lw_a0a0(SNode node0, SNode node1) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.DependentTypeInstance$N9);
    rootBuilder1.setReferenceTarget(LINKS.decl$HI1L, node0);
    rootBuilder1.setReferenceTarget(LINKS.point$7bUg, node1);
