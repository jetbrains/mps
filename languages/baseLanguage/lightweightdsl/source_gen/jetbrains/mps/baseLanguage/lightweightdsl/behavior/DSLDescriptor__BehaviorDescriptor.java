...
public final class DSLDescriptor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> initializeInstance_id2VRROcY8CaS = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("initializeInstance").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3384419124890469048L).languageId(0xbc73f2e16994cc67L, 0xc7d5b9dda05f4be2L).build2(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""), SMethodBuilder.createJavaParameter((Class<SModel>) ((Class) Object.class), ""));
