...
public class typeof_DepType_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode depType, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    if (!(typeCheckingContext.isSingleTypeComputation())) {
      {
        SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(depType, LINKS.getter$HURw);
  ...
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.DependentTypeDescriptor$1L;
  }
  ...
  private static SNode _quotation_createNode_nexsxk_a1a0c0a0a0b() {
    ...
    quotedNode_1 = new SNodeBuilder(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xfd3920347849419dL, 0x907112563d152375L, "jetbrains.mps.baseLanguage.closures"), 0x1174a4d19ffL, "FunctionType"), null, null).node();
