...
public final class DependentTypeInstance__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getMyType_id7T23sO8yx5P = new SMethodBuilder<>(SNode.class).name("getMyType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9097849371504546165L).languageId(0xbc73f2e16994cc67L, 0xc7d5b9dda05f4be2L).build2();
