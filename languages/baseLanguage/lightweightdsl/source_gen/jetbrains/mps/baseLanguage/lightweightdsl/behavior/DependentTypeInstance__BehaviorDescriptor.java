...
public final class DependentTypeInstance__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getMyType_id7T23sO8yx5P = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getMyType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("7T23sO8yx5P").build();
