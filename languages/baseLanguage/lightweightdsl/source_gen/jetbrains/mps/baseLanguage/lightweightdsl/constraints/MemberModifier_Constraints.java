...
public class MemberModifier_Constraints extends BaseConstraintsDescriptor {
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    return Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(SNodeOperations.getNodeAncestor(parentNode, CONCEPTS.DSLClassMember$rT, true, false), LINKS.modifier$xlAc), SNodeOperations.asSConcept(SNodeOperations.asSConcept(childConcept)))).count() < 2;
  }
