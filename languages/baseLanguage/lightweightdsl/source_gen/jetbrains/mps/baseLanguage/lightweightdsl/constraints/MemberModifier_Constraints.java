...
public class MemberModifier_Constraints extends BaseConstraintsDescriptor {
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    return Sequence.fromIterable(SNodeOperations.ofConcept(SLinkOperations.getChildren(SNodeOperations.getNodeAncestor(parentNode, CONCEPTS.DSLClassMember$68, true, false), LINKS.modifier$3mgr), SNodeOperations.asSConcept(SNodeOperations.asSConcept(childConcept)))).count() < 2;
  }
