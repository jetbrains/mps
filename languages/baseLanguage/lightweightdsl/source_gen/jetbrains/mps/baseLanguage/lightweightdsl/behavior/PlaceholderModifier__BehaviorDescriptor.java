...
public final class PlaceholderModifier__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> create_id7T23sO8tTvX = new SMethodBuilder<>(SNode.class).name("create").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9097849371503335421L).languageId(0xbc73f2e16994cc67L, 0xc7d5b9dda05f4be2L).build2();
