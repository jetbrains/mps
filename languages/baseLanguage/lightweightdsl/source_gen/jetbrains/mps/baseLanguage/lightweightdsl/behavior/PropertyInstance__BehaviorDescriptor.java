...
public final class PropertyInstance__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getValueExpression_id3m06Jgserfw = new SMethodBuilder<>(SNode.class).name("getValueExpression").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3855110916777030624L).languageId(0xbc73f2e16994cc67L, 0xc7d5b9dda05f4be2L).build2();
