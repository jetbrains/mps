...
public class typeof_BinaryOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
            ...
            typeCheckingContext.whenConcrete(rType, new Runnable() {
              public void run() {
                ...
                final SNode sequenceType_typevar_1184848409899 = typeCheckingContext.createNewRuntimeTypesVariable();
                {
                  ...
                  typeCheckingContext.createEquation((SNode) typeCheckingContext.getRepresentative(sequenceType_typevar_1184848409899), (SNode) _quotation_createNode_nog713_a1a0c0c0a0a1a0b0a0a0a1a0b0c0b(typeCheckingContext.getRepresentative(elementType_typevar_1184848397564)), _info_12389875345);
                }
                {
                  SNode _nodeToCheck_1029348928467 = op;
  ...
  private static SNode _quotation_createNode_nog713_a1a0c0c0a0a1a0b0a0a0a1a0b0c0b(Object parameter_1) {
