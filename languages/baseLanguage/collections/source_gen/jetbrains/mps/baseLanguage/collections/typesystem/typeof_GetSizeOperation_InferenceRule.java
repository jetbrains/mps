...
public class typeof_GetSizeOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode op, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    final SNode elementType_typevar_1184847379888 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) _quotation_createNode_jdnuju_a0a0c0c0b(typeCheckingContext.getRepresentative(elementType_typevar_1184847379888)), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1184847389619", true), false, true, _info_12389875345);
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1184847365040", true), (SNode) _quotation_createNode_jdnuju_a1a0c0d0b(), _info_12389875345);
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.GetSizeOperation$oi;
  }
  ...
  private static SNode _quotation_createNode_jdnuju_a0a0c0c0b(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_jdnuju_a1a0c0d0b() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
