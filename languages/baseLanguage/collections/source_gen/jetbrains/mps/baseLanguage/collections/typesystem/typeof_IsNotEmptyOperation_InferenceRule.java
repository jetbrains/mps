...
public class typeof_IsNotEmptyOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
      ...
      SNode matchedNode_rn73y2_a0 = SNodeOperations.getParent(op);
      {
        boolean matches_rn73y2_a0a = false;
        {
          ...
          if (matchingNode_rn73y2_a0a != null) {
            matches_rn73y2_a0a = matchingNode_rn73y2_a0a.getConcept().isSubConceptOf(CONCEPTS.DotExpression$6a);
          }
        }
        if (matches_rn73y2_a0a) {
          {
            ...
            typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1219443359861", true), (SNode) _quotation_createNode_30ohwl_a1a0c0a0a0c0b0a0b(), _info_12389875345);
          }
        } else {
          {
  ...
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.IsNotEmptyOperation$5y;
  }
  ...
  private static SNode _quotation_createNode_30ohwl_a1a0c0a0a0c0b0a0b() {
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept IsNotEmptyOperation$5y = MetaAdapterFactory.getConcept(0x8388864671ce4f1cL, 0x9c53c54016f6ad4fL, 0x111ecf423b7L, "jetbrains.mps.baseLanguage.collections.structure.IsNotEmptyOperation");
  }
}
