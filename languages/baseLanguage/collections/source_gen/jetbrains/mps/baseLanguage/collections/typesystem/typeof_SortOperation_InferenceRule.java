...
public class typeof_SortOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode so, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
...

    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1205680514461", true), (SNode) _quotation_createNode_6zmwfs_a1a0c0e0b(typeCheckingContext.getRepresentative(paramType_typevar_1205680579640), typeCheckingContext.getRepresentative(returnType_typevar_6642338866061368355)), false, true, _info_12389875345);
    }
    if (!(typeCheckingContext.isSingleTypeComputation())) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.getRepresentative(returnType_typevar_6642338866061368355), (SNode) _quotation_createNode_6zmwfs_a1a0c0a0f0b(), true, true, _info_12389875345);
      }
    }
    // todo: unmeet closure
    if (!(typeCheckingContext.isSingleTypeComputation())) {
      {
        ...
        typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1205680791173", true), (SNode) _quotation_createNode_6zmwfs_a1a0c0a0h0b(), true, true, _info_12389875345);
      }
    }

    // FIXME: conflict resolution: prefer changes from bugfix branch
  ...
  private static SNode _quotation_createNode_6zmwfs_a1a0c0e0b(Object parameter_1, Object parameter_2) {
    SNode quotedNode_3 = null;
  ...
  private static SNode _quotation_createNode_6zmwfs_a1a0c0a0f0b() {
  ...
  private static SNode _quotation_createNode_6zmwfs_a1a0c0a0h0b() {
    SNode quotedNode_1 = null;
