...
public final class StackType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<SNode> getAbstractCreators_id6A07P3f4z36(@NotNull SNode __thisNode__, SModel targetModel) {
    ...
    ListSequence.fromList(res).addElement(_quotation_createNode_pawenb_a0a1a0(SLinkOperations.getTarget(__thisNode__, LINKS.elementType$B4nw)));
  ...
  /*package*/ static boolean canBeCoerced_id476YRQvP9l3(@NotNull SNode __thisNode__, SAbstractConcept c) {
    if (CONCEPTS.LinkedListType$bW.equals(c) || CONCEPTS.ListType$z$.equals(c) || CONCEPTS.QueueType$4E.equals(c) || CONCEPTS.SetType$1N.equals(c) || CONCEPTS.SortedSetType$Tt.equals(c) || CONCEPTS.MapType$2H.equals(c) || CONCEPTS.SortedMapType$oG.equals(c)) {
      return false;
    }
    return true;
  }
