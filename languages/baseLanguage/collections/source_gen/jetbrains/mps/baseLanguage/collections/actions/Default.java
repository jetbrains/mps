...
public class Default {
  public static class NodeFactory_8656797459614949039 implements NodeFactory {
    ...
    private static SNode createMultiForEachVariableReference_qjewi8_a0a0a0a0f0a0a0(SNode node0) {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.MultiForEachVariableReference$4f);
      rootBuilder1.setReferenceTarget(LINKS.variable$ZC9Q, node0);
  ...
  public static class NodeFactory_8656797459614853042 implements NodeFactory {
    ...
    private static SNode createForEachVariableReference_qjewi8_a0a0a0a0e0a0a1(SNode node0) {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ForEachVariableReference$CR);
      rootBuilder1.setReferenceTarget(LINKS.variable$j6kA, node0);
      return rootBuilder1.getResult();
    }
  }
