...
public class CustomMapCreator_SubstituteMenu extends SubstituteMenuBase {
  public CustomMapCreator_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for CustomMapCreator. Generated from implicit smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c8959032e(jetbrains.mps.baseLanguage.collections.structure)", "1576845966386891367")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_dxd0az_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_dxd0az_a() {
      super(CONCEPTS.CustomMapCreator$j2, LINKS.containerDeclaration$QVZa, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_dxd0az_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_dxd0az_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "CustomMapCreator", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.CustomMapCreator$j2);
    }
