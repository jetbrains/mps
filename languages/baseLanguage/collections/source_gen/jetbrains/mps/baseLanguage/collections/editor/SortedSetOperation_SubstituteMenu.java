...
public class SortedSetOperation_SubstituteMenu extends SubstituteMenuBase {
  ...
  public class SMP_Subconcepts_e9ffp7_a extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(CONCEPTS.SortedSetOperation$Uy).stream().filter((SAbstractConcept concept) -> filterConcept(_context, concept)).collect(Collectors.toList());
    }
