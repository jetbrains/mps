...
public class OperationInference {
          ...
          if (!(typeCheckingContext.isSingleTypeComputation())) {
            {
              ...
              typeCheckingContext.createGreaterThanInequality((SNode) createSequenceType_z5jmtl_a0a0c0a0a0a0a1a0b0a0a(elemType), (SNode) typeCheckingContext.getExpandedNode(operandType), true, true, _info_12389875345);
            }
          }
  ...
  public static void inferParamType(final TypeCheckingContext typeCheckingContext, SNode operation) {
    ...
    OperationInference.inferParamType(typeCheckingContext, operation, typeCheckingContext.getRepresentative(elementType_typevar_5449465669808509765));
  }
  ...
  public static void inferInternalOperation(final TypeCheckingContext typeCheckingContext, SNode operation, SNode elemType, SNode closureType) {
    OperationInference.inferParamType(typeCheckingContext, operation, elemType);
    {
        ...
        public void run() {
          {
            ...
            typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "2321665441776750737", true), (SNode) ClassifierTypeUtil.copyTypeRecursively(SNodeOperations.as(typeCheckingContext.getExpandedNode(concreteElementType), CONCEPTS.Type$bu)), false, true, _info_12389875345);
          }
        }
  ...
  public static void inferFilteringOperation(final TypeCheckingContext typeCheckingContext, SNode operation, SNode elemType) {
    OperationInference.inferInternalOperation(typeCheckingContext, operation, elemType, _quotation_createNode_z5jmtl_d0a0j(elemType));
  }
  ...
  public static void inferFilteringOperation(final TypeCheckingContext typeCheckingContext, SNode operation) {
    ...
    OperationInference.inferFilteringOperation(typeCheckingContext, operation, typeCheckingContext.getRepresentative(elementType_typevar_5449465669808470068));
  }

  private static SNode createSequenceType_z5jmtl_a0a0c0a0a0a0a1a0b0a0a(SNode p0) {
