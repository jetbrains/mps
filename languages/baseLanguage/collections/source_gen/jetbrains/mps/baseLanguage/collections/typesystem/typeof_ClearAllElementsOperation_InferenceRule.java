...
public class typeof_ClearAllElementsOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode op, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    OperationInference.inferParamType(typeCheckingContext, op);
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1227022560572", true), (SNode) _quotation_createNode_mtxlia_a1a0c0b0b(), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_mtxlia_a1a0c0b0b() {
