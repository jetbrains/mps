...
public class typeof_AddElementOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode op, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    OperationInference.inferSingleArgumentOperation(typeCheckingContext, op, typeCheckingContext.getRepresentative(elementType_typevar_2141797557973018714));
    {
  ...
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.AddElementOperation$ST;
  }
