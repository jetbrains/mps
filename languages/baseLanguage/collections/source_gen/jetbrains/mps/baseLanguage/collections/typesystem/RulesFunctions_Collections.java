...
public class RulesFunctions_Collections {
  ...
  public static SNode getInput(final TypeCheckingContext typeCheckingContext, SNode op) {
    ...
    if (SNodeOperations.isInstanceOf(parent, CONCEPTS.DotExpression$6a)) {
      input = SLinkOperations.getTarget(SNodeOperations.cast(parent, CONCEPTS.DotExpression$6a), LINKS.operand$Lcrr);
    } else {
      {
  ...
  public static SNode getOutput(SNode op) {
    ...
    SNode parent = SNodeOperations.getParent(op);
    if (SNodeOperations.isInstanceOf(parent, CONCEPTS.DotExpression$6a)) {
      output = SNodeOperations.as(SLinkOperations.getTarget(SNodeOperations.cast(parent, CONCEPTS.DotExpression$6a), LINKS.operation$X4R8), CONCEPTS.SequenceOperation$V5);
      return output;
    } else {
      return null;
    }
