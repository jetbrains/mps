...
public final class CustomMapCreator__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> createType_id1ny5gPbZSFj = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("createType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1ny5gPbZSFj").build();
