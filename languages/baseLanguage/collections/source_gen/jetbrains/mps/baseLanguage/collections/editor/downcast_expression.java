...
public class downcast_expression extends TransformationMenuBase {
  public downcast_expression() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "downcast_expression", new SNodePointer("r:00000000-0000-4000-0000-011c8959032a(jetbrains.mps.baseLanguage.collections.editor)", "1741258697587177308")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
    ...
    private class TMP_Action_ryktp7_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c8959032a(jetbrains.mps.baseLanguage.collections.editor)", "1741258697587177337"));
          return this;
        }
        @Nullable
        @Override
