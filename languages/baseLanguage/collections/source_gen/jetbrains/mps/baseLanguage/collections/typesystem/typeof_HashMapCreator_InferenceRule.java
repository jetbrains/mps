...
public class typeof_HashMapCreator_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode hashMapCreator, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    typeCheckingContext.addDependencyForCurrent(SLinkOperations.getTarget(hashMapCreator, LINKS.initializer$hMbF));

    final SNode keyType_typevar_7830826264642622863 = typeCheckingContext.createNewRuntimeTypesVariable();
    final SNode valueType_typevar_7830826264642622950 = typeCheckingContext.createNewRuntimeTypesVariable();
    if ((SLinkOperations.getTarget(hashMapCreator, LINKS.keyType$Uj4M) != null) && (SLinkOperations.getTarget(hashMapCreator, LINKS.valueType$2EUo) != null)) {
      {
        SNode _nodeToCheck_1029348928467 = hashMapCreator;
        EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "7830826264642627915", 0, null);
        typeCheckingContext.createEquation((SNode) typeCheckingContext.getRepresentative(keyType_typevar_7830826264642622863), (SNode) SLinkOperations.getTarget(hashMapCreator, LINKS.keyType$Uj4M), _info_12389875345);
      }
      {
        SNode _nodeToCheck_1029348928467 = hashMapCreator;
        EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "7830826264642630066", 0, null);
      ...
      if (!(typeCheckingContext.isSingleTypeComputation())) {
        {
          ...
          typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "1562299158921037853", true), (SNode) _quotation_createNode_dvqbcx_a1a0c0a0a0g0b(), true, true, _info_12389875345);
        }
      }
    }
  }
  ...
  private static SNode _quotation_createNode_dvqbcx_a1a0c0a0a0g0b() {
