...
public class BLC_rtansform extends TransformationMenuBase {
  public BLC_rtansform() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "BLC_rtansform", new SNodePointer("r:00000000-0000-4000-0000-011c8959032a(jetbrains.mps.baseLanguage.collections.editor)", "1741258697587177380")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
    ...
    private class TMP_Action_ahju1d_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem, ConstraintsVerifiableActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c8959032a(jetbrains.mps.baseLanguage.collections.editor)", "1741258697587177412"));
          return this;
        }
        @Nullable
        @Override
