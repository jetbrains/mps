...
public class typeof_GetLastIndexOfOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  public typeof_GetLastIndexOfOperation_InferenceRule() {
  }
  public void applyRule(final SNode op, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode input = RulesFunctions_Collections.getInput(typeCheckingContext, op);
    final SNode elementType_typevar_4020503625588455777 = typeCheckingContext.createNewRuntimeTypesVariable();
    {
      ...
      typeCheckingContext.createGreaterThanInequality((SNode) _quotation_createNode_3i3cw9_a0a0c0c0b(typeCheckingContext.getRepresentative(elementType_typevar_4020503625588455777)), (SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "4020503625588455780", true), false, true, _info_12389875345);
    }
    ...
    }
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959032b(jetbrains.mps.baseLanguage.collections.typesystem)", "4020503625588455801", true), (SNode) _quotation_createNode_3i3cw9_a1a0c0e0b(), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_3i3cw9_a0a0c0c0b(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_3i3cw9_a1a0c0e0b() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
