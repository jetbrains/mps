...
public final class QueueType__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<SNode> getAbstractCreators_id6A07P3f4z36(@NotNull SNode __thisNode__, SModel targetModel) {
    ...
    ListSequence.fromList(res).addElement(_quotation_createNode_1g15wz_a0a1a0(SLinkOperations.getTarget(__thisNode__, LINKS.elementType$B4nw)));
    ListSequence.fromList(res).addElement(_quotation_createNode_1g15wz_a0a2a0(SLinkOperations.getTarget(__thisNode__, LINKS.elementType$B4nw)));
  ...
  /*package*/ static boolean canBeCoerced_id476YRQvP9l3(@NotNull SNode __thisNode__, SAbstractConcept c) {
    if (CONCEPTS.LinkedListType$bW.equals(c) || CONCEPTS.ListType$z$.equals(c) || CONCEPTS.StackType$pL.equals(c) || CONCEPTS.SetType$1N.equals(c) || CONCEPTS.SortedSetType$Tt.equals(c) || CONCEPTS.MapType$2H.equals(c) || CONCEPTS.SortedMapType$oG.equals(c)) {
      return false;
    }
    return true;
  }
  ...
  private static SNode _quotation_createNode_1g15wz_a0a1a0(Object parameter_1) {
    ...
    quotedNode_2 = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0x8388864671ce4f1cL, 0x9c53c54016f6ad4fL, "jetbrains.mps.baseLanguage.collections"), 0x11daf69a138L, "LinkedListCreator")).getResult();
  ...
  private static SNode _quotation_createNode_1g15wz_a0a2a0(Object parameter_1) {
    ...
    SNode quotedNode_2 = null;
    SNode quotedNode_3 = null;
    quotedNode_2 = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0x8388864671ce4f1cL, 0x9c53c54016f6ad4fL, "jetbrains.mps.baseLanguage.collections"), 0x2e9a0b9a89009f6cL, "PriorityQueueCreator")).getResult();
    quotedNode_3 = (SNode) parameter_1;
    if (quotedNode_3 != null) {
      quotedNode_2.addChild(MetaAdapterFactory.getContainmentLink(0x8388864671ce4f1cL, 0x9c53c54016f6ad4fL, 0x1202df1ada0L, 0x1202df24e9fL, "elementType"), SNodeOperations.copyIfNecessary(quotedNode_3));
    }
