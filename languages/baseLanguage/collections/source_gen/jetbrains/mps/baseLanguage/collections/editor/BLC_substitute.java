...
public class BLC_substitute extends SubstituteMenuBase {
  ...
  public class SMP_Group_4r5ods_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts() {
      return Arrays.<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>asList(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Group_4r5ods_a.SMP_Action_4r5ods_a0(), CONCEPTS.SortDirection$n7), new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Group_4r5ods_a.SMP_Action_4r5ods_b0(), CONCEPTS.SortDirection$n7));
    }
