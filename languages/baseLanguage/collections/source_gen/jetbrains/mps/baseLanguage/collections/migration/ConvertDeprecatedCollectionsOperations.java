  ...
  public void doExecute(final SModule m) {
    {
      ...
      CollectionSequence.fromCollection(CommandUtil.instances(CommandUtil.selectScope(null, context), CONCEPTS.AddSetElementOperation$fa, false)).visitAll(new _Adapters._return_P1_E0_to__void_P1_E0_adapter(new _FunctionTypes._return_P1_E0<SNode, SNode>() {
        public SNode invoke(SNode it) {
          return SNodeOperations.replaceWithAnother(it, _quotation_createNode_oas78t_a0a0a0a0a0a0g(SNodeOperations.copyNode(SLinkOperations.getTarget(it, LINKS.argument$dp1k))));
        }
      }));
      CollectionSequence.fromCollection(CommandUtil.instances(CommandUtil.selectScope(null, context), CONCEPTS.AddAllSetElementsOperation$TC, false)).visitAll(new _Adapters._return_P1_E0_to__void_P1_E0_adapter(new _FunctionTypes._return_P1_E0<SNode, SNode>() {
        public SNode invoke(SNode it) {
          return SNodeOperations.replaceWithAnother(it, _quotation_createNode_oas78t_a0a0a0a0b0a0g(SNodeOperations.copyNode(SLinkOperations.getTarget(it, LINKS.argument$sATI))));
        }
      }));
      CollectionSequence.fromCollection(CommandUtil.instances(CommandUtil.selectScope(null, context), CONCEPTS.RemoveSetElementOperation$lF, false)).visitAll(new _Adapters._return_P1_E0_to__void_P1_E0_adapter(new _FunctionTypes._return_P1_E0<SNode, SNode>() {
        public SNode invoke(SNode it) {
          return SNodeOperations.replaceWithAnother(it, _quotation_createNode_oas78t_a0a0a0a0c0a0g(SNodeOperations.copyNode(SLinkOperations.getTarget(it, LINKS.argument$7Jlk))));
        }
      }));
      CollectionSequence.fromCollection(CommandUtil.instances(CommandUtil.selectScope(null, context), CONCEPTS.RemoveAllSetElementsOperation$yY, false)).visitAll(new _Adapters._return_P1_E0_to__void_P1_E0_adapter(new _FunctionTypes._return_P1_E0<SNode, SNode>() {
        public SNode invoke(SNode it) {
          return SNodeOperations.replaceWithAnother(it, _quotation_createNode_oas78t_a0a0a0a0d0a0g(SNodeOperations.copyNode(SLinkOperations.getTarget(it, LINKS.argument$sItp))));
        }
      }));
    }
  }
