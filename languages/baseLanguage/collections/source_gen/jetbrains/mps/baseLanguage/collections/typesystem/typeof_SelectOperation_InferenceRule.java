...
public class typeof_SelectOperation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode so, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    OperationInference.inferInternalOperation(typeCheckingContext, so, typeCheckingContext.getRepresentative(sequenceParamType_typevar_1225884177658), _quotation_createNode_jxb36x_d0f0b(typeCheckingContext.getRepresentative(selectorParamType_typevar_1240677567421), typeCheckingContext.getRepresentative(resType_typevar_1203177754378)));
    {
      SNode _nodeToCheck_1029348928467 = so;
  ...
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.SelectOperation$LF;
  }
  ...
  private static SNode _quotation_createNode_jxb36x_d0f0b(Object parameter_1, Object parameter_2) {
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept SelectOperation$LF = MetaAdapterFactory.getConcept(0x8388864671ce4f1cL, 0x9c53c54016f6ad4fL, 0x117e4785fdeL, "jetbrains.mps.baseLanguage.collections.structure.SelectOperation");
  }
}
