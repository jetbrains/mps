...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForDocumentedNodeAnnotation() {
    ...
    b.version(3);
    b.aggregate("text", 0x3b971d44f99ad98aL).target(0xc7fb639fbe784307L, 0x89b0b5959c3fa8c8L, 0x2331694e5619f411L).optional(false).ordered(true).multiple(false).origin("4293932951803713930").done();
    return b.create();
  }
}
