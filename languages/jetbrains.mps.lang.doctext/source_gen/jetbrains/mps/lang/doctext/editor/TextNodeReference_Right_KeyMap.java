...
public class TextNodeReference_Right_KeyMap extends KeyMapImpl {
  public TextNodeReference_Right_KeyMap() {
    this.setApplicableToEveryModel(false);
    KeyMapAction action;
    action = new TextNodeReference_Right_KeyMap_Action0();
    this.putAction("any", " ", action);
  }
  public static class TextNodeReference_Right_KeyMap_Action0 extends KeyMapActionImpl {
    public TextNodeReference_Right_KeyMap_Action0() {
