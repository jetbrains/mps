...
public class TextNodeReference_Left_Actions {
  ...
  /*package*/ static AbstractCellAction createAction_BACKSPACE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (SNodeOperations.isInstanceOf(SNodeOperations.getPrevSibling(node), CONCEPTS.Word$Dn) && (SPropertyOperations.getString(SNodeOperations.as(SNodeOperations.getPrevSibling(node), CONCEPTS.Word$Dn), PROPS.value$zQr_) == null || SPropertyOperations.getString(SNodeOperations.as(SNodeOperations.getPrevSibling(node), CONCEPTS.Word$Dn), PROPS.value$zQr_) == "")) {
