...
public class ConstraintsDefNative_SubstituteMenu extends SubstituteMenuBase {
  @NotNull
  @Override
  ...
  public List<SubstituteMenuItem> createMenuItems(@NotNull SubstituteMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("default substitute menu for " + "ConstraintsDefNative", new SNodePointer("r:c333438f-9631-41c0-a716-72d23eed1ba4(jetbrains.mps.lang.constraints.rules.editor)", "315923949159341659")));
    try {
    ...
    protected SubstituteMenuItem wrapItem(final SubstituteMenuItem item, final SubstituteMenuContext _context) {
      ...
      return new SubstituteMenuItemWrapper(item) {
        ...
        public SAbstractConcept getOutputConcept() {
          return MetaAdapterFactory.getConcept(0x47257bf378d3470bL, 0x89d98c3261a61d15L, 0x4bf59690bc00f6b1L, "jetbrains.mps.lang.constraints.rules.structure.ConstraintsDefNative");
        }
        @Nullable
        @Override
        public SNode createNode(@NotNull String pattern) {
