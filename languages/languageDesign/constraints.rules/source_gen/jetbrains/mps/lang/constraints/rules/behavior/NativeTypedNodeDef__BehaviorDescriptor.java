...
public final class NativeTypedNodeDef__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x47257bf378d3470bL, 0x89d98c3261a61d15L, 0x46263286da99051L, "jetbrains.mps.lang.constraints.rules.structure.NativeTypedNodeDef");
  ...
  /*package*/ static SNode buildTypeForRule_id4JP_D2W1aNL(@NotNull SNode __thisNode__, SNode member) {
    SNode root = SNodeOperations.cast(SNodeOperations.getContainingRoot(member), MetaAdapterFactory.getConcept(0x47257bf378d3470bL, 0x89d98c3261a61d15L, 0x6530303593554221L, "jetbrains.mps.lang.constraints.rules.structure.ConstraintsRoot2"));
    SNode applicableConcept = SLinkOperations.getTarget(root, MetaAdapterFactory.getReferenceLink(0x47257bf378d3470bL, 0x89d98c3261a61d15L, 0x6530303593554221L, 0x6530303593940081L, "concept"));
    if (applicableConcept == null) {
      return TypedDef__BehaviorDescriptor.getErasedType_id4JP_D2W1aPH.invoke(__thisNode__);
    }
    return _quotation_createNode_v8u64w_a3a1(applicableConcept);
  }
  ...
  private static SNode _quotation_createNode_v8u64w_a3a1(Object parameter_1) {
    PersistenceFacade facade = PersistenceFacade.getInstance();
