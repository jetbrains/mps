...
public final class AbstractCellIdScopeProviderNodeOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static final SMethod<Scope> getPropertyDeclarationScope_id3K0abI6bsqm = new SMethodBuilder<>(Scope.class).name("getPropertyDeclarationScope").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(4323500428150818454L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2(SMethodBuilder.createJavaParameter(SNode.class, "concept"));
  public static final SMethod<Scope> getEditorCellIdScope_id3K0abI6bXeJ = new SMethodBuilder<>(Scope.class).name("getEditorCellIdScope").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4323500428150952879L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2(SMethodBuilder.createJavaParameter(SNode.class, "concept"));
