...
public final class CellMenuPart_ReferentPrimary__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getMatchingTextFunction_id6K3nYZvn7p1 = new SMethodBuilder<>(SNode.class).name("getMatchingTextFunction").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7783170064875550273L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
  public static final SMethod<SNode> getVisibleMatchingTextFunction_id5KYS0pi3wd5 = new SMethodBuilder<>(SNode.class).name("getVisibleMatchingTextFunction").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6646996417796506437L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
