...
public final class StyleKey__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getClassName_id3w77Jl_kKl7 = new SMethodBuilder<>(String.class).name("getClassName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4037229630276699463L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
  public static final SMethod<String> getClassFQName_id3w77Jl_kKlh = new SMethodBuilder<>(String.class).name("getClassFQName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4037229630276699473L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
  public static final SMethod<SNode> getStyleKeyPack_id3w77Jl_kPZ_ = new SMethodBuilder<>(SNode.class).name("getStyleKeyPack").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4037229630276722661L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getPresentation_idhEwIMiw, getClassName_id3w77Jl_kKl7, getClassFQName_id3w77Jl_kKlh, getStyleKeyPack_id3w77Jl_kPZ_);
