...
public final class CellMenuPart_Abstract__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getEditedFeature_idhJEvH7P = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getEditedFeature").modifiers(0, AccessPrivileges.PACKAGE).concept(CONCEPT).id("hJEvH7P").build();
  public static final SMethod<SNode> getEditedLink_idhJEvotS = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getEditedLink").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("hJEvotS").build();
  public static final SMethod<SNode> getEditedAggregationLink_idhJEvgUM = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getEditedAggregationLink").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("hJEvgUM").build();
  public static final SMethod<SNode> getReferenceDeclaration_id1o9RazL_axx = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getReferenceDeclaration").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1o9RazL_axx").build();
