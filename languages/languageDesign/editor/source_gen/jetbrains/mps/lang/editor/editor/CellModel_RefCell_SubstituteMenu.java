...
public class CellModel_RefCell_SubstituteMenu extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new CellModel_RefCell_SubstituteMenu.SMP_Subconcepts_hnmfkt_b());
    return result;
  }
  ...
  public class SMP_ReferenceScope_hnmfkt_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_hnmfkt_a() {
      ...
      super((SAbstractConcept) MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xfd52a2c922L, "jetbrains.mps.lang.editor.structure.CellModel_RefCell"), MetaAdapterFactory.getReferenceLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x10964446123L, 0x10973779681L, "relationDeclaration"));
    }
    @NotNull
    @Override
    ...
    protected ReferenceScopeSubstituteMenuItem createItem(SubstituteMenuContext context, SNode referencedNode) {
      return new CellModel_RefCell_SubstituteMenu.SMP_ReferenceScope_hnmfkt_a.Item(context, referencedNode, getSConcept(), getReferenceLink());
    }
  ...
  public class SMP_Subconcepts_hnmfkt_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0xfd52a2c922L, "jetbrains.mps.lang.editor.structure.CellModel_RefCell"));
    }
    @NotNull
    @Override
    public List<SubstituteMenuItem> createItems(SubstituteMenuContext context) {
