...
/*package*/ class CellModel_Collection_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new childCellModelListHandler_cvgoyj_b1a0a(myNode, getEditorContext());
  ...
  private static class childCellModelListHandler_cvgoyj_b1a0a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.childCellModel$HAw7;
    }
    ...
    public EditorCell createEmptyCell() {
      ...
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(childCellModelListHandler_cvgoyj_b1a0a.this.getNode(), LINKS.childCellModel$HAw7));
      try {
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new childCellModelListHandler_cvgoyj_b0a0(myNode, getEditorContext());
  ...
  private static class childCellModelListHandler_cvgoyj_b0a0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(childCellModelListHandler_cvgoyj_b0a0.this.getNode(), LINKS.childCellModel$HAw7));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
  ...
  private EditorCell createRefNodeList_2() {
    AbstractCellListHandler handler = new childCellModelListHandler_cvgoyj_b0a(myNode, getEditorContext());
  ...
  private static class childCellModelListHandler_cvgoyj_b0a extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(childCellModelListHandler_cvgoyj_b0a.this.getNode(), LINKS.childCellModel$HAw7));
      try {
        EditorCell emptyCell = null;
        emptyCell = super.createEmptyCell();
        installElementCellActions(null, emptyCell, true);
