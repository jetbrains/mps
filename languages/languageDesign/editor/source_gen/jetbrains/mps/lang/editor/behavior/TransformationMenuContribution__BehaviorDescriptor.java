...
public final class TransformationMenuContribution__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getMenuReference_id1quYWAD2_PI = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getMenuReference").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1quYWAD2_PI").build();
