...
public final class TransformationMenuContribution__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getMenuReference_id1quYWAD2_PI = new SMethodBuilder<>(SNode.class).name("getMenuReference").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1630016958697725294L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
  ...
  /*package*/ static SNode getMenuReference_id1quYWAD2_PI(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.menuReference$uYXm);
  }
