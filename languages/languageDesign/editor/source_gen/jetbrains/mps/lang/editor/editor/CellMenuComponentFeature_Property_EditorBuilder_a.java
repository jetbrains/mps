...
/*package*/ class CellMenuComponentFeature_Property_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public CellMenuComponentFeature_Property_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.relationDeclaration$$vVu;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.propertyDeclaration$81$A);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.relationDeclaration$$vVu);
    }
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink propertyDeclaration$81$A = MetaAdapterFactory.getReferenceLink(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x10f7d811428L, 0x10f7d83266fL, "propertyDeclaration");
  }
