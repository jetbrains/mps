...
public final class ConceptFunctionParameter_editorContext__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> useGenericAccessor_id1PvcgmUaIFz = new SMethodBuilder<>(Boolean.TYPE).name("useGenericAccessor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2116464250555394787L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(useGenericAccessor_id1PvcgmUaIFz);
