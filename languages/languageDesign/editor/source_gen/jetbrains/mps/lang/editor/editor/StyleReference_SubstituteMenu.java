...
public class StyleReference_SubstituteMenu extends SubstituteMenuBase {
  public StyleReference_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for StyleReference. Generated from implicit smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c8959029e(jetbrains.mps.lang.editor.structure)", "9122903797312246523")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_3y4dr_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_3y4dr_a() {
      super(CONCEPTS.StyleReference$y3, LINKS.style$$2C0, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_3y4dr_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_3y4dr_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "StyleReference", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.StyleReference$y3);
    }
