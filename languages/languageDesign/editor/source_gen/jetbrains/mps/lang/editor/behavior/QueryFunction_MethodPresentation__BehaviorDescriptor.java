...
public final class QueryFunction_MethodPresentation__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x950e7629b27d75eL, "jetbrains.mps.lang.editor.structure.QueryFunction_MethodPresentation");
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(result).addElement(CONCEPTS.ConceptFunctionParameter_selectedNode$IB);
    ListSequence.fromList(result).addElement(CONCEPTS.ConceptFunctionParameter_editorContext$k8);
    ListSequence.fromList(result).addElement(CONCEPTS.ConceptFunctionParameter_parameterObject$yI);
    ListSequence.fromList(result).addElement(CONCEPTS.ConceptFunctionParameter_StyledText$cZ);
    return result;
  }
  ...
  /*package*/ QueryFunction_MethodPresentation__BehaviorDescriptor() {
  }
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept ConceptFunctionParameter_selectedNode$IB = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x3a54c53a29dbb0faL, "jetbrains.mps.lang.editor.structure.ConceptFunctionParameter_selectedNode");
    ...
    /*package*/ static final SConcept ConceptFunctionParameter_StyledText$cZ = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x3ed01d37608fe0afL, "jetbrains.mps.lang.editor.structure.ConceptFunctionParameter_StyledText");
  }
}
