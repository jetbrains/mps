...
public final class QueryFunction_MethodPresentation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getParameterConcepts_id2xELmDxyi2v, getExpectedReturnType_idhEwIGRD);
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(result).addElement(CONCEPTS.ConceptFunctionParameter_selectedNode$Ue);
    ListSequence.fromList(result).addElement(CONCEPTS.ConceptFunctionParameter_editorContext$vJ);
    ListSequence.fromList(result).addElement(CONCEPTS.ConceptFunctionParameter_parameterObject$Il);
    ListSequence.fromList(result).addElement(CONCEPTS.ConceptFunctionParameter_StyledText$oA);
    return result;
  }
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept ConceptFunctionParameter_StyledText$oA = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x3ed01d37608fe0afL, "jetbrains.mps.lang.editor.structure.ConceptFunctionParameter_StyledText");
  }
}
