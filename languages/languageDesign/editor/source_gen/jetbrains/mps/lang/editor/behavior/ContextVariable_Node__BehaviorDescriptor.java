...
public final class ContextVariable_Node__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static final SMethod<SNode> getApplicableConcept_id4Fjf6xN2WlM = new SMethodBuilder<>(SNode.class).name("getApplicableConcept").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(5391719598197032306L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getProviderConcept_idaxxf7pcCKs, getApplicableConcept_id4Fjf6xN2WlM, getType_id27DJnJtIQ9C);
