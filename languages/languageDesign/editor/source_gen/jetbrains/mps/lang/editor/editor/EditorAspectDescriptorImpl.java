...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase {
  ...
  public Collection<ConceptEditor> getDeclaredEditors(SAbstractConcept concept) {
    ...
    switch (conceptIndex.index(cncpt)) {
      ...
      case 64:
        return Collections.<ConceptEditor>singletonList(new CompletionCustomization_Editor());
      case 65:
  ...
  private static String[] stringSwitchCases_xbvbvu_a0a0a0b1a5 = new String[]{"jetbrains.mps.lang.editor.editor.BooleanStyleSheetItem_FlagMenu"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0c1a5 = new String[]{"jetbrains.mps.lang.editor.editor.CellModel_Collection_CollapseByDefaultMenu", "jetbrains.mps.lang.editor.editor.CellModel_Collection_UsesFoldingMenu"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0d1a5 = new String[]{"jetbrains.mps.lang.editor.editor.CellModel_RefNodeList_UsesFoldingMenu"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0e1a5 = new String[]{"jetbrains.mps.lang.editor.editor.CompletionCustomization_SubstituteSpecificator"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0f1a5 = new String[]{"jetbrains.mps.lang.editor.editor.PropertyDeclarationCellSelector_Empty_SideTransformMenu"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0g1a5 = new String[]{"jetbrains.mps.lang.editor.editor.addExtendedClass_StyleClass"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0h1a5 = new String[]{"jetbrains.mps.lang.editor.editor.SubstituteMenuReference_Default_QueryMenu"};
  private static String[] stringSwitchCases_xbvbvu_a0a0a0a1a7 = new String[]{"jetbrains.mps.lang.editor.editor.CellIdReferenceSelector_SmartReference"};
}
