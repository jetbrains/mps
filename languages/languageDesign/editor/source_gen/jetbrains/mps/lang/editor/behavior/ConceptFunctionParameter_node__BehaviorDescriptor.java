...
public final class ConceptFunctionParameter_node__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> useGenericAccessor_id6E2BWlDjAuB = new SMethodBuilder<>(Boolean.TYPE).name("useGenericAccessor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7674872385216866215L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(useGenericAccessor_id6E2BWlDjAuB);
