...
public final class QueryFunction_StyleParameter__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isSeparatorStyleQuery_id6VCLXpKP7HP = new SMethodBuilder<>(Boolean.TYPE).name("isSeparatorStyleQuery").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7991857262598847349L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getParameterConcepts_id2xELmDxyi2v, isSeparatorStyleQuery_id6VCLXpKP7HP, getExpectedReturnType_idhEwIGRD);
