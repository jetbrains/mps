...
public class typeof_ConceptFunctionParameter_prevNode_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode node, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    SNode refNodeListCellModel = QueryFunction_StyleParameter__BehaviorDescriptor.getContainingCellModelRefNodeList_id3Jh9EXLN9Lo.invoke(SNodeOperations.as(ConceptFunctionParameter__BehaviorDescriptor.findConceptFunction_idhEwJh7Q.invoke(node), CONCEPTS.QueryFunction_StyleParameter$Yk));
    if (refNodeListCellModel != null) {
      {
        ...
        typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959029a(jetbrains.mps.lang.editor.typesystem)", "4310268853341509552", true), (SNode) _quotation_createNode_x6esm1_a1a0c0a0b0b(SLinkOperations.getTarget(SLinkOperations.getTarget(refNodeListCellModel, LINKS.relationDeclaration$E2hc), LINKS.target$m40F)), _info_12389875345);
      }
    }
  }
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.ConceptFunctionParameter_prevNode$qw;
  }
