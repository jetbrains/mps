...
public final class ConceptEditorHintDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getHintsContainer_id59ZEGVRaGvE = new SMethodBuilder<>(SNode.class).name("getHintsContainer").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5944657839039105002L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
  public static final SMethod<String> getQualifiedName_id59ZEGVRaGvv = new SMethodBuilder<>(String.class).name("getQualifiedName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5944657839039104991L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
