...
public final class IMenuPartParameterized__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SContainmentLink> getLinkNodeOfParameterizedPart_id1quYWAD03b2 = new SMethodBuilder<>(SContainmentLink.class).name("getLinkNodeOfParameterizedPart").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1630016958697059010L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
