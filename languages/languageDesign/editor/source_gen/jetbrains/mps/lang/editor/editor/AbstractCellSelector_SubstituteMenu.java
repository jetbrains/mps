...
public class AbstractCellSelector_SubstituteMenu extends SubstituteMenuBase {
  ...
  public class SMP_Group_1rdeze_c extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_1rdeze_c() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:00000000-0000-4000-0000-011c89590299(jetbrains.mps.lang.editor.editor)", "8979250711608554143")));
    }
    @Override
