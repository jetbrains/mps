...
public class CellSelectorReference_Actions {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (SConceptOperations.isExactly(SNodeOperations.asSConcept(CONCEPTS.AbstractCellSelector$JG), SNodeOperations.asSConcept(SNodeOperations.getConcept(SLinkOperations.getTarget(node, LINKS.cellSelector$u$HA))))) {
          if (DeletionApproverUtil.approve(editorContext, node, "cellSelector")) {
            return;
          }
          SLinkOperations.setTarget(node, LINKS.cellSelector$u$HA, null);
  ...
  /*package*/ static AbstractCellAction createAction_INSERT(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (SLinkOperations.getTarget(node, LINKS.selectionStart$UKIJ) == null) {
          SLinkOperations.setTarget(node, LINKS.selectionStart$UKIJ, SConceptOperations.createNewNode(MetaAdapterFactory.getConcept(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c37f506fL, "jetbrains.mps.baseLanguage.structure.Expression")));
        }
      }
