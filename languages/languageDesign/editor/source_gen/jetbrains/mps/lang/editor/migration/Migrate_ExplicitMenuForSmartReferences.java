...
public class Migrate_ExplicitMenuForSmartReferences extends MigrationScriptBase {
  ...
  private static SNode createSmartRefMigrationDataEntity_b3phj_a0a2a6a1a3a3a6(SNode node0, SNode node1) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.SmartRefMigrationDataEntity$3n);
    rootBuilder1.setReferenceTarget(LINKS.conceptNode$rGc9, node0);
    rootBuilder1.setReferenceTarget(LINKS.generatedMenu$rGTc, node1);
