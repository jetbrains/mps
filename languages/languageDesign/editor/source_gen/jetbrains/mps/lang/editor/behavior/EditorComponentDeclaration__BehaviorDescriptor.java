...
public final class EditorComponentDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getConceptDeclaration_id7c58AbNVkhZ = new SMethodBuilder<>(SNode.class).name("getConceptDeclaration").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8288068497639818367L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2(SMethodBuilder.createJavaParameter((Class<Set<SNode>>) ((Class) Object.class), "visitedEditorComponents"));
