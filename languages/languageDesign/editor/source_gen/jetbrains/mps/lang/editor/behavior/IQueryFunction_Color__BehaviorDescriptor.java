...
public final class IQueryFunction_Color__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isFunction_idhPjjBbV = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isFunction").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("hPjjBbV").build();
  public static final SMethod<String> getRGBValue_idhPj_Kt2 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getRGBValue").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("hPj_Kt2").build();
