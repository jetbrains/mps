...
public class CellIdReferenceSelector_SmartReference extends SubstituteMenuBase {
  public CellIdReferenceSelector_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "CellIdReferenceSelector_SmartReference", new SNodePointer("r:00000000-0000-4000-0000-011c89590299(jetbrains.mps.lang.editor.editor)", "4747359941571311258")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_vhwei_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_vhwei_a() {
      super(CONCEPTS.CellIdReferenceSelector$vW, LINKS.id$X9uE, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c89590299(jetbrains.mps.lang.editor.editor)", "4747359941571311257")));
    }
