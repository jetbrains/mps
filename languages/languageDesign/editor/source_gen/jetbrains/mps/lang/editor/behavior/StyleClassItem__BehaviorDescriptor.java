...
public final class StyleClassItem__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isApplicableToCell_idhEUcU7K = new SMethodBuilder<>(Boolean.TYPE).name("isApplicableToCell").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1214304723440L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2(SMethodBuilder.createJavaParameter(SNode.class, "cellModel"));
  ...
  public static final SMethod<SNode> getStyleContainer_id6VCLXpKS8DC = new SMethodBuilder<>(SNode.class).name("getStyleContainer").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7991857262599637608L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
