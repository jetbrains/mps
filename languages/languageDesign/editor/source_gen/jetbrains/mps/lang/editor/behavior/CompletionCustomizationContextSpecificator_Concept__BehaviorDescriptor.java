...
public final class CompletionCustomizationContextSpecificator_Concept__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getConcept_id7U0pk79eiL7 = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getConcept").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("7U0pk79eiL7").build();

  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getConcept_id7U0pk79eiL7);
