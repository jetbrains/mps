...
public final class CompletionCustomizationContextSpecificator_Concept__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getConcept_id7U0pk79eiL7 = new SMethodBuilder<>(SNode.class).name("getConcept").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9115396979021130823L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getConcept_id7U0pk79eiL7);


  /*package*/ static SNode getConcept_id7U0pk79eiL7(@NotNull SNode __thisNode__) {
    return SLinkOperations.getTarget(__thisNode__, LINKS.conceptDeclaration$q9iq);
  }
