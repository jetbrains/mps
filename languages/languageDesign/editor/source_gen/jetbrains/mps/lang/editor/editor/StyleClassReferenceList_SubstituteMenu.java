...
public class StyleClassReferenceList_SubstituteMenu extends SubstituteMenuBase {
  ...
  private static SNode createStyleClassReferenceList_cyyevv_a0a0a(Iterable<? extends SNode> seq0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.StyleClassReferenceList$lx);
    rootBuilder1.forChild(LINKS.element$1rSY).initNodeList(seq0, CONCEPTS.StyleClassReference$J9);
