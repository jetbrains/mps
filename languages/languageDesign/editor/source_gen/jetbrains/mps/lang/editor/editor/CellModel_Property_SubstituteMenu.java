...
public class CellModel_Property_SubstituteMenu extends SubstituteMenuBase {
  public CellModel_Property_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for CellModel_Property. Generated from the smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c8959029e(jetbrains.mps.lang.editor.structure)", "8846826897881127670")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_pe92n9_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_pe92n9_a() {
      super(CONCEPTS.CellModel_Property$uh, LINKS.relationDeclaration$E2hc, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }
  ...
  public class SMP_Subconcepts_pe92n9_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_pe92n9_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "CellModel_Property", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.CellModel_Property$uh);
    }
