...
public final class ChangePropertyWithNonEmpty_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      SNode nonEmpty = SNodeFactoryOperations.createNewNode(CONCEPTS.CellModel_NonEmptyProperty$BH, node);
      SLinkOperations.setTarget(nonEmpty, LINKS.relationDeclaration$E2hc, SLinkOperations.getTarget(node, LINKS.relationDeclaration$E2hc));
      ...
      jetbrains.mps.lang.smodel.generator.smodelAdapter.SNodeOperations.replaceWithAnother(node, nonEmpty);
    }
    ...
    private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
      return SConceptOperations.isExactly(jetbrains.mps.lang.smodel.generator.smodelAdapter.SNodeOperations.asSConcept(jetbrains.mps.lang.smodel.generator.smodelAdapter.SNodeOperations.getConcept(node)), CONCEPTS.CellModel_Property$uh);
    }
