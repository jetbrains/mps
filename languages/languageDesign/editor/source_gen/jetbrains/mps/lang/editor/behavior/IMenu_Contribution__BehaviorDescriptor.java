...
public final class IMenu_Contribution__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getMenuReference_id1quYWAD2_PI = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getMenuReference").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1quYWAD2_PI").build();
  ...
  public static final SMethod<SNode> getApplicableConcept_id1quYWAD18xk = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getApplicableConcept").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1quYWAD18xk").build();
