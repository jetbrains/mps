...
public final class IMenu_Contribution__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getMenuReference_id1quYWAD2_PI = new SMethodBuilder<>(SNode.class).name("getMenuReference").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1630016958697725294L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
  ...
  public static final SMethod<SNode> getApplicableConcept_id1quYWAD18xk = new SMethodBuilder<>(SNode.class).name("getApplicableConcept").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1630016958697343060L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
