...
public final class ForegroundColorStyleClassItem__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x1143b38c56eL, "jetbrains.mps.lang.editor.structure.ForegroundColorStyleClassItem");

  public static final SMethod<Boolean> isApplicableToCellConcept_id2u3gVK1lsco = new SMethodBuilder<>(Boolean.TYPE).name("isApplicableToCellConcept").modifiers(9, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2847193864183595800L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2(SMethodBuilder.createJavaParameter(SConcept.class, "cellConcept"));

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(isApplicableToCellConcept_id2u3gVK1lsco);
  ...
  /*package*/ ForegroundColorStyleClassItem__BehaviorDescriptor() {
  }
