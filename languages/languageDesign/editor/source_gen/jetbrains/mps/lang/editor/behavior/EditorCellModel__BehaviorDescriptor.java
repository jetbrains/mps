...
public final class EditorCellModel__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> setSelectable_idi4bRWUe = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("setSelectable").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1241444765326L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2(SMethodBuilder.createJavaParameter(Boolean.TYPE, ""));
  public static final SMethod<Void> setTransparent_id3uCw42NPV2V = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("setTransparent").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4010596483556946107L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2(SMethodBuilder.createJavaParameter(Boolean.TYPE, ""));
