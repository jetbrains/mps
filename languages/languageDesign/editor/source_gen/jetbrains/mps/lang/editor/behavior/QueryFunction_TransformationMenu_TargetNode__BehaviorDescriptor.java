...
public final class QueryFunction_TransformationMenu_TargetNode__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static final SMethod<SNode> getExpectedReturnConcept_id5ZcqSl_NE$j = new SMethodBuilder<>(SNode.class).name("getExpectedReturnConcept").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(6903010549534992659L).languageId(0xa83a7ff23bde13baL, 0x18bc659203a64e29L).build2();
