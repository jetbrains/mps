...
public final class ApplicationPluginDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getGeneratedName_idqKmr2orM46 = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getGeneratedName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("qKmr2orM46").build();
  public static final SMethod<String> getGeneratedClassFQName_idqKmr2orM4h = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getGeneratedClassFQName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("qKmr2orM4h").build();
  ...
  /*package*/ static String getGeneratedName_idqKmr2orM46(@NotNull SNode __thisNode__) {
    return NameUtil.toValidIdentifier(SPropertyOperations.getString(__thisNode__, PROPS.name$MnvL)) + "_AppPluginPart";
  }
  ...
  /*package*/ static SNode createType_idhEwJimy(@NotNull SNode __thisNode__) {
    ...
    SLinkOperations.setTarget(type, LINKS.plugin$HQ_8, __thisNode__);
    return type;
  }
