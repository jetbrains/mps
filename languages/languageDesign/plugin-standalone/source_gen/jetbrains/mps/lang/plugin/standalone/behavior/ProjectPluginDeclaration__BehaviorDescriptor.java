...
public final class ProjectPluginDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getGeneratedName_idqKmr2orM2S = new SMethodBuilder<>(String.class).name("getGeneratedName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(481983775135178936L).languageId(0xb11de42104eb9343L, 0xef7bf5acd06c4342L).build2();
  public static final SMethod<String> getGeneratedClassFQName_idqKmr2orM33 = new SMethodBuilder<>(String.class).name("getGeneratedClassFQName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(481983775135178947L).languageId(0xb11de42104eb9343L, 0xef7bf5acd06c4342L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getGeneratedName_idqKmr2orM2S, getGeneratedClassFQName_idqKmr2orM33, createType_idhEwJimy);


  /*package*/ static String getGeneratedName_idqKmr2orM2S(@NotNull SNode __thisNode__) {
    return NameUtil.toValidIdentifier(SPropertyOperations.getString(__thisNode__, PROPS.name$MnvL)) + "_ProjectPluginPart";
  }
  ...
  /*package*/ static SNode createType_idhEwJimy(@NotNull SNode __thisNode__) {
    ...
    SLinkOperations.setTarget(type, LINKS.plugin$I6NC, __thisNode__);
    return type;
  }
  ...
  private static final class LINKS {
    /*package*/ static final SReferenceLink plugin$I6NC = MetaAdapterFactory.getReferenceLink(0xef7bf5acd06c4342L, 0xb11de42104eb9343L, 0x6b059b0986f2068L, 0x6b059b0986f206aL, "plugin");
  }
}
