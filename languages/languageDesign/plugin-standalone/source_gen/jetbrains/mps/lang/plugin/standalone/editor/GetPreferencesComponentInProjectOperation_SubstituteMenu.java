...
public class GetPreferencesComponentInProjectOperation_SubstituteMenu extends SubstituteMenuBase {
  public GetPreferencesComponentInProjectOperation_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for GetPreferencesComponentInProjectOperation. Generated from the smart reference attribute.", new SNodePointer("r:c70ee934-afb1-4c02-b6a9-1c4d1908a792(jetbrains.mps.lang.plugin.standalone.structure)", "4747359941569483743")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_r7b91_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_r7b91_a() {
      super(CONCEPTS.GetPreferencesComponentInProjectOperation$XZ, LINKS.componentDeclaration$puA7, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }
  ...
  public class SMP_Subconcepts_r7b91_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_r7b91_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "GetPreferencesComponentInProjectOperation", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.GetPreferencesComponentInProjectOperation$XZ);
    }
