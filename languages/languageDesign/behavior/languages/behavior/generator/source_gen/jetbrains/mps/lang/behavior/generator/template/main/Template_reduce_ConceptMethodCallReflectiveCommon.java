...
public class Template_reduce_ConceptMethodCallReflectiveCommon extends TemplateDeclarationBase {
  ...
  public SNodeReference getTemplateNode() {
    return new SNodePointer("r:229ce18d-2bb0-4d5b-a7cd-cec65841e459(jetbrains.mps.lang.behavior.generator.template.main@generator)", "8560627202335249984");
  }
    ...
    if (QueriesGenerated.ifMacro_Condition_17_0(new IfMacroContext(context, ifMacroRef))) {
      final SNode tnode2 = environment.createOutputNode(myConcepts[0]);
      {
        TemplateContext context1 = context.subContext();
        {
          ...
          tlist3 = environment.callSite(new Template_reduce_reflectiveInvoke(), new SNodePointer("r:229ce18d-2bb0-4d5b-a7cd-cec65841e459(jetbrains.mps.lang.behavior.generator.template.main@generator)", "633481135935145327")).apply(context1);
          environment.aggregate(tnode2, myAggregationLinks[0], tlist3);
        }
        {
          Collection<SNode> tlist4 = null;
          final SNode copySrcInput4 = QueriesGenerated.sourceNodeQuery_17_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro));
          tlist4 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput4), copySrcMacro, "tpl/r:229ce18d-2bb0-4d5b-a7cd-cec65841e459/4598718932037655771", context1);
      ...
      tlist5 = environment.callSite(new Template_reduce_reflectiveInvoke(), new SNodePointer("r:229ce18d-2bb0-4d5b-a7cd-cec65841e459(jetbrains.mps.lang.behavior.generator.template.main@generator)", "633481135935145328")).apply(context);
      tlist1 = tlist5;
    }
  ...
  private static final SNodePointer copySrcMacro = new SNodePointer("r:229ce18d-2bb0-4d5b-a7cd-cec65841e459(jetbrains.mps.lang.behavior.generator.template.main@generator)", "4598718932037685342");
  private static final SNodePointer ifMacroRef = new SNodePointer("r:229ce18d-2bb0-4d5b-a7cd-cec65841e459(jetbrains.mps.lang.behavior.generator.template.main@generator)", "4598718932037661886");
}
