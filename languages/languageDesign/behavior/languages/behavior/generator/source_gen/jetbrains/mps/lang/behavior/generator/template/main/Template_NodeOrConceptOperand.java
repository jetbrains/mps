...
public class Template_NodeOrConceptOperand extends TemplateDeclarationBase {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    if (QueriesGenerated.ifMacro_Condition_13_0(new IfMacroContext(context, ifMacroRef))) {
      final SNode tnode2 = environment.createOutputNode(myConcepts[0]);
      {
        ...
        TemplateContext context1 = context.subContext();
        {
          ...
          final SNode copySrcInput3 = QueriesGenerated.sourceNodeQuery_13_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro));
          tlist3 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput3), copySrcMacro, "tpl/r:229ce18d-2bb0-4d5b-a7cd-cec65841e459/3099391750892231738", context1);
      ...
      final SNode copySrcInput4 = QueriesGenerated.sourceNodeQuery_13_1(new SourceSubstituteMacroNodeContext(context, copySrcMacro1));
      tlist4 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput4), copySrcMacro1, "tpl/r:229ce18d-2bb0-4d5b-a7cd-cec65841e459/3099391750892231756", context);
      tlist1 = tlist4;
    }
  ...
  private static final SNodePointer copySrcMacro = new SNodePointer("r:229ce18d-2bb0-4d5b-a7cd-cec65841e459(jetbrains.mps.lang.behavior.generator.template.main@generator)", "3099391750892231739");
  private static final SNodePointer ifMacroRef = new SNodePointer("r:229ce18d-2bb0-4d5b-a7cd-cec65841e459(jetbrains.mps.lang.behavior.generator.template.main@generator)", "3099391750892231746");
  private static final SNodePointer copySrcMacro1 = new SNodePointer("r:229ce18d-2bb0-4d5b-a7cd-cec65841e459(jetbrains.mps.lang.behavior.generator.template.main@generator)", "3099391750892231757");
}
