...
public final class PasteConceptMethodDeclaration_PasteWrapper_1 implements PasteWrapper {
  @Override
  ...
  public SNode wrap(SNode sourceNode) {
    ...
    ListSequence.fromList(SNodeOperations.getNodeDescendants(SLinkOperations.getTarget(method, LINKS.body$5xQk), CONCEPTS.IThisExpression$8h, false, new SAbstractConcept[]{})).visitAll((it) -> SNodeOperations.replaceWithNewChild(it, CONCEPTS.ThisNodeExpression$v1));
