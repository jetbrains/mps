...
public final class ConceptBehavior__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<SNode>> getAllSuperBehaviors_id1$X$vL9L8i8 = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getAllSuperBehaviors").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1818770337282950280L).languageId(0x87d963a55f2a9db1L, 0xaf65afd8f0dd4942L).build2();
  ...
  public static final SMethod<String> getBehaviorFqName_id66HNO1XTVFW = new SMethodBuilder<>(String.class).name("getBehaviorFqName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7038509668547148540L).languageId(0x87d963a55f2a9db1L, 0xaf65afd8f0dd4942L).build2();
