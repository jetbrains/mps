...
/*package*/ class Node_ConceptMethodCall_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public Node_ConceptMethodCall_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createRefCell_0() {
    ...
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.conceptMethodDeclaration$RIoP);
    ...
    provider.setEmptyCellId("empty_" + "conceptMethodDeclaration");
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink conceptMethodDeclaration$RIoP = MetaAdapterFactory.getReferenceLink(0xaf65afd8f0dd4942L, 0x87d963a55f2a9db1L, 0x2ce598bdcf8e55cdL, 0x2ce598bdcf8e59bfL, "conceptMethodDeclaration");
  }
