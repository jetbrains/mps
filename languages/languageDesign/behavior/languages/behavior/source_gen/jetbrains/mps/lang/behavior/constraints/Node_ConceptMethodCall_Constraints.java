...
public class Node_ConceptMethodCall_Constraints extends BaseConstraintsDescriptor {
  /*package*/ Node_ConceptMethodCall_Constraints(ConstraintsDescriptorInitContext initContext) {
    super(CONCEPTS.Node_ConceptMethodCall$RC, initContext);
    record(new RD1(this));
  }
    ...
    public ReferenceScopeProvider getScopeProvider() {
      return new BaseScopeProvider() {
        ...
        public SNodeReference getSearchScopeValidatorNode() {
          return new SNodePointer("r:6786d6ee-e5cc-4a77-9efd-65a8dca8b187(jetbrains.mps.lang.behavior.constraints)", "6302905782373066148");
        }
        @Override
