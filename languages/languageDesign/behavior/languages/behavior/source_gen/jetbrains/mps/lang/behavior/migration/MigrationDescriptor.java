...
public class MigrationDescriptor implements MigrationAspectDescriptor {
  private Map<Integer, MigrationScript> myScripts = MapSequence.fromMapAndEntryArray(new HashMap<Integer, MigrationScript>(), Map.entry(0, new MigrateStaticBehaviorThisAndSuper()), Map.entry(1, new Remove_ConceptMethodDeclaration_IsPrivate_Property()));
