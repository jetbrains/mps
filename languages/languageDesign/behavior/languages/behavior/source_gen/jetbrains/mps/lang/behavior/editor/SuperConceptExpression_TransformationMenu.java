...
public class SuperConceptExpression_TransformationMenu extends TransformationMenuBase {
  public SuperConceptExpression_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "SuperConceptExpression", new SNodePointer("r:dc79d042-ba38-4e91-9392-42f38106ae44(jetbrains.mps.lang.behavior.editor)", "7613853987897845683")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  public class TMP_Group_2w7hld_a1 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_2w7hld_a1() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:dc79d042-ba38-4e91-9392-42f38106ae44(jetbrains.mps.lang.behavior.editor)", "7613853987897845692")));
    }
    @Override
    ...
    private class TMP_Action_2w7hld_a0b extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:dc79d042-ba38-4e91-9392-42f38106ae44(jetbrains.mps.lang.behavior.editor)", "7613853987897845701"));
          return this;
        }
        @Nullable
        @Override
