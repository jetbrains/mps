...
public class SuperConceptExpression_TransformationMenu extends TransformationMenuBase {
  ...
  public class TMP_Group_2w7hld_a1 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected boolean isApplicable(TransformationMenuContext _context) {
      return (SLinkOperations.getTarget(_context.getNode(), LINKS.superConcept$xQVw) == null);
    }
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new TMP_Group_2w7hld_a1.TMP_Action_2w7hld_a0b());
    }
    private class TMP_Action_2w7hld_a0b extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      protected TransformationMenuItem createItem(TransformationMenuContext context) {
        TMP_Group_2w7hld_a1.TMP_Action_2w7hld_a0b.Item item = new TMP_Group_2w7hld_a1.TMP_Action_2w7hld_a0b.Item(context);
        String description;
        try {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        public void execute(@NotNull String pattern) {
          ...
          if (result == null) {
            SLinkOperations.setPointer(_context.getNode(), LINKS.superConcept$xQVw, new SNodePointer("r:00000000-0000-4000-0000-011c89590288(jetbrains.mps.lang.core.structure)", "1133920641626"));
          } else {
            SLinkOperations.setTarget(_context.getNode(), LINKS.superConcept$xQVw, result);
          }
