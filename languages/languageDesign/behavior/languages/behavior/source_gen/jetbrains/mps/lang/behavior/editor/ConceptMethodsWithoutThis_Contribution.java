...
public class ConceptMethodsWithoutThis_Contribution extends SubstituteMenuBase {
  ...
  public class SMP_Group_lcxjkp_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_lcxjkp_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:dc79d042-ba38-4e91-9392-42f38106ae44(jetbrains.mps.lang.behavior.editor)", "1741258697587172257")));
    }
    @Override
