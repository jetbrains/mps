...
public class MigrateScopes extends MigrationScriptBase {
  ...
  private static SNode createCustomScope_9zyy9x_a0a0a0a0m0d0d(SNode node0) {
    ...
    rootBuilder1.forChild(LINKS.scope$fOvw).initNode(node0, CONCEPTS.Expression$TP, true);
  ...
  private static SNode createCustomScope_9zyy9x_a0a0a0a0a21a3a3(SNode node0) {
    ...
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.CustomScope$CZ);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.scope$fOvw).init(CONCEPTS.GenericNewExpression$ev);
      {
        SNodeBuilder n3 = n2.forChild(LINKS.creator$Wnha).init(CONCEPTS.ClassCreator$yU);
        n3.setReference(LINKS.baseMethodDeclaration$ItxI, new SNodePointer(facade.createModelReference("6ed54515-acc8-4d1e-a16c-9fd6cfe951ea/java:jetbrains.mps.project(MPS.Core/)"), facade.createNodeId("~EditableFilteringScope.<init>(org.jetbrains.mps.openapi.module.SearchScope)")));
        {
          SNodeBuilder n4 = n3.forChild(LINKS.actualArgument$ItKJ).initNode(node0, CONCEPTS.Expression$TP, false);
        }
      }
    }
    return rootBuilder1.getResult();
  ...
  private static SNode createCustomScope_9zyy9x_a0a0a0a1m0d0d(SNode node0) {
    ...
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.CustomScope$CZ);
    {
      ...
      {
        SNodeBuilder n3 = n2.forChild(LINKS.creator$Wnha).init(CONCEPTS.ClassCreator$yU);
        n3.setReference(LINKS.baseMethodDeclaration$ItxI, new SNodePointer(facade.createModelReference("6ed54515-acc8-4d1e-a16c-9fd6cfe951ea/java:jetbrains.mps.ide.findusages.model.scopes(MPS.Core/)"), facade.createNodeId("~ModelsScope.<init>(java.lang.Iterable)")));
        {
          SNodeBuilder n4 = n3.forChild(LINKS.actualArgument$ItKJ).initNode(node0, CONCEPTS.Expression$TP, false);
        }
      }
  ...
  private static SNode createCustomScope_9zyy9x_a0a0a0a0b21a3a3(SNode node0) {
    ...
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.CustomScope$CZ);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.scope$fOvw).init(CONCEPTS.GenericNewExpression$ev);
      {
        ...
        n3.setReference(LINKS.baseMethodDeclaration$ItxI, new SNodePointer(facade.createModelReference("6ed54515-acc8-4d1e-a16c-9fd6cfe951ea/java:jetbrains.mps.project(MPS.Core/)"), facade.createNodeId("~EditableFilteringScope.<init>(org.jetbrains.mps.openapi.module.SearchScope)")));
        {
          SNodeBuilder n4 = n3.forChild(LINKS.actualArgument$ItKJ).init(CONCEPTS.GenericNewExpression$ev);
          {
            SNodeBuilder n5 = n4.forChild(LINKS.creator$Wnha).init(CONCEPTS.ClassCreator$yU);
            n5.setReference(LINKS.baseMethodDeclaration$ItxI, new SNodePointer(facade.createModelReference("6ed54515-acc8-4d1e-a16c-9fd6cfe951ea/java:jetbrains.mps.ide.findusages.model.scopes(MPS.Core/)"), facade.createNodeId("~ModelsScope.<init>(java.lang.Iterable)")));
            {
              SNodeBuilder n6 = n5.forChild(LINKS.actualArgument$ItKJ).initNode(node0, CONCEPTS.Expression$TP, false);
            }
          }
        }
      }
  ...
  private static SNode createCustomScope_9zyy9x_a0a0a0a2m0d0d(SNode node0) {
    ...
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.CustomScope$CZ);
    {
      ...
      {
        SNodeBuilder n3 = n2.forChild(LINKS.creator$Wnha).init(CONCEPTS.ClassCreator$yU);
        n3.setReference(LINKS.baseMethodDeclaration$ItxI, new SNodePointer(facade.createModelReference("6ed54515-acc8-4d1e-a16c-9fd6cfe951ea/java:jetbrains.mps.ide.findusages.model.scopes(MPS.Core/)"), facade.createNodeId("~ModulesScope.<init>(java.lang.Iterable)")));
        {
          SNodeBuilder n4 = n3.forChild(LINKS.actualArgument$ItKJ).initNode(node0, CONCEPTS.Expression$TP, false);
        }
      }
    ...
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.CustomScope$CZ);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.scope$fOvw).init(CONCEPTS.GenericNewExpression$ev);
      {
        ...
        n3.setReference(LINKS.baseMethodDeclaration$ItxI, new SNodePointer(facade.createModelReference("6ed54515-acc8-4d1e-a16c-9fd6cfe951ea/java:jetbrains.mps.project(MPS.Core/)"), facade.createNodeId("~EditableFilteringScope.<init>(org.jetbrains.mps.openapi.module.SearchScope)")));
        {
          ...
          {
            SNodeBuilder n5 = n4.forChild(LINKS.creator$Wnha).init(CONCEPTS.ClassCreator$yU);
            n5.setReference(LINKS.baseMethodDeclaration$ItxI, new SNodePointer(facade.createModelReference("6ed54515-acc8-4d1e-a16c-9fd6cfe951ea/java:jetbrains.mps.ide.findusages.model.scopes(MPS.Core/)"), facade.createNodeId("~ModulesScope.<init>(java.lang.Iterable)")));
            {
              SNodeBuilder n6 = n5.forChild(LINKS.actualArgument$ItKJ).initNode(node0, CONCEPTS.Expression$TP, false);
            }
          }
