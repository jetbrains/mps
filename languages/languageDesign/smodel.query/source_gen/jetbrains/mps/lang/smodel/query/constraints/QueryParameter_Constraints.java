...
public class QueryParameter_Constraints extends BaseConstraintsDescriptor {
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    ...
    return Sequence.fromIterable(QueryExpression__BehaviorDescriptor.getSupportedParameters_id3J6h25QXCDW.invoke(SNodeOperations.asSConcept(SNodeOperations.getConcept(SNodeOperations.cast(SNodeOperations.getParent(parentNode), CONCEPTS.QueryExpression$lN))))).contains(SNodeOperations.castConcept(SNodeOperations.asSConcept(childConcept), CONCEPTS.QueryParameter$2S));
  }
