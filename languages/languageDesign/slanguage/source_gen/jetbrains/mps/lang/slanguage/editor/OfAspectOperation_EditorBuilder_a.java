...
import jetbrains.mps.lang.slanguage.editor.AspectName_StyleSheet.AspectRefStyleClass;
...
/*package*/ class OfAspectOperation_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.requestedAspect$fCKn;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.requestedAspect$fCKn);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.requestedAspect$fCKn);
    }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createProperty_0() {
      ...
      try {
        ...
        Style style = new StyleImpl();
        new AspectRefStyleClass(this).apply(style, editorCell);
        editorCell.getStyle().putAll(style);
