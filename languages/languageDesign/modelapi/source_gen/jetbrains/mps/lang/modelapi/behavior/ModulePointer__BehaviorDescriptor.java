...
public final class ModulePointer__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> create_id1Bs_61$mIAC = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("create").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1Bs_61$mIAC").build(SMethodBuilder.createJavaParameter((Class<SModel>) ((Class) Object.class), ""), SMethodBuilder.createJavaParameter(SModuleReference.class, ""));
  public static final SMethod<SModuleReference> toModuleReference_id1Bs_61$mqDd = new SMethodBuilder<SModuleReference>(new SJavaCompoundTypeImpl(SModuleReference.class)).name("toModuleReference").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1Bs_61$mqDd").build();
