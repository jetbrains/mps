...
public class AllRepositoryModels_TM extends TransformationMenuBase {
  public AllRepositoryModels_TM() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "AllRepositoryModels_TM", new SNodePointer("r:7bd127a5-e641-4c13-b150-b9c9b96f76ae(jetbrains.mps.lang.modelapi.editor)", "8301441419087499614")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.SUBSTITUTE).contains(_context.getMenuLocation())) {
      result.add(new TMP_IncludeSM_vzoe4h_a0());
    }
    return result;
  }

  public class TMP_IncludeSM_vzoe4h_a0 extends IncludeSubstituteMenuTransformationMenuPart {
    @NotNull
    @Override
    public List<TransformationMenuItem> createItems(@NotNull TransformationMenuContext context) {
      ...
      try {
        ...
        context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("include substitute menu " + "named substitute menu " + "AllRepositoryModels_SM", new SNodePointer("r:7bd127a5-e641-4c13-b150-b9c9b96f76ae(jetbrains.mps.lang.modelapi.editor)", "3815448882692956574")));
