...
public class NamedNodeReference_ChildTransformationMenu extends TransformationMenuBase {
  public NamedNodeReference_ChildTransformationMenu() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "NamedNodeReference_ChildTransformationMenu", new SNodePointer("r:7bd127a5-e641-4c13-b150-b9c9b96f76ae(jetbrains.mps.lang.modelapi.editor)", "855366892729060217")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new TMP_Action_c3ajtm_a0());
    }
    return result;
  }
  ...
  private class TMP_Action_c3ajtm_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:7bd127a5-e641-4c13-b150-b9c9b96f76ae(jetbrains.mps.lang.modelapi.editor)", "7400021826774870249"));
        return this;
      }
      @Nullable
      @Override
      ...
      public void execute(@NotNull String pattern) {
        ...
        SLinkOperations.setTarget(_context.getNode(), LINKS.child$fAzx, newNode);
