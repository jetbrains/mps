...
public class InterfaceConceptDeclaration_ApplySideTransforms extends TransformationMenuBase {
  public InterfaceConceptDeclaration_ApplySideTransforms() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "InterfaceConceptDeclaration_ApplySideTransforms", new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587240700")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM, MenuLocations.SUBSTITUTE));
  }
