...
public class CreateConceptFromUsageHelper {
  ...
  private static SNode createConceptDeclaration_yye2ek_a0a0n(Object p0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ConceptDeclaration$gH);
  ...
  private static SNode createInterfaceConceptDeclaration_yye2ek_a0a0o(Object p0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.InterfaceConceptDeclaration$CG);
    rootBuilder1.setProperty(PROPS.name$MnvL, PROPS.name$MnvL.getType().toString(p0));
    return rootBuilder1.getResult();
  }
