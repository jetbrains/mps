...
public class CreateFirstDeclaration_ext_3 extends TransformationMenuBase {
  public CreateFirstDeclaration_ext_3() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "CreateFirstDeclaration_ext_3", new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587065213")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new TMP_Group_zaql1a_a0());
    }
    return result;
  }

  public class TMP_Group_zaql1a_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_zaql1a_a0() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587065219")));
    }
    @Override
    protected boolean isApplicable(TransformationMenuContext _context) {
      return ListSequence.fromList(SLinkOperations.getChildren(_context.getNode(), LINKS.linkDeclaration$YU1f)).where((it) -> SEnumOperations.isMember(SPropertyOperations.getEnum(it, PROPS.metaClass$PeKc), 0xfc6f4e95b8L)).isEmpty();
    }
    @Override
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new TMP_Action_zaql1a_a0a(), new TMP_Param_zaql1a_b0a());
    }
    private class TMP_Action_zaql1a_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587065242"));
          return this;
        }
        @Nullable
        @Override
        ...
        public void execute(@NotNull final String pattern) {
          ...
          SPropertyOperations.setEnum(childLink, PROPS.metaClass$PeKc, 0xfc6f4e95b8L, "reference");
    ...
    private class TMP_Param_zaql1a_b0a extends ParameterizedMenuPart<SNode, TransformationMenuItem, TransformationMenuContext> {
      ...
      protected List<TransformationMenuItem> createItems(SNode parameter, TransformationMenuContext context) {
        return new TMP_Action_zaql1a_a1a0(parameter).createItems(context);
      }
      ...
      private class TMP_Action_zaql1a_a1a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
        ...
        private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
          ...
          /*package*/ Item resetTraceInfo() {
            updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587065363"));
            return this;
          }
          @Nullable
          @Override
