...
public final class EnumerationMemberDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getMemberPresentation_idVFd4X$DFGV = new SMethodBuilder<>(String.class).name("getMemberPresentation").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1075010451653704507L).languageId(0x8389f407dc1158b7L, 0xc72da2b97cce4447L).build2();
  public static final SMethod<Boolean> isDefault_idVFd4X$DLvk = new SMethodBuilder<>(Boolean.TYPE).name("isDefault").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1075010451653728212L).languageId(0x8389f407dc1158b7L, 0xc72da2b97cce4447L).build2();
