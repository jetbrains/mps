...
public final class InterfaceConceptDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<SNode>> getAllMethodsInPriorityOrder_id7TwdR6lloGH = new SMethodBuilder<>((Class<List<SNode>>) ((Class) Object.class)).name("getAllMethodsInPriorityOrder").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9106339407519386413L).languageId(0x8389f407dc1158b7L, 0xc72da2b97cce4447L).build2();
  /*package*/ static final SMethod<Void> collectAllMethodsInPriorityOrder_id3waV7Ya5fRc = new SMethodBuilder<>(Void.TYPE).name("collectAllMethodsInPriorityOrder").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(4038300048412704204L).languageId(0x8389f407dc1158b7L, 0xc72da2b97cce4447L).build2(SMethodBuilder.createJavaParameter((Class<List<SNode>>) ((Class) Object.class), "methods"), SMethodBuilder.createJavaParameter((Class<Set<SNode>>) ((Class) Object.class), "concepts"));
