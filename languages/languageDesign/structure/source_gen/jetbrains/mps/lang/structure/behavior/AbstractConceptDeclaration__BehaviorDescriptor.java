...
public final class AbstractConceptDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static SNode findLinkDeclaration_idhEwILKz(@NotNull SNode __thisNode__, String role) {
    return SNodeOperations.cast(ConceptAndSuperConceptsCache.getInstance(__thisNode__).getLinkDeclarationByRole(role), CONCEPTS.LinkDeclaration$1p);
  }
  ...
  /*package*/ static SNode findPropertyDeclaration_idhK3S4A1(@NotNull SNode __thisNode__, String name) {
    return SNodeOperations.cast(ConceptAndSuperConceptsCache.getInstance(__thisNode__).getPropertyDeclarationByName(name), CONCEPTS.PropertyDeclaration$1S);
  }
