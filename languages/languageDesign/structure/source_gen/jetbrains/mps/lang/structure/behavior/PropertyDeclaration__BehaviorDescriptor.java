...
public final class PropertyDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isPrimitiveString_idhT22swA = new SMethodBuilder<>(Boolean.TYPE).name("isPrimitiveString").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1229468583974L).languageId(0x8389f407dc1158b7L, 0xc72da2b97cce4447L).build2();
  public static final SMethod<Boolean> isPrimitiveInteger_idhT23WS5 = new SMethodBuilder<>(Boolean.TYPE).name("isPrimitiveInteger").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1229468978693L).languageId(0x8389f407dc1158b7L, 0xc72da2b97cce4447L).build2();
  public static final SMethod<Boolean> isPrimitiveBoolean_idhT23T2l = new SMethodBuilder<>(Boolean.TYPE).name("isPrimitiveBoolean").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1229468962965L).languageId(0x8389f407dc1158b7L, 0xc72da2b97cce4447L).build2();
  public static final SMethod<SNode> getConceptDeclaration_id2OF3rgRewqT = new SMethodBuilder<>(SNode.class).name("getConceptDeclaration").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3254710223377139385L).languageId(0x8389f407dc1158b7L, 0xc72da2b97cce4447L).build2();
  public static final SMethod<Boolean> is_id4MKjpUYnih4 = new SMethodBuilder<>(Boolean.TYPE).name("is").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5526002086977545284L).languageId(0x8389f407dc1158b7L, 0xc72da2b97cce4447L).build2(SMethodBuilder.createJavaParameter(SProperty.class, "property"));
