...
public final class SmartRefAttributeUtil {
  ...
  public static SNode extractAttribute(SNode concept) {
    ...
    SNode attr = new IAttributeDescriptor.NodeAttribute(CONCEPTS.SmartReferenceAttribute$B3).get(concept);
    if (attr != null) {
      return attr;
    }
    // checkforimplicitsmartreference
  ...
  public static boolean isAttributedImplicitly(SNode concept) {
    return (new IAttributeDescriptor.NodeAttribute(CONCEPTS.SmartReferenceAttribute$B3).get(concept) == null) && canBeAttributedImplicitly(concept);
  }
  ...
  public static SNode getCharacteristicLinkDeclaration(SNode concept) {
    ...
    if ((new IAttributeDescriptor.NodeAttribute(CONCEPTS.SmartReferenceAttribute$B3).get(concept) != null)) {
      return SLinkOperations.getTarget(new IAttributeDescriptor.NodeAttribute(CONCEPTS.SmartReferenceAttribute$B3).get(concept), LINKS.charactersticReference$41pR);
    } else {
