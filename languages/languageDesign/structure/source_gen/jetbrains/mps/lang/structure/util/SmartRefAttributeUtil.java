...
public final class SmartRefAttributeUtil {
  ...
  private static SNode createSmartReferenceAttribute_9k4hui_a0a5a4(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.SmartReferenceAttribute$B3);
    rootBuilder1.setReferenceTarget(LINKS.charactersticReference$41pR, node0);
