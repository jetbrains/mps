...
public class CreateFirstDeclaration extends TransformationMenuBase {
  public CreateFirstDeclaration() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "CreateFirstDeclaration", new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587065619")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.RIGHT_SIDE_TRANSFORM).contains(_context.getMenuLocation())) {
      result.add(new TMP_Group_ofqub7_a0());
    }
    return result;
  }

  public class TMP_Group_ofqub7_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_ofqub7_a0() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587065625")));
    }
    @Override
    ...
    private class TMP_Action_ofqub7_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587065635"));
          return this;
        }
        @Nullable
        @Override
        ...
        public void execute(@NotNull final String pattern) {
          SNode property = SNodeFactoryOperations.addNewChild(_context.getNode(), LINKS.propertyDeclaration$YUgg, null);
    ...
    private class TMP_Param_ofqub7_b0a extends ParameterizedMenuPart<SNode, TransformationMenuItem, TransformationMenuContext> {
      /*package*/ TMP_Param_ofqub7_b0a() {
        super(new EditorMenuDescriptorBase("parameterized transformation menu part", new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587065716")));
      }
      @NotNull
      @Override
      ...
      private class TMP_Action_ofqub7_a1a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
        ...
        private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
          ...
          /*package*/ Item resetTraceInfo() {
            updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587065749"));
            return this;
          }
          @Nullable
          @Override
          ...
          public void execute(@NotNull String pattern) {
            SNode property = SNodeFactoryOperations.addNewChild(_context.getNode(), LINKS.propertyDeclaration$YUgg, null);
            SLinkOperations.setTarget(property, LINKS.dataType$5j5Y, myParameterObject);
