...
public class LinkDeclaration_SubstituteMenu extends SubstituteMenuBase {
  ...
  public class SMP_Group_3looc_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_3looc_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:00000000-0000-4000-0000-011c8959028d(jetbrains.mps.lang.structure.editor)", "1741258697587094709")));
    }
    @Override
    ...
    private class SMP_Param_3looc_a0 extends ParameterizedMenuPart<SNode, SubstituteMenuItem, SubstituteMenuContext> {
      ...
      protected Iterable<? extends SNode> getParameters(SubstituteMenuContext _context) {
        return Sequence.fromIterable(SNodeOperations.ofConcept(Scopes.forConcepts(_context.getParentNode(), CONCEPTS.AbstractConceptDeclaration$KA).getAvailableElements(""), CONCEPTS.AbstractConceptDeclaration$KA)).where(new NotNullWhereFilter()).toList();
      }
