...
public final class EnumerationDataTypeDeclaration_Old__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getDefaultMember_idhEwIM$p = new SMethodBuilder<>(SNode.class).name("getDefaultMember").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877397785L).languageId(0x8389f407dc1158b7L, 0xc72da2b97cce4447L).build2();
