...
public final class EnumerationDataTypeDeclaration_Old__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getDefaultMember_idhEwIM$p = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getDefaultMember").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("hEwIM$p").build();
