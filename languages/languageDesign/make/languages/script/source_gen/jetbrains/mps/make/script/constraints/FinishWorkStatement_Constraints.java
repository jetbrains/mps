...
public class FinishWorkStatement_Constraints extends BaseConstraintsDescriptor {
  public FinishWorkStatement_Constraints() {
    super(CONCEPTS.FinishWorkStatement$Er);
  }

  @Override
  protected Map<SReferenceLink, ReferenceConstraintsDescriptor> getSpecifiedReferences() {
    BaseReferenceConstraintsDescriptor d0 = new BaseReferenceConstraintsDescriptor(LINKS.workStatement$Egbq, this) {
      @Override
      ...
      public ReferenceScopeProvider getScopeProvider() {
        return new BaseScopeProvider() {
          ...
          public SNodeReference getSearchScopeValidatorNode() {
            return breakingNode_tiy6xt_a0a2a0a0a1a0a0a0c;
          }
          @Override
  ...
  private static final SNodePointer breakingNode_tiy6xt_a0a2a0a0a1a0a0a0c = new SNodePointer("r:56325792-0540-48ec-8d52-897a8821cc64(jetbrains.mps.make.script.constraints)", "6836281137582794403");
