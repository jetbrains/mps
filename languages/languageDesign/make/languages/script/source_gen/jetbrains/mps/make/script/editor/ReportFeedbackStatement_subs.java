...
public class ReportFeedbackStatement_subs extends SubstituteMenuBase {
  public ReportFeedbackStatement_subs() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "ReportFeedbackStatement_subs", new SNodePointer("r:997bd332-957d-4e59-bb10-bc8a630d5568(jetbrains.mps.make.script.editor)", "1741258697587105220")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_hskkdq_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_hskkdq_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:997bd332-957d-4e59-bb10-bc8a630d5568(jetbrains.mps.make.script.editor)", "1741258697587105222")));
    }
    @Override
    ...
    private class SMP_Param_hskkdq_a0 extends ParameterizedMenuPart<SEnumerationLiteral, SubstituteMenuItem, SubstituteMenuContext> {
      /*package*/ SMP_Param_hskkdq_a0() {
        super(new EditorMenuDescriptorBase("parameterized substitute menu part", new SNodePointer("r:997bd332-957d-4e59-bb10-bc8a630d5568(jetbrains.mps.make.script.editor)", "1741258697587105260")));
      }
      @NotNull
      @Override
      ...
      private class SMP_Action_hskkdq_a0a extends SingleItemSubstituteMenuPart {
        ...
        private class Item extends DefaultSubstituteMenuItem {
          ...
          /*package*/ void resetTraceInfo() {
            ...
            updateTraceInfo(description, new SNodePointer("r:997bd332-957d-4e59-bb10-bc8a630d5568(jetbrains.mps.make.script.editor)", "1741258697587105293"));
          }
