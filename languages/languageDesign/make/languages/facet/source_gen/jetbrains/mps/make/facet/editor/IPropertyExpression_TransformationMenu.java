...
public class IPropertyExpression_TransformationMenu extends TransformationMenuBase {
  ...
  public class TMP_Group_j2qvk8_a1 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_j2qvk8_a1.TMP_Action_j2qvk8_a0b(), CONCEPTS.ResourceSpecificPropertiesExpression$vx));
    }
