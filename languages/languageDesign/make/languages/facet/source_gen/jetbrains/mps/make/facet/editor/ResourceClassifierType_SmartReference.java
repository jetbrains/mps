...
public class ResourceClassifierType_SmartReference extends SubstituteMenuBase {
  public ResourceClassifierType_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "ResourceClassifierType_SmartReference", new SNodePointer("r:53dc5a43-c15e-4a00-8af6-c42420ba30d9(jetbrains.mps.make.facet.editor)", "4747359941571311347")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_vyxpf0_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_vyxpf0_a() {
      super(CONCEPTS.ResourceClassifierType$$Z, LINKS.classifier$cxMr, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:53dc5a43-c15e-4a00-8af6-c42420ba30d9(jetbrains.mps.make.facet.editor)", "4747359941571311345")));
    }
