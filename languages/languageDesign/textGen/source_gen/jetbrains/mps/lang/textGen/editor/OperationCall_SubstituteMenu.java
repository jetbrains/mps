...
public class OperationCall_SubstituteMenu extends SubstituteMenuBase {
  public OperationCall_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for OperationCall. Generated from implicit smart reference attribute.", new SNodePointer("r:de0d3c0c-d049-41cf-bbf9-a920ba513cd3(jetbrains.mps.lang.textGen.structure)", "1233924848298")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_pkbewp_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_pkbewp_a() {
      super(CONCEPTS.OperationCall$Zk, LINKS.function$S4s1, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }
  ...
  public class SMP_Subconcepts_pkbewp_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.OperationCall$Zk);
    }
