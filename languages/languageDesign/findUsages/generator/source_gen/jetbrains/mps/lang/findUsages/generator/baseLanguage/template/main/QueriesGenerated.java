...
public class QueriesGenerated extends QueryProviderBase {
  ...
  public static Object propertyMacro_GetValue_0_0(final PropertyMacroContext _context) {
    return (String) FinderDeclaration__BehaviorDescriptor.getGeneratedClassLongName_idhEwIc4S.invoke(SLinkOperations.getTarget(_context.getNode(), LINKS.finder$rHsq));
  }
  ...
  public static Object propertyMacro_GetValue_1_1(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(_context.getNode(), PROPS.description$TObG);
  }
  public static Object propertyMacro_GetValue_1_2(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(_context.getNode(), PROPS.longDescription$dF8v);
  }
  public static Object propertyMacro_GetValue_1_3(final PropertyMacroContext _context) {
    SNode body = SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.findFunction$tZ7C), LINKS.body$pTP2);
    return ListSequence.fromList(SNodeOperations.getNodeDescendantsWhereConceptInList(body, new SAbstractConcept[]{CONCEPTS.ExecuteFinderExpression$OP, CONCEPTS.ExecuteFindersGetSearchResults$Nw, CONCEPTS.OnEachNodeFoundByExpression$R}, false, new SAbstractConcept[]{})).count();
  }
  public static Object propertyMacro_GetValue_1_4(final PropertyMacroContext _context) {
    return TracingUtil.getInput(_context.getNode()).getNodeId().toString();
  }
  public static Object propertyMacro_GetValue_4_0(final PropertyMacroContext _context) {
    return (String) FinderDeclaration__BehaviorDescriptor.getGeneratedClassLongName_idhEwIc4S.invoke(SLinkOperations.getTarget(_context.getNode(), LINKS.finder$Ugy_));
  }
  ...
  public static Object propertyMacro_GetValue_6_1(final PropertyMacroContext _context) {
    ...
    assert SNodeOperations.isInstanceOf(module, CONCEPTS.Language$jx);
  ...
  public static Object propertyMacro_GetValue_6_4(final PropertyMacroContext _context) {
    return NameUtil.toValidIdentifier(SPropertyOperations.getString(_context.getNode(), PROPS.name$tAp1));
  }
  public static Object propertyMacro_GetValue_8_0(final PropertyMacroContext _context) {
    return SPropertyOperations.getString(ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(_context.getNode(), LINKS.callback$SWfR), LINKS.parameter$WRt7)).first(), PROPS.name$tAp1);
  }
  public static Object propertyMacro_GetValue_8_1(final PropertyMacroContext _context) {
    return (String) FinderDeclaration__BehaviorDescriptor.getGeneratedClassLongName_idhEwIc4S.invoke(SLinkOperations.getTarget(_context.getNode(), LINKS.finder$rHsq));
  }
  public static Object referenceMacro_GetReferent_1_0(final ReferenceMacroContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.forConcept$vx0W);
  }
  ...
  public static boolean ifMacro_Condition_0_0(final IfMacroContext _context) {
    return (SLinkOperations.getTarget(_context.getNode(), LINKS.progress$zzEL) != null);
  }
  public static boolean ifMacro_Condition_0_1(final IfMacroContext _context) {
    return (SLinkOperations.getTarget(_context.getNode(), LINKS.scope$zzEi) != null);
  }
  public static boolean ifMacro_Condition_1_0(final IfMacroContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.isVisibleBlock$k_SI) != null;
  }
  ...
  public static boolean ifMacro_Condition_1_2(final IfMacroContext _context) {
    return (SLinkOperations.getTarget(_context.getNode(), LINKS.isUsedByDefault$SElg) != null);
  }
  public static boolean ifMacro_Condition_1_3(final IfMacroContext _context) {
    return SPropertyOperations.getString(_context.getNode(), PROPS.description$TObG) != null && !(SPropertyOperations.getString(_context.getNode(), PROPS.description$TObG).equals(""));
  }
  public static boolean ifMacro_Condition_1_4(final IfMacroContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.isApplicableFunction$tZ79) != null;
  }
  public static boolean ifMacro_Condition_1_5(final IfMacroContext _context) {
    return ListSequence.fromList(SNodeOperations.getNodeDescendants(SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.findFunction$tZ7C), LINKS.body$pTP2), CONCEPTS.ConceptFunctionParameter_progressMonitor$UB, false, new SAbstractConcept[]{})).isEmpty();
  }
  public static boolean ifMacro_Condition_1_6(final IfMacroContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.searchedNodesBlock$tZ87) != null;
  }
  public static boolean ifMacro_Condition_1_7(final IfMacroContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.categorizeBlock$tZ8A) != null;
  }
  ...
  public static boolean ifMacro_Condition_4_0(final IfMacroContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.queryScope$Ugx8) == null;
  }
  public static boolean ifMacro_Condition_4_1(final IfMacroContext _context) {
    SNode ancestor = SNodeOperations.getNodeAncestor(_context.getNode(), CONCEPTS.FindBlock$3f, false, false);
    return ancestor != null && ((SLinkOperations.getTarget(_context.getNode(), LINKS.monitor$_VEk) != null) || ListSequence.fromList(SNodeOperations.getNodeDescendants(SLinkOperations.getTarget(ancestor, LINKS.body$pTP2), CONCEPTS.ConceptFunctionParameter_progressMonitor$UB, false, new SAbstractConcept[]{})).isEmpty());
  }
  public static boolean ifMacro_Condition_4_2(final IfMacroContext _context) {
    return (SLinkOperations.getTarget(_context.getNode(), LINKS.monitor$_VEk) == null);
  }
  public static boolean ifMacro_Condition_8_0(final IfMacroContext _context) {
    SNode ancestor = SNodeOperations.getNodeAncestor(_context.getNode(), CONCEPTS.FindBlock$3f, false, false);
    return ancestor != null && ((SLinkOperations.getTarget(_context.getNode(), LINKS.monitor$VTPu) != null) || ListSequence.fromList(SNodeOperations.getNodeDescendants(SLinkOperations.getTarget(ancestor, LINKS.body$pTP2), CONCEPTS.ConceptFunctionParameter_progressMonitor$UB, false, new SAbstractConcept[]{})).isEmpty());
  }
  public static boolean ifMacro_Condition_8_1(final IfMacroContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.monitor$VTPu) != null;
  }
  ...
  public static boolean ifMacro_Condition_8_3(final IfMacroContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.queryScope$VTOZ) == null;
  }
  public static SNode sourceNodeQuery_0_0(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.progress$zzEL);
  }
  public static SNode sourceNodeQuery_0_1(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.queryNode$zzDN);
  }
  public static SNode sourceNodeQuery_0_2(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.scope$zzEi);
  }
  public static SNode sourceNodeQuery_0_3(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.finder$c0Aw);
  }
  public static SNode sourceNodeQuery_1_0(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.isVisibleBlock$k_SI), LINKS.body$pTP2);
  }
  public static SNode sourceNodeQuery_1_1(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.isUsedByDefault$SElg), LINKS.body$pTP2);
  }
  public static SNode sourceNodeQuery_1_2(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.isApplicableFunction$tZ79), LINKS.body$pTP2);
  }
  public static SNode sourceNodeQuery_1_3(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.findFunction$tZ7C), LINKS.body$pTP2);
  }
  public static SNode sourceNodeQuery_1_4(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.searchedNodesBlock$tZ87), LINKS.body$pTP2);
  }
  public static SNode sourceNodeQuery_1_5(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.categorizeBlock$tZ8A), LINKS.body$pTP2);
  }
  public static SNode sourceNodeQuery_2_0(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.foundNode$xYfy);
  }
  public static SNode sourceNodeQuery_3_0(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.foundNode$FNMs);
  }
  public static SNode sourceNodeQuery_4_0(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.queryNode$UgwD);
  }
  public static SNode sourceNodeQuery_4_1(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.queryScope$Ugx8);
  }
  public static SNode sourceNodeQuery_4_2(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.monitor$_VEk);
  }
  public static SNode sourceNodeQuery_8_0(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.monitor$VTPu);
  }
  ...
  public static SNode sourceNodeQuery_8_2(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.callback$SWfR), LINKS.body$DJEC);
  }
  public static SNode sourceNodeQuery_8_3(final SourceSubstituteMacroNodeContext _context) {
    return SLinkOperations.getTarget(_context.getNode(), LINKS.queryNode$VTOw);
  }
  ...
  public static Iterable<SNode> sourceNodesQuery_0_1(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(_context.getNode(), LINKS.finder$N620);
  }
  ...
  public static Iterable<SNode> sourceNodesQuery_8_0(final SourceSubstituteMacroNodesContext _context) {
    return SLinkOperations.getChildren(_context.getNode(), LINKS.finders$mMCT);
  }
  public static Object varMacro_Value_6_0(final TemplateVarContext _context) {
    return ListSequence.fromList(SModelOperations.roots(_context.getInputModel(), CONCEPTS.FinderDeclaration$5E)).sort(new ISelector<SNode, String>() {
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SReferenceLink finder$Ugy_ = MetaAdapterFactory.getReferenceLink(0x64d34fcdad024e73L, 0xaff8a581124c2e30L, 0x118d6fce801L, 0x118d6fce808L, "finder");
    ...
    /*package*/ static final SContainmentLink finder$c0Aw = MetaAdapterFactory.getContainmentLink(0x64d34fcdad024e73L, 0xaff8a581124c2e30L, 0x5e9f5a0f21d59aacL, 0x5e9f5a0f21d59aadL, "finder");
    /*package*/ static final SContainmentLink foundNode$xYfy = MetaAdapterFactory.getContainmentLink(0x64d34fcdad024e73L, 0xaff8a581124c2e30L, 0x1177408145aL, 0x11774086327L, "foundNode");
    /*package*/ static final SContainmentLink foundNode$FNMs = MetaAdapterFactory.getContainmentLink(0x64d34fcdad024e73L, 0xaff8a581124c2e30L, 0x1177404a3f4L, 0x117740540a3L, "foundNode");
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept ExecuteFindersGetSearchResults$Nw = MetaAdapterFactory.getConcept(0x64d34fcdad024e73L, 0xaff8a581124c2e30L, 0x1bd5a514384e1959L, "jetbrains.mps.lang.findUsages.structure.ExecuteFindersGetSearchResults");
    ...
    /*package*/ static final SConcept ConceptFunctionParameter_progressMonitor$UB = MetaAdapterFactory.getConcept(0x13744753c81f424aL, 0x9c1bcf8943bf4e86L, 0x7be6ee9831c8594L, "jetbrains.mps.lang.sharedConcepts.structure.ConceptFunctionParameter_progressMonitor");
