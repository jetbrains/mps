...
public final class OnEachNodeFoundByExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static Scope getScope_id52_Geb4QDV$(@NotNull SNode __thisNode__, SAbstractConcept kind, SNode child) {
    return ScopeProvider__BehaviorDescriptor.getScope_id52_Geb4QDV$.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.callback$Mbt7), kind, child);
  }
  /*package*/ static Scope getScope_id52_Geb4QFgX(@NotNull SNode __thisNode__, SAbstractConcept kind, SContainmentLink link, int index) {
    return ScopeProvider__BehaviorDescriptor.getScope_id52_Geb4QFgX.invoke(SLinkOperations.getTarget(__thisNode__, LINKS.callback$Mbt7), kind, link, ((int) index));
  }
