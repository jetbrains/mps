...
public class typeof_ResultStatement2_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  private static SNode createClassifierType_b1nqsi_a1a0c0a0b() {
    ...
    rootBuilder1.setReference(LINKS.classifier$xslD, new SNodePointer(facade.createModelReference("r:d98d04fb-4a60-4106-81cf-6cb40b67de4d(jetbrains.mps.ide.findusages.model)"), facade.createNodeId("847291649004063609")));
