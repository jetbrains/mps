...
public class typeof_TypedDefReference_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode defRef, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if (type == null) {
      type = TypedDef__BehaviorDescriptor.getErasedType_id4JP_D2W1aPH.invoke(SLinkOperations.getTarget(defRef, MetaAdapterFactory.getReferenceLink(0xea3159bff48e4720L, 0xbde286dba75f0d34L, 0x6530303593574311L, 0x6530303593578e5eL, "declaration")));
    }

    {
      SNode _nodeToCheck_1029348928467 = defRef;
      EquationInfo _info_12389875345 = new EquationInfo(_nodeToCheck_1029348928467, null, "r:81761937-d5e4-4286-86d9-adeda96624b1(jetbrains.mps.lang.context.defs.typesystem)", "7291380803376377960", 0, null);
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:81761937-d5e4-4286-86d9-adeda96624b1(jetbrains.mps.lang.context.defs.typesystem)", "7291380803376377535", true), (SNode) type, _info_12389875345);
    }
  }
