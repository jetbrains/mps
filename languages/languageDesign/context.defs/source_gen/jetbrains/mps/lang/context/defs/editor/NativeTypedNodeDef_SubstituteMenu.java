...
public class NativeTypedNodeDef_SubstituteMenu extends SubstituteMenuBase {
  public NativeTypedNodeDef_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "NativeTypedNodeDef", new SNodePointer("r:5441ac19-e3a2-4d9e-bc0b-a714425f0db4(jetbrains.mps.lang.context.defs.editor)", "315923949159207193")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_lvcjtg_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_lvcjtg_a() {
      super(CONCEPTS.NativeTypedNodeDef$PM, LINKS.conceptParameter$gT_9, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:5441ac19-e3a2-4d9e-bc0b-a714425f0db4(jetbrains.mps.lang.context.defs.editor)", "315923949159506997")));
    }
