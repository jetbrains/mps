...
@Generated
public class Template_reduce_Model_NodesOperation extends TemplateDeclarationBase {

  public Template_reduce_Model_NodesOperation() {
    super(new MO());
  }
    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      }
      {
        ...
        if (QueriesGenerated.ifMacro_Condition_26_0(new IfMacroContext(context1, ifMacroRef_6tyzcg_b0a0b0e0c0g))) {
          ...
          {
            final SNode switchInput5 = QueriesGenerated.sourceNodeQuery_26_1(new SourceSubstituteMacroNodeContext(context1, switchMacroRef_6tyzcg_b0a0a0a1a1a4a2a6));
            if (switchInput5 == null) {
              ...
              tlist5 = environment.trySwitch(templateSwitchNode_6tyzcg_a0a0c0a1a1a1a4a2a6, switchContext5);
              if (tlist5 == null) {
