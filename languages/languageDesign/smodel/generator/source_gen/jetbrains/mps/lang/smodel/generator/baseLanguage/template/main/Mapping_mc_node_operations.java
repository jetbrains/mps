...
public class Mapping_mc_node_operations extends MapConfigBase implements TemplateMappingConfiguration {
  public Mapping_mc_node_operations(@NotNull TemplateModel model) {
    super(new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1139619842725"), "mc_node_operations", model, false, new MO());
  }
  @Override
