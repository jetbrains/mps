...
public class Template_reduce_LanguageId_SLanguage extends TemplateDeclarationBase {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    context1 = context1.withVariable("var:idValue", QueriesGenerated.varMacro_Value_84_0(new TemplateVarContext(context1, new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2409421742521904787"))));
    final SNode tnode2 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      }
      {
        ...
        SNodeAccessUtil.setPropertyValue(tnode5, myProperties[1], QueriesGenerated.propertyMacro_GetValue_84_2(new PropertyMacroContext(context2, "", propertyMacro2)));
