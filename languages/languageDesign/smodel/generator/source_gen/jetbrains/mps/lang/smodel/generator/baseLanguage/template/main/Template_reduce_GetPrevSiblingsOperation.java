...
public class Template_reduce_GetPrevSiblingsOperation extends TemplateDeclarationBase {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      environment.associate(tnode1, myAssociationLinks[1], "r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)", "6599163591527294180");
      TemplateContext context1 = context.subContext();
      {
        Collection<SNode> tlist2 = null;
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_18_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_ha6uio_b0a0c0d0c0g));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_ha6uio_b0a0c0d0c0g, "tpl/r:00000000-0000-4000-0000-011c89590303/1145573188506", context1);
        environment.aggregate(tnode1, myAggregationLinks[0], tlist2);
      }
      {
        final SNode tnode3 = environment.createOutputNode(myConcepts[1]);
        SNodeAccessUtil.setPropertyValue(tnode3, myProperties[0], QueriesGenerated.propertyMacro_GetValue_18_0(new PropertyMacroContext(context1, null, propertyMacro_ha6uio_c0a2a0a1a4a2a6)));
  ...
  private static final SNodePointer copySrcMacro_ha6uio_b0a0c0d0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1145573188507");
  private static final SNodePointer propertyMacro_ha6uio_c0a2a0a1a4a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1145573188509");
}
