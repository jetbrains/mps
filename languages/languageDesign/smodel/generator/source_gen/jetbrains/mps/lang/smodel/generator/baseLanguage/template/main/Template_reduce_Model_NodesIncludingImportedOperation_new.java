...
public class Template_reduce_Model_NodesIncludingImportedOperation_new extends TemplateDeclarationBase {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_43_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro, "tpl/r:00000000-0000-4000-0000-011c89590303/5443371287119273267", context1);
        environment.aggregate(tnode1, myAggregationLinks[0], tlist2);
      }
      {
        Collection<SNode> tlist3 = Collections.emptyList();
        if (QueriesGenerated.ifMacro_Condition_43_0(new IfMacroContext(context1, ifMacroRef))) {
          Collection<SNode> tlist4 = null;
          {
            final SNode switchInput4 = QueriesGenerated.sourceNodeQuery_43_1(new SourceSubstituteMacroNodeContext(context1, switchMacroRef));
  ...
  private static final SNodePointer copySrcMacro = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "5443371287119273268");
  private static final SNodePointer switchMacroRef = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6750920497477170815");
  ...
  private static final SNodePointer ifMacroRef = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6750920497477166897");
}
