...
public class Template_reduce_NodeIdentity_SNodeReference extends TemplateDeclarationBase {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    context1 = context1.withVariable("var:targetRef", QueriesGenerated.varMacro_Value_118_0(new TemplateVarContext(context1, new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2409421742521904827"))));
      ...
      TemplateContext context2 = context1.subContext();
      {
        final SNode tnode3 = environment.createOutputNode(myConcepts[1]);
        {
          ...
          TemplateContext context3 = context2.subContext();
          {
            ...
            SNodeAccessUtil.setPropertyValue(tnode4, myProperties[0], QueriesGenerated.propertyMacro_GetValue_118_0(new PropertyMacroContext(context3, "modelUID", propertyMacro)));
            environment.aggregate(tnode3, myAggregationLinks[0], tnode4);
          }
          {
            final SNode tnode5 = environment.createOutputNode(myConcepts[2]);
            SNodeAccessUtil.setPropertyValue(tnode5, myProperties[0], QueriesGenerated.propertyMacro_GetValue_118_1(new PropertyMacroContext(context3, "nodeID", propertyMacro1)));
