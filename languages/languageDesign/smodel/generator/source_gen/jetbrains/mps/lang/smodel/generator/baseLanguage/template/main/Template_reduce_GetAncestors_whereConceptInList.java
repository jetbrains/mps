...
public class Template_reduce_GetAncestors_whereConceptInList extends TemplateDeclarationBase {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      ...
      tnode1.setReference(myAssociationLinks[1], SReference.create(myAssociationLinks[1], tnode1, PersistenceFacade.getInstance().createModelReference("r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)"), PersistenceFacade.getInstance().createNodeId("6599163591527293626")));
      TemplateContext context1 = context.subContext();
      {
        Collection<SNode> tlist2 = null;
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_37_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_tfk7rm_b0a0c0d0c0g));
          ...
          TemplateContext context2 = context1.subContext();
          {
            ...
            try {
              ...
              }
              {
                ...
                final Iterable<SNode> loopList7 = QueriesGenerated.sourceNodesQuery_37_0(new SourceSubstituteMacroNodesContext(context3, loopMacroRef_tfk7rm_b0a0a1a2a1a1a1a4a2a6));
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode10, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_37_0(new PropertyMacroContext(context1, null, propertyMacro_tfk7rm_c0a0c0a0b0f0c0g))));
        } finally {
        }
  ...
  private static final SNodePointer propertyMacro_tfk7rm_c0a0c0a0b0f0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1173123508504");
}
