    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      }
      {
        ...
        if (QueriesGenerated.ifMacro_Condition_38_0(new IfMacroContext(context1, ifMacroRef_eixwn7_b0a0b0e0c0g))) {
          ...
          {
            final SNode switchInput4 = QueriesGenerated.sourceNodeQuery_38_1(new SourceSubstituteMacroNodeContext(context1, switchMacroRef_eixwn7_b0a0a0a1a1a4a2a6));
            if (switchInput4 == null) {
              ...
              tlist4 = environment.trySwitch(templateSwitchNode_eixwn7_a0a0c0a1a1a1a4a2a6, switchContext4);
              if (tlist4 == null) {
