...
@Generated
public class Template_reduce_Model_RootsIncludingImportedOperation_new extends TemplateDeclarationBase {

  public Template_reduce_Model_RootsIncludingImportedOperation_new() {
    super(new MO());
  }
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_38_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_eixwn7_b0a0c0d0c0g));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_eixwn7_b0a0c0d0c0g, "tpl/r:00000000-0000-4000-0000-011c89590303/2702976628215407192", context1);
      ...
      }
      {
        ...
        if (QueriesGenerated.ifMacro_Condition_38_0(new IfMacroContext(context1, ifMacroRef_eixwn7_b0a0b0e0c0g))) {
          Collection<SNode> tlist5 = null;
          {
            final SNode switchInput5 = QueriesGenerated.sourceNodeQuery_38_1(new SourceSubstituteMacroNodeContext(context1, switchMacroRef_eixwn7_b0a0a0a1a1a4a2a6));
            if (switchInput5 == null) {
              ...
              tlist5 = environment.trySwitch(templateSwitchNode_eixwn7_a0a0c0a1a1a1a4a2a6, switchContext5);
              if (tlist5 == null) {
  ...
  private static final SNodePointer copySrcMacro_eixwn7_b0a0c0d0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2702976628215407193");
  private static final SNodePointer switchMacroRef_eixwn7_b0a0a0a1a1a4a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6750920497477158674");
  private static final SNodePointer templateSwitchNode_eixwn7_a0a0c0a1a1a1a4a2a6 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3902354333653355606");
  private static final SNodePointer ifMacroRef_eixwn7_b0a0b0e0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6750920497477157899");
}
