...
public class Switch_switch_EnumOperation_Old extends TemplateSwitchBase implements TemplateSwitchMapping {
  ...
  public Switch_switch_EnumOperation_Old() {
    rules = TemplateUtil.<TemplateReductionRule>asIterable(new Switch_switch_EnumOperation_Old.ReductionRule0(), new Switch_switch_EnumOperation_Old.ReductionRule1(), new Switch_switch_EnumOperation_Old.ReductionRule2(), new Switch_switch_EnumOperation_Old.ReductionRule3());
  }
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      try {
        ...
        TemplateContext context1 = context.subContext();
        {
          ...
          SNode callInputNode2 = QueriesGenerated.sourceNodeQuery_117_0(new SourceSubstituteMacroNodeContext(context1, callMacro_vmdyp3_b0a0a1a3a2a1h));
        ...
        }
        {
          ...
          try {
            SNodeAccessUtil.setProperty(tnode4, MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x3b418722717710b4L, 0x3b418722717710b5L, "value"), TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_117_0(new PropertyMacroContext(context1, "1L", propertyMacro_vmdyp3_c0a0c0a0b0e0c0b7))));
          } finally {
          }
        ...
        }
        {
          ...
          if (QueriesGenerated.ifMacro_Condition_117_0(new IfMacroContext(context1, ifMacroRef_vmdyp3_b0a0b0f0c0b7))) {
            ...
            try {
              SNodeAccessUtil.setProperty(tnode6, MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf93d565d10L, 0xf93d565d11L, "value"), TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_117_1(new PropertyMacroContext(context1, "v", propertyMacro_vmdyp3_c0a0c0a0b0b0f0c0b7))));
            } finally {
            }
  ...
  /*package*/ static final class ReductionRule1 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      try {
        ...
        {
          Collection<SNode> tlist2 = null;
          SNode callInputNode2 = QueriesGenerated.sourceNodeQuery_117_1(new SourceSubstituteMacroNodeContext(context1, callMacro_vmdyp3_b0a0a1a3a2a1i));
          TemplateContext context2;
          context2 = context1.subContext(null, callInputNode2);
          if (callInputNode2 != null) {
            tlist2 = new Template_reduce_EnumDeclaration_indentityValueSequence().apply(environment, context2);
  ...
  /*package*/ static final class ReductionRule2 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      try {
        ...
        {
          Collection<SNode> tlist2 = null;
          final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_117_2(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_vmdyp3_b0a0c0d0c0b9));
          tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro_vmdyp3_b0a0c0d0c0b9, "tpl/r:00000000-0000-4000-0000-011c89590303/2733396919553280458", context1);
          for (SNode child3 : TemplateUtil.asNotNull(tlist2)) {
            tnode1.addChild(MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x11857355952L, 0xf8c78301aeL, "actualArgument"), child3);
          }
          // TODO validate child 
        }
        {
          ...
          SNode callInputNode4 = QueriesGenerated.sourceNodeQuery_117_3(new SourceSubstituteMacroNodeContext(context1, callMacro_vmdyp3_b0a0a1a4a2a1j));
          TemplateContext context2;
  ...
  /*package*/ static final class ReductionRule3 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      try {
        ...
        {
          Collection<SNode> tlist2 = null;
          if (QueriesGenerated.ifMacro_Condition_117_1(new IfMacroContext(context1, ifMacroRef_vmdyp3_b0a0b0d0c0b01))) {
            ...
            try {
              ...
              {
                Collection<SNode> tlist5 = null;
                final SNode copySrcInput5 = QueriesGenerated.sourceNodeQuery_117_5(new SourceSubstituteMacroNodeContext(context2, copySrcMacro_vmdyp3_b0a0c0c0b0b0d0c0b01));
                tlist5 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput5), copySrcMacro_vmdyp3_b0a0c0c0b0b0d0c0b01, "tpl/r:00000000-0000-4000-0000-011c89590303/2733396919553298545", context2);
            ...
            final SNode copySrcInput7 = QueriesGenerated.sourceNodeQuery_117_4(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_vmdyp3_b0a0c0a1a3a2a1k));
            tlist7 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput7), copySrcMacro_vmdyp3_b0a0c0a1a3a2a1k, "tpl/r:00000000-0000-4000-0000-011c89590303/2733396919553298532", context1);
            tlist2 = tlist7;
          }
        ...
        }
        {
          ...
          SNode callInputNode9 = QueriesGenerated.sourceNodeQuery_117_6(new SourceSubstituteMacroNodeContext(context1, callMacro_vmdyp3_b0a0a1a4a2a1k));
  ...
  private static SNodePointer callMacro_vmdyp3_b0a0a1a3a2a1h = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2733396919553278886");
  private static SNodePointer propertyMacro_vmdyp3_c0a0c0a0b0e0c0b7 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2733396919553278888");
  private static SNodePointer propertyMacro_vmdyp3_c0a0c0a0b0b0f0c0b7 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2733396919553278913");
  private static SNodePointer ifMacroRef_vmdyp3_b0a0b0f0c0b7 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "5374941486721969419");
  private static SNodePointer callMacro_vmdyp3_b0a0a1a3a2a1i = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3799973320546241360");
  private static SNodePointer copySrcMacro_vmdyp3_b0a0c0d0c0b9 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2733396919553294540");
  private static SNodePointer callMacro_vmdyp3_b0a0a1a4a2a1j = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2733396919553280585");
  private static SNodePointer copySrcMacro_vmdyp3_b0a0c0c0b0b0d0c0b01 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2733396919553298546");
  private static SNodePointer ifMacroRef_vmdyp3_b0a0b0d0c0b01 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2733396919553298520");
  private static SNodePointer copySrcMacro_vmdyp3_b0a0c0a1a3a2a1k = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2733396919553298533");
  private static SNodePointer callMacro_vmdyp3_b0a0a1a4a2a1k = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2733396919553281070");
}
