...
public class Template_reduce_GetAncestor_whereConceptInList extends TemplateDeclarationBase {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_28_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro));
        tlist2 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput2), copySrcMacro, "tpl/r:00000000-0000-4000-0000-011c89590303/2111762137401170934", context1);
          ...
          TemplateContext context2 = context1.subContext();
          {
            final SNode tnode4 = environment.createOutputNode(myConcepts[2]);
            {
              ...
              }
              {
                ...
                final Iterable<SNode> loopList6 = QueriesGenerated.sourceNodesQuery_28_0(new SourceSubstituteMacroNodesContext(context3, loopMacroRef));
                for (SNode itnode6 : loopList6) {
                  ...
                  SNode callInputNode7 = QueriesGenerated.sourceNodeQuery_28_1(new SourceSubstituteMacroNodeContext(context4, callMacro));
                  TemplateContext context5 = context4;
                  context5 = context5.subContext(null, callInputNode7);
                  if (callInputNode7 != null) {
                    tlist7 = environment.callSite(new Template_reduce_ConceptDeclaration2SAbstractConcept(), new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "633481135935145297")).apply(context5);
                  } else {
      ...
      }
      {
        ...
        SNodeAccessUtil.setPropertyValue(tnode8, myProperties[0], QueriesGenerated.propertyMacro_GetValue_28_0(new PropertyMacroContext(context1, null, propertyMacro)));
        environment.aggregate(tnode1, myAggregationLinks[0], tnode8);
      }
      {
        final SNode tnode9 = environment.createOutputNode(myConcepts[4]);
        SNodeAccessUtil.setPropertyValue(tnode9, myProperties[0], QueriesGenerated.propertyMacro_GetValue_28_1(new PropertyMacroContext(context1, null, propertyMacro1)));
  ...
  private static final SNodePointer copySrcMacro = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2111762137401170935");
  private static final SNodePointer loopMacroRef = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "3902354333653985486");
  private static final SNodePointer callMacro = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "633481135935145297");
  private static final SNodePointer propertyMacro = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2111762137401170959");
  private static final SNodePointer propertyMacro1 = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "2111762137401170968");
}
