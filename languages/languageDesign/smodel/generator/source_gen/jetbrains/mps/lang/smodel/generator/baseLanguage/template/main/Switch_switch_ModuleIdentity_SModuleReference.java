...
public class Switch_switch_ModuleIdentity_SModuleReference extends TemplateSwitchBase implements TemplateSwitchMapping {
  ...
  public void processNull(TemplateExecutionEnvironment environment) {
    environment.getLogger().error(getSwitchNode(), "\"Need an instance of ModuleIdentity\"");
  }
  /*package*/ static final class ReductionRule0 extends ReductionRuleBase {
    public ReductionRule0() {
      super(new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1678062499342605305"), CONCEPTS.ModulePointer$_2, true);
    }
    @Override
  ...
  /*package*/ static final class ReductionRule1 extends ReductionRuleBase {
    public ReductionRule1() {
      super(new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6907104285549043613"), CONCEPTS.ModulePointer$rJ, true);
    }
    @Override
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      final TemplateExecutionEnvironment environment = context.getEnvironment();
        ...
        }
        {
          ...
          try {
            ...
            TemplateContext context2 = context1.subContext();
            {
              ...
              try {
                SNodeAccessUtil.setPropertyValue(tnode4, MetaAdapterFactory.getProperty(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf93d565d10L, 0xf93d565d11L, "value"), QueriesGenerated.propertyMacro_GetValue_91_0(new PropertyMacroContext(context2, "", propertyMacro_seg6b4_c0a2a0a1a2a1a2a2a1i)));
              } finally {
              }
