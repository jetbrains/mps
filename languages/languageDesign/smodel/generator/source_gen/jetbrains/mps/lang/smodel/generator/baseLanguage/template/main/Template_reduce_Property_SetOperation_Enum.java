...
@Generated
public class Template_reduce_Property_SetOperation_Enum extends TemplateDeclarationBase {

  public Template_reduce_Property_SetOperation_Enum() {
    super(new MO());
  }

  public SNodeReference getTemplateNode() {
    return new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6202631021711145809");
  }
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    {
      environment.associate(tnode1, myAssociationLinks[0], "r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)", "6202631021711098328");
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_117_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro));
      ...
      }
      {
        ...
        SNode callInputNode3 = QueriesGenerated.sourceNodeQuery_117_1(new SourceSubstituteMacroNodeContext(context1, callMacro));
        TemplateContext context2 = context1;
        context2 = context2.subContext(null, callInputNode3);
        if (callInputNode3 != null) {
          tlist3 = environment.callSite(new Template_reduce_PropertyDeclaration_SProperty(), new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6202631021711153849")).apply(context2);
        } else {
      ...
      }
      {
        ...
        SNode callInputNode4 = QueriesGenerated.sourceNodeQuery_117_2(new SourceSubstituteMacroNodeContext(context1, callMacro1));
        TemplateContext context3 = context1;
        context3 = context3.subContext(null, callInputNode4);
        if (callInputNode4 != null) {
          tlist4 = environment.callSite(new Template_reduce_EnumMember2Id(), new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "8540066610856020057")).apply(context3);
        } else {
      ...
      }
      {
        ...
        SNodeAccessUtil.setPropertyValue(tnode5, myProperties[0], QueriesGenerated.propertyMacro_GetValue_117_0(new PropertyMacroContext(context1, "name", propertyMacro)));
