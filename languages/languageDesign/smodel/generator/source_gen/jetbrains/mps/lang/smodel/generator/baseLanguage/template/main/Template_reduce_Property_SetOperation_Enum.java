...
@Generated
public class Template_reduce_Property_SetOperation_Enum extends TemplateDeclarationBase implements TemplateDeclaration2 {
  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    try {
      tnode1.setReference(myAssociationLinks[0], SReference.create(myAssociationLinks[0], tnode1, PersistenceFacade.getInstance().createModelReference("r:c3548bac-30eb-4a2a-937c-0111d5697309(jetbrains.mps.lang.smodel.generator.smodelAdapter)"), PersistenceFacade.getInstance().createNodeId("6202631021711098328")));
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode copySrcInput2 = QueriesGenerated.sourceNodeQuery_137_0(new SourceSubstituteMacroNodeContext(context1, copySrcMacro_543klu_b0a0c0d0c0g));
      ...
      }
      {
        ...
        SNode callInputNode4 = QueriesGenerated.sourceNodeQuery_137_1(new SourceSubstituteMacroNodeContext(context1, callMacro_543klu_b0a0a1a4a2a6));
      ...
      }
      {
        ...
        try {
          SNodeAccessUtil.setProperty(tnode6, myProperties[0], TemplateUtil.asString(QueriesGenerated.propertyMacro_GetValue_137_0(new PropertyMacroContext(context1, "", propertyMacro_543klu_c0a0c0a0b0f0c0g))));
        } finally {
        }
  ...
  private static SNodePointer propertyMacro_543klu_c0a0c0a0b0f0c0g = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "6202631021711157775");
}
