...
public class Template_reduce_IsNotNullOperation extends TemplateDeclarationBase {
      ...
      TemplateContext context1 = context.subContext();
      {
        final SNode tnode2 = environment.createOutputNode(myConcepts[1]);
        {
          ...
          }
          {
            ...
            final SNode copySrcInput4 = QueriesGenerated.sourceNodeQuery_31_0(new SourceSubstituteMacroNodeContext(context2, copySrcMacro));
            tlist4 = environment.copyNodes(TemplateUtil.singletonList(copySrcInput4), copySrcMacro, "tpl/r:00000000-0000-4000-0000-011c89590303/1172008609677", context2);
  ...
  private static final SNodePointer copySrcMacro = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1172008623308");
}
