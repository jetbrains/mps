  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      }
      {
        ...
        SNode callInputNode3 = QueriesGenerated.sourceNodeQuery_37_1(new SourceSubstituteMacroNodeContext(context1, callMacro_eixx3a_b0a0a1a4a2a6));
        TemplateContext context2 = context1;
        context2 = context2.subContext(null, callInputNode3);
        if (callInputNode3 != null) {
          tlist3 = environment.callSite(new Template_reduce_ConceptDeclaration2SAbstractConcept(), new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "633481135935145301")).apply(context2);
        } else {
