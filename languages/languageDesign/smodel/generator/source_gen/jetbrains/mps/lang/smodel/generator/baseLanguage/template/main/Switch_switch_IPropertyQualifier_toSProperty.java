...
public class Switch_switch_IPropertyQualifier_toSProperty extends TemplateSwitchBase implements TemplateSwitchMapping {
  ...
  /*package*/ final class ReductionRule0 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      ...
      final SNode copySrcInput1 = QueriesGenerated.sourceNodeQuery_69_0(new SourceSubstituteMacroNodeContext(context, copySrcMacro));
  ...
  /*package*/ final class ReductionRule1 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      final TemplateExecutionEnvironment environment = context.getEnvironment();
      Collection<SNode> tlist1 = null;
      SNode callInputNode1 = QueriesGenerated.sourceNodeQuery_69_1(new SourceSubstituteMacroNodeContext(context, callMacro));
