  ...
  protected FragmentResult applyPart0(@NotNull final TemplateContext context) throws GenerationException {
    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      }
      {
        ...
        {
          SNodeAccessUtil.setPropertyValue(tnode7, myProperties[0], QueriesGenerated.propertyMacro_GetValue_110_0(new PropertyMacroContext(context1, "A_BehaviorDescriptor", propertyMacro_peulco_c0a2a0a1a2a2a6)));
          SNodeAccessUtil.setPropertyValue(tnode7, myProperties[1], QueriesGenerated.propertyMacro_GetValue_110_1(new PropertyMacroContext(context1, "fooMethod", propertyMacro_peulco_c0a2a1a1a2a2a6)));
          TemplateContext context5 = context1.subContext();
          {
            final SNode tnode8 = environment.createOutputNode(myConcepts[3]);
            {
              ...
              TemplateContext context6 = context5.subContext();
              {
                ...
                final SNode copySrcInput9 = QueriesGenerated.sourceNodeQuery_110_1(new SourceSubstituteMacroNodeContext(context6, copySrcMacro_peulco_b0a0c0c0b0d0b0c0c0g));
