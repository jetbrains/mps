...
public class Template_reduce_ModulePointer_SModuleReference extends TemplateDeclarationBase {
      ...
      }
      {
        final SNode tnode3 = environment.createOutputNode(myConcepts[2]);
        {
          ...
          TemplateContext context2 = context1.subContext();
          {
            ...
            SNodeAccessUtil.setPropertyValue(tnode4, myProperties[0], QueriesGenerated.propertyMacro_GetValue_89_0(new PropertyMacroContext(context2, "", propertyMacro)));
  ...
  private static final SNodePointer propertyMacro = new SNodePointer("r:00000000-0000-4000-0000-011c89590303(jetbrains.mps.lang.smodel.generator.baseLanguage.template.main@generator)", "1678062499342615992");
}
