...
public class Switch_switch_ConceptMethodReflectiveCall extends TemplateSwitchBase implements TemplateSwitchMapping {
  ...
  public Collection<SNode> applyDefault(final TemplateContext context) throws GenerationException {
    ...
    SNode callInputNode1 = QueriesGenerated.sourceNodeQuery_77_4(new SourceSubstituteMacroNodeContext(context, callMacro_dxinld_b0a0a2a5));
  ...
  /*package*/ final class ReductionRule0 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      final TemplateExecutionEnvironment environment = context.getEnvironment();
      Collection<SNode> tlist1 = null;
      SNode callInputNode1 = QueriesGenerated.sourceNodeQuery_77_0(new SourceSubstituteMacroNodeContext(context, callMacro_dxinld_b0a0a2a1g));
      TemplateContext context1 = context;
      context1 = context1.subContext(null, callInputNode1);
      if (callInputNode1 != null) {
  ...
  /*package*/ final class ReductionRule1 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      final TemplateExecutionEnvironment environment = context.getEnvironment();
      Collection<SNode> tlist1 = null;
      SNode callInputNode1 = QueriesGenerated.sourceNodeQuery_77_1(new SourceSubstituteMacroNodeContext(context, callMacro_dxinld_b0a0a2a1h));
      TemplateContext context1 = context;
      context1 = context1.subContext(null, callInputNode1);
      if (callInputNode1 != null) {
  ...
  /*package*/ final class ReductionRule2 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      final TemplateExecutionEnvironment environment = context.getEnvironment();
      Collection<SNode> tlist1 = null;
      SNode callInputNode1 = QueriesGenerated.sourceNodeQuery_77_2(new SourceSubstituteMacroNodeContext(context, callMacro_dxinld_b0a0a2a1i));
      TemplateContext context1 = context;
      context1 = context1.subContext(null, callInputNode1);
      if (callInputNode1 != null) {
  ...
  /*package*/ final class ReductionRule3 extends ReductionRuleBase {
    ...
    public Collection<SNode> apply(@NotNull final TemplateContext context) throws GenerationException {
      final TemplateExecutionEnvironment environment = context.getEnvironment();
      Collection<SNode> tlist1 = null;
      SNode callInputNode1 = QueriesGenerated.sourceNodeQuery_77_3(new SourceSubstituteMacroNodeContext(context, callMacro_dxinld_b0a0a2a1j));
      TemplateContext context1 = context;
      context1 = context1.subContext(null, callInputNode1);
      if (callInputNode1 != null) {
