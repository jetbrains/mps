...
public final class Node_GetChildrenOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getLinkQualifier_id30XARhxpW1K = new SMethodBuilder<>(SNode.class).name("getLinkQualifier").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3476105411552591984L).languageId(0x81bc4d213d9375e1L, 0x7866978ea0f04cc7L).build2();
