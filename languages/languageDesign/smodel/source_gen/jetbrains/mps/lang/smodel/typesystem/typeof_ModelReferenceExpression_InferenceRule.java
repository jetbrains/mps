...
public class typeof_ModelReferenceExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode modelRef, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if ((SLinkOperations.getTarget(modelRef, LINKS.repo$cK2X) != null)) {
      {
        SNode _nodeToCheck_1029348928467 = SLinkOperations.getTarget(modelRef, LINKS.repo$cK2X);
  ...
  private static SNode createClassifierType_siar27_a1a0c0a0b0b() {
    ...
    rootBuilder1.setReference(LINKS.classifier$cxMr, new SNodePointer(facade.createModelReference("8865b7a8-5271-43d3-884c-6fd1d9cfdd34/java:org.jetbrains.mps.openapi.module(MPS.OpenAPI/)"), facade.createNodeId("~SRepository")));
