...
public class RepositoryLanguages_Substitute extends SubstituteMenuBase {
  public RepositoryLanguages_Substitute() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "RepositoryLanguages_Substitute", new SNodePointer("r:00000000-0000-4000-0000-011c895902fd(jetbrains.mps.lang.smodel.editor)", "5769081855528901637")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Param_pm0kc4_a extends ParameterizedMenuPart<SModuleReference, SubstituteMenuItem, SubstituteMenuContext> {
    ...
    protected List<SubstituteMenuItem> createItems(SModuleReference parameter, SubstituteMenuContext context) {
      return new SMP_Action_pm0kc4_a0(parameter).createItems(context);
    }
    @NotNull
    @Override
    ...
    private class SMP_Action_pm0kc4_a0 extends SingleItemSubstituteMenuPart {
      ...
      private class Item extends DefaultSubstituteMenuItem {
        ...
        /*package*/ void resetTraceInfo() {
          ...
          updateTraceInfo(description, new SNodePointer("r:00000000-0000-4000-0000-011c895902fd(jetbrains.mps.lang.smodel.editor)", "5769081855528901639"));
        }
