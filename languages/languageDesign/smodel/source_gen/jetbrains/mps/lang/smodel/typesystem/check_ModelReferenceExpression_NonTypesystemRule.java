    ...
    if ((SLinkOperations.getTarget(modelRefExpr, LINKS.repo$cK2X) == null)) {
      {
        ...
        IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(modelRefExpr, "Repository for looking up model must be provided", "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "8646272096493143147", null, errorTarget);
      }
    }
  }
