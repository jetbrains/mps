...
public class SNodeOperation_SubstituteMenu extends SubstituteMenuBase {
  public SNodeOperation_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "SNodeOperation", new SNodePointer("r:00000000-0000-4000-0000-011c895902fd(jetbrains.mps.lang.smodel.editor)", "1741258697587099252")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Include_u6z34j_a extends IncludeSubstituteMenuSubstituteMenuPart {
    ...
    public SMP_Include_u6z34j_a() {
      super(new EditorMenuDescriptorBase("include " + "named substitute menu " + "snodeOperation", new SNodePointer("r:00000000-0000-4000-0000-011c895902fd(jetbrains.mps.lang.smodel.editor)", "1741258697587099442")));
    }
