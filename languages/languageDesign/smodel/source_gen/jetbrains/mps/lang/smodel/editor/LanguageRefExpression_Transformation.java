...
public class LanguageRefExpression_Transformation extends TransformationMenuBase {
  public LanguageRefExpression_Transformation() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "LanguageRefExpression_Transformation", new SNodePointer("r:00000000-0000-4000-0000-011c895902fd(jetbrains.mps.lang.smodel.editor)", "2469893808088029481")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
