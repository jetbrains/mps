...
public final class AttributeQualifier__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getAttributeContainerType_id5zEkxuKhwBG = new SMethodBuilder<>(SNode.class).name("getAttributeContainerType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6407023681583057388L).languageId(0x81bc4d213d9375e1L, 0x7866978ea0f04cc7L).build2();
  public static final SMethod<SNode> getTargetConcept_id5zEkxuKhyRq = new SMethodBuilder<>(SNode.class).name("getTargetConcept").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6407023681583066586L).languageId(0x81bc4d213d9375e1L, 0x7866978ea0f04cc7L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getAttributeContainerType_id5zEkxuKhwBG, getTargetConcept_id5zEkxuKhyRq);
