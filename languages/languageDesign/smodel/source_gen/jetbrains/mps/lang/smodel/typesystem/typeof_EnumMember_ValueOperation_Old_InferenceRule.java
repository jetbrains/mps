...
public class typeof_EnumMember_ValueOperation_Old_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode operation, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    if (SNodeOperations.isInstanceOf(SNodeOperations.getParent(operation), CONCEPTS.DotExpression$6a)) {
      {
          ...
          public void run() {
            {
              ...
              typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "1240577344539", true), (SNode) RulesUtil.datatypeBLType(SLinkOperations.getTarget(SNodeOperations.cast(typeCheckingContext.getExpandedNode(enumDecl), CONCEPTS.EnumerationDataTypeDeclaration_Old$Ll), LINKS.memberDataType$IU7B)), _info_12389875345);
            }
          }
  ...
  public SAbstractConcept getApplicableConcept() {
    return CONCEPTS.EnumMember_ValueOperation_Old$qj;
  }
