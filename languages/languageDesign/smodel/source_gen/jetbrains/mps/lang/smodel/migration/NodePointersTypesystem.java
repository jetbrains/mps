...
public class NodePointersTypesystem extends MigrationScriptBase {
  ...
  private static SNode createSemanticDowncastExpression_p7xwcw_a0a0a2a0a0a0b0a0g(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.SemanticDowncastExpression$vW);
    rootBuilder1.forChild(LINKS.leftExpression$ZUv8).initNode(node0, CONCEPTS.Expression$mB, true);
