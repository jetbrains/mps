...
public class EnumMemberReference_Old_SubstituteMenu extends SubstituteMenuBase {
  public EnumMemberReference_Old_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for EnumMemberReference_Old. Generated from the smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c89590301(jetbrains.mps.lang.smodel.structure)", "4747359941569483844")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_jz4s40_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_jz4s40_a() {
      super(CONCEPTS.EnumMemberReference_Old$15, LINKS.enumMember$hl0V, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }
