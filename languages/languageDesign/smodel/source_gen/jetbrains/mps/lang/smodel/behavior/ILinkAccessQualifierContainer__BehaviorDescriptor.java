...
public final class ILinkAccessQualifierContainer__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Iterable<SNode>> getLinkAccessScope_id2xk$X1Ld2Yi = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("getLinkAccessScope").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2906110183022538642L).languageId(0x81bc4d213d9375e1L, 0x7866978ea0f04cc7L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getLinkAccessScope_id2xk$X1Ld2Yi);
