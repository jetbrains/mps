...
public class AllRepoModels_MenuContrib extends SubstituteMenuBase {
  public AllRepoModels_MenuContrib() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "ModelIdentity", new SNodePointer("r:00000000-0000-4000-0000-011c895902fd(jetbrains.mps.lang.smodel.editor)", "7899164836083749658")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_ngt524_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    public class SMP_Include_ngt524_a0 extends IncludeSubstituteMenuSubstituteMenuPart {
      ...
      public SMP_Include_ngt524_a0() {
        super(new EditorMenuDescriptorBase("include " + "named substitute menu " + "AllRepositoryModels_SM", new SNodePointer("r:00000000-0000-4000-0000-011c895902fd(jetbrains.mps.lang.smodel.editor)", "7899164836083762200")));
      }
