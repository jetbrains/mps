...
public class RepositoryLanguages_SubstituteWrapped extends SubstituteMenuBase {
  ...
  private static SNode createLanguageIdentityBySourceModule_z8062m_a0a0a(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.LanguageIdentityBySourceModule$T8);
    rootBuilder1.forChild(LINKS.moduleReference$Jac_).initNode(node0, CONCEPTS.ModuleIdentity$U1, true);
