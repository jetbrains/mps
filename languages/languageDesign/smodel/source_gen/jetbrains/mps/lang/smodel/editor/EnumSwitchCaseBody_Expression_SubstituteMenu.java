...
public class EnumSwitchCaseBody_Expression_SubstituteMenu extends SubstituteMenuBase {
  ...
  private static SNode createEnumSwitchCaseBody_Expression_le0nmc_a0a0a(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.EnumSwitchCaseBody_Expression$YM);
    rootBuilder1.forChild(LINKS.expression$VREw).initNode(node0, CONCEPTS.Expression$mB, true);
