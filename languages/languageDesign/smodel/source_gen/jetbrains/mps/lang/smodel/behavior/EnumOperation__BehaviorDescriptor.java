...
public final class EnumOperation__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getEnumDecl_id66cvXGSmQgk = new SMethodBuilder<>(SNode.class).name("getEnumDecl").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7029133697938580500L).languageId(0x81bc4d213d9375e1L, 0x7866978ea0f04cc7L).build2();
