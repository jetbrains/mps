...
public final class SwitchExpressionPW_PasteWrapper_4 implements PasteWrapper {
  ...
  private static SNode createEnumSwitchCaseBody_StatementList_degi1_a0a0e(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.EnumSwitchCaseBody_StatementList$I);
    rootBuilder1.forChild(LINKS.statementList$VSCw).initNode(node0, CONCEPTS.StatementList$m_, true);
