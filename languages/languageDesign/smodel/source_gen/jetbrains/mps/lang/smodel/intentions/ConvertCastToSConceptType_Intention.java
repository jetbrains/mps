...
public final class ConvertCastToSConceptType_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SLinkOperations.setTarget(repl, LINKS.concept$C5xM, SLinkOperations.getTarget(node, LINKS.concept$C5xM));
      SLinkOperations.setTarget(repl, LINKS.leftExpression$uiR3, SLinkOperations.getTarget(node, LINKS.leftExpression$uiR3));
    ...
    private boolean isApplicableToNode(final SNode node, final EditorContext editorContext) {
      return (!((boolean) SNodeTypeCastExpression__BehaviorDescriptor.isSNodeCast_idi1Btg5H.invoke(node)) || !((boolean) SNodeTypeCastExpression__BehaviorDescriptor.hasValidType_id3$jHpAYjQYh.invoke(node))) && !(SPropertyOperations.getBoolean(node, PROPS.asCast$Egst));
    }
