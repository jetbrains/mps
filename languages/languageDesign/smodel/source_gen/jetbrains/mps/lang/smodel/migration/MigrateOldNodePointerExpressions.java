...
public class MigrateOldNodePointerExpressions extends MigrationScriptBase {
  ...
  private static SNode createReviewMigration_old_5d7h7i_a0a0a0a0a0a6() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ReviewMigration_old$2j);
    rootBuilder1.setProperty(PROPS.readableId$SY7S, "MigrateOldNodePointerExpressions");
    rootBuilder1.setProperty(PROPS.reasonShort$6I8j, "Couldn't migrate node with attributes");
