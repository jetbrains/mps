...
public class MigrateOldNodePointerExpressions extends MigrationScriptBase {
  ...
  private static SNode createReviewMigration_old_5d7h7i_a0a0a0a0a0a6() {
    ...
    rootBuilder1.setProperty(PROPS.readableId$scJA, "MigrateOldNodePointerExpressions");
    rootBuilder1.setProperty(PROPS.reasonShort$DWK1, "Couldn't migrate node with attributes");
