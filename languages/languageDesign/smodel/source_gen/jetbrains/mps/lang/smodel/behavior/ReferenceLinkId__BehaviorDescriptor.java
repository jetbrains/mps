...
public final class ReferenceLinkId__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SReferenceLink> getReference_id7jb4LXp9a7o = new SMethodBuilder<SReferenceLink>(new SJavaCompoundTypeImpl(SReferenceLink.class)).name("getReference").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("7jb4LXp9a7o").build();
  public static final SMethod<Void> setReference_id5e7X3XCLvlR = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("setReference").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("5e7X3XCLvlR").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  public static final SMethod<Void> setReference_id7jb4LXp9a6q = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("setReference").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("7jb4LXp9a6q").build(SMethodBuilder.createJavaParameter(SReferenceLink.class, ""));
  public static final SMethod<Long> getIdValue_id7jb4LXp9a7d = new SMethodBuilder<Long>(new SJavaCompoundTypeImpl(Long.TYPE)).name("getIdValue").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("7jb4LXp9a7d").build();
