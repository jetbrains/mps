...
public final class SNodeTypeCastExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isSNodeCast_idi1Btg5H = new SMethodBuilder<>(Boolean.TYPE).name("isSNodeCast").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1238686302573L).languageId(0x81bc4d213d9375e1L, 0x7866978ea0f04cc7L).build2();
  public static final SMethod<Boolean> hasValidType_id3$jHpAYjQYh = new SMethodBuilder<>(Boolean.TYPE).name("hasValidType").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4112830556646895505L).languageId(0x81bc4d213d9375e1L, 0x7866978ea0f04cc7L).build2();
