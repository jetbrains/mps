...
public class typeof_AsSConcept_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
        ...
        if (SNodeOperations.isInstanceOf(typeCheckingContext.getExpandedNode(operandType), CONCEPTS.ConceptNodeType$92)) {
          {
            ...
            typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "8828148184967395095", true), (SNode) _quotation_createNode_24c979_a1a0c0a0a0b0a1a0a1(SLinkOperations.getTarget(SNodeOperations.cast(typeCheckingContext.getExpandedNode(operandType), CONCEPTS.ConceptNodeType$92), LINKS.conceptDeclaraton$Pc1V)), _info_12389875345);
          }
          ...
          if (!(typeCheckingContext.isSingleTypeComputation())) {
            {
              ...
              typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.getExpandedNode(operandType), (SNode) _quotation_createNode_24c979_a1a0c0a0a0a0a1a0b0a0b(), true, false, _info_12389875345);
            }
          }
          {
            SNode _nodeToCheck_1029348928467 = asSConcept;
            ...
            typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "955802970103931826", true), (SNode) _quotation_createNode_24c979_a1a0c0b0a0a1a0b0a0b(), _info_12389875345);
          }
        }
  ...
  private static SNode _quotation_createNode_24c979_a1a0c0a0a0b0a1a0a1(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_24c979_a1a0c0a0a0a0a1a0b0a0b() {
  ...
  private static SNode _quotation_createNode_24c979_a1a0c0b0a0a1a0b0a0b() {
    SNode quotedNode_1 = null;
    SNodeBuilder nb = new SNodeBuilder(null, null).init(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0x7866978ea0f04cc7L, 0x81bc4d213d9375e1L, "jetbrains.mps.lang.smodel"), 0x5cab42cd97571ceeL, "SConceptType"));
    quotedNode_1 = nb.getResult();
    return quotedNode_1;
