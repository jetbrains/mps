...
public class NodeAttributeQualifier_SmartReference extends SubstituteMenuBase {
  public NodeAttributeQualifier_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "NodeAttributeQualifier_SmartReference", new SNodePointer("r:00000000-0000-4000-0000-011c895902fd(jetbrains.mps.lang.smodel.editor)", "4747359941571311404")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_i3c8co_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_i3c8co_a() {
      super(CONCEPTS.NodeAttributeQualifier$qh, LINKS.attributeConcept$x5q0, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c895902fd(jetbrains.mps.lang.smodel.editor)", "4747359941571311402")));
    }
