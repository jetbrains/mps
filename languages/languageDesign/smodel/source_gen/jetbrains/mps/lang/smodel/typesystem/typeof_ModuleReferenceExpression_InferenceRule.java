...
public class typeof_ModuleReferenceExpression_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode module, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    {
      ...
      typeCheckingContext.createEquation((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c895902fe(jetbrains.mps.lang.smodel.typesystem)", "4040588429969539742", true), (SNode) _quotation_createNode_x1bqsf_a1a0c0a0b(), _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_x1bqsf_a1a0c0a0b() {
