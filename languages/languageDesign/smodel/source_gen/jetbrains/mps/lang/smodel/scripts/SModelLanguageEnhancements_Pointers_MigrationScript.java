...
public final class SModelLanguageEnhancements_Pointers_MigrationScript extends BaseMigrationScript {
  ...
  private static SNode createDotExpression_y8o86o_a0c0a4(SNode node0, SNode node1) {
    ...
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.operation$gs9E).init(CONCEPTS.Link_SetTargetPointerOperation$6D);
      {
        SNodeBuilder n3 = n2.forChild(LINKS.linkTarget$BrA0).init(CONCEPTS.NodePointerArg_Identity$75);
        n3.forChild(LINKS.ref$U7VA).initNode(node1, CONCEPTS.NodeIdentity$8R, true);
      }
    }
    return rootBuilder1.getResult();
  }
  private static SNode createLink_SetTargetPointerOperation_y8o86o_a0b0a5(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.Link_SetTargetPointerOperation$6D);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.linkTarget$BrA0).init(CONCEPTS.NodePointerArg_Identity$75);
      n2.forChild(LINKS.ref$U7VA).initNode(node0, CONCEPTS.NodeIdentity$8R, true);
    }
    return rootBuilder1.getResult();
  }
