...
public final class SModelLanguageEnhancements_Pointers_MigrationScript extends BaseMigrationScript {
  ...
  private static SNode createDotExpression_y8o86o_a0c0a4(SNode node0, SNode node1) {
    ...
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.operation$_mGS).init(CONCEPTS.Link_SetTargetPointerOperation$59);
      {
        SNodeBuilder n3 = n2.forChild(LINKS.linkTarget$32$w).init(CONCEPTS.NodePointerArg_Identity$5_);
        n3.forChild(LINKS.ref$lIU6).initNode(node1, CONCEPTS.NodeIdentity$tk, true);
      }
    }
  ...
  private static SNode createLink_SetTargetPointerOperation_y8o86o_a0b0a5(SNode node0) {
    ...
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.linkTarget$32$w).init(CONCEPTS.NodePointerArg_Identity$5_);
      n2.forChild(LINKS.ref$lIU6).initNode(node0, CONCEPTS.NodeIdentity$tk, true);
    }
    return rootBuilder1.getResult();
  }
