...
public final class AggregationIdentity__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SContainmentLink> getLink_id7jb4LXp8VrU = new SMethodBuilder<SContainmentLink>(new SJavaCompoundTypeImpl(SContainmentLink.class)).name("getLink").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8415841354032330490L).languageId(0x81bc4d213d9375e1L, 0x7866978ea0f04cc7L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getLink_id7jb4LXp8VrU);
