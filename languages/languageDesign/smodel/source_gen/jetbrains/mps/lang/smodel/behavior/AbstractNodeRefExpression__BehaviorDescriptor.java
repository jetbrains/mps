...
public final class AbstractNodeRefExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Iterable<SNode>> getPossibleTargetNodes_id4x3U0fpSqvX = new SMethodBuilder<>((Class<Iterable<SNode>>) ((Class) Object.class)).name("getPossibleTargetNodes").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5207260697408415741L).languageId(0x81bc4d213d9375e1L, 0x7866978ea0f04cc7L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getTargetNode_id36vPRrqnscn, getPossibleTargetNodes_id4x3U0fpSqvX);
