...
public class supertypesOf_ListType_ListType_elementSNode_SubtypingRule extends SubtypingRule_Runtime implements ISubtypingRule_Runtime {
  ...
  public List<SNode> getSubOrSuperTypes(SNode listType, TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    SNode classifierType = TypecheckingFacade.getFromContext().coerceType(SLinkOperations.getTarget(listType, LINKS.elementType$xJJW), CONCEPTS.ClassifierType$IZ);
    if (SLinkOperations.hasPointer(classifierType, LINKS.classifier$pQ_R, new SNodePointer("8865b7a8-5271-43d3-884c-6fd1d9cfdd34/java:org.jetbrains.mps.openapi.model(MPS.OpenAPI/)", "~SNode"))) {
