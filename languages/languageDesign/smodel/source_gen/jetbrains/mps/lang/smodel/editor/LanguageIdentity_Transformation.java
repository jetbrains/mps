...
public class LanguageIdentity_Transformation extends TransformationMenuBase {
  public LanguageIdentity_Transformation() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "LanguageIdentity_Transformation", new SNodePointer("r:00000000-0000-4000-0000-011c895902fd(jetbrains.mps.lang.smodel.editor)", "5503407155931295401")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
