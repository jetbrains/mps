...
public class SNodeOperation_SubstituteMenu_Additional extends SubstituteMenuBase {
  public SNodeOperation_SubstituteMenu_Additional() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "SNodeOperation_SubstituteMenu_Additional", new SNodePointer("r:00000000-0000-4000-0000-011c895902fd(jetbrains.mps.lang.smodel.editor)", "1741258697587099444")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_gnupa8_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_gnupa8_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:00000000-0000-4000-0000-011c895902fd(jetbrains.mps.lang.smodel.editor)", "1741258697587099446")));
    }
    @Override
