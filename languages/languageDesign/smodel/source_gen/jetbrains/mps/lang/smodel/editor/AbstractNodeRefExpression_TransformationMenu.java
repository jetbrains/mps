...
public class AbstractNodeRefExpression_TransformationMenu extends TransformationMenuBase {
  ...
  public class TMP_Group_wxvpf4_a1 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts() {
      return Arrays.<MenuPart<TransformationMenuItem, TransformationMenuContext>>asList(new ConstraintsFilteringTransformationMenuPartDecorator(new TMP_Group_wxvpf4_a1.TMP_Action_wxvpf4_a0b(), CONCEPTS.ChildNodeRefExpression$jQ));
    }
