      ...
      case 0:
        if (true) {
          switch (menuId.getFqName()) {
            case "jetbrains.mps.lang.generator.plan.editor.Transform_MakeForkOf":
              return Arrays.asList(new TransformationMenu[]{new Transform_MakeForkOf()});
            default:
          }
        }
        break;
