...
/*package*/ class NodeMacro_label_inspector_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.mappingLabel$jbOO;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.mappingLabel$jbOO);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.mappingLabel$jbOO);
    }
