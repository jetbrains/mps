...
public final class EditingUtil {
  ...
  public static void createTemplateFragment(final SNode node) {
    ...
    ListSequence.fromList(AttributeOperations.getAttributeList(node, new IAttributeDescriptor.NodeAttribute(CONCEPTS.NodeMacro$qU))).toListSequence().visitAll(new IVisitor<SNode>() {
      public void visit(SNode it) {
