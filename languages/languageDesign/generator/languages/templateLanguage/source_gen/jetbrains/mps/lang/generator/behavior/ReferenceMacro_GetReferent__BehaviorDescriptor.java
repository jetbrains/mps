...
public final class ReferenceMacro_GetReferent__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static final SMethod<SNode> fromMacro_id2I_OWQO_cV$ = new SMethodBuilder<>(SNode.class).name("fromMacro").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(3145152795239567076L).languageId(0x8fd384331ff25befL, 0xb401a68083254110L).build2(SMethodBuilder.createJavaParameter(SNode.class, "refMacro"));
  /*package*/ static final SMethod<SNode> fromRefReductionRule_id2I_OWQO_d$v = new SMethodBuilder<>(SNode.class).name("fromRefReductionRule").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(3145152795239569695L).languageId(0x8fd384331ff25befL, 0xb401a68083254110L).build2(SMethodBuilder.createJavaParameter(SNode.class, "reductionRule"));
