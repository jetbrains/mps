...
public class TemplateArgumentVariableRefExpression_SmartReference extends SubstituteMenuBase {
  ...
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    ...
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_ReferenceScope_5gt0as_a(), CONCEPTS.TemplateArgumentVariableRefExpression$1W));
    return result;
  }
  ...
  public class SMP_ReferenceScope_5gt0as_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_5gt0as_a() {
      ...
      super((SAbstractConcept) CONCEPTS.TemplateArgumentVariableRefExpression$1W, LINKS.varmacro$8C1J);
    }
    @NotNull
    @Override
    ...
    protected ReferenceScopeSubstituteMenuItem createItem(SubstituteMenuContext context, SNode referencedNode) {
      return new SMP_ReferenceScope_5gt0as_a.Item(context, referencedNode, getSConcept(), getReferenceLink());
    }
