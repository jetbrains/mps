...
public final class TemplateSwitchMacro__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getTemplateSwitch_idQzR6Ththuv = new SMethodBuilder<>(SNode.class).name("getTemplateSwitch").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(982871510068041631L).languageId(0x8fd384331ff25befL, 0xb401a68083254110L).build2();
