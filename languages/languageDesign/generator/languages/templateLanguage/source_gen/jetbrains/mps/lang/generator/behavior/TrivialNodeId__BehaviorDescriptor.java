...
public final class TrivialNodeId__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> instantiate_id39TODbGt9gR = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("instantiate").modifiers(SModifiersImpl.create(0, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("39TODbGt9gR").registry(REGISTRY).build(SMethodBuilder.createJavaParameter((Class<SModel>) ((Class) Object.class), ""));
