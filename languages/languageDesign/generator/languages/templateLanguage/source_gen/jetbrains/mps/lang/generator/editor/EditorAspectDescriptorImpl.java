...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase {
  ...
  public Collection<ConceptEditor> getDeclaredEditors(SAbstractConcept concept) {
    ...
    switch (conceptIndex.index(cncpt)) {
      ...
      case 19:
        return Collections.<ConceptEditor>singletonList(new InsertCallSiteMacro_Editor());
      case 20:
      ...
      case 23:
        return Collections.<ConceptEditor>singletonList(new LoopMacroNamespaceAccessor_Editor());
      case 24:
      ...
      case 44:
        return Collections.<ConceptEditor>singletonList(new TemplateArgumentVarRefExpression2_Editor());
      case 45:
        return Collections.<ConceptEditor>singletonList(new TemplateCall_Editor());
      case 46:
      ...
      case 56:
        return Collections.<ConceptEditor>singletonList(new VarMacro2_Editor());
      case 57:
  ...
  public Collection<TransformationMenu> getDeclaredNamedTransformationMenus(NamedMenuId menuId) {
    ...
    switch (conceptIndex2.index(cncpt)) {
      case 0:
        if (true) {
          switch (menuId.getFqName()) {
            case "jetbrains.mps.lang.generator.editor.SecondInput":
              return Arrays.asList(new TransformationMenu[]{new SecondInput()});
            default:
          }
        }
        break;
      case 1:
        if (true) {
          switch (menuId.getFqName()) {
            case "jetbrains.mps.lang.generator.editor.ReplaceNodeMacro":
              return Arrays.asList(new TransformationMenu[]{new ReplaceNodeMacro()});
            default:
          }
        }
        break;
  ...
  public Collection<SubstituteMenu> getDeclaredDefaultSubstituteMenus(SAbstractConcept concept) {
    ...
    switch (conceptIndex3.index(cncpt)) {
      ...
      case 6:
        return Collections.<SubstituteMenu>singletonList(new LoopMacroNamespaceAccessor_SubstituteMenu());
      case 7:
      ...
      case 14:
        return Collections.<SubstituteMenu>singletonList(new TemplateArgumentVarRefExpression2_SubstituteMenu());
      case 15:
        return Collections.<SubstituteMenu>singletonList(new TemplateCall_SubstituteMenu());
      case 16:
  ...
  public Collection<SubstituteMenu> getDeclaredNamedSubstituteMenus(NamedMenuId menuId) {
    ...
    switch (conceptIndex4.index(cncpt)) {
      case 0:
        if (true) {
          switch (menuId.getFqName()) {
            case "jetbrains.mps.lang.generator.editor.GeneratorParameterReference_SmartReference":
  ...
  private static final ConceptSwitchIndex conceptIndex2 = new ConceptSwitchIndexBuilder().put(MetaIdFactory.conceptId(0xb401a68083254110L, 0x8fd384331ff25befL, 0x1179be47606L), MetaIdFactory.conceptId(0xb401a68083254110L, 0x8fd384331ff25befL, 0xfd47ed6742L)).seal();
  ...
  private static final ConceptSwitchIndex conceptIndex4 = new ConceptSwitchIndexBuilder().put(MetaIdFactory.conceptId(0xb401a68083254110L, 0x8fd384331ff25befL, 0x90726ff283cbf8aL)).seal();
}
