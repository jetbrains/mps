...
public class EditorAspectDescriptorImpl extends EditorAspectDescriptorBase {
  ...
  public Collection<SubstituteMenu> getDeclaredNamedSubstituteMenus(NamedMenuId menuId) {
    ...
    switch (conceptIndex4.index(cncpt)) {
      ...
      case 1:
        if (true) {
          switch (menuId.getFqName()) {
            case "jetbrains.mps.lang.generator.editor.TemplateArgumentVariableRefExpression_SmartReference":
  ...
  public Collection<EditorMenuItemCustomizer> getEditorMenuItemCustomizers() {
    return Arrays.asList(new EditorMenuItemCustomizer[]{new OldVarMacroStrikeout()});
  }
