...
public class ReplaceNodeMacro extends TransformationMenuBase {
  public ReplaceNodeMacro() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "ReplaceNodeMacro", new SNodePointer("r:00000000-0000-4000-0000-011c895902e3(jetbrains.mps.lang.generator.editor)", "7723269784408643379")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
