...
public class GeneratorParameterReference_SmartReference extends SubstituteMenuBase {
  public GeneratorParameterReference_SmartReference() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "GeneratorParameterReference_SmartReference", new SNodePointer("r:00000000-0000-4000-0000-011c895902e3(jetbrains.mps.lang.generator.editor)", "4747359941571311309")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_zgxupi_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_zgxupi_a() {
      super(CONCEPTS.GeneratorParameterReference$oD, LINKS.declaration$Woky, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c895902e3(jetbrains.mps.lang.generator.editor)", "4747359941571311307")));
    }
