...
public class MappingScriptReference_SubstituteMenu extends SubstituteMenuBase {
  public MappingScriptReference_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for MappingScriptReference. Generated from implicit smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c895902e8(jetbrains.mps.lang.generator.structure)", "1195502151594")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_co4dbn_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_co4dbn_a() {
      super(CONCEPTS.MappingScriptReference$Kf, LINKS.mappingScript$AU0b, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_co4dbn_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_co4dbn_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "MappingScriptReference", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.MappingScriptReference$Kf);
    }
