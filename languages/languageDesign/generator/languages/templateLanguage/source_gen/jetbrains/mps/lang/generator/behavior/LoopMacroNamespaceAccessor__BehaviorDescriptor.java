...
public final class LoopMacroNamespaceAccessor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SAbstractConcept> getMacroConcept_id2vVmcK3iiCI = new SMethodBuilder<SAbstractConcept>(new SJavaCompoundTypeImpl((Class<SAbstractConcept>) ((Class) Object.class))).name("getMacroConcept").modifiers(SModifiersImpl.create(9, AccessPrivileges.PUBLIC)).concept(CONCEPT).id("2vVmcK3iiCI").build();
