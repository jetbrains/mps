...
public final class ConvertToReferenceCall_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  private static SNode createReferenceMacro_nfdvwd_a0a0e0a(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ReferenceMacro$30);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.referentFunction$6c9k).init(CONCEPTS.ReferenceMacro_GetReferent$ww);
      n2.forChild(LINKS.body$e68K).initNode(node0, CONCEPTS.StatementList$m_, true);
    }
  ...
  private static SNode createDotExpression_nfdvwd_a0a5a0(SNode node0, SNode node1) {
    ...
    rootBuilder1.forChild(LINKS.operation$gs9E).initNode(node1, CONCEPTS.IOperation$ga, true);
    return rootBuilder1.getResult();
  }
