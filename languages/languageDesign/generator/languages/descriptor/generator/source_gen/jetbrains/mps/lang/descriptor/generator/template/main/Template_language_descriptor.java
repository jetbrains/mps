...
@Generated
public class Template_language_descriptor extends TemplateDeclarationBase {
  ...
  public void apply(TemplateContext context, ApplySink sink) throws GenerationException {
    ...
    final SNode tnode1 = environment.createOutputNode(myConcepts[0]);
    {
      ...
      TemplateContext context1 = context.subContext();
      {
        ...
        final SNode insertInput2 = QueriesGenerated.insertMacro_Query_2_0(new InsertMacroContext(context1, insertMacro));
        if (insertInput2 != null) {
          tlist2 = Collections.singletonList(environment.insertNode(insertInput2, insertMacro, context1));
        }
  ...
  private static final SNodePointer template = new SNodePointer("r:1dfaf07d-c77a-451e-91d3-b6f80f0f8508(jetbrains.mps.lang.descriptor.generator.template.main@generator)", "1698302279987411125");
  private static final SNodePointer insertMacro = new SNodePointer("r:1dfaf07d-c77a-451e-91d3-b6f80f0f8508(jetbrains.mps.lang.descriptor.generator.template.main@generator)", "1509962061695074411");
}
