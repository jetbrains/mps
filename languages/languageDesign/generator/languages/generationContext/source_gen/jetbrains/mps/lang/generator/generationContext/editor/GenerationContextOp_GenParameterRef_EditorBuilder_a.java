...
/*package*/ class GenerationContextOp_GenParameterRef_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.importClause$np6;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.importClause$np6);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.importClause$np6);
    }
    ...
    private EditorCell createReadOnlyModelAccessor_0() {
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor.ReadOnly() {
        public String getText() {
          return ((SLinkOperations.getTarget(myNode, LINKS.declaration$Woky) != null) ? SPropertyOperations.getString(SLinkOperations.getTarget(myNode, LINKS.declaration$Woky), PROPS.name$MnvL) : "<unknown>");
        }
      }, myNode);
