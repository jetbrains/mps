...
public final class GenerationContextOp_UserObjectAccessBase__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isLValueInAssignment_idhIg3nxk = new SMethodBuilder<>(Boolean.TYPE).name("isLValueInAssignment").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1217892546644L).languageId(0xa3daae92af1e64d5L, 0xd7706f639be2479cL).build2();
