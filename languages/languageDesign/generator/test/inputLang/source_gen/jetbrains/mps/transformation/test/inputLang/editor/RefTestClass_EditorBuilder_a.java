...
/*package*/ class RefTestClass_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.extends$Yoc8;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.extends$Yoc8);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.extends$Yoc8);
    }
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new methodsListHandler_cblid8_f0(myNode, getEditorContext());
  ...
  private static class methodsListHandler_cblid8_f0 extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.methods$YPx5;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.RefTestMethod$Oc;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(methodsListHandler_cblid8_f0.this.getNode(), LINKS.methods$YPx5));
      try {
