...
/*package*/ class ModelReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_i85no5_a1a() {
    return isNotEmptyString(SPropertyOperations.getString(myNode, PROPS.stereotype$h2Bb));
  }
  private EditorCell createProperty_0() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.qualifiedName$331j;
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.stereotype$h2Bb;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
