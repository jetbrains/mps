...
public final class ModelReference__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SModelReference> toModelReference_id2BHFktfnfdc = new SMethodBuilder<>(SModelReference.class).name("toModelReference").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3021261446821245772L).languageId(0x947f093788f263a9L, 0x86ef829012bb4ca7L).build2();
  public static final SMethod<Void> populateFrom_id2BHFktfniCd = new SMethodBuilder<>(Void.TYPE).name("populateFrom").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3021261446821259789L).languageId(0x947f093788f263a9L, 0x86ef829012bb4ca7L).build2(SMethodBuilder.createJavaParameter(SModelReference.class, "modelRef"));
