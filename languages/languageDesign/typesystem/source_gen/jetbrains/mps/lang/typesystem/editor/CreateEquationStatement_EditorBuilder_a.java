...
/*package*/ class CreateEquationStatement_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createConstant_0() {
    ...
    Style style = new StyleImpl();
    style.set(StyleAttributes.TEXT_COLOR, getStyleRegistry().getSimpleColor(_StyleParameter_QueryFunction_mi4qyq_a0a0a()));
  ...
  private EditorCell createConstant_1() {
    ...
    style.set(StyleAttributes.TEXT_COLOR, getStyleRegistry().getSimpleColor(_StyleParameter_QueryFunction_mi4qyq_a0b0a()));
    style.set(StyleAttributes.PUNCTUATION_RIGHT, true);
    editorCell.getStyle().putAll(style);
    editorCell.setDefaultText("");
    return editorCell;
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new leftExpressionSingleRoleHandler_mi4qyq_c0a(myNode, LINKS.leftExpression$U_o$, getEditorContext());
  ...
  private EditorCell createRefNode_1() {
    SingleRoleCellProvider provider = new rightExpressionSingleRoleHandler_mi4qyq_e0a(myNode, LINKS.rightExpression$U_B_, getEditorContext());
    return provider.createCell();
  }
  ...
  private EditorCell createConstant_2() {
    ...
    Style style = new StyleImpl();
    new ParenthesisStyleClass(this).apply(style, editorCell);
    style.set(StyleAttributes.TEXT_COLOR, getStyleRegistry().getSimpleColor(_StyleParameter_QueryFunction_mi4qyq_a0f0a()));
  ...
  private EditorCell createRefNode_2() {
    SingleRoleCellProvider provider = new leftExpressionSingleRoleHandler_mi4qyq_a1a(myNode, LINKS.leftExpression$U_o$, getEditorContext());
    return provider.createCell();
  }
  ...
  private EditorCell createRefNode_3() {
    SingleRoleCellProvider provider = new rightExpressionSingleRoleHandler_mi4qyq_c1a(myNode, LINKS.rightExpression$U_B_, getEditorContext());
    return provider.createCell();
  }
