...
public class TypeClause_SubstituteMenu extends SubstituteMenuBase {
  public TypeClause_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "TypeClause", new SNodePointer("r:00000000-0000-4000-0000-011c895902b0(jetbrains.mps.lang.typesystem.editor)", "1741258697587166609")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Wrap_zbskfb_a extends WrapperSubstituteMenuPart {
    private SMP_Wrap_zbskfb_a() {
      super(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "Expression", new SNodePointer("r:00000000-0000-4000-0000-011c895902b0(jetbrains.mps.lang.typesystem.editor)", "1741258697587166611")));
    }
  ...
  public class SMP_Subconcepts_zbskfb_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_zbskfb_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "TypeClause", new SNodePointer("r:00000000-0000-4000-0000-011c895902b0(jetbrains.mps.lang.typesystem.editor)", "1741258697587166926")));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.TypeClause$1g);
    }
