...
public class CreateQFixFromUsageHelper {
  ...
  private static SNode createTypesystemIntention_5x9eia_a0a1a0a0b0p0l(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.TypesystemIntention$sw);
    rootBuilder1.setReferenceTarget(LINKS.quickFix$ClX6, node0);
    return rootBuilder1.getResult();
  }
  private static SNode createTypesystemQuickFix_5x9eia_a0a0n(Object p0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.TypesystemQuickFix$$8);
    rootBuilder1.setProperty(PROPS.name$MnvL, PROPS.name$MnvL.getType().toString(p0));
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.executeBlock$oqWd).init(CONCEPTS.QuickFixExecuteBlock$4F);
      n2.forChild(LINKS.body$e68K).init(CONCEPTS.StatementList$m_);
    }
    return rootBuilder1.getResult();
  }
