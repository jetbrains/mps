...
public class InferenceRule_add_OverridesConceptFunction extends TransformationMenuBase {
  public InferenceRule_add_OverridesConceptFunction() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "InferenceRule_add_OverridesConceptFunction", new SNodePointer("r:00000000-0000-4000-0000-011c895902b0(jetbrains.mps.lang.typesystem.editor)", "1741258697587166486")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM));
  }
  ...
  public class TMP_Group_5qd74_a0 extends GroupMenuPart<TransformationMenuItem, TransformationMenuContext> {
    public TMP_Group_5qd74_a0() {
      super(new EditorMenuDescriptorBase("transformation menu group", new SNodePointer("r:00000000-0000-4000-0000-011c895902b0(jetbrains.mps.lang.typesystem.editor)", "1741258697587166492")));
    }
    @Override
      ...
      private class TMP_Action_5qd74_a0a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
        ...
        private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
          ...
          /*package*/ Item resetTraceInfo() {
            updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c895902b0(jetbrains.mps.lang.typesystem.editor)", "1741258697587166511"));
            return this;
          }
          @Nullable
          @Override
