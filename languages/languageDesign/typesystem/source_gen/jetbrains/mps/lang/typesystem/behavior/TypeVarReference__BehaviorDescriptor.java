...
public final class TypeVarReference__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<RuleIdFlavouredItem.TypesystemRuleId>> antiquotationSuppressRules_id2FXdWdhG0kq = new SMethodBuilder<>((Class<List<RuleIdFlavouredItem.TypesystemRuleId>>) ((Class) Object.class)).name("antiquotationSuppressRules").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3097693430729409818L).languageId(0xab76d5ed1746f2b2L, 0x7a5dda6291404668L).build2();
  ...
  /*package*/ static List<RuleIdFlavouredItem.TypesystemRuleId> antiquotationSuppressRules_id2FXdWdhG0kq(@NotNull SAbstractConcept __thisConcept__) {
    ...
    return ListSequence.fromList(result).select((it) -> new RuleIdFlavouredItem.TypesystemRuleId(it)).toList();
  }
