...
/*package*/ class ConceptReference_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.concept$zIbV;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.concept$zIbV);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.concept$zIbV);
    }
  ...
  private EditorCell createProperty_1() {
    ...
    try {
      ...
      editorCell.getStyle().putAll(style);
      editorCell.setSubstituteInfo(new CompositeSubstituteInfo(getEditorContext(), new PropertyCellContext(myNode, property), new SubstituteInfoPartExt[]{new ConceptReference_name_postfixCellMenu_s9fwl0_a0e0(), new SChildSubstituteInfoPartEx(editorCell)}));
      setCellContext(editorCell);
      Iterable<SNode> propertyAttributes = SNodeOperations.ofConcept(new IAttributeDescriptor.AllAttributes().list(myNode), CONCEPTS.PropertyAttribute$Gb);
      Iterable<SNode> currentPropertyAttributes = Sequence.fromIterable(propertyAttributes).where(new IWhereFilter<SNode>() {
        public boolean accept(SNode it) {
  ...
  public static class ConceptReference_name_postfixCellMenu_s9fwl0_a0e0 extends AbstractCellMenuPart_PropertyPostfixHints {
    ...
    protected List<String> getPostfixes(SNode node, EditorContext editorContext) {
      List<String> result;
      if ((SLinkOperations.getTarget(node, LINKS.concept$zIbV) != null) && SPropertyOperations.getString(SLinkOperations.getTarget(node, LINKS.concept$zIbV), PROPS.name$MnvL) != null) {
        String name = NameUtil.decapitalize(SPropertyOperations.getString(SLinkOperations.getTarget(node, LINKS.concept$zIbV), PROPS.name$MnvL));
