...
public final class ConvertPatternRule_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SNode newApplicable = createConceptReference_kdoxak_a0d0a(SNodeOperations.asNode(PatternExpression__BehaviorDescriptor.getQuotedNodeConcept_id4vXWNHn1_L$.invoke(pattern)), SPropertyOperations.getString(SLinkOperations.getTarget(node, LINKS.applicableNode$uxMM), PROPS.name$lA7v));
  ...
  private static SNode createConceptReference_kdoxak_a0d0a(SNode node0, Object p0) {
    ...
    rootBuilder1.setReferenceTarget(LINKS.concept$aRU5, node0);
  ...
  private static SNode createStatementList_kdoxak_a0g0a(SNode node0, SNode node1, SNode node2) {
    ...
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.statement$pYcS).init(CONCEPTS.MatchStatement$1G);
      {
        SNodeBuilder n3 = n2.forChild(LINKS.expression$9Zn0).init(CONCEPTS.ApplicableNodeReference$VP);
        n3.setReferenceTarget(LINKS.applicableNode$eBEr, node0);
      }
      {
        SNodeBuilder n4 = n2.forChild(LINKS.item$RUbD).init(CONCEPTS.MatchStatementItem$EH);
        n4.forChild(LINKS.condition$fyVx).initNode(node1, CONCEPTS.ApplicableNodeCondition$sh, true);
        n4.forChild(LINKS.ifTrue$aS3x).initNode(node2, CONCEPTS.StatementList$TN, true);
      }
    }
    return rootBuilder1.getResult();
  }
