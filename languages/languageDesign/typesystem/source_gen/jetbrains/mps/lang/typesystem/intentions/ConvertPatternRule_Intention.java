...
public final class ConvertPatternRule_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      ...
      SNode newApplicable = createConceptReference_kdoxak_a0d0a(SNodeOperations.asNode(PatternExpression__BehaviorDescriptor.getQuotedNodeConcept_id4vXWNHn1_L$.invoke(pattern)), SPropertyOperations.getString(SLinkOperations.getTarget(node, LINKS.applicableNode$Ro4C), PROPS.name$MnvL));
  ...
  private static SNode createConceptReference_kdoxak_a0d0a(SNode node0, Object p0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ConceptReference$14);
    rootBuilder1.setProperty(PROPS.name$MnvL, PROPS.name$MnvL.getType().toString(p0));
    rootBuilder1.setReferenceTarget(LINKS.concept$zIbV, node0);
    return rootBuilder1.getResult();
  }
  private static SNode createStatementList_kdoxak_a0g0a(SNode node0, SNode node1, SNode node2) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.StatementList$m_);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.statement$53DE).init(CONCEPTS.MatchStatement$jy);
      {
        SNodeBuilder n3 = n2.forChild(LINKS.expression$yPCQ).init(CONCEPTS.ApplicableNodeReference$dF);
        n3.setReferenceTarget(LINKS.applicableNode$BtWh, node0);
      }
      {
        SNodeBuilder n4 = n2.forChild(LINKS.item$gKtv).init(CONCEPTS.MatchStatementItem$Wz);
        n4.forChild(LINKS.condition$Cpdn).initNode(node1, CONCEPTS.ApplicableNodeCondition$I7, true);
        n4.forChild(LINKS.ifTrue$zIln).initNode(node2, CONCEPTS.StatementList$m_, true);
      }
    }
    return rootBuilder1.getResult();
  }
