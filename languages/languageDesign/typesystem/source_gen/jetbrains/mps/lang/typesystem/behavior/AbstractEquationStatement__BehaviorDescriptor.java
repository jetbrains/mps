...
public final class AbstractEquationStatement__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static void attachNewMessageAnnotation_id7nf9pEwlup1(@NotNull SNode __thisNode__) {
    SNode newAnnotation = SNodeFactoryOperations.createNewNode(CONCEPTS.TypesystemEquationStatementAnnotation$Fd, null);
  ...
  /*package*/ static String getName_id1oFBbRehoLP(@NotNull SNode __thisNode__) {
    if ((AttributeOperations.getAttribute(__thisNode__, new IAttributeDescriptor.NodeAttribute(CONCEPTS.MessageStatementAnnotation$sq)) != null)) {
      ...
      String nameGenerated = MessageStatementUtil.generateNameFromExpression(SLinkOperations.getTarget(__thisNode__, LINKS.errorString$uOJc));
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept TypesystemEquationStatementAnnotation$Fd = MetaAdapterFactory.getConcept(0x7a5dda6291404668L, 0xab76d5ed1746f2b2L, 0x408630be72364360L, "jetbrains.mps.lang.typesystem.structure.TypesystemEquationStatementAnnotation");
