...
public final class AbstractRule__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isAttributeRule_id6lCixFI9vx1 = new SMethodBuilder<>(Boolean.TYPE).name("isAttributeRule").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7307171874933700673L).languageId(0xab76d5ed1746f2b2L, 0x7a5dda6291404668L).build2();
