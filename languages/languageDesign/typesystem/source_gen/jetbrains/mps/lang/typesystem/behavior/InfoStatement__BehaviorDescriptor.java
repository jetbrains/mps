...
public final class InfoStatement__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> attachNewMessageAnnotation_id7nf9pEwlup1 = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("attachMessageAnnotation").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("7nf9pEwlup1").build();
