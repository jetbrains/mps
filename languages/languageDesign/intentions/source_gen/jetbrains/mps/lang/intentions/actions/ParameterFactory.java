...
public class ParameterFactory {
  public static class NodeFactory_4958616572666533619 implements NodeFactory {
    ...
    private static SNode createForConceptMethodParameter_3abd0g_a0a1a0a() {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ForConceptMethodParameter$q0);
      rootBuilder1.setProperty(PROPS.name$MnvL, "node");
      rootBuilder1.forChild(LINKS.type$a1UY).init(CONCEPTS.SNodeType$hR);
