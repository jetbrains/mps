...
public final class IntentionDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getConceptName_idhEwIbu6 = new SMethodBuilder<>(String.class).name("getConceptName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877237638L).languageId(0x8431763b0c3c9f20L, 0xd7a92d38f7db40d0L).build2();
