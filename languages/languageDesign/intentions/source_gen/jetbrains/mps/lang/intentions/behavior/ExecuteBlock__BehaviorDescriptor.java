...
public final class ExecuteBlock__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    ...
    if ((SNodeOperations.getNodeAncestor(__thisNode__, CONCEPTS.ParameterizedIntentionDeclaration$Q_, false, false) != null)) {
      ListSequence.fromList(result).addElement(CONCEPTS.IntentionParameter$HG);
    }
    return result;
  }
  ...
  /*package*/ ExecuteBlock__BehaviorDescriptor() {
  }
