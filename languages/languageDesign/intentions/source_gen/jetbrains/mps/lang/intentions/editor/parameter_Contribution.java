...
public class parameter_Contribution extends SubstituteMenuBase {
  public parameter_Contribution() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "Expression", new SNodePointer("r:00000000-0000-4000-0000-011c89590350(jetbrains.mps.lang.intentions.editor)", "1741258697587120409")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Concepts_bxx1tv_a extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Concepts_bxx1tv_a() {
      super(new EditorMenuDescriptorBase("simple actions for the list of concepts", new SNodePointer("r:00000000-0000-4000-0000-011c89590350(jetbrains.mps.lang.intentions.editor)", "1741258697587120412")));
    }
