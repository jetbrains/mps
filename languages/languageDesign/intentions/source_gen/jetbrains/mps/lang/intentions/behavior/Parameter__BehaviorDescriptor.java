...
public final class Parameter__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getDeclaration_id7T23sO8vZuR = new SMethodBuilder<>(SNode.class).name("getDeclaration").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(9097849371503884215L).languageId(0xbc73f2e16994cc67L, 0xc7d5b9dda05f4be2L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getDeclaration_id7T23sO8vZuR, getExpectedRetType_idi2fhBNC);
  ...
  /*package*/ static SNode getExpectedRetType_idi2fhBNC(@NotNull SNode __thisNode__) {
    return _quotation_createNode_5ob2us_a0a1(SLinkOperations.getTarget(__thisNode__, LINKS.parameterType$gOGt));
  }
