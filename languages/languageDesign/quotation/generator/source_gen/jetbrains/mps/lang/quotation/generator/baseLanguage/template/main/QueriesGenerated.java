...
public class QueriesGenerated {
  public static boolean rule_Condition_4_0(final BaseMappingRuleContext _context) {
    return (boolean) NodeBuilderNode__BehaviorDescriptor.isExpressionExternal_id4IuFl2JvP6C.invoke(SNodeOperations.asSConcept(CONCEPTS.NodeBuilderNode$Sn), NodeBuilderInitProperty__BehaviorDescriptor.getInitValue_id1o$2SUuvKUZ.invoke(_context.getNode()));
  }
  public static boolean rule_Condition_4_1(final BaseMappingRuleContext _context) {
    return SNodeOperations.isInstanceOf(NodeBuilderInitProperty__BehaviorDescriptor.getInitValue_id1o$2SUuvKUZ.invoke(_context.getNode()), CONCEPTS.StringLiteral$xu) && (boolean) DataTypeDeclaration__BehaviorDescriptor.isSimpleString_idhKtFG6a.invoke(SLinkOperations.getTarget(SLinkOperations.getTarget(_context.getNode(), LINKS.property$Y_u4), LINKS.dataType$5j5Y));
  }
  ...
  public static boolean rule_Condition_4_5(final BaseMappingRuleContext _context) {
    return SEnumOperations.isMember(SPropertyOperations.getEnum(SLinkOperations.getTarget(_context.getNode(), LINKS.link$VNT5), PROPS.metaClass$PeKc), 0xfc6f4e95b8L) && SNodeOperations.isInstanceOf(NodeBuilderInitLink__BehaviorDescriptor.getInitValue_id1o$2SUuvJqx.invoke(_context.getNode()), CONCEPTS.NodeBuilderExpression$UJ) && !((boolean) NodeBuilderNode__BehaviorDescriptor.isExpressionExternal_id4IuFl2JvP6C.invoke(SNodeOperations.asSConcept(CONCEPTS.NodeBuilderNode$Sn), SLinkOperations.getTarget(SNodeOperations.cast(NodeBuilderInitLink__BehaviorDescriptor.getInitValue_id1o$2SUuvJqx.invoke(_context.getNode()), CONCEPTS.NodeBuilderExpression$UJ), LINKS.expression$2il5))) && Expression__BehaviorDescriptor.getCompileTimeConstantValue_idi1LP2xI.invoke(SLinkOperations.getTarget(SNodeOperations.cast(NodeBuilderInitLink__BehaviorDescriptor.getInitValue_id1o$2SUuvJqx.invoke(_context.getNode()), CONCEPTS.NodeBuilderExpression$UJ), LINKS.expression$2il5), SNodeOperations.getModel(_context.getNode()).getModule()) == null;
  }
  ...
  public static boolean rule_Condition_5_0(final BaseMappingRuleContext _context) {
    return !(((Boolean) _context.getVariable("forceDeclare"))) && ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.as(_context.getNode(), CONCEPTS.NodeBuilderNode$Sn), LINKS.values$JgAV)).isEmpty();
  }
  ...
  public static boolean ifMacro_Condition_0_2(final IfMacroContext _context) {
    SNode quotation = SNodeOperations.getNodeAncestor(_context.getNode(), CONCEPTS.Quotation$Vl, false, false);
    return (SLinkOperations.getTarget(quotation, LINKS.nodeId_old$s_sY) == null) && (SLinkOperations.getTarget(SLinkOperations.getTarget(quotation, LINKS.modelToCreate$$LCB), LINKS.nodeId$HXr5) == null);
  }
  ...
  public static Iterable<SNode> sourceNodesQuery_3_0(final SourceSubstituteMacroNodesContext _context) {
    return Sequence.fromIterable(NodeBuilderNode__BehaviorDescriptor.getExternalExpressions_idRRzwLnBxZy.invoke(SLinkOperations.getTarget(_context.getNode(), LINKS.quotedNode$cF64))).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.hasRole(it, LINKS.expression$2il5) && (SNodeOperations.hasRole(SNodeOperations.getParent(it), LINKS.expression$YNz0) || SNodeOperations.hasRole(SNodeOperations.getParent(it), LINKS.initValue$qHpN)) && (boolean) LinkDeclaration__BehaviorDescriptor.isSingular_idhEwIfAt.invoke(SLinkOperations.getTarget(SNodeOperations.cast(SNodeOperations.getParent(SNodeOperations.getParent(it)), CONCEPTS.NodeBuilderInitLink$XR), LINKS.link$VNT5)) || SNodeOperations.hasRole(it, LINKS.expression$2il5) && SNodeOperations.hasRole(SNodeOperations.getParent(it), LINKS.nodes$MvP4);
      }
    });
  }
  public static Iterable<SNode> sourceNodesQuery_3_1(final SourceSubstituteMacroNodesContext _context) {
    return Sequence.fromIterable(NodeBuilderNode__BehaviorDescriptor.getExternalExpressions_idRRzwLnBxZy.invoke(SLinkOperations.getTarget(_context.getNode(), LINKS.quotedNode$cF64))).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.hasRole(it, LINKS.expression$2il5) && (SNodeOperations.hasRole(SNodeOperations.getParent(it), LINKS.expression$YNz0) || SNodeOperations.hasRole(SNodeOperations.getParent(it), LINKS.initValue$qHpN)) && !((boolean) LinkDeclaration__BehaviorDescriptor.isSingular_idhEwIfAt.invoke(SLinkOperations.getTarget(SNodeOperations.cast(SNodeOperations.getParent(SNodeOperations.getParent(it)), CONCEPTS.NodeBuilderInitLink$XR), LINKS.link$VNT5)));
      }
    });
  }
  public static Iterable<SNode> sourceNodesQuery_3_2(final SourceSubstituteMacroNodesContext _context) {
    return Sequence.fromIterable(NodeBuilderNode__BehaviorDescriptor.getExternalExpressions_idRRzwLnBxZy.invoke(SLinkOperations.getTarget(_context.getNode(), LINKS.quotedNode$cF64))).where(new IWhereFilter<SNode>() {
      public boolean accept(SNode it) {
        return SNodeOperations.hasRole(it, LINKS.expression$YNz0) || SNodeOperations.hasRole(it, LINKS.initValue$fqch);
      }
    });
  }
  ...
  public static Object varMacro_Value_5_1(final TemplateVarContext _context) {
    ConcurrentMap<String, Integer> builderMap = QuotationUtil.getBuilderMap(_context, SNodeOperations.getNodeAncestor(_context.getNode(), CONCEPTS.NodeBuilder$GJ, false, false), "index");
    int index = (builderMap.isEmpty() ? 0 : builderMap.get("index"));
    builderMap.put("index", index + 1);
    return index + 1;
  }
