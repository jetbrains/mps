...
public class typeof_Quotation_InferenceRule extends AbstractInferenceRule_Runtime implements InferenceRule_Runtime {
  ...
  public void applyRule(final SNode quotation, final TypeCheckingContext typeCheckingContext, IsApplicableStatus status) {
    ...
    }
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959034a(jetbrains.mps.lang.quotation.typesystem)", "3180306201267183161", true), (SNode) _quotation_createNode_wzo52i_a1a2a1a1(), false, false, _info_12389875345);
    }
    {
      ...
      typeCheckingContext.createLessThanInequality((SNode) typeCheckingContext.typeOf(_nodeToCheck_1029348928467, "r:00000000-0000-4000-0000-011c8959034a(jetbrains.mps.lang.quotation.typesystem)", "3180306201267192131", true), (SNode) _quotation_createNode_wzo52i_a1a2a2a1(), false, false, _info_12389875345);
    }
  }
  ...
  private static SNode _quotation_createNode_wzo52i_a1a2a0a1(Object parameter_1) {
  ...
  private static SNode _quotation_createNode_wzo52i_a1a2a1a1() {
    PersistenceFacade facade = PersistenceFacade.getInstance();
