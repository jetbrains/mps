...
public class NodeBuilderInitLink_ExpressionMenu extends TransformationMenuBase {
  public NodeBuilderInitLink_ExpressionMenu() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "NodeBuilderInitLink_ExpressionMenu", new SNodePointer("r:00000000-0000-4000-0000-011c89590349(jetbrains.mps.lang.quotation.editor)", "7984637217096306158")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
