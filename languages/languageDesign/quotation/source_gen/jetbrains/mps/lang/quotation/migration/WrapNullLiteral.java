...
public class WrapNullLiteral extends MigrationScriptBase {
  ...
  private static SNode createNodeBuilderExpression_nzk9pr_a0b0a0a0a0a6(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.NodeBuilderExpression$UJ);
    rootBuilder1.forChild(LINKS.expression$2il5).initNode(node0, CONCEPTS.Expression$mB, true);
