...
public class NodeBuilderInitLink_Menu extends SubstituteMenuBase {
  public NodeBuilderInitLink_Menu() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "NodeBuilderInitLink_Menu", new SNodePointer("r:00000000-0000-4000-0000-011c89590349(jetbrains.mps.lang.quotation.editor)", "7984637217096192335")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Wrap_5gak4t_b extends WrapperSubstituteMenuPart {
    private SMP_Wrap_5gak4t_b() {
      super(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "NullLiteral", new SNodePointer("r:00000000-0000-4000-0000-011c89590349(jetbrains.mps.lang.quotation.editor)", "6511867472298489813")));
    }
