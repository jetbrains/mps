...
public class QuotationConverter {
  ...
  private SNode convertPropertyOrAntiquotation(SProperty property, SNode attribute, String value) throws NumberFormatException {
    ...
    if (attribute != null) {
      SLinkOperations.setTarget(pval, LINKS.initValue$fqch, SLinkOperations.getTarget(attribute, LINKS.expression$hE$));
    } else {
      if ((boolean) DataTypeDeclaration__BehaviorDescriptor.isSimpleBooleanOrEnumOfBoolean_idhKtGY3g.invoke(dataType)) {
        SLinkOperations.setTarget(pval, LINKS.initValue$fqch, _quotation_createNode_aytayy_a0a0a0a5a5(Boolean.parseBoolean(value)));
      } else if ((boolean) DataTypeDeclaration__BehaviorDescriptor.isSimpleIntegerOrEnumOfInteger_idhKtGTZR.invoke(dataType)) {
        SLinkOperations.setTarget(pval, LINKS.initValue$fqch, _quotation_createNode_aytayy_a0a0a0a0f0f(Integer.parseInt(value)));
      } else if ((boolean) DataTypeDeclaration__BehaviorDescriptor.isSimpleStringOrEnumOfString_idhKtGPCt.invoke(dataType)) {
        SLinkOperations.setTarget(pval, LINKS.initValue$fqch, _quotation_createNode_aytayy_a0a0b0a0f0f(value));
      } else if (SNodeOperations.isInstanceOf(dataType, CONCEPTS.EnumerationDeclaration$hv)) {
        SLinkOperations.setTarget(pval, LINKS.initValue$fqch, _quotation_createNode_aytayy_a0a0c0a0f0f(SNodeOperations.cast(dataType, CONCEPTS.EnumerationDeclaration$hv), SNodeOperations.cast(check_aytayy_a1a0a0a2a0a5a5(check_aytayy_a0b0a0a0c0a0f0f(as_aytayy_a0a0b2a0a2a0a5a6(property.getType().fromString(value), SEnumerationLiteral.class)), pval), CONCEPTS.EnumerationMemberDeclaration$s9)));
      }
    }
    return pval;
  }
  ...
  private static SNode createNodeBuilderInitLink_aytayy_a0a0a4a7(SNode node0, Iterable<? extends SNode> seq0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.NodeBuilderInitLink$XR);
    rootBuilder1.setReferenceTarget(LINKS.link$VNT5, node0);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.initValue$qHpN).init(CONCEPTS.NodeBuilderList$md);
      n2.forChild(LINKS.nodes$MvP4).initNodeList(seq0, CONCEPTS.NodeBuilderInitLinkValue$_E);
    }
  ...
  private static SNode createNodeBuilderInitLink_aytayy_a0a0a5a7(SNode node0, SNode node1) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.NodeBuilderInitLink$XR);
    rootBuilder1.setReferenceTarget(LINKS.link$VNT5, node0);
    rootBuilder1.forChild(LINKS.initValue$qHpN).initNode(node1, CONCEPTS.NodeBuilderInitLinkValue$_E, true);
    return rootBuilder1.getResult();
  }
  private static SNode createNodeBuilderInitLink_aytayy_a0a3a6a7(SNode node0, SNode node1) {
    ...
    rootBuilder1.setReferenceTarget(LINKS.link$VNT5, node0);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.initValue$qHpN).init(CONCEPTS.NodeBuilderExpression$UJ);
      n2.forChild(LINKS.expression$2il5).initNode(node1, CONCEPTS.Expression$mB, true);
    }
    return rootBuilder1.getResult();
  }
