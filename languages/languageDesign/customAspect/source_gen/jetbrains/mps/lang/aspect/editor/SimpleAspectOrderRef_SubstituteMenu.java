...
public class SimpleAspectOrderRef_SubstituteMenu extends SubstituteMenuBase {
  public SimpleAspectOrderRef_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for SimpleAspectOrderRef. Generated from implicit smart reference attribute.", new SNodePointer("r:2ea71bfd-fe13-4525-9346-023b05757b39(jetbrains.mps.lang.aspect.structure)", "174635545557784815")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_rard3o_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_rard3o_a() {
      super(CONCEPTS.SimpleAspectOrderRef$Mw, LINKS.target$d3me, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_rard3o_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_rard3o_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "SimpleAspectOrderRef", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.SimpleAspectOrderRef$Mw);
    }
