...
/*package*/ class TransformationMenuPart_Refactoring_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.refactoring$YX8k;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.refactoring$YX8k);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.refactoring$YX8k);
    }
  ...
  private static class featuresListHandler_rkww6w_c0 extends RefNodeListHandler {
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(featuresListHandler_rkww6w_c0.this.getNode(), LINKS.features$gNd));
      try {
