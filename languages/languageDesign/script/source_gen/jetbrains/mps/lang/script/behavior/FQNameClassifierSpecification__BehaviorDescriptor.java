...
public final class FQNameClassifierSpecification__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getClassifierFqName_id4HFrnGErDob = new SMethodBuilder<>(String.class).name("getClassifierFqName").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5434557751112930827L).languageId(0xbc2cde50fd4ce470L, 0xeddeefac2d64437L).build2();
  public static final SMethod<String> getSModelReference_id4HFrnGEt_VQ = new SMethodBuilder<>(String.class).name("getSModelReference").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5434557751113441014L).languageId(0xbc2cde50fd4ce470L, 0xeddeefac2d64437L).build2();
