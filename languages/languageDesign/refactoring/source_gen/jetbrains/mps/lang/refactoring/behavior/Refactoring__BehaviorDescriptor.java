...
public final class Refactoring__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getBaseConcept_id2hxg_BDjKM8, setBaseConcept_id5r_35Ihc58c);


  /*package*/ static SNode getBaseConcept_id2hxg_BDjKM8(@NotNull SNode __thisNode__) {
    if (!(SNodeOperations.isInstanceOf(SLinkOperations.getTarget(__thisNode__, LINKS.target$qEUa), CONCEPTS.NodeTarget$gN))) {
      return null;
    }
    return SLinkOperations.getTarget(SNodeOperations.cast(SLinkOperations.getTarget(__thisNode__, LINKS.target$qEUa), CONCEPTS.NodeTarget$gN), LINKS.concept$wG_L);
  }
  /*package*/ static void setBaseConcept_id5r_35Ihc58c(@NotNull SNode __thisNode__, SNode baseConcept) {
    ...
    SLinkOperations.setTarget(nodeTarget, LINKS.concept$wG_L, baseConcept);
    SLinkOperations.setTarget(__thisNode__, LINKS.target$qEUa, nodeTarget);
  }
