...
public class NativeDefStyles_StyleSheet {
   ...
   */
  @Deprecated
  public static void apply_RuleKindStyle(Style style, EditorCell editorCell) {
    SNode node = (editorCell == null ? null : editorCell.getSNode());
    EditorContext editorContext = (editorCell == null ? null : editorCell.getContext());
    new NativeDefStyles_StyleSheet.RuleKindStyleStyleClass(editorContext, node).apply(style, editorCell);
  }
  ...
  public static class RuleKindStyleStyleClass extends AbstractStyleClass {
    public RuleKindStyleStyleClass(EditorContext editorContext, SNode node) {
      super(editorContext, node);
    }
