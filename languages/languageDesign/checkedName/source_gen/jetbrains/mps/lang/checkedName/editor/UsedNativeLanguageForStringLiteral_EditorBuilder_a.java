...
/*package*/ class UsedNativeLanguageForStringLiteral_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public UsedNativeLanguageForStringLiteral_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_f5lrnp_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_f5lrnp_a0");
  ...
  private EditorCell createProperty_0() {
    ...
    try {
      final SProperty property = PROPS.nativeLanguage$HnA0;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
      editorCell.setDefaultText("<no nativeLanguage>");
      editorCell.setCellId("property_nativeLanguage");
      Style style = new StyleImpl();
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ">");
    editorCell.setCellId("Constant_f5lrnp_d0");
    Style style = new StyleImpl();
