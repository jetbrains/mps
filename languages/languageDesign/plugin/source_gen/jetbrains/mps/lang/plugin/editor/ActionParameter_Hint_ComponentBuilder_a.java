...
/*package*/ class ActionParameter_Hint_ComponentBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createReadOnlyModelAccessor_0() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor.ReadOnly() {
      public String getText() {
        ...
        String descriptionString = SPropertyOperations.getString(SNodeOperations.cast(SLinkOperations.getTarget(description, LINKS.value$Y7om), CONCEPTS.StringLiteral$xu), PROPS.value$w7MM);
  ...
  private EditorCell createReadOnlyModelAccessor_1() {
    EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new ModelAccessor.ReadOnly() {
      public String getText() {
        ...
        String longDescriptionString = SPropertyOperations.getString(SNodeOperations.cast(SLinkOperations.getTarget(longDescription, LINKS.value$Y7om), CONCEPTS.StringLiteral$xu), PROPS.value$w7MM);
  ...
  private static SNode _quotation_createNode_xpsq7t_a0a0a0a0a0a0a0a0a0a() {
    ...
    nb.setReference(MetaAdapterFactory.getReferenceLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0x101de48bf9eL, 0x101de490babL, "classifier"), "742f6602-5a2f-4313-aa6e-ae1cd4ffdc61/java:jetbrains.mps.ide.actions(MPS.Platform/)/~MPSCommonDataKeys$Description");
    return quotedNode_1;
  }
