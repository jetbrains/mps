...
public final class GroupAnchor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getId_idhEwIkYn = new SMethodBuilder<>(String.class).name("getId").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877276567L).languageId(0xaeba0a1039153ab1L, 0x28f9e4973b424291L).build2();
  public static final SMethod<String> getActionId_id4L4tRTddLSL = new SMethodBuilder<>(String.class).name("getActionId").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5495648829643890225L).languageId(0xaeba0a1039153ab1L, 0x28f9e4973b424291L).build2();
