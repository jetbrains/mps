...
public final class PreferencePageCommitBlock__BehaviorDescriptor extends BaseBHDescriptor {
  private static final SAbstractConcept CONCEPT = MetaAdapterFactory.getConcept(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x119e291160cL, "jetbrains.mps.lang.plugin.structure.PreferencePageCommitBlock");

  public static final SMethod<Boolean> showName_id1653mnvAgry = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("showName").modifiers(9, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1653mnvAgry").build();
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(result).addElement(CONCEPTS.ConceptFunctionParameter_Project$mm);
    ListSequence.fromList(result).addElement(CONCEPTS.ConceptFunctionParameter_PreferencePage_component$yk);
    return result;
  }
  ...
  /*package*/ PreferencePageCommitBlock__BehaviorDescriptor() {
  }
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept ConceptFunctionParameter_Project$mm = MetaAdapterFactory.getConcept(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0x11aa1691a43L, "jetbrains.mps.lang.plugin.structure.ConceptFunctionParameter_Project");
