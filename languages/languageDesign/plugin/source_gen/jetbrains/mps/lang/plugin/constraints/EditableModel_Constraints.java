...
public class EditableModel_Constraints extends BaseConstraintsDescriptor {
  ...
  private static boolean staticCanBeAChild(SNode node, SNode parentNode, SAbstractConcept childConcept, SContainmentLink link) {
    return TypecheckingFacade.getFromContext().isSubtype(TypecheckingFacade.getFromContext().getTypeOf(SNodeOperations.getNodeAncestor(parentNode, CONCEPTS.ActionDataParameterDeclaration$Tg, true, false)), _quotation_createNode_z543ji_b0a0a2());
  }
  private static SNode _quotation_createNode_z543ji_b0a0a2() {
