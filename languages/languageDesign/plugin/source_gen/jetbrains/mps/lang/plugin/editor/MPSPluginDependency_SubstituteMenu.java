...
public class MPSPluginDependency_SubstituteMenu extends SubstituteMenuBase {
  public MPSPluginDependency_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for MPSPluginDependency. Generated from implicit smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c89590368(jetbrains.mps.lang.plugin.structure)", "203415309825565488")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_3m2jlx_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_3m2jlx_a() {
      super(CONCEPTS.MPSPluginDependency$82, LINKS.plugin$lEsz, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_3m2jlx_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_3m2jlx_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "MPSPluginDependency", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.MPSPluginDependency$82);
    }
