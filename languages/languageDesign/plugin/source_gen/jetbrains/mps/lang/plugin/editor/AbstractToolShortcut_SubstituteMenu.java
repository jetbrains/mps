...
public class AbstractToolShortcut_SubstituteMenu extends SubstituteMenuBase {
  ...
  public class SMP_Subconcepts_7ty2v0_a extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    protected Collection getConcepts(final SubstituteMenuContext _context) {
      return ConceptDescendantsCache.getInstance().getDirectDescendants(CONCEPTS.AbstractToolShortcut$H$).stream().filter(new Predicate<SAbstractConcept>() {
  ...
  private static SNode createCustomToolShortcut_7ty2v0_a0a0b(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.CustomToolShortcut$dV);
    {
      SNodeBuilder n2 = rootBuilder1.forChild(LINKS.changes$UATs).initNode(node0, CONCEPTS.AbstractToolKeystroke$SP, false);
    }
