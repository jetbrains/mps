...
public final class ActionGroupDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getGroupPrefix_idhEwJa7y = new SMethodBuilder<>(String.class).name("getGroupPrefix").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877494242L).languageId(0xaeba0a1039153ab1L, 0x28f9e4973b424291L).build2();
  public static final SMethod<String> getGeneratedName_idhEwJa82 = new SMethodBuilder<>(String.class).name("getGeneratedName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877494274L).languageId(0xaeba0a1039153ab1L, 0x28f9e4973b424291L).build2();
  public static final SMethod<String> getGeneratedClassFQName_idhEwJa8g = new SMethodBuilder<>(String.class).name("getGeneratedClassFQName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877494288L).languageId(0xaeba0a1039153ab1L, 0x28f9e4973b424291L).build2();
