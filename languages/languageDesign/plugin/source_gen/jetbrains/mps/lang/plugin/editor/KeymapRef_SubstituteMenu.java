...
public class KeymapRef_SubstituteMenu extends SubstituteMenuBase {
  public KeymapRef_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for KeymapRef. Generated from implicit smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c89590368(jetbrains.mps.lang.plugin.structure)", "331224023792855166")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_evuyo1_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_evuyo1_a() {
      super(CONCEPTS.KeymapRef$X9, LINKS.keymap$F_03, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_evuyo1_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_evuyo1_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "KeymapRef", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.KeymapRef$X9);
    }
