...
public final class CreateBlock__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private static final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(showName_id1653mnvAgry, getParameterConcepts_id2xELmDxyi2v, getExpectedReturnType_idhEwIGRD, usesParameterObject_id1653mnvAgq0);
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(result).addElement(CONCEPTS.ConceptFunctionParameter_NodeReference$CY);
  ...
  /*package*/ static boolean usesParameterObject_id1653mnvAgq0(@NotNull SAbstractConcept __thisConcept__) {
    // in fact, we use dedicated templates for each CF parameter, see EditorTabs MC, however, why not 
    // to state this CF does use parameter object.
    return true;
  }
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept ConceptFunctionParameter_NodeReference$CY = MetaAdapterFactory.getConcept(0x28f9e4973b424291L, 0xaeba0a1039153ab1L, 0xb6b688a943085fcL, "jetbrains.mps.lang.plugin.structure.ConceptFunctionParameter_NodeReference");
