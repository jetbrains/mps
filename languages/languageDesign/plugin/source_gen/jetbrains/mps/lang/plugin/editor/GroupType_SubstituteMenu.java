...
public class GroupType_SubstituteMenu extends SubstituteMenuBase {
  public GroupType_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for GroupType. Generated from the smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c89590368(jetbrains.mps.lang.plugin.structure)", "4747359941569483768")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_zea67z_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_zea67z_a() {
      super(CONCEPTS.GroupType$8x, LINKS.actionGroup$zaV4, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }
