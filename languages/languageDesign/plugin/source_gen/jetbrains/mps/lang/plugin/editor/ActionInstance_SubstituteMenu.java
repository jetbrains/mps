...
public class ActionInstance_SubstituteMenu extends SubstituteMenuBase {
  public ActionInstance_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for ActionInstance. Generated from implicit smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c89590368(jetbrains.mps.lang.plugin.structure)", "1203088046679")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_2cluuu_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_2cluuu_a() {
      super(CONCEPTS.ActionInstance$Zi, LINKS.action$rhg1, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_2cluuu_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_2cluuu_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "ActionInstance", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.ActionInstance$Zi);
    }
