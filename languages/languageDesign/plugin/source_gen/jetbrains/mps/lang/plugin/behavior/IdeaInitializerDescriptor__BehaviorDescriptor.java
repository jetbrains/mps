...
public final class IdeaInitializerDescriptor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getGeneratedFileName_id3uUnGg98wJc = new SMethodBuilder<>(String.class).name("getGeneratedFileName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4015626213814045644L).languageId(0xaeba0a1039153ab1L, 0x28f9e4973b424291L).build2();
  public static final SMethod<String> getGeneratedFileShortName_id3uUnGg98M$X = new SMethodBuilder<>(String.class).name("getGeneratedFileShortName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4015626213814118717L).languageId(0xaeba0a1039153ab1L, 0x28f9e4973b424291L).build2();
  public static final SMethod<String> getGeneratesFileExtension_id3uUnGg98M_4 = new SMethodBuilder<>(String.class).name("getGeneratesFileExtension").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4015626213814118724L).languageId(0xaeba0a1039153ab1L, 0x28f9e4973b424291L).build2();
  public static final SMethod<String> getLibrariesResourceName_id6Ug_cEzkAtK = new SMethodBuilder<>(String.class).name("getLibrariesResourceName").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7967031338862798704L).languageId(0xaeba0a1039153ab1L, 0x28f9e4973b424291L).build2();
