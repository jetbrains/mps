...
public class NumberToolShortcut_SubstituteMenu extends SubstituteMenuBase {
  public NumberToolShortcut_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "NumberToolShortcut", new SNodePointer("r:00000000-0000-4000-0000-011c89590363(jetbrains.mps.lang.plugin.editor)", "471625927508412675")));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SimpleConceptSubstituteMenuPart(CONCEPTS.NumberToolShortcut$wS, new EditorMenuDescriptorBase("simple substitute menu part for concept: " + "NumberToolShortcut", new SNodePointer("r:00000000-0000-4000-0000-011c89590363(jetbrains.mps.lang.plugin.editor)", "471625927509637891"))), CONCEPTS.NumberToolShortcut$wS));
  ...
  private class SMP_Action_33swfs_b extends SingleItemSubstituteMenuPart {
    ...
    private class Item extends DefaultSubstituteMenuItem {
      ...
      /*package*/ void resetTraceInfo() {
        ...
        updateTraceInfo(description, new SNodePointer("r:00000000-0000-4000-0000-011c89590363(jetbrains.mps.lang.plugin.editor)", "471625927508555327"));
      }
