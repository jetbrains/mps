...
public class NumberToolShortcut_SubstituteMenu extends SubstituteMenuBase {
  ...
  private static SNode createNumberToolShortcut_33swfs_a0a0b(Object p0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.NumberToolShortcut$wS);
    rootBuilder1.setProperty(PROPS.number$WFYX, PROPS.number$WFYX.getType().toString(p0));
