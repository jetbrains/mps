...
public class AddMyselfToMenuOfRuleBlockMember extends SubstituteMenuBase {
  public AddMyselfToMenuOfRuleBlockMember() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "default substitute menu for " + "RuleBlockMember", new SNodePointer("r:b27aeb14-fefb-4745-88f9-0731c33985d8(jetbrains.mps.lang.rulesAndMessages.editor)", "668954446731666655")));
  }
  @NotNull
  @Override
