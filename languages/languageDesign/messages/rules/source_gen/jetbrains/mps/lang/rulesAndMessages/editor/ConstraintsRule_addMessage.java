...
public class ConstraintsRule_addMessage extends TransformationMenuBase {
  ...
  public List<TransformationMenuItem> createMenuItems(@NotNull TransformationMenuContext context) {
    ...
    context.getEditorMenuTrace().setDescriptor(new EditorMenuDescriptorBase("contribution to the " + "default transformation menu for " + "RuleBlockMember", new SNodePointer("r:b27aeb14-fefb-4745-88f9-0731c33985d8(jetbrains.mps.lang.rulesAndMessages.editor)", "5258059200640889497")));
    try {
  ...
  private class TMP_Action_15ym95_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SubstituteCompletionActionItem {
      ...
      public void execute(@NotNull String pattern) {
        ...
        SNode replacement = SNodeFactoryOperations.replaceWithNewChild(transformingRule, MetaAdapterFactory.getConcept(0xb3551702269c4f05L, 0xba6158060cef4292L, 0x46263286dc0ce67L, "jetbrains.mps.lang.rulesAndMessages.structure.ConstraintsRuleWithMessage"));
