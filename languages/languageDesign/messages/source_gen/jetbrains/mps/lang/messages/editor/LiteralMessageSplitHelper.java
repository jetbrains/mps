...
public final class LiteralMessageSplitHelper {
  ...
  private static SNode createLiteralMessageExpression_fsei94_a0a0a3a1a1a7(Object p0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.LiteralMessageExpression$$8);
    rootBuilder1.setProperty(PROPS.message$umWY, PROPS.message$umWY.getType().toString(p0));
  ...
  private static SNode createCombinedMessageExpression_fsei94_a0a0a0g0b0b0h(Iterable<? extends SNode> seq0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.CombinedMessageExpression$6z);
    rootBuilder1.forChild(LINKS.part$kCpv).initNodeList(seq0, CONCEPTS.MessageExpression$zD);
    return rootBuilder1.getResult();
  }
