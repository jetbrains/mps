...
public class MacroMessageExpression_TransformationMenu extends TransformationMenuBase {
  public MacroMessageExpression_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "MacroMessageExpression", new SNodePointer("r:46037634-9be0-4da8-8dd8-3cb367171177(jetbrains.mps.lang.messages.editor)", "6878448148911830664")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
