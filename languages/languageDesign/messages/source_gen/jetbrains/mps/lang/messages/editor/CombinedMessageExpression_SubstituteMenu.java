...
public class CombinedMessageExpression_SubstituteMenu extends SubstituteMenuBase {
  public CombinedMessageExpression_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "CombinedMessageExpression", new SNodePointer("r:46037634-9be0-4da8-8dd8-3cb367171177(jetbrains.mps.lang.messages.editor)", "5258059200643875754")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Wrap_6s2f6n_b extends WrapperSubstituteMenuPart {
    private SMP_Wrap_6s2f6n_b() {
      super(new EditorMenuDescriptorBase("wrap " + "default substitute menu for " + "MessageExpression", new SNodePointer("r:46037634-9be0-4da8-8dd8-3cb367171177(jetbrains.mps.lang.messages.editor)", "5419908871934263197")));
    }
