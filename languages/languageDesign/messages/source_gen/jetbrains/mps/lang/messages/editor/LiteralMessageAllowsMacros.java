...
public class LiteralMessageAllowsMacros extends TransformationMenuBase {
  public LiteralMessageAllowsMacros() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "LiteralMessageAllowsMacros", new SNodePointer("r:46037634-9be0-4da8-8dd8-3cb367171177(jetbrains.mps.lang.messages.editor)", "2716118816016769335")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
    ...
    private class TMP_Action_bp93v8_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SubstituteCompletionActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:46037634-9be0-4da8-8dd8-3cb367171177(jetbrains.mps.lang.messages.editor)", "4356326056162120467"));
          return this;
        }
        @Nullable
        @Override
