...
public final class NodeDefaultSearchScope__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getReferentConcept_idhEwIhhr = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getReferentConcept").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("hEwIhhr").build();
