...
public final class NodeDefaultSearchScope__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getReferentConcept_idhEwIhhr = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getReferentConcept").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1213877261403L).languageId(0x8b10c83066ffa4a1L, 0x3f4bc5f5c6c14a28L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getReferentConcept_idhEwIhhr);
