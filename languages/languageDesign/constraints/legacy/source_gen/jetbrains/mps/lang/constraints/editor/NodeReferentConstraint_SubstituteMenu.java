...
public class NodeReferentConstraint_SubstituteMenu extends SubstituteMenuBase {
  public NodeReferentConstraint_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for NodeReferentConstraint. Generated from the smart reference attribute.", new SNodePointer("r:00000000-0000-4000-0000-011c8959030d(jetbrains.mps.lang.constraints.structure)", "8846826897881127661")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_lmi3tj_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_lmi3tj_a() {
      super(CONCEPTS.NodeReferentConstraint$PH, LINKS.applicableLink$7IrX, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }
