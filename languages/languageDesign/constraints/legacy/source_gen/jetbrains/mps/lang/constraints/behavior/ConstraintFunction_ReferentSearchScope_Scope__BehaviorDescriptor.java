...
public final class ConstraintFunction_ReferentSearchScope_Scope__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getExpectedReturnType_idhEwIGRD, usesParameterObjectFor_idhEwIGRw, getParameterConcepts_id2xELmDxyi2v);
  ...
  /*package*/ static List<SConcept> getParameterConcepts_id2xELmDxyi2v(@NotNull SNode __thisNode__) {
    ...
    ListSequence.fromList(result).addElement(CONCEPTS.ConstraintFunctionParameter_containmentLink$bA);
    ListSequence.fromList(result).addElement(CONCEPTS.ConstraintFunctionParameter_position$sJ);
    ListSequence.fromList(result).addElement(CONCEPTS.ConstraintFunctionParameter_linkTarget$tq);
    return result;
  }
