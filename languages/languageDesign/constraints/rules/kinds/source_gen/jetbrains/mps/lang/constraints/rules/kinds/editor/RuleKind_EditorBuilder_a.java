...
/*package*/ class RuleKind_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefCell_0() {
    CellProviderWithRole provider = new RefCellCellProvider(myNode, LINKS.context$kJBE, CONCEPTS.Context$J, "context", getEditorContext()) {
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.context$kJBE);
    }
  ...
  /*package*/ static class Inline_Builder0 extends AbstractEditorBuilder {
    ...
    private EditorCell createRefNode_0() {
      SingleRoleCellProvider provider = new Inline_Builder0.conceptParameterSingleRoleHandler_velomm_a0a3a(myNode, LINKS.conceptParameter$RcpC, getEditorContext());
  ...
  /*package*/ static class Inline_Builder1 extends AbstractEditorBuilder {
    ...
    private static class defsListHandler_velomm_a0a0e0 extends RefNodeListHandler {
      ...
      public EditorCell createEmptyCell() {
        getCellFactory().pushCellContext();
        getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(defsListHandler_velomm_a0a0e0.this.getNode(), LINKS.defs$5m69));
        try {
