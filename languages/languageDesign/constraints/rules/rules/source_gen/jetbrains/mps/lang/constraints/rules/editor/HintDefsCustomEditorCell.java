...
public class HintDefsCustomEditorCell extends AbstractCellProvider {
  ...
  private static SNode createEditorListOfDefs_igmisa_a0d0e(Iterable<? extends SNode> seq0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.EditorListOfDefs$ZA);
    rootBuilder1.forChild(LINKS.defs$pap1).initNodeList(seq0, CONCEPTS.TypedDefReference$yw);
