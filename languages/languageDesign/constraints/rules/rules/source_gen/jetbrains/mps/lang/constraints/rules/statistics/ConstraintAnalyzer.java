...
public class ConstraintAnalyzer {
  ...
  public static class ResultSingleExpression extends Result {
    ...
    private static SNode createRule_6fp4o1_a0a0a2b(SNode node0) {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.Rule$DP);
      rootBuilder1.setProperty(PROPS.name$MnvL, "rule");
      {
        SNodeBuilder n2 = rootBuilder1.forChild(LINKS.expr$45_Z).init(CONCEPTS.ExpressionWrapper$eu);
        n2.forChild(LINKS.expression$aVsE).initNode(node0, CONCEPTS.Expression$mB, true);
      }
  ...
  public static class ResultIfLatterBuilder {
        ...
        if (SNodeOperations.isInstanceOf(ListSequence.fromList(SLinkOperations.getChildren(SLinkOperations.getTarget(ifStatement, LINKS.ifTrue$5Rg8), LINKS.statement$53DE)).first(), CONCEPTS.ReturnStatement$lt)) {
          ...
          if (SNodeOperations.isInstanceOf(SLinkOperations.getTarget(returnStatement, LINKS.expression$eJ92), CONCEPTS.BooleanConstant$n4)) {
            if (SPropertyOperations.getBoolean(SNodeOperations.cast(SLinkOperations.getTarget(returnStatement, LINKS.expression$eJ92), CONCEPTS.BooleanConstant$n4), PROPS.value$5y_M) == true) {
              ...
              ListSequence.fromList(rules).addElement(createRule_6fp4o1_a0a0a0a0b0b0b0o5(invertExpression(SLinkOperations.getTarget(ifStatement, LINKS.condition$5R17)), "rule" + (ListSequence.fromList(rules).count() + 1)));
            }
          } else {
            ListSequence.fromList(rules).addElement(createRule_6fp4o1_a0a0a0b0b0b0o5(SLinkOperations.getTarget(ifStatement, LINKS.condition$5R17), SLinkOperations.getTarget(returnStatement, LINKS.expression$eJ92), "rule" + (ListSequence.fromList(rules).count() + 1)));
          }
        } else {
          ...
          SNode defFromVar = createDefForRule_6fp4o1_a0b0a1a1a41f(SLinkOperations.getTarget(ifStatement, LINKS.condition$5R17), SLinkOperations.getTarget(localVariableDeclaration, LINKS.initializer$2twD), SLinkOperations.getTarget(localVariableDeclaration, LINKS.type$a1UY), SPropertyOperations.getString(localVariableDeclaration, PROPS.name$MnvL));
    ...
    private static SNode createIfStatement_6fp4o1_a0a0a4f(SNode node0, SNode node1) {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.IfStatement$Q4);
      rootBuilder1.setProperty(PROPS.forceMultiLine$S6tO, PROPS.forceMultiLine$S6tO.getType().toString(true));
      rootBuilder1.forChild(LINKS.condition$5R17).initNode(node0, CONCEPTS.Expression$mB, true);
      {
        SNodeBuilder n2 = rootBuilder1.forChild(LINKS.ifTrue$5Rg8).init(CONCEPTS.StatementList$m_);
        {
          SNodeBuilder n3 = n2.forChild(LINKS.statement$53DE).init(CONCEPTS.ReturnStatement$lt);
          n3.forChild(LINKS.expression$eJ92).initNode(node1, CONCEPTS.Expression$mB, true);
        }
      }
      return rootBuilder1.getResult();
    }
    private static SNode createBooleanConstant_6fp4o1_a0a0a5f() {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.BooleanConstant$n4);
      rootBuilder1.setProperty(PROPS.value$5y_M, PROPS.value$5y_M.getType().toString(true));
      return rootBuilder1.getResult();
    }
    private static SNode createAndExpression_6fp4o1_a0a0a0a1a5f(SNode node0, SNode node1) {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.AndExpression$c);
      rootBuilder1.forChild(LINKS.leftExpression$sEj).initNode(node0, CONCEPTS.Expression$mB, true);
      rootBuilder1.forChild(LINKS.rightExpression$nvX).initNode(node1, CONCEPTS.Expression$mB, true);
      return rootBuilder1.getResult();
    }
    private static SNode createIfStatement_6fp4o1_a0a2a6f(SNode node0, SNode node1) {
      ...
      rootBuilder1.forChild(LINKS.condition$5R17).initNode(node0, CONCEPTS.Expression$mB, true);
      {
        SNodeBuilder n2 = rootBuilder1.forChild(LINKS.ifTrue$5Rg8).init(CONCEPTS.StatementList$m_);
        {
          SNodeBuilder n3 = n2.forChild(LINKS.statement$53DE).init(CONCEPTS.LocalVariableDeclarationStatement$4w);
          n3.forChild(LINKS.localVariableDeclaration$RpjM).initNode(node1, CONCEPTS.LocalVariableDeclaration$41, true);
        }
      }
      return rootBuilder1.getResult();
    }
    private static SNode createNotExpression_6fp4o1_a0a0a0j5(SNode node0) {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.NotExpression$Pc);
      {
        SNodeBuilder n2 = rootBuilder1.forChild(LINKS.expression$sv_H).init(CONCEPTS.ParenthesizedExpression$Ws);
        n2.forChild(LINKS.expression$TlhM).initNode(node0, CONCEPTS.Expression$mB, true);
      }
      return rootBuilder1.getResult();
    }
    private static SNode createRule_6fp4o1_a0a0a0a0b0b0b0o5(SNode node0, Object p0) {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.Rule$DP);
      rootBuilder1.setProperty(PROPS.name$MnvL, PROPS.name$MnvL.getType().toString(p0));
      {
        SNodeBuilder n2 = rootBuilder1.forChild(LINKS.condition$h$Ae).init(CONCEPTS.ApplicableCondition$p8);
        {
          SNodeBuilder n3 = n2.forChild(LINKS.expr$ZgCK).init(CONCEPTS.ExpressionWrapper$eu);
          {
            SNodeBuilder n4 = n3.forChild(LINKS.expression$aVsE).init(CONCEPTS.BooleanConstant$n4);
            n4.setProperty(PROPS.value$5y_M, PROPS.value$5y_M.getType().toString(true));
          }
        }
      }
      {
        SNodeBuilder n5 = rootBuilder1.forChild(LINKS.expr$45_Z).init(CONCEPTS.ExpressionWrapper$eu);
        n5.forChild(LINKS.expression$aVsE).initNode(node0, CONCEPTS.Expression$mB, true);
      }
      return rootBuilder1.getResult();
    }
    private static SNode createRule_6fp4o1_a0a0a0b0b0b0o5(SNode node0, SNode node1, Object p0) {
      ...
      rootBuilder1.setProperty(PROPS.name$MnvL, PROPS.name$MnvL.getType().toString(p0));
      {
        ...
        {
          SNodeBuilder n3 = n2.forChild(LINKS.expr$ZgCK).init(CONCEPTS.ExpressionWrapper$eu);
          n3.forChild(LINKS.expression$aVsE).initNode(node0, CONCEPTS.Expression$mB, true);
        }
      }
      {
        SNodeBuilder n4 = rootBuilder1.forChild(LINKS.expr$45_Z).init(CONCEPTS.ExpressionWrapper$eu);
        n4.forChild(LINKS.expression$aVsE).initNode(node1, CONCEPTS.Expression$mB, true);
      }
      return rootBuilder1.getResult();
    }
    private static SNode createDefForRule_6fp4o1_a0b0a1a1a41f(SNode node0, SNode node1, SNode node2, Object p0) {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.DefForRule$_k);
      rootBuilder1.setProperty(PROPS.name$MnvL, PROPS.name$MnvL.getType().toString(p0));
      {
        SNodeBuilder n2 = rootBuilder1.forChild(LINKS.condition$h$Ae).init(CONCEPTS.ApplicableCondition$p8);
        {
      ...
      {
        SNodeBuilder n4 = rootBuilder1.forChild(LINKS.expr$mUyW).init(CONCEPTS.ExpressionWrapper$eu);
        n4.forChild(LINKS.expression$aVsE).initNode(node1, CONCEPTS.Expression$mB, true);
      }
      rootBuilder1.forChild(LINKS.type$S49v).initNode(node2, CONCEPTS.Type$bu, true);
      return rootBuilder1.getResult();
    }
  }
  ...
  private static SNode createTypedDefReference_6fp4o1_a0a0a2a0a41(SNode node0) {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.TypedDefReference$yw);
    rootBuilder1.setReferenceTarget(LINKS.declaration$xU6a, node0);
    return rootBuilder1.getResult();
  }
