            ...
            if (SetSequence.fromSet(visiting).contains(depDef)) {
              {
                ...
                IErrorReporter _reporter_2309309498 = typeCheckingContext.reportTypeError(def, "Remove cycle in the declared defs (" + SNodeUtil.getPresentation(it) + " is involved)", "r:61c80a02-cc27-4085-b38d-beaf0fede70a(jetbrains.mps.lang.constraints.rules.typesystem)", "2716118816012262155", null, errorTarget);
              }
              return;
            }
