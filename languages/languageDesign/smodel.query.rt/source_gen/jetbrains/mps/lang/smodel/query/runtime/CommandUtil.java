...
public class CommandUtil {
  public static Iterable<SNode> nodes(SearchScope scope) {
    return Sequence.fromIterable(models(scope)).translate((it) -> SModelOperations.nodes(it, null));
  }

  public static Iterable<SReference> references(SearchScope scope) {
    return Sequence.fromIterable(nodes(scope)).translate((it) -> SNodeOperations.getReferences(it));
  }
  ...
  public static _FunctionTypes._return_P0_E0<? extends SearchResults> nodesToResults(final Iterable<SNodeReference> nodes, final SRepository repository) {
    return () -> {
      ...
      Sequence.fromIterable(nodes).where(new _FunctionTypes._return_P1_E0<Boolean, SNodeReference>() {
        public Boolean invoke(SNodeReference it) {
          return check_1pinza_a0a0a0a0b0a0a21(it, repository) != null;
        }
      }).visitAll(new _FunctionTypes._void_P1_E0<SNodeReference>() {
        public void invoke(SNodeReference it) {
  ...
  public static _FunctionTypes._return_P0_E0<? extends SearchResults> modelsToResults(final Iterable<SModelReference> models, final SRepository repository) {
    return () -> {
      ...
      Sequence.fromIterable(models).where(new _FunctionTypes._return_P1_E0<Boolean, SModelReference>() {
        public Boolean invoke(SModelReference it) {
          return check_1pinza_a0a0a0a0b0a0a41(it, repository) != null;
        }
      }).visitAll(new _FunctionTypes._void_P1_E0<SModelReference>() {
        public void invoke(SModelReference it) {
  ...
  public static _FunctionTypes._return_P0_E0<? extends SearchResults> modulesToResults(final Iterable<SModuleReference> modules, final SRepository repository) {
    return ((_FunctionTypes._return_P0_E0<SearchResults<SModule>>) () -> {
      final SearchResults<SModule> res = new SearchResults<SModule>();
      Sequence.fromIterable(modules).where(new _FunctionTypes._return_P1_E0<Boolean, SModuleReference>() {
        public Boolean invoke(SModuleReference it) {
          return check_1pinza_a0a0a0a0b0a0a61(it, repository) != null;
        }
      }).visitAll(new _FunctionTypes._void_P1_E0<SModuleReference>() {
        public void invoke(SModuleReference it) {
