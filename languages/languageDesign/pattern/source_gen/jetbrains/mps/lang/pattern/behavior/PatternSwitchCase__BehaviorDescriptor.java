...
public final class PatternSwitchCase__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> hasVariableReferences_id5sDn0OneX$C = new SMethodBuilder<>(Boolean.TYPE).name("hasVariableReferences").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6280652366638995752L).languageId(0xaf012b78369b0ba7L, 0xd4615e3bd6714ba9L).build2();

  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getScope_id52_Geb4QDV$, hasVariableReferences_id5sDn0OneX$C);
