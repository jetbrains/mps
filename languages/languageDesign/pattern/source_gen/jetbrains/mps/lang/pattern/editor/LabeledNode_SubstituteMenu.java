...
public class LabeledNode_SubstituteMenu extends SubstituteMenuBase {
  public LabeledNode_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "LabeledNode", new SNodePointer("r:00000000-0000-4000-0000-011c89590342(jetbrains.mps.lang.pattern.editor)", "291641273397913865")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Action_xgule9_a extends SingleItemSubstituteMenuPart {
    ...
    private class Item extends DefaultSubstituteMenuItem {
      ...
      /*package*/ void resetTraceInfo() {
        ...
        updateTraceInfo(description, new SNodePointer("r:00000000-0000-4000-0000-011c89590342(jetbrains.mps.lang.pattern.editor)", "9079830899493334285"));
      }
