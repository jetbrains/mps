...
public class AbstractPatternProvider_SubstituteMenu extends SubstituteMenuBase {
  ...
  private static SNode createInlinePatternProvider_mehu0s_a0a0b(SNode p0) {
    SNodeBuilder rootBuilder = new SNodeBuilder().init(CONCEPTS.InlinePatternProvider$43);
    rootBuilder.forChild(LINKS.pattern$65eZ).initNode(p0, CONCEPTS.PatternBuilder$Pa, true);
