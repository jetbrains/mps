...
public class ExpressionPatternProvider extends TransformationMenuBase {
  public ExpressionPatternProvider() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "ExpressionPatternProvider", new SNodePointer("r:00000000-0000-4000-0000-011c89590342(jetbrains.mps.lang.pattern.editor)", "8187773339868339892")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM, MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.SUBSTITUTE));
  }
