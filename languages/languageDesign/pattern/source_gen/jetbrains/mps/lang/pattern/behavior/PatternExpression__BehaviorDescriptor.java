...
public final class PatternExpression__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<List<SNode>> getVariables_id4dzCQkRGUKX = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getVariables").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4dzCQkRGUKX").build();
  public static final SMethod<List<SNode>> getUniqueVariables_id4dzCQkRGULU = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getUniqueVariables").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4dzCQkRGULU").build();
  public static final SMethod<List<SNode>> getOwnVariables_id7c7Ta3MgIQj = new SMethodBuilder<List<SNode>>(new SJavaCompoundTypeImpl((Class<List<SNode>>) ((Class) Object.class))).name("getOwnVariables").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("7c7Ta3MgIQj").build();
  public static final SMethod<SAbstractConcept> getQuotedNodeConcept_id4vXWNHn1_L$ = new SMethodBuilder<SAbstractConcept>(new SJavaCompoundTypeImpl((Class<SAbstractConcept>) ((Class) Object.class))).name("getQuotedNodeConcept").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4vXWNHn1_L$").build();
  public static final SMethod<Boolean> hasVariable_id4dzCQkRGUNw = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("hasVariable").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4dzCQkRGUNw").build();
