...
public class ReplaceQualifierReference_Pattern extends TransformationMenuBase {
  public ReplaceQualifierReference_Pattern() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "named transformation menu " + "ReplaceQualifiedReference", new SNodePointer("r:00000000-0000-4000-0000-011c89590342(jetbrains.mps.lang.pattern.editor)", "7939357357339334264")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
    ...
    private class TMP_Action_7swimr_a0a extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
      ...
      private class Item extends ActionItemBase implements SubstituteCompletionActionItem {
        ...
        /*package*/ Item resetTraceInfo() {
          updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:00000000-0000-4000-0000-011c89590342(jetbrains.mps.lang.pattern.editor)", "7939357357339587928"));
          return this;
        }
        @Nullable
        @Override
