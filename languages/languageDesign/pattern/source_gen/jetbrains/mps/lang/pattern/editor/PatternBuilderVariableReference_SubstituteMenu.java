...
public class PatternBuilderVariableReference_SubstituteMenu extends SubstituteMenuBase {
  public PatternBuilderVariableReference_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "PatternBuilderVariableReference", new SNodePointer("r:00000000-0000-4000-0000-011c89590342(jetbrains.mps.lang.pattern.editor)", "2793477601722764421")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_ya5k1m_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_ya5k1m_a() {
      super(CONCEPTS.PatternBuilderVariableReference$5T, LINKS.declaration$vkQ_, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:00000000-0000-4000-0000-011c89590342(jetbrains.mps.lang.pattern.editor)", "2793477601722765106")));
    }
