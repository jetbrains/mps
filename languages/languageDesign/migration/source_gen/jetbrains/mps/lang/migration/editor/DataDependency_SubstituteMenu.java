...
public class DataDependency_SubstituteMenu extends SubstituteMenuBase {
  public DataDependency_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for DataDependency. Generated from implicit smart reference attribute.", new SNodePointer("r:53885008-7612-46ff-8b11-27f1d42c3adb(jetbrains.mps.lang.migration.structure)", "4950161090496546961")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_8c4vsx_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_8c4vsx_a() {
      super(CONCEPTS.DataDependency$JY, LINKS.script$2Ure, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_8c4vsx_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_8c4vsx_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "DataDependency", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.DataDependency$JY);
    }
