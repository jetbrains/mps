...
public final class TransformStatement__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getPatternConcept_id4SSaNAQl5wN = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getPatternConcept").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4SSaNAQl5wN").build();
  public static final SMethod<SNode> getQuotationConcept_id4SSaNAQlbzK = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getQuotationConcept").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("4SSaNAQlbzK").build();
