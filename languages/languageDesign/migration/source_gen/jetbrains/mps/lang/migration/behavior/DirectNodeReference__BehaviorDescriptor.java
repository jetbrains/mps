...
public final class DirectNodeReference__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isSameTarget_id6szrkDoc2JJ = new SMethodBuilder<>(Boolean.TYPE).name("isSameTarget").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7431903976166009839L).languageId(0x97d5b46ae6a81709L, 0x9074634404fd4286L).build2(SMethodBuilder.createJavaParameter(SReference.class, "reference"));
  public static final SMethod<SNodeReference> getNodeReference_id4uVwhQyQbdz = new SMethodBuilder<>(SNodeReference.class).name("getNodeReference").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5168866961623921507L).languageId(0x97d5b46ae6a81709L, 0x9074634404fd4286L).build2();
  public static final SMethod<SNode> tryToFindNode_id6szrkDoc2K7 = new SMethodBuilder<>(SNode.class).name("tryToFindNode").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(7431903976166009863L).languageId(0x97d5b46ae6a81709L, 0x9074634404fd4286L).build2(SMethodBuilder.createJavaParameter(SRepository.class, "repository"));
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(isSameTarget_id6szrkDoc2JJ, getNodeReference_id4uVwhQyQbdz, tryToFindNode_id6szrkDoc2K7, getPresentation_idhEwIMiw);
