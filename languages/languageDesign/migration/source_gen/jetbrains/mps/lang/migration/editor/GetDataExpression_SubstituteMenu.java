...
public class GetDataExpression_SubstituteMenu extends SubstituteMenuBase {
  public GetDataExpression_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "GetDataExpression", new SNodePointer("r:b37fdbd0-16ea-49c3-a711-9a930a47b589(jetbrains.mps.lang.migration.editor)", "6807933448475708172")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_8g9hw0_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_8g9hw0_a() {
      super(CONCEPTS.GetDataExpression$Na, LINKS.requiredDataDeclararion$77eK, new EditorMenuDescriptorBase("reference scope substitute menu part", new SNodePointer("r:b37fdbd0-16ea-49c3-a711-9a930a47b589(jetbrains.mps.lang.migration.editor)", "6807933448475822791")));
    }
