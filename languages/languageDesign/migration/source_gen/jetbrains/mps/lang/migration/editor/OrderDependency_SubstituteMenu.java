...
public class OrderDependency_SubstituteMenu extends SubstituteMenuBase {
  public OrderDependency_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for OrderDependency. Generated from implicit smart reference attribute.", new SNodePointer("r:53885008-7612-46ff-8b11-27f1d42c3adb(jetbrains.mps.lang.migration.structure)", "4144229974054378362")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_g2oj2n_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_g2oj2n_a() {
      super(CONCEPTS.OrderDependency$U1, LINKS.script$BxVg, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }

  }
  public class SMP_Subconcepts_g2oj2n_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_g2oj2n_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "OrderDependency", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.OrderDependency$U1);
    }
