...
public final class OrderDeclaration__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getGeneratedClassName_id2CFL3ni7zCY = new SMethodBuilder<>(String.class).name("getGeneratedClassName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3038738109029038654L).languageId(0x80ff33ab2b506ee4L, 0xc9d137c4325944f8L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getGeneratedClassName_id2CFL3ni7zCY, presents_id1jgMklchcXk, getOrderDeclaration_id2CFL3ni7A9T);
