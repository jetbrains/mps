...
public final class ConceptFunctionParameter_nodeToPastePostProcess__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getPostProcessor_id5eziI4W3iyy = new SMethodBuilder<>(SNode.class).name("getPostProcessor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6026743057587447970L).languageId(0xaef20004f6a1cdbdL, 0xaee9cad2acd44608L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getPostProcessor_id5eziI4W3iyy, dontUseParameterObject_id1653mnvAgv$);
