...
/*package*/ class CopyPasteHandlers_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new postProcessorListHandler_ffwobm_a2a(myNode, getEditorContext());
  ...
  private static class postProcessorListHandler_ffwobm_a2a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.postProcessor$8InE;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.PastePostProcessor$WA;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(postProcessorListHandler_ffwobm_a2a.this.getNode(), LINKS.postProcessor$8InE));
      try {
    ...
    private EditorCell createConstant_2() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_ffwobm_a0c0");
      editorCell.setDefaultText("<<paste post-processors>>");
      return editorCell;
    }
  }
  ...
  private EditorCell createRefNodeList_1() {
    AbstractCellListHandler handler = new preProcessorListHandler_ffwobm_a4a(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Vertical(), false);
  ...
  private static class preProcessorListHandler_ffwobm_a4a extends RefNodeListHandler {
    ...
    public SContainmentLink getSLink() {
      return LINKS.preProcessor$8IAF;
    }
    public SAbstractConcept getChildSConcept() {
      return CONCEPTS.CopyPreProcessor$Gv;
    }
    ...
    public EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(preProcessorListHandler_ffwobm_a4a.this.getNode(), LINKS.preProcessor$8IAF));
      try {
        EditorCell emptyCell = null;
    ...
    private EditorCell createConstant_4() {
      EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "");
      editorCell.setCellId("Constant_ffwobm_a0e0");
      editorCell.setDefaultText("<<copy pre-processors>>");
      return editorCell;
    }
  }
