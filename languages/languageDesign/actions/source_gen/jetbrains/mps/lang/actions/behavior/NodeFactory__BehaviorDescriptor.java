...
public final class NodeFactory__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getQueryMethodName_idhKujcRH = new SMethodBuilder<>(String.class).name("getQueryMethodName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1220279061997L).languageId(0xaef20004f6a1cdbdL, 0xaee9cad2acd44608L).build2();
