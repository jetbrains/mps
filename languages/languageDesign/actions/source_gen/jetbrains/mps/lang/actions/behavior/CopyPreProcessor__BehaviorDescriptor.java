...
public final class CopyPreProcessor__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getClassName_id5abCRRjcnXl = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("getClassName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).id("5abCRRjcnXl").build();
