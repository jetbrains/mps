...
public final class ConceptFunctionParameter_nodeToCopyPreProcess__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getPreProcessor_id5abCRRjcA31 = new SMethodBuilder<>(SNode.class).name("getPreProcessor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5948027493682405569L).languageId(0xaef20004f6a1cdbdL, 0xaee9cad2acd44608L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(getPreProcessor_id5abCRRjcA31, dontUseParameterObject_id1653mnvAgv$);
  ...
  protected <T> T invokeSpecial0(@NotNull SNode node, @NotNull SMethod<T> method, @Nullable Object[] parameters) {
    ...
    switch (methodIndex) {
      case 0:
        return (T) ((SNode) getPreProcessor_id5abCRRjcA31(node));
      default:
        throw new BHMethodNotFoundException(this, method);
    }
  }
