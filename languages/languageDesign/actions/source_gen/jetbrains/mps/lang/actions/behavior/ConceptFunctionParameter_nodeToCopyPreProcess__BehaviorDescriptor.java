...
public final class ConceptFunctionParameter_nodeToCopyPreProcess__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getPreProcessor_id5abCRRjcA31 = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getPreProcessor").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5948027493682405569L).languageId(0xaef20004f6a1cdbdL, 0xaee9cad2acd44608L).build2();
