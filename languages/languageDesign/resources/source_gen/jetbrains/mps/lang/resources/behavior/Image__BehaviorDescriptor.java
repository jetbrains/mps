...
public final class Image__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Boolean> isValid_idIb_Fk7zRKP = new SMethodBuilder<>(Boolean.TYPE).name("isValid").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(831924260440079413L).languageId(0x996311712ea622e5L, 0x982eb8df2c964bd7L).build2();
  ...
  private final List<SMethod<?>> BH_METHODS = Arrays.<SMethod<?>>asList(isValid_idIb_Fk7zRKP, getImageForGeneration_id2p1v3tObywX);
