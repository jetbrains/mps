...
public class Binaries_Facet extends IFacet.Stub {
  private static final Logger LOG = Logger.getLogger(Binaries_Facet.class);
              ...
              try {
                ...
                repository.getModelAccess().runReadAction(() -> {
                  for (MResource in : Sequence.fromIterable(input)) {
                    Iterable<SModel> models = Sequence.fromIterable(in.models()).ofType(SModel.class).where(new IWhereFilter<SModel>() {
