...
public class Binaries_Facet extends IFacet.Stub {
  private static final Logger LOG = LogManager.getLogger(Binaries_Facet.class);
                ...
                repository.getModelAccess().runReadAction(new Runnable() {
                  public void run() {
                    ...
                    for (SModel model : Sequence.fromIterable(models)) {
                      ...
                      try {
                        generatedBinaryFiles = ListSequence.fromList(jetbrains.mps.lang.smodel.generator.smodelAdapter.SModelOperations.nodes(model, AUX_rhbawb.Resource_a9e20c38)).translate(new ITranslator2<SNode, Tuples._2<IFile, byte[]>>() {
