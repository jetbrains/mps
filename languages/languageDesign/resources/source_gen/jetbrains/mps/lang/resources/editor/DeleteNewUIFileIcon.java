...
public class DeleteNewUIFileIcon {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (DeletionApproverUtil.approve(editorContext, node, "newuiVariantWrapper")) {
          return;
        }
        SPropertyOperations.set(node, PROPS.newuiFile$Eed5, "");
      }
      @Override
      ...
      public boolean canExecute_internal(EditorContext editorContext, SNode node) {
        return isNotEmptyString(SPropertyOperations.getString(node, PROPS.newuiFile$Eed5));
      }
