...
public class IconResourceReference_subs_Contribution extends SubstituteMenuBase {
  ...
  private class SMP_Param_c11kxs_a extends ParameterizedMenuPart<SNode, SubstituteMenuItem, SubstituteMenuContext> {
    ...
    protected List<SubstituteMenuItem> createItems(SNode parameter, SubstituteMenuContext context) {
      return new SMP_Param_c11kxs_a.SMP_Action_c11kxs_a0(parameter).createItems(context);
    }
    @NotNull
    @Override
    ...
    private class SMP_Action_c11kxs_a0 extends SingleItemSubstituteMenuPart {
      ...
      protected SubstituteMenuItem createItem(SubstituteMenuContext _context) {
        SMP_Param_c11kxs_a.SMP_Action_c11kxs_a0.Item item = new SMP_Param_c11kxs_a.SMP_Action_c11kxs_a0.Item(_context);
        String description;
        try {
  ...
  private static SNode _quotation_createNode_c11kxs_a0a0a0(Object parameter_1) {
    ...
    quotedNode_2 = new SNodeBuilder(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0x982eb8df2c964bd7L, 0x996311712ea622e5L, "jetbrains.mps.lang.resources"), 0x7c8b08a50a39c6c7L, "OldIconReference"), null, null).node();
