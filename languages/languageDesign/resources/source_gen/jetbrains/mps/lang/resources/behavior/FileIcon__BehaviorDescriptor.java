...
public final class FileIcon__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getNamingConventionNewuiFileName_id1$fQzw7$wcx = new SMethodBuilder<>(String.class).name("getNamingConventionNewuiFileName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1805901909778891553L).languageId(0x996311712ea622e5L, 0x982eb8df2c964bd7L).build2();
  public static final SMethod<String> getNewuiFileName_id1$fQzw7yhpR = new SMethodBuilder<>(String.class).name("getNewuiFileName").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1805901909778306679L).languageId(0x996311712ea622e5L, 0x982eb8df2c964bd7L).build2();
  ...
  public static final SMethod<List<String>> getAdditionalFiles_id2NwO_B0ZkCe = new SMethodBuilder<>((Class<List<String>>) ((Class) Object.class)).name("getAdditionalFiles").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(3233815815383763470L).languageId(0x996311712ea622e5L, 0x982eb8df2c964bd7L).build2(SMethodBuilder.createJavaParameter(String.class, "sourcePath"));
  /*package*/ static final SMethod<Tuples._2<IFile, byte[]>> copyFile_id34SjXUxB1C6 = new SMethodBuilder<>((Class<Tuples._2<IFile, byte[]>>) ((Class) Object.class)).name("copyFile").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(3546672524166961670L).languageId(0x996311712ea622e5L, 0x982eb8df2c964bd7L).build2(SMethodBuilder.createJavaParameter(String.class, "source"), SMethodBuilder.createJavaParameter(IFile.class, "outputDir"), SMethodBuilder.createJavaParameter(Boolean.TYPE, "mustExist"));
  public static final SMethod<Boolean> isValid_id7Mb2akaestJ = new SMethodBuilder<>(Boolean.TYPE).name("isValid").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(8974276187400030063L).languageId(0x996311712ea622e5L, 0x982eb8df2c964bd7L).build2();
  public static final SMethod<Boolean> isExplicitNewuiFileValid_id1$fQzw7$eeH = new SMethodBuilder<>(Boolean.TYPE).name("isExplicitNewuiFileValid").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1805901909778817965L).languageId(0x996311712ea622e5L, 0x982eb8df2c964bd7L).build2();
  public static final SMethod<Boolean> isNewuiFileAvailable_id1$fQzw7$tKW = new SMethodBuilder<>(Boolean.TYPE).name("isNewuiFileAvailable").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1805901909778881596L).languageId(0x996311712ea622e5L, 0x982eb8df2c964bd7L).build2();
  public static final SMethod<Boolean> isFileValid_id1$fQzw7$hd7 = new SMethodBuilder<>(Boolean.TYPE).name("isFileValid").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1805901909778830151L).languageId(0x996311712ea622e5L, 0x982eb8df2c964bd7L).build2(SMethodBuilder.createJavaParameter(String.class, "name"));
