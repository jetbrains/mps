...
public final class TextIcon__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> getResourceId_id2p1v3tOadt0 = new SMethodBuilder<>(String.class).name("getResourceId").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2756621024541333312L).languageId(0x996311712ea622e5L, 0x982eb8df2c964bd7L).build2();
  public static final SMethod<String> getNewuiResourceId_id1$fQzw7$LYY = new SMethodBuilder<>(String.class).name("getNewuiResourceId").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1805901909778964414L).languageId(0x996311712ea622e5L, 0x982eb8df2c964bd7L).build2();
