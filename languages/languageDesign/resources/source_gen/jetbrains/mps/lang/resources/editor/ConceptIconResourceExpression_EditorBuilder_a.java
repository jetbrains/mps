...
/*package*/ class ConceptIconResourceExpression_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean nodeCondition_5awc4i_a2a() {
    return (SLinkOperations.getTarget(myNode, LINKS.concept_old$rjGf) != null);
  }
  private boolean nodeCondition_5awc4i_a3a() {
    return (SLinkOperations.getTarget(myNode, LINKS.concept$LkIQ) != null) || (SLinkOperations.getTarget(myNode, LINKS.concept_old$rjGf) == null);
  }
  ...
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.concept_old$rjGf;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.concept_old$rjGf);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.concept_old$rjGf);
    }
  ...
  private EditorCell createRefNode_0() {
    SingleRoleCellProvider provider = new conceptSingleRoleHandler_5awc4i_d0(myNode, LINKS.concept$LkIQ, getEditorContext());
  ...
  private static class conceptSingleRoleHandler_5awc4i_d0 extends SingleRoleCellProvider {
    ...
    protected EditorCell createChildCell(SNode child) {
      ...
      editorCell.setAction(CellActionType.DELETE, new CellAction_DeleteSmart(getNode(), LINKS.concept$LkIQ, child));
      editorCell.setAction(CellActionType.BACKSPACE, new CellAction_DeleteSmart(getNode(), LINKS.concept$LkIQ, child));
    ...
    private void installCellInfo(SNode child, EditorCell editorCell, boolean isEmpty) {
      ...
      if (editorCell.getSRole() == null) {
        editorCell.setSRole(LINKS.concept$LkIQ);
      }
    }
    @Override
    protected EditorCell createEmptyCell() {
      getCellFactory().pushCellContext();
      getCellFactory().setNodeLocation(new SNodeLocation.FromParentAndLink(getNode(), LINKS.concept$LkIQ));
      try {
