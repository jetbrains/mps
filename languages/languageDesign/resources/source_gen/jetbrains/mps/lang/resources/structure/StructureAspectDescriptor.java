...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  private static ConceptDescriptor createDescriptorForBaseURLFunction() {
    ...
    // extends: jetbrains.mps.lang.resources.structure.BaseURL
    b.super_(0x982eb8df2c964bd7L, 0x996311712ea622e5L, 0x4197d5560e6a38b7L);
  ...
  private static ConceptDescriptor createDescriptorForCircle() {
    ...
    // extends: jetbrains.mps.lang.resources.structure.Primitive
    b.super_(0x982eb8df2c964bd7L, 0x996311712ea622e5L, 0x26417c37742e28b1L);
  ...
  private static ConceptDescriptor createDescriptorForFactoryMethodIcon() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("jetbrains.mps.lang.resources", "FactoryMethodIcon", 0x982eb8df2c964bd7L, 0x996311712ea622e5L, 0x774cdde25a7e1427L);
    b.class_(false, false, false);
    b.parent(0x982eb8df2c964bd7L, 0x996311712ea622e5L, 0x26417c3774289eeeL);
    b.origin("r:03d44d4c-3d65-461c-9085-0f48e9569e59(jetbrains.mps.lang.resources.structure)/8596489752993993767");
    b.version(3);
    b.aggregate("factoryMethod", 0x774cdde25a7e1429L).target(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xfbbebabf09L).optional(false).ordered(true).multiple(false).origin("8596489752993993769").done();
    b.alias("factory method");
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForJBColorLiteral() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("jetbrains.mps.lang.resources", "JBColorLiteral", 0x982eb8df2c964bd7L, 0x996311712ea622e5L, 0x46f465e43534a2d4L);
    b.class_(false, false, false);
    b.parent(0x982eb8df2c964bd7L, 0x996311712ea622e5L, 0x19d079f4ec114bdeL);
    b.origin("r:03d44d4c-3d65-461c-9085-0f48e9569e59(jetbrains.mps.lang.resources.structure)/5112823507791946452");
    b.version(3);
    b.property("lightThemeVal", 0x46f465e43534aaa3L).type(MetaIdFactory.dataTypeId(0x982eb8df2c964bd7L, 0x996311712ea622e5L, 0x19d079f4ec114c10L)).origin("5112823507791948451").done();
    b.property("darkThemeVal", 0x46f465e43534aaa4L).type(MetaIdFactory.dataTypeId(0x982eb8df2c964bd7L, 0x996311712ea622e5L, 0x19d079f4ec114c10L)).origin("5112823507791948452").done();
    b.alias("##");
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForTextIcon() {
    ...
    b.aggregate("layers", 0x26417c37742e0e66L).target(0x982eb8df2c964bd7L, 0x996311712ea622e5L, 0x26417c37742e0e65L).optional(true).ordered(true).multiple(true).origin("2756621024541675110").done();
