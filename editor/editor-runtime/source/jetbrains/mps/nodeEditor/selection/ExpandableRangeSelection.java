...
public class ExpandableRangeSelection extends AbstractMultipleSelection {
  ...
  public ExpandableRangeSelection(@NotNull EditorComponent editorComponent, @NotNull SNode firstNode, @NotNull SNode lastNode, boolean growingForward) {
    this(editorComponent, firstNode, lastNode, growingForward, null);
  }

  public ExpandableRangeSelection(@NotNull EditorComponent editorComponent, @NotNull SNode firstNode, @NotNull SNode lastNode, boolean growingForward, String emptyCellId) {
    super(editorComponent);
  ...
  public boolean isSame(Selection another) {
    ...
    ExpandableRangeSelection that = (ExpandableRangeSelection) another;
  ...
  public void executeAction(CellActionType type) {
    ...
    } else if (type == CellActionType.SELECT_LEFT) {
        ...
        public void doExecute() {
          if(myGrowingForward && getFirstNode() != getLastNode()) {
            ...
            if(nextSelectableChild != null) {
              selectionManager.pushSelection(new ExpandableRangeSelection(getEditorComponent(), getFirstNode(), nextSelectableChild, myGrowingForward));
            }
          } else {
            SNode nextSelectableChild = getNextSelectableNode(getFirstNode(), false);
            if(nextSelectableChild != null) {
              selectionManager.pushSelection(new ExpandableRangeSelection(getEditorComponent(), nextSelectableChild, getLastNode(), false));
            }
          }
        }
      });
      ...
      editorContext.getRepository().getModelAccess().executeCommand(new EditorCommand(editorContext) {
        ...
        public void doExecute() {
          if(!myGrowingForward && getFirstNode() != getLastNode()) {
            ...
            if(nextSelectableChild != null) {
              selectionManager.pushSelection(new ExpandableRangeSelection(getEditorComponent(), nextSelectableChild, getLastNode(), myGrowingForward));
            }
          } else {
            SNode nextSelectableChild = getNextSelectableNode(getLastNode(), true);
            if(nextSelectableChild != null) {
              selectionManager.pushSelection(new ExpandableRangeSelection(getEditorComponent(), getFirstNode(), nextSelectableChild, true));
            }
