package TestModelRenamer.tests;
...
public class RenameModel_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(RenameModel_Test.class, "${mps_home}", "r:669fd631-5dbf-406f-b776-b59f9b35d48f(TestModelRenamer.tests@tests)", false);
