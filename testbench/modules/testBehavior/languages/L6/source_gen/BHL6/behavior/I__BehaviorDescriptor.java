...
public final class I__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> foo_idyOqIWcnDrn = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("foo").modifiers(12, AccessPrivileges.PUBLIC).concept(CONCEPT).id("yOqIWcnDrn").build();
