...
public final class J__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<String> foo_idyOqIWcnDrn = new SMethodBuilder<>(String.class).name("foo").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(627243823048595159L).languageId(0xbc43d0051c9b1e8fL, 0x424c173aee734dc9L).build2();
  public static final SMethod<String> bar_id43RsG_ymtGN = new SMethodBuilder<>(String.class).name("bar").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(4681336546938968883L).languageId(0xbc43d0051c9b1e8fL, 0x424c173aee734dc9L).build2();
