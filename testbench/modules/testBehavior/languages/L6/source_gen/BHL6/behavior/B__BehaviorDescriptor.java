...
public final class B__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Integer> foo_id5mnatV0hwZQ = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("foo").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6167444251392479222L).languageId(0xbc43d0051c9b1e8fL, 0x424c173aee734dc9L).build2();
  public static final SMethod<Integer> bar_id5mnatV0hx04 = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("bar").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6167444251392479236L).languageId(0xbc43d0051c9b1e8fL, 0x424c173aee734dc9L).build2();
  ...
  public static final SMethod<Integer> foo3_id4RMBeRWcio1 = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.class)).name("foo3").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5616724231236691457L).languageId(0xbc43d0051c9b1e8fL, 0x424c173aee734dc9L).build2();
  /*package*/ static final SMethod<Integer> privateMethod_id1olXtyGAKnt = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("privateMethod").modifiers(0, AccessPrivileges.PRIVATE).concept(CONCEPT).baseMethodId(1591448354302920157L).languageId(0xbc43d0051c9b1e8fL, 0x424c173aee734dc9L).build2(SMethodBuilder.createJavaParameter(Object.class, ""));
  public static final SMethod<Integer> foo4_id1olXtyGAKpB = new SMethodBuilder<Integer>(new SJavaCompoundTypeImpl(Integer.TYPE)).name("foo4").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(1591448354302920295L).languageId(0xbc43d0051c9b1e8fL, 0x424c173aee734dc9L).build2();
