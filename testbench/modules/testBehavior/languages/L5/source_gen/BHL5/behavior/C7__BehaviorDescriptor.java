...
public final class C7__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> bar_id2k7p7sTvyr6 = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("bar").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2k7p7sTvyr6").build();
  public static final SMethod<Void> foo_id2k7p7sTv$MS = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("foo").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2k7p7sTv$MS").build();
  public static final SMethod<Void> foo_id2k7p7sTv$Mh = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.class)).name("foo").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2k7p7sTv$Mh").build();
  ...
  private static void ___init___(@NotNull SNode __thisNode__) {
    ...
    C6__BehaviorDescriptor.bar_id2k7p7sTvyr6.invoke0(__thisNode__, CONCEPTS.C6$ot);
    I3__BehaviorDescriptor.foo_id2k7p7sTv$MS.invoke0(__thisNode__, CONCEPTS.I3$Rd);
    C6__BehaviorDescriptor.foo_id2eC$PxWCr8m.invokeSpecial(__thisNode__);
    C6__BehaviorDescriptor.bar_id2k7p7sTvyr6.invokeSuper(__thisNode__, CONCEPTS.C7$TA);
  }
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SInterfaceConcept I3$Rd = MetaAdapterFactory.getInterfaceConcept(0xb4fa1e36714a4c77L, 0x8e953eae9632decbL, 0x25076477397e4c6fL, "BHL5.structure.I3");
