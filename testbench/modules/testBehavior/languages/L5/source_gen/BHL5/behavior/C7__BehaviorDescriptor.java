...
public final class C7__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> foo_id2k7p7sTv$MS = new SMethodBuilder<>(Void.TYPE).name("foo").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2668211767468772536L).languageId(0x8e953eae9632decbL, 0xb4fa1e36714a4c77L).build2();
  public static final SMethod<Void> foo_id2k7p7sTv$Mh = new SMethodBuilder<>(Void.TYPE).name("foo").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(2668211767468772497L).languageId(0x8e953eae9632decbL, 0xb4fa1e36714a4c77L).build2();
