...
public final class A__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<Void> justVoidReturnTypeMethod1_id5mnatV0hB9t = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("justVoidReturnTypeMethod1").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(6167444251392504413L).languageId(0xb1e014d3f948db39L, 0x4239359f64574d2aL).build2();
  public static final SMethod<Void> justVoidReturnTypeMethod2_id4XEqvthVyKi = new SMethodBuilder<Void>(new SJavaCompoundTypeImpl(Void.TYPE)).name("justVoidReturnTypeMethod2").modifiers(0, AccessPrivileges.PUBLIC).concept(CONCEPT).baseMethodId(5722502787480038418L).languageId(0xb1e014d3f948db39L, 0x4239359f64574d2aL).build2();
