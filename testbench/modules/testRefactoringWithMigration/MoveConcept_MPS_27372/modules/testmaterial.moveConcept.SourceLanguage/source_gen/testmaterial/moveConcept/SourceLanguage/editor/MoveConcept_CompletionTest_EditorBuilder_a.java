...
/*package*/ class MoveConcept_CompletionTest_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public MoveConcept_CompletionTest_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_qkb63f_a");
  ...
  private EditorCell createConstant_0() {
    ...
    editorCell.setCellId("Constant_qkb63f_c0");
  ...
  private EditorCell createRefNodeList_0() {
    AbstractCellListHandler handler = new childListHandler_qkb63f_d0(myNode, getEditorContext());
    EditorCell_Collection editorCell = handler.createCells(new CellLayout_Indent(), false);
    editorCell.setCellId("child");
    Style style = new StyleImpl();
  ...
  private static class childListHandler_qkb63f_d0 extends RefNodeListHandler {
    @NotNull
    private SNode myNode;

    public childListHandler_qkb63f_d0(SNode ownerNode, EditorContext context) {
      super(context, false);
      myNode = ownerNode;
    }
  ...
  private EditorCell createConstant_1() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "}");
    editorCell.setCellId("Constant_qkb63f_e0");
    editorCell.setDefaultText("");
    return editorCell;
  }
