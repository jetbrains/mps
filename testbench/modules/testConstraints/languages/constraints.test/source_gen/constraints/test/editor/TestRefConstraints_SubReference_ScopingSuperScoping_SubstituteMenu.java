...
public class TestRefConstraints_SubReference_ScopingSuperScoping_SubstituteMenu extends SubstituteMenuBase {
  public TestRefConstraints_SubReference_ScopingSuperScoping_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for TestRefConstraints_SubReference_ScopingSuperScoping. Generated from the smart reference attribute.", new SNodePointer("r:35917c6a-b8ff-491f-83ca-d36ca2c36595(constraints.test.structure)", "2614955748379661946")));
  }
  @NotNull
  @Override
  ...
  public class SMP_ReferenceScope_tico4d_a extends ReferenceScopeSubstituteMenuPart {
    ...
    public SMP_ReferenceScope_tico4d_a() {
      super(CONCEPTS.TestRefConstraints_SubReference_ScopingSuperScoping$Gn, LINKS.target$Wyj6, new EditorMenuDescriptorBase("reference scope substitute menu part", null));
    }
  ...
  public class SMP_Subconcepts_tico4d_b extends ConceptMenusPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Subconcepts_tico4d_b() {
      super(new EditorMenuDescriptorBase("include menus for all the direct subconcepts of " + "TestRefConstraints_SubReference_ScopingSuperScoping", null));
    }

    @Override
    protected Collection<SAbstractConcept> getConcepts(final SubstituteMenuContext _context) {
      return getDirectDescendants(_context, CONCEPTS.TestRefConstraints_SubReference_ScopingSuperScoping$Gn);
    }
