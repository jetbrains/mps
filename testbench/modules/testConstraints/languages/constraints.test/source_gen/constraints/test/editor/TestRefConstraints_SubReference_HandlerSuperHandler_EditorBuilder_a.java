...
/*package*/ class TestRefConstraints_SubReference_HandlerSuperHandler_EditorBuilder_a extends AbstractEditorBuilder {
  @NotNull
  private SNode myNode;

  public TestRefConstraints_SubReference_HandlerSuperHandler_EditorBuilder_a(@NotNull EditorContext context, @NotNull SNode node) {
    super(context);
    myNode = node;
  }
  ...
  private EditorCell createCollection_0() {
    ...
    editorCell.setCellId("Collection_whdc4u_a");
  ...
  private EditorCell createConstant_0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, "handler-super-handler ");
    editorCell.setCellId("Constant_whdc4u_a0");
