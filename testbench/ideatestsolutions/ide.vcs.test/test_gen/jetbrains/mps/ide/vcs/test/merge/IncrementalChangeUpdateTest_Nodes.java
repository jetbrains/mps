  ...
  public void addSameRoleChildren() {
    testChanges(new _Adapters._return_P0_E0_to_Runnable_adapter(new _FunctionTypes._return_P0_E0<SNode>() {
      public SNode invoke() {
        ...
        ListSequence.fromList(SLinkOperations.getChildren(testRoot, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c108ca66L, 0xff2ac0b419L, "implementedInterface"))).addElement(_quotation_createNode_2k50sb_a0a1a0a0a61());
        ListSequence.fromList(SLinkOperations.getChildren(testRoot, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c108ca66L, 0xff2ac0b419L, "implementedInterface"))).addElement(_quotation_createNode_2k50sb_a0a2a0a0a61());
        return ListSequence.fromList(SLinkOperations.getChildren(testRoot, MetaAdapterFactory.getContainmentLink(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, 0xf8c108ca66L, 0xff2ac0b419L, "implementedInterface"))).addElement(_quotation_createNode_2k50sb_a0a3a0a0a61());
      }
    }));
  }
