...
public class TestCaseRef_SubstituteMenu extends SubstituteMenuBase {
  public TestCaseRef_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "TestCaseRef", new SNodePointer("r:aed1d11b-73e5-474f-a263-22833310a33f(jetbrains.mps.testbench.suite.editor)", "1741258697587114301")));
  }
  @NotNull
  @Override
  protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts(final SubstituteMenuContext _context) {
    List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> result = new ArrayList<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>();
    result.add(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Param_dnvvk3_a(), CONCEPTS.TestCaseRef$nP));
    return result;
  }
    ...
    private class SMP_Action_dnvvk3_a0 extends SingleItemSubstituteMenuPart {
      ...
      private class Item extends DefaultSubstituteMenuItem {
        ...
        public Item(SubstituteMenuContext context) {
          super(CONCEPTS.TestCaseRef$nP, context);
          _context = context;
        }
        ...
        /*package*/ void resetTraceInfo() {
          ...
          updateTraceInfo(description, new SNodePointer("r:aed1d11b-73e5-474f-a263-22833310a33f(jetbrains.mps.testbench.suite.editor)", "1741258697587114363"));
        }
        ...
        public SNode createNode(@NotNull String pattern) {
          ...
          SLinkOperations.setTarget(tref, LINKS.testCase$R3Mf, myParameterObject);
        ...
        protected CompletionItemInformation createInformation(String pattern) {
          return new CompletionItemInformation(myParameterObject, CONCEPTS.TestCaseRef$nP, getMatchingText(pattern), getDescriptionText(pattern));
        }
        @Nullable
        @Override
