...
/*package*/ class TestCaseRef_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private boolean _StyleParameter_QueryFunction_aryab1_a0a0() {
    return SPropertyOperations.getBoolean(getNode(), PROPS.muted$5$LF);
  }
  private EditorCell createRefCell_0() {
    final SReferenceLink referenceLink = LINKS.testCase$R3Mf;
    SReferenceCellProvider provider = new SReferenceCellProvider(getNode(), referenceLink, getEditorContext()) {
      protected EditorCell createReferenceCell(final SNode targetNode) {
        EditorCell cell = getUpdateSession().updateReferencedNodeCell(() -> new Inline_Builder0(getEditorContext(), getNode(), targetNode).createCell(), targetNode, LINKS.testCase$R3Mf);
    ...
    if (editorCell.getSRole() == null) {
      ...
      editorCell.setSRole(LINKS.testCase$R3Mf);
    }
