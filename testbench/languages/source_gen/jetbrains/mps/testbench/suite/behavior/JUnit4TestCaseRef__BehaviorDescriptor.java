...
public final class JUnit4TestCaseRef__BehaviorDescriptor extends BaseBHDescriptor {
  ...
  public static final SMethod<SNode> getTargetTest_id7BTZ519MNAR = new SMethodBuilder<SNode>(new SJavaCompoundTypeImpl((Class<SNode>) ((Class) Object.class))).name("getTargetTest").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("7BTZ519MNAR").build();
  public static final SMethod<Boolean> isSame_id1ouvi_ymQH = new SMethodBuilder<Boolean>(new SJavaCompoundTypeImpl(Boolean.TYPE)).name("isSame").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1ouvi_ymQH").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
  public static final SMethod<String> fqClassName_id2$98zG5liRT = new SMethodBuilder<String>(new SJavaCompoundTypeImpl(String.class)).name("fqClassName").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("2$98zG5liRT").build();
  public static final SMethod<Iterable<String>> testNames_id3z1mdFUF$j3 = new SMethodBuilder<Iterable<String>>(new SJavaCompoundTypeImpl((Class<Iterable<String>>) ((Class) Object.class))).name("testNames").modifiers(8, AccessPrivileges.PUBLIC).concept(CONCEPT).id("3z1mdFUF$j3").build();
  public static final SMethod<Iterable<SNode>> getTestClassesForModule_id1k5vvhz$GBa = new SMethodBuilder<Iterable<SNode>>(new SJavaCompoundTypeImpl((Class<Iterable<SNode>>) ((Class) Object.class))).name("getTestClassesForModule").modifiers(1, AccessPrivileges.PUBLIC).concept(CONCEPT).id("1k5vvhz$GBa").build(SMethodBuilder.createJavaParameter((Class<SNode>) ((Class) Object.class), ""));
