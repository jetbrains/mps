...
public class TextCheckbox_SPACE_KeepsSelection_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(TextCheckbox_SPACE_KeepsSelection_Test.class).projectPath(null).modelRef("r:9dd38274-05d8-45ba-a41e-44ac52909443(jetbrains.mps.lang.editor.forms.test@tests)").reopenProject(false).build());
