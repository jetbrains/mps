...
public class RH_methodFilter_Extension extends Extension.Default<IHttpRequestHandlerFactory> {
  public RH_methodFilter_Extension() {
  ...
  public IHttpRequestHandlerFactory factory = new IHttpRequestHandlerFactory() {
    ...
    public String getHandlerName() {
      return "RH_methodFilter";
    }
    @NotNull
    public IHttpRequestHandler create(@NotNull HttpRequest request) {
      return new RH_methodFilter_RequestHandler(request);
    }
  };
