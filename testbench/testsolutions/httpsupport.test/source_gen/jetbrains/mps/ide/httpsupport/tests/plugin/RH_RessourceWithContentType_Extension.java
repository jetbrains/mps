...
public class RH_RessourceWithContentType_Extension extends Extension.Default<IHttpRequestHandlerFactory> {
  public RH_RessourceWithContentType_Extension() {
  ...
  public IHttpRequestHandlerFactory factory = new IHttpRequestHandlerFactory() {
    ...
    public String getHandlerName() {
      return "RH_RessourceWithContentType";
    }
    @NotNull
    public IHttpRequestHandler create(@NotNull HttpRequest request) {
      return new RH_RessourceWithContentType_RequestHandler(request);
    }
  };
