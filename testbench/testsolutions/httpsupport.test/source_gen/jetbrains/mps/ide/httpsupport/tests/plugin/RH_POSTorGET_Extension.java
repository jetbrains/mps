...
public class RH_POSTorGET_Extension extends Extension.Default<IHttpRequestHandlerFactory> {
  public RH_POSTorGET_Extension() {
    super("jetbrains.mps.ide.httpsupport.HttpRequestHandlerEP");
  }
  private static final List<String> QUERY_METHODS = ListSequence.fromListAndArray(new ArrayList<>(), "POST", "GET");
  ...
  public IHttpRequestHandlerFactory factory = new IHttpRequestHandlerFactory() {
    ...
    public IHttpRequestHandler create(@NotNull HttpRequest request) {
      return new RH_POSTorGET_RequestHandler(request);
    }

    public String getServicePrefix() {
      return "handlerTest/simplePostGet";
    }
