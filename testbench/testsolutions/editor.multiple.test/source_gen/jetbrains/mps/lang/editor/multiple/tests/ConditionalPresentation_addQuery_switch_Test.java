...
public class ConditionalPresentation_addQuery_switch_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(ConditionalPresentation_addQuery_switch_Test.class).projectPath(null).modelRef("r:dbab6746-af91-4594-857e-d38a36667e17(jetbrains.mps.lang.editor.multiple.tests)").reopenProject(false).build());
