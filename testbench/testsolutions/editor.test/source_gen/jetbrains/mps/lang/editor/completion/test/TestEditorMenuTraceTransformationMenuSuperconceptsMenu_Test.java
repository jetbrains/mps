...
public class TestEditorMenuTraceTransformationMenuSuperconceptsMenu_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(TestEditorMenuTraceTransformationMenuSuperconceptsMenu_Test.class).projectPath(null).modelRef("r:f27d9626-8ef5-4cba-bce0-6aa6369f05ff(jetbrains.mps.lang.editor.completion.test)").reopenProject(false).build());
  ...
  private static final class CONCEPTS {
    ...
    /*package*/ static final SConcept TransformationMenuPart_Super$b2 = MetaAdapterFactory.getConcept(0x18bc659203a64e29L, 0xa83a7ff23bde13baL, 0x7541587144d24773L, "jetbrains.mps.lang.editor.structure.TransformationMenuPart_Super");
  }
}
