...
public class CompleteNotCamelCaseFromMiddle_Test extends BaseTransformationTest {
  @ClassRule
  public static final TestParametersCache ourParamCache = new TestParametersCache(CompleteNotCamelCaseFromMiddle_Test.class, "${mps_home}", "r:f27d9626-8ef5-4cba-bce0-6aa6369f05ff(jetbrains.mps.lang.editor.completion.test)", false);

  public CompleteNotCamelCaseFromMiddle_Test() {
    super(ourParamCache);
  }
  ...
  /*package*/ static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      initEditorComponent("6292171174659801641", "6292171174659801643");
