...
public class CompleteImmediately_OnlyStartsWithPattern_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(CompleteImmediately_OnlyStartsWithPattern_Test.class).projectPath(null).modelRef("r:f27d9626-8ef5-4cba-bce0-6aa6369f05ff(jetbrains.mps.lang.editor.completion.test)").reopenProject(false).build());

  public CompleteImmediately_OnlyStartsWithPattern_Test() {
