...
public class PrimSet_Test extends Util_Test {
  ...
  public void test_intSet() throws Exception {
    ...
    SetSequence.fromSet(is).addSequence(Sequence.fromIterable(Sequence.fromClosure(() -> {
...
__switch__:
  ...
  public void test_longSet() throws Exception {
    ...
    Sequence.fromIterable(ArrayUtils.fromLongArray(new long[]{5, 4, 3, 2, 1, 2, 3, 4, 5})).visitAll((i) -> SetSequence.fromSet(ls).addElement(i));
    this.assertIterableEqualsAsSet(this.input5(), SetSequence.fromSet(ls).select((l) -> (int) (long) l));
  }
  @Test
