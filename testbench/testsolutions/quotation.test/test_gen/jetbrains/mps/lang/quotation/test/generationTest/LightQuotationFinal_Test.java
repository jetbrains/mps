...
public class LightQuotationFinal_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    private static SNode createReturnStatement_3vdjo8_a0c0f61(SNode node0) {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ReturnStatement$lt);
      rootBuilder1.forChild(LINKS.expression$eJ92).initNode(node0, CONCEPTS.Expression$mB, true);
      return rootBuilder1.getResult();
    }
    ...
    private static SNode createStatementList_3vdjo8_a0c0h61(SNode node0) {
      ...
      {
        SNodeBuilder n2 = rootBuilder1.forChild(LINKS.statement$53DE).initNode(node0, CONCEPTS.Statement$P6, false);
      }
      return rootBuilder1.getResult();
    }
    ...
    private static SNode createStatementList_3vdjo8_a0c0j61(Iterable<? extends SNode> seq0) {
      SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.StatementList$m_);
      rootBuilder1.forChild(LINKS.statement$53DE).initNodeList(seq0, CONCEPTS.Statement$P6);
      return rootBuilder1.getResult();
    }
