...
@MPSLaunch
public class TestSubstitute_ReferenceInAttribute_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(TestSubstitute_ReferenceInAttribute_Test.class).projectPath(null).modelRef("r:62873c84-7a76-488a-9b84-4e0ffdbec8db(jetbrains.mps.lang.editor.menus.substitute.tests.tests@tests)").reopenProject(false).build());

  public TestSubstitute_ReferenceInAttribute_Test() {
  ...
  /*package*/ static class TestBody extends BaseEditorTestBody {
    ...
    public void testMethodImpl() throws Exception {
      initEditorComponent("4930188782568771952", "4930188782568771995");
