...
public class Set_Test extends Util_Test {
  ...
  public void test_collection() throws Exception {
    ...
    Assert.assertEquals("a b", IterableUtils.join(CollectionSequence.fromCollection(cs).sort((it) -> it, true), " "));
    SetSequence.fromSet(hss).addElement("c");
    Assert.assertEquals("a b c", IterableUtils.join(CollectionSequence.fromCollection(cs).sort((it) -> it, true), " "));
  }
  @Test
  public void test_unmodifiable() throws Exception {
    ...
    Assert.assertEquals("a c d", IterableUtils.join(SetSequence.fromSet(hss).sort((it) -> it, true), " "));
    ...
    Assert.assertEquals("c d", IterableUtils.join(SetSequence.fromSet(uhss).sort((it) -> it, true), " "));
    try {
