...
public class LinkedMap_Test extends Util_Test {
  ...
  public void test_accessOrder() throws Exception {
    Map<String, Integer> map = MapSequence.fromMapAndEntryArray(new LinkedHashMap<String, Integer>(16, (float) 0.75, true), Map.entry("A", 1), Map.entry("B", 2), Map.entry("C", 3), Map.entry("D", 4), Map.entry("E", 5));
