...
public class List_Test extends Util_Test {
  ...
  public void test_containsAll() throws Exception {
    Iterable<Integer> bigSeq = Sequence.fromClosure(() -> {
...
__switch__:
    ...
    List<Integer> bigList = Sequence.fromIterable(bigSeq).toList();
    Collections.shuffle(bigList);
    List<Integer> anotherBigList = ListSequence.fromList(bigList).select((i) -> i).toList();
    Collections.shuffle(anotherBigList);
    long start = System.currentTimeMillis();
    Assert.assertTrue(ListSequence.fromList(bigList).select((i) -> i).containsSequence(ListSequence.fromList(anotherBigList).select((i) -> i)));
  ...
  @Test
  public void test_toListDuplicates() throws Exception {
    Iterable<Integer> emptySeq = ListSequence.fromList(new ArrayList<Integer>());
    ListSequence.fromList(Sequence.fromIterable(emptySeq).toList()).addElement(123);
    Assert.assertTrue(Sequence.fromIterable(emptySeq).isEmpty());
  }
  @Test
  ...
  public void test_opAssign() throws Exception {
    ...
    Assert.assertTrue(645 == (BLOperations.plusAssign(ListSequence.fromList(listi).getElementRef(0), 300)));
    Assert.assertTrue(645 == (int) ListSequence.fromList(listi).getElement(0));
    Assert.assertTrue((BLOperations.minusAssign(ListSequence.fromList(listi).getElementRef(1), 40)) == 503);
    Assert.assertTrue((int) ListSequence.fromList(listi).getElement(1) == 503);
    Assert.assertTrue(9999 == (BLOperations.multAssign(ListSequence.fromList(listi).getElementRef(2), 9)));
