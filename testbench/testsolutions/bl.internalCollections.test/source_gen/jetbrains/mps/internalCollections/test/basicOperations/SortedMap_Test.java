...
public class SortedMap_Test extends Util_Test {
  ...
  public void test_sortedMap() throws Exception {
    SortedMap<String, Integer> smap = SortedMapSequence.fromMapAndEntryArray(new TreeMap<String, Integer>(), Map.entry("C", 3), Map.entry("A", 1), Map.entry("B", 2), Map.entry("E", 5), Map.entry("D", 4));
