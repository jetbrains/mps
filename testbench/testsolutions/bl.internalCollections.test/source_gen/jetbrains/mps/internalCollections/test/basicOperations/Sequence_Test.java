...
public class Sequence_Test extends Util_Test {
  ...
  public void test_sequenceFromClosure() throws Exception {
    Iterable<Integer> seq = ((_FunctionTypes._return_P0_E0<Iterable<Integer>>) () -> {
...
__switch__:
    ...
    Iterable<Integer> seq3 = Sequence.fromClosure(() -> {
      return (Iterable<Integer>) () -> {
        return new YieldingIterator<Integer>() {
          private int __CP__ = 0;
          protected boolean moveToNext() {
...
__switch__:
  ...
  public void test_sequenceTypeWithoutElement() throws Exception {
    Iterable<Integer> si = Sequence.fromClosure(() -> {
      return (Iterable<Integer>) () -> {
        return new YieldingIterator<Integer>() {
          private int __CP__ = 0;
          protected boolean moveToNext() {
...
__switch__:
  ...
  public void test_primitiveValues() throws Exception {
    ...
    Assert.assertTrue(fff == (int) Sequence.fromIterable(seqi).findFirst((it) -> it == (int) fff));
  }
  @Test
  public void test_mps18138() throws Exception {
    Iterable<? extends Iterable<Integer>> sosoi = Sequence.fromIterable(Sequence.fromArray(new int[][]{})).select((it) -> ArrayUtils.fromIntegerArray(it));
  }
