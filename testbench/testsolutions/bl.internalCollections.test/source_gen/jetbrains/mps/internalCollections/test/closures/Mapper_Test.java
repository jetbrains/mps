...
public class Mapper_Test extends Util_Test {
  ...
  public void test_mapMethod() throws Exception {
    ...
    ISequence<Integer> test = seq.translate((it1) -> {
...
__switch__:
  ...
  public void test_mapperVar() throws Exception {
    ISequence<Integer> seq = Sequence.fromIterable(this.input5());
    _FunctionTypes._return_P1_E0<? extends Iterable<Integer>, ? super Integer> trans = (Integer i) -> {
      return (Iterable<Integer>) () -> {
        return new YieldingIterator<Integer>() {
          private int __CP__ = 0;
          protected boolean moveToNext() {
...
__switch__:
  ...
  public void test_mappingOperation() throws Exception {
    Iterable<Integer> test = Sequence.fromIterable(this.input5()).translate((i) -> {
      return (Iterable<Integer>) () -> {
        return new YieldingIterator<Integer>() {
          private int __CP__ = 0;
          protected boolean moveToNext() {
...
__switch__:
  ...
  public void test_legacyMapper() throws Exception {
    Iterable<Integer> test = Sequence.fromIterable(this.input5()).translate((it) -> {
      return (Iterable<Integer>) () -> {
        return new YieldingIterator<Integer>() {
          private int __CP__ = 0;
          protected boolean moveToNext() {
...
__switch__:
  ...
  public void test_stopSkip() throws Exception {
    Iterable<Integer> test = Sequence.fromIterable(this.input10()).translate((it) -> {
      return (Iterable<Integer>) () -> {
        return new YieldingIterator<Integer>() {
          private int __CP__ = 0;
          protected boolean moveToNext() {
...
__switch__:
    ...
    Iterable<Integer> test2 = Sequence.fromIterable(this.input10()).translate((it) -> {
      return (Iterable<Integer>) () -> {
        return new YieldingIterator<Integer>() {
          private int __CP__ = 0;
          protected boolean moveToNext() {
...
__switch__:
    ...
    Iterable<Integer> test2 = Sequence.fromIterable(this.input5()).translate((it) -> {
      return (Iterable<Integer>) () -> {
        return new YieldingIterator<Integer>() {
          private int __CP__ = 0;
          protected boolean moveToNext() {
...
__switch__:
    ...
    Iterable<Integer> test3 = Sequence.fromIterable(this.input5()).translate((it) -> {
      return (Iterable<Integer>) () -> {
        return new YieldingIterator<Integer>() {
          private int __CP__ = 0;
          protected boolean moveToNext() {
...
__switch__:
    ...
    Iterable<Integer> test4 = Sequence.fromIterable(this.input5()).translate((it) -> {
      return (Iterable<Integer>) () -> {
        return new YieldingIterator<Integer>() {
          private int __CP__ = 0;
          protected boolean moveToNext() {
...
__switch__:
  ...
  public void test_nextWithoutHasNext() throws Exception {
    this.assertIteratorYields(ListSequence.fromList(ListSequence.fromListAndArray(new ArrayList<Integer>(), 1, 3)).translate((i) -> {
      return (Iterable<Integer>) () -> {
        return new YieldingIterator<Integer>() {
          private int __CP__ = 0;
          protected boolean moveToNext() {
...
__switch__:
  ...
  public void test_selectManyAdvancesTooEarly() throws Exception {
    ...
    ListSequence.fromList(test).translate((i) -> {
      return (Iterable<Integer>) () -> {
        return new YieldingIterator<Integer>() {
          private int __CP__ = 0;
          protected boolean moveToNext() {
