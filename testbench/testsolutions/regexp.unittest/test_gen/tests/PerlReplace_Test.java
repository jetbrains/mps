...
public class PerlReplace_Test {
  ...
  private static final Pattern REPLREGEXP_b0b0a = Pattern.compile("(\\w)\\1*(?:\\s*)", 0);
  private static final Pattern REPLREGEXP_b0c0a = Pattern.compile("(\\w)\\1*(?:\\s*)", 0);
  private static final Pattern REPLREGEXP_b0a0b = Pattern.compile("\\s*(\\w+)\\s+(\\w+)", 0);
  private static final Pattern REPLREGEXP_a1a1 = Pattern.compile("(\\w)", 0);
  private static final Pattern REPLREGEXP_b0a0c = Pattern.compile("a", 0);
  private static final Pattern REPLREGEXP_b0b0c = Pattern.compile("a", 2);
  private static final Pattern REPLREGEXP_b0a0d = Pattern.compile(".+", 0);
  private static final Pattern REPLREGEXP_b0b0d = Pattern.compile(".+", 32);
  private static final Pattern REPLREGEXP_b0a0e = Pattern.compile("^(\\w+):", 8);
  private static final Pattern REPLREGEXP_b0b0e = Pattern.compile("^(\\w+):", 0);
  private static final Pattern REPLREGEXP_b0a0f = Pattern.compile("\\w", 0);
  private static final Pattern REPLREGEXP_b0b0f = Pattern.compile("\\w", 0);
  private static final Pattern REPLREGEXP_b0c0f = Pattern.compile("\\w", 0);
  private static final Pattern REPLREGEXP_b0d0f = Pattern.compile("\\w", 0);
  private static final Pattern REPLREGEXP_b0e0f = Pattern.compile("\\w", 0);
  private static final Pattern REPLREGEXP_b0f0f = Pattern.compile("\\w", 0);
  private static final Pattern REPLREGEXP_b0g0f = Pattern.compile("\\w", 0);
  private static final Pattern REPLREGEXP_b0h0f = Pattern.compile("\\w", 0);
  private static final Pattern REPLREGEXP_b0i0f = Pattern.compile("\\w", 0);
  private static final Pattern REPLREGEXP_b0j0f = Pattern.compile("\\w", 0);
  private static final Pattern REPLREGEXP_b0k0f = Pattern.compile("\\w", 0);
  private static final Pattern REPLREGEXP_b0l0f = Pattern.compile("\\w", 0);
  private static final Pattern REPLREGEXP_b0m0f = Pattern.compile("\\w", 0);
}
