...
public class NamedTuples_Test {
  ...
  public void test_filter() throws Exception {
    Iterable<Data> seq = this.getSequence();
    Sequence.fromIterable(seq).any((it) -> it.foo() == it.bar());
  }
  @Test
  ...
  public String getString(Pair<String, String>... tuples) {
    return IterableUtils.join(Sequence.fromIterable(Sequence.fromArray(tuples)).select((t) -> t.first() + "=" + t.second()), ", ");
  }
  ...
  public Iterable<Data> getSequence() {
    return Sequence.fromClosure(new _FunctionTypes._return_P0_E0<Iterable<Data>>() {
      public Iterable<Data> invoke() {
