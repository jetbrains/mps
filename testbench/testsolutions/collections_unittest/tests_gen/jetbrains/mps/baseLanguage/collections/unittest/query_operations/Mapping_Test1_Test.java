...
public class Mapping_Test1_Test {
  @Test
...
__switch__:
  ...
  public void test__yieldNull() throws Exception {
    if (Sequence.IGNORE_NULL_VALUES) {
      ...
      List<String> strings2 = ListSequence.fromList(strings).translate((it) -> {
        return (Iterable<String>) () -> {
          return new YieldingIterator<String>() {
            private int __CP__ = 0;
            protected boolean moveToNext() {
...
__switch__:
      ...
      org.junit.Assert.assertNull(ListSequence.fromList(strings2).first());
      org.junit.Assert.assertNull(ListSequence.fromList(strings2).last());
    }
  }
  @Test
  public void test__null() throws Exception {
    List<String> s1 = null;
    Iterable<String> s2 = ListSequence.fromList(s1).translate((it) -> {
      return (Iterable<String>) () -> {
        return new YieldingIterator<String>() {
          private int __CP__ = 0;
          protected boolean moveToNext() {
