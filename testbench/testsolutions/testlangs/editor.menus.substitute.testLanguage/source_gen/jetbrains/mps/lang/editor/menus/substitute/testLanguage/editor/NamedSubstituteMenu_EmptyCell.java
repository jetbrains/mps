...
public class NamedSubstituteMenu_EmptyCell extends SubstituteMenuBase {
  public NamedSubstituteMenu_EmptyCell() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "NamedSubstituteMenu_EmptyCell", new SNodePointer("r:d793eea9-8b7b-4c58-a7a2-62336f54dcce(jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor)", "8998492695587525299")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Action_gllbhd_a extends SingleItemSubstituteMenuPart {
    ...
    private class Item extends DefaultSubstituteMenuItem {
      ...
      /*package*/ void resetTraceInfo() {
        ...
        updateTraceInfo(description, new SNodePointer("r:d793eea9-8b7b-4c58-a7a2-62336f54dcce(jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor)", "8998492695587525300"));
      }
