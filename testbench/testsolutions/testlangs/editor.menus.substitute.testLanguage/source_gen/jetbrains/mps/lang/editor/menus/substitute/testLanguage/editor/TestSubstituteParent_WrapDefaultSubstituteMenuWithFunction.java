...
public class TestSubstituteParent_WrapDefaultSubstituteMenuWithFunction extends TransformationMenuBase {
  public TestSubstituteParent_WrapDefaultSubstituteMenuWithFunction() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "TestSubstituteParent_WrapDefaultSubstituteMenuWithFunction", new SNodePointer("r:d793eea9-8b7b-4c58-a7a2-62336f54dcce(jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor)", "7577899271409421186")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
