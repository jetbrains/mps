...
public class NamedTransformationMenu extends TransformationMenuBase {
  public NamedTransformationMenu() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "NamedTransformationMenu", new SNodePointer("r:d793eea9-8b7b-4c58-a7a2-62336f54dcce(jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor)", "8998492695591068407")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
