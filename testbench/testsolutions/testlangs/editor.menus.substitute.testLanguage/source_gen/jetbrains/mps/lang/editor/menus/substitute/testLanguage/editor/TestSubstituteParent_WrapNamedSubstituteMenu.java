...
public class TestSubstituteParent_WrapNamedSubstituteMenu extends TransformationMenuBase {
  public TestSubstituteParent_WrapNamedSubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "TestSubstituteParent_WrapNamedSubstituteMenu", new SNodePointer("r:d793eea9-8b7b-4c58-a7a2-62336f54dcce(jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor)", "4647688914604929173")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  public class TMP_WrapSM_17gfqn_a0 extends WrapSubstituteMenuTransformationMenuPart {
    ...
    private class SMIasTMI extends SubstituteMenuItemAsActionItem implements SubstituteCompletionActionItem {
      ...
      public void execute(@NotNull String pattern) {
        ...
        ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(targetNode, CONCEPTS.TestSubstituteParent$GP), LINKS.wrapNamedSubstituteMenuFromTransformMenu$4_kL)).addElement(createdNode);
      }
