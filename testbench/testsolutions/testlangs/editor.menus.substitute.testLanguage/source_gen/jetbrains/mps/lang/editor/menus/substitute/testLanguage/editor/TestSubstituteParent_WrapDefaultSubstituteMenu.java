...
public class TestSubstituteParent_WrapDefaultSubstituteMenu extends TransformationMenuBase {
  public TestSubstituteParent_WrapDefaultSubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "TestSubstituteParent_WrapDefaultSubstituteMenu", new SNodePointer("r:d793eea9-8b7b-4c58-a7a2-62336f54dcce(jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor)", "8292814565107665606")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  public class TMP_WrapSM_n24zo3_a0 extends WrapSubstituteMenuTransformationMenuPart {
    ...
    private class SMIasTMI extends SubstituteMenuItemAsActionItem implements SubstituteCompletionActionItem {
      ...
      public void execute(@NotNull String pattern) {
        ...
        ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.cast(targetNode, CONCEPTS.TestSubstituteParent$GP), LINKS.wrapDefaultSubstituteMenuFromTransform$8lP0)).addElement(createdNode);
      }
