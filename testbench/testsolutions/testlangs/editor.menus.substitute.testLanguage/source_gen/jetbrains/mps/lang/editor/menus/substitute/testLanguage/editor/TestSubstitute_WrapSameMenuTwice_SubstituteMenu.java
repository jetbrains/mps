...
public class TestSubstitute_WrapSameMenuTwice_SubstituteMenu extends SubstituteMenuBase {
  public TestSubstitute_WrapSameMenuTwice_SubstituteMenu() {
    super(false, new EditorMenuDescriptorBase("default substitute menu for " + "TestSubstitute_WrapSameMenuTwice", new SNodePointer("r:d793eea9-8b7b-4c58-a7a2-62336f54dcce(jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor)", "4572725119287634470")));
  }
  @NotNull
  @Override
  ...
  private class SMP_Wrap_aqil95_a extends WrapperSubstituteMenuPart {
    private SMP_Wrap_aqil95_a() {
      super(new EditorMenuDescriptorBase("wrap " + "named substitute menu " + "TestSubstitute_SameMenu_ToWrap", new SNodePointer("r:d793eea9-8b7b-4c58-a7a2-62336f54dcce(jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor)", "2943611457087128160")));
    }
  ...
  private class SMP_Wrap_aqil95_b extends WrapperSubstituteMenuPart {
    private SMP_Wrap_aqil95_b() {
      super(new EditorMenuDescriptorBase("wrap " + "named substitute menu " + "TestSubstitute_SameMenu_ToWrap", new SNodePointer("r:d793eea9-8b7b-4c58-a7a2-62336f54dcce(jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor)", "2943611457087131458")));
    }
