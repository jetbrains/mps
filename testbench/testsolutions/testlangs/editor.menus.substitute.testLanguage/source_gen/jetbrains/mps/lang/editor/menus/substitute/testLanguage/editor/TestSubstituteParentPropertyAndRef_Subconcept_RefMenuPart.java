...
public class TestSubstituteParentPropertyAndRef_Subconcept_RefMenuPart extends TransformationMenuBase {
  public TestSubstituteParentPropertyAndRef_Subconcept_RefMenuPart() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "TestSubstituteParentPropertyAndRef_Subconcept_RefMenuPart", new SNodePointer("r:d793eea9-8b7b-4c58-a7a2-62336f54dcce(jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor)", "3553171620717959090")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
