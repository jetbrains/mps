...
public final class AddOrRemoveReferenceAttribute_Intention extends AbstractIntentionDescriptor implements IntentionFactory {
  ...
  /*package*/ final class IntentionImplementation extends AbstractIntentionExecutable {
    ...
    public String getDescription(final SNode node, final EditorContext editorContext) {
      if ((new IAttributeDescriptor.NodeAttribute(CONCEPTS.TestSubstituteAttribute_WithReference$2B).get(node) == null)) {
    ...
    public void execute(final SNode node, final EditorContext editorContext) {
      if ((new IAttributeDescriptor.NodeAttribute(CONCEPTS.TestSubstituteAttribute_WithReference$2B).get(node) == null)) {
        ...
        SNodeOperations.deleteNode(new IAttributeDescriptor.NodeAttribute(CONCEPTS.TestSubstituteAttribute_WithReference$2B).get(node));
      }
    }
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept TestSubstituteAttribute_WithReference$2B = MetaAdapterFactory.getConcept(0xcb6d57037c8e46a9L, 0xb993c1373dc0942fL, 0x446b8c93949517d7L, "jetbrains.mps.lang.editor.menus.substitute.testLanguage.structure.TestSubstituteAttribute_WithReference");
  }
}
