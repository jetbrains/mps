...
public class TestSubstituteParentPropertyAndReference_ReferenceMenuPart extends TransformationMenuBase {
  public TestSubstituteParentPropertyAndReference_ReferenceMenuPart() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "TestSubstituteParentPropertyAndReference_ReferenceMenuPart", new SNodePointer("r:d793eea9-8b7b-4c58-a7a2-62336f54dcce(jetbrains.mps.lang.editor.menus.substitute.testLanguage.editor)", "476103360382571677")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  public class TMP_Reference_17vnwe_a0 extends ReferenceMenuTransformationMenuPart {
    ...
    private class Item extends ReferenceTransformationMenuItem implements SubstituteCompletionActionItem {
      ...
      public boolean canExecute(String pattern) {
        boolean val = _context.getEditorContext() != null && _context.getNode() != null && _context.getModel() != null && targetNode != null;
        return Objects.equals(SPropertyOperations.getString(targetNode, PROPS.name$MnvL), "nodeToReference1");
      }
