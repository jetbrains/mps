...
public class UnusedContribution extends TransformationMenuBase {
  public UnusedContribution() {
    super(true, new EditorMenuDescriptorBase("contribution to the " + "named transformation menu " + "ContributedToFromUnusedLanguage", new SNodePointer("r:965afa85-7195-40ad-84ac-dc46d395c63b(jetbrains.mps.lang.editor.menus.testUnusedExtendingLanguage.editor)", "189670312547646590")), List.<String>of("test location"));
  }
  ...
  private class TMP_Action_upxn7_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:965afa85-7195-40ad-84ac-dc46d395c63b(jetbrains.mps.lang.editor.menus.testUnusedExtendingLanguage.editor)", "3526874291840080514"));
        return this;
      }
      @Nullable
      @Override
