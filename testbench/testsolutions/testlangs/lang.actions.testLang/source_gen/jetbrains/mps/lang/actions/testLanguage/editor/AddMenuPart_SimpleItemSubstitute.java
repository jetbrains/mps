...
public class AddMenuPart_SimpleItemSubstitute extends SubstituteMenuBase {
  ...
  public class SMP_Group_mw8afp_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    ...
    protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts() {
      return Arrays.<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>asList(new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Group_mw8afp_a.SMP_Action_mw8afp_a0(), CONCEPTS.ActionTestChild1$4Y), new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Group_mw8afp_a.SMP_Action_mw8afp_b0(), CONCEPTS.ActionTestChild1$4Y), new ConstraintsFilteringSubstituteMenuPartDecorator(new SMP_Group_mw8afp_a.SMP_Action_mw8afp_c0(), CONCEPTS.ActionTestChild2$KO));
    }
