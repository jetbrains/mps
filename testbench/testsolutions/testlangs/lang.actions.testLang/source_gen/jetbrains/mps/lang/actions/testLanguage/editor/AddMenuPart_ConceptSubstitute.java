...
public class AddMenuPart_ConceptSubstitute extends SubstituteMenuBase {
  public AddMenuPart_ConceptSubstitute() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "AddMenuPart_ConceptSubstitute", new SNodePointer("r:6f930e62-d183-4ca9-a17e-cab70bc506c7(jetbrains.mps.lang.actions.testLanguage.editor)", "1741258697587037771")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_1nroa3_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_1nroa3_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:6f930e62-d183-4ca9-a17e-cab70bc506c7(jetbrains.mps.lang.actions.testLanguage.editor)", "1741258697587037773")));
    }
    @Override
