...
public class ConceptSubstitutePartTest extends SubstituteMenuBase {
  public ConceptSubstitutePartTest() {
    super(false, new EditorMenuDescriptorBase("named substitute menu " + "ConceptSubstitutePartTest", new SNodePointer("r:6f930e62-d183-4ca9-a17e-cab70bc506c7(jetbrains.mps.lang.actions.testLanguage.editor)", "1741258697587038985")));
  }
  @NotNull
  @Override
  ...
  public class SMP_Group_rd4mcj_a extends GroupMenuPart<SubstituteMenuItem, SubstituteMenuContext> {
    public SMP_Group_rd4mcj_a() {
      super(new EditorMenuDescriptorBase("substitute menu group", new SNodePointer("r:6f930e62-d183-4ca9-a17e-cab70bc506c7(jetbrains.mps.lang.actions.testLanguage.editor)", "1741258697587038987")));
    }
    @Override
    ...
    protected List<MenuPart<SubstituteMenuItem, SubstituteMenuContext>> getParts() {
      return Arrays.<MenuPart<SubstituteMenuItem, SubstituteMenuContext>>asList(new ConstraintsFilteringSubstituteMenuPartDecorator(new SimpleConceptSubstituteMenuPart(CONCEPTS.ActionTestChild1$4Y, new EditorMenuDescriptorBase("simple substitute menu part for concept: " + "ActionTestChild1", new SNodePointer("r:6f930e62-d183-4ca9-a17e-cab70bc506c7(jetbrains.mps.lang.actions.testLanguage.editor)", "1741258697587039089"))), CONCEPTS.ActionTestChild1$4Y));
    }
  }
