...
public class ActionTestSidetransformAddConceptAbstractChild_TransformationMenu extends TransformationMenuBase {
  public ActionTestSidetransformAddConceptAbstractChild_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "ActionTestSidetransformAddConceptAbstractChild", new SNodePointer("r:6f930e62-d183-4ca9-a17e-cab70bc506c7(jetbrains.mps.lang.actions.testLanguage.editor)", "1741258697587036461")), List.<String>of(MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM, MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.LEFT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM, MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
