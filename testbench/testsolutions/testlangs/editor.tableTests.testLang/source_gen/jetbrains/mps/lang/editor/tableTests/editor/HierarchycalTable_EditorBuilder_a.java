...
/*package*/ class HierarchycalTable_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createTable_0() {
    TableModelFactory creator = new TableModelFactory() {
      public TableModel createTableModel() {
        return new HierarchycalTableModelWithHeader(myNode, LINKS.rows$eyhn, LINKS.cells$h6fm, LINKS.headers$O$1H);
      }
    };
  ...
  private static final class LINKS {
    ...
    /*package*/ static final SContainmentLink headers$O$1H = MetaAdapterFactory.getContainmentLink(0xdf8799e7254a406fL, 0xbd67f4cc27337152L, 0x760c9302beb3e1d1L, 0x760c9302beb3e1d4L, "headers");
  }
}
