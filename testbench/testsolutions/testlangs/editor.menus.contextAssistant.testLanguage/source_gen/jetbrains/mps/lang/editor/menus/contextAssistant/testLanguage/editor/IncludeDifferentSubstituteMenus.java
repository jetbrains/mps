...
public class IncludeDifferentSubstituteMenus extends TransformationMenuBase {
  public IncludeDifferentSubstituteMenus() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "IncludeDifferentSubstituteMenus", new SNodePointer("r:0f1cfce5-1514-42b6-8353-156be9a116e3(jetbrains.mps.lang.editor.menus.contextAssistant.testLanguage.editor)", "1892012100483284121")), List.<String>of(MenuLocations.CONTEXT_ASSISTANT));
  }
  ...
  public class TMP_IncludeSM_dmlyok_a0 extends IncludeSubstituteMenuTransformationMenuPart {
    ...
    protected SContainmentLink getContainmentLink(TransformationMenuContext context) {
      return LINKS.childIncludeDifferentSubstituteMenus$bKxV;
    }
    @Override
