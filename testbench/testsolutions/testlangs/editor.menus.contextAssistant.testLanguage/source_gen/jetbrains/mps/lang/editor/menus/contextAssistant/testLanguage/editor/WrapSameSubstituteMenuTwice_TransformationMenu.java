...
public class WrapSameSubstituteMenuTwice_TransformationMenu extends TransformationMenuBase {
  public WrapSameSubstituteMenuTwice_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "WrapSameSubstituteMenuTwice", new SNodePointer("r:0f1cfce5-1514-42b6-8353-156be9a116e3(jetbrains.mps.lang.editor.menus.contextAssistant.testLanguage.editor)", "4572725119287832203")), List.<String>of(MenuLocations.CONTEXT_ASSISTANT));
  }
  ...
  public class TMP_WrapSM_36vfck_a0 extends WrapSubstituteMenuTransformationMenuPart {
    ...
    private class SMIasTMI extends SubstituteMenuItemAsActionItem {
