...
public class ParentNamedMenu extends TransformationMenuBase {
  public ParentNamedMenu() {
    super(false, new EditorMenuDescriptorBase("named transformation menu " + "ParentNamedMenu", new SNodePointer("r:0f1cfce5-1514-42b6-8353-156be9a116e3(jetbrains.mps.lang.editor.menus.contextAssistant.testLanguage.editor)", "4202667662394486071")), List.<String>of(MenuLocations.SUBSTITUTE));
  }
  ...
  protected List<MenuPart<TransformationMenuItem, TransformationMenuContext>> getParts(TransformationMenuContext _context) {
    ...
    if (ListSequence.fromListAndArray(new ArrayList<String>(), MenuLocations.SUBSTITUTE).contains(_context.getMenuLocation())) {
      result.add(new TMP_Action_bwf8lj_a0());
    }
    return result;
  }
  ...
  private class TMP_Action_bwf8lj_a0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SubstituteCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:0f1cfce5-1514-42b6-8353-156be9a116e3(jetbrains.mps.lang.editor.menus.contextAssistant.testLanguage.editor)", "3738029991953491941"));
        return this;
      }
      @Nullable
      @Override
      ...
      public void execute(@NotNull String pattern) {
        SPropertyOperations.set(_context.getNode(), PROPS.name$MnvL, "z");
      }
