...
public class WrapDifferentSubstituteMenus_TransformationMenu extends TransformationMenuBase {
  public WrapDifferentSubstituteMenus_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "WrapDifferentSubstituteMenus", new SNodePointer("r:0f1cfce5-1514-42b6-8353-156be9a116e3(jetbrains.mps.lang.editor.menus.contextAssistant.testLanguage.editor)", "1892012100483323574")), List.<String>of(MenuLocations.CONTEXT_ASSISTANT));
  }
