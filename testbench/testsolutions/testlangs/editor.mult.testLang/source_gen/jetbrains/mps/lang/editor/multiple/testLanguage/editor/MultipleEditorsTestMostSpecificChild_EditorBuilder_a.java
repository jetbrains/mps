...
/*package*/ class MultipleEditorsTestMostSpecificChild_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createProperty_1() {
    getCellFactory().pushCellContext();
    try {
      final SProperty property = PROPS.defaultProperty$5LI;
      getCellFactory().setPropertyInfo(new SPropertyInfo(myNode, property));
      EditorCell_Property editorCell = EditorCell_Property.create(getEditorContext(), new SPropertyAccessor(myNode, property, false, false), myNode);
  ...
  private static final class PROPS {
    ...
    /*package*/ static final SProperty defaultProperty$5LI = MetaAdapterFactory.getProperty(0x7a80051c66e94bfcL, 0x9698b12adfed3d9fL, 0x76f70aa86b49610dL, 0x76f70aa86b49694bL, "defaultProperty");
  }
