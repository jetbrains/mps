...
public class NoFeature_Customization implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    NoFeature_CustomizationSpecific customizer = new NoFeature_CustomizationSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class NoFeature_CustomizationSpecific implements EditorMenuItemCustomizer {
