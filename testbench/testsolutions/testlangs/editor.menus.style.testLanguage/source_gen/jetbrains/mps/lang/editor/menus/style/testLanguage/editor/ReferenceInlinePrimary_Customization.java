...
public class ReferenceInlinePrimary_Customization implements EditorMenuItemCustomizer {
  ...
  public void customize(EditorMenuItemStyle customization, EditorMenuItemCustomizationContext context) {
    ...
    ReferenceInlinePrimary_CustomizationSpecific customizer = new ReferenceInlinePrimary_CustomizationSpecific();
    if (customizer.matches(context)) {
      customizer.customize(customization, context);
    }
  }

  private static class ReferenceInlinePrimary_CustomizationSpecific implements EditorMenuItemCustomizer {
    public boolean matches(EditorMenuItemCustomizationContext context) {
      return new EditorMenuItemModifyingConceptContextMatcher(CONCEPTS.TestCompletionCustomization_ParentTestContextMatcher$Un) {
        ...
        protected boolean doMatchesContext_(SNode contextNode, SContainmentLink containmentLink, SReferenceLink referenceLink, SProperty property) {
          return Objects.equals(referenceLink, LINKS.referenceInlinePrimary$7QWB);
        }
  ...
  private static final class LINKS {
    /*package*/ static final SReferenceLink referenceInlinePrimary$7QWB = MetaAdapterFactory.getReferenceLink(0xb4a430be169648bfL, 0xbb724333242e590cL, 0x49b11095109798c7L, 0x399c6e0ff745479fL, "referenceInlinePrimary");
  }
