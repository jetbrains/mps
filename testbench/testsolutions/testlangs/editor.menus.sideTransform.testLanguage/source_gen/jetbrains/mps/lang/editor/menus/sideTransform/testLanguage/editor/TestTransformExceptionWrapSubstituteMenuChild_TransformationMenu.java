...
public class TestTransformExceptionWrapSubstituteMenuChild_TransformationMenu extends TransformationMenuBase {
  public TestTransformExceptionWrapSubstituteMenuChild_TransformationMenu() {
    super(false, new EditorMenuDescriptorBase("default transformation menu for " + "TestTransformExceptionWrapSubstituteMenuChild", new SNodePointer("r:73252a8a-5dfe-41ab-9452-7c5453e47c1f(jetbrains.mps.lang.editor.menus.sideTransform.testLanguage.editor)", "8955468859940959985")), List.<String>of(MenuLocations.RIGHT_SIDE_TRANSFORM));
  }
  ...
  public class TMP_WrapSM_u021up_a0 extends WrapSubstituteMenuTransformationMenuPart {
    ...
    private SAbstractConcept getConceptToFindMenuFor(TransformationMenuContext _context) {
      return CONCEPTS.TestSideTransform_SimpleNode$za;
    }
  ...
  private class TMP_Action_u021up_b0 extends SingleItemMenuPart<TransformationMenuItem, TransformationMenuContext> {
    ...
    private class Item extends ActionItemBase implements SideTransformCompletionActionItem {
      ...
      /*package*/ Item resetTraceInfo() {
        updateTraceInfo("single item: " + getLabelText(""), new SNodePointer("r:73252a8a-5dfe-41ab-9452-7c5453e47c1f(jetbrains.mps.lang.editor.menus.sideTransform.testLanguage.editor)", "8955468859940961493"));
        return this;
      }
      @Nullable
      @Override
  ...
  private static final class CONCEPTS {
    /*package*/ static final SConcept TestSideTransform_SimpleNode$za = MetaAdapterFactory.getConcept(0x14a4b50159f64c39L, 0xb5de4a5d59477831L, 0x56074a6f055ddb27L, "jetbrains.mps.lang.editor.menus.sideTransform.testLanguage.structure.TestSideTransform_SimpleNode");
  }
}
