...
public class PriorityCheckTest_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_testRotation() throws Exception {
      ...
      SPropertyOperations.assign(constant, PriorityCheckTest_Test.PROPS.value$ZeO0, 3);
      SLinkOperations.setTarget(op, PriorityCheckTest_Test.LINKS.leftExpression$rxLZ, constant);
      ...
      SLinkOperations.setTarget(op, PriorityCheckTest_Test.LINKS.rightExpression$rxBl, SNodeOperations.cast(getNodeById("3852894662483449704"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf8cc67c7fbL, "PlusExpression"))));
