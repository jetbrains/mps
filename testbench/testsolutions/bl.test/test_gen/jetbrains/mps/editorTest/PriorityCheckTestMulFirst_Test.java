...
public class PriorityCheckTestMulFirst_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_testRotation() throws Exception {
      ...
      SPropertyOperations.assign(constant, PriorityCheckTestMulFirst_Test.PROPS.value$ZeO0, 3);
      SLinkOperations.setTarget(op, PriorityCheckTestMulFirst_Test.LINKS.leftExpression$rxLZ, constant);
      ...
      SLinkOperations.setTarget(op, PriorityCheckTestMulFirst_Test.LINKS.rightExpression$rxBl, SNodeOperations.cast(getNodeById("818296778579227386"), SNodeOperations.asSConcept(MetaAdapterFactory.getConcept(MetaAdapterFactory.getLanguage(0xf3061a5392264cc5L, 0xa443f952ceaf5816L, "jetbrains.mps.baseLanguage"), 0xf8cc67c7fbL, "PlusExpression"))));
