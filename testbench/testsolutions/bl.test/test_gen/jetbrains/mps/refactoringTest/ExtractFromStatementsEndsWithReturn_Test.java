...
public class ExtractFromStatementsEndsWithReturn_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCache(ExtractFromStatementsEndsWithReturn_Test.class, "${mps_home}", "r:4dc6ffb5-4bbb-4773-b0b7-e52989ceb56f(jetbrains.mps.refactoringTest@tests)", false));
  ...
  public void test_extractFromStatementsEndsWithReturn() throws Throwable {
    new TestBody(this).test_extractFromStatementsEndsWithReturn();
  }
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_extractFromStatementsEndsWithReturn() throws Exception {
      ...
      runWithinCommand(() -> {
        ...
        ref.doRefactor();
        {
          List<SNode> nodesBefore = ListSequence.fromListAndArray(new ArrayList<SNode>(), getNodeById("1230052642041"));
          List<SNode> nodesAfter = ListSequence.fromListAndArray(new ArrayList<SNode>(), getNodeById("1230052642054"));
