...
public class ChangeReturningType_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(ChangeReturningType_Test.class).projectPath(null).modelRef("r:4dc6ffb5-4bbb-4773-b0b7-e52989ceb56f(jetbrains.mps.refactoringTest@tests)").reopenProject(null).build());
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_ChangeReturningType() throws Exception {
      ...
      runWithinCommand(() -> {
        ...
        SLinkOperations.setTarget(params.getDeclaration(), LINKS.returnType$5xoi, SNodeOperations.copyNode(getAnnotatedNode("string")));
