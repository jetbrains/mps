...
public class ExtractMethodFromConstructor_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCache(ExtractMethodFromConstructor_Test.class, "${mps_home}", "r:4dc6ffb5-4bbb-4773-b0b7-e52989ceb56f(jetbrains.mps.refactoringTest@tests)", false));

  public ExtractMethodFromConstructor_Test() {
    super(ourParametersCacheExtension.getParametersCache());
  }

  @Test
  public void test_ExtractMethodFromConstructor() throws Throwable {
    new TestBody(this).test_ExtractMethodFromConstructor();
  }
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_ExtractMethodFromConstructor() throws Exception {
      ...
      runWithinCommand(() -> {
        ...
        ref.doRefactor();
        {
          List<SNode> nodesBefore = ListSequence.fromListAndArray(new ArrayList<SNode>(), getNodeById("1230052407136"));
          List<SNode> nodesAfter = ListSequence.fromListAndArray(new ArrayList<SNode>(), getNodeById("1230052407147"));
