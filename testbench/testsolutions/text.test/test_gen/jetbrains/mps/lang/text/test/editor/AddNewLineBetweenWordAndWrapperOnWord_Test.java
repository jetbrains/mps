...
public class AddNewLineBetweenWordAndWrapperOnWord_Test extends BaseTransformationTest {
  @RegisterExtension
  private static final TestParametersCacheExtension ourParametersCacheExtension = new TestParametersCacheExtension(new TestParametersCacheBuilder(AddNewLineBetweenWordAndWrapperOnWord_Test.class).projectPath(null).modelRef("r:6cf522f1-8af4-45dd-b0f5-721b6e5caab5(jetbrains.mps.lang.text.test.editor@tests)").reopenProject(false).build());
