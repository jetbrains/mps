...
public class Validation_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_NodeRecursiveConstructorInvocationCheck6923385624929443716() throws Exception {
      ...
      new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(nodeToCheck, MessageStatus.ERROR, new SNodePointer("r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "698255809162976968"), myProject.getRepository()).run();
    }
    ...
    public void test_NodeIllegalCombinationOfModifiersCheck6923385624927426848() throws Exception {
      ...
      new CheckExpectedMessageAction.CheckExpectedRuleMessageAction(nodeToCheck, MessageStatus.ERROR, new SNodePointer("r:00000000-0000-4000-0000-011c895902c5(jetbrains.mps.baseLanguage.typesystem)", "7868761255934417558"), myProject.getRepository()).run();
    }
