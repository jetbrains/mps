...
public class UnexpectedReturnInAnonymousClass_Test extends BaseTransformationTest {
  ...
  /*package*/ static class TestBody extends BaseTestBody {
    ...
    public void test_NodeTypeSystemCheck7854334384284976424() throws Exception {
      ...
      new CheckExpectedMessageRunnable.CheckExpectedTypesystemMessageRunnable(nodeToCheck, MessageStatus.ERROR, "Error: (instance of IntegerType) is expected to be returned from the method", myProject.getRepository(), ((ProjectBase) myProject).getPlatform()).run();
    }
