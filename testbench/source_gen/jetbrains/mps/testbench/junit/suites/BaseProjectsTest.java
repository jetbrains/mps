...
public class BaseProjectsTest {
  ...
  public static List<Object[]> testParameters() throws InvocationTargetException, InterruptedException {
    EnvironmentConfig config = EnvironmentConfig.defaultConfig().withAutomaticPluginDiscovery()/*.setCreatePluginClassLoaders(false).withJavaPlugin().withKotlinPlugin().withMigrationPlugin()*/.withTestModeOn();
