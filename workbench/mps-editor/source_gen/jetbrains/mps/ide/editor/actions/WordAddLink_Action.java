...
public class WordAddLink_Action extends BaseAction {
  ...
  public boolean isApplicable(AnActionEvent event, final Map<String, Object> _params) {
    return isEmptyString(SPropertyOperations.getString(event.getData(MPSCommonDataKeys.NODE), PROPS.url$SIrt));
  }
  @Override
  ...
  protected boolean collectActionData(AnActionEvent event, final Map<String, Object> _params) {
    ...
    }
    {
      ...
      if (node != null && !(SNodeOperations.isInstanceOf(node, CONCEPTS.Word$Dn))) {
        node = null;
      }
      if (node == null) {
        return false;
