...
/**
 * Avoids being a platform component, unlike @see {@link BaseTabbedProjectTool}
 */
public abstract class BaseTabbedProjectServiceTool extends BaseTool {

  private final List<IDisposableTab> myTabList = new ArrayList<>();
  private boolean myContentRemovedListenerAdded = false;

  protected BaseTabbedProjectServiceTool(Project project, String id, Map<String, KeyStroke> shortcutsByKeymap, Icon icon,
