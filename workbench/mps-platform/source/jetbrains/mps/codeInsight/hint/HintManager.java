...
/**
 * Copied from {@link com.intellij.codeInsight.hint.HintManager}.
 */
public abstract class HintManager {
  ...
  public abstract void showErrorHint(@NotNull EditorComponent editor, @NotNull @HintText String text);

  public abstract void showErrorHint(@NotNull EditorComponent editor, @NotNull @HintText String text, @PositionFlags short position);

  public void showInformationHint(@NotNull EditorComponent editor, @NotNull @HintText String text) {
    showInformationHint(editor, text, ABOVE);
  }

  public abstract void showInformationHint(@NotNull EditorComponent editor, @NotNull @HintText String text, @PositionFlags short position);

  public abstract void showInformationHint(@NotNull EditorComponent editor, @NotNull @HintText String text, @Nullable HyperlinkListener listener);

  public abstract void showInformationHint(@NotNull EditorComponent editor, @NotNull JComponent component);

  public abstract void showQuestionHint(@NotNull EditorComponent editor, @NotNull @HintText String hintText, int offset1, int offset2,
