  ...
  private void populate(MPSTreeNode root, Iterable<DepLink> allDependencies) {
    ...
    for (final SModuleReference module : Sequence.fromIterable(sortedModules)) {
      ...
      if (module.equals(myModule.getModuleReference())) {
        ...
        // ifthere'sanydependencywithlooptoitself,androleofeachelementofthispathisDependency,thenit'sdependencycycle
        // NOTE,selectManyendsupasTranslatingSequence,itwedon'twantcyclestoberecalculatedagainandagainonany
        // ModuleDependencyNode.isLeafcall,shallkeepitcalcualtedinacollectiononceandforall(e.g.withtoList)
