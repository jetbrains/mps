...
@GeneratedClass(node = "r:6e42326f-4bc0-4b77-a711-f3d4535f48d5(jetbrains.mps.ide.script.plugin.migrationtool)/754691077499752570", model = "r:6e42326f-4bc0-4b77-a711-f3d4535f48d5(jetbrains.mps.ide.script.plugin.migrationtool)")
public class MigrationScriptsController {
  ...
  public Collection<SearchResult<SNode>> computeAliveIncludedResults(final List<SNodeReference> includedResultNodes, SRepository repo) {
    ...
    List<SearchResult<SNode>> aliveResults = myFinder.getLastSearchResults().getNotNullResults();
