...
@GeneratedClass(node = "r:6e42326f-4bc0-4b77-a711-f3d4535f48d5(jetbrains.mps.ide.script.plugin.migrationtool)/6586015060859883006", model = "r:6e42326f-4bc0-4b77-a711-f3d4535f48d5(jetbrains.mps.ide.script.plugin.migrationtool)")
public class MigrationScriptExecutor {
  ...
  public void execImmediately(ProgressMonitor promon) {
    // uptothepointotMigrationScriptController.process,wearefinewithreadaction
    // However,atthemoment,wedonotcaretospeedupUIstuffasitwouldrequirethoroughrefactoring,whilesimplicityismygoalnow.
    // E.g.shallsplitprepare()toruninreadaction,tocollectapplicableSNodeReference,andseparateapply()torunascommandinUIthread
