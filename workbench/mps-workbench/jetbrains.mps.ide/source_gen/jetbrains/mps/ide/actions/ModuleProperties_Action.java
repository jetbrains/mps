...
public class ModuleProperties_Action extends BaseAction {
  ...
  public void doExecute(@NotNull final AnActionEvent event, final Map<String, Object> _params) {
    // saveallissortofhack-changestoamodulemightleadtomodulere-load
    // (happensforGenerator)andcloseofallrespectivemodifiededitors(andchangeslost)
    // ThebestwaytofixwouldbeGeneratormodulenotchangingitslanguage(whichinturntriggers
    // removalofallgeneratormodels),butpreservingeverythingintactasitisfore.g.languagemodulechanges
