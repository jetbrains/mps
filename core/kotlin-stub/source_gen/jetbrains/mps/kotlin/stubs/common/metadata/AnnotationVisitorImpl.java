...
public class AnnotationVisitorImpl implements AnnotationVisitor {
  ...
  public void visitAnnotation(KmAnnotation annotation) {
    ...
    {
      final SNode args = node;
      if (SNodeOperations.isInstanceOf(args, CONCEPTS.IArguments$xj)) {
        for (IMapping<String, KmAnnotationArgument> arg : MapSequence.fromMap(annotation.getArguments())) {
          addArgument(className, arg.key(), arg.value(), args, context);
        }
      }
    }
  ...
  /*package*/ SNode arrayOf(SNode type, int depth, VisitorContext context) {
    if (depth == 0) {
      ...
      ListSequence.fromList(SLinkOperations.getChildren(SNodeOperations.as(clType, CONCEPTS.IProjectedTypeArguments$ql), LINKS.typeProjections$vhti)).addElement(createTypeProjection_l27wj3_a0a1a0a0o(arrayOf(type, depth - 1, context), SEnumOperations.getMember(MetaAdapterFactory.getEnumeration(0x6b3888c1980244d8L, 0x8baff8e6c33ed689L, 0x21e0c923289a2189L, "jetbrains.mps.kotlin.structure.VarianceModifier"), 0x21e0c923289a2222L, "inv")));
      return clType;
    }
  }
  ...
  private static SNode createNavigationOperation_l27wj3_a6a1a0k(SNode p0, SNode p1) {
  ...
  private static SNode createTypeProjection_l27wj3_a0a1a0a0o(SNode p0, SEnumerationLiteral p1) {
