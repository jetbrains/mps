...
public class ClassVisitor extends KmClassVisitor {
  ...
  private final boolean myLazyNode;

  public ClassVisitor(VisitorContext ctx, boolean lazyNode, _FunctionTypes._void_P1_E0<? super SNode> callback) {
    myCallback = callback;
    context = ctx;
    myLazyNode = lazyNode;
  }
  ...
  public void visit(int flags, @NotNull String fqName) {
    setNode(EnumFlags.getClass(Flags.CLASS_KIND.get(flags), myLazyNode));
    {
  ...
  public KmTypeVisitor visitSupertype(int flags) {
    {
      ...
      if (SNodeOperations.isInstanceOf(inheriting, CONCEPTS.IInheritExplicitly$UG)) {
        return new TypeVisitor(context, flags, (SNode type, String id) -> {
          ...
          {
            final SNode javaClassType = type;
            if (SNodeOperations.isInstanceOf(javaClassType, CONCEPTS.JavaClassType$Gf)) {
