...
public class MpsLoadTask extends Task {
  ...
  public void execute() throws BuildException {
    ...
    if (myFork) {
      ...
      commandLine.add("@" + dumpClassPathToArgFile(sb.toString()).getAbsolutePath());
      if (myOpenPackages) {
  ...
  private File dumpClassPathToArgFile(String classPath) {
    try {
      File argFile = File.createTempFile("mpsLoadTask-cp", ".txt");
      argFile.deleteOnExit();
      String content = "-classpath \"" + classPath.replace('\\', '/') + "\"";
      Files.writeString(argFile.toPath(), content);
      return argFile;
    } catch (IOException e) {
      throw new BuildException(e);
    }
