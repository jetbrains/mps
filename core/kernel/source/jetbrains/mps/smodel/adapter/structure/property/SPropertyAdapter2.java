...
/**
 * {@link SPropertyAdapter} tailored for bootstrap application.
 * see BOOTSTRAP META OBJECTS javadoc for {@link jetbrains.mps.smodel.adapter.BootstrapAdapterFactory}
 *
 * At the moment, it's only 'name' attribute we care to guard for bootstrap purposes, i.e. don't want to go through PropertyDescriptor
 * to find out actual value.
 *
 * Indeed, the name is unfortunate, just don't want to see neither SPropertyBootstrapAdapter nor SPropertyAdapterBS
 *
