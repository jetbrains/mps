...
@GeneratedClass(nodeId = "5455284157994035575", model = "r:314576fc-3aee-4386-a0a5-a38348ac317d(jetbrains.mps.scope)")
  ...
  public static ListScope forResolvableElements(Iterable<SNode> elements) {
    return new ListScope(elements) {
      public String getName(SNode child) {
        ...
        return ((String) BHReflection.invoke0(child, CONCEPTS.BaseConcept$gP, SMethodIdV2.create("getPresentation", 1213877396640L, 0x553941aeb020c32eL)));
      }
    };
  }
