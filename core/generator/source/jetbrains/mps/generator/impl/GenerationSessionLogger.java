 ...
 * Note, error count is vital to recognize m2m failure (see GenerationSession), with errors not counted,
 * any m2m without exception would be treated as successful.
 */
