...
@Immutable
public final class MissingChildContext implements Context {
  private final SNode myNode;
  private final SNode myChild;
  private final SContainmentLink myLink;

  public MissingChildContext(@NotNull SNode node, @NotNull SNode childNode, @NotNull SContainmentLink link) {
    myNode = node;
    myChild = childNode;
    myLink = link;
  }
