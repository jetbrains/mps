...
public class ASMNodeId {
  ...
  public static SNodeId createId(ASMClass cls, ASMMethod method) {
    ...
    sb.append(')');
    String stubMethodWithoutReturnType = sb.toString();
    if (!method.isConstructor()) {
      sb.append(':');
      sb.append(ASMNodeId.asString(method.getReturnType()));
      String stubMethodWithReturnType = sb.toString();
      return new StringBasedIdForJavaStubMethods(StringBasedIdForJavaStubMethods.ID_PREFIX + stubMethodWithReturnType);
    }
    return new jetbrains.mps.smodel.SNodeId.Foreign(jetbrains.mps.smodel.SNodeId.Foreign.ID_PREFIX + stubMethodWithoutReturnType);
  }
