...
public class ClassifierUpdater {
  ...
  private void updateInstanceMethods(SNode cls) {
    for (ASMMethod m : myParsedClass.getDeclaredMethods()) {
      ...
      if (!(m.isAbstract()) && SNodeOperations.isInstanceOf(cls, CONCEPTS.Interface$db)) {
        SLinkOperations.addNewChild(md, LINKS.modifiers$F5MM, CONCEPTS.DefaultModifier$PN);
      }
  ...
  private static SNode createClassifierClassExpression_ol94f8_a0a0o0rb() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ClassifierClassExpression$lN);
    return rootBuilder1.getResult();
  }
  ...
  private static SNode createByteType_ol94f8_a0a1a44() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ByteType$Ms);
    return rootBuilder1.getResult();
  }
  private static SNode createShortType_ol94f8_a0a2a44() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.ShortType$ro);
    return rootBuilder1.getResult();
  }
  ...
  private static SNode createLongType_ol94f8_a0a4a44() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.LongType$5X);
    return rootBuilder1.getResult();
  }
  private static SNode createFloatType_ol94f8_a0a5a44() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.FloatType$up);
    return rootBuilder1.getResult();
  }
  private static SNode createDoubleType_ol94f8_a0a6a44() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.DoubleType$x0);
    return rootBuilder1.getResult();
  }
  ...
  private static SNode createCharType_ol94f8_a0a8a44() {
    SNodeBuilder rootBuilder1 = new SNodeBuilder().init(CONCEPTS.CharType$JQ);
    return rootBuilder1.getResult();
  }
