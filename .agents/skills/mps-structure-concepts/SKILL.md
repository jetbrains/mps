...
description: Steps to define concepts, interface concepts, and enums in an MPS language. Includes the full reference for `mps_mcp_perform_structure_operation` (operations and parameter formats).
---
...
### Operation Reference
Read `references/structure-operation-api.md` when you need exact `mps_mcp_perform_structure_operation` operation names, JSON parameter formats, or structure blueprint schemas.
