...
| `ClassifierType(List<SNode>)` in a rule's return type | Java parser default — see `mps-model-code/references/variable-declarations.md` | Replace `returnType` with MPS `ListType`/`SequenceType` |
